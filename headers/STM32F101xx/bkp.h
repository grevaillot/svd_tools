...
/** BKP_CSR BKP_CSR control/status register (BKP_CSR) **/
...
/** BKP_RTCCR_ASOS Alarm or second output selection **/
#define BKP_RTCCR_ASOS		(1 << 9)
/** BKP_RTCCR_ASOE Alarm or second output enable **/
...
/** @defgroup bkp_csr CSR BKP_CSR control/status register (BKP_CSR)
@{*/
