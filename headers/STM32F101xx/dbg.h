...
/** DBG_CR_DBG_TIM14_STOP TIM14 counter stopped when core is halted **/
#define DBG_CR_DBG_TIM14_STOP		(1 << 27)
/** DBG_CR_DBG_TIM13_STOP TIM13 counter stopped when core is halted **/
#define DBG_CR_DBG_TIM13_STOP		(1 << 26)
/** DBG_CR_DBG_TIM12_STOP TIM12 counter stopped when core is halted **/
#define DBG_CR_DBG_TIM12_STOP		(1 << 25)
/** DBG_CR_DBG_TIM17_STOP TIM17 counter stopped when core is halted **/
#define DBG_CR_DBG_TIM17_STOP		(1 << 24)
/** DBG_CR_DBG_TIM16_STOP TIM16 counter stopped when core is halted **/
#define DBG_CR_DBG_TIM16_STOP		(1 << 23)
/** DBG_CR_DBG_TIM15_STOP TIM15 counter stopped when core is halted **/
#define DBG_CR_DBG_TIM15_STOP		(1 << 22)
