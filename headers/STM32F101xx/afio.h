...
/** AFIO_MAPR_ADC2_ETRGREG_REMAP ADC 2 external trigger regular conversion remapping **/
#define AFIO_MAPR_ADC2_ETRGREG_REMAP		(1 << 20)
/** AFIO_MAPR_ADC2_ETRGINJ_REMAP ADC 2 external trigger injected conversion remapping **/
#define AFIO_MAPR_ADC2_ETRGINJ_REMAP		(1 << 19)
/** AFIO_MAPR_ADC1_ETRGREG_REMAP ADC 1 external trigger regular conversion remapping **/
#define AFIO_MAPR_ADC1_ETRGREG_REMAP		(1 << 18)
/** AFIO_MAPR_ADC1_ETRGINJ_REMAP ADC 1 External trigger injected conversion remapping **/
...
#define AFIO_MAPR_CAN_REMAP_SHIFT		13
#define AFIO_MAPR_CAN_REMAP_MASK		0x03
/** @defgroup afio_mapr_can_remap CANREMAP CAN1 remapping
@{*/
/**@}*/
