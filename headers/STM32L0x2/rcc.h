...
/** @defgroup rcc_crrcr_hsi48cal HSI48CAL 48 MHz HSI clock calibration
@{*/
/**@}*/

/** RCC_CRRCR_HSI48DIV6EN 48 MHz HSI clock divided by 6 output enable **/
#define RCC_CRRCR_HSI48DIV6EN		(1 << 2)
/** RCC_CRRCR_HSI48RDY 48MHz HSI clock ready flag **/
#define RCC_CRRCR_HSI48RDY		(1 << 1)
/** RCC_CRRCR_HSI48ON 48MHz HSI clock enable bit **/
...
/** RCC_CIER_HSI48RDYIE HSI48 ready interrupt flag **/
...
/** RCC_AHBRSTR_RNGRST Random Number Generator module reset **/
#define RCC_AHBRSTR_RNGRST		(1 << 20)
/** RCC_AHBRSTR_TOUCHRST Touch Sensing reset **/
#define RCC_AHBRSTR_TOUCHRST		(1 << 16)
...
/** RCC_APB2RSTR_TM12RST TIM22 timer reset **/
#define RCC_APB2RSTR_TM12RST		(1 << 5)
...
/** RCC_APB1RSTR_CRSRST Clock recovery system reset **/
...
/** RCC_APB1RSTR_LPUART12RST UART2 reset **/
#define RCC_APB1RSTR_LPUART12RST		(1 << 17)
...
/** RCC_APB1RSTR_TIM3RST Timer3 reset **/
#define RCC_APB1RSTR_TIM3RST		(1 << 1)
/** RCC_APB1RSTR_TIM2RST Timer2 reset **/
...
/** RCC_IOPENR_IOPEEN I/O port E clock enable bit **/
...
/** RCC_AHBENR_RNGEN Random Number Generator clock enable bit **/
#define RCC_AHBENR_RNGEN		(1 << 20)
/** RCC_AHBENR_TOUCHEN Touch Sensing clock enable bit **/
...
/** RCC_APB2ENR_MIFIEN MiFaRe Firewall clock enable bit **/
#define RCC_APB2ENR_MIFIEN		(1 << 7)
...
/** RCC_APB1ENR_DACEN DAC interface clock enable bit **/
#define RCC_APB1ENR_DACEN		(1 << 29)
/** RCC_APB1ENR_PWREN Power interface clock enable bit **/
#define RCC_APB1ENR_PWREN		(1 << 28)
/** RCC_APB1ENR_CRSEN Clock recovery system clock enable bit **/
#define RCC_APB1ENR_CRSEN		(1 << 27)
/** RCC_APB1ENR_USBEN USB clock enable bit **/
...
/** RCC_APB1ENR_TIM3EN Timer3 clock enable bit **/
...
/** RCC_IOPSMEN_IOPDSMEN IOPDSMEN **/
#define RCC_IOPSMEN_IOPDSMEN		(1 << 3)
/** RCC_IOPSMEN_IOPCSMEN IOPCSMEN **/
#define RCC_IOPSMEN_IOPCSMEN		(1 << 2)
/** RCC_IOPSMEN_IOPBSMEN IOPBSMEN **/
#define RCC_IOPSMEN_IOPBSMEN		(1 << 1)
/** RCC_IOPSMEN_IOPASMEN IOPASMEN **/
...
/** RCC_AHBSMENR_CRYPSMEN Crypto clock enable during sleep mode bit **/
#define RCC_AHBSMENR_CRYPSMEN		(1 << 24)
/** RCC_AHBSMENR_RNGSMEN Random Number Generator clock enable during sleep mode bit **/
#define RCC_AHBSMENR_RNGSMEN		(1 << 20)
/** RCC_AHBSMENR_TOUCHSMEN Touch Sensing clock enable during sleep mode bit **/
...
/** RCC_APB1SMENR_I2C3SMEN 2C3 clock enable during Sleep mode bit **/
#define RCC_APB1SMENR_I2C3SMEN		(1 << 30)
/** RCC_APB1SMENR_DACSMEN DAC interface clock enable during sleep mode bit **/
...
/** RCC_APB1SMENR_USBSMEN USB clock enable during sleep mode bit **/
...
/** RCC_APB1SMENR_USART4SMEN USART4 clock enable during Sleep mode bit **/
...
/** RCC_APB1SMENR_TIM3SMEN Timer3 clock enable during Sleep mode bit **/
...
/** RCC_CCIPR_HSI48MSEL 48 MHz HSI48 clock source selection bit **/
#define RCC_CCIPR_HSI48MSEL		(1 << 26)
...
/** @defgroup rcc_ccipr_i2c3sel I2C3SEL I2C3 clock source selection bits
@{*/
/**@}*/
