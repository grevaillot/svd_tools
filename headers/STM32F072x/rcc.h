...
/** RCC_CFGR_PLLNODIV PLL clock not divided for MCO **/
...
/** @defgroup rcc_cfgr_pllsrc PLLSRC PLL input clock source
@{*/
/**@}*/
...
/** RCC_CIR_HSI48RDYC HSI48 Ready Interrupt Clear **/
...
/** RCC_CIR_HSI48RDYIE HSI48 ready interrupt enable **/
...
/** RCC_CIR_HSI48RDYF HSI48 ready interrupt flag **/
...
/** RCC_APB1RSTR_CRSRST Clock Recovery System interface reset **/
#define RCC_APB1RSTR_CRSRST		(1 << 27)
/** RCC_APB1RSTR_CANRST CAN interface reset **/
#define RCC_APB1RSTR_CANRST		(1 << 25)
/** RCC_APB1RSTR_USBRST USB interface reset **/
...
/** RCC_APB1RSTR_TIM7RST TIM7 timer reset **/
...
/** RCC_APB1ENR_CRSEN Clock Recovery System interface clock enable **/
#define RCC_APB1ENR_CRSEN		(1 << 27)
/** RCC_APB1ENR_CANEN CAN interface clock enable **/
#define RCC_APB1ENR_CANEN		(1 << 25)
/** RCC_APB1ENR_USBRST USB interface clock enable **/
#define RCC_APB1ENR_USBRST		(1 << 23)
/** RCC_APB1ENR_I2C2EN I2C 2 clock enable **/
#define RCC_APB1ENR_I2C2EN		(1 << 22)
/** RCC_APB1ENR_I2C1EN I2C 1 clock enable **/
#define RCC_APB1ENR_I2C1EN		(1 << 21)
/** RCC_APB1ENR_USART4EN USART4 clock enable **/
...
/** RCC_APB1ENR_TIM7EN TIM7 timer clock enable **/
...
/** RCC_CFGR3_USBSW USB clock source selection **/
...
/** RCC_CR2_HSI48CAL HSI48 factory clock calibration **/
#define RCC_CR2_HSI48CAL		(1 << 24)
/** RCC_CR2_HSI48RDY HSI48 clock ready flag **/
#define RCC_CR2_HSI48RDY		(1 << 17)
/** RCC_CR2_HSI48ON HSI48 clock enable **/
