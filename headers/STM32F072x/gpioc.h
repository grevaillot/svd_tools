...
/** GPIOC_OTYPER_OT15 Port x configuration bit 15 **/
#define GPIOC_OTYPER_OT15		(1 << 15)
/** GPIOC_OTYPER_OT14 Port x configuration bit 14 **/
#define GPIOC_OTYPER_OT14		(1 << 14)
/** GPIOC_OTYPER_OT13 Port x configuration bit 13 **/
#define GPIOC_OTYPER_OT13		(1 << 13)
/** GPIOC_OTYPER_OT12 Port x configuration bit 12 **/
#define GPIOC_OTYPER_OT12		(1 << 12)
/** GPIOC_OTYPER_OT11 Port x configuration bit 11 **/
#define GPIOC_OTYPER_OT11		(1 << 11)
/** GPIOC_OTYPER_OT10 Port x configuration bit 10 **/
#define GPIOC_OTYPER_OT10		(1 << 10)
/** GPIOC_OTYPER_OT9 Port x configuration bit 9 **/
#define GPIOC_OTYPER_OT9		(1 << 9)
/** GPIOC_OTYPER_OT8 Port x configuration bit 8 **/
#define GPIOC_OTYPER_OT8		(1 << 8)
/** GPIOC_OTYPER_OT7 Port x configuration bit 7 **/
#define GPIOC_OTYPER_OT7		(1 << 7)
/** GPIOC_OTYPER_OT6 Port x configuration bit 6 **/
#define GPIOC_OTYPER_OT6		(1 << 6)
/** GPIOC_OTYPER_OT5 Port x configuration bit 5 **/
#define GPIOC_OTYPER_OT5		(1 << 5)
/** GPIOC_OTYPER_OT4 Port x configuration bit 4 **/
#define GPIOC_OTYPER_OT4		(1 << 4)
/** GPIOC_OTYPER_OT3 Port x configuration bit 3 **/
#define GPIOC_OTYPER_OT3		(1 << 3)
/** GPIOC_OTYPER_OT2 Port x configuration bit 2 **/
#define GPIOC_OTYPER_OT2		(1 << 2)
/** GPIOC_OTYPER_OT1 Port x configuration bit 1 **/
#define GPIOC_OTYPER_OT1		(1 << 1)
/** GPIOC_OTYPER_OT0 Port x configuration bit 0 **/
...
/** GPIOC_LCKR_LCKK Port x lock bit y **/
...
/** GPIOC_BRR_BR15 Port x Reset bit y **/
#define GPIOC_BRR_BR15		(1 << 15)
/** GPIOC_BRR_BR14 Port x Reset bit y **/
#define GPIOC_BRR_BR14		(1 << 14)
/** GPIOC_BRR_BR13 Port x Reset bit y **/
#define GPIOC_BRR_BR13		(1 << 13)
/** GPIOC_BRR_BR12 Port x Reset bit y **/
#define GPIOC_BRR_BR12		(1 << 12)
/** GPIOC_BRR_BR11 Port x Reset bit y **/
#define GPIOC_BRR_BR11		(1 << 11)
/** GPIOC_BRR_BR10 Port x Reset bit y **/
#define GPIOC_BRR_BR10		(1 << 10)
/** GPIOC_BRR_BR9 Port x Reset bit y **/
#define GPIOC_BRR_BR9		(1 << 9)
/** GPIOC_BRR_BR8 Port x Reset bit y **/
#define GPIOC_BRR_BR8		(1 << 8)
/** GPIOC_BRR_BR7 Port x Reset bit y **/
#define GPIOC_BRR_BR7		(1 << 7)
/** GPIOC_BRR_BR6 Port x Reset bit y **/
#define GPIOC_BRR_BR6		(1 << 6)
/** GPIOC_BRR_BR5 Port x Reset bit y **/
#define GPIOC_BRR_BR5		(1 << 5)
/** GPIOC_BRR_BR4 Port x Reset bit y **/
#define GPIOC_BRR_BR4		(1 << 4)
/** GPIOC_BRR_BR3 Port x Reset bit y **/
#define GPIOC_BRR_BR3		(1 << 3)
/** GPIOC_BRR_BR2 Port x Reset bit y **/
#define GPIOC_BRR_BR2		(1 << 2)
/** GPIOC_BRR_BR1 Port x Reset bit y **/
#define GPIOC_BRR_BR1		(1 << 1)
/** GPIOC_BRR_BR0 Port x Reset bit y **/
