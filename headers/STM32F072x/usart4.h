...
/** @defgroup usart4_cr1_deat DEAT Driver Enable assertion time
@{*/
/**@}*/
...
/** @defgroup usart4_cr1_dedt DEDT Driver Enable deassertion time
@{*/
/**@}*/
...
/** USART4_CR1_M Word length **/
#define USART4_CR1_M		(1 << 12)
...
#define USART4_CR2_ADD4_SHIFT		28
#define USART4_CR2_ADD4_MASK		0x0f
/** @defgroup usart4_cr2_add4 ADD4 Address of the USART node
@{*/
/**@}*/


#define USART4_CR2_ADD0_SHIFT		24
#define USART4_CR2_ADD0_MASK		0x0f
/** @defgroup usart4_cr2_add0 ADD0 Address of the USART node
@{*/
/**@}*/
...
/** USART4_CR2_DATAINV Binary data inversion **/
#define USART4_CR2_DATAINV		(1 << 18)
...
/** USART4_CR3_IRLP IrDA low-power **/
#define USART4_CR3_IRLP		(1 << 2)
/** USART4_CR3_IREN IrDA mode enable **/
...
#define USART4_BRR_DIV_Mantissa_SHIFT		4
#define USART4_BRR_DIV_Mantissa_MASK		0xfff
/** @defgroup usart4_brr_div_mantissa DIVMantissa mantissa of USARTDIV
@{*/
/**@}*/


#define USART4_BRR_DIV_Fraction_SHIFT		0
#define USART4_BRR_DIV_Fraction_MASK		0x0f
/** @defgroup usart4_brr_div_fraction DIVFraction fraction of USARTDIV
@{*/
/**@}*/
...
/** USART4_ISR_REACK Receive enable acknowledge flag **/
#define USART4_ISR_REACK		(1 << 22)
/** USART4_ISR_TEACK Transmit enable acknowledge flag **/
#define USART4_ISR_TEACK		(1 << 21)
/** USART4_ISR_WUF Wakeup from Stop mode flag **/
#define USART4_ISR_WUF		(1 << 20)
/** USART4_ISR_RWU Receiver wakeup from Mute mode **/
#define USART4_ISR_RWU		(1 << 19)
/** USART4_ISR_SBKF Send break flag **/
#define USART4_ISR_SBKF		(1 << 18)
/** USART4_ISR_CMF character match flag **/
#define USART4_ISR_CMF		(1 << 17)
/** USART4_ISR_BUSY Busy flag **/
#define USART4_ISR_BUSY		(1 << 16)
/** USART4_ISR_ABRF Auto baud rate flag **/
#define USART4_ISR_ABRF		(1 << 15)
/** USART4_ISR_ABRE Auto baud rate error **/
#define USART4_ISR_ABRE		(1 << 14)
/** USART4_ISR_EOBF End of block flag **/
#define USART4_ISR_EOBF		(1 << 12)
/** USART4_ISR_RTOF Receiver timeout **/
#define USART4_ISR_RTOF		(1 << 11)
/** USART4_ISR_CTS CTS flag **/
#define USART4_ISR_CTS		(1 << 10)
/** USART4_ISR_CTSIF CTS interrupt flag **/
#define USART4_ISR_CTSIF		(1 << 9)
/** USART4_ISR_LBDF LIN break detection flag **/
#define USART4_ISR_LBDF		(1 << 8)
/** USART4_ISR_TXE Transmit data register empty **/
#define USART4_ISR_TXE		(1 << 7)
/** USART4_ISR_TC Transmission complete **/
#define USART4_ISR_TC		(1 << 6)
/** USART4_ISR_RXNE Read data register not empty **/
#define USART4_ISR_RXNE		(1 << 5)
/** USART4_ISR_IDLE Idle line detected **/
#define USART4_ISR_IDLE		(1 << 4)
/** USART4_ISR_ORE Overrun error **/
#define USART4_ISR_ORE		(1 << 3)
/** USART4_ISR_NF Noise detected flag **/
#define USART4_ISR_NF		(1 << 2)
/** USART4_ISR_FE Framing error **/
#define USART4_ISR_FE		(1 << 1)
/** USART4_ISR_PE Parity error **/
...
/** USART4_ICR_EOBCF End of timeout clear flag **/
