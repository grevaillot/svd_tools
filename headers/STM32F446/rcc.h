...
/** RCC_CKGATENR clocks gated enable register **/
#define RCC_CKGATENR			MMIO32(RCC_BASE + 0x90)
/** RCC_DCKCFGR2 dedicated clocks configuration register 2 **/
...
/** RCC_APB1RSTR_I2CFMP1RST I2CFMP1 reset **/
#define RCC_APB1RSTR_I2CFMP1RST		(1 << 24)
...
/** RCC_APB1RSTR_SPDIFRST SPDIF-IN reset **/
#define RCC_APB1RSTR_SPDIFRST		(1 << 16)
...
/** RCC_APB1ENR_CEC CEC interface clock enable **/
#define RCC_APB1ENR_CEC		(1 << 27)
...
/** RCC_APB1ENR_I2CFMP1EN I2CFMP1 clock enable **/
#define RCC_APB1ENR_I2CFMP1EN		(1 << 24)
...
/** RCC_APB1ENR_SPDIFEN SPDIF-IN clock enable **/
#define RCC_APB1ENR_SPDIFEN		(1 << 16)
...
/** RCC_APB1LPENR_CECLPEN CEC clock enable during Sleep mode **/
...
/** RCC_APB1LPENR_I2CFMP1LPEN I2CFMP1 clock enable during Sleep mode **/
#define RCC_APB1LPENR_I2CFMP1LPEN		(1 << 24)
...
/** RCC_APB1LPENR_SPDIFLPEN SPDIF clock enable during Sleep mode **/
#define RCC_APB1LPENR_SPDIFLPEN		(1 << 16)
...
/** RCC_APB2LPENR_SAI2LPEN SAI2 clock enable **/
#define RCC_APB2LPENR_SAI2LPEN		(1 << 23)
/** RCC_APB2LPENR_SAI1LPEN SAI1 clock enable **/
...
/** RCC_BDCR_LSEMOD External low-speed oscillator mode **/
...
#define RCC_PLLI2SCFGR_PLLI2SP_MASK		0x03
/** @defgroup rcc_plli2scfgr_plli2sp PLLI2SP PLLI2S division factor for SPDIF-IN clock
@{*/
/**@}*/
...
/** @defgroup rcc_plli2scfgr_plli2sm PLLI2SM Division factor for audio PLL (PLLI2S) input clock
@{*/
/**@}*/
...
/** @defgroup rcc_pllsaicfgr_pllsaiq PLLSAIQ PLLSAI division factor for SAIs clock
@{*/
/**@}*/
...
/** @defgroup rcc_pllsaicfgr_pllsaip PLLSAIP PLLSAI division factor for 48 MHz clock
@{*/
/**@}*/
...
/** @defgroup rcc_pllsaicfgr_pllsaim PLLSAIM Division factor for audio PLLSAI input clock
@{*/
/**@}*/
...
/** @defgroup rcc_dckcfgr DCKCFGR Dedicated Clock Configuration Register
@{*/


#define RCC_DCKCFGR_I2S2SRC_SHIFT		27
#define RCC_DCKCFGR_I2S2SRC_MASK		0x03
/** @defgroup rcc_dckcfgr_i2s2src I2S2SRC I2S APB2 clock source selection
@{*/
/**@}*/
...
/** @defgroup rcc_dckcfgr_i2s1src I2S1SRC I2S APB1 clock source selection
@{*/
/**@}*/
...
#define RCC_DCKCFGR_SAI2SRC_MASK		0x03
/** @defgroup rcc_dckcfgr_sai2src SAI2SRC SAI2 clock source selection
@{*/
/**@}*/


#define RCC_DCKCFGR_SAI1SRC_SHIFT		20
#define RCC_DCKCFGR_SAI1SRC_MASK		0x03
/** @defgroup rcc_dckcfgr_sai1src SAI1SRC SAI1 clock source selection
@{*/
/**@}*/
...
/** @defgroup rcc_dckcfgr_pllsaidivq PLLSAIDIVQ PLLSAI division factor for SAIs clock
@{*/
/**@}*/
...
/** @defgroup rcc_dckcfgr_plli2sdivq PLLI2SDIVQ PLLI2S division factor for SAIs clock
@{*/
/**@}*/
...
/** @defgroup rcc_ckgatenr CKGATENR clocks gated enable register
@{*/
...
/** @defgroup rcc_dckcfgr2 DCKCFGR2 dedicated clocks configuration register 2
@{*/

/** RCC_DCKCFGR2_SPDIFSEL SPDIF clock selection **/
#define RCC_DCKCFGR2_SPDIFSEL		(1 << 29)
/** RCC_DCKCFGR2_SDIOSEL SDIO clock selection **/
#define RCC_DCKCFGR2_SDIOSEL		(1 << 28)
/** RCC_DCKCFGR2_CK48MSEL SDIO/USBFS/HS clock selection **/
#define RCC_DCKCFGR2_CK48MSEL		(1 << 27)
/** RCC_DCKCFGR2_CECSEL HDMI CEC clock source selection **/
#define RCC_DCKCFGR2_CECSEL		(1 << 26)

#define RCC_DCKCFGR2_FMPI2C1SEL_SHIFT		22
#define RCC_DCKCFGR2_FMPI2C1SEL_MASK		0x03
/** @defgroup rcc_dckcfgr2_fmpi2c1sel FMPI2C1SEL I2C4 kernel clock source selection
@{*/
/**@}*/
