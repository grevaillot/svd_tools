...
/** @defgroup rcc_pllcfgr_pllr PLLR Main PLL division factor for DSI clock
@{*/
/**@}*/


#define RCC_PLLCFGR_PLLQ_SHIFT		24
#define RCC_PLLCFGR_PLLQ_MASK		0x0f
/** @defgroup rcc_pllcfgr_pllq PLLQ Main PLL (PLL) division factor for USB OTG FS, SDIO and random number generator clocks
@{*/
/**@}*/
...
/** @defgroup rcc_pllcfgr_pllp PLLP Main PLL (PLL) division factor for main system clock
@{*/
/**@}*/
...
/** @defgroup rcc_pllcfgr_plln PLLN Main PLL (PLL) multiplication factor for VCO
@{*/
/**@}*/
...
/** @defgroup rcc_pllcfgr_pllm PLLM Division factor for the main PLL (PLL) and audio PLL (PLLI2S) input clock
@{*/
/**@}*/
...
/** RCC_AHB3RSTR_QSPIRST QUADSPI memory controller reset **/
...
/** RCC_APB2RSTR_DSIRST DSI host reset **/
...
/** RCC_APB2ENR_DSIEN DSI clocks enable **/
...
/** RCC_APB2LPENR_DSILPEN DSI clocks enable during Sleep mode **/
#define RCC_APB2LPENR_DSILPEN		(1 << 27)
/** RCC_APB2LPENR_LTDCLPEN LTDC clock enable **/
...
/** @defgroup rcc_pllsaicfgr_pllsaiq PLLSAIQ PLLSAI division factor for SAI1 clock
@{*/
/**@}*/
...
/** RCC_DCKCFGR_SDMMCSEL SDIO clock source selection **/
#define RCC_DCKCFGR_SDMMCSEL		(1 << 28)
/** RCC_DCKCFGR_MSEL 48 MHz clock source selection **/
#define RCC_DCKCFGR_MSEL		(1 << 27)
/** RCC_DCKCFGR_TIMPRE Timers clocks prescalers selection **/
#define RCC_DCKCFGR_TIMPRE		(1 << 24)

#define RCC_DCKCFGR_SAI1BSRC_SHIFT		22
#define RCC_DCKCFGR_SAI1BSRC_MASK		0x03
/** @defgroup rcc_dckcfgr_sai1bsrc SAI1BSRC SAI1-B clock source selection
@{*/
/**@}*/


#define RCC_DCKCFGR_SAI1ASRC_SHIFT		20
#define RCC_DCKCFGR_SAI1ASRC_MASK		0x03
/** @defgroup rcc_dckcfgr_sai1asrc SAI1ASRC SAI1 clock source selection
@{*/
/**@}*/


#define RCC_DCKCFGR_PLLSAIDIVR_SHIFT		16
#define RCC_DCKCFGR_PLLSAIDIVR_MASK		0x03
/** @defgroup rcc_dckcfgr_pllsaidivr PLLSAIDIVR PLLSAIDIVR
@{*/
/**@}*/
...
#define RCC_DCKCFGR_PLLIS2DIVQ_SHIFT		0
#define RCC_DCKCFGR_PLLIS2DIVQ_MASK		0x1f
/** @defgroup rcc_dckcfgr_pllis2divq PLLIS2DIVQ PLLI2S division factor for SAIs clock
@{*/
/**@}*/
