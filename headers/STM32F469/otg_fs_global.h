...
/** OTG_FS_GLOBAL_FS_GRXSTSR_Host OTG_FS Receive status debug read(Hostmode) **/
...
/** OTG_FS_GLOBAL_FS_DIEPTXF1 OTG_FS device IN endpoint transmit FIFO size register (OTG_FS_DIEPTXF1) **/
#define OTG_FS_GLOBAL_FS_DIEPTXF1			MMIO32(OTG_FS_GLOBAL_BASE + 0x104)
/** OTG_FS_GLOBAL_FS_DIEPTXF2 OTG_FS device IN endpoint transmit FIFO size register (OTG_FS_DIEPTXF2) **/
#define OTG_FS_GLOBAL_FS_DIEPTXF2			MMIO32(OTG_FS_GLOBAL_BASE + 0x108)
/** OTG_FS_GLOBAL_FS_DIEPTXF3 OTG_FS device IN endpoint transmit FIFO size register (OTG_FS_DIEPTXF3) **/
#define OTG_FS_GLOBAL_FS_DIEPTXF3			MMIO32(OTG_FS_GLOBAL_BASE + 0x10c)
/** OTG_FS_GLOBAL_FS_DIEPTXF4 OTG_FS device IN endpoint transmit FIFO size register (OTG_FS_DIEPTXF4) **/
#define OTG_FS_GLOBAL_FS_DIEPTXF4			MMIO32(OTG_FS_GLOBAL_BASE + 0x110)
/** OTG_FS_GLOBAL_FS_DIEPTXF5 OTG_FS device IN endpoint transmit FIFO size register (OTG_FS_DIEPTXF5) **/
#define OTG_FS_GLOBAL_FS_DIEPTXF5			MMIO32(OTG_FS_GLOBAL_BASE + 0x114)
...
/** @defgroup otg_fs_global_fs_grxstsr_host FSGRXSTSRHost OTG_FS Receive status debug read(Hostmode)
@{*/
...
/** OTG_FS_GLOBAL_FS_GCCFG_SOFOUTEN SOF output enable **/
#define OTG_FS_GLOBAL_FS_GCCFG_SOFOUTEN		(1 << 20)
/** OTG_FS_GLOBAL_FS_GCCFG_VBUSBSEN Enable the VBUS sensing device **/
#define OTG_FS_GLOBAL_FS_GCCFG_VBUSBSEN		(1 << 19)
/** OTG_FS_GLOBAL_FS_GCCFG_VBUSASEN Enable the VBUS sensing device **/
#define OTG_FS_GLOBAL_FS_GCCFG_VBUSASEN		(1 << 18)
/** OTG_FS_GLOBAL_FS_GCCFG_PWRDWN Power down **/
...
/** @defgroup otg_fs_global_fs_dieptxf1 FSDIEPTXF1 OTG_FS device IN endpoint transmit FIFO size register (OTG_FS_DIEPTXF1)
@{*/
...
/** @defgroup otg_fs_global_fs_dieptxf2 FSDIEPTXF2 OTG_FS device IN endpoint transmit FIFO size register (OTG_FS_DIEPTXF2)
@{*/
...
/** @defgroup otg_fs_global_fs_dieptxf3 FSDIEPTXF3 OTG_FS device IN endpoint transmit FIFO size register (OTG_FS_DIEPTXF3)
@{*/
...
/** @defgroup otg_fs_global_fs_dieptxf4 FSDIEPTXF4 OTG_FS device IN endpoint transmit FIFO size register (OTG_FS_DIEPTXF4)
@{*/


/**@}*/

/** @defgroup otg_fs_global_fs_dieptxf5 FSDIEPTXF5 OTG_FS device IN endpoint transmit FIFO size register (OTG_FS_DIEPTXF5)
@{*/
