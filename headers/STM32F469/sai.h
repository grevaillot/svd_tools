...
#define SAI_GCR			MMIO32(SAI_BASE + 0x00)
...
/** @defgroup sai_gcr GCR Global configuration register
@{*/


#define SAI_GCR_SYNCOUT_SHIFT		0
#define SAI_GCR_SYNCOUT_MASK		0x03
/** @defgroup sai_gcr_syncout SYNCOUT Synchronization outputs
@{*/
/**@}*/
...
#define SAI_ACR1_MCJDIV_MASK		0x0f
...
#define SAI_BCR1_MCJDIV_MASK		0x0f
