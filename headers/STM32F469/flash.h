...
/** FLASH_SR_RDERR Proprietary readout protection (PCROP) error **/
...
/** FLASH_OPTCR_SPRMOD Selection of protection mode for nWPRi bits **/
#define FLASH_OPTCR_SPRMOD		(1 << 31)
/** FLASH_OPTCR_DB1M Dual-bank on 1 Mbyte Flash memory devices **/
...
/** FLASH_OPTCR_BFB2 Dual-bank Boot option byte **/
...
#define FLASH_OPTCR1_nWRP_SHIFT		16
#define FLASH_OPTCR1_nWRP_MASK		0xfff
/** @defgroup flash_optcr1_nwrp nWRP Not write protect
@{*/
/**@}*/
