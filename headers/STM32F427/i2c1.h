...
/** I2C1_FLTR I2C FLTR register **/
#define I2C1_FLTR			MMIO32(I2C1_BASE + 0x24)
...
/** @defgroup i2c1_fltr FLTR I2C FLTR register
@{*/

/** I2C1_FLTR_ANOFF Analog noise filter OFF **/
#define I2C1_FLTR_ANOFF		(1 << 4)

#define I2C1_FLTR_DNF_SHIFT		0
#define I2C1_FLTR_DNF_MASK		0x0f
/** @defgroup i2c1_fltr_dnf DNF Digital noise filter
@{*/
/**@}*/
