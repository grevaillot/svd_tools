...
#define CRC_POL_Polynomialcoefficients_SHIFT		0
#define CRC_POL_Polynomialcoefficients_MASK		0xffffffff
/** @defgroup crc_pol_polynomialcoefficients Polynomialcoefficients Programmable polynomial
@{*/
/**@}*/
