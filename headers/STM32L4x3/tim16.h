...
#define TIM16_DCR			MMIO32(TIM16_BASE + 0x48)
/** TIM16_DMAR DMA address for full transfer **/
#define TIM16_DMAR			MMIO32(TIM16_BASE + 0x4c)
/** TIM16_OR1 TIM16 option register 1 **/
#define TIM16_OR1			MMIO32(TIM16_BASE + 0x50)
/** TIM16_OR2 TIM17 option register 1 **/
#define TIM16_OR2			MMIO32(TIM16_BASE + 0x60)
...
/** TIM16_DIER_TDE Trigger DMA request enable **/
#define TIM16_DIER_TDE		(1 << 14)
...
/** TIM16_DIER_TIE Trigger interrupt enable **/
#define TIM16_DIER_TIE		(1 << 6)
...
/** TIM16_SR_TIF Trigger interrupt flag **/
#define TIM16_SR_TIF		(1 << 6)
...
/** TIM16_EGR_TG Trigger generation **/
#define TIM16_EGR_TG		(1 << 6)
...
/** TIM16_CCMR1_Output_OC1M_2 Output Compare 1 mode **/
#define TIM16_CCMR1_Output_OC1M_2		(1 << 16)
...
#define TIM16_DMAR_DMAB_MASK		0xffff
...
/** @defgroup tim16_or1 OR1 TIM16 option register 1
@{*/


#define TIM16_OR1_TI1_RMP_SHIFT		0
#define TIM16_OR1_TI1_RMP_MASK		0x03
/** @defgroup tim16_or1_ti1_rmp TI1RMP Input capture 1 remap
@{*/
/**@}*/
...
/** @defgroup tim16_or2 OR2 TIM17 option register 1
@{*/

/** TIM16_OR2_BKCMP2P BRK COMP2 input polarit **/
#define TIM16_OR2_BKCMP2P		(1 << 11)
/** TIM16_OR2_BKCMP1P BRK COMP1 input polarity **/
#define TIM16_OR2_BKCMP1P		(1 << 10)
/** TIM16_OR2_BKINP BRK BKIN input polarity **/
#define TIM16_OR2_BKINP		(1 << 9)
/** TIM16_OR2_BKDFBK1E BRK DFSDM_BREAK1 enable **/
#define TIM16_OR2_BKDFBK1E		(1 << 8)
/** TIM16_OR2_BKCMP2E BRK COMP2 enable **/
#define TIM16_OR2_BKCMP2E		(1 << 2)
/** TIM16_OR2_BKCMP1E BRK COMP1 enable **/
#define TIM16_OR2_BKCMP1E		(1 << 1)
/** TIM16_OR2_BKINE BRK BKIN input enable **/
#define TIM16_OR2_BKINE		(1 << 0)
