...
/** TIM1_OR1 DMA address for full transfer **/
...
/** TIM1_OR2 DMA address for full transfer **/
#define TIM1_OR2			MMIO32(TIM1_BASE + 0x60)
/** TIM1_OR3 DMA address for full transfer **/
#define TIM1_OR3			MMIO32(TIM1_BASE + 0x64)
...
/** @defgroup tim1_or1 OR1 DMA address for full transfer
@{*/

/** TIM1_OR1_TI1_RMP Input Capture 1 remap **/
#define TIM1_OR1_TI1_RMP		(1 << 4)

#define TIM1_OR1_ETR_ADC3_RMP_SHIFT		2
#define TIM1_OR1_ETR_ADC3_RMP_MASK		0x03
/** @defgroup tim1_or1_etr_adc3_rmp ETRADC3RMP External trigger remap on ADC3 analog watchdog
@{*/
/**@}*/


#define TIM1_OR1_ETR_ADC1_RMP_SHIFT		0
#define TIM1_OR1_ETR_ADC1_RMP_MASK		0x03
/** @defgroup tim1_or1_etr_adc1_rmp ETRADC1RMP External trigger remap on ADC1 analog watchdog
@{*/
/**@}*/
...
/** @defgroup tim1_or2 OR2 DMA address for full transfer
@{*/


#define TIM1_OR2_ETRSEL_SHIFT		14
#define TIM1_OR2_ETRSEL_MASK		0x07
/** @defgroup tim1_or2_etrsel ETRSEL ETR source selection
@{*/
/**@}*/

/** TIM1_OR2_BKCMP2P BRK COMP2 input polarity **/
#define TIM1_OR2_BKCMP2P		(1 << 11)
/** TIM1_OR2_BKCMP1P BRK COMP1 input polarity **/
#define TIM1_OR2_BKCMP1P		(1 << 10)
/** TIM1_OR2_BKINP BRK BKIN input polarity **/
#define TIM1_OR2_BKINP		(1 << 9)
/** TIM1_OR2_BKDFBK0E BRK DFSDM_BREAK0 enable **/
#define TIM1_OR2_BKDFBK0E		(1 << 8)
/** TIM1_OR2_BKCMP2E BRK COMP2 enable **/
#define TIM1_OR2_BKCMP2E		(1 << 2)
/** TIM1_OR2_BKCMP1E BRK COMP1 enable **/
#define TIM1_OR2_BKCMP1E		(1 << 1)
/** TIM1_OR2_BKINE BRK BKIN input enable **/
#define TIM1_OR2_BKINE		(1 << 0)

/**@}*/

/** @defgroup tim1_or3 OR3 DMA address for full transfer
@{*/

/** TIM1_OR3_BK2CMP2P BRK2 COMP2 input polarity **/
#define TIM1_OR3_BK2CMP2P		(1 << 11)
/** TIM1_OR3_BK2CMP1P BRK2 COMP1 input polarity **/
#define TIM1_OR3_BK2CMP1P		(1 << 10)
/** TIM1_OR3_BK2INP BRK2 BKIN input polarity **/
#define TIM1_OR3_BK2INP		(1 << 9)
/** TIM1_OR3_BK2DFBK0E BRK2 DFSDM_BREAK0 enable **/
#define TIM1_OR3_BK2DFBK0E		(1 << 8)
/** TIM1_OR3_BK2CMP2E BRK2 COMP2 enable **/
#define TIM1_OR3_BK2CMP2E		(1 << 2)
/** TIM1_OR3_BK2CMP1E BRK2 COMP1 enable **/
#define TIM1_OR3_BK2CMP1E		(1 << 1)
/** TIM1_OR3_BK2INE BRK2 BKIN input enable **/
#define TIM1_OR3_BK2INE		(1 << 0)
