...
/** UART4_CR1_RXFFIE RXFIFO Full interrupt enable **/
#define UART4_CR1_RXFFIE		(1 << 31)
/** UART4_CR1_TXFEIE TXFIFO empty interrupt enable **/
#define UART4_CR1_TXFEIE		(1 << 30)
/** UART4_CR1_FIFOEN FIFO mode enable **/
#define UART4_CR1_FIFOEN		(1 << 29)
/** UART4_CR1_M1 Word length **/
...
/** UART4_CR2_DIS_NSS When the DSI_NSS bit is set, the NSS pin input is ignored **/
#define UART4_CR2_DIS_NSS		(1 << 3)
/** UART4_CR2_SLVEN Synchronous Slave mode enable **/
...
/** @defgroup uart4_cr3_txftcfg TXFTCFG TXFIFO threshold configuration
@{*/
/**@}*/

/** UART4_CR3_RXFTIE RXFIFO threshold interrupt enable **/
#define UART4_CR3_RXFTIE		(1 << 28)

#define UART4_CR3_RXFTCFG_SHIFT		25
#define UART4_CR3_RXFTCFG_MASK		0x07
/** @defgroup uart4_cr3_rxftcfg RXFTCFG Receive FIFO threshold configuration
@{*/
/**@}*/

/** UART4_CR3_TCBGTIE Transmission Complete before guard time, interrupt enable **/
#define UART4_CR3_TCBGTIE		(1 << 24)
/** UART4_CR3_TXFTIE TXFIFO threshold interrupt enable **/
...
#define UART4_BRR_BRR_4_15_SHIFT		4
#define UART4_BRR_BRR_4_15_MASK		0xfff
/** @defgroup uart4_brr_brr_4_15 BRR415 DIV_Mantissa
@{*/
/**@}*/


#define UART4_BRR_BRR_0_3_SHIFT		0
#define UART4_BRR_BRR_0_3_MASK		0x0f
/** @defgroup uart4_brr_brr_0_3 BRR03 DIV_Fraction
@{*/
/**@}*/
...
/** UART4_ISR_TXFT TXFIFO threshold flag **/
#define UART4_ISR_TXFT		(1 << 27)
/** UART4_ISR_RXFT RXFIFO threshold flag **/
#define UART4_ISR_RXFT		(1 << 26)
/** UART4_ISR_TCBGT Transmission complete before guard time flag **/
#define UART4_ISR_TCBGT		(1 << 25)
/** UART4_ISR_RXFF RXFIFO Full **/
#define UART4_ISR_RXFF		(1 << 24)
/** UART4_ISR_TXFE TXFIFO Empty **/
...
/** UART4_ISR_UDR SPI slave underrun error flag **/
...
/** UART4_ICR_UDRCF SPI slave underrun clear flag **/
...
/** UART4_ICR_TCBGTC Transmission complete before Guard time clear flag **/
#define UART4_ICR_TCBGTC		(1 << 7)
/** UART4_ICR_TCCF Transmission complete clear flag **/
#define UART4_ICR_TCCF		(1 << 6)
/** UART4_ICR_TXFECF TXFIFO empty clear flag **/
...
/** @defgroup uart4_presc_prescaler PRESCALER Clock prescaler
@{*/
/**@}*/
