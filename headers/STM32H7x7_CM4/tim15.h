...
/** TIM15_AF1 TIM15 alternate fdfsdm1_breakon register 1 **/
#define TIM15_AF1			MMIO32(TIM15_BASE + 0x60)
/** TIM15_TISEL TIM15 input selection register **/
#define TIM15_TISEL			MMIO32(TIM15_BASE + 0x68)
...
/** TIM15_CR2_OIS2 Output Idle state 2 **/
...
#define TIM15_SMCR_TS_2_0_SHIFT		4
#define TIM15_SMCR_TS_2_0_MASK		0x07
/** @defgroup tim15_smcr_ts_2_0 TS20 Trigger selection
@{*/
/**@}*/
...
/** TIM15_CCMR1_Output_OC1M_3 Output Compare 1 mode bit 3 **/
#define TIM15_CCMR1_Output_OC1M_3		(1 << 16)

#define TIM15_CCMR1_Output_OC2M_SHIFT		12
#define TIM15_CCMR1_Output_OC2M_MASK		0x07
/** @defgroup tim15_ccmr1_output_oc2m OC2M Output Compare 2 mode
@{*/
/**@}*/

/** TIM15_CCMR1_Output_OC2PE Output Compare 2 preload enable **/
#define TIM15_CCMR1_Output_OC2PE		(1 << 11)
/** TIM15_CCMR1_Output_OC2FE Output Compare 2 fast enable **/
#define TIM15_CCMR1_Output_OC2FE		(1 << 10)

#define TIM15_CCMR1_Output_CC2S_SHIFT		8
#define TIM15_CCMR1_Output_CC2S_MASK		0x03
/** @defgroup tim15_ccmr1_output_cc2s CC2S Capture/Compare 2 selection
@{*/
/**@}*/
...
/** @defgroup tim15_ccmr1_input_ic2f IC2F Input capture 2 filter
@{*/
/**@}*/
...
/** @defgroup tim15_ccmr1_input_ic2psc IC2PSC Input capture 2 prescaler
@{*/
/**@}*/
...
/** @defgroup tim15_ccmr1_input_cc2s CC2S Capture/Compare 2 selection
@{*/
/**@}*/
...
/** TIM15_CCER_CC2NP Capture/Compare 2 output Polarity **/
...
/** @defgroup tim15_ccr2_ccr2 CCR2 Capture/Compare 2 value
@{*/
/**@}*/
...
/** @defgroup tim15_af1 AF1 TIM15 alternate fdfsdm1_breakon register 1
@{*/
...
/** TIM15_AF1_BKDF1BK0E BRK dfsdm1_break[0] enable **/
#define TIM15_AF1_BKDF1BK0E		(1 << 8)
...
/** @defgroup tim15_tisel TISEL TIM15 input selection register
@{*/


#define TIM15_TISEL_TI2SEL_SHIFT		8
#define TIM15_TISEL_TI2SEL_MASK		0x0f
/** @defgroup tim15_tisel_ti2sel TI2SEL selects TI2[0] to TI2[15] input
@{*/
/**@}*/
...
/** @defgroup tim15_tisel_ti1sel TI1SEL selects TI1[0] to TI1[15] input
@{*/
/**@}*/
