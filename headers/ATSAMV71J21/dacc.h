...
/** DACC_DACC_VERSION Version Register **/
#define DACC_DACC_VERSION			MMIO32(DACC_BASE + 0xfc)
...
/** @defgroup dacc_dacc_version DACCVERSION Version Register
@{*/


#define DACC_DACC_VERSION_MFN_SHIFT		16
#define DACC_DACC_VERSION_MFN_MASK		0x07
/** @defgroup dacc_dacc_version_mfn MFN Metal Fix Number
@{*/
/**@}*/


#define DACC_DACC_VERSION_VERSION_SHIFT		0
#define DACC_DACC_VERSION_VERSION_MASK		0xfff
/** @defgroup dacc_dacc_version_version VERSION Version
@{*/
/**@}*/
