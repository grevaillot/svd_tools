...
/** TC2_TC_VER Version Register **/
#define TC2_TC_VER			MMIO32(TC2_BASE + 0xfc)
...
/** @defgroup tc2_tc_ver TCVER Version Register
@{*/


#define TC2_TC_VER_MFN_SHIFT		16
#define TC2_TC_VER_MFN_MASK		0x07
/** @defgroup tc2_tc_ver_mfn MFN Metal Fix Number
@{*/
/**@}*/


#define TC2_TC_VER_VERSION_SHIFT		0
#define TC2_TC_VER_VERSION_MASK		0xfff
/** @defgroup tc2_tc_ver_version VERSION Version of the Hardware Module
@{*/
/**@}*/
