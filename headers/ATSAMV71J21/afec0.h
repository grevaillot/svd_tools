...
/** AFEC0_AFEC_VERSION AFEC Version Register **/
#define AFEC0_AFEC_VERSION			MMIO32(AFEC0_BASE + 0xfc)
...
/** @defgroup afec0_afec_mr_startup STARTUP Startup Time
@{*/
/**@}*/
...
/** AFEC0_AFEC_MR_FWUP Fast Wakeup **/
...
/** @defgroup afec0_afec_version AFECVERSION AFEC Version Register
@{*/


#define AFEC0_AFEC_VERSION_MFN_SHIFT		16
#define AFEC0_AFEC_VERSION_MFN_MASK		0x07
/** @defgroup afec0_afec_version_mfn MFN Metal Fix Number
@{*/
/**@}*/


#define AFEC0_AFEC_VERSION_VERSION_SHIFT		0
#define AFEC0_AFEC_VERSION_VERSION_MASK		0xfff
/** @defgroup afec0_afec_version_version VERSION Version of the Hardware Module
@{*/
/**@}*/
