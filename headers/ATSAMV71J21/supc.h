...
/** SUPC_SUPC_WUMR Supply Controller Wakeup Mode Register **/
#define SUPC_SUPC_WUMR			MMIO32(SUPC_BASE + 0x0c)
/** SUPC_SUPC_WUIR Supply Controller Wakeup Inputs Register **/
...
/** SUPC_SYSC_VERSION Version Register **/
#define SUPC_SYSC_VERSION			MMIO32(SUPC_BASE + 0xfc)
...
/** @defgroup supc_supc_wumr SUPCWUMR Supply Controller Wakeup Mode Register
@{*/
...
/** @defgroup supc_supc_wumr_wkupdbc WKUPDBC Wakeup Inputs Debouncer Period
@{*/
/**@}*/
...
/** SUPC_SUPC_WUMR_RTCEN Real-time Clock Wakeup Enable **/
#define SUPC_SUPC_WUMR_RTCEN		(1 << 3)
/** SUPC_SUPC_WUMR_RTTEN Real-time Timer Wakeup Enable **/
#define SUPC_SUPC_WUMR_RTTEN		(1 << 2)
/** SUPC_SUPC_WUMR_SMEN Supply Monitor Wakeup Enable **/
#define SUPC_SUPC_WUMR_SMEN		(1 << 1)

/**@}*/

/** @defgroup supc_supc_wuir SUPCWUIR Supply Controller Wakeup Inputs Register
@{*/

/** SUPC_SUPC_WUIR_WKUPT13 Wakeup Input Type 0 to 13 **/
#define SUPC_SUPC_WUIR_WKUPT13		(1 << 29)
/** SUPC_SUPC_WUIR_WKUPT12 Wakeup Input Type 0 to 12 **/
#define SUPC_SUPC_WUIR_WKUPT12		(1 << 28)
/** SUPC_SUPC_WUIR_WKUPT11 Wakeup Input Type 0 to 11 **/
#define SUPC_SUPC_WUIR_WKUPT11		(1 << 27)
/** SUPC_SUPC_WUIR_WKUPT10 Wakeup Input Type 0 to 10 **/
#define SUPC_SUPC_WUIR_WKUPT10		(1 << 26)
/** SUPC_SUPC_WUIR_WKUPT9 Wakeup Input Type 0 to 9 **/
#define SUPC_SUPC_WUIR_WKUPT9		(1 << 25)
/** SUPC_SUPC_WUIR_WKUPT8 Wakeup Input Type 0 to 8 **/
#define SUPC_SUPC_WUIR_WKUPT8		(1 << 24)
/** SUPC_SUPC_WUIR_WKUPT7 Wakeup Input Type 0 to 7 **/
#define SUPC_SUPC_WUIR_WKUPT7		(1 << 23)
/** SUPC_SUPC_WUIR_WKUPT6 Wakeup Input Type 0 to 6 **/
#define SUPC_SUPC_WUIR_WKUPT6		(1 << 22)
/** SUPC_SUPC_WUIR_WKUPT5 Wakeup Input Type 0 to 5 **/
#define SUPC_SUPC_WUIR_WKUPT5		(1 << 21)
/** SUPC_SUPC_WUIR_WKUPT4 Wakeup Input Type 0 to 4 **/
#define SUPC_SUPC_WUIR_WKUPT4		(1 << 20)
/** SUPC_SUPC_WUIR_WKUPT3 Wakeup Input Type 0 to 3 **/
#define SUPC_SUPC_WUIR_WKUPT3		(1 << 19)
/** SUPC_SUPC_WUIR_WKUPT2 Wakeup Input Type 0 to 2 **/
#define SUPC_SUPC_WUIR_WKUPT2		(1 << 18)
/** SUPC_SUPC_WUIR_WKUPT1 Wakeup Input Type 0 to 1 **/
#define SUPC_SUPC_WUIR_WKUPT1		(1 << 17)
/** SUPC_SUPC_WUIR_WKUPT0 Wakeup Input Type 0 to 0 **/
#define SUPC_SUPC_WUIR_WKUPT0		(1 << 16)
/** SUPC_SUPC_WUIR_WKUPEN13 Wakeup Input Enable 0 to 13 **/
#define SUPC_SUPC_WUIR_WKUPEN13		(1 << 13)
/** SUPC_SUPC_WUIR_WKUPEN12 Wakeup Input Enable 0 to 12 **/
#define SUPC_SUPC_WUIR_WKUPEN12		(1 << 12)
/** SUPC_SUPC_WUIR_WKUPEN11 Wakeup Input Enable 0 to 11 **/
#define SUPC_SUPC_WUIR_WKUPEN11		(1 << 11)
/** SUPC_SUPC_WUIR_WKUPEN10 Wakeup Input Enable 0 to 10 **/
#define SUPC_SUPC_WUIR_WKUPEN10		(1 << 10)
/** SUPC_SUPC_WUIR_WKUPEN9 Wakeup Input Enable 0 to 9 **/
#define SUPC_SUPC_WUIR_WKUPEN9		(1 << 9)
/** SUPC_SUPC_WUIR_WKUPEN8 Wakeup Input Enable 0 to 8 **/
#define SUPC_SUPC_WUIR_WKUPEN8		(1 << 8)
/** SUPC_SUPC_WUIR_WKUPEN7 Wakeup Input Enable 0 to 7 **/
#define SUPC_SUPC_WUIR_WKUPEN7		(1 << 7)
/** SUPC_SUPC_WUIR_WKUPEN6 Wakeup Input Enable 0 to 6 **/
#define SUPC_SUPC_WUIR_WKUPEN6		(1 << 6)
/** SUPC_SUPC_WUIR_WKUPEN5 Wakeup Input Enable 0 to 5 **/
#define SUPC_SUPC_WUIR_WKUPEN5		(1 << 5)
/** SUPC_SUPC_WUIR_WKUPEN4 Wakeup Input Enable 0 to 4 **/
#define SUPC_SUPC_WUIR_WKUPEN4		(1 << 4)
/** SUPC_SUPC_WUIR_WKUPEN3 Wakeup Input Enable 0 to 3 **/
#define SUPC_SUPC_WUIR_WKUPEN3		(1 << 3)
/** SUPC_SUPC_WUIR_WKUPEN2 Wakeup Input Enable 0 to 2 **/
#define SUPC_SUPC_WUIR_WKUPEN2		(1 << 2)
/** SUPC_SUPC_WUIR_WKUPEN1 Wakeup Input Enable 0 to 1 **/
#define SUPC_SUPC_WUIR_WKUPEN1		(1 << 1)
/** SUPC_SUPC_WUIR_WKUPEN0 Wakeup Input Enable 0 to 0 **/
...
/** SUPC_SUPC_SR_LPDBCS1 Low-power Debouncer Wakeup Status on WKUP1 (cleared on read) **/
#define SUPC_SUPC_SR_LPDBCS1		(1 << 14)
/** SUPC_SUPC_SR_LPDBCS0 Low-power Debouncer Wakeup Status on WKUP0 (cleared on read) **/
...
/** SUPC_SUPC_SR_SMWS Supply Monitor Detection Wakeup Status (cleared on read) **/
#define SUPC_SUPC_SR_SMWS		(1 << 2)
/** SUPC_SUPC_SR_WKUPS WKUP Wakeup Status (cleared on read) **/
#define SUPC_SUPC_SR_WKUPS		(1 << 1)

/**@}*/

/** @defgroup supc_sysc_version SYSCVERSION Version Register
@{*/


#define SUPC_SYSC_VERSION_MFN_SHIFT		16
#define SUPC_SYSC_VERSION_MFN_MASK		0x07
/** @defgroup supc_sysc_version_mfn MFN Metal Fix Number
@{*/
/**@}*/


#define SUPC_SYSC_VERSION_VERSION_SHIFT		0
#define SUPC_SYSC_VERSION_VERSION_MASK		0xfff
/** @defgroup supc_sysc_version_version VERSION Version of the Hardware Module
@{*/
/**@}*/
