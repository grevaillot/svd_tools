...
/** EFC_EEFC_VERSION EEFC Version Register **/
#define EFC_EEFC_VERSION			MMIO32(EFC_BASE + 0x14)
...
/** @defgroup efc_eefc_version EEFCVERSION EEFC Version Register
@{*/


#define EFC_EEFC_VERSION_MFN_SHIFT		16
#define EFC_EEFC_VERSION_MFN_MASK		0x07
/** @defgroup efc_eefc_version_mfn MFN Metal Fix Number
@{*/
/**@}*/


#define EFC_EEFC_VERSION_VERSION_SHIFT		0
#define EFC_EEFC_VERSION_VERSION_MASK		0xfff
/** @defgroup efc_eefc_version_version VERSION Version of the Hardware Module
@{*/
/**@}*/
