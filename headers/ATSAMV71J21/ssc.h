...
/** SSC_SSC_VERSION Version Register **/
#define SSC_SSC_VERSION			MMIO32(SSC_BASE + 0xfc)
...
/** @defgroup ssc_ssc_version SSCVERSION Version Register
@{*/


#define SSC_SSC_VERSION_MFN_SHIFT		16
#define SSC_SSC_VERSION_MFN_MASK		0x07
/** @defgroup ssc_ssc_version_mfn MFN Metal Fix Number
@{*/
/**@}*/


#define SSC_SSC_VERSION_VERSION_SHIFT		0
#define SSC_SSC_VERSION_VERSION_MASK		0xffff
/** @defgroup ssc_ssc_version_version VERSION Version of the Hardware Module
@{*/
/**@}*/
