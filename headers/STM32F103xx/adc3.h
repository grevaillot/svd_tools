...
/** ADC3_CR2_TSVREFE Temperature sensor and VREFINT enable **/
#define ADC3_CR2_TSVREFE		(1 << 23)
/** ADC3_CR2_SWSTART Start conversion of regular channels **/
#define ADC3_CR2_SWSTART		(1 << 22)
/** ADC3_CR2_JSWSTART Start conversion of injected channels **/
#define ADC3_CR2_JSWSTART		(1 << 21)
/** ADC3_CR2_EXTTRIG External trigger conversion mode for regular channels **/
#define ADC3_CR2_EXTTRIG		(1 << 20)

#define ADC3_CR2_EXTSEL_SHIFT		17
#define ADC3_CR2_EXTSEL_MASK		0x07
/** @defgroup adc3_cr2_extsel EXTSEL External event select for regular group
@{*/
/**@}*/

/** ADC3_CR2_JEXTTRIG External trigger conversion mode for injected channels **/
#define ADC3_CR2_JEXTTRIG		(1 << 15)

#define ADC3_CR2_JEXTSEL_SHIFT		12
#define ADC3_CR2_JEXTSEL_MASK		0x07
...
/** ADC3_CR2_DMA Direct memory access mode **/
#define ADC3_CR2_DMA		(1 << 8)
/** ADC3_CR2_RSTCAL Reset calibration **/
#define ADC3_CR2_RSTCAL		(1 << 3)
/** ADC3_CR2_CAL A/D calibration **/
#define ADC3_CR2_CAL		(1 << 2)
...
#define ADC3_SMPR1_SMP17_SHIFT		21
#define ADC3_SMPR1_SMP17_MASK		0x07
/** @defgroup adc3_smpr1_smp17 SMP17 Channel 17 sample time selection
@{*/
/**@}*/


#define ADC3_SMPR1_SMP16_SHIFT		18
#define ADC3_SMPR1_SMP16_MASK		0x07
/** @defgroup adc3_smpr1_smp16 SMP16 Channel 16 sample time selection
@{*/
/**@}*/


#define ADC3_SMPR1_SMP15_SHIFT		15
#define ADC3_SMPR1_SMP15_MASK		0x07
/** @defgroup adc3_smpr1_smp15 SMP15 Channel 15 sample time selection
@{*/
/**@}*/


#define ADC3_SMPR1_SMP14_SHIFT		12
#define ADC3_SMPR1_SMP14_MASK		0x07
/** @defgroup adc3_smpr1_smp14 SMP14 Channel 14 sample time selection
@{*/
/**@}*/


#define ADC3_SMPR1_SMP13_SHIFT		9
#define ADC3_SMPR1_SMP13_MASK		0x07
/** @defgroup adc3_smpr1_smp13 SMP13 Channel 13 sample time selection
@{*/
/**@}*/


#define ADC3_SMPR1_SMP12_SHIFT		6
#define ADC3_SMPR1_SMP12_MASK		0x07
/** @defgroup adc3_smpr1_smp12 SMP12 Channel 12 sample time selection
@{*/
/**@}*/


#define ADC3_SMPR1_SMP11_SHIFT		3
#define ADC3_SMPR1_SMP11_MASK		0x07
/** @defgroup adc3_smpr1_smp11 SMP11 Channel 11 sample time selection
@{*/
/**@}*/


#define ADC3_SMPR1_SMP10_SHIFT		0
#define ADC3_SMPR1_SMP10_MASK		0x07
/** @defgroup adc3_smpr1_smp10 SMP10 Channel 10 sample time selection
@{*/
/**@}*/
...
#define ADC3_SMPR2_SMP9_SHIFT		27
#define ADC3_SMPR2_SMP9_MASK		0x07
/** @defgroup adc3_smpr2_smp9 SMP9 Channel 9 sample time selection
@{*/
/**@}*/


#define ADC3_SMPR2_SMP8_SHIFT		24
#define ADC3_SMPR2_SMP8_MASK		0x07
/** @defgroup adc3_smpr2_smp8 SMP8 Channel 8 sample time selection
@{*/
/**@}*/


#define ADC3_SMPR2_SMP7_SHIFT		21
#define ADC3_SMPR2_SMP7_MASK		0x07
/** @defgroup adc3_smpr2_smp7 SMP7 Channel 7 sample time selection
@{*/
/**@}*/


#define ADC3_SMPR2_SMP6_SHIFT		18
#define ADC3_SMPR2_SMP6_MASK		0x07
/** @defgroup adc3_smpr2_smp6 SMP6 Channel 6 sample time selection
@{*/
/**@}*/


#define ADC3_SMPR2_SMP5_SHIFT		15
#define ADC3_SMPR2_SMP5_MASK		0x07
/** @defgroup adc3_smpr2_smp5 SMP5 Channel 5 sample time selection
@{*/
/**@}*/


#define ADC3_SMPR2_SMP4_SHIFT		12
#define ADC3_SMPR2_SMP4_MASK		0x07
/** @defgroup adc3_smpr2_smp4 SMP4 Channel 4 sample time selection
@{*/
/**@}*/


#define ADC3_SMPR2_SMP3_SHIFT		9
#define ADC3_SMPR2_SMP3_MASK		0x07
/** @defgroup adc3_smpr2_smp3 SMP3 Channel 3 sample time selection
@{*/
/**@}*/


#define ADC3_SMPR2_SMP2_SHIFT		6
#define ADC3_SMPR2_SMP2_MASK		0x07
/** @defgroup adc3_smpr2_smp2 SMP2 Channel 2 sample time selection
@{*/
/**@}*/


#define ADC3_SMPR2_SMP1_SHIFT		3
#define ADC3_SMPR2_SMP1_MASK		0x07
/** @defgroup adc3_smpr2_smp1 SMP1 Channel 1 sample time selection
@{*/
/**@}*/


#define ADC3_SMPR2_SMP0_SHIFT		0
#define ADC3_SMPR2_SMP0_MASK		0x07
/** @defgroup adc3_smpr2_smp0 SMP0 Channel 0 sample time selection
@{*/
/**@}*/
