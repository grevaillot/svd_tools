...
/** @defgroup tim13_registers General purpose timer Register
@{*/
...
/** TIM13_CCMR1_Output capture/compare mode register (output mode) **/
#define TIM13_CCMR1_Output			MMIO32(TIM13_BASE + 0x18)
/** TIM13_CCMR1_Input capture/compare mode register (input mode) **/
...
/** @defgroup tim13_ccmr1_output CCMR1Output capture/compare mode register (output mode)
@{*/
...
/** @defgroup tim13_ccmr1_input CCMR1Input capture/compare mode register (input mode)
@{*/
...
#define TIM13_CCMR1_Input_IC1PSC_SHIFT		2
#define TIM13_CCMR1_Input_IC1PSC_MASK		0x03
/** @defgroup tim13_ccmr1_input_ic1psc IC1PSC Input capture 1 prescaler
@{*/
/**@}*/
