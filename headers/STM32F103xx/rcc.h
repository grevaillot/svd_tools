...
/** RCC_APB2RSTR_TIM11RST TIM11 timer reset **/
#define RCC_APB2RSTR_TIM11RST		(1 << 21)
/** RCC_APB2RSTR_TIM10RST TIM10 timer reset **/
#define RCC_APB2RSTR_TIM10RST		(1 << 20)
/** RCC_APB2RSTR_TIM9RST TIM9 timer reset **/
#define RCC_APB2RSTR_TIM9RST		(1 << 19)
/** RCC_APB2RSTR_ADC3RST ADC 3 interface reset **/
...
/** RCC_APB2RSTR_IOPGRST IO port G reset **/
#define RCC_APB2RSTR_IOPGRST		(1 << 8)
/** RCC_APB2RSTR_IOPFRST IO port F reset **/
...
/** RCC_AHBENR_SDIOEN SDIO clock enable **/
#define RCC_AHBENR_SDIOEN		(1 << 10)
/** RCC_AHBENR_FSMCEN FSMC clock enable **/
...
/** RCC_APB2ENR_ADC3EN ADC3 interface clock enable **/
...
/** RCC_APB2ENR_IOPGEN I/O port G clock enable **/
#define RCC_APB2ENR_IOPGEN		(1 << 8)
/** RCC_APB2ENR_IOPFEN I/O port F clock enable **/
