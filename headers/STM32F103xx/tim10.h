...
/** @defgroup tim10_registers General purpose timer Register
@{*/

/** TIM10_CR1 control register 1 **/
#define TIM10_CR1			MMIO32(TIM10_BASE + 0x00)
/** TIM10_CR2 control register 2 **/
#define TIM10_CR2			MMIO32(TIM10_BASE + 0x04)
...
/** TIM10_CCMR1_Output capture/compare mode register (output mode) **/
#define TIM10_CCMR1_Output			MMIO32(TIM10_BASE + 0x18)
/** TIM10_CCMR1_Input capture/compare mode register (input mode) **/
...
/** @defgroup tim10_cr2 CR2 control register 2
@{*/


#define TIM10_CR2_MMS_SHIFT		4
#define TIM10_CR2_MMS_MASK		0x07
/** @defgroup tim10_cr2_mms MMS Master mode selection
@{*/
/**@}*/
...
/** @defgroup tim10_ccmr1_output CCMR1Output capture/compare mode register (output mode)
@{*/
...
/** @defgroup tim10_ccmr1_input CCMR1Input capture/compare mode register (input mode)
@{*/
...
#define TIM10_CCMR1_Input_IC1PSC_SHIFT		2
#define TIM10_CCMR1_Input_IC1PSC_MASK		0x03
/** @defgroup tim10_ccmr1_input_ic1psc IC1PSC Input capture 1 prescaler
@{*/
/**@}*/
