...
/** WWDG_CR Control register (WWDG_CR) **/
#define WWDG_CR			MMIO32(WWDG_BASE + 0x00)
/** WWDG_CFR Configuration register (WWDG_CFR) **/
#define WWDG_CFR			MMIO32(WWDG_BASE + 0x04)
/** WWDG_SR Status register (WWDG_SR) **/
#define WWDG_SR			MMIO32(WWDG_BASE + 0x08)

/**@}*/


/** @defgroup wwdg_cr CR Control register (WWDG_CR)
@{*/
...
/** @defgroup wwdg_cfr CFR Configuration register (WWDG_CFR)
@{*/
...
/** @defgroup wwdg_sr SR Status register (WWDG_SR)
@{*/

/** WWDG_SR_EWI Early Wakeup Interrupt **/
#define WWDG_SR_EWI		(1 << 0)
