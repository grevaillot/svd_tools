...
/** @defgroup tim11_registers General purpose timer Register
@{*/

/** TIM11_CR1 control register 1 **/
#define TIM11_CR1			MMIO32(TIM11_BASE + 0x00)
/** TIM11_CR2 control register 2 **/
#define TIM11_CR2			MMIO32(TIM11_BASE + 0x04)
...
/** @defgroup tim11_cr2 CR2 control register 2
@{*/


#define TIM11_CR2_MMS_SHIFT		4
#define TIM11_CR2_MMS_MASK		0x07
/** @defgroup tim11_cr2_mms MMS Master mode selection
@{*/
/**@}*/
