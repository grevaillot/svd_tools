...
/** MCAN0_MCAN_DBTP Data Bit Timing and Prescaler Register **/
#define MCAN0_MCAN_DBTP			MMIO32(MCAN0_BASE + 0x0c)
...
/** MCAN0_MCAN_NBTP Nominal Bit Timing and Prescaler Register **/
#define MCAN0_MCAN_NBTP			MMIO32(MCAN0_BASE + 0x1c)
...
/** MCAN0_MCAN_TDCR Transmit Delay Compensation Register **/
#define MCAN0_MCAN_TDCR			MMIO32(MCAN0_BASE + 0x48)
...
/** @defgroup mcan0_mcan_dbtp MCANDBTP Data Bit Timing and Prescaler Register
@{*/

/** MCAN0_MCAN_DBTP_TDC Transmitter Delay Compensation **/
#define MCAN0_MCAN_DBTP_TDC		(1 << 23)

#define MCAN0_MCAN_DBTP_DBRP_SHIFT		16
#define MCAN0_MCAN_DBTP_DBRP_MASK		0x1f
/** @defgroup mcan0_mcan_dbtp_dbrp DBRP Data Bit Rate Prescaler
@{*/
/**@}*/


#define MCAN0_MCAN_DBTP_DTSEG1_SHIFT		8
#define MCAN0_MCAN_DBTP_DTSEG1_MASK		0x1f
/** @defgroup mcan0_mcan_dbtp_dtseg1 DTSEG1 Data Time Segment Before Sample Point
@{*/
/**@}*/


#define MCAN0_MCAN_DBTP_DTSEG2_SHIFT		4
#define MCAN0_MCAN_DBTP_DTSEG2_MASK		0x0f
/** @defgroup mcan0_mcan_dbtp_dtseg2 DTSEG2 Data Time Segment After Sample Point
@{*/
/**@}*/


#define MCAN0_MCAN_DBTP_DSJW_SHIFT		0
#define MCAN0_MCAN_DBTP_DSJW_MASK		0x07
/** @defgroup mcan0_mcan_dbtp_dsjw DSJW Data (Re) Synchronization Jump Width
@{*/
/**@}*/
...
/** MCAN0_MCAN_CCCR_NISO Non-ISO Operation **/
#define MCAN0_MCAN_CCCR_NISO		(1 << 15)
/** MCAN0_MCAN_CCCR_TXP Transmit Pause (read/write, write protection) **/
#define MCAN0_MCAN_CCCR_TXP		(1 << 14)
/** MCAN0_MCAN_CCCR_EFBI Edge Filtering during Bus Integration (read/write, write protection) **/
#define MCAN0_MCAN_CCCR_EFBI		(1 << 13)
/** MCAN0_MCAN_CCCR_PXHD Protocol Exception Event Handling (read/write, write protection) **/
#define MCAN0_MCAN_CCCR_PXHD		(1 << 12)
/** MCAN0_MCAN_CCCR_BRSE Bit Rate Switching Enable (read/write, write protection) **/
#define MCAN0_MCAN_CCCR_BRSE		(1 << 9)
/** MCAN0_MCAN_CCCR_FDOE CAN FD Operation Enable (read/write, write protection) **/
#define MCAN0_MCAN_CCCR_FDOE		(1 << 8)
...
/** @defgroup mcan0_mcan_nbtp MCANNBTP Nominal Bit Timing and Prescaler Register
@{*/


#define MCAN0_MCAN_NBTP_NSJW_SHIFT		25
#define MCAN0_MCAN_NBTP_NSJW_MASK		0x7f
/** @defgroup mcan0_mcan_nbtp_nsjw NSJW Nominal (Re) Synchronization Jump Width
@{*/
/**@}*/


#define MCAN0_MCAN_NBTP_NBRP_SHIFT		16
#define MCAN0_MCAN_NBTP_NBRP_MASK		0x1ff
/** @defgroup mcan0_mcan_nbtp_nbrp NBRP Nominal Bit Rate Prescaler
@{*/
/**@}*/


#define MCAN0_MCAN_NBTP_NTSEG1_SHIFT		8
#define MCAN0_MCAN_NBTP_NTSEG1_MASK		0xff
/** @defgroup mcan0_mcan_nbtp_ntseg1 NTSEG1 Nominal Time Segment Before Sample Point
@{*/
/**@}*/


#define MCAN0_MCAN_NBTP_NTSEG2_SHIFT		0
#define MCAN0_MCAN_NBTP_NTSEG2_MASK		0x7f
/** @defgroup mcan0_mcan_nbtp_ntseg2 NTSEG2 Nominal Time Segment After Sample Point
@{*/
/**@}*/
...
#define MCAN0_MCAN_PSR_TDCV_SHIFT		16
#define MCAN0_MCAN_PSR_TDCV_MASK		0x7f
/** @defgroup mcan0_mcan_psr_tdcv TDCV Transmitter Delay Compensation Value
@{*/
/**@}*/

/** MCAN0_MCAN_PSR_PXE Protocol Exception Event (cleared on read) **/
#define MCAN0_MCAN_PSR_PXE		(1 << 14)
/** MCAN0_MCAN_PSR_RFDF Received a CAN FD Message (cleared on read) **/
#define MCAN0_MCAN_PSR_RFDF		(1 << 13)
...
#define MCAN0_MCAN_PSR_DLEC_SHIFT		8
#define MCAN0_MCAN_PSR_DLEC_MASK		0x07
/** @defgroup mcan0_mcan_psr_dlec DLEC Data Phase Last Error Code (set to 111 on read)
@{*/
/**@}*/
...
/** @defgroup mcan0_mcan_tdcr MCANTDCR Transmit Delay Compensation Register
@{*/


#define MCAN0_MCAN_TDCR_TDCO_SHIFT		8
#define MCAN0_MCAN_TDCR_TDCO_MASK		0x7f
/** @defgroup mcan0_mcan_tdcr_tdco TDCO Transmitter Delay Compensation Offset
@{*/
/**@}*/


#define MCAN0_MCAN_TDCR_TDCF_SHIFT		0
#define MCAN0_MCAN_TDCR_TDCF_MASK		0x7f
/** @defgroup mcan0_mcan_tdcr_tdcf TDCF Transmitter Delay Compensation Filter
@{*/
/**@}*/
...
/** MCAN0_MCAN_IR_ARA Access to Reserved Address **/
#define MCAN0_MCAN_IR_ARA		(1 << 29)
/** MCAN0_MCAN_IR_PED Protocol Error in Data Phase **/
#define MCAN0_MCAN_IR_PED		(1 << 28)
/** MCAN0_MCAN_IR_PEA Protocol Error in Arbitration Phase **/
#define MCAN0_MCAN_IR_PEA		(1 << 27)
...
/** MCAN0_MCAN_IE_ARAE Access to Reserved Address Enable **/
#define MCAN0_MCAN_IE_ARAE		(1 << 29)
/** MCAN0_MCAN_IE_PEDE Protocol Error in Data Phase Enable **/
#define MCAN0_MCAN_IE_PEDE		(1 << 28)
/** MCAN0_MCAN_IE_PEAE Protocol Error in Arbitration Phase Enable **/
#define MCAN0_MCAN_IE_PEAE		(1 << 27)
...
/** MCAN0_MCAN_ILS_ARAL Access to Reserved Address Line **/
#define MCAN0_MCAN_ILS_ARAL		(1 << 29)
/** MCAN0_MCAN_ILS_PEDL Protocol Error in Data Phase Line **/
#define MCAN0_MCAN_ILS_PEDL		(1 << 28)
/** MCAN0_MCAN_ILS_PEAL Protocol Error in Arbitration Phase Line **/
#define MCAN0_MCAN_ILS_PEAL		(1 << 27)
