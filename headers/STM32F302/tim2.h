...
/** TIM2_SMCR_SMS_3 Slave mode selection bit3 **/
...
/** TIM2_CCMR2_Output_OC4M_3 Output compare 4 mode bit3 **/
#define TIM2_CCMR2_Output_OC4M_3		(1 << 24)
/** TIM2_CCMR2_Output_OC3M_3 Output compare 3 mode bit3 **/
...
/** TIM2_CNT_CNT_or_UIFCPY if IUFREMAP=0 than CNT with read write access else UIFCPY with read only access **/
#define TIM2_CNT_CNT_or_UIFCPY		(1 << 31)

#define TIM2_CNT_CNTH_SHIFT		16
#define TIM2_CNT_CNTH_MASK		0x7fff
...
/** @defgroup tim2_ccr1_ccr1h CCR1H High Capture/Compare 1 value (on TIM2)
@{*/
/**@}*/
...
/** @defgroup tim2_ccr2_ccr2h CCR2H High Capture/Compare 2 value (on TIM2)
@{*/
/**@}*/
...
/** @defgroup tim2_ccr3_ccr3h CCR3H High Capture/Compare value (on TIM2)
@{*/
/**@}*/
...
/** @defgroup tim2_ccr4_ccr4h CCR4H High Capture/Compare value (on TIM2)
@{*/
/**@}*/
