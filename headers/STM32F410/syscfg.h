...
/** SYSCFG_CFGR Configuration register **/
#define SYSCFG_CFGR			MMIO32(SYSCFG_BASE + 0x2c)
...
/** @defgroup syscfg_cfgr CFGR Configuration register
@{*/

/** SYSCFG_CFGR_FMPI2C1_SDA FMPI2C1_SDA **/
#define SYSCFG_CFGR_FMPI2C1_SDA		(1 << 1)
/** SYSCFG_CFGR_FMPI2C1_SCL FMPI2C1_SCL **/
#define SYSCFG_CFGR_FMPI2C1_SCL		(1 << 0)
