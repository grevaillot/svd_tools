...
/** RCC_DCKCFGR DCKCFGR register **/
#define RCC_DCKCFGR			MMIO32(RCC_BASE + 0x8c)
/** RCC_DCKCFGR2 DCKCFGR2 register **/
...
/** RCC_PLLCFGR_PLLR3 PLLR3 **/
#define RCC_PLLCFGR_PLLR3		(1 << 30)
/** RCC_PLLCFGR_PLLR2 PLLR2 **/
#define RCC_PLLCFGR_PLLR2		(1 << 29)
/** RCC_PLLCFGR_PLLR1 PLLR1 **/
#define RCC_PLLCFGR_PLLR1		(1 << 28)
...
/** RCC_CFGR_MCO2EN MCO output enable **/
#define RCC_CFGR_MCO2EN		(1 << 9)
/** RCC_CFGR_MCO1EN MCO output enable **/
#define RCC_CFGR_MCO1EN		(1 << 8)
...
/** RCC_AHB1RSTR_RNGRST RNGRST **/
#define RCC_AHB1RSTR_RNGRST		(1 << 31)
...
/** RCC_APB1RSTR_I2C4RST I2C4 reset **/
...
/** RCC_APB1RSTR_LPTIM1RST LPTIM1 reset **/
...
/** RCC_AHB1ENR_RNGEN RNG clock enable **/
#define RCC_AHB1ENR_RNGEN		(1 << 31)
...
/** RCC_APB1ENR_RTCAPBEN RTC APB clock enable **/
#define RCC_APB1ENR_RTCAPBEN		(1 << 10)
/** RCC_APB1ENR_LPTIM1EN LPTIM1 clock enable **/
...
/** RCC_APB2ENR_EXTITEN EXTI ans external IT clock enable **/
#define RCC_APB2ENR_EXTITEN		(1 << 15)
...
/** RCC_AHB1LPENR_RNGLPEN RNG clock enable during sleep mode **/
#define RCC_AHB1LPENR_RNGLPEN		(1 << 31)
...
/** RCC_APB1LPENR_RTCAPBLPEN RTC APB clock enable during sleep mode **/
#define RCC_APB1LPENR_RTCAPBLPEN		(1 << 10)
/** RCC_APB1LPENR_LPTIM1LPEN LPTIM1 clock enable during sleep mode **/
...
/** RCC_APB2LPENR_EXTITLPEN EXTI and External IT clock enable during sleep mode **/
#define RCC_APB2LPENR_EXTITLPEN		(1 << 15)
...
/** @defgroup rcc_dckcfgr DCKCFGR DCKCFGR register
@{*/


#define RCC_DCKCFGR_I2SSRC_SHIFT		25
#define RCC_DCKCFGR_I2SSRC_MASK		0x03
/** @defgroup rcc_dckcfgr_i2ssrc I2SSRC I2SSRC
@{*/
/**@}*/

/** RCC_DCKCFGR_TIMPRE TIMPRE **/
#define RCC_DCKCFGR_TIMPRE		(1 << 24)

/**@}*/

/** @defgroup rcc_dckcfgr2 DCKCFGR2 DCKCFGR2 register
@{*/


#define RCC_DCKCFGR2_LPTIM1SEL_SHIFT		30
#define RCC_DCKCFGR2_LPTIM1SEL_MASK		0x03
/** @defgroup rcc_dckcfgr2_lptim1sel LPTIM1SEL LPTIM1SEL
@{*/
/**@}*/


#define RCC_DCKCFGR2_I2C4SEL_SHIFT		22
#define RCC_DCKCFGR2_I2C4SEL_MASK		0x03
/** @defgroup rcc_dckcfgr2_i2c4sel I2C4SEL I2C4SEL
@{*/
/**@}*/
