...
/** OTG_HS_DEVICE_OTG_HS_DIEPEACHMSK1 OTG_HS device each in endpoint-1 interrupt register **/
#define OTG_HS_DEVICE_OTG_HS_DIEPEACHMSK1			MMIO32(OTG_HS_DEVICE_BASE + 0x40)
/** OTG_HS_DEVICE_OTG_HS_DOEPEACHMSK1 OTG_HS device each OUT endpoint-1 interrupt register **/
#define OTG_HS_DEVICE_OTG_HS_DOEPEACHMSK1			MMIO32(OTG_HS_DEVICE_BASE + 0x80)
...
/** OTG_HS_DEVICE_OTG_HS_DIEPDMA1 OTG_HS device endpoint-1 DMA address register **/
#define OTG_HS_DEVICE_OTG_HS_DIEPDMA1			MMIO32(OTG_HS_DEVICE_BASE + 0x114)
...
/** OTG_HS_DEVICE_OTG_HS_DIEPDMA2 OTG_HS device endpoint-2 DMA address register **/
#define OTG_HS_DEVICE_OTG_HS_DIEPDMA2			MMIO32(OTG_HS_DEVICE_BASE + 0x134)
...
/** OTG_HS_DEVICE_OTG_HS_DIEPDMA3 OTG_HS device endpoint-3 DMA address register **/
#define OTG_HS_DEVICE_OTG_HS_DIEPDMA3			MMIO32(OTG_HS_DEVICE_BASE + 0x154)
...
/** OTG_HS_DEVICE_OTG_HS_DIEPDMA4 OTG_HS device endpoint-4 DMA address register **/
#define OTG_HS_DEVICE_OTG_HS_DIEPDMA4			MMIO32(OTG_HS_DEVICE_BASE + 0x174)
...
/** OTG_HS_DEVICE_OTG_HS_DIEPDMA5 OTG_HS device endpoint-5 DMA address register **/
#define OTG_HS_DEVICE_OTG_HS_DIEPDMA5			MMIO32(OTG_HS_DEVICE_BASE + 0x194)
...
/** OTG_HS_DEVICE_OTG_HS_DOEPTSIZ0 OTG_HS device endpoint-1 transfer size register **/
...
/** OTG_HS_DEVICE_OTG_HS_DOEPTSIZ1 OTG_HS device endpoint-2 transfer size register **/
...
/** OTG_HS_DEVICE_OTG_HS_DOEPTSIZ2 OTG_HS device endpoint-3 transfer size register **/
...
/** OTG_HS_DEVICE_OTG_HS_DOEPTSIZ3 OTG_HS device endpoint-4 transfer size register **/
...
/** OTG_HS_DEVICE_OTG_HS_DOEPTSIZ4 OTG_HS device endpoint-5 transfer size register **/
...
/** @defgroup otg_hs_device_otg_hs_diepeachmsk1 OTGHSDIEPEACHMSK1 OTG_HS device each in endpoint-1 interrupt register
@{*/

/** OTG_HS_DEVICE_OTG_HS_DIEPEACHMSK1_NAKM NAK interrupt mask **/
#define OTG_HS_DEVICE_OTG_HS_DIEPEACHMSK1_NAKM		(1 << 13)
/** OTG_HS_DEVICE_OTG_HS_DIEPEACHMSK1_BIM BNA interrupt mask **/
#define OTG_HS_DEVICE_OTG_HS_DIEPEACHMSK1_BIM		(1 << 9)
/** OTG_HS_DEVICE_OTG_HS_DIEPEACHMSK1_TXFURM FIFO underrun mask **/
#define OTG_HS_DEVICE_OTG_HS_DIEPEACHMSK1_TXFURM		(1 << 8)
/** OTG_HS_DEVICE_OTG_HS_DIEPEACHMSK1_INEPNEM IN endpoint NAK effective mask **/
#define OTG_HS_DEVICE_OTG_HS_DIEPEACHMSK1_INEPNEM		(1 << 6)
/** OTG_HS_DEVICE_OTG_HS_DIEPEACHMSK1_INEPNMM IN token received with EP mismatch mask **/
#define OTG_HS_DEVICE_OTG_HS_DIEPEACHMSK1_INEPNMM		(1 << 5)
/** OTG_HS_DEVICE_OTG_HS_DIEPEACHMSK1_ITTXFEMSK IN token received when TxFIFO empty mask **/
#define OTG_HS_DEVICE_OTG_HS_DIEPEACHMSK1_ITTXFEMSK		(1 << 4)
/** OTG_HS_DEVICE_OTG_HS_DIEPEACHMSK1_TOM Timeout condition mask (nonisochronous endpoints) **/
#define OTG_HS_DEVICE_OTG_HS_DIEPEACHMSK1_TOM		(1 << 3)
/** OTG_HS_DEVICE_OTG_HS_DIEPEACHMSK1_EPDM Endpoint disabled interrupt mask **/
#define OTG_HS_DEVICE_OTG_HS_DIEPEACHMSK1_EPDM		(1 << 1)
/** OTG_HS_DEVICE_OTG_HS_DIEPEACHMSK1_XFRCM Transfer completed interrupt mask **/
#define OTG_HS_DEVICE_OTG_HS_DIEPEACHMSK1_XFRCM		(1 << 0)

/**@}*/

/** @defgroup otg_hs_device_otg_hs_doepeachmsk1 OTGHSDOEPEACHMSK1 OTG_HS device each OUT endpoint-1 interrupt register
@{*/

/** OTG_HS_DEVICE_OTG_HS_DOEPEACHMSK1_NYETM NYET interrupt mask **/
#define OTG_HS_DEVICE_OTG_HS_DOEPEACHMSK1_NYETM		(1 << 14)
/** OTG_HS_DEVICE_OTG_HS_DOEPEACHMSK1_NAKM NAK interrupt mask **/
#define OTG_HS_DEVICE_OTG_HS_DOEPEACHMSK1_NAKM		(1 << 13)
/** OTG_HS_DEVICE_OTG_HS_DOEPEACHMSK1_BERRM Bubble error interrupt mask **/
#define OTG_HS_DEVICE_OTG_HS_DOEPEACHMSK1_BERRM		(1 << 12)
/** OTG_HS_DEVICE_OTG_HS_DOEPEACHMSK1_BIM BNA interrupt mask **/
#define OTG_HS_DEVICE_OTG_HS_DOEPEACHMSK1_BIM		(1 << 9)
/** OTG_HS_DEVICE_OTG_HS_DOEPEACHMSK1_TXFURM OUT packet error mask **/
#define OTG_HS_DEVICE_OTG_HS_DOEPEACHMSK1_TXFURM		(1 << 8)
/** OTG_HS_DEVICE_OTG_HS_DOEPEACHMSK1_INEPNEM IN endpoint NAK effective mask **/
#define OTG_HS_DEVICE_OTG_HS_DOEPEACHMSK1_INEPNEM		(1 << 6)
/** OTG_HS_DEVICE_OTG_HS_DOEPEACHMSK1_INEPNMM IN token received with EP mismatch mask **/
#define OTG_HS_DEVICE_OTG_HS_DOEPEACHMSK1_INEPNMM		(1 << 5)
/** OTG_HS_DEVICE_OTG_HS_DOEPEACHMSK1_ITTXFEMSK IN token received when TxFIFO empty mask **/
#define OTG_HS_DEVICE_OTG_HS_DOEPEACHMSK1_ITTXFEMSK		(1 << 4)
/** OTG_HS_DEVICE_OTG_HS_DOEPEACHMSK1_TOM Timeout condition mask **/
#define OTG_HS_DEVICE_OTG_HS_DOEPEACHMSK1_TOM		(1 << 3)
/** OTG_HS_DEVICE_OTG_HS_DOEPEACHMSK1_EPDM Endpoint disabled interrupt mask **/
#define OTG_HS_DEVICE_OTG_HS_DOEPEACHMSK1_EPDM		(1 << 1)
/** OTG_HS_DEVICE_OTG_HS_DOEPEACHMSK1_XFRCM Transfer completed interrupt mask **/
#define OTG_HS_DEVICE_OTG_HS_DOEPEACHMSK1_XFRCM		(1 << 0)
...
/** @defgroup otg_hs_device_otg_hs_diepdma1 OTGHSDIEPDMA1 OTG_HS device endpoint-1 DMA address register
@{*/
...
/** @defgroup otg_hs_device_otg_hs_diepdma2 OTGHSDIEPDMA2 OTG_HS device endpoint-2 DMA address register
@{*/
...
/** @defgroup otg_hs_device_otg_hs_diepdma3 OTGHSDIEPDMA3 OTG_HS device endpoint-3 DMA address register
@{*/
...
/** @defgroup otg_hs_device_otg_hs_diepdma4 OTGHSDIEPDMA4 OTG_HS device endpoint-4 DMA address register
@{*/
...
/** @defgroup otg_hs_device_otg_hs_diepdma5 OTGHSDIEPDMA5 OTG_HS device endpoint-5 DMA address register
@{*/


#define OTG_HS_DEVICE_OTG_HS_DIEPDMA5_DMAADDR_SHIFT		0
#define OTG_HS_DEVICE_OTG_HS_DIEPDMA5_DMAADDR_MASK		0xffffffff
/** @defgroup otg_hs_device_otg_hs_diepdma5_dmaaddr DMAADDR DMA address
@{*/
/**@}*/
...
/** @defgroup otg_hs_device_otg_hs_doeptsiz0 OTGHSDOEPTSIZ0 OTG_HS device endpoint-1 transfer size register
@{*/
...
/** @defgroup otg_hs_device_otg_hs_doeptsiz1 OTGHSDOEPTSIZ1 OTG_HS device endpoint-2 transfer size register
@{*/
...
/** @defgroup otg_hs_device_otg_hs_doeptsiz2 OTGHSDOEPTSIZ2 OTG_HS device endpoint-3 transfer size register
@{*/
...
/** @defgroup otg_hs_device_otg_hs_doeptsiz3 OTGHSDOEPTSIZ3 OTG_HS device endpoint-4 transfer size register
@{*/
...
/** @defgroup otg_hs_device_otg_hs_doeptsiz4 OTGHSDOEPTSIZ4 OTG_HS device endpoint-5 transfer size register
@{*/
