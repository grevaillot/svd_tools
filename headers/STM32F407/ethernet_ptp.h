...
/** Ethernet_PTP_PTPTSCR_TSPFFMAE TSPFFMAE **/
...
/** @defgroup ethernet_ptp_ptptscr_tscnt TSCNT TSCNT
@{*/
/**@}*/

/** Ethernet_PTP_PTPTSCR_TSSMRME TSSMRME **/
#define Ethernet_PTP_PTPTSCR_TSSMRME		(1 << 15)
/** Ethernet_PTP_PTPTSCR_TSSEME TSSEME **/
#define Ethernet_PTP_PTPTSCR_TSSEME		(1 << 14)
/** Ethernet_PTP_PTPTSCR_TSSIPV4FE TSSIPV4FE **/
#define Ethernet_PTP_PTPTSCR_TSSIPV4FE		(1 << 13)
/** Ethernet_PTP_PTPTSCR_TSSIPV6FE TSSIPV6FE **/
#define Ethernet_PTP_PTPTSCR_TSSIPV6FE		(1 << 12)
/** Ethernet_PTP_PTPTSCR_TSSPTPOEFE TSSPTPOEFE **/
#define Ethernet_PTP_PTPTSCR_TSSPTPOEFE		(1 << 11)
/** Ethernet_PTP_PTPTSCR_TSPTPPSV2E TSPTPPSV2E **/
#define Ethernet_PTP_PTPTSCR_TSPTPPSV2E		(1 << 10)
/** Ethernet_PTP_PTPTSCR_TSSSR TSSSR **/
#define Ethernet_PTP_PTPTSCR_TSSSR		(1 << 9)
/** Ethernet_PTP_PTPTSCR_TSSARFE TSSARFE **/
#define Ethernet_PTP_PTPTSCR_TSSARFE		(1 << 8)
/** Ethernet_PTP_PTPTSCR_TTSARU TTSARU **/
#define Ethernet_PTP_PTPTSCR_TTSARU		(1 << 5)
/** Ethernet_PTP_PTPTSCR_TSITE TSITE **/
#define Ethernet_PTP_PTPTSCR_TSITE		(1 << 4)
/** Ethernet_PTP_PTPTSCR_TSSTU TSSTU **/
#define Ethernet_PTP_PTPTSCR_TSSTU		(1 << 3)
/** Ethernet_PTP_PTPTSCR_TSSTI TSSTI **/
#define Ethernet_PTP_PTPTSCR_TSSTI		(1 << 2)
/** Ethernet_PTP_PTPTSCR_TSFCU TSFCU **/
#define Ethernet_PTP_PTPTSCR_TSFCU		(1 << 1)
/** Ethernet_PTP_PTPTSCR_TSE TSE **/
...
/** @defgroup ethernet_ptp_ptpssir_stssi STSSI STSSI
@{*/
/**@}*/
...
/** @defgroup ethernet_ptp_ptptshr_sts STS STS
@{*/
/**@}*/
...
/** Ethernet_PTP_PTPTSLR_STPNS STPNS **/
...
/** @defgroup ethernet_ptp_ptptslr_stss STSS STSS
@{*/
/**@}*/
...
/** @defgroup ethernet_ptp_ptptshur_tsus TSUS TSUS
@{*/
/**@}*/
...
/** Ethernet_PTP_PTPTSLUR_TSUPNS TSUPNS **/
...
/** @defgroup ethernet_ptp_ptptslur_tsuss TSUSS TSUSS
@{*/
/**@}*/
...
/** @defgroup ethernet_ptp_ptptsar_tsa TSA TSA
@{*/
/**@}*/
...
/** @defgroup ethernet_ptp_ptpttlr_ttsl TTSL TTSL
@{*/
/**@}*/
...
/** Ethernet_PTP_PTPTSSR_TSTTR TSTTR **/
#define Ethernet_PTP_PTPTSSR_TSTTR		(1 << 1)
/** Ethernet_PTP_PTPTSSR_TSSO TSSO **/
