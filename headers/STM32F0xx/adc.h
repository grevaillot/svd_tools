...
/** ADC_CCR common configuration register **/
...
/** ADC_CFGR2_JITOFF_D4 JITOFF_D4 **/
#define ADC_CFGR2_JITOFF_D4		(1 << 31)
/** ADC_CFGR2_JITOFF_D2 JITOFF_D2 **/
#define ADC_CFGR2_JITOFF_D2		(1 << 30)
...
/** @defgroup adc_ccr CCR common configuration register
@{*/
...
/** ADC_CCR_VREFEN Temperature sensor and VREFINT enable **/
