...
/** SPI1_SPI_CSR[0] Chip Select Register (CS_number = 0) 0 **/
#define SPI1_SPI_CSR[0]			MMIO32(SPI1_BASE + 0x30)
/** SPI1_SPI_CSR[1] Chip Select Register (CS_number = 0) 0 **/
#define SPI1_SPI_CSR[1]			MMIO32(SPI1_BASE + 0x34)
/** SPI1_SPI_CSR[2] Chip Select Register (CS_number = 0) 0 **/
#define SPI1_SPI_CSR[2]			MMIO32(SPI1_BASE + 0x38)
/** SPI1_SPI_CSR[3] Chip Select Register (CS_number = 0) 0 **/
...
/** SPI1_SPI_VERSION Version Register **/
#define SPI1_SPI_VERSION			MMIO32(SPI1_BASE + 0xfc)
...
/** SPI1_SPI_CR_FIFODIS FIFO Disable **/
#define SPI1_SPI_CR_FIFODIS		(1 << 31)
/** SPI1_SPI_CR_FIFOEN FIFO Enable **/
#define SPI1_SPI_CR_FIFOEN		(1 << 30)
/** SPI1_SPI_CR_LASTXFER Last Transfer **/
#define SPI1_SPI_CR_LASTXFER		(1 << 24)
/** SPI1_SPI_CR_RXFCLR Receive FIFO Clear **/
#define SPI1_SPI_CR_RXFCLR		(1 << 17)
/** SPI1_SPI_CR_TXFCLR Transmit FIFO Clear **/
#define SPI1_SPI_CR_TXFCLR		(1 << 16)
...
/** @defgroup spi1_spi_csr[0] SPICSR[0] Chip Select Register (CS_number = 0) 0
@{*/
...
/** @defgroup spi1_spi_csr[1] SPICSR[1] Chip Select Register (CS_number = 0) 0
@{*/
...
/** @defgroup spi1_spi_csr[2] SPICSR[2] Chip Select Register (CS_number = 0) 0
@{*/
...
/** @defgroup spi1_spi_csr[3] SPICSR[3] Chip Select Register (CS_number = 0) 0
@{*/
...
/** @defgroup spi1_spi_version SPIVERSION Version Register
@{*/


#define SPI1_SPI_VERSION_MFN_SHIFT		16
#define SPI1_SPI_VERSION_MFN_MASK		0x07
/** @defgroup spi1_spi_version_mfn MFN Metal Fix Number
@{*/
/**@}*/


#define SPI1_SPI_VERSION_VERSION_SHIFT		0
#define SPI1_SPI_VERSION_VERSION_MASK		0xfff
/** @defgroup spi1_spi_version_version VERSION Version of the Hardware Module
@{*/
/**@}*/
