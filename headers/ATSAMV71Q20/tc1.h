...
/** TC1_TC_VER Version Register **/
#define TC1_TC_VER			MMIO32(TC1_BASE + 0xfc)
...
/** @defgroup tc1_tc_ver TCVER Version Register
@{*/


#define TC1_TC_VER_MFN_SHIFT		16
#define TC1_TC_VER_MFN_MASK		0x07
/** @defgroup tc1_tc_ver_mfn MFN Metal Fix Number
@{*/
/**@}*/


#define TC1_TC_VER_VERSION_SHIFT		0
#define TC1_TC_VER_VERSION_MASK		0xfff
/** @defgroup tc1_tc_ver_version VERSION Version of the Hardware Module
@{*/
/**@}*/
