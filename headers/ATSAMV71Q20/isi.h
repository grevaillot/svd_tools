...
/** ISI_ISI_VERSION Version Register **/
#define ISI_ISI_VERSION			MMIO32(ISI_BASE + 0xfc)
...
/** @defgroup isi_isi_version ISIVERSION Version Register
@{*/


#define ISI_ISI_VERSION_MFN_SHIFT		16
#define ISI_ISI_VERSION_MFN_MASK		0x07
/** @defgroup isi_isi_version_mfn MFN Metal Fix Number
@{*/
/**@}*/


#define ISI_ISI_VERSION_VERSION_SHIFT		0
#define ISI_ISI_VERSION_VERSION_MASK		0xfff
/** @defgroup isi_isi_version_version VERSION Version of the Hardware Module
@{*/
/**@}*/
