...
/** UART0_UART_VERSION Version Register **/
#define UART0_UART_VERSION			MMIO32(UART0_BASE + 0xfc)
...
/** UART0_UART_CR_DBGE Debug Enable **/
#define UART0_UART_CR_DBGE		(1 << 15)
...
/** UART0_UART_SR_WKUPREQ Wake-Up Request **/
#define UART0_UART_SR_WKUPREQ		(1 << 23)
/** UART0_UART_SR_CLKREQ Clock Request **/
#define UART0_UART_SR_CLKREQ		(1 << 22)
/** UART0_UART_SR_SWES SleepWalking Enable Status **/
#define UART0_UART_SR_SWES		(1 << 21)
...
/** @defgroup uart0_uart_version UARTVERSION Version Register
@{*/


#define UART0_UART_VERSION_MFN_SHIFT		16
#define UART0_UART_VERSION_MFN_MASK		0x07
/** @defgroup uart0_uart_version_mfn MFN Metal Fix Number
@{*/
/**@}*/


#define UART0_UART_VERSION_VERSION_SHIFT		0
#define UART0_UART_VERSION_VERSION_MASK		0xfff
/** @defgroup uart0_uart_version_version VERSION Hardware Module Version
@{*/
/**@}*/
