...
/** UART3_UART_VERSION Version Register **/
#define UART3_UART_VERSION			MMIO32(UART3_BASE + 0xfc)
...
/** UART3_UART_CR_DBGE Debug Enable **/
#define UART3_UART_CR_DBGE		(1 << 15)
...
/** UART3_UART_SR_WKUPREQ Wake-Up Request **/
#define UART3_UART_SR_WKUPREQ		(1 << 23)
/** UART3_UART_SR_CLKREQ Clock Request **/
#define UART3_UART_SR_CLKREQ		(1 << 22)
/** UART3_UART_SR_SWES SleepWalking Enable Status **/
#define UART3_UART_SR_SWES		(1 << 21)
...
/** @defgroup uart3_uart_version UARTVERSION Version Register
@{*/


#define UART3_UART_VERSION_MFN_SHIFT		16
#define UART3_UART_VERSION_MFN_MASK		0x07
/** @defgroup uart3_uart_version_mfn MFN Metal Fix Number
@{*/
/**@}*/


#define UART3_UART_VERSION_VERSION_SHIFT		0
#define UART3_UART_VERSION_VERSION_MASK		0xfff
/** @defgroup uart3_uart_version_version VERSION Hardware Module Version
@{*/
/**@}*/
