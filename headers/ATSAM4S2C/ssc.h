...
/** SSC_WPMR Write Protection Mode Register **/
#define SSC_WPMR			MMIO32(SSC_BASE + 0xe4)
/** SSC_WPSR Write Protection Status Register **/
...
/** @defgroup ssc_wpmr WPMR Write Protection Mode Register
@{*/


#define SSC_WPMR_WPKEY_SHIFT		8
#define SSC_WPMR_WPKEY_MASK		0xffffff
/** @defgroup ssc_wpmr_wpkey WPKEY Write Protection Key
@{*/
/**@}*/

/** SSC_WPMR_WPEN Write Protection Enable **/
#define SSC_WPMR_WPEN		(1 << 0)

/**@}*/

/** @defgroup ssc_wpsr WPSR Write Protection Status Register
@{*/


#define SSC_WPSR_WPVSRC_SHIFT		8
#define SSC_WPSR_WPVSRC_MASK		0xffff
/** @defgroup ssc_wpsr_wpvsrc WPVSRC Write Protect Violation Source
@{*/
/**@}*/

/** SSC_WPSR_WPVS Write Protection Violation Status **/
