...
/** TIM14_CCMR1_Input capture/compare mode register (inputmode) **/
...
/** TIM14_OR option register **/
#define TIM14_OR			MMIO32(TIM14_BASE + 0x50)
...
/** @defgroup tim14_ccmr1_input CCMR1Input capture/compare mode register (inputmode)
@{*/
...
/** @defgroup tim14_or OR option register
@{*/


#define TIM14_OR_RMP_SHIFT		0
#define TIM14_OR_RMP_MASK		0x03
/** @defgroup tim14_or_rmp RMP Input 1 remapping capability
@{*/
/**@}*/
