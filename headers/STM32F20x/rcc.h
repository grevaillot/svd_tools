...
/** RCC_CFGR_MCO21 Microcontroller clock output 2 **/
#define RCC_CFGR_MCO21		(1 << 31)
/** RCC_CFGR_MCO20 Microcontroller clock output 2 **/
#define RCC_CFGR_MCO20		(1 << 30)
/** RCC_CFGR_MCO2PRE2 MCO2 prescaler **/
#define RCC_CFGR_MCO2PRE2		(1 << 29)
/** RCC_CFGR_MCO2PRE1 MCO2 prescaler **/
#define RCC_CFGR_MCO2PRE1		(1 << 28)
/** RCC_CFGR_MCO2PRE0 MCO2 prescaler **/
#define RCC_CFGR_MCO2PRE0		(1 << 27)
/** RCC_CFGR_MCO1PRE2 MCO1 prescaler **/
#define RCC_CFGR_MCO1PRE2		(1 << 26)
/** RCC_CFGR_MCO1PRE1 MCO1 prescaler **/
#define RCC_CFGR_MCO1PRE1		(1 << 25)
/** RCC_CFGR_MCO1PRE0 MCO1 prescaler **/
#define RCC_CFGR_MCO1PRE0		(1 << 24)
/** RCC_CFGR_I2SSRC I2S clock selection **/
#define RCC_CFGR_I2SSRC		(1 << 23)
/** RCC_CFGR_MCO11 Microcontroller clock output 1 **/
#define RCC_CFGR_MCO11		(1 << 22)
/** RCC_CFGR_MCO10 Microcontroller clock output 1 **/
#define RCC_CFGR_MCO10		(1 << 21)
/** RCC_CFGR_RTCPRE4 HSE division factor for RTC clock **/
#define RCC_CFGR_RTCPRE4		(1 << 20)
/** RCC_CFGR_RTCPRE3 HSE division factor for RTC clock **/
#define RCC_CFGR_RTCPRE3		(1 << 19)
/** RCC_CFGR_RTCPRE2 HSE division factor for RTC clock **/
#define RCC_CFGR_RTCPRE2		(1 << 18)
/** RCC_CFGR_RTCPRE1 HSE division factor for RTC clock **/
#define RCC_CFGR_RTCPRE1		(1 << 17)
/** RCC_CFGR_RTCPRE0 HSE division factor for RTC clock **/
#define RCC_CFGR_RTCPRE0		(1 << 16)
/** RCC_CFGR_PPRE22 APB high-speed prescaler (APB2) **/
#define RCC_CFGR_PPRE22		(1 << 15)
/** RCC_CFGR_PPRE21 APB high-speed prescaler (APB2) **/
#define RCC_CFGR_PPRE21		(1 << 14)
/** RCC_CFGR_PPRE20 APB high-speed prescaler (APB2) **/
#define RCC_CFGR_PPRE20		(1 << 13)
/** RCC_CFGR_PPRE12 APB Low speed prescaler (APB1) **/
#define RCC_CFGR_PPRE12		(1 << 12)
/** RCC_CFGR_PPRE11 APB Low speed prescaler (APB1) **/
#define RCC_CFGR_PPRE11		(1 << 11)
/** RCC_CFGR_PPRE10 APB Low speed prescaler (APB1) **/
#define RCC_CFGR_PPRE10		(1 << 10)
/** RCC_CFGR_HPRE3 AHB prescaler **/
#define RCC_CFGR_HPRE3		(1 << 7)
/** RCC_CFGR_HPRE2 AHB prescaler **/
#define RCC_CFGR_HPRE2		(1 << 6)
/** RCC_CFGR_HPRE1 AHB prescaler **/
#define RCC_CFGR_HPRE1		(1 << 5)
/** RCC_CFGR_HPRE0 AHB prescaler **/
...
/** RCC_AHB3RSTR_FSMCRST Flexible static memory controller module reset **/
...
/** RCC_AHB3ENR_FSMCEN Flexible static memory controller module clock enable **/
...
/** RCC_AHB3LPENR_FSMCLPEN Flexible static memory controller module clock enable during Sleep mode **/
...
/** RCC_PLLI2SCFGR_PLLI2SR2 PLLI2S division factor for I2S clocks **/
#define RCC_PLLI2SCFGR_PLLI2SR2		(1 << 30)
/** RCC_PLLI2SCFGR_PLLI2SR1 PLLI2S division factor for I2S clocks **/
#define RCC_PLLI2SCFGR_PLLI2SR1		(1 << 29)
/** RCC_PLLI2SCFGR_PLLI2SR0 PLLI2S division factor for I2S clocks **/
#define RCC_PLLI2SCFGR_PLLI2SR0		(1 << 28)
/** RCC_PLLI2SCFGR_PLLI2SN8 PLLI2S multiplication factor for VCO **/
#define RCC_PLLI2SCFGR_PLLI2SN8		(1 << 14)
/** RCC_PLLI2SCFGR_PLLI2SN7 PLLI2S multiplication factor for VCO **/
#define RCC_PLLI2SCFGR_PLLI2SN7		(1 << 13)
/** RCC_PLLI2SCFGR_PLLI2SN6 PLLI2S multiplication factor for VCO **/
#define RCC_PLLI2SCFGR_PLLI2SN6		(1 << 12)
/** RCC_PLLI2SCFGR_PLLI2SN5 PLLI2S multiplication factor for VCO **/
#define RCC_PLLI2SCFGR_PLLI2SN5		(1 << 11)
/** RCC_PLLI2SCFGR_PLLI2SN4 PLLI2S multiplication factor for VCO **/
#define RCC_PLLI2SCFGR_PLLI2SN4		(1 << 10)
/** RCC_PLLI2SCFGR_PLLI2SN3 PLLI2S multiplication factor for VCO **/
#define RCC_PLLI2SCFGR_PLLI2SN3		(1 << 9)
/** RCC_PLLI2SCFGR_PLLI2SN2 PLLI2S multiplication factor for VCO **/
#define RCC_PLLI2SCFGR_PLLI2SN2		(1 << 8)
/** RCC_PLLI2SCFGR_PLLI2SN1 PLLI2S multiplication factor for VCO **/
#define RCC_PLLI2SCFGR_PLLI2SN1		(1 << 7)
/** RCC_PLLI2SCFGR_PLLI2SN0 PLLI2S multiplication factor for VCO **/
#define RCC_PLLI2SCFGR_PLLI2SN0		(1 << 6)
