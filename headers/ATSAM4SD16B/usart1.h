...
/** USART1_CR_RTSDIS Request to Send Pin Control **/
#define USART1_CR_RTSDIS		(1 << 19)
/** USART1_CR_RTSEN Request to Send Pin Control **/
#define USART1_CR_RTSEN		(1 << 18)
/** USART1_CR_DTRDIS Data Terminal Ready Disable **/
#define USART1_CR_DTRDIS		(1 << 17)
/** USART1_CR_DTREN Data Terminal Ready Enable **/
#define USART1_CR_DTREN		(1 << 16)
/** USART1_CR_RETTO Start Time-out Immediately **/
...
/** USART1_CR_STTTO Clear TIMEOUT Flag and Start Time-out After Next Character Received **/
...
/** USART1_MR_FILTER Receive Line Filter **/
...
/** USART1_MR_SPI_MODE_CLKO Clock Output Select **/
#define USART1_MR_SPI_MODE_CLKO		(1 << 18)
...
/** USART1_IER_DCDIC Data Carrier Detect Input Change Interrupt Enable **/
#define USART1_IER_DCDIC		(1 << 18)
/** USART1_IER_DSRIC Data Set Ready Input Change Enable **/
#define USART1_IER_DSRIC		(1 << 17)
/** USART1_IER_RIIC Ring Indicator Input Change Enable **/
#define USART1_IER_RIIC		(1 << 16)
/** USART1_IER_NACK Non Acknowledge Interrupt Enable **/
#define USART1_IER_NACK		(1 << 13)
/** USART1_IER_RXBUFF Receive Buffer Full Interrupt Enable (available in all USART modes of operation) **/
#define USART1_IER_RXBUFF		(1 << 12)
/** USART1_IER_TXBUFE Transmit Buffer Empty Interrupt Enable (available in all USART modes of operation) **/
...
/** USART1_IER_ENDTX End of Transmit Buffer Interrupt Enable (available in all USART modes of operation) **/
#define USART1_IER_ENDTX		(1 << 4)
/** USART1_IER_ENDRX End of Receive Buffer Interrupt Enable (available in all USART modes of operation) **/
...
/** USART1_IER_SPI_MODE_RXBUFF Receive Buffer Full Interrupt Enable **/
#define USART1_IER_SPI_MODE_RXBUFF		(1 << 12)
/** USART1_IER_SPI_MODE_TXBUFE Transmit Buffer Empty Interrupt Enable **/
...
/** USART1_IER_SPI_MODE_ENDTX End of Transmit Buffer Interrupt Enable **/
#define USART1_IER_SPI_MODE_ENDTX		(1 << 4)
/** USART1_IER_SPI_MODE_ENDRX End of Receive Buffer Interrupt Enable **/
...
/** USART1_IDR_DCDIC Data Carrier Detect Input Change Interrupt Disable **/
#define USART1_IDR_DCDIC		(1 << 18)
/** USART1_IDR_DSRIC Data Set Ready Input Change Disable **/
#define USART1_IDR_DSRIC		(1 << 17)
/** USART1_IDR_RIIC Ring Indicator Input Change Disable **/
#define USART1_IDR_RIIC		(1 << 16)
/** USART1_IDR_NACK Non Acknowledge Interrupt Disable **/
#define USART1_IDR_NACK		(1 << 13)
/** USART1_IDR_RXBUFF Receive Buffer Full Interrupt Disable (available in all USART modes of operation) **/
#define USART1_IDR_RXBUFF		(1 << 12)
/** USART1_IDR_TXBUFE Transmit Buffer Empty Interrupt Disable (available in all USART modes of operation) **/
...
/** USART1_IDR_ENDTX End of Transmit Buffer Interrupt Disable (available in all USART modes of operation) **/
#define USART1_IDR_ENDTX		(1 << 4)
/** USART1_IDR_ENDRX End of Receive Buffer Transfer Interrupt Disable (available in all USART modes of operation) **/
...
/** USART1_IDR_SPI_MODE_RXBUFF Receive Buffer Full Interrupt Disable **/
#define USART1_IDR_SPI_MODE_RXBUFF		(1 << 12)
/** USART1_IDR_SPI_MODE_TXBUFE Transmit Buffer Empty Interrupt Disable **/
...
/** USART1_IDR_SPI_MODE_ENDTX End of Transmit Buffer Interrupt Disable **/
#define USART1_IDR_SPI_MODE_ENDTX		(1 << 4)
/** USART1_IDR_SPI_MODE_ENDRX End of Receive Buffer Transfer Interrupt Disable **/
...
/** USART1_IMR_DCDIC Data Carrier Detect Input Change Interrupt Mask **/
#define USART1_IMR_DCDIC		(1 << 18)
/** USART1_IMR_DSRIC Data Set Ready Input Change Mask **/
#define USART1_IMR_DSRIC		(1 << 17)
/** USART1_IMR_RIIC Ring Indicator Input Change Mask **/
#define USART1_IMR_RIIC		(1 << 16)
/** USART1_IMR_NACK Non Acknowledge Interrupt Mask **/
#define USART1_IMR_NACK		(1 << 13)
/** USART1_IMR_RXBUFF Receive Buffer Full Interrupt Mask (available in all USART modes of operation) **/
#define USART1_IMR_RXBUFF		(1 << 12)
/** USART1_IMR_TXBUFE Transmit Buffer Empty Interrupt Mask (available in all USART modes of operation) **/
...
/** USART1_IMR_ENDTX End of Transmit Buffer Interrupt Mask (available in all USART modes of operation) **/
#define USART1_IMR_ENDTX		(1 << 4)
/** USART1_IMR_ENDRX End of Receive Buffer Interrupt Mask (available in all USART modes of operation) **/
...
/** USART1_IMR_SPI_MODE_RXBUFF Receive Buffer Full Interrupt Mask **/
#define USART1_IMR_SPI_MODE_RXBUFF		(1 << 12)
/** USART1_IMR_SPI_MODE_TXBUFE Transmit Buffer Empty Interrupt Mask **/
...
/** USART1_IMR_SPI_MODE_ENDTX End of Transmit Buffer Interrupt Mask **/
#define USART1_IMR_SPI_MODE_ENDTX		(1 << 4)
/** USART1_IMR_SPI_MODE_ENDRX End of Receive Buffer Interrupt Mask **/
...
/** USART1_CSR_MANERR Manchester Error (cleared by writing a one to the bit US_CR.RSTSTA) **/
#define USART1_CSR_MANERR		(1 << 24)
/** USART1_CSR_CTS Image of CTS Input **/
#define USART1_CSR_CTS		(1 << 23)
/** USART1_CSR_DCD Image of DCD Input **/
#define USART1_CSR_DCD		(1 << 22)
/** USART1_CSR_DSR Image of DSR Input **/
#define USART1_CSR_DSR		(1 << 21)
/** USART1_CSR_RI Image of RI Input **/
#define USART1_CSR_RI		(1 << 20)
/** USART1_CSR_CTSIC Clear to Send Input Change Flag (cleared on read) **/
#define USART1_CSR_CTSIC		(1 << 19)
/** USART1_CSR_DCDIC Data Carrier Detect Input Change Flag (cleared on read) **/
#define USART1_CSR_DCDIC		(1 << 18)
/** USART1_CSR_DSRIC Data Set Ready Input Change Flag (cleared on read) **/
#define USART1_CSR_DSRIC		(1 << 17)
/** USART1_CSR_RIIC Ring Indicator Input Change Flag (cleared on read) **/
#define USART1_CSR_RIIC		(1 << 16)
/** USART1_CSR_NACK Non Acknowledge Interrupt (cleared by writing a one to bit US_CR.RSTNACK) **/
#define USART1_CSR_NACK		(1 << 13)
/** USART1_CSR_RXBUFF RX Buffer Full (cleared by writing US_RCR or US_RNCR) **/
#define USART1_CSR_RXBUFF		(1 << 12)
/** USART1_CSR_TXBUFE TX Buffer Empty (cleared by writing US_TCR or US_TNCR) **/
#define USART1_CSR_TXBUFE		(1 << 11)
/** USART1_CSR_ITER Max Number of Repetitions Reached (cleared by writing a one to bit US_CR.RSTIT) **/
#define USART1_CSR_ITER		(1 << 10)
/** USART1_CSR_TXEMPTY Transmitter Empty (cleared by writing US_THR) **/
#define USART1_CSR_TXEMPTY		(1 << 9)
/** USART1_CSR_TIMEOUT Receiver Time-out (cleared by writing a one to bit US_CR.STTTO) **/
#define USART1_CSR_TIMEOUT		(1 << 8)
/** USART1_CSR_PARE Parity Error (cleared by writing a one to bit US_CR.RSTSTA) **/
#define USART1_CSR_PARE		(1 << 7)
/** USART1_CSR_FRAME Framing Error (cleared by writing a one to bit US_CR.RSTSTA) **/
#define USART1_CSR_FRAME		(1 << 6)
/** USART1_CSR_OVRE Overrun Error (cleared by writing a one to bit US_CR.RSTSTA) **/
#define USART1_CSR_OVRE		(1 << 5)
/** USART1_CSR_ENDTX End of TX Buffer (cleared by writing US_TCR or US_TNCR) **/
#define USART1_CSR_ENDTX		(1 << 4)
/** USART1_CSR_ENDRX End of RX Buffer (cleared by writing US_RCR or US_RNCR) **/
#define USART1_CSR_ENDRX		(1 << 3)
/** USART1_CSR_RXBRK Break Received/End of Break (cleared by writing a one to bit US_CR.RSTSTA) **/
#define USART1_CSR_RXBRK		(1 << 2)
/** USART1_CSR_TXRDY Transmitter Ready (cleared by writing US_THR) **/
#define USART1_CSR_TXRDY		(1 << 1)
/** USART1_CSR_RXRDY Receiver Ready (cleared by reading US_RHR) **/
...
/** USART1_CSR_SPI_MODE_RXBUFF RX Buffer Full (cleared by writing US_RCR or US_RNCR) **/
#define USART1_CSR_SPI_MODE_RXBUFF		(1 << 12)
/** USART1_CSR_SPI_MODE_TXBUFE TX Buffer Empty (cleared by writing US_TCR or US_TNCR) **/
#define USART1_CSR_SPI_MODE_TXBUFE		(1 << 11)
/** USART1_CSR_SPI_MODE_UNRE Underrun Error (cleared by writing a one to bit US_CR.RSTSTA) **/
#define USART1_CSR_SPI_MODE_UNRE		(1 << 10)
/** USART1_CSR_SPI_MODE_TXEMPTY Transmitter Empty (cleared by writing US_THR) **/
#define USART1_CSR_SPI_MODE_TXEMPTY		(1 << 9)
/** USART1_CSR_SPI_MODE_OVRE Overrun Error (cleared by writing a one to bit US_CR.RSTSTA) **/
#define USART1_CSR_SPI_MODE_OVRE		(1 << 5)
/** USART1_CSR_SPI_MODE_ENDTX End of TX Buffer (cleared by writing US_TCR or US_TNCR) **/
#define USART1_CSR_SPI_MODE_ENDTX		(1 << 4)
/** USART1_CSR_SPI_MODE_ENDRX End of RX Buffer (cleared by writing US_RCR or US_RNCR) **/
#define USART1_CSR_SPI_MODE_ENDRX		(1 << 3)
/** USART1_CSR_SPI_MODE_TXRDY Transmitter Ready (cleared by writing US_THR) **/
#define USART1_CSR_SPI_MODE_TXRDY		(1 << 1)
/** USART1_CSR_SPI_MODE_RXRDY Receiver Ready (cleared by reading US_RHR) **/
