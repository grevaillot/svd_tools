...
/** USART1_IER_LIN_MODE Interrupt Enable Register **/
#define USART1_IER_LIN_MODE			MMIO32(USART1_BASE + 0x08)
...
/** USART1_IDR_LIN_MODE Interrupt Disable Register **/
#define USART1_IDR_LIN_MODE			MMIO32(USART1_BASE + 0x0c)
...
/** USART1_IMR_LIN_MODE Interrupt Mask Register **/
#define USART1_IMR_LIN_MODE			MMIO32(USART1_BASE + 0x10)
...
/** USART1_CSR_LIN_MODE Channel Status Register **/
#define USART1_CSR_LIN_MODE			MMIO32(USART1_BASE + 0x14)
/** USART1_RHR Receive Holding Register **/
#define USART1_RHR			MMIO32(USART1_BASE + 0x18)
/** USART1_THR Transmit Holding Register **/
...
/** USART1_MAN Manchester Configuration Register **/
#define USART1_MAN			MMIO32(USART1_BASE + 0x50)
/** USART1_LINMR LIN Mode Register **/
#define USART1_LINMR			MMIO32(USART1_BASE + 0x54)
/** USART1_LINIR LIN Identifier Register **/
#define USART1_LINIR			MMIO32(USART1_BASE + 0x58)
/** USART1_LINBRR LIN Baud Rate Register **/
#define USART1_LINBRR			MMIO32(USART1_BASE + 0x5c)
/** USART1_WPMR Write Protection Mode Register **/
#define USART1_WPMR			MMIO32(USART1_BASE + 0xe4)
/** USART1_WPSR Write Protection Status Register **/
...
/** USART1_CR_LINWKUP Send LIN Wakeup Signal **/
#define USART1_CR_LINWKUP		(1 << 21)
/** USART1_CR_LINABT Abort LIN Transmission **/
#define USART1_CR_LINABT		(1 << 20)
...
/** USART1_IER_NACK Non Acknowledge Interrupt Enable **/
...
/** USART1_IER_SPI_MODE_RXBUFF  **/
#define USART1_IER_SPI_MODE_RXBUFF		(1 << 12)
/** USART1_IER_SPI_MODE_TXBUFE  **/
#define USART1_IER_SPI_MODE_TXBUFE		(1 << 11)
...
/** USART1_IER_SPI_MODE_ENDTX  **/
#define USART1_IER_SPI_MODE_ENDTX		(1 << 4)
/** USART1_IER_SPI_MODE_ENDRX  **/
#define USART1_IER_SPI_MODE_ENDRX		(1 << 3)
...
/** @defgroup usart1_ier_lin_mode IERLINMODE Interrupt Enable Register
@{*/

/** USART1_IER_LIN_MODE_LINSNRE LIN Slave Not Responding Error Interrupt Enable **/
#define USART1_IER_LIN_MODE_LINSNRE		(1 << 29)
/** USART1_IER_LIN_MODE_LINCE LIN Checksum Error Interrupt Enable **/
#define USART1_IER_LIN_MODE_LINCE		(1 << 28)
/** USART1_IER_LIN_MODE_LINIPE LIN Identifier Parity Interrupt Enable **/
#define USART1_IER_LIN_MODE_LINIPE		(1 << 27)
/** USART1_IER_LIN_MODE_LINISFE LIN Inconsistent Synch Field Error Interrupt Enable **/
#define USART1_IER_LIN_MODE_LINISFE		(1 << 26)
/** USART1_IER_LIN_MODE_LINBE LIN Bus Error Interrupt Enable **/
#define USART1_IER_LIN_MODE_LINBE		(1 << 25)
/** USART1_IER_LIN_MODE_LINTC LIN Transfer Completed Interrupt Enable **/
#define USART1_IER_LIN_MODE_LINTC		(1 << 15)
/** USART1_IER_LIN_MODE_LINID LIN Identifier Sent or LIN Identifier Received Interrupt Enable **/
#define USART1_IER_LIN_MODE_LINID		(1 << 14)
/** USART1_IER_LIN_MODE_LINBK LIN Break Sent or LIN Break Received Interrupt Enable **/
#define USART1_IER_LIN_MODE_LINBK		(1 << 13)
/** USART1_IER_LIN_MODE_RXBUFF  **/
#define USART1_IER_LIN_MODE_RXBUFF		(1 << 12)
/** USART1_IER_LIN_MODE_TXBUFE  **/
#define USART1_IER_LIN_MODE_TXBUFE		(1 << 11)
/** USART1_IER_LIN_MODE_TXEMPTY TXEMPTY Interrupt Enable **/
#define USART1_IER_LIN_MODE_TXEMPTY		(1 << 9)
/** USART1_IER_LIN_MODE_TIMEOUT Time-out Interrupt Enable **/
#define USART1_IER_LIN_MODE_TIMEOUT		(1 << 8)
/** USART1_IER_LIN_MODE_PARE Parity Error Interrupt Enable **/
#define USART1_IER_LIN_MODE_PARE		(1 << 7)
/** USART1_IER_LIN_MODE_FRAME Framing Error Interrupt Enable **/
#define USART1_IER_LIN_MODE_FRAME		(1 << 6)
/** USART1_IER_LIN_MODE_OVRE Overrun Error Interrupt Enable **/
#define USART1_IER_LIN_MODE_OVRE		(1 << 5)
/** USART1_IER_LIN_MODE_ENDTX  **/
#define USART1_IER_LIN_MODE_ENDTX		(1 << 4)
/** USART1_IER_LIN_MODE_ENDRX  **/
#define USART1_IER_LIN_MODE_ENDRX		(1 << 3)
/** USART1_IER_LIN_MODE_TXRDY TXRDY Interrupt Enable **/
#define USART1_IER_LIN_MODE_TXRDY		(1 << 1)
/** USART1_IER_LIN_MODE_RXRDY RXRDY Interrupt Enable **/
#define USART1_IER_LIN_MODE_RXRDY		(1 << 0)
...
/** USART1_IDR_NACK Non Acknowledge Interrupt Disable **/
...
/** USART1_IDR_SPI_MODE_RXBUFF  **/
#define USART1_IDR_SPI_MODE_RXBUFF		(1 << 12)
/** USART1_IDR_SPI_MODE_TXBUFE  **/
#define USART1_IDR_SPI_MODE_TXBUFE		(1 << 11)
...
/** USART1_IDR_SPI_MODE_ENDTX  **/
#define USART1_IDR_SPI_MODE_ENDTX		(1 << 4)
/** USART1_IDR_SPI_MODE_ENDRX  **/
#define USART1_IDR_SPI_MODE_ENDRX		(1 << 3)
...
/** @defgroup usart1_idr_lin_mode IDRLINMODE Interrupt Disable Register
@{*/

/** USART1_IDR_LIN_MODE_LINSNRE LIN Slave Not Responding Error Interrupt Disable **/
#define USART1_IDR_LIN_MODE_LINSNRE		(1 << 29)
/** USART1_IDR_LIN_MODE_LINCE LIN Checksum Error Interrupt Disable **/
#define USART1_IDR_LIN_MODE_LINCE		(1 << 28)
/** USART1_IDR_LIN_MODE_LINIPE LIN Identifier Parity Interrupt Disable **/
#define USART1_IDR_LIN_MODE_LINIPE		(1 << 27)
/** USART1_IDR_LIN_MODE_LINISFE LIN Inconsistent Synch Field Error Interrupt Disable **/
#define USART1_IDR_LIN_MODE_LINISFE		(1 << 26)
/** USART1_IDR_LIN_MODE_LINBE LIN Bus Error Interrupt Disable **/
#define USART1_IDR_LIN_MODE_LINBE		(1 << 25)
/** USART1_IDR_LIN_MODE_LINTC LIN Transfer Completed Interrupt Disable **/
#define USART1_IDR_LIN_MODE_LINTC		(1 << 15)
/** USART1_IDR_LIN_MODE_LINID LIN Identifier Sent or LIN Identifier Received Interrupt Disable **/
#define USART1_IDR_LIN_MODE_LINID		(1 << 14)
/** USART1_IDR_LIN_MODE_LINBK LIN Break Sent or LIN Break Received Interrupt Disable **/
#define USART1_IDR_LIN_MODE_LINBK		(1 << 13)
/** USART1_IDR_LIN_MODE_RXBUFF  **/
#define USART1_IDR_LIN_MODE_RXBUFF		(1 << 12)
/** USART1_IDR_LIN_MODE_TXBUFE  **/
#define USART1_IDR_LIN_MODE_TXBUFE		(1 << 11)
/** USART1_IDR_LIN_MODE_TXEMPTY TXEMPTY Interrupt Disable **/
#define USART1_IDR_LIN_MODE_TXEMPTY		(1 << 9)
/** USART1_IDR_LIN_MODE_TIMEOUT Time-out Interrupt Disable **/
#define USART1_IDR_LIN_MODE_TIMEOUT		(1 << 8)
/** USART1_IDR_LIN_MODE_PARE Parity Error Interrupt Disable **/
#define USART1_IDR_LIN_MODE_PARE		(1 << 7)
/** USART1_IDR_LIN_MODE_FRAME Framing Error Interrupt Disable **/
#define USART1_IDR_LIN_MODE_FRAME		(1 << 6)
/** USART1_IDR_LIN_MODE_OVRE Overrun Error Interrupt Disable **/
#define USART1_IDR_LIN_MODE_OVRE		(1 << 5)
/** USART1_IDR_LIN_MODE_ENDTX  **/
#define USART1_IDR_LIN_MODE_ENDTX		(1 << 4)
/** USART1_IDR_LIN_MODE_ENDRX  **/
#define USART1_IDR_LIN_MODE_ENDRX		(1 << 3)
/** USART1_IDR_LIN_MODE_TXRDY TXRDY Interrupt Disable **/
#define USART1_IDR_LIN_MODE_TXRDY		(1 << 1)
/** USART1_IDR_LIN_MODE_RXRDY RXRDY Interrupt Disable **/
#define USART1_IDR_LIN_MODE_RXRDY		(1 << 0)
...
/** USART1_IMR_NACK Non Acknowledge Interrupt Mask **/
...
/** USART1_IMR_SPI_MODE_RXBUFF  **/
#define USART1_IMR_SPI_MODE_RXBUFF		(1 << 12)
/** USART1_IMR_SPI_MODE_TXBUFE  **/
#define USART1_IMR_SPI_MODE_TXBUFE		(1 << 11)
...
/** USART1_IMR_SPI_MODE_ENDTX  **/
#define USART1_IMR_SPI_MODE_ENDTX		(1 << 4)
/** USART1_IMR_SPI_MODE_ENDRX  **/
#define USART1_IMR_SPI_MODE_ENDRX		(1 << 3)
...
/** @defgroup usart1_imr_lin_mode IMRLINMODE Interrupt Mask Register
@{*/

/** USART1_IMR_LIN_MODE_LINSNRE LIN Slave Not Responding Error Interrupt Mask **/
#define USART1_IMR_LIN_MODE_LINSNRE		(1 << 29)
/** USART1_IMR_LIN_MODE_LINCE LIN Checksum Error Interrupt Mask **/
#define USART1_IMR_LIN_MODE_LINCE		(1 << 28)
/** USART1_IMR_LIN_MODE_LINIPE LIN Identifier Parity Interrupt Mask **/
#define USART1_IMR_LIN_MODE_LINIPE		(1 << 27)
/** USART1_IMR_LIN_MODE_LINISFE LIN Inconsistent Synch Field Error Interrupt Mask **/
#define USART1_IMR_LIN_MODE_LINISFE		(1 << 26)
/** USART1_IMR_LIN_MODE_LINBE LIN Bus Error Interrupt Mask **/
#define USART1_IMR_LIN_MODE_LINBE		(1 << 25)
/** USART1_IMR_LIN_MODE_LINTC LIN Transfer Completed Interrupt Mask **/
#define USART1_IMR_LIN_MODE_LINTC		(1 << 15)
/** USART1_IMR_LIN_MODE_LINID LIN Identifier Sent or LIN Identifier Received Interrupt Mask **/
#define USART1_IMR_LIN_MODE_LINID		(1 << 14)
/** USART1_IMR_LIN_MODE_LINBK LIN Break Sent or LIN Break Received Interrupt Mask **/
#define USART1_IMR_LIN_MODE_LINBK		(1 << 13)
/** USART1_IMR_LIN_MODE_RXBUFF  **/
#define USART1_IMR_LIN_MODE_RXBUFF		(1 << 12)
/** USART1_IMR_LIN_MODE_TXBUFE  **/
#define USART1_IMR_LIN_MODE_TXBUFE		(1 << 11)
/** USART1_IMR_LIN_MODE_TXEMPTY TXEMPTY Interrupt Mask **/
#define USART1_IMR_LIN_MODE_TXEMPTY		(1 << 9)
/** USART1_IMR_LIN_MODE_TIMEOUT Time-out Interrupt Mask **/
#define USART1_IMR_LIN_MODE_TIMEOUT		(1 << 8)
/** USART1_IMR_LIN_MODE_PARE Parity Error Interrupt Mask **/
#define USART1_IMR_LIN_MODE_PARE		(1 << 7)
/** USART1_IMR_LIN_MODE_FRAME Framing Error Interrupt Mask **/
#define USART1_IMR_LIN_MODE_FRAME		(1 << 6)
/** USART1_IMR_LIN_MODE_OVRE Overrun Error Interrupt Mask **/
#define USART1_IMR_LIN_MODE_OVRE		(1 << 5)
/** USART1_IMR_LIN_MODE_ENDTX  **/
#define USART1_IMR_LIN_MODE_ENDTX		(1 << 4)
/** USART1_IMR_LIN_MODE_ENDRX  **/
#define USART1_IMR_LIN_MODE_ENDRX		(1 << 3)
/** USART1_IMR_LIN_MODE_TXRDY TXRDY Interrupt Mask **/
#define USART1_IMR_LIN_MODE_TXRDY		(1 << 1)
/** USART1_IMR_LIN_MODE_RXRDY RXRDY Interrupt Mask **/
#define USART1_IMR_LIN_MODE_RXRDY		(1 << 0)
...
/** USART1_CSR_NACK Non Acknowledge Interrupt **/
...
/** USART1_CSR_ITER Max Number of Repetitions Reached **/
...
/** USART1_CSR_SPI_MODE_RXBUFF  **/
#define USART1_CSR_SPI_MODE_RXBUFF		(1 << 12)
/** USART1_CSR_SPI_MODE_TXBUFE  **/
#define USART1_CSR_SPI_MODE_TXBUFE		(1 << 11)
...
/** USART1_CSR_SPI_MODE_ENDTX  **/
#define USART1_CSR_SPI_MODE_ENDTX		(1 << 4)
/** USART1_CSR_SPI_MODE_ENDRX  **/
#define USART1_CSR_SPI_MODE_ENDRX		(1 << 3)
...
/** @defgroup usart1_csr_lin_mode CSRLINMODE Channel Status Register
@{*/

/** USART1_CSR_LIN_MODE_LINSNRE LIN Slave Not Responding Error **/
#define USART1_CSR_LIN_MODE_LINSNRE		(1 << 29)
/** USART1_CSR_LIN_MODE_LINCE LIN Checksum Error **/
#define USART1_CSR_LIN_MODE_LINCE		(1 << 28)
/** USART1_CSR_LIN_MODE_LINIPE LIN Identifier Parity Error **/
#define USART1_CSR_LIN_MODE_LINIPE		(1 << 27)
/** USART1_CSR_LIN_MODE_LINISFE LIN Inconsistent Synch Field Error **/
#define USART1_CSR_LIN_MODE_LINISFE		(1 << 26)
/** USART1_CSR_LIN_MODE_LINBE LIN Bit Error **/
#define USART1_CSR_LIN_MODE_LINBE		(1 << 25)
/** USART1_CSR_LIN_MODE_LINBLS LIN Bus Line Status **/
#define USART1_CSR_LIN_MODE_LINBLS		(1 << 23)
/** USART1_CSR_LIN_MODE_LINTC LIN Transfer Completed **/
#define USART1_CSR_LIN_MODE_LINTC		(1 << 15)
/** USART1_CSR_LIN_MODE_LINID LIN Identifier Sent or LIN Identifier Received **/
#define USART1_CSR_LIN_MODE_LINID		(1 << 14)
/** USART1_CSR_LIN_MODE_LINBK LIN Break Sent or LIN Break Received **/
#define USART1_CSR_LIN_MODE_LINBK		(1 << 13)
/** USART1_CSR_LIN_MODE_RXBUFF  **/
#define USART1_CSR_LIN_MODE_RXBUFF		(1 << 12)
/** USART1_CSR_LIN_MODE_TXBUFE  **/
#define USART1_CSR_LIN_MODE_TXBUFE		(1 << 11)
/** USART1_CSR_LIN_MODE_TXEMPTY Transmitter Empty **/
#define USART1_CSR_LIN_MODE_TXEMPTY		(1 << 9)
/** USART1_CSR_LIN_MODE_TIMEOUT Receiver Time-out **/
#define USART1_CSR_LIN_MODE_TIMEOUT		(1 << 8)
/** USART1_CSR_LIN_MODE_PARE Parity Error **/
#define USART1_CSR_LIN_MODE_PARE		(1 << 7)
/** USART1_CSR_LIN_MODE_FRAME Framing Error **/
#define USART1_CSR_LIN_MODE_FRAME		(1 << 6)
/** USART1_CSR_LIN_MODE_OVRE Overrun Error **/
#define USART1_CSR_LIN_MODE_OVRE		(1 << 5)
/** USART1_CSR_LIN_MODE_ENDTX  **/
#define USART1_CSR_LIN_MODE_ENDTX		(1 << 4)
/** USART1_CSR_LIN_MODE_ENDRX  **/
#define USART1_CSR_LIN_MODE_ENDRX		(1 << 3)
/** USART1_CSR_LIN_MODE_TXRDY Transmitter Ready **/
#define USART1_CSR_LIN_MODE_TXRDY		(1 << 1)
/** USART1_CSR_LIN_MODE_RXRDY Receiver Ready **/
#define USART1_CSR_LIN_MODE_RXRDY		(1 << 0)

/**@}*/

/** @defgroup usart1_rhr RHR Receive Holding Register
@{*/
...
/** @defgroup usart1_thr THR Transmit Holding Register
@{*/
...
#define USART1_RTOR_TO_MASK		0x1ffff
...
/** @defgroup usart1_man MAN Manchester Configuration Register
@{*/
...
/** @defgroup usart1_linmr LINMR LIN Mode Register
@{*/

/** USART1_LINMR_PDCM PDC Mode **/
#define USART1_LINMR_PDCM		(1 << 16)

#define USART1_LINMR_DLC_SHIFT		8
#define USART1_LINMR_DLC_MASK		0xff
/** @defgroup usart1_linmr_dlc DLC Data Length Control
@{*/
/**@}*/

/** USART1_LINMR_WKUPTYP Wakeup Signal Type **/
#define USART1_LINMR_WKUPTYP		(1 << 7)
/** USART1_LINMR_FSDIS Frame Slot Mode Disable **/
#define USART1_LINMR_FSDIS		(1 << 6)
/** USART1_LINMR_DLM Data Length Mode **/
#define USART1_LINMR_DLM		(1 << 5)
/** USART1_LINMR_CHKTYP Checksum Type **/
#define USART1_LINMR_CHKTYP		(1 << 4)
/** USART1_LINMR_CHKDIS Checksum Disable **/
#define USART1_LINMR_CHKDIS		(1 << 3)
/** USART1_LINMR_PARDIS Parity Disable **/
#define USART1_LINMR_PARDIS		(1 << 2)

#define USART1_LINMR_NACT_SHIFT		0
#define USART1_LINMR_NACT_MASK		0x03
/** @defgroup usart1_linmr_nact NACT LIN Node Action
@{*/
/**@}*/
...
/** @defgroup usart1_linir LINIR LIN Identifier Register
@{*/


#define USART1_LINIR_IDCHR_SHIFT		0
#define USART1_LINIR_IDCHR_MASK		0xff
/** @defgroup usart1_linir_idchr IDCHR Identifier Character
@{*/
/**@}*/
...
/** @defgroup usart1_linbrr LINBRR LIN Baud Rate Register
@{*/


#define USART1_LINBRR_LINFP_SHIFT		16
#define USART1_LINBRR_LINFP_MASK		0x07
/** @defgroup usart1_linbrr_linfp LINFP Fractional Part after Synchronization
@{*/
/**@}*/


#define USART1_LINBRR_LINCD_SHIFT		0
#define USART1_LINBRR_LINCD_MASK		0xffff
/** @defgroup usart1_linbrr_lincd LINCD Clock Divider after Synchronization
@{*/
/**@}*/
...
/** @defgroup usart1_wpmr WPMR Write Protection Mode Register
@{*/


#define USART1_WPMR_WPKEY_SHIFT		8
#define USART1_WPMR_WPKEY_MASK		0xffffff
/** @defgroup usart1_wpmr_wpkey WPKEY Write Protection Key
@{*/
/**@}*/

/** USART1_WPMR_WPEN Write Protection Enable **/
#define USART1_WPMR_WPEN		(1 << 0)

/**@}*/

/** @defgroup usart1_wpsr WPSR Write Protection Status Register
@{*/


#define USART1_WPSR_WPVSRC_SHIFT		8
#define USART1_WPSR_WPVSRC_MASK		0xffff
/** @defgroup usart1_wpsr_wpvsrc WPVSRC Write Protection Violation Source
@{*/
/**@}*/

/** USART1_WPSR_WPVS Write Protection Violation Status **/
