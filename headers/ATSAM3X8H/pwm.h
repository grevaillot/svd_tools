...
/** PWM_FPE1 PWM Fault Protection Enable Register 1 **/
#define PWM_FPE1			MMIO32(PWM_BASE + 0x6c)
/** PWM_FPE2 PWM Fault Protection Enable Register 2 **/
#define PWM_FPE2			MMIO32(PWM_BASE + 0x70)
...
/** PWM_CMR4 PWM Channel Mode Register (ch_num = 4) **/
#define PWM_CMR4			MMIO32(PWM_BASE + 0x280)
/** PWM_CDTY4 PWM Channel Duty Cycle Register (ch_num = 4) **/
#define PWM_CDTY4			MMIO32(PWM_BASE + 0x284)
/** PWM_CDTYUPD4 PWM Channel Duty Cycle Update Register (ch_num = 4) **/
#define PWM_CDTYUPD4			MMIO32(PWM_BASE + 0x288)
/** PWM_CPRD4 PWM Channel Period Register (ch_num = 4) **/
#define PWM_CPRD4			MMIO32(PWM_BASE + 0x28c)
/** PWM_CPRDUPD4 PWM Channel Period Update Register (ch_num = 4) **/
#define PWM_CPRDUPD4			MMIO32(PWM_BASE + 0x290)
/** PWM_CCNT4 PWM Channel Counter Register (ch_num = 4) **/
#define PWM_CCNT4			MMIO32(PWM_BASE + 0x294)
/** PWM_DT4 PWM Channel Dead Time Register (ch_num = 4) **/
#define PWM_DT4			MMIO32(PWM_BASE + 0x298)
/** PWM_DTUPD4 PWM Channel Dead Time Update Register (ch_num = 4) **/
#define PWM_DTUPD4			MMIO32(PWM_BASE + 0x29c)
/** PWM_CMR5 PWM Channel Mode Register (ch_num = 5) **/
#define PWM_CMR5			MMIO32(PWM_BASE + 0x2a0)
/** PWM_CDTY5 PWM Channel Duty Cycle Register (ch_num = 5) **/
#define PWM_CDTY5			MMIO32(PWM_BASE + 0x2a4)
/** PWM_CDTYUPD5 PWM Channel Duty Cycle Update Register (ch_num = 5) **/
#define PWM_CDTYUPD5			MMIO32(PWM_BASE + 0x2a8)
/** PWM_CPRD5 PWM Channel Period Register (ch_num = 5) **/
#define PWM_CPRD5			MMIO32(PWM_BASE + 0x2ac)
/** PWM_CPRDUPD5 PWM Channel Period Update Register (ch_num = 5) **/
#define PWM_CPRDUPD5			MMIO32(PWM_BASE + 0x2b0)
/** PWM_CCNT5 PWM Channel Counter Register (ch_num = 5) **/
#define PWM_CCNT5			MMIO32(PWM_BASE + 0x2b4)
/** PWM_DT5 PWM Channel Dead Time Register (ch_num = 5) **/
#define PWM_DT5			MMIO32(PWM_BASE + 0x2b8)
/** PWM_DTUPD5 PWM Channel Dead Time Update Register (ch_num = 5) **/
#define PWM_DTUPD5			MMIO32(PWM_BASE + 0x2bc)
/** PWM_CMR6 PWM Channel Mode Register (ch_num = 6) **/
#define PWM_CMR6			MMIO32(PWM_BASE + 0x2c0)
/** PWM_CDTY6 PWM Channel Duty Cycle Register (ch_num = 6) **/
#define PWM_CDTY6			MMIO32(PWM_BASE + 0x2c4)
/** PWM_CDTYUPD6 PWM Channel Duty Cycle Update Register (ch_num = 6) **/
#define PWM_CDTYUPD6			MMIO32(PWM_BASE + 0x2c8)
/** PWM_CPRD6 PWM Channel Period Register (ch_num = 6) **/
#define PWM_CPRD6			MMIO32(PWM_BASE + 0x2cc)
/** PWM_CPRDUPD6 PWM Channel Period Update Register (ch_num = 6) **/
#define PWM_CPRDUPD6			MMIO32(PWM_BASE + 0x2d0)
/** PWM_CCNT6 PWM Channel Counter Register (ch_num = 6) **/
#define PWM_CCNT6			MMIO32(PWM_BASE + 0x2d4)
/** PWM_DT6 PWM Channel Dead Time Register (ch_num = 6) **/
#define PWM_DT6			MMIO32(PWM_BASE + 0x2d8)
/** PWM_DTUPD6 PWM Channel Dead Time Update Register (ch_num = 6) **/
#define PWM_DTUPD6			MMIO32(PWM_BASE + 0x2dc)
/** PWM_CMR7 PWM Channel Mode Register (ch_num = 7) **/
#define PWM_CMR7			MMIO32(PWM_BASE + 0x2e0)
/** PWM_CDTY7 PWM Channel Duty Cycle Register (ch_num = 7) **/
#define PWM_CDTY7			MMIO32(PWM_BASE + 0x2e4)
/** PWM_CDTYUPD7 PWM Channel Duty Cycle Update Register (ch_num = 7) **/
#define PWM_CDTYUPD7			MMIO32(PWM_BASE + 0x2e8)
/** PWM_CPRD7 PWM Channel Period Register (ch_num = 7) **/
#define PWM_CPRD7			MMIO32(PWM_BASE + 0x2ec)
/** PWM_CPRDUPD7 PWM Channel Period Update Register (ch_num = 7) **/
#define PWM_CPRDUPD7			MMIO32(PWM_BASE + 0x2f0)
/** PWM_CCNT7 PWM Channel Counter Register (ch_num = 7) **/
#define PWM_CCNT7			MMIO32(PWM_BASE + 0x2f4)
/** PWM_DT7 PWM Channel Dead Time Register (ch_num = 7) **/
#define PWM_DT7			MMIO32(PWM_BASE + 0x2f8)
/** PWM_DTUPD7 PWM Channel Dead Time Update Register (ch_num = 7) **/
#define PWM_DTUPD7			MMIO32(PWM_BASE + 0x2fc)
...
/** PWM_ENA_CHID7 Channel ID **/
#define PWM_ENA_CHID7		(1 << 7)
/** PWM_ENA_CHID6 Channel ID **/
#define PWM_ENA_CHID6		(1 << 6)
/** PWM_ENA_CHID5 Channel ID **/
#define PWM_ENA_CHID5		(1 << 5)
/** PWM_ENA_CHID4 Channel ID **/
#define PWM_ENA_CHID4		(1 << 4)
...
/** PWM_DIS_CHID7 Channel ID **/
#define PWM_DIS_CHID7		(1 << 7)
/** PWM_DIS_CHID6 Channel ID **/
#define PWM_DIS_CHID6		(1 << 6)
/** PWM_DIS_CHID5 Channel ID **/
#define PWM_DIS_CHID5		(1 << 5)
/** PWM_DIS_CHID4 Channel ID **/
#define PWM_DIS_CHID4		(1 << 4)
...
/** PWM_SR_CHID7 Channel ID **/
#define PWM_SR_CHID7		(1 << 7)
/** PWM_SR_CHID6 Channel ID **/
#define PWM_SR_CHID6		(1 << 6)
/** PWM_SR_CHID5 Channel ID **/
#define PWM_SR_CHID5		(1 << 5)
/** PWM_SR_CHID4 Channel ID **/
#define PWM_SR_CHID4		(1 << 4)
...
/** PWM_IER1_FCHID7 Fault Protection Trigger on Channel 7 Interrupt Enable **/
#define PWM_IER1_FCHID7		(1 << 23)
/** PWM_IER1_FCHID6 Fault Protection Trigger on Channel 6 Interrupt Enable **/
#define PWM_IER1_FCHID6		(1 << 22)
/** PWM_IER1_FCHID5 Fault Protection Trigger on Channel 5 Interrupt Enable **/
#define PWM_IER1_FCHID5		(1 << 21)
/** PWM_IER1_FCHID4 Fault Protection Trigger on Channel 4 Interrupt Enable **/
#define PWM_IER1_FCHID4		(1 << 20)
...
/** PWM_IER1_CHID7 Counter Event on Channel 7 Interrupt Enable **/
#define PWM_IER1_CHID7		(1 << 7)
/** PWM_IER1_CHID6 Counter Event on Channel 6 Interrupt Enable **/
#define PWM_IER1_CHID6		(1 << 6)
/** PWM_IER1_CHID5 Counter Event on Channel 5 Interrupt Enable **/
#define PWM_IER1_CHID5		(1 << 5)
/** PWM_IER1_CHID4 Counter Event on Channel 4 Interrupt Enable **/
#define PWM_IER1_CHID4		(1 << 4)
...
/** PWM_IDR1_FCHID7 Fault Protection Trigger on Channel 7 Interrupt Disable **/
#define PWM_IDR1_FCHID7		(1 << 23)
/** PWM_IDR1_FCHID6 Fault Protection Trigger on Channel 6 Interrupt Disable **/
#define PWM_IDR1_FCHID6		(1 << 22)
/** PWM_IDR1_FCHID5 Fault Protection Trigger on Channel 5 Interrupt Disable **/
#define PWM_IDR1_FCHID5		(1 << 21)
/** PWM_IDR1_FCHID4 Fault Protection Trigger on Channel 4 Interrupt Disable **/
#define PWM_IDR1_FCHID4		(1 << 20)
...
/** PWM_IDR1_CHID7 Counter Event on Channel 7 Interrupt Disable **/
#define PWM_IDR1_CHID7		(1 << 7)
/** PWM_IDR1_CHID6 Counter Event on Channel 6 Interrupt Disable **/
#define PWM_IDR1_CHID6		(1 << 6)
/** PWM_IDR1_CHID5 Counter Event on Channel 5 Interrupt Disable **/
#define PWM_IDR1_CHID5		(1 << 5)
/** PWM_IDR1_CHID4 Counter Event on Channel 4 Interrupt Disable **/
#define PWM_IDR1_CHID4		(1 << 4)
...
/** PWM_IMR1_FCHID7 Fault Protection Trigger on Channel 7 Interrupt Mask **/
#define PWM_IMR1_FCHID7		(1 << 23)
/** PWM_IMR1_FCHID6 Fault Protection Trigger on Channel 6 Interrupt Mask **/
#define PWM_IMR1_FCHID6		(1 << 22)
/** PWM_IMR1_FCHID5 Fault Protection Trigger on Channel 5 Interrupt Mask **/
#define PWM_IMR1_FCHID5		(1 << 21)
/** PWM_IMR1_FCHID4 Fault Protection Trigger on Channel 4 Interrupt Mask **/
#define PWM_IMR1_FCHID4		(1 << 20)
...
/** PWM_IMR1_CHID7 Counter Event on Channel 7 Interrupt Mask **/
#define PWM_IMR1_CHID7		(1 << 7)
/** PWM_IMR1_CHID6 Counter Event on Channel 6 Interrupt Mask **/
#define PWM_IMR1_CHID6		(1 << 6)
/** PWM_IMR1_CHID5 Counter Event on Channel 5 Interrupt Mask **/
#define PWM_IMR1_CHID5		(1 << 5)
/** PWM_IMR1_CHID4 Counter Event on Channel 4 Interrupt Mask **/
#define PWM_IMR1_CHID4		(1 << 4)
...
/** PWM_ISR1_FCHID7 Fault Protection Trigger on Channel 7 **/
#define PWM_ISR1_FCHID7		(1 << 23)
/** PWM_ISR1_FCHID6 Fault Protection Trigger on Channel 6 **/
#define PWM_ISR1_FCHID6		(1 << 22)
/** PWM_ISR1_FCHID5 Fault Protection Trigger on Channel 5 **/
#define PWM_ISR1_FCHID5		(1 << 21)
/** PWM_ISR1_FCHID4 Fault Protection Trigger on Channel 4 **/
#define PWM_ISR1_FCHID4		(1 << 20)
...
/** PWM_ISR1_CHID7 Counter Event on Channel 7 **/
#define PWM_ISR1_CHID7		(1 << 7)
/** PWM_ISR1_CHID6 Counter Event on Channel 6 **/
#define PWM_ISR1_CHID6		(1 << 6)
/** PWM_ISR1_CHID5 Counter Event on Channel 5 **/
#define PWM_ISR1_CHID5		(1 << 5)
/** PWM_ISR1_CHID4 Counter Event on Channel 4 **/
#define PWM_ISR1_CHID4		(1 << 4)
...
/** PWM_SCM_SYNC7 Synchronous Channel 7 **/
#define PWM_SCM_SYNC7		(1 << 7)
/** PWM_SCM_SYNC6 Synchronous Channel 6 **/
#define PWM_SCM_SYNC6		(1 << 6)
/** PWM_SCM_SYNC5 Synchronous Channel 5 **/
#define PWM_SCM_SYNC5		(1 << 5)
/** PWM_SCM_SYNC4 Synchronous Channel 4 **/
#define PWM_SCM_SYNC4		(1 << 4)
...
/** PWM_OOV_OOVL7 Output Override Value for PWML output of the channel 7 **/
#define PWM_OOV_OOVL7		(1 << 23)
/** PWM_OOV_OOVL6 Output Override Value for PWML output of the channel 6 **/
#define PWM_OOV_OOVL6		(1 << 22)
/** PWM_OOV_OOVL5 Output Override Value for PWML output of the channel 5 **/
#define PWM_OOV_OOVL5		(1 << 21)
/** PWM_OOV_OOVL4 Output Override Value for PWML output of the channel 4 **/
#define PWM_OOV_OOVL4		(1 << 20)
...
/** PWM_OOV_OOVH7 Output Override Value for PWMH output of the channel 7 **/
#define PWM_OOV_OOVH7		(1 << 7)
/** PWM_OOV_OOVH6 Output Override Value for PWMH output of the channel 6 **/
#define PWM_OOV_OOVH6		(1 << 6)
/** PWM_OOV_OOVH5 Output Override Value for PWMH output of the channel 5 **/
#define PWM_OOV_OOVH5		(1 << 5)
/** PWM_OOV_OOVH4 Output Override Value for PWMH output of the channel 4 **/
#define PWM_OOV_OOVH4		(1 << 4)
...
/** PWM_OS_OSL7 Output Selection for PWML output of the channel 7 **/
#define PWM_OS_OSL7		(1 << 23)
/** PWM_OS_OSL6 Output Selection for PWML output of the channel 6 **/
#define PWM_OS_OSL6		(1 << 22)
/** PWM_OS_OSL5 Output Selection for PWML output of the channel 5 **/
#define PWM_OS_OSL5		(1 << 21)
/** PWM_OS_OSL4 Output Selection for PWML output of the channel 4 **/
#define PWM_OS_OSL4		(1 << 20)
...
/** PWM_OS_OSH7 Output Selection for PWMH output of the channel 7 **/
#define PWM_OS_OSH7		(1 << 7)
/** PWM_OS_OSH6 Output Selection for PWMH output of the channel 6 **/
#define PWM_OS_OSH6		(1 << 6)
/** PWM_OS_OSH5 Output Selection for PWMH output of the channel 5 **/
#define PWM_OS_OSH5		(1 << 5)
/** PWM_OS_OSH4 Output Selection for PWMH output of the channel 4 **/
#define PWM_OS_OSH4		(1 << 4)
...
/** PWM_OSS_OSSL7 Output Selection Set for PWML output of the channel 7 **/
#define PWM_OSS_OSSL7		(1 << 23)
/** PWM_OSS_OSSL6 Output Selection Set for PWML output of the channel 6 **/
#define PWM_OSS_OSSL6		(1 << 22)
/** PWM_OSS_OSSL5 Output Selection Set for PWML output of the channel 5 **/
#define PWM_OSS_OSSL5		(1 << 21)
/** PWM_OSS_OSSL4 Output Selection Set for PWML output of the channel 4 **/
#define PWM_OSS_OSSL4		(1 << 20)
...
/** PWM_OSS_OSSH7 Output Selection Set for PWMH output of the channel 7 **/
#define PWM_OSS_OSSH7		(1 << 7)
/** PWM_OSS_OSSH6 Output Selection Set for PWMH output of the channel 6 **/
#define PWM_OSS_OSSH6		(1 << 6)
/** PWM_OSS_OSSH5 Output Selection Set for PWMH output of the channel 5 **/
#define PWM_OSS_OSSH5		(1 << 5)
/** PWM_OSS_OSSH4 Output Selection Set for PWMH output of the channel 4 **/
#define PWM_OSS_OSSH4		(1 << 4)
...
/** PWM_OSC_OSCL7 Output Selection Clear for PWML output of the channel 7 **/
#define PWM_OSC_OSCL7		(1 << 23)
/** PWM_OSC_OSCL6 Output Selection Clear for PWML output of the channel 6 **/
#define PWM_OSC_OSCL6		(1 << 22)
/** PWM_OSC_OSCL5 Output Selection Clear for PWML output of the channel 5 **/
#define PWM_OSC_OSCL5		(1 << 21)
/** PWM_OSC_OSCL4 Output Selection Clear for PWML output of the channel 4 **/
#define PWM_OSC_OSCL4		(1 << 20)
...
/** PWM_OSC_OSCH7 Output Selection Clear for PWMH output of the channel 7 **/
#define PWM_OSC_OSCH7		(1 << 7)
/** PWM_OSC_OSCH6 Output Selection Clear for PWMH output of the channel 6 **/
#define PWM_OSC_OSCH6		(1 << 6)
/** PWM_OSC_OSCH5 Output Selection Clear for PWMH output of the channel 5 **/
#define PWM_OSC_OSCH5		(1 << 5)
/** PWM_OSC_OSCH4 Output Selection Clear for PWMH output of the channel 4 **/
#define PWM_OSC_OSCH4		(1 << 4)
...
/** PWM_OSSUPD_OSSUPL7 Output Selection Set for PWML output of the channel 7 **/
#define PWM_OSSUPD_OSSUPL7		(1 << 23)
/** PWM_OSSUPD_OSSUPL6 Output Selection Set for PWML output of the channel 6 **/
#define PWM_OSSUPD_OSSUPL6		(1 << 22)
/** PWM_OSSUPD_OSSUPL5 Output Selection Set for PWML output of the channel 5 **/
#define PWM_OSSUPD_OSSUPL5		(1 << 21)
/** PWM_OSSUPD_OSSUPL4 Output Selection Set for PWML output of the channel 4 **/
#define PWM_OSSUPD_OSSUPL4		(1 << 20)
...
/** PWM_OSSUPD_OSSUPH7 Output Selection Set for PWMH output of the channel 7 **/
#define PWM_OSSUPD_OSSUPH7		(1 << 7)
/** PWM_OSSUPD_OSSUPH6 Output Selection Set for PWMH output of the channel 6 **/
#define PWM_OSSUPD_OSSUPH6		(1 << 6)
/** PWM_OSSUPD_OSSUPH5 Output Selection Set for PWMH output of the channel 5 **/
#define PWM_OSSUPD_OSSUPH5		(1 << 5)
/** PWM_OSSUPD_OSSUPH4 Output Selection Set for PWMH output of the channel 4 **/
#define PWM_OSSUPD_OSSUPH4		(1 << 4)
...
/** PWM_OSCUPD_OSCUPL7 Output Selection Clear for PWML output of the channel 7 **/
#define PWM_OSCUPD_OSCUPL7		(1 << 23)
/** PWM_OSCUPD_OSCUPL6 Output Selection Clear for PWML output of the channel 6 **/
#define PWM_OSCUPD_OSCUPL6		(1 << 22)
/** PWM_OSCUPD_OSCUPL5 Output Selection Clear for PWML output of the channel 5 **/
#define PWM_OSCUPD_OSCUPL5		(1 << 21)
/** PWM_OSCUPD_OSCUPL4 Output Selection Clear for PWML output of the channel 4 **/
#define PWM_OSCUPD_OSCUPL4		(1 << 20)
...
/** PWM_OSCUPD_OSCUPH7 Output Selection Clear for PWMH output of the channel 7 **/
#define PWM_OSCUPD_OSCUPH7		(1 << 7)
/** PWM_OSCUPD_OSCUPH6 Output Selection Clear for PWMH output of the channel 6 **/
#define PWM_OSCUPD_OSCUPH6		(1 << 6)
/** PWM_OSCUPD_OSCUPH5 Output Selection Clear for PWMH output of the channel 5 **/
#define PWM_OSCUPD_OSCUPH5		(1 << 5)
/** PWM_OSCUPD_OSCUPH4 Output Selection Clear for PWMH output of the channel 4 **/
#define PWM_OSCUPD_OSCUPH4		(1 << 4)
...
/** PWM_FPV_FPVL7 Fault Protection Value for PWML output on channel 7 **/
#define PWM_FPV_FPVL7		(1 << 23)
/** PWM_FPV_FPVL6 Fault Protection Value for PWML output on channel 6 **/
#define PWM_FPV_FPVL6		(1 << 22)
/** PWM_FPV_FPVL5 Fault Protection Value for PWML output on channel 5 **/
#define PWM_FPV_FPVL5		(1 << 21)
/** PWM_FPV_FPVL4 Fault Protection Value for PWML output on channel 4 **/
#define PWM_FPV_FPVL4		(1 << 20)
...
/** PWM_FPV_FPVH7 Fault Protection Value for PWMH output on channel 7 **/
#define PWM_FPV_FPVH7		(1 << 7)
/** PWM_FPV_FPVH6 Fault Protection Value for PWMH output on channel 6 **/
#define PWM_FPV_FPVH6		(1 << 6)
/** PWM_FPV_FPVH5 Fault Protection Value for PWMH output on channel 5 **/
#define PWM_FPV_FPVH5		(1 << 5)
/** PWM_FPV_FPVH4 Fault Protection Value for PWMH output on channel 4 **/
#define PWM_FPV_FPVH4		(1 << 4)
...
/** @defgroup pwm_fpe1 FPE1 PWM Fault Protection Enable Register 1
@{*/


#define PWM_FPE1_FPE3_SHIFT		24
#define PWM_FPE1_FPE3_MASK		0xff
/** @defgroup pwm_fpe1_fpe3 FPE3 Fault Protection Enable for channel 3 (fault input bit varies from 0 to 5)
@{*/
/**@}*/


#define PWM_FPE1_FPE2_SHIFT		16
#define PWM_FPE1_FPE2_MASK		0xff
/** @defgroup pwm_fpe1_fpe2 FPE2 Fault Protection Enable for channel 2 (fault input bit varies from 0 to 5)
@{*/
/**@}*/


#define PWM_FPE1_FPE1_SHIFT		8
#define PWM_FPE1_FPE1_MASK		0xff
/** @defgroup pwm_fpe1_fpe1 FPE1 Fault Protection Enable for channel 1 (fault input bit varies from 0 to 5)
@{*/
/**@}*/


#define PWM_FPE1_FPE0_SHIFT		0
#define PWM_FPE1_FPE0_MASK		0xff
/** @defgroup pwm_fpe1_fpe0 FPE0 Fault Protection Enable for channel 0 (fault input bit varies from 0 to 5)
@{*/
/**@}*/
...
/** @defgroup pwm_fpe2 FPE2 PWM Fault Protection Enable Register 2
@{*/


#define PWM_FPE2_FPE7_SHIFT		24
#define PWM_FPE2_FPE7_MASK		0xff
/** @defgroup pwm_fpe2_fpe7 FPE7 Fault Protection Enable for channel 7 (fault input bit varies from 0 to 5)
@{*/
/**@}*/


#define PWM_FPE2_FPE6_SHIFT		16
#define PWM_FPE2_FPE6_MASK		0xff
/** @defgroup pwm_fpe2_fpe6 FPE6 Fault Protection Enable for channel 6 (fault input bit varies from 0 to 5)
@{*/
/**@}*/


#define PWM_FPE2_FPE5_SHIFT		8
#define PWM_FPE2_FPE5_MASK		0xff
/** @defgroup pwm_fpe2_fpe5 FPE5 Fault Protection Enable for channel 5 (fault input bit varies from 0 to 5)
@{*/
/**@}*/


#define PWM_FPE2_FPE4_SHIFT		0
#define PWM_FPE2_FPE4_MASK		0xff
/** @defgroup pwm_fpe2_fpe4 FPE4 Fault Protection Enable for channel 4 (fault input bit varies from 0 to 5)
@{*/
/**@}*/
...
/** PWM_SMMR_DOWN3 DOWN Count **/
#define PWM_SMMR_DOWN3		(1 << 19)
/** PWM_SMMR_DOWN2 DOWN Count **/
#define PWM_SMMR_DOWN2		(1 << 18)
/** PWM_SMMR_DOWN1 DOWN Count **/
#define PWM_SMMR_DOWN1		(1 << 17)
/** PWM_SMMR_DOWN0 DOWN Count **/
#define PWM_SMMR_DOWN0		(1 << 16)
/** PWM_SMMR_GCEN3 Gray Count ENable **/
#define PWM_SMMR_GCEN3		(1 << 3)
/** PWM_SMMR_GCEN2 Gray Count ENable **/
#define PWM_SMMR_GCEN2		(1 << 2)
...
/** @defgroup pwm_cmr4 CMR4 PWM Channel Mode Register (ch_num = 4)
@{*/

/** PWM_CMR4_DTLI Dead-Time PWMLx Output Inverted **/
#define PWM_CMR4_DTLI		(1 << 18)
/** PWM_CMR4_DTHI Dead-Time PWMHx Output Inverted **/
#define PWM_CMR4_DTHI		(1 << 17)
/** PWM_CMR4_DTE Dead-Time Generator Enable **/
#define PWM_CMR4_DTE		(1 << 16)
/** PWM_CMR4_CES Counter Event Selection **/
#define PWM_CMR4_CES		(1 << 10)
/** PWM_CMR4_CPOL Channel Polarity **/
#define PWM_CMR4_CPOL		(1 << 9)
/** PWM_CMR4_CALG Channel Alignment **/
#define PWM_CMR4_CALG		(1 << 8)

#define PWM_CMR4_CPRE_SHIFT		0
#define PWM_CMR4_CPRE_MASK		0x0f
/** @defgroup pwm_cmr4_cpre CPRE Channel Pre-scaler
@{*/
/**@}*/
...
/** @defgroup pwm_cdty4 CDTY4 PWM Channel Duty Cycle Register (ch_num = 4)
@{*/


#define PWM_CDTY4_CDTY_SHIFT		0
#define PWM_CDTY4_CDTY_MASK		0xffffff
/** @defgroup pwm_cdty4_cdty CDTY Channel Duty-Cycle
@{*/
/**@}*/
...
/** @defgroup pwm_cdtyupd4 CDTYUPD4 PWM Channel Duty Cycle Update Register (ch_num = 4)
@{*/


#define PWM_CDTYUPD4_CDTYUPD_SHIFT		0
#define PWM_CDTYUPD4_CDTYUPD_MASK		0xffffff
/** @defgroup pwm_cdtyupd4_cdtyupd CDTYUPD Channel Duty-Cycle Update
@{*/
/**@}*/
...
/** @defgroup pwm_cprd4 CPRD4 PWM Channel Period Register (ch_num = 4)
@{*/


#define PWM_CPRD4_CPRD_SHIFT		0
#define PWM_CPRD4_CPRD_MASK		0xffffff
/** @defgroup pwm_cprd4_cprd CPRD Channel Period
@{*/
/**@}*/
...
/** @defgroup pwm_cprdupd4 CPRDUPD4 PWM Channel Period Update Register (ch_num = 4)
@{*/


#define PWM_CPRDUPD4_CPRDUPD_SHIFT		0
#define PWM_CPRDUPD4_CPRDUPD_MASK		0xffffff
/** @defgroup pwm_cprdupd4_cprdupd CPRDUPD Channel Period Update
@{*/
/**@}*/
...
/** @defgroup pwm_ccnt4 CCNT4 PWM Channel Counter Register (ch_num = 4)
@{*/


#define PWM_CCNT4_CNT_SHIFT		0
#define PWM_CCNT4_CNT_MASK		0xffffff
/** @defgroup pwm_ccnt4_cnt CNT Channel Counter Register
@{*/
/**@}*/
...
/** @defgroup pwm_dt4 DT4 PWM Channel Dead Time Register (ch_num = 4)
@{*/


#define PWM_DT4_DTL_SHIFT		16
#define PWM_DT4_DTL_MASK		0xffff
/** @defgroup pwm_dt4_dtl DTL Dead-Time Value for PWMLx Output
@{*/
/**@}*/


#define PWM_DT4_DTH_SHIFT		0
#define PWM_DT4_DTH_MASK		0xffff
/** @defgroup pwm_dt4_dth DTH Dead-Time Value for PWMHx Output
@{*/
/**@}*/
...
/** @defgroup pwm_dtupd4 DTUPD4 PWM Channel Dead Time Update Register (ch_num = 4)
@{*/


#define PWM_DTUPD4_DTLUPD_SHIFT		16
#define PWM_DTUPD4_DTLUPD_MASK		0xffff
/** @defgroup pwm_dtupd4_dtlupd DTLUPD Dead-Time Value Update for PWMLx Output
@{*/
/**@}*/


#define PWM_DTUPD4_DTHUPD_SHIFT		0
#define PWM_DTUPD4_DTHUPD_MASK		0xffff
/** @defgroup pwm_dtupd4_dthupd DTHUPD Dead-Time Value Update for PWMHx Output
@{*/
/**@}*/
...
/** @defgroup pwm_cmr5 CMR5 PWM Channel Mode Register (ch_num = 5)
@{*/

/** PWM_CMR5_DTLI Dead-Time PWMLx Output Inverted **/
#define PWM_CMR5_DTLI		(1 << 18)
/** PWM_CMR5_DTHI Dead-Time PWMHx Output Inverted **/
#define PWM_CMR5_DTHI		(1 << 17)
/** PWM_CMR5_DTE Dead-Time Generator Enable **/
#define PWM_CMR5_DTE		(1 << 16)
/** PWM_CMR5_CES Counter Event Selection **/
#define PWM_CMR5_CES		(1 << 10)
/** PWM_CMR5_CPOL Channel Polarity **/
#define PWM_CMR5_CPOL		(1 << 9)
/** PWM_CMR5_CALG Channel Alignment **/
#define PWM_CMR5_CALG		(1 << 8)

#define PWM_CMR5_CPRE_SHIFT		0
#define PWM_CMR5_CPRE_MASK		0x0f
/** @defgroup pwm_cmr5_cpre CPRE Channel Pre-scaler
@{*/
/**@}*/
...
/** @defgroup pwm_cdty5 CDTY5 PWM Channel Duty Cycle Register (ch_num = 5)
@{*/


#define PWM_CDTY5_CDTY_SHIFT		0
#define PWM_CDTY5_CDTY_MASK		0xffffff
/** @defgroup pwm_cdty5_cdty CDTY Channel Duty-Cycle
@{*/
/**@}*/
...
/** @defgroup pwm_cdtyupd5 CDTYUPD5 PWM Channel Duty Cycle Update Register (ch_num = 5)
@{*/


#define PWM_CDTYUPD5_CDTYUPD_SHIFT		0
#define PWM_CDTYUPD5_CDTYUPD_MASK		0xffffff
/** @defgroup pwm_cdtyupd5_cdtyupd CDTYUPD Channel Duty-Cycle Update
@{*/
/**@}*/
...
/** @defgroup pwm_cprd5 CPRD5 PWM Channel Period Register (ch_num = 5)
@{*/


#define PWM_CPRD5_CPRD_SHIFT		0
#define PWM_CPRD5_CPRD_MASK		0xffffff
/** @defgroup pwm_cprd5_cprd CPRD Channel Period
@{*/
/**@}*/
...
/** @defgroup pwm_cprdupd5 CPRDUPD5 PWM Channel Period Update Register (ch_num = 5)
@{*/


#define PWM_CPRDUPD5_CPRDUPD_SHIFT		0
#define PWM_CPRDUPD5_CPRDUPD_MASK		0xffffff
/** @defgroup pwm_cprdupd5_cprdupd CPRDUPD Channel Period Update
@{*/
/**@}*/
...
/** @defgroup pwm_ccnt5 CCNT5 PWM Channel Counter Register (ch_num = 5)
@{*/


#define PWM_CCNT5_CNT_SHIFT		0
#define PWM_CCNT5_CNT_MASK		0xffffff
/** @defgroup pwm_ccnt5_cnt CNT Channel Counter Register
@{*/
/**@}*/
...
/** @defgroup pwm_dt5 DT5 PWM Channel Dead Time Register (ch_num = 5)
@{*/


#define PWM_DT5_DTL_SHIFT		16
#define PWM_DT5_DTL_MASK		0xffff
/** @defgroup pwm_dt5_dtl DTL Dead-Time Value for PWMLx Output
@{*/
/**@}*/


#define PWM_DT5_DTH_SHIFT		0
#define PWM_DT5_DTH_MASK		0xffff
/** @defgroup pwm_dt5_dth DTH Dead-Time Value for PWMHx Output
@{*/
/**@}*/
...
/** @defgroup pwm_dtupd5 DTUPD5 PWM Channel Dead Time Update Register (ch_num = 5)
@{*/


#define PWM_DTUPD5_DTLUPD_SHIFT		16
#define PWM_DTUPD5_DTLUPD_MASK		0xffff
/** @defgroup pwm_dtupd5_dtlupd DTLUPD Dead-Time Value Update for PWMLx Output
@{*/
/**@}*/


#define PWM_DTUPD5_DTHUPD_SHIFT		0
#define PWM_DTUPD5_DTHUPD_MASK		0xffff
/** @defgroup pwm_dtupd5_dthupd DTHUPD Dead-Time Value Update for PWMHx Output
@{*/
/**@}*/
...
/** @defgroup pwm_cmr6 CMR6 PWM Channel Mode Register (ch_num = 6)
@{*/

/** PWM_CMR6_DTLI Dead-Time PWMLx Output Inverted **/
#define PWM_CMR6_DTLI		(1 << 18)
/** PWM_CMR6_DTHI Dead-Time PWMHx Output Inverted **/
#define PWM_CMR6_DTHI		(1 << 17)
/** PWM_CMR6_DTE Dead-Time Generator Enable **/
#define PWM_CMR6_DTE		(1 << 16)
/** PWM_CMR6_CES Counter Event Selection **/
#define PWM_CMR6_CES		(1 << 10)
/** PWM_CMR6_CPOL Channel Polarity **/
#define PWM_CMR6_CPOL		(1 << 9)
/** PWM_CMR6_CALG Channel Alignment **/
#define PWM_CMR6_CALG		(1 << 8)

#define PWM_CMR6_CPRE_SHIFT		0
#define PWM_CMR6_CPRE_MASK		0x0f
/** @defgroup pwm_cmr6_cpre CPRE Channel Pre-scaler
@{*/
/**@}*/
...
/** @defgroup pwm_cdty6 CDTY6 PWM Channel Duty Cycle Register (ch_num = 6)
@{*/


#define PWM_CDTY6_CDTY_SHIFT		0
#define PWM_CDTY6_CDTY_MASK		0xffffff
/** @defgroup pwm_cdty6_cdty CDTY Channel Duty-Cycle
@{*/
/**@}*/
...
/** @defgroup pwm_cdtyupd6 CDTYUPD6 PWM Channel Duty Cycle Update Register (ch_num = 6)
@{*/


#define PWM_CDTYUPD6_CDTYUPD_SHIFT		0
#define PWM_CDTYUPD6_CDTYUPD_MASK		0xffffff
/** @defgroup pwm_cdtyupd6_cdtyupd CDTYUPD Channel Duty-Cycle Update
@{*/
/**@}*/
...
/** @defgroup pwm_cprd6 CPRD6 PWM Channel Period Register (ch_num = 6)
@{*/


#define PWM_CPRD6_CPRD_SHIFT		0
#define PWM_CPRD6_CPRD_MASK		0xffffff
/** @defgroup pwm_cprd6_cprd CPRD Channel Period
@{*/
/**@}*/
...
/** @defgroup pwm_cprdupd6 CPRDUPD6 PWM Channel Period Update Register (ch_num = 6)
@{*/


#define PWM_CPRDUPD6_CPRDUPD_SHIFT		0
#define PWM_CPRDUPD6_CPRDUPD_MASK		0xffffff
/** @defgroup pwm_cprdupd6_cprdupd CPRDUPD Channel Period Update
@{*/
/**@}*/
...
/** @defgroup pwm_ccnt6 CCNT6 PWM Channel Counter Register (ch_num = 6)
@{*/


#define PWM_CCNT6_CNT_SHIFT		0
#define PWM_CCNT6_CNT_MASK		0xffffff
/** @defgroup pwm_ccnt6_cnt CNT Channel Counter Register
@{*/
/**@}*/
...
/** @defgroup pwm_dt6 DT6 PWM Channel Dead Time Register (ch_num = 6)
@{*/


#define PWM_DT6_DTL_SHIFT		16
#define PWM_DT6_DTL_MASK		0xffff
/** @defgroup pwm_dt6_dtl DTL Dead-Time Value for PWMLx Output
@{*/
/**@}*/


#define PWM_DT6_DTH_SHIFT		0
#define PWM_DT6_DTH_MASK		0xffff
/** @defgroup pwm_dt6_dth DTH Dead-Time Value for PWMHx Output
@{*/
/**@}*/
...
/** @defgroup pwm_dtupd6 DTUPD6 PWM Channel Dead Time Update Register (ch_num = 6)
@{*/


#define PWM_DTUPD6_DTLUPD_SHIFT		16
#define PWM_DTUPD6_DTLUPD_MASK		0xffff
/** @defgroup pwm_dtupd6_dtlupd DTLUPD Dead-Time Value Update for PWMLx Output
@{*/
/**@}*/


#define PWM_DTUPD6_DTHUPD_SHIFT		0
#define PWM_DTUPD6_DTHUPD_MASK		0xffff
/** @defgroup pwm_dtupd6_dthupd DTHUPD Dead-Time Value Update for PWMHx Output
@{*/
/**@}*/
...
/** @defgroup pwm_cmr7 CMR7 PWM Channel Mode Register (ch_num = 7)
@{*/

/** PWM_CMR7_DTLI Dead-Time PWMLx Output Inverted **/
#define PWM_CMR7_DTLI		(1 << 18)
/** PWM_CMR7_DTHI Dead-Time PWMHx Output Inverted **/
#define PWM_CMR7_DTHI		(1 << 17)
/** PWM_CMR7_DTE Dead-Time Generator Enable **/
#define PWM_CMR7_DTE		(1 << 16)
/** PWM_CMR7_CES Counter Event Selection **/
#define PWM_CMR7_CES		(1 << 10)
/** PWM_CMR7_CPOL Channel Polarity **/
#define PWM_CMR7_CPOL		(1 << 9)
/** PWM_CMR7_CALG Channel Alignment **/
#define PWM_CMR7_CALG		(1 << 8)

#define PWM_CMR7_CPRE_SHIFT		0
#define PWM_CMR7_CPRE_MASK		0x0f
/** @defgroup pwm_cmr7_cpre CPRE Channel Pre-scaler
@{*/
/**@}*/
...
/** @defgroup pwm_cdty7 CDTY7 PWM Channel Duty Cycle Register (ch_num = 7)
@{*/


#define PWM_CDTY7_CDTY_SHIFT		0
#define PWM_CDTY7_CDTY_MASK		0xffffff
/** @defgroup pwm_cdty7_cdty CDTY Channel Duty-Cycle
@{*/
/**@}*/
...
/** @defgroup pwm_cdtyupd7 CDTYUPD7 PWM Channel Duty Cycle Update Register (ch_num = 7)
@{*/


#define PWM_CDTYUPD7_CDTYUPD_SHIFT		0
#define PWM_CDTYUPD7_CDTYUPD_MASK		0xffffff
/** @defgroup pwm_cdtyupd7_cdtyupd CDTYUPD Channel Duty-Cycle Update
@{*/
/**@}*/
...
/** @defgroup pwm_cprd7 CPRD7 PWM Channel Period Register (ch_num = 7)
@{*/


#define PWM_CPRD7_CPRD_SHIFT		0
#define PWM_CPRD7_CPRD_MASK		0xffffff
/** @defgroup pwm_cprd7_cprd CPRD Channel Period
@{*/
/**@}*/
...
/** @defgroup pwm_cprdupd7 CPRDUPD7 PWM Channel Period Update Register (ch_num = 7)
@{*/


#define PWM_CPRDUPD7_CPRDUPD_SHIFT		0
#define PWM_CPRDUPD7_CPRDUPD_MASK		0xffffff
/** @defgroup pwm_cprdupd7_cprdupd CPRDUPD Channel Period Update
@{*/
/**@}*/
...
/** @defgroup pwm_ccnt7 CCNT7 PWM Channel Counter Register (ch_num = 7)
@{*/


#define PWM_CCNT7_CNT_SHIFT		0
#define PWM_CCNT7_CNT_MASK		0xffffff
/** @defgroup pwm_ccnt7_cnt CNT Channel Counter Register
@{*/
/**@}*/
...
/** @defgroup pwm_dt7 DT7 PWM Channel Dead Time Register (ch_num = 7)
@{*/


#define PWM_DT7_DTL_SHIFT		16
#define PWM_DT7_DTL_MASK		0xffff
/** @defgroup pwm_dt7_dtl DTL Dead-Time Value for PWMLx Output
@{*/
/**@}*/


#define PWM_DT7_DTH_SHIFT		0
#define PWM_DT7_DTH_MASK		0xffff
/** @defgroup pwm_dt7_dth DTH Dead-Time Value for PWMHx Output
@{*/
/**@}*/
...
/** @defgroup pwm_dtupd7 DTUPD7 PWM Channel Dead Time Update Register (ch_num = 7)
@{*/


#define PWM_DTUPD7_DTLUPD_SHIFT		16
#define PWM_DTUPD7_DTLUPD_MASK		0xffff
/** @defgroup pwm_dtupd7_dtlupd DTLUPD Dead-Time Value Update for PWMLx Output
@{*/
/**@}*/


#define PWM_DTUPD7_DTHUPD_SHIFT		0
#define PWM_DTUPD7_DTHUPD_MASK		0xffff
/** @defgroup pwm_dtupd7_dthupd DTHUPD Dead-Time Value Update for PWMHx Output
@{*/
/**@}*/
