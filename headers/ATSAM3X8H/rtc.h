...
/** RTC_WPMR Write Protect Mode Register **/
#define RTC_WPMR			MMIO32(RTC_BASE + 0xe4)
...
/** @defgroup rtc_wpmr WPMR Write Protect Mode Register
@{*/


#define RTC_WPMR_WPKEY_SHIFT		8
#define RTC_WPMR_WPKEY_MASK		0xffffff
/** @defgroup rtc_wpmr_wpkey WPKEY Write Protect KEY
@{*/
/**@}*/

/** RTC_WPMR_WPEN Write Protect Enable **/
