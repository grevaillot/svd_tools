...
#define HSMCI_DMA			MMIO32(HSMCI_BASE + 0x50)
...
/** HSMCI_SR_UNRE Underrun **/
#define HSMCI_SR_UNRE		(1 << 31)
/** HSMCI_SR_OVRE Overrun **/
#define HSMCI_SR_OVRE		(1 << 30)
/** HSMCI_SR_ACKRCVE Boot Operation Acknowledge Error **/
#define HSMCI_SR_ACKRCVE		(1 << 29)
/** HSMCI_SR_ACKRCV Boot Operation Acknowledge Received **/
...
/** HSMCI_SR_DMADONE DMA Transfer done **/
#define HSMCI_SR_DMADONE		(1 << 25)
/** HSMCI_SR_BLKOVRE DMA Block Overrun Error **/
#define HSMCI_SR_BLKOVRE		(1 << 24)
/** HSMCI_SR_CSTOE Completion Signal Time-out Error **/
#define HSMCI_SR_CSTOE		(1 << 23)
/** HSMCI_SR_DTOE Data Time-out Error **/
#define HSMCI_SR_DTOE		(1 << 22)
/** HSMCI_SR_DCRCE Data CRC Error **/
#define HSMCI_SR_DCRCE		(1 << 21)
/** HSMCI_SR_RTOE Response Time-out Error **/
#define HSMCI_SR_RTOE		(1 << 20)
/** HSMCI_SR_RENDE Response End Bit Error **/
#define HSMCI_SR_RENDE		(1 << 19)
/** HSMCI_SR_RCRCE Response CRC Error **/
#define HSMCI_SR_RCRCE		(1 << 18)
/** HSMCI_SR_RDIRE Response Direction Error **/
#define HSMCI_SR_RDIRE		(1 << 17)
/** HSMCI_SR_RINDE Response Index Error **/
#define HSMCI_SR_RINDE		(1 << 16)
/** HSMCI_SR_CSRCV CE-ATA Completion Signal Received **/
#define HSMCI_SR_CSRCV		(1 << 13)
/** HSMCI_SR_SDIOWAIT SDIO Read Wait Operation Status **/
#define HSMCI_SR_SDIOWAIT		(1 << 12)
/** HSMCI_SR_SDIOIRQforSlotB  **/
#define HSMCI_SR_SDIOIRQforSlotB		(1 << 9)
/** HSMCI_SR_SDIOIRQforSlotA  **/
#define HSMCI_SR_SDIOIRQforSlotA		(1 << 8)
/** HSMCI_SR_NOTBUSY HSMCI Not Busy **/
#define HSMCI_SR_NOTBUSY		(1 << 5)
/** HSMCI_SR_DTIP Data Transfer in Progress **/
#define HSMCI_SR_DTIP		(1 << 4)
/** HSMCI_SR_BLKE Data Block Ended **/
#define HSMCI_SR_BLKE		(1 << 3)
/** HSMCI_SR_TXRDY Transmit Ready **/
#define HSMCI_SR_TXRDY		(1 << 2)
/** HSMCI_SR_RXRDY Receiver Ready **/
#define HSMCI_SR_RXRDY		(1 << 1)
/** HSMCI_SR_CMDRDY Command Ready **/
...
/** HSMCI_IER_DMADONE DMA Transfer completed Interrupt Enable **/
#define HSMCI_IER_DMADONE		(1 << 25)
/** HSMCI_IER_BLKOVRE DMA Block Overrun Error Interrupt Enable **/
...
/** HSMCI_IER_SDIOIRQforSlotB  **/
#define HSMCI_IER_SDIOIRQforSlotB		(1 << 9)
/** HSMCI_IER_SDIOIRQforSlotA  **/
#define HSMCI_IER_SDIOIRQforSlotA		(1 << 8)
...
/** HSMCI_IDR_DMADONE DMA Transfer completed Interrupt Disable **/
#define HSMCI_IDR_DMADONE		(1 << 25)
/** HSMCI_IDR_BLKOVRE DMA Block Overrun Error Interrupt Disable **/
...
/** HSMCI_IDR_SDIOIRQforSlotB  **/
#define HSMCI_IDR_SDIOIRQforSlotB		(1 << 9)
/** HSMCI_IDR_SDIOIRQforSlotA  **/
#define HSMCI_IDR_SDIOIRQforSlotA		(1 << 8)
...
/** HSMCI_IMR_DMADONE DMA Transfer Completed Interrupt Mask **/
#define HSMCI_IMR_DMADONE		(1 << 25)
/** HSMCI_IMR_BLKOVRE DMA Block Overrun Error Interrupt Mask **/
...
/** HSMCI_IMR_SDIOIRQforSlotB  **/
#define HSMCI_IMR_SDIOIRQforSlotB		(1 << 9)
/** HSMCI_IMR_SDIOIRQforSlotA  **/
#define HSMCI_IMR_SDIOIRQforSlotA		(1 << 8)
...
/** @defgroup hsmci_dma DMA DMA Configuration Register
@{*/

/** HSMCI_DMA_ROPT Read Optimization with padding **/
#define HSMCI_DMA_ROPT		(1 << 12)
/** HSMCI_DMA_DMAEN DMA Hardware Handshaking Enable **/
#define HSMCI_DMA_DMAEN		(1 << 8)
/** HSMCI_DMA_CHKSIZE DMA Channel Read and Write Chunk Size **/
#define HSMCI_DMA_CHKSIZE		(1 << 4)

#define HSMCI_DMA_OFFSET_SHIFT		0
#define HSMCI_DMA_OFFSET_MASK		0x03
/** @defgroup hsmci_dma_offset OFFSET DMA Write Buffer Offset
@{*/
/**@}*/
