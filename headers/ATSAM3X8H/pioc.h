...
/** PIOC_ABSR Peripheral AB Select Register **/
#define PIOC_ABSR			MMIO32(PIOC_BASE + 0x70)
/** PIOC_SCIFSR System Clock Glitch Input Filter Select Register **/
#define PIOC_SCIFSR			MMIO32(PIOC_BASE + 0x80)
/** PIOC_DIFSR Debouncing Input Filter Select Register **/
#define PIOC_DIFSR			MMIO32(PIOC_BASE + 0x84)
/** PIOC_IFDGSR Glitch or Debouncing Input Filter Clock Selection Status Register **/
#define PIOC_IFDGSR			MMIO32(PIOC_BASE + 0x88)
...
/** PIOC_AIMDR Additional Interrupt Modes Disables Register **/
...
/** PIOC_WPMR Write Protect Mode Register **/
#define PIOC_WPMR			MMIO32(PIOC_BASE + 0xe4)
/** PIOC_WPSR Write Protect Status Register **/
...
/** PIOC_IFSR_P31 Input Filer Status **/
#define PIOC_IFSR_P31		(1 << 31)
/** PIOC_IFSR_P30 Input Filer Status **/
#define PIOC_IFSR_P30		(1 << 30)
/** PIOC_IFSR_P29 Input Filer Status **/
#define PIOC_IFSR_P29		(1 << 29)
/** PIOC_IFSR_P28 Input Filer Status **/
#define PIOC_IFSR_P28		(1 << 28)
/** PIOC_IFSR_P27 Input Filer Status **/
#define PIOC_IFSR_P27		(1 << 27)
/** PIOC_IFSR_P26 Input Filer Status **/
#define PIOC_IFSR_P26		(1 << 26)
/** PIOC_IFSR_P25 Input Filer Status **/
#define PIOC_IFSR_P25		(1 << 25)
/** PIOC_IFSR_P24 Input Filer Status **/
#define PIOC_IFSR_P24		(1 << 24)
/** PIOC_IFSR_P23 Input Filer Status **/
#define PIOC_IFSR_P23		(1 << 23)
/** PIOC_IFSR_P22 Input Filer Status **/
#define PIOC_IFSR_P22		(1 << 22)
/** PIOC_IFSR_P21 Input Filer Status **/
#define PIOC_IFSR_P21		(1 << 21)
/** PIOC_IFSR_P20 Input Filer Status **/
#define PIOC_IFSR_P20		(1 << 20)
/** PIOC_IFSR_P19 Input Filer Status **/
#define PIOC_IFSR_P19		(1 << 19)
/** PIOC_IFSR_P18 Input Filer Status **/
#define PIOC_IFSR_P18		(1 << 18)
/** PIOC_IFSR_P17 Input Filer Status **/
#define PIOC_IFSR_P17		(1 << 17)
/** PIOC_IFSR_P16 Input Filer Status **/
#define PIOC_IFSR_P16		(1 << 16)
/** PIOC_IFSR_P15 Input Filer Status **/
#define PIOC_IFSR_P15		(1 << 15)
/** PIOC_IFSR_P14 Input Filer Status **/
#define PIOC_IFSR_P14		(1 << 14)
/** PIOC_IFSR_P13 Input Filer Status **/
#define PIOC_IFSR_P13		(1 << 13)
/** PIOC_IFSR_P12 Input Filer Status **/
#define PIOC_IFSR_P12		(1 << 12)
/** PIOC_IFSR_P11 Input Filer Status **/
#define PIOC_IFSR_P11		(1 << 11)
/** PIOC_IFSR_P10 Input Filer Status **/
#define PIOC_IFSR_P10		(1 << 10)
/** PIOC_IFSR_P9 Input Filer Status **/
#define PIOC_IFSR_P9		(1 << 9)
/** PIOC_IFSR_P8 Input Filer Status **/
#define PIOC_IFSR_P8		(1 << 8)
/** PIOC_IFSR_P7 Input Filer Status **/
#define PIOC_IFSR_P7		(1 << 7)
/** PIOC_IFSR_P6 Input Filer Status **/
#define PIOC_IFSR_P6		(1 << 6)
/** PIOC_IFSR_P5 Input Filer Status **/
#define PIOC_IFSR_P5		(1 << 5)
/** PIOC_IFSR_P4 Input Filer Status **/
#define PIOC_IFSR_P4		(1 << 4)
/** PIOC_IFSR_P3 Input Filer Status **/
#define PIOC_IFSR_P3		(1 << 3)
/** PIOC_IFSR_P2 Input Filer Status **/
#define PIOC_IFSR_P2		(1 << 2)
/** PIOC_IFSR_P1 Input Filer Status **/
#define PIOC_IFSR_P1		(1 << 1)
/** PIOC_IFSR_P0 Input Filer Status **/
...
/** @defgroup pioc_absr ABSR Peripheral AB Select Register
@{*/

/** PIOC_ABSR_P31 Peripheral A Select. **/
#define PIOC_ABSR_P31		(1 << 31)
/** PIOC_ABSR_P30 Peripheral A Select. **/
#define PIOC_ABSR_P30		(1 << 30)
/** PIOC_ABSR_P29 Peripheral A Select. **/
#define PIOC_ABSR_P29		(1 << 29)
/** PIOC_ABSR_P28 Peripheral A Select. **/
#define PIOC_ABSR_P28		(1 << 28)
/** PIOC_ABSR_P27 Peripheral A Select. **/
#define PIOC_ABSR_P27		(1 << 27)
/** PIOC_ABSR_P26 Peripheral A Select. **/
#define PIOC_ABSR_P26		(1 << 26)
/** PIOC_ABSR_P25 Peripheral A Select. **/
#define PIOC_ABSR_P25		(1 << 25)
/** PIOC_ABSR_P24 Peripheral A Select. **/
#define PIOC_ABSR_P24		(1 << 24)
/** PIOC_ABSR_P23 Peripheral A Select. **/
#define PIOC_ABSR_P23		(1 << 23)
/** PIOC_ABSR_P22 Peripheral A Select. **/
#define PIOC_ABSR_P22		(1 << 22)
/** PIOC_ABSR_P21 Peripheral A Select. **/
#define PIOC_ABSR_P21		(1 << 21)
/** PIOC_ABSR_P20 Peripheral A Select. **/
#define PIOC_ABSR_P20		(1 << 20)
/** PIOC_ABSR_P19 Peripheral A Select. **/
#define PIOC_ABSR_P19		(1 << 19)
/** PIOC_ABSR_P18 Peripheral A Select. **/
#define PIOC_ABSR_P18		(1 << 18)
/** PIOC_ABSR_P17 Peripheral A Select. **/
#define PIOC_ABSR_P17		(1 << 17)
/** PIOC_ABSR_P16 Peripheral A Select. **/
#define PIOC_ABSR_P16		(1 << 16)
/** PIOC_ABSR_P15 Peripheral A Select. **/
#define PIOC_ABSR_P15		(1 << 15)
/** PIOC_ABSR_P14 Peripheral A Select. **/
#define PIOC_ABSR_P14		(1 << 14)
/** PIOC_ABSR_P13 Peripheral A Select. **/
#define PIOC_ABSR_P13		(1 << 13)
/** PIOC_ABSR_P12 Peripheral A Select. **/
#define PIOC_ABSR_P12		(1 << 12)
/** PIOC_ABSR_P11 Peripheral A Select. **/
#define PIOC_ABSR_P11		(1 << 11)
/** PIOC_ABSR_P10 Peripheral A Select. **/
#define PIOC_ABSR_P10		(1 << 10)
/** PIOC_ABSR_P9 Peripheral A Select. **/
#define PIOC_ABSR_P9		(1 << 9)
/** PIOC_ABSR_P8 Peripheral A Select. **/
#define PIOC_ABSR_P8		(1 << 8)
/** PIOC_ABSR_P7 Peripheral A Select. **/
#define PIOC_ABSR_P7		(1 << 7)
/** PIOC_ABSR_P6 Peripheral A Select. **/
#define PIOC_ABSR_P6		(1 << 6)
/** PIOC_ABSR_P5 Peripheral A Select. **/
#define PIOC_ABSR_P5		(1 << 5)
/** PIOC_ABSR_P4 Peripheral A Select. **/
#define PIOC_ABSR_P4		(1 << 4)
/** PIOC_ABSR_P3 Peripheral A Select. **/
#define PIOC_ABSR_P3		(1 << 3)
/** PIOC_ABSR_P2 Peripheral A Select. **/
#define PIOC_ABSR_P2		(1 << 2)
/** PIOC_ABSR_P1 Peripheral A Select. **/
#define PIOC_ABSR_P1		(1 << 1)
/** PIOC_ABSR_P0 Peripheral A Select. **/
#define PIOC_ABSR_P0		(1 << 0)

/**@}*/

/** @defgroup pioc_scifsr SCIFSR System Clock Glitch Input Filter Select Register
@{*/

/** PIOC_SCIFSR_P31 System Clock Glitch Filtering Select. **/
#define PIOC_SCIFSR_P31		(1 << 31)
/** PIOC_SCIFSR_P30 System Clock Glitch Filtering Select. **/
#define PIOC_SCIFSR_P30		(1 << 30)
/** PIOC_SCIFSR_P29 System Clock Glitch Filtering Select. **/
#define PIOC_SCIFSR_P29		(1 << 29)
/** PIOC_SCIFSR_P28 System Clock Glitch Filtering Select. **/
#define PIOC_SCIFSR_P28		(1 << 28)
/** PIOC_SCIFSR_P27 System Clock Glitch Filtering Select. **/
#define PIOC_SCIFSR_P27		(1 << 27)
/** PIOC_SCIFSR_P26 System Clock Glitch Filtering Select. **/
#define PIOC_SCIFSR_P26		(1 << 26)
/** PIOC_SCIFSR_P25 System Clock Glitch Filtering Select. **/
#define PIOC_SCIFSR_P25		(1 << 25)
/** PIOC_SCIFSR_P24 System Clock Glitch Filtering Select. **/
#define PIOC_SCIFSR_P24		(1 << 24)
/** PIOC_SCIFSR_P23 System Clock Glitch Filtering Select. **/
#define PIOC_SCIFSR_P23		(1 << 23)
/** PIOC_SCIFSR_P22 System Clock Glitch Filtering Select. **/
#define PIOC_SCIFSR_P22		(1 << 22)
/** PIOC_SCIFSR_P21 System Clock Glitch Filtering Select. **/
#define PIOC_SCIFSR_P21		(1 << 21)
/** PIOC_SCIFSR_P20 System Clock Glitch Filtering Select. **/
#define PIOC_SCIFSR_P20		(1 << 20)
/** PIOC_SCIFSR_P19 System Clock Glitch Filtering Select. **/
#define PIOC_SCIFSR_P19		(1 << 19)
/** PIOC_SCIFSR_P18 System Clock Glitch Filtering Select. **/
#define PIOC_SCIFSR_P18		(1 << 18)
/** PIOC_SCIFSR_P17 System Clock Glitch Filtering Select. **/
#define PIOC_SCIFSR_P17		(1 << 17)
/** PIOC_SCIFSR_P16 System Clock Glitch Filtering Select. **/
#define PIOC_SCIFSR_P16		(1 << 16)
/** PIOC_SCIFSR_P15 System Clock Glitch Filtering Select. **/
#define PIOC_SCIFSR_P15		(1 << 15)
/** PIOC_SCIFSR_P14 System Clock Glitch Filtering Select. **/
#define PIOC_SCIFSR_P14		(1 << 14)
/** PIOC_SCIFSR_P13 System Clock Glitch Filtering Select. **/
#define PIOC_SCIFSR_P13		(1 << 13)
/** PIOC_SCIFSR_P12 System Clock Glitch Filtering Select. **/
#define PIOC_SCIFSR_P12		(1 << 12)
/** PIOC_SCIFSR_P11 System Clock Glitch Filtering Select. **/
#define PIOC_SCIFSR_P11		(1 << 11)
/** PIOC_SCIFSR_P10 System Clock Glitch Filtering Select. **/
#define PIOC_SCIFSR_P10		(1 << 10)
/** PIOC_SCIFSR_P9 System Clock Glitch Filtering Select. **/
#define PIOC_SCIFSR_P9		(1 << 9)
/** PIOC_SCIFSR_P8 System Clock Glitch Filtering Select. **/
#define PIOC_SCIFSR_P8		(1 << 8)
/** PIOC_SCIFSR_P7 System Clock Glitch Filtering Select. **/
#define PIOC_SCIFSR_P7		(1 << 7)
/** PIOC_SCIFSR_P6 System Clock Glitch Filtering Select. **/
#define PIOC_SCIFSR_P6		(1 << 6)
/** PIOC_SCIFSR_P5 System Clock Glitch Filtering Select. **/
#define PIOC_SCIFSR_P5		(1 << 5)
/** PIOC_SCIFSR_P4 System Clock Glitch Filtering Select. **/
#define PIOC_SCIFSR_P4		(1 << 4)
/** PIOC_SCIFSR_P3 System Clock Glitch Filtering Select. **/
#define PIOC_SCIFSR_P3		(1 << 3)
/** PIOC_SCIFSR_P2 System Clock Glitch Filtering Select. **/
#define PIOC_SCIFSR_P2		(1 << 2)
/** PIOC_SCIFSR_P1 System Clock Glitch Filtering Select. **/
#define PIOC_SCIFSR_P1		(1 << 1)
/** PIOC_SCIFSR_P0 System Clock Glitch Filtering Select. **/
#define PIOC_SCIFSR_P0		(1 << 0)

/**@}*/

/** @defgroup pioc_difsr DIFSR Debouncing Input Filter Select Register
@{*/

/** PIOC_DIFSR_P31 Debouncing Filtering Select. **/
#define PIOC_DIFSR_P31		(1 << 31)
/** PIOC_DIFSR_P30 Debouncing Filtering Select. **/
#define PIOC_DIFSR_P30		(1 << 30)
/** PIOC_DIFSR_P29 Debouncing Filtering Select. **/
#define PIOC_DIFSR_P29		(1 << 29)
/** PIOC_DIFSR_P28 Debouncing Filtering Select. **/
#define PIOC_DIFSR_P28		(1 << 28)
/** PIOC_DIFSR_P27 Debouncing Filtering Select. **/
#define PIOC_DIFSR_P27		(1 << 27)
/** PIOC_DIFSR_P26 Debouncing Filtering Select. **/
#define PIOC_DIFSR_P26		(1 << 26)
/** PIOC_DIFSR_P25 Debouncing Filtering Select. **/
#define PIOC_DIFSR_P25		(1 << 25)
/** PIOC_DIFSR_P24 Debouncing Filtering Select. **/
#define PIOC_DIFSR_P24		(1 << 24)
/** PIOC_DIFSR_P23 Debouncing Filtering Select. **/
#define PIOC_DIFSR_P23		(1 << 23)
/** PIOC_DIFSR_P22 Debouncing Filtering Select. **/
#define PIOC_DIFSR_P22		(1 << 22)
/** PIOC_DIFSR_P21 Debouncing Filtering Select. **/
#define PIOC_DIFSR_P21		(1 << 21)
/** PIOC_DIFSR_P20 Debouncing Filtering Select. **/
#define PIOC_DIFSR_P20		(1 << 20)
/** PIOC_DIFSR_P19 Debouncing Filtering Select. **/
#define PIOC_DIFSR_P19		(1 << 19)
/** PIOC_DIFSR_P18 Debouncing Filtering Select. **/
#define PIOC_DIFSR_P18		(1 << 18)
/** PIOC_DIFSR_P17 Debouncing Filtering Select. **/
#define PIOC_DIFSR_P17		(1 << 17)
/** PIOC_DIFSR_P16 Debouncing Filtering Select. **/
#define PIOC_DIFSR_P16		(1 << 16)
/** PIOC_DIFSR_P15 Debouncing Filtering Select. **/
#define PIOC_DIFSR_P15		(1 << 15)
/** PIOC_DIFSR_P14 Debouncing Filtering Select. **/
#define PIOC_DIFSR_P14		(1 << 14)
/** PIOC_DIFSR_P13 Debouncing Filtering Select. **/
#define PIOC_DIFSR_P13		(1 << 13)
/** PIOC_DIFSR_P12 Debouncing Filtering Select. **/
#define PIOC_DIFSR_P12		(1 << 12)
/** PIOC_DIFSR_P11 Debouncing Filtering Select. **/
#define PIOC_DIFSR_P11		(1 << 11)
/** PIOC_DIFSR_P10 Debouncing Filtering Select. **/
#define PIOC_DIFSR_P10		(1 << 10)
/** PIOC_DIFSR_P9 Debouncing Filtering Select. **/
#define PIOC_DIFSR_P9		(1 << 9)
/** PIOC_DIFSR_P8 Debouncing Filtering Select. **/
#define PIOC_DIFSR_P8		(1 << 8)
/** PIOC_DIFSR_P7 Debouncing Filtering Select. **/
#define PIOC_DIFSR_P7		(1 << 7)
/** PIOC_DIFSR_P6 Debouncing Filtering Select. **/
#define PIOC_DIFSR_P6		(1 << 6)
/** PIOC_DIFSR_P5 Debouncing Filtering Select. **/
#define PIOC_DIFSR_P5		(1 << 5)
/** PIOC_DIFSR_P4 Debouncing Filtering Select. **/
#define PIOC_DIFSR_P4		(1 << 4)
/** PIOC_DIFSR_P3 Debouncing Filtering Select. **/
#define PIOC_DIFSR_P3		(1 << 3)
/** PIOC_DIFSR_P2 Debouncing Filtering Select. **/
#define PIOC_DIFSR_P2		(1 << 2)
/** PIOC_DIFSR_P1 Debouncing Filtering Select. **/
#define PIOC_DIFSR_P1		(1 << 1)
/** PIOC_DIFSR_P0 Debouncing Filtering Select. **/
#define PIOC_DIFSR_P0		(1 << 0)

/**@}*/

/** @defgroup pioc_ifdgsr IFDGSR Glitch or Debouncing Input Filter Clock Selection Status Register
@{*/

/** PIOC_IFDGSR_P31 Glitch or Debouncing Filter Selection Status **/
#define PIOC_IFDGSR_P31		(1 << 31)
/** PIOC_IFDGSR_P30 Glitch or Debouncing Filter Selection Status **/
#define PIOC_IFDGSR_P30		(1 << 30)
/** PIOC_IFDGSR_P29 Glitch or Debouncing Filter Selection Status **/
#define PIOC_IFDGSR_P29		(1 << 29)
/** PIOC_IFDGSR_P28 Glitch or Debouncing Filter Selection Status **/
#define PIOC_IFDGSR_P28		(1 << 28)
/** PIOC_IFDGSR_P27 Glitch or Debouncing Filter Selection Status **/
#define PIOC_IFDGSR_P27		(1 << 27)
/** PIOC_IFDGSR_P26 Glitch or Debouncing Filter Selection Status **/
#define PIOC_IFDGSR_P26		(1 << 26)
/** PIOC_IFDGSR_P25 Glitch or Debouncing Filter Selection Status **/
#define PIOC_IFDGSR_P25		(1 << 25)
/** PIOC_IFDGSR_P24 Glitch or Debouncing Filter Selection Status **/
#define PIOC_IFDGSR_P24		(1 << 24)
/** PIOC_IFDGSR_P23 Glitch or Debouncing Filter Selection Status **/
#define PIOC_IFDGSR_P23		(1 << 23)
/** PIOC_IFDGSR_P22 Glitch or Debouncing Filter Selection Status **/
#define PIOC_IFDGSR_P22		(1 << 22)
/** PIOC_IFDGSR_P21 Glitch or Debouncing Filter Selection Status **/
#define PIOC_IFDGSR_P21		(1 << 21)
/** PIOC_IFDGSR_P20 Glitch or Debouncing Filter Selection Status **/
#define PIOC_IFDGSR_P20		(1 << 20)
/** PIOC_IFDGSR_P19 Glitch or Debouncing Filter Selection Status **/
#define PIOC_IFDGSR_P19		(1 << 19)
/** PIOC_IFDGSR_P18 Glitch or Debouncing Filter Selection Status **/
#define PIOC_IFDGSR_P18		(1 << 18)
/** PIOC_IFDGSR_P17 Glitch or Debouncing Filter Selection Status **/
#define PIOC_IFDGSR_P17		(1 << 17)
/** PIOC_IFDGSR_P16 Glitch or Debouncing Filter Selection Status **/
#define PIOC_IFDGSR_P16		(1 << 16)
/** PIOC_IFDGSR_P15 Glitch or Debouncing Filter Selection Status **/
#define PIOC_IFDGSR_P15		(1 << 15)
/** PIOC_IFDGSR_P14 Glitch or Debouncing Filter Selection Status **/
#define PIOC_IFDGSR_P14		(1 << 14)
/** PIOC_IFDGSR_P13 Glitch or Debouncing Filter Selection Status **/
#define PIOC_IFDGSR_P13		(1 << 13)
/** PIOC_IFDGSR_P12 Glitch or Debouncing Filter Selection Status **/
#define PIOC_IFDGSR_P12		(1 << 12)
/** PIOC_IFDGSR_P11 Glitch or Debouncing Filter Selection Status **/
#define PIOC_IFDGSR_P11		(1 << 11)
/** PIOC_IFDGSR_P10 Glitch or Debouncing Filter Selection Status **/
#define PIOC_IFDGSR_P10		(1 << 10)
/** PIOC_IFDGSR_P9 Glitch or Debouncing Filter Selection Status **/
#define PIOC_IFDGSR_P9		(1 << 9)
/** PIOC_IFDGSR_P8 Glitch or Debouncing Filter Selection Status **/
#define PIOC_IFDGSR_P8		(1 << 8)
/** PIOC_IFDGSR_P7 Glitch or Debouncing Filter Selection Status **/
#define PIOC_IFDGSR_P7		(1 << 7)
/** PIOC_IFDGSR_P6 Glitch or Debouncing Filter Selection Status **/
#define PIOC_IFDGSR_P6		(1 << 6)
/** PIOC_IFDGSR_P5 Glitch or Debouncing Filter Selection Status **/
#define PIOC_IFDGSR_P5		(1 << 5)
/** PIOC_IFDGSR_P4 Glitch or Debouncing Filter Selection Status **/
#define PIOC_IFDGSR_P4		(1 << 4)
/** PIOC_IFDGSR_P3 Glitch or Debouncing Filter Selection Status **/
#define PIOC_IFDGSR_P3		(1 << 3)
/** PIOC_IFDGSR_P2 Glitch or Debouncing Filter Selection Status **/
#define PIOC_IFDGSR_P2		(1 << 2)
/** PIOC_IFDGSR_P1 Glitch or Debouncing Filter Selection Status **/
#define PIOC_IFDGSR_P1		(1 << 1)
/** PIOC_IFDGSR_P0 Glitch or Debouncing Filter Selection Status **/
#define PIOC_IFDGSR_P0		(1 << 0)
...
/** @defgroup pioc_aimdr AIMDR Additional Interrupt Modes Disables Register
@{*/
...
/** PIOC_AIMMR_P31 Peripheral CD Status. **/
#define PIOC_AIMMR_P31		(1 << 31)
/** PIOC_AIMMR_P30 Peripheral CD Status. **/
#define PIOC_AIMMR_P30		(1 << 30)
/** PIOC_AIMMR_P29 Peripheral CD Status. **/
#define PIOC_AIMMR_P29		(1 << 29)
/** PIOC_AIMMR_P28 Peripheral CD Status. **/
#define PIOC_AIMMR_P28		(1 << 28)
/** PIOC_AIMMR_P27 Peripheral CD Status. **/
#define PIOC_AIMMR_P27		(1 << 27)
/** PIOC_AIMMR_P26 Peripheral CD Status. **/
#define PIOC_AIMMR_P26		(1 << 26)
/** PIOC_AIMMR_P25 Peripheral CD Status. **/
#define PIOC_AIMMR_P25		(1 << 25)
/** PIOC_AIMMR_P24 Peripheral CD Status. **/
#define PIOC_AIMMR_P24		(1 << 24)
/** PIOC_AIMMR_P23 Peripheral CD Status. **/
#define PIOC_AIMMR_P23		(1 << 23)
/** PIOC_AIMMR_P22 Peripheral CD Status. **/
#define PIOC_AIMMR_P22		(1 << 22)
/** PIOC_AIMMR_P21 Peripheral CD Status. **/
#define PIOC_AIMMR_P21		(1 << 21)
/** PIOC_AIMMR_P20 Peripheral CD Status. **/
#define PIOC_AIMMR_P20		(1 << 20)
/** PIOC_AIMMR_P19 Peripheral CD Status. **/
#define PIOC_AIMMR_P19		(1 << 19)
/** PIOC_AIMMR_P18 Peripheral CD Status. **/
#define PIOC_AIMMR_P18		(1 << 18)
/** PIOC_AIMMR_P17 Peripheral CD Status. **/
#define PIOC_AIMMR_P17		(1 << 17)
/** PIOC_AIMMR_P16 Peripheral CD Status. **/
#define PIOC_AIMMR_P16		(1 << 16)
/** PIOC_AIMMR_P15 Peripheral CD Status. **/
#define PIOC_AIMMR_P15		(1 << 15)
/** PIOC_AIMMR_P14 Peripheral CD Status. **/
#define PIOC_AIMMR_P14		(1 << 14)
/** PIOC_AIMMR_P13 Peripheral CD Status. **/
#define PIOC_AIMMR_P13		(1 << 13)
/** PIOC_AIMMR_P12 Peripheral CD Status. **/
#define PIOC_AIMMR_P12		(1 << 12)
/** PIOC_AIMMR_P11 Peripheral CD Status. **/
#define PIOC_AIMMR_P11		(1 << 11)
/** PIOC_AIMMR_P10 Peripheral CD Status. **/
#define PIOC_AIMMR_P10		(1 << 10)
/** PIOC_AIMMR_P9 Peripheral CD Status. **/
#define PIOC_AIMMR_P9		(1 << 9)
/** PIOC_AIMMR_P8 Peripheral CD Status. **/
#define PIOC_AIMMR_P8		(1 << 8)
/** PIOC_AIMMR_P7 Peripheral CD Status. **/
#define PIOC_AIMMR_P7		(1 << 7)
/** PIOC_AIMMR_P6 Peripheral CD Status. **/
#define PIOC_AIMMR_P6		(1 << 6)
/** PIOC_AIMMR_P5 Peripheral CD Status. **/
#define PIOC_AIMMR_P5		(1 << 5)
/** PIOC_AIMMR_P4 Peripheral CD Status. **/
#define PIOC_AIMMR_P4		(1 << 4)
/** PIOC_AIMMR_P3 Peripheral CD Status. **/
#define PIOC_AIMMR_P3		(1 << 3)
/** PIOC_AIMMR_P2 Peripheral CD Status. **/
#define PIOC_AIMMR_P2		(1 << 2)
/** PIOC_AIMMR_P1 Peripheral CD Status. **/
#define PIOC_AIMMR_P1		(1 << 1)
/** PIOC_AIMMR_P0 Peripheral CD Status. **/
...
/** @defgroup pioc_wpmr WPMR Write Protect Mode Register
@{*/


#define PIOC_WPMR_WPKEY_SHIFT		8
#define PIOC_WPMR_WPKEY_MASK		0xffffff
/** @defgroup pioc_wpmr_wpkey WPKEY Write Protect KEY
@{*/
/**@}*/

/** PIOC_WPMR_WPEN Write Protect Enable **/
#define PIOC_WPMR_WPEN		(1 << 0)

/**@}*/

/** @defgroup pioc_wpsr WPSR Write Protect Status Register
@{*/


#define PIOC_WPSR_WPVSRC_SHIFT		8
#define PIOC_WPSR_WPVSRC_MASK		0xffff
/** @defgroup pioc_wpsr_wpvsrc WPVSRC Write Protect Violation Source
@{*/
/**@}*/

/** PIOC_WPSR_WPVS Write Protect Violation Status **/
