...
/** PWM_WPCR PWM Write Protection Control Register **/
#define PWM_WPCR			MMIO32(PWM_BASE + 0xe4)
/** PWM_WPSR PWM Write Protection Status Register **/
...
/** @defgroup pwm_clk_preb PREB CLKB Source Clock Selection
@{*/
/**@}*/
...
/** @defgroup pwm_clk_divb DIVB CLKB Divide Factor
@{*/
/**@}*/
...
/** @defgroup pwm_clk_prea PREA CLKA Source Clock Selection
@{*/
/**@}*/
...
/** @defgroup pwm_clk_diva DIVA CLKA Divide Factor
@{*/
/**@}*/
...
/** @defgroup pwm_scm_ptrcs PTRCS Peripheral DMA Controller Transfer Request Comparison Selection
@{*/
/**@}*/

/** PWM_SCM_PTRM Peripheral DMA Controller Transfer Request Mode **/
...
/** @defgroup pwm_fmr_ffil FFIL Fault Filtering
@{*/
/**@}*/
...
/** @defgroup pwm_fmr_fmod FMOD Fault Activation Mode
@{*/
/**@}*/
...
/** @defgroup pwm_fmr_fpol FPOL Fault Polarity
@{*/
/**@}*/
...
/** @defgroup pwm_fsr_fs FS Fault Status
@{*/
/**@}*/
...
/** @defgroup pwm_fsr_fiv FIV Fault Input Value
@{*/
/**@}*/
...
/** @defgroup pwm_fcr_fclr FCLR Fault Clear
@{*/
/**@}*/
...
/** @defgroup pwm_fpe_fpe3 FPE3 Fault Protection Enable for channel 3
@{*/
/**@}*/
...
/** @defgroup pwm_fpe_fpe2 FPE2 Fault Protection Enable for channel 2
@{*/
/**@}*/
...
/** @defgroup pwm_fpe_fpe1 FPE1 Fault Protection Enable for channel 1
@{*/
/**@}*/
...
/** @defgroup pwm_fpe_fpe0 FPE0 Fault Protection Enable for channel 0
@{*/
/**@}*/
...
/** @defgroup pwm_wpcr WPCR PWM Write Protection Control Register
@{*/


#define PWM_WPCR_WPKEY_SHIFT		8
#define PWM_WPCR_WPKEY_MASK		0xffffff
/** @defgroup pwm_wpcr_wpkey WPKEY Write Protection Key
@{*/
/**@}*/

/** PWM_WPCR_WPRG5 Write Protection Register Group 5 **/
#define PWM_WPCR_WPRG5		(1 << 7)
/** PWM_WPCR_WPRG4 Write Protection Register Group 4 **/
#define PWM_WPCR_WPRG4		(1 << 6)
/** PWM_WPCR_WPRG3 Write Protection Register Group 3 **/
#define PWM_WPCR_WPRG3		(1 << 5)
/** PWM_WPCR_WPRG2 Write Protection Register Group 2 **/
#define PWM_WPCR_WPRG2		(1 << 4)
/** PWM_WPCR_WPRG1 Write Protection Register Group 1 **/
#define PWM_WPCR_WPRG1		(1 << 3)
/** PWM_WPCR_WPRG0 Write Protection Register Group 0 **/
#define PWM_WPCR_WPRG0		(1 << 2)

#define PWM_WPCR_WPCMD_SHIFT		0
#define PWM_WPCR_WPCMD_MASK		0x03
/** @defgroup pwm_wpcr_wpcmd WPCMD Write Protection Command
@{*/
/**@}*/
...
/** @defgroup pwm_wpsr WPSR PWM Write Protection Status Register
@{*/
