...
/** TWI0_SR_TXBUFE TX Buffer Empty (cleared by writing TWI_TCR or TWI_TNCR) **/
#define TWI0_SR_TXBUFE		(1 << 15)
/** TWI0_SR_RXBUFF RX Buffer Full (cleared by writing TWI_RCR or TWI_RNCR) **/
#define TWI0_SR_RXBUFF		(1 << 14)
/** TWI0_SR_ENDTX End of TX buffer (cleared by writing TWI_TCR or TWI_TNCR) **/
#define TWI0_SR_ENDTX		(1 << 13)
/** TWI0_SR_ENDRX End of RX buffer (cleared by writing TWI_RCR or TWI_RNCR) **/
#define TWI0_SR_ENDRX		(1 << 12)
/** TWI0_SR_EOSACC End Of Slave Access (cleared on read) **/
#define TWI0_SR_EOSACC		(1 << 11)
/** TWI0_SR_SCLWS Clock Wait State **/
#define TWI0_SR_SCLWS		(1 << 10)
/** TWI0_SR_ARBLST Arbitration Lost (cleared on read) **/
#define TWI0_SR_ARBLST		(1 << 9)
/** TWI0_SR_NACK Not Acknowledged (cleared on read) **/
#define TWI0_SR_NACK		(1 << 8)
/** TWI0_SR_OVRE Overrun Error (cleared on read) **/
#define TWI0_SR_OVRE		(1 << 6)
/** TWI0_SR_GACC General Call Access (cleared on read) **/
#define TWI0_SR_GACC		(1 << 5)
/** TWI0_SR_SVACC Slave Access **/
#define TWI0_SR_SVACC		(1 << 4)
/** TWI0_SR_SVREAD Slave Read **/
#define TWI0_SR_SVREAD		(1 << 3)
/** TWI0_SR_TXRDY Transmit Holding Register Ready (cleared by writing TWI_THR) **/
#define TWI0_SR_TXRDY		(1 << 2)
/** TWI0_SR_RXRDY Receive Holding Register Ready (cleared by reading TWI_RHR) **/
#define TWI0_SR_RXRDY		(1 << 1)
/** TWI0_SR_TXCOMP Transmission Completed (cleared by writing TWI_THR) **/
