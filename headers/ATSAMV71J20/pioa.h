...
/** PIOA_PIO_VERSION Version Register **/
#define PIOA_PIO_VERSION			MMIO32(PIOA_BASE + 0xfc)
...
/** @defgroup pioa_pio_version PIOVERSION Version Register
@{*/


#define PIOA_PIO_VERSION_MFN_SHIFT		16
#define PIOA_PIO_VERSION_MFN_MASK		0x07
/** @defgroup pioa_pio_version_mfn MFN Metal Fix Number
@{*/
/**@}*/


#define PIOA_PIO_VERSION_VERSION_SHIFT		0
#define PIOA_PIO_VERSION_VERSION_MASK		0xfff
/** @defgroup pioa_pio_version_version VERSION Hardware Module Version
@{*/
/**@}*/
