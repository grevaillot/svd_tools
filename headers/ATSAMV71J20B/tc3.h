...
#define TC3_TC_BMR_MAXCMP_SHIFT		26
#define TC3_TC_BMR_MAXCMP_MASK		0x0f
/** @defgroup tc3_tc_bmr_maxcmp MAXCMP Maximum Consecutive Missing Pulses
@{*/
/**@}*/
...
/** TC3_TC_BMR_AUTOC AutoCorrection of missing pulses **/
#define TC3_TC_BMR_AUTOC		(1 << 18)
...
/** TC3_TC_QIER_MPE Consecutive Missing Pulse Error **/
#define TC3_TC_QIER_MPE		(1 << 3)
...
/** TC3_TC_QIDR_MPE Consecutive Missing Pulse Error **/
#define TC3_TC_QIDR_MPE		(1 << 3)
...
/** TC3_TC_QIMR_MPE Consecutive Missing Pulse Error **/
#define TC3_TC_QIMR_MPE		(1 << 3)
...
/** TC3_TC_QISR_MPE Consecutive Missing Pulse Error **/
#define TC3_TC_QISR_MPE		(1 << 3)
