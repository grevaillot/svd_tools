...
#define ICM_ICM_CFG_DAPROT_SHIFT		24
#define ICM_ICM_CFG_DAPROT_MASK		0x3f
/** @defgroup icm_icm_cfg_daprot DAPROT Region Descriptor Area Protection
@{*/
/**@}*/


#define ICM_ICM_CFG_HAPROT_SHIFT		16
#define ICM_ICM_CFG_HAPROT_MASK		0x3f
/** @defgroup icm_icm_cfg_haprot HAPROT Region Hash Area Protection
@{*/
/**@}*/
