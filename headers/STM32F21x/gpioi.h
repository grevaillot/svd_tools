...
/** GPIOI_OTYPER_OT15 Port x configuration bit 15 **/
#define GPIOI_OTYPER_OT15		(1 << 15)
/** GPIOI_OTYPER_OT14 Port x configuration bit 14 **/
#define GPIOI_OTYPER_OT14		(1 << 14)
/** GPIOI_OTYPER_OT13 Port x configuration bit 13 **/
#define GPIOI_OTYPER_OT13		(1 << 13)
/** GPIOI_OTYPER_OT12 Port x configuration bit 12 **/
#define GPIOI_OTYPER_OT12		(1 << 12)
/** GPIOI_OTYPER_OT11 Port x configuration bit 11 **/
#define GPIOI_OTYPER_OT11		(1 << 11)
/** GPIOI_OTYPER_OT10 Port x configuration bit 10 **/
#define GPIOI_OTYPER_OT10		(1 << 10)
/** GPIOI_OTYPER_OT9 Port x configuration bit 9 **/
#define GPIOI_OTYPER_OT9		(1 << 9)
/** GPIOI_OTYPER_OT8 Port x configuration bit 8 **/
#define GPIOI_OTYPER_OT8		(1 << 8)
/** GPIOI_OTYPER_OT7 Port x configuration bit 7 **/
#define GPIOI_OTYPER_OT7		(1 << 7)
/** GPIOI_OTYPER_OT6 Port x configuration bit 6 **/
#define GPIOI_OTYPER_OT6		(1 << 6)
/** GPIOI_OTYPER_OT5 Port x configuration bit 5 **/
#define GPIOI_OTYPER_OT5		(1 << 5)
/** GPIOI_OTYPER_OT4 Port x configuration bit 4 **/
#define GPIOI_OTYPER_OT4		(1 << 4)
/** GPIOI_OTYPER_OT3 Port x configuration bit 3 **/
#define GPIOI_OTYPER_OT3		(1 << 3)
/** GPIOI_OTYPER_OT2 Port x configuration bit 2 **/
#define GPIOI_OTYPER_OT2		(1 << 2)
/** GPIOI_OTYPER_OT1 Port x configuration bit 1 **/
#define GPIOI_OTYPER_OT1		(1 << 1)
/** GPIOI_OTYPER_OT0 Port x configuration bit 0 **/
