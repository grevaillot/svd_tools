...
#define NVIC_ISER2			MMIO32(NVIC_BASE + 0x108)
...
#define NVIC_ICER2			MMIO32(NVIC_BASE + 0x188)
...
#define NVIC_ISPR2			MMIO32(NVIC_BASE + 0x208)
...
#define NVIC_ICPR2			MMIO32(NVIC_BASE + 0x288)
...
#define NVIC_IABR2			MMIO32(NVIC_BASE + 0x308)
...
#define NVIC_IPR14			MMIO32(NVIC_BASE + 0x438)
/** NVIC_IPR15 Interrupt Priority Register **/
#define NVIC_IPR15			MMIO32(NVIC_BASE + 0x43c)
/** NVIC_IPR16 Interrupt Priority Register **/
#define NVIC_IPR16			MMIO32(NVIC_BASE + 0x440)
/** NVIC_IPR17 Interrupt Priority Register **/
#define NVIC_IPR17			MMIO32(NVIC_BASE + 0x444)
/** NVIC_IPR18 Interrupt Priority Register **/
#define NVIC_IPR18			MMIO32(NVIC_BASE + 0x448)
/** NVIC_IPR19 Interrupt Priority Register **/
#define NVIC_IPR19			MMIO32(NVIC_BASE + 0x44c)
/** NVIC_IPR20 Interrupt Priority Register **/
#define NVIC_IPR20			MMIO32(NVIC_BASE + 0x450)
