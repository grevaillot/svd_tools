...
/** HASH_HR1 digest registers **/
#define HASH_HR1			MMIO32(HASH_BASE + 0x10)
/** HASH_HR2 digest registers **/
#define HASH_HR2			MMIO32(HASH_BASE + 0x14)
/** HASH_HR3 digest registers **/
#define HASH_HR3			MMIO32(HASH_BASE + 0x18)
/** HASH_HR4 digest registers **/
#define HASH_HR4			MMIO32(HASH_BASE + 0x1c)
...
/** HASH_CR_ALGO Algorithm selection **/
...
/** @defgroup hash_hr1 HR1 digest registers
@{*/


#define HASH_HR1_H1_SHIFT		0
#define HASH_HR1_H1_MASK		0xffffffff
/** @defgroup hash_hr1_h1 H1 H1
@{*/
/**@}*/
...
/** @defgroup hash_hr2 HR2 digest registers
@{*/


#define HASH_HR2_H2_SHIFT		0
#define HASH_HR2_H2_MASK		0xffffffff
/** @defgroup hash_hr2_h2 H2 H2
@{*/
/**@}*/
...
/** @defgroup hash_hr3 HR3 digest registers
@{*/


#define HASH_HR3_H3_SHIFT		0
#define HASH_HR3_H3_MASK		0xffffffff
/** @defgroup hash_hr3_h3 H3 H3
@{*/
/**@}*/
...
/** @defgroup hash_hr4 HR4 digest registers
@{*/


#define HASH_HR4_H4_SHIFT		0
#define HASH_HR4_H4_MASK		0xffffffff
/** @defgroup hash_hr4_h4 H4 H4
@{*/
/**@}*/
