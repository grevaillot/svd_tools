...
/** RCC_AHBENR_ETHMACRXEN Ethernet MAC RX clock enable **/
#define RCC_AHBENR_ETHMACRXEN		(1 << 16)
/** RCC_AHBENR_ETHMACTXEN Ethernet MAC TX clock enable **/
#define RCC_AHBENR_ETHMACTXEN		(1 << 15)
/** RCC_AHBENR_ETHMACEN Ethernet MAC clock enable **/
...
/** RCC_AHBRSTR_ETHMACRST Ethernet MAC reset **/
