...
/** @defgroup uart4_registers Universal asynchronous receiver
...
/** UART4_SR_NE Noise error flag **/
#define UART4_SR_NE		(1 << 2)
...
/** @defgroup uart4_dr DR UART4 DR
@{*/


#define UART4_DR_DR_SHIFT		0
#define UART4_DR_DR_MASK		0x1ff
/** @defgroup uart4_dr_dr DR DR
@{*/
/**@}*/
...
/** @defgroup uart4_brr BRR UART4 BRR
@{*/
...
/** @defgroup uart4_cr1 CR1 UART4 CR1
@{*/
...
/** @defgroup uart4_cr2 CR2 UART4 CR2
@{*/
...
/** @defgroup uart4_cr3 CR3 UART4 CR3
@{*/
