...
/** USART4_CR1_DEAT4 Driver Enable assertion time **/
#define USART4_CR1_DEAT4		(1 << 25)
/** USART4_CR1_DEAT3 DEAT3 **/
#define USART4_CR1_DEAT3		(1 << 24)
/** USART4_CR1_DEAT2 DEAT2 **/
#define USART4_CR1_DEAT2		(1 << 23)
/** USART4_CR1_DEAT1 DEAT1 **/
#define USART4_CR1_DEAT1		(1 << 22)
/** USART4_CR1_DEAT0 DEAT0 **/
#define USART4_CR1_DEAT0		(1 << 21)
/** USART4_CR1_DEDT4 Driver Enable de-assertion time **/
#define USART4_CR1_DEDT4		(1 << 20)
/** USART4_CR1_DEDT3 DEDT3 **/
#define USART4_CR1_DEDT3		(1 << 19)
/** USART4_CR1_DEDT2 DEDT2 **/
#define USART4_CR1_DEDT2		(1 << 18)
/** USART4_CR1_DEDT1 DEDT1 **/
#define USART4_CR1_DEDT1		(1 << 17)
/** USART4_CR1_DEDT0 DEDT0 **/
#define USART4_CR1_DEDT0		(1 << 16)
...
/** USART4_CR2_ABRMOD1 Auto baud rate mode **/
#define USART4_CR2_ABRMOD1		(1 << 22)
/** USART4_CR2_ABRMOD0 ABRMOD0 **/
#define USART4_CR2_ABRMOD0		(1 << 21)
...
/** @defgroup usart4_brr_div_mantissa DIVMantissa DIV_Mantissa
@{*/
/**@}*/
...
/** @defgroup usart4_brr_div_fraction DIVFraction DIV_Fraction
@{*/
/**@}*/
