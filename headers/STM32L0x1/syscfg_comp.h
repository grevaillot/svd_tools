...
/** @defgroup syscfg_comp_registers System configuration controller and COMP
      register Register
@{*/
...
/** SYSCFG_COMP_COMP1_CTRL Comparator 1 control and status register **/
#define SYSCFG_COMP_COMP1_CTRL			MMIO32(SYSCFG_COMP_BASE + 0x18)
/** SYSCFG_COMP_COMP2_CTRL Comparator 2 control and status register **/
#define SYSCFG_COMP_COMP2_CTRL			MMIO32(SYSCFG_COMP_BASE + 0x1c)
...
#define SYSCFG_COMP_CFGR2_CAPA_SHIFT		1
#define SYSCFG_COMP_CFGR2_CAPA_MASK		0x07
/** @defgroup syscfg_comp_cfgr2_capa CAPA Configuration of internal VLCD rail connection to optional external capacitor
@{*/
/**@}*/
...
/** @defgroup syscfg_comp_comp1_ctrl COMP1CTRL Comparator 1 control and status register
@{*/

/** SYSCFG_COMP_COMP1_CTRL_COMP1LOCK COMP1_CSR register lock bit **/
#define SYSCFG_COMP_COMP1_CTRL_COMP1LOCK		(1 << 31)
/** SYSCFG_COMP_COMP1_CTRL_COMP1VALUE Comparator 1 output status bit **/
#define SYSCFG_COMP_COMP1_CTRL_COMP1VALUE		(1 << 30)
/** SYSCFG_COMP_COMP1_CTRL_COMP1POLARITY Comparator 1 polarity selection bit **/
#define SYSCFG_COMP_COMP1_CTRL_COMP1POLARITY		(1 << 15)
/** SYSCFG_COMP_COMP1_CTRL_COMP1LPTIMIN1 Comparator 1 LPTIM input propagation bit **/
#define SYSCFG_COMP_COMP1_CTRL_COMP1LPTIMIN1		(1 << 12)
/** SYSCFG_COMP_COMP1_CTRL_COMP1WM Comparator 1 window mode selection bit **/
#define SYSCFG_COMP_COMP1_CTRL_COMP1WM		(1 << 8)

#define SYSCFG_COMP_COMP1_CTRL_COMP1INNSEL_SHIFT		4
#define SYSCFG_COMP_COMP1_CTRL_COMP1INNSEL_MASK		0x03
/** @defgroup syscfg_comp_comp1_ctrl_comp1innsel COMP1INNSEL Comparator 1 Input Minus connection configuration bit
@{*/
/**@}*/

/** SYSCFG_COMP_COMP1_CTRL_COMP1EN Comparator 1 enable bit **/
#define SYSCFG_COMP_COMP1_CTRL_COMP1EN		(1 << 0)

/**@}*/

/** @defgroup syscfg_comp_comp2_ctrl COMP2CTRL Comparator 2 control and status register
@{*/

/** SYSCFG_COMP_COMP2_CTRL_COMP2LOCK COMP2_CSR register lock bit **/
#define SYSCFG_COMP_COMP2_CTRL_COMP2LOCK		(1 << 31)
/** SYSCFG_COMP_COMP2_CTRL_COMP2VALUE Comparator 2 output status bit **/
#define SYSCFG_COMP_COMP2_CTRL_COMP2VALUE		(1 << 30)
/** SYSCFG_COMP_COMP2_CTRL_COMP2POLARITY Comparator 2 polarity selection bit **/
#define SYSCFG_COMP_COMP2_CTRL_COMP2POLARITY		(1 << 15)
/** SYSCFG_COMP_COMP2_CTRL_COMP2LPTIMIN1 Comparator 2 LPTIM input 1 propagation bit **/
#define SYSCFG_COMP_COMP2_CTRL_COMP2LPTIMIN1		(1 << 13)
/** SYSCFG_COMP_COMP2_CTRL_COMP2LPTIMIN2 Comparator 2 LPTIM input 2 propagation bit **/
#define SYSCFG_COMP_COMP2_CTRL_COMP2LPTIMIN2		(1 << 12)

#define SYSCFG_COMP_COMP2_CTRL_COMP2INPSEL_SHIFT		8
#define SYSCFG_COMP_COMP2_CTRL_COMP2INPSEL_MASK		0x07
/** @defgroup syscfg_comp_comp2_ctrl_comp2inpsel COMP2INPSEL Comparator 2 Input Plus connection configuration bit
@{*/
/**@}*/


#define SYSCFG_COMP_COMP2_CTRL_COMP2INNSEL_SHIFT		4
#define SYSCFG_COMP_COMP2_CTRL_COMP2INNSEL_MASK		0x07
/** @defgroup syscfg_comp_comp2_ctrl_comp2innsel COMP2INNSEL Comparator 2 Input Minus connection configuration bit
@{*/
/**@}*/

/** SYSCFG_COMP_COMP2_CTRL_COMP2SPEED Comparator 2 power mode selection bit **/
#define SYSCFG_COMP_COMP2_CTRL_COMP2SPEED		(1 << 3)
/** SYSCFG_COMP_COMP2_CTRL_COMP2EN Comparator 2 enable bit **/
#define SYSCFG_COMP_COMP2_CTRL_COMP2EN		(1 << 0)
