...
/** IWDG_KR Key register (IWDG_KR) **/
#define IWDG_KR			MMIO32(IWDG_BASE + 0x00)
/** IWDG_PR Prescaler register (IWDG_PR) **/
#define IWDG_PR			MMIO32(IWDG_BASE + 0x04)
/** IWDG_RLR Reload register (IWDG_RLR) **/
#define IWDG_RLR			MMIO32(IWDG_BASE + 0x08)
/** IWDG_SR Status register (IWDG_SR) **/
#define IWDG_SR			MMIO32(IWDG_BASE + 0x0c)

/**@}*/


/** @defgroup iwdg_kr KR Key register (IWDG_KR)
@{*/
...
/** @defgroup iwdg_pr PR Prescaler register (IWDG_PR)
@{*/
...
/** @defgroup iwdg_rlr RLR Reload register (IWDG_RLR)
@{*/
...
/** @defgroup iwdg_sr SR Status register (IWDG_SR)
@{*/
