...
/** AFIO_MAPR2_MISC_REMAP Miscellaneous features remapping **/
#define AFIO_MAPR2_MISC_REMAP		(1 << 13)
/** AFIO_MAPR2_TIM12_REMAP TIM12 remapping **/
#define AFIO_MAPR2_TIM12_REMAP		(1 << 12)
/** AFIO_MAPR2_TIM67_DAC_DMA_REMAP TIM67_DAC DMA remapping **/
...
/** AFIO_MAPR2_TIM1_DMA_REMAP TIM1 DMA remapping **/
#define AFIO_MAPR2_TIM1_DMA_REMAP		(1 << 4)
/** AFIO_MAPR2_CEC_REMAP CEC remapping **/
#define AFIO_MAPR2_CEC_REMAP		(1 << 3)
/** AFIO_MAPR2_TIM17_REMAP TIM17 remapping **/
#define AFIO_MAPR2_TIM17_REMAP		(1 << 2)
/** AFIO_MAPR2_TIM16_REMAP TIM16 remapping **/
#define AFIO_MAPR2_TIM16_REMAP		(1 << 1)
/** AFIO_MAPR2_TIM15_REMAP TIM15 remapping **/
