...
/** LPTIM4_LPTIM_CFGR2 LPTIM configuration register 2 **/
#define LPTIM4_LPTIM_CFGR2			MMIO32(LPTIM4_BASE + 0x24)
...
/** @defgroup lptim4_lptim_cfgr2 LPTIMCFGR2 LPTIM configuration register 2
@{*/


#define LPTIM4_LPTIM_CFGR2_IN1SEL_SHIFT		0
#define LPTIM4_LPTIM_CFGR2_IN1SEL_MASK		0x03
/** @defgroup lptim4_lptim_cfgr2_in1sel IN1SEL LPTIM Input 1 selection
@{*/
/**@}*/
