...
/** @defgroup tim2_registers General purpose timers Register
@{*/
...
#define TIM2_TISEL			MMIO32(TIM2_BASE + 0x68)
...
/** @defgroup tim2_smcr_ts_4_3 TS43 Trigger selection
@{*/
/**@}*/
...
#define TIM2_CCMR1_Input_IC2PCS_SHIFT		10
#define TIM2_CCMR1_Input_IC2PCS_MASK		0x03
/** @defgroup tim2_ccmr1_input_ic2pcs IC2PCS Input capture 2 prescaler
@{*/
/**@}*/
...
/** TIM2_CCER_CC4NP Capture/Compare 4 output Polarity **/
...
/** TIM2_CNT_CNT[31] Value depends on IUFREMAP in TIMx_CR1. **/
#define TIM2_CNT_CNT[31]		(1 << 31)

#define TIM2_CNT_CNT_H_SHIFT		16
#define TIM2_CNT_CNT_H_MASK		0x7fff
/** @defgroup tim2_cnt_cnt_h CNTH High counter value
@{*/
/**@}*/


#define TIM2_CNT_CNT_L_SHIFT		0
#define TIM2_CNT_CNT_L_MASK		0xffff
/** @defgroup tim2_cnt_cnt_l CNTL low counter value
@{*/
/**@}*/
...
#define TIM2_ARR_ARR_H_SHIFT		16
#define TIM2_ARR_ARR_H_MASK		0xffff
/** @defgroup tim2_arr_arr_h ARRH High Auto-reload value
@{*/
/**@}*/


#define TIM2_ARR_ARR_L_SHIFT		0
#define TIM2_ARR_ARR_L_MASK		0xffff
/** @defgroup tim2_arr_arr_l ARRL Low Auto-reload value
@{*/
/**@}*/
...
#define TIM2_CCR1_CCR1_H_SHIFT		16
#define TIM2_CCR1_CCR1_H_MASK		0xffff
/** @defgroup tim2_ccr1_ccr1_h CCR1H High Capture/Compare 1 value
@{*/
/**@}*/


#define TIM2_CCR1_CCR1_L_SHIFT		0
#define TIM2_CCR1_CCR1_L_MASK		0xffff
/** @defgroup tim2_ccr1_ccr1_l CCR1L Low Capture/Compare 1 value
@{*/
/**@}*/
...
#define TIM2_CCR2_CCR2_H_SHIFT		16
#define TIM2_CCR2_CCR2_H_MASK		0xffff
/** @defgroup tim2_ccr2_ccr2_h CCR2H High Capture/Compare 2 value
@{*/
/**@}*/


#define TIM2_CCR2_CCR2_L_SHIFT		0
#define TIM2_CCR2_CCR2_L_MASK		0xffff
/** @defgroup tim2_ccr2_ccr2_l CCR2L Low Capture/Compare 2 value
@{*/
/**@}*/
...
#define TIM2_CCR3_CCR3_H_SHIFT		16
#define TIM2_CCR3_CCR3_H_MASK		0xffff
/** @defgroup tim2_ccr3_ccr3_h CCR3H High Capture/Compare value
@{*/
/**@}*/


#define TIM2_CCR3_CCR3_L_SHIFT		0
#define TIM2_CCR3_CCR3_L_MASK		0xffff
/** @defgroup tim2_ccr3_ccr3_l CCR3L Low Capture/Compare value
@{*/
/**@}*/
...
#define TIM2_CCR4_CCR4_H_SHIFT		16
#define TIM2_CCR4_CCR4_H_MASK		0xffff
/** @defgroup tim2_ccr4_ccr4_h CCR4H High Capture/Compare value
@{*/
/**@}*/


#define TIM2_CCR4_CCR4_L_SHIFT		0
#define TIM2_CCR4_CCR4_L_MASK		0xffff
/** @defgroup tim2_ccr4_ccr4_l CCR4L Low Capture/Compare value
@{*/
/**@}*/
