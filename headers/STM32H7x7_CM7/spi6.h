...
/** SPI6_I2SCFGR configuration register **/
#define SPI6_I2SCFGR			MMIO32(SPI6_BASE + 0x50)
...
/** @defgroup spi6_sr SR Polynomial Register
@{*/
...
/** @defgroup spi6_crcpoly CRCPOLY Status Register
@{*/
...
/** @defgroup spi6_i2scfgr I2SCFGR configuration register
@{*/

/** SPI6_I2SCFGR_MCKOE Master clock output enable **/
#define SPI6_I2SCFGR_MCKOE		(1 << 25)
/** SPI6_I2SCFGR_ODD Odd factor for the prescaler **/
#define SPI6_I2SCFGR_ODD		(1 << 24)

#define SPI6_I2SCFGR_I2SDIV_SHIFT		16
#define SPI6_I2SCFGR_I2SDIV_MASK		0xff
/** @defgroup spi6_i2scfgr_i2sdiv I2SDIV I2S linear prescaler
@{*/
/**@}*/

/** SPI6_I2SCFGR_DATFMT Data format **/
#define SPI6_I2SCFGR_DATFMT		(1 << 14)
/** SPI6_I2SCFGR_WSINV Fixed channel length in SLAVE **/
#define SPI6_I2SCFGR_WSINV		(1 << 13)
/** SPI6_I2SCFGR_FIXCH Word select inversion **/
#define SPI6_I2SCFGR_FIXCH		(1 << 12)
/** SPI6_I2SCFGR_CKPOL Serial audio clock polarity **/
#define SPI6_I2SCFGR_CKPOL		(1 << 11)
/** SPI6_I2SCFGR_CHLEN Channel length (number of bits per audio channel) **/
#define SPI6_I2SCFGR_CHLEN		(1 << 10)

#define SPI6_I2SCFGR_DATLEN_SHIFT		8
...
#define SPI6_I2SCFGR_I2SCFG_SHIFT		1
#define SPI6_I2SCFGR_I2SCFG_MASK		0x07
/** @defgroup spi6_i2scfgr_i2scfg I2SCFG I2S configuration mode
@{*/
/**@}*/

/** SPI6_I2SCFGR_I2SMOD I2S mode selection **/
#define SPI6_I2SCFGR_I2SMOD		(1 << 0)
