...
/** @defgroup usart3_registers Universal synchronous asynchronous receiver       transmitter Register
@{*/
...
/** USART3_CR1_RXFFIE RXFFIE **/
#define USART3_CR1_RXFFIE		(1 << 31)
/** USART3_CR1_TXFEIE TXFEIE **/
#define USART3_CR1_TXFEIE		(1 << 30)
/** USART3_CR1_FIFOEN FIFOEN **/
...
/** USART3_CR2_DIS_NSS DIS_NSS **/
#define USART3_CR2_DIS_NSS		(1 << 3)
/** USART3_CR2_SLVEN SLVEN **/
...
/** @defgroup usart3_cr3_txftcfg TXFTCFG TXFTCFG
@{*/
/**@}*/

/** USART3_CR3_RXFTIE RXFTIE **/
#define USART3_CR3_RXFTIE		(1 << 28)

#define USART3_CR3_RXFTCFG_SHIFT		25
#define USART3_CR3_RXFTCFG_MASK		0x07
/** @defgroup usart3_cr3_rxftcfg RXFTCFG RXFTCFG
@{*/
/**@}*/

/** USART3_CR3_TCBGTIE TCBGTIE **/
#define USART3_CR3_TCBGTIE		(1 << 24)
/** USART3_CR3_TXFTIE TXFTIE **/
...
/** @defgroup usart3_brr_div_mantissa DIVMantissa DIV_Mantissa
@{*/
/**@}*/
...
/** @defgroup usart3_brr_div_fraction DIVFraction DIV_Fraction
@{*/
/**@}*/
...
/** USART3_ICR_TCBGTCF TCBGTCF **/
#define USART3_ICR_TCBGTCF		(1 << 7)
/** USART3_ICR_TCCF Transmission complete clear flag **/
#define USART3_ICR_TCCF		(1 << 6)
/** USART3_ICR_TXFECF TXFECF **/
...
/** @defgroup usart3_presc_prescaler PRESCALER PRESCALER
@{*/
/**@}*/
