...
/** ADC3_CFGR2 configuration register **/
...
/** ADC3_GCOMP Gain compensation Register **/
#define ADC3_GCOMP			MMIO32(ADC3_BASE + 0xc0)
...
/** ADC3_CFGR_JQDIS Injected Queue disable **/
...
/** ADC3_CFGR_ALIGN_5 ALIGN_5 **/
#define ADC3_CFGR_ALIGN_5		(1 << 5)
...
/** @defgroup adc3_cfgr2 CFGR2 configuration register
@{*/

/** ADC3_CFGR2_SMPTRIG SMPTRIG **/
#define ADC3_CFGR2_SMPTRIG		(1 << 27)
/** ADC3_CFGR2_BULB BULB **/
#define ADC3_CFGR2_BULB		(1 << 26)
/** ADC3_CFGR2_SWTRIG SWTRIG **/
#define ADC3_CFGR2_SWTRIG		(1 << 25)
/** ADC3_CFGR2_GCOMP GCOMP **/
#define ADC3_CFGR2_GCOMP		(1 << 16)
/** ADC3_CFGR2_ROVSM EXTEN **/
#define ADC3_CFGR2_ROVSM		(1 << 10)
/** ADC3_CFGR2_TROVS Triggered Regular Oversampling **/
#define ADC3_CFGR2_TROVS		(1 << 9)

#define ADC3_CFGR2_OVSS_SHIFT		5
#define ADC3_CFGR2_OVSS_MASK		0x0f
/** @defgroup adc3_cfgr2_ovss OVSS ALIGN
@{*/
/**@}*/


#define ADC3_CFGR2_OVSR_SHIFT		2
#define ADC3_CFGR2_OVSR_MASK		0x07
/** @defgroup adc3_cfgr2_ovsr OVSR RES
@{*/
/**@}*/

/** ADC3_CFGR2_JOVSE DMACFG **/
#define ADC3_CFGR2_JOVSE		(1 << 1)
/** ADC3_CFGR2_ROVSE DMAEN **/
...
/** ADC3_SMPR1_SMPPLUS Addition of one clock cycle to the sampling time **/
#define ADC3_SMPR1_SMPPLUS		(1 << 31)
...
/** @defgroup adc3_smpr1_smp0 SMP0 SMP0
@{*/
/**@}*/
...
#define ADC3_TR1_AWDFILT_SHIFT		12
#define ADC3_TR1_AWDFILT_MASK		0x07
/** @defgroup adc3_tr1_awdfilt AWDFILT AWDFILT
@{*/
/**@}*/
...
#define ADC3_DR_RDATA_MASK		0xffff
/** @defgroup adc3_dr_rdata RDATA Regular Data converted
@{*/
/**@}*/
...
/** ADC3_OFR1_SATEN SATEN **/
#define ADC3_OFR1_SATEN		(1 << 25)
/** ADC3_OFR1_OFFSETPOS OFFSETPOS **/
#define ADC3_OFR1_OFFSETPOS		(1 << 24)
...
/** ADC3_OFR2_OFFSET1_EN OFFSET1_EN **/
#define ADC3_OFR2_OFFSET1_EN		(1 << 31)

#define ADC3_OFR2_OFFSET1_CH_SHIFT		26
#define ADC3_OFR2_OFFSET1_CH_MASK		0x1f
/** @defgroup adc3_ofr2_offset1_ch OFFSET1CH OFFSET1_CH
@{*/
/**@}*/

/** ADC3_OFR2_SATEN SATEN **/
#define ADC3_OFR2_SATEN		(1 << 25)
/** ADC3_OFR2_OFFSETPOS OFFSETPOS **/
#define ADC3_OFR2_OFFSETPOS		(1 << 24)

#define ADC3_OFR2_OFFSET1_SHIFT		0
#define ADC3_OFR2_OFFSET1_MASK		0xfff
/** @defgroup adc3_ofr2_offset1 OFFSET1 OFFSET1
@{*/
/**@}*/
...
/** ADC3_OFR3_OFFSET1_EN OFFSET1_EN **/
#define ADC3_OFR3_OFFSET1_EN		(1 << 31)

#define ADC3_OFR3_OFFSET1_CH_SHIFT		26
#define ADC3_OFR3_OFFSET1_CH_MASK		0x1f
/** @defgroup adc3_ofr3_offset1_ch OFFSET1CH OFFSET1_CH
@{*/
/**@}*/

/** ADC3_OFR3_SATEN SATEN **/
#define ADC3_OFR3_SATEN		(1 << 25)
/** ADC3_OFR3_OFFSETPOS OFFSETPOS **/
#define ADC3_OFR3_OFFSETPOS		(1 << 24)

#define ADC3_OFR3_OFFSET1_SHIFT		0
#define ADC3_OFR3_OFFSET1_MASK		0xfff
/** @defgroup adc3_ofr3_offset1 OFFSET1 OFFSET1
@{*/
/**@}*/
...
/** ADC3_OFR4_OFFSET1_EN OFFSET1_EN **/
#define ADC3_OFR4_OFFSET1_EN		(1 << 31)

#define ADC3_OFR4_OFFSET1_CH_SHIFT		26
#define ADC3_OFR4_OFFSET1_CH_MASK		0x1f
/** @defgroup adc3_ofr4_offset1_ch OFFSET1CH OFFSET1_CH
@{*/
/**@}*/

/** ADC3_OFR4_SATEN SATEN **/
#define ADC3_OFR4_SATEN		(1 << 25)
/** ADC3_OFR4_OFFSETPOS OFFSETPOS **/
#define ADC3_OFR4_OFFSETPOS		(1 << 24)

#define ADC3_OFR4_OFFSET1_SHIFT		0
#define ADC3_OFR4_OFFSET1_MASK		0xfff
/** @defgroup adc3_ofr4_offset1 OFFSET1 OFFSET1
@{*/
/**@}*/
...
#define ADC3_AWD2CR_AWD2CH_MASK		0x7ffff
...
#define ADC3_AWD3CR_AWD3CH_MASK		0x7ffff
...
#define ADC3_DIFSEL_DIFSEL_1_18_SHIFT		1
#define ADC3_DIFSEL_DIFSEL_1_18_MASK		0x3ffff
/** @defgroup adc3_difsel_difsel_1_18 DIFSEL118 Differential mode for channels 15 to 1
@{*/
/**@}*/

/** ADC3_DIFSEL_DIFSEL_0 Differential mode for channels 0 **/
#define ADC3_DIFSEL_DIFSEL_0		(1 << 0)
...
/** @defgroup adc3_gcomp GCOMP Gain compensation Register
@{*/


#define ADC3_GCOMP_GCOMPCOEFF_SHIFT		0
#define ADC3_GCOMP_GCOMPCOEFF_MASK		0x3fff
/** @defgroup adc3_gcomp_gcompcoeff GCOMPCOEFF GCOMPCOEFF
@{*/
/**@}*/
