...
/** UCPD1_RXDR UCPD Rx Data Register **/
#define UCPD1_RXDR			MMIO32(UCPD1_BASE + 0x30)
/** UCPD1_RX_ORDEXT1 UCPD Rx Ordered Set Extension Register 1 **/
#define UCPD1_RX_ORDEXT1			MMIO32(UCPD1_BASE + 0x34)
/** UCPD1_RX_ORDEXT2 UCPD Rx Ordered Set Extension Register 2 **/
#define UCPD1_RX_ORDEXT2			MMIO32(UCPD1_BASE + 0x38)

/**@}*/


/** @defgroup ucpd1_cfg1 CFG1 UCPD configuration register 1
@{*/
...
/** @defgroup ucpd1_cr CR UCPD configuration register 2
@{*/
...
/** @defgroup ucpd1_rxdr RXDR UCPD Rx Data Register
@{*/
...
/** @defgroup ucpd1_rx_ordext1 RXORDEXT1 UCPD Rx Ordered Set Extension Register 1
@{*/
...
/** @defgroup ucpd1_rx_ordext2 RXORDEXT2 UCPD Rx Ordered Set Extension Register 2
@{*/
