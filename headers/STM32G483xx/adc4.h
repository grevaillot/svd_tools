...
/** ADC4_CFGR2 configuration register **/
#define ADC4_CFGR2			MMIO32(ADC4_BASE + 0x10)
...
/** ADC4_GCOMP Gain compensation Register **/
#define ADC4_GCOMP			MMIO32(ADC4_BASE + 0xc0)
...
/** ADC4_CFGR_JQDIS Injected Queue disable **/
#define ADC4_CFGR_JQDIS		(1 << 31)
...
/** ADC4_CFGR_ALIGN_5 ALIGN_5 **/
#define ADC4_CFGR_ALIGN_5		(1 << 5)
...
/** @defgroup adc4_cfgr2 CFGR2 configuration register
@{*/

/** ADC4_CFGR2_SMPTRIG SMPTRIG **/
#define ADC4_CFGR2_SMPTRIG		(1 << 27)
/** ADC4_CFGR2_BULB BULB **/
#define ADC4_CFGR2_BULB		(1 << 26)
/** ADC4_CFGR2_SWTRIG SWTRIG **/
#define ADC4_CFGR2_SWTRIG		(1 << 25)
/** ADC4_CFGR2_GCOMP GCOMP **/
#define ADC4_CFGR2_GCOMP		(1 << 16)
/** ADC4_CFGR2_ROVSM EXTEN **/
#define ADC4_CFGR2_ROVSM		(1 << 10)
/** ADC4_CFGR2_TROVS Triggered Regular Oversampling **/
#define ADC4_CFGR2_TROVS		(1 << 9)

#define ADC4_CFGR2_OVSS_SHIFT		5
#define ADC4_CFGR2_OVSS_MASK		0x0f
/** @defgroup adc4_cfgr2_ovss OVSS ALIGN
@{*/
/**@}*/


#define ADC4_CFGR2_OVSR_SHIFT		2
#define ADC4_CFGR2_OVSR_MASK		0x07
/** @defgroup adc4_cfgr2_ovsr OVSR RES
@{*/
/**@}*/

/** ADC4_CFGR2_JOVSE DMACFG **/
#define ADC4_CFGR2_JOVSE		(1 << 1)
/** ADC4_CFGR2_ROVSE DMAEN **/
#define ADC4_CFGR2_ROVSE		(1 << 0)
...
/** ADC4_SMPR1_SMPPLUS Addition of one clock cycle to the sampling time **/
#define ADC4_SMPR1_SMPPLUS		(1 << 31)
...
#define ADC4_SMPR1_SMP0_SHIFT		0
#define ADC4_SMPR1_SMP0_MASK		0x07
/** @defgroup adc4_smpr1_smp0 SMP0 SMP0
@{*/
/**@}*/
...
#define ADC4_TR1_AWDFILT_SHIFT		12
#define ADC4_TR1_AWDFILT_MASK		0x07
/** @defgroup adc4_tr1_awdfilt AWDFILT AWDFILT
@{*/
/**@}*/
...
#define ADC4_SQR1_L_SHIFT		0
#define ADC4_SQR1_L_MASK		0x0f
/** @defgroup adc4_sqr1_l L Regular channel sequence length
@{*/
/**@}*/
...
#define ADC4_DR_RDATA_SHIFT		0
#define ADC4_DR_RDATA_MASK		0xffff
/** @defgroup adc4_dr_rdata RDATA Regular Data converted
@{*/
/**@}*/
...
#define ADC4_JSQR_JSQ4_SHIFT		27
...
#define ADC4_JSQR_JSQ3_SHIFT		21
...
#define ADC4_JSQR_JSQ2_SHIFT		15
...
#define ADC4_JSQR_JEXTEN_SHIFT		7
...
#define ADC4_JSQR_JEXTSEL_MASK		0x1f
...
/** ADC4_OFR1_SATEN SATEN **/
#define ADC4_OFR1_SATEN		(1 << 25)
/** ADC4_OFR1_OFFSETPOS OFFSETPOS **/
#define ADC4_OFR1_OFFSETPOS		(1 << 24)
...
/** ADC4_OFR2_OFFSET1_EN OFFSET1_EN **/
#define ADC4_OFR2_OFFSET1_EN		(1 << 31)

#define ADC4_OFR2_OFFSET1_CH_SHIFT		26
#define ADC4_OFR2_OFFSET1_CH_MASK		0x1f
/** @defgroup adc4_ofr2_offset1_ch OFFSET1CH OFFSET1_CH
@{*/
/**@}*/

/** ADC4_OFR2_SATEN SATEN **/
#define ADC4_OFR2_SATEN		(1 << 25)
/** ADC4_OFR2_OFFSETPOS OFFSETPOS **/
#define ADC4_OFR2_OFFSETPOS		(1 << 24)

#define ADC4_OFR2_OFFSET1_SHIFT		0
#define ADC4_OFR2_OFFSET1_MASK		0xfff
/** @defgroup adc4_ofr2_offset1 OFFSET1 OFFSET1
@{*/
/**@}*/
...
/** ADC4_OFR3_OFFSET1_EN OFFSET1_EN **/
#define ADC4_OFR3_OFFSET1_EN		(1 << 31)

#define ADC4_OFR3_OFFSET1_CH_SHIFT		26
#define ADC4_OFR3_OFFSET1_CH_MASK		0x1f
/** @defgroup adc4_ofr3_offset1_ch OFFSET1CH OFFSET1_CH
@{*/
/**@}*/

/** ADC4_OFR3_SATEN SATEN **/
#define ADC4_OFR3_SATEN		(1 << 25)
/** ADC4_OFR3_OFFSETPOS OFFSETPOS **/
#define ADC4_OFR3_OFFSETPOS		(1 << 24)

#define ADC4_OFR3_OFFSET1_SHIFT		0
#define ADC4_OFR3_OFFSET1_MASK		0xfff
/** @defgroup adc4_ofr3_offset1 OFFSET1 OFFSET1
@{*/
/**@}*/
...
/** ADC4_OFR4_OFFSET1_EN OFFSET1_EN **/
#define ADC4_OFR4_OFFSET1_EN		(1 << 31)

#define ADC4_OFR4_OFFSET1_CH_SHIFT		26
#define ADC4_OFR4_OFFSET1_CH_MASK		0x1f
/** @defgroup adc4_ofr4_offset1_ch OFFSET1CH OFFSET1_CH
@{*/
/**@}*/

/** ADC4_OFR4_SATEN SATEN **/
#define ADC4_OFR4_SATEN		(1 << 25)
/** ADC4_OFR4_OFFSETPOS OFFSETPOS **/
#define ADC4_OFR4_OFFSETPOS		(1 << 24)

#define ADC4_OFR4_OFFSET1_SHIFT		0
#define ADC4_OFR4_OFFSET1_MASK		0xfff
/** @defgroup adc4_ofr4_offset1 OFFSET1 OFFSET1
@{*/
/**@}*/
...
#define ADC4_AWD2CR_AWD2CH_SHIFT		0
#define ADC4_AWD2CR_AWD2CH_MASK		0x7ffff
...
#define ADC4_AWD3CR_AWD3CH_SHIFT		0
#define ADC4_AWD3CR_AWD3CH_MASK		0x7ffff
...
#define ADC4_DIFSEL_DIFSEL_1_18_SHIFT		1
#define ADC4_DIFSEL_DIFSEL_1_18_MASK		0x3ffff
/** @defgroup adc4_difsel_difsel_1_18 DIFSEL118 Differential mode for channels 15 to 1
@{*/
/**@}*/

/** ADC4_DIFSEL_DIFSEL_0 Differential mode for channels 0 **/
#define ADC4_DIFSEL_DIFSEL_0		(1 << 0)
...
/** @defgroup adc4_gcomp GCOMP Gain compensation Register
@{*/


#define ADC4_GCOMP_GCOMPCOEFF_SHIFT		0
#define ADC4_GCOMP_GCOMPCOEFF_MASK		0x3fff
/** @defgroup adc4_gcomp_gcompcoeff GCOMPCOEFF GCOMPCOEFF
@{*/
/**@}*/
