...
/** OTG_FS_PWRCLK_FS_PCGCCTL OTG_FS power and clock gating control register **/
#define OTG_FS_PWRCLK_FS_PCGCCTL			MMIO32(OTG_FS_PWRCLK_BASE + 0x00)

/**@}*/


/** @defgroup otg_fs_pwrclk_fs_pcgcctl FSPCGCCTL OTG_FS power and clock gating control register
@{*/
