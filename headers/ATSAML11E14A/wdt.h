...
/** WDT_CTRLA_RUNSTDBY Run During Standby **/
#define WDT_CTRLA_RUNSTDBY		(1 << 6)
...
#define WDT_SYNCBUSY_CLEAR		(1 << 5)
/** WDT_SYNCBUSY_ALWAYSON Always-On Synchronization Busy **/
#define WDT_SYNCBUSY_ALWAYSON		(1 << 4)
/** WDT_SYNCBUSY_RUNSTDBY Run During Standby Synchronization Busy **/
#define WDT_SYNCBUSY_RUNSTDBY		(1 << 3)
