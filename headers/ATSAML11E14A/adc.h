...
#define ADC_CTRLC_DUALSEL_SHIFT		12
#define ADC_CTRLC_DUALSEL_MASK		0x03
/** @defgroup adc_ctrlc_dualsel DUALSEL Dual Mode Trigger Selection
@{*/
/**@}*/
...
/** ADC_CTRLC_R2R Rail-to-Rail mode enable **/
#define ADC_CTRLC_R2R		(1 << 7)
