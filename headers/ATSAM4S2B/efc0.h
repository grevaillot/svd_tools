...
/** EFC0_FMR_CLOE Code Loop Optimization Enable **/
...
/** EFC0_FMR_FRDY Flash Ready Interrupt Enable **/
...
/** EFC0_FSR_FLERR Flash Error Status (cleared when a programming operation starts) **/
#define EFC0_FSR_FLERR		(1 << 3)
/** EFC0_FSR_FLOCKE Flash Lock Error Status (cleared on read) **/
#define EFC0_FSR_FLOCKE		(1 << 2)
/** EFC0_FSR_FCMDE Flash Command Error Status (cleared on read or by writing EEFC_FCR) **/
#define EFC0_FSR_FCMDE		(1 << 1)
/** EFC0_FSR_FRDY Flash Ready Status (cleared when Flash is busy) **/
