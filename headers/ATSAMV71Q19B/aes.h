...
/** AES_AES_GHASHR[0] GCM Intermediate Hash Word Register **/
#define AES_AES_GHASHR[0]			MMIO32(AES_BASE + 0x78)
/** AES_AES_GHASHR[1] GCM Intermediate Hash Word Register **/
#define AES_AES_GHASHR[1]			MMIO32(AES_BASE + 0x7c)
/** AES_AES_GHASHR[2] GCM Intermediate Hash Word Register **/
#define AES_AES_GHASHR[2]			MMIO32(AES_BASE + 0x80)
/** AES_AES_GHASHR[3] GCM Intermediate Hash Word Register **/
#define AES_AES_GHASHR[3]			MMIO32(AES_BASE + 0x84)
/** AES_AES_TAGR[0] GCM Authentication Tag Word Register **/
#define AES_AES_TAGR[0]			MMIO32(AES_BASE + 0x88)
/** AES_AES_TAGR[1] GCM Authentication Tag Word Register **/
#define AES_AES_TAGR[1]			MMIO32(AES_BASE + 0x8c)
/** AES_AES_TAGR[2] GCM Authentication Tag Word Register **/
#define AES_AES_TAGR[2]			MMIO32(AES_BASE + 0x90)
/** AES_AES_TAGR[3] GCM Authentication Tag Word Register **/
...
/** AES_AES_GCMHR[0] GCM H Word Register **/
#define AES_AES_GCMHR[0]			MMIO32(AES_BASE + 0x9c)
/** AES_AES_GCMHR[1] GCM H Word Register **/
#define AES_AES_GCMHR[1]			MMIO32(AES_BASE + 0xa0)
/** AES_AES_GCMHR[2] GCM H Word Register **/
#define AES_AES_GCMHR[2]			MMIO32(AES_BASE + 0xa4)
/** AES_AES_GCMHR[3] GCM H Word Register **/
...
/** @defgroup aes_aes_keywr[0] AESKEYWR[0] Key Word Register
@{*/
...
/** @defgroup aes_aes_keywr[1] AESKEYWR[1] Key Word Register
@{*/
...
/** @defgroup aes_aes_keywr[2] AESKEYWR[2] Key Word Register
@{*/
...
/** @defgroup aes_aes_keywr[3] AESKEYWR[3] Key Word Register
@{*/
...
/** @defgroup aes_aes_keywr[4] AESKEYWR[4] Key Word Register
@{*/
...
/** @defgroup aes_aes_keywr[5] AESKEYWR[5] Key Word Register
@{*/
...
/** @defgroup aes_aes_keywr[6] AESKEYWR[6] Key Word Register
@{*/
...
/** @defgroup aes_aes_keywr[7] AESKEYWR[7] Key Word Register
@{*/
...
/** @defgroup aes_aes_idatar[0] AESIDATAR[0] Input Data Register
@{*/
...
/** @defgroup aes_aes_idatar[1] AESIDATAR[1] Input Data Register
@{*/
...
/** @defgroup aes_aes_idatar[2] AESIDATAR[2] Input Data Register
@{*/
...
/** @defgroup aes_aes_idatar[3] AESIDATAR[3] Input Data Register
@{*/
...
/** @defgroup aes_aes_odatar[0] AESODATAR[0] Output Data Register
@{*/
...
/** @defgroup aes_aes_odatar[1] AESODATAR[1] Output Data Register
@{*/
...
/** @defgroup aes_aes_odatar[2] AESODATAR[2] Output Data Register
@{*/
...
/** @defgroup aes_aes_odatar[3] AESODATAR[3] Output Data Register
@{*/
...
/** @defgroup aes_aes_ivr[0] AESIVR[0] Initialization Vector Register
@{*/
...
/** @defgroup aes_aes_ivr[1] AESIVR[1] Initialization Vector Register
@{*/
...
/** @defgroup aes_aes_ivr[2] AESIVR[2] Initialization Vector Register
@{*/
...
/** @defgroup aes_aes_ivr[3] AESIVR[3] Initialization Vector Register
@{*/
...
/** @defgroup aes_aes_ghashr[0] AESGHASHR[0] GCM Intermediate Hash Word Register
@{*/
...
/** @defgroup aes_aes_ghashr[1] AESGHASHR[1] GCM Intermediate Hash Word Register
@{*/
...
/** @defgroup aes_aes_ghashr[2] AESGHASHR[2] GCM Intermediate Hash Word Register
@{*/
...
/** @defgroup aes_aes_ghashr[3] AESGHASHR[3] GCM Intermediate Hash Word Register
@{*/
...
/** @defgroup aes_aes_tagr[0] AESTAGR[0] GCM Authentication Tag Word Register
@{*/
...
/** @defgroup aes_aes_tagr[1] AESTAGR[1] GCM Authentication Tag Word Register
@{*/
...
/** @defgroup aes_aes_tagr[2] AESTAGR[2] GCM Authentication Tag Word Register
@{*/
...
/** @defgroup aes_aes_tagr[3] AESTAGR[3] GCM Authentication Tag Word Register
@{*/
...
/** @defgroup aes_aes_gcmhr[0] AESGCMHR[0] GCM H Word Register
@{*/
...
/** @defgroup aes_aes_gcmhr[1] AESGCMHR[1] GCM H Word Register
@{*/
...
/** @defgroup aes_aes_gcmhr[2] AESGCMHR[2] GCM H Word Register
@{*/
...
/** @defgroup aes_aes_gcmhr[3] AESGCMHR[3] GCM H Word Register
@{*/
