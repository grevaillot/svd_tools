...
/** USART6_PRESC USART prescaler register **/
#define USART6_PRESC			MMIO32(USART6_BASE + 0x2c)
...
/** USART6_CR1_RXFFIE RXFIFO Full interrupt enable **/
#define USART6_CR1_RXFFIE		(1 << 31)
/** USART6_CR1_TXFEIE TXFIFO empty interrupt enable **/
#define USART6_CR1_TXFEIE		(1 << 30)
/** USART6_CR1_FIFOEN FIFO mode enable **/
#define USART6_CR1_FIFOEN		(1 << 29)
...
/** USART6_CR2_DIS_NSS When the DSI_NSS bit is set, the NSS pin input is ignored **/
#define USART6_CR2_DIS_NSS		(1 << 3)
/** USART6_CR2_SLVEN Synchronous Slave mode enable **/
#define USART6_CR2_SLVEN		(1 << 0)
...
#define USART6_CR3_TXFTCFG_SHIFT		29
#define USART6_CR3_TXFTCFG_MASK		0x07
/** @defgroup usart6_cr3_txftcfg TXFTCFG TXFIFO threshold configuration
@{*/
/**@}*/

/** USART6_CR3_RXFTIE RXFIFO threshold interrupt enable **/
#define USART6_CR3_RXFTIE		(1 << 28)

#define USART6_CR3_RXFTCFG_SHIFT		25
#define USART6_CR3_RXFTCFG_MASK		0x07
/** @defgroup usart6_cr3_rxftcfg RXFTCFG Receive FIFO threshold configuration
@{*/
/**@}*/

/** USART6_CR3_TCBGTIE Transmission Complete before guard time, interrupt enable **/
#define USART6_CR3_TCBGTIE		(1 << 24)
/** USART6_CR3_TXFTIE TXFIFO threshold interrupt enable **/
#define USART6_CR3_TXFTIE		(1 << 23)
...
#define USART6_BRR_BRR_4_15_SHIFT		4
#define USART6_BRR_BRR_4_15_MASK		0xfff
/** @defgroup usart6_brr_brr_4_15 BRR415 DIV_Mantissa
@{*/
/**@}*/


#define USART6_BRR_BRR_0_3_SHIFT		0
#define USART6_BRR_BRR_0_3_MASK		0x0f
/** @defgroup usart6_brr_brr_0_3 BRR03 DIV_Fraction
@{*/
/**@}*/
...
/** USART6_ISR_TXFT TXFIFO threshold flag **/
#define USART6_ISR_TXFT		(1 << 27)
/** USART6_ISR_RXFT RXFIFO threshold flag **/
#define USART6_ISR_RXFT		(1 << 26)
/** USART6_ISR_TCBGT Transmission complete before guard time flag **/
#define USART6_ISR_TCBGT		(1 << 25)
/** USART6_ISR_RXFF RXFIFO Full **/
#define USART6_ISR_RXFF		(1 << 24)
/** USART6_ISR_TXFE TXFIFO Empty **/
#define USART6_ISR_TXFE		(1 << 23)
/** USART6_ISR_REACK REACK **/
...
/** USART6_ISR_UDR SPI slave underrun error flag **/
#define USART6_ISR_UDR		(1 << 13)
...
/** USART6_ICR_UDRCF SPI slave underrun clear flag **/
#define USART6_ICR_UDRCF		(1 << 13)
...
/** USART6_ICR_TCBGTC Transmission complete before Guard time clear flag **/
#define USART6_ICR_TCBGTC		(1 << 7)
/** USART6_ICR_TCCF Transmission complete clear flag **/
#define USART6_ICR_TCCF		(1 << 6)
/** USART6_ICR_TXFECF TXFIFO empty clear flag **/
#define USART6_ICR_TXFECF		(1 << 5)
...
/** @defgroup usart6_presc PRESC USART prescaler register
@{*/


#define USART6_PRESC_PRESCALER_SHIFT		0
#define USART6_PRESC_PRESCALER_MASK		0x0f
/** @defgroup usart6_presc_prescaler PRESCALER Clock prescaler
@{*/
/**@}*/
