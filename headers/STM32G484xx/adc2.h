...
/** ADC2_GCOMP Gain compensation Register **/
#define ADC2_GCOMP			MMIO32(ADC2_BASE + 0xc0)
...
/** ADC2_CFGR_ALIGN_5 ALIGN_5 **/
#define ADC2_CFGR_ALIGN_5		(1 << 5)
...
/** ADC2_CFGR2_SMPTRIG SMPTRIG **/
#define ADC2_CFGR2_SMPTRIG		(1 << 27)
/** ADC2_CFGR2_BULB BULB **/
#define ADC2_CFGR2_BULB		(1 << 26)
/** ADC2_CFGR2_SWTRIG SWTRIG **/
#define ADC2_CFGR2_SWTRIG		(1 << 25)
/** ADC2_CFGR2_GCOMP GCOMP **/
#define ADC2_CFGR2_GCOMP		(1 << 16)
...
#define ADC2_TR1_AWDFILT_SHIFT		12
#define ADC2_TR1_AWDFILT_MASK		0x07
/** @defgroup adc2_tr1_awdfilt AWDFILT AWDFILT
@{*/
/**@}*/
...
/** ADC2_OFR1_SATEN SATEN **/
#define ADC2_OFR1_SATEN		(1 << 25)
/** ADC2_OFR1_OFFSETPOS OFFSETPOS **/
#define ADC2_OFR1_OFFSETPOS		(1 << 24)
...
/** ADC2_OFR2_OFFSET1_EN OFFSET1_EN **/
#define ADC2_OFR2_OFFSET1_EN		(1 << 31)

#define ADC2_OFR2_OFFSET1_CH_SHIFT		26
#define ADC2_OFR2_OFFSET1_CH_MASK		0x1f
/** @defgroup adc2_ofr2_offset1_ch OFFSET1CH OFFSET1_CH
@{*/
/**@}*/

/** ADC2_OFR2_SATEN SATEN **/
#define ADC2_OFR2_SATEN		(1 << 25)
/** ADC2_OFR2_OFFSETPOS OFFSETPOS **/
#define ADC2_OFR2_OFFSETPOS		(1 << 24)

#define ADC2_OFR2_OFFSET1_SHIFT		0
#define ADC2_OFR2_OFFSET1_MASK		0xfff
/** @defgroup adc2_ofr2_offset1 OFFSET1 OFFSET1
@{*/
/**@}*/
...
/** ADC2_OFR3_OFFSET1_EN OFFSET1_EN **/
#define ADC2_OFR3_OFFSET1_EN		(1 << 31)

#define ADC2_OFR3_OFFSET1_CH_SHIFT		26
#define ADC2_OFR3_OFFSET1_CH_MASK		0x1f
/** @defgroup adc2_ofr3_offset1_ch OFFSET1CH OFFSET1_CH
@{*/
/**@}*/

/** ADC2_OFR3_SATEN SATEN **/
#define ADC2_OFR3_SATEN		(1 << 25)
/** ADC2_OFR3_OFFSETPOS OFFSETPOS **/
#define ADC2_OFR3_OFFSETPOS		(1 << 24)

#define ADC2_OFR3_OFFSET1_SHIFT		0
#define ADC2_OFR3_OFFSET1_MASK		0xfff
/** @defgroup adc2_ofr3_offset1 OFFSET1 OFFSET1
@{*/
/**@}*/
...
/** ADC2_OFR4_OFFSET1_EN OFFSET1_EN **/
#define ADC2_OFR4_OFFSET1_EN		(1 << 31)

#define ADC2_OFR4_OFFSET1_CH_SHIFT		26
#define ADC2_OFR4_OFFSET1_CH_MASK		0x1f
/** @defgroup adc2_ofr4_offset1_ch OFFSET1CH OFFSET1_CH
@{*/
/**@}*/

/** ADC2_OFR4_SATEN SATEN **/
#define ADC2_OFR4_SATEN		(1 << 25)
/** ADC2_OFR4_OFFSETPOS OFFSETPOS **/
#define ADC2_OFR4_OFFSETPOS		(1 << 24)

#define ADC2_OFR4_OFFSET1_SHIFT		0
#define ADC2_OFR4_OFFSET1_MASK		0xfff
/** @defgroup adc2_ofr4_offset1 OFFSET1 OFFSET1
@{*/
/**@}*/
...
#define ADC2_DIFSEL_DIFSEL_1_18_SHIFT		1
#define ADC2_DIFSEL_DIFSEL_1_18_MASK		0x3ffff
/** @defgroup adc2_difsel_difsel_1_18 DIFSEL118 Differential mode for channels 15 to 1
@{*/
/**@}*/
...
/** @defgroup adc2_gcomp GCOMP Gain compensation Register
@{*/


#define ADC2_GCOMP_GCOMPCOEFF_SHIFT		0
#define ADC2_GCOMP_GCOMPCOEFF_MASK		0x3fff
/** @defgroup adc2_gcomp_gcompcoeff GCOMPCOEFF GCOMPCOEFF
@{*/
/**@}*/
