...
/** HRTIM_TIME_TIMEDIER TIMxDIER **/
#define HRTIM_TIME_TIMEDIER			MMIO32(HRTIM_TIME_BASE + 0x0c)
...
/** HRTIM_TIME_TIMECR2 HRTIM Timerx Control Register 2 **/
#define HRTIM_TIME_TIMECR2			MMIO32(HRTIM_TIME_BASE + 0x6c)
/** HRTIM_TIME_EEEFR3 HRTIM Timerx External Event Filtering Register 3 **/
#define HRTIM_TIME_EEEFR3			MMIO32(HRTIM_TIME_BASE + 0x70)
...
/** HRTIM_TIME_TIMECR_TAU TAU **/
#define HRTIM_TIME_TIMECR_TAU		(1 << 19)
...
/** HRTIM_TIME_TIMECR_TFU TFU **/
#define HRTIM_TIME_TIMECR_TFU		(1 << 16)
...
/** HRTIM_TIME_TIMECR_RSYNCU Re-Synchronized Update **/
#define HRTIM_TIME_TIMECR_RSYNCU		(1 << 9)

#define HRTIM_TIME_TIMECR_INTLVD_SHIFT		7
#define HRTIM_TIME_TIMECR_INTLVD_MASK		0x03
/** @defgroup hrtim_time_timecr_intlvd INTLVD Interleaved mode
@{*/
/**@}*/
...
/** HRTIM_TIME_TIMEISR_O2CPY Output 2 Copy **/
#define HRTIM_TIME_TIMEISR_O2CPY		(1 << 21)
/** HRTIM_TIME_TIMEISR_O1CPY Output 1 Copy **/
#define HRTIM_TIME_TIMEISR_O1CPY		(1 << 20)
...
/** @defgroup hrtim_time_timedier TIMEDIER TIMxDIER
@{*/

/** HRTIM_TIME_TIMEDIER_DLYPRTDE DLYPRTDE **/
#define HRTIM_TIME_TIMEDIER_DLYPRTDE		(1 << 30)
/** HRTIM_TIME_TIMEDIER_RSTDE RSTDE **/
#define HRTIM_TIME_TIMEDIER_RSTDE		(1 << 29)
/** HRTIM_TIME_TIMEDIER_RSTx2DE RSTx2DE **/
#define HRTIM_TIME_TIMEDIER_RSTx2DE		(1 << 28)
/** HRTIM_TIME_TIMEDIER_SETx2DE SETx2DE **/
#define HRTIM_TIME_TIMEDIER_SETx2DE		(1 << 27)
/** HRTIM_TIME_TIMEDIER_RSTx1DE RSTx1DE **/
#define HRTIM_TIME_TIMEDIER_RSTx1DE		(1 << 26)
/** HRTIM_TIME_TIMEDIER_SET1xDE SET1xDE **/
#define HRTIM_TIME_TIMEDIER_SET1xDE		(1 << 25)
/** HRTIM_TIME_TIMEDIER_CPT2DE CPT2DE **/
#define HRTIM_TIME_TIMEDIER_CPT2DE		(1 << 24)
/** HRTIM_TIME_TIMEDIER_CPT1DE CPT1DE **/
#define HRTIM_TIME_TIMEDIER_CPT1DE		(1 << 23)
/** HRTIM_TIME_TIMEDIER_UPDDE UPDDE **/
#define HRTIM_TIME_TIMEDIER_UPDDE		(1 << 22)
/** HRTIM_TIME_TIMEDIER_REPDE REPDE **/
#define HRTIM_TIME_TIMEDIER_REPDE		(1 << 20)
/** HRTIM_TIME_TIMEDIER_CMP4DE CMP4DE **/
#define HRTIM_TIME_TIMEDIER_CMP4DE		(1 << 19)
/** HRTIM_TIME_TIMEDIER_CMP3DE CMP3DE **/
#define HRTIM_TIME_TIMEDIER_CMP3DE		(1 << 18)
/** HRTIM_TIME_TIMEDIER_CMP2DE CMP2DE **/
#define HRTIM_TIME_TIMEDIER_CMP2DE		(1 << 17)
/** HRTIM_TIME_TIMEDIER_CMP1DE CMP1DE **/
#define HRTIM_TIME_TIMEDIER_CMP1DE		(1 << 16)
/** HRTIM_TIME_TIMEDIER_DLYPRTIE DLYPRTIE **/
#define HRTIM_TIME_TIMEDIER_DLYPRTIE		(1 << 14)
/** HRTIM_TIME_TIMEDIER_RSTIE RSTIE **/
#define HRTIM_TIME_TIMEDIER_RSTIE		(1 << 13)
/** HRTIM_TIME_TIMEDIER_RSTx2IE RSTx2IE **/
#define HRTIM_TIME_TIMEDIER_RSTx2IE		(1 << 12)
/** HRTIM_TIME_TIMEDIER_SETx2IE SETx2IE **/
#define HRTIM_TIME_TIMEDIER_SETx2IE		(1 << 11)
/** HRTIM_TIME_TIMEDIER_RSTx1IE RSTx1IE **/
#define HRTIM_TIME_TIMEDIER_RSTx1IE		(1 << 10)
/** HRTIM_TIME_TIMEDIER_SET1xIE SET1xIE **/
#define HRTIM_TIME_TIMEDIER_SET1xIE		(1 << 9)
/** HRTIM_TIME_TIMEDIER_CPT2IE CPT2IE **/
#define HRTIM_TIME_TIMEDIER_CPT2IE		(1 << 8)
/** HRTIM_TIME_TIMEDIER_CPT1IE CPT1IE **/
#define HRTIM_TIME_TIMEDIER_CPT1IE		(1 << 7)
/** HRTIM_TIME_TIMEDIER_UPDIE UPDIE **/
#define HRTIM_TIME_TIMEDIER_UPDIE		(1 << 6)
/** HRTIM_TIME_TIMEDIER_REPIE REPIE **/
#define HRTIM_TIME_TIMEDIER_REPIE		(1 << 4)
/** HRTIM_TIME_TIMEDIER_CMP4IE CMP4IE **/
#define HRTIM_TIME_TIMEDIER_CMP4IE		(1 << 3)
/** HRTIM_TIME_TIMEDIER_CMP3IE CMP3IE **/
#define HRTIM_TIME_TIMEDIER_CMP3IE		(1 << 2)
/** HRTIM_TIME_TIMEDIER_CMP2IE CMP2IE **/
#define HRTIM_TIME_TIMEDIER_CMP2IE		(1 << 1)
/** HRTIM_TIME_TIMEDIER_CMP1IE CMP1IE **/
#define HRTIM_TIME_TIMEDIER_CMP1IE		(1 << 0)
...
/** HRTIM_TIME_CPT1ER_DIR Timerx Capture 1 Direction status **/
#define HRTIM_TIME_CPT1ER_DIR		(1 << 16)
...
/** HRTIM_TIME_CPT2ER_DIR Timerx Capture 1 Direction status **/
#define HRTIM_TIME_CPT2ER_DIR		(1 << 16)
...
/** HRTIM_TIME_RSTER_TIMFCPM2 Timer F Compare 2 **/
#define HRTIM_TIME_RSTER_TIMFCPM2		(1 << 31)
...
/** HRTIM_TIME_RSTER_TIMFCMP1 Timer A Update reset **/
#define HRTIM_TIME_RSTER_TIMFCMP1		(1 << 0)
...
/** HRTIM_TIME_CPT1ECR_TFCMP2 TFCMP2 **/
#define HRTIM_TIME_CPT1ECR_TFCMP2		(1 << 31)
/** HRTIM_TIME_CPT1ECR_TFCMP1 TFCMP1 **/
#define HRTIM_TIME_CPT1ECR_TFCMP1		(1 << 30)
/** HRTIM_TIME_CPT1ECR_TF1RST TF1RST **/
#define HRTIM_TIME_CPT1ECR_TF1RST		(1 << 29)
/** HRTIM_TIME_CPT1ECR_TF1SET TF1SET **/
#define HRTIM_TIME_CPT1ECR_TF1SET		(1 << 28)
...
/** HRTIM_TIME_CPT2ECR_TFCMP2 TFCMP2 **/
#define HRTIM_TIME_CPT2ECR_TFCMP2		(1 << 31)
/** HRTIM_TIME_CPT2ECR_TFCMP1 TFCMP1 **/
#define HRTIM_TIME_CPT2ECR_TFCMP1		(1 << 30)
/** HRTIM_TIME_CPT2ECR_TF1RST TF1RST **/
#define HRTIM_TIME_CPT2ECR_TF1RST		(1 << 29)
/** HRTIM_TIME_CPT2ECR_TF1SET TF1SET **/
#define HRTIM_TIME_CPT2ECR_TF1SET		(1 << 28)
...
/** HRTIM_TIME_OUTER_BIAR Balanced Idle Automatic Resume **/
#define HRTIM_TIME_OUTER_BIAR		(1 << 14)
...
/** HRTIM_TIME_FLTER_FLT6EN Fault 6 enable **/
#define HRTIM_TIME_FLTER_FLT6EN		(1 << 5)
...
/** @defgroup hrtim_time_timecr2 TIMECR2 HRTIM Timerx Control Register 2
@{*/

/** HRTIM_TIME_TIMECR2_TRGHLF Triggered-half mode **/
#define HRTIM_TIME_TIMECR2_TRGHLF		(1 << 20)
/** HRTIM_TIME_TIMECR2_GTCMP3 Greater than Compare 3 PWM mode **/
#define HRTIM_TIME_TIMECR2_GTCMP3		(1 << 17)
/** HRTIM_TIME_TIMECR2_GTCMP1 Greater than Compare 1 PWM mode **/
#define HRTIM_TIME_TIMECR2_GTCMP1		(1 << 16)

#define HRTIM_TIME_TIMECR2_FEROM_SHIFT		14
#define HRTIM_TIME_TIMECR2_FEROM_MASK		0x03
/** @defgroup hrtim_time_timecr2_ferom FEROM Fault and Event Roll-Over Mode
@{*/
/**@}*/


#define HRTIM_TIME_TIMECR2_BMROM_SHIFT		12
#define HRTIM_TIME_TIMECR2_BMROM_MASK		0x03
/** @defgroup hrtim_time_timecr2_bmrom BMROM Burst Mode Roll-Over Mode
@{*/
/**@}*/


#define HRTIM_TIME_TIMECR2_ADROM_SHIFT		10
#define HRTIM_TIME_TIMECR2_ADROM_MASK		0x03
/** @defgroup hrtim_time_timecr2_adrom ADROM ADC Roll-Over Mode
@{*/
/**@}*/


#define HRTIM_TIME_TIMECR2_OUTROM_SHIFT		8
#define HRTIM_TIME_TIMECR2_OUTROM_MASK		0x03
/** @defgroup hrtim_time_timecr2_outrom OUTROM Output Roll-Over Mode
@{*/
/**@}*/


#define HRTIM_TIME_TIMECR2_ROM_SHIFT		6
#define HRTIM_TIME_TIMECR2_ROM_MASK		0x03
/** @defgroup hrtim_time_timecr2_rom ROM Roll-Over Mode
@{*/
/**@}*/

/** HRTIM_TIME_TIMECR2_UDM Up-Down Mode **/
#define HRTIM_TIME_TIMECR2_UDM		(1 << 4)
/** HRTIM_TIME_TIMECR2_DCDR Dual Channel DAC Reset trigger **/
#define HRTIM_TIME_TIMECR2_DCDR		(1 << 2)
/** HRTIM_TIME_TIMECR2_DCDS Dual Channel DAC Step trigger **/
#define HRTIM_TIME_TIMECR2_DCDS		(1 << 1)
/** HRTIM_TIME_TIMECR2_DCDE Dual Channel DAC trigger enable **/
#define HRTIM_TIME_TIMECR2_DCDE		(1 << 0)

/**@}*/

/** @defgroup hrtim_time_eeefr3 EEEFR3 HRTIM Timerx External Event Filtering Register 3
@{*/


#define HRTIM_TIME_EEEFR3_EEVACNT_SHIFT		8
#define HRTIM_TIME_EEEFR3_EEVACNT_MASK		0x3f
/** @defgroup hrtim_time_eeefr3_eevacnt EEVACNT External Event A counter
@{*/
/**@}*/


#define HRTIM_TIME_EEEFR3_EEVASEL_SHIFT		4
#define HRTIM_TIME_EEEFR3_EEVASEL_MASK		0x0f
/** @defgroup hrtim_time_eeefr3_eevasel EEVASEL External Event A Selection
@{*/
/**@}*/

/** HRTIM_TIME_EEEFR3_EEVARSTM External Event A Reset Mode **/
#define HRTIM_TIME_EEEFR3_EEVARSTM		(1 << 2)
/** HRTIM_TIME_EEEFR3_EEVACRES External Event A Counter Reset **/
#define HRTIM_TIME_EEEFR3_EEVACRES		(1 << 1)
/** HRTIM_TIME_EEEFR3_EEVACE External Event A Counter Enable **/
#define HRTIM_TIME_EEEFR3_EEVACE		(1 << 0)
