...
/** HRTIM_TIMD_TIMDDIER TIMxDIER **/
#define HRTIM_TIMD_TIMDDIER			MMIO32(HRTIM_TIMD_BASE + 0x0c)
...
/** HRTIM_TIMD_TIMDCR2 HRTIM Timerx Control Register 2 **/
#define HRTIM_TIMD_TIMDCR2			MMIO32(HRTIM_TIMD_BASE + 0x6c)
/** HRTIM_TIMD_DEEFR3 HRTIM Timerx External Event Filtering Register 3 **/
#define HRTIM_TIMD_DEEFR3			MMIO32(HRTIM_TIMD_BASE + 0x70)
...
/** HRTIM_TIMD_TIMDCR_TAU TAU **/
#define HRTIM_TIMD_TIMDCR_TAU		(1 << 19)
...
/** HRTIM_TIMD_TIMDCR_TFU TFU **/
#define HRTIM_TIMD_TIMDCR_TFU		(1 << 16)
...
/** HRTIM_TIMD_TIMDCR_RSYNCU Re-Synchronized Update **/
#define HRTIM_TIMD_TIMDCR_RSYNCU		(1 << 9)

#define HRTIM_TIMD_TIMDCR_INTLVD_SHIFT		7
#define HRTIM_TIMD_TIMDCR_INTLVD_MASK		0x03
/** @defgroup hrtim_timd_timdcr_intlvd INTLVD Interleaved mode
@{*/
/**@}*/
...
/** @defgroup hrtim_timd_timddier TIMDDIER TIMxDIER
@{*/

/** HRTIM_TIMD_TIMDDIER_DLYPRTDE DLYPRTDE **/
#define HRTIM_TIMD_TIMDDIER_DLYPRTDE		(1 << 30)
/** HRTIM_TIMD_TIMDDIER_RSTDE RSTDE **/
#define HRTIM_TIMD_TIMDDIER_RSTDE		(1 << 29)
/** HRTIM_TIMD_TIMDDIER_RSTx2DE RSTx2DE **/
#define HRTIM_TIMD_TIMDDIER_RSTx2DE		(1 << 28)
/** HRTIM_TIMD_TIMDDIER_SETx2DE SETx2DE **/
#define HRTIM_TIMD_TIMDDIER_SETx2DE		(1 << 27)
/** HRTIM_TIMD_TIMDDIER_RSTx1DE RSTx1DE **/
#define HRTIM_TIMD_TIMDDIER_RSTx1DE		(1 << 26)
/** HRTIM_TIMD_TIMDDIER_SET1xDE SET1xDE **/
#define HRTIM_TIMD_TIMDDIER_SET1xDE		(1 << 25)
/** HRTIM_TIMD_TIMDDIER_CPT2DE CPT2DE **/
#define HRTIM_TIMD_TIMDDIER_CPT2DE		(1 << 24)
/** HRTIM_TIMD_TIMDDIER_CPT1DE CPT1DE **/
#define HRTIM_TIMD_TIMDDIER_CPT1DE		(1 << 23)
/** HRTIM_TIMD_TIMDDIER_UPDDE UPDDE **/
#define HRTIM_TIMD_TIMDDIER_UPDDE		(1 << 22)
/** HRTIM_TIMD_TIMDDIER_REPDE REPDE **/
#define HRTIM_TIMD_TIMDDIER_REPDE		(1 << 20)
/** HRTIM_TIMD_TIMDDIER_CMP4DE CMP4DE **/
#define HRTIM_TIMD_TIMDDIER_CMP4DE		(1 << 19)
/** HRTIM_TIMD_TIMDDIER_CMP3DE CMP3DE **/
#define HRTIM_TIMD_TIMDDIER_CMP3DE		(1 << 18)
/** HRTIM_TIMD_TIMDDIER_CMP2DE CMP2DE **/
#define HRTIM_TIMD_TIMDDIER_CMP2DE		(1 << 17)
/** HRTIM_TIMD_TIMDDIER_CMP1DE CMP1DE **/
#define HRTIM_TIMD_TIMDDIER_CMP1DE		(1 << 16)
/** HRTIM_TIMD_TIMDDIER_DLYPRTIE DLYPRTIE **/
#define HRTIM_TIMD_TIMDDIER_DLYPRTIE		(1 << 14)
/** HRTIM_TIMD_TIMDDIER_RSTIE RSTIE **/
#define HRTIM_TIMD_TIMDDIER_RSTIE		(1 << 13)
/** HRTIM_TIMD_TIMDDIER_RSTx2IE RSTx2IE **/
#define HRTIM_TIMD_TIMDDIER_RSTx2IE		(1 << 12)
/** HRTIM_TIMD_TIMDDIER_SETx2IE SETx2IE **/
#define HRTIM_TIMD_TIMDDIER_SETx2IE		(1 << 11)
/** HRTIM_TIMD_TIMDDIER_RSTx1IE RSTx1IE **/
#define HRTIM_TIMD_TIMDDIER_RSTx1IE		(1 << 10)
/** HRTIM_TIMD_TIMDDIER_SET1xIE SET1xIE **/
#define HRTIM_TIMD_TIMDDIER_SET1xIE		(1 << 9)
/** HRTIM_TIMD_TIMDDIER_CPT2IE CPT2IE **/
#define HRTIM_TIMD_TIMDDIER_CPT2IE		(1 << 8)
/** HRTIM_TIMD_TIMDDIER_CPT1IE CPT1IE **/
#define HRTIM_TIMD_TIMDDIER_CPT1IE		(1 << 7)
/** HRTIM_TIMD_TIMDDIER_UPDIE UPDIE **/
#define HRTIM_TIMD_TIMDDIER_UPDIE		(1 << 6)
/** HRTIM_TIMD_TIMDDIER_REPIE REPIE **/
#define HRTIM_TIMD_TIMDDIER_REPIE		(1 << 4)
/** HRTIM_TIMD_TIMDDIER_CMP4IE CMP4IE **/
#define HRTIM_TIMD_TIMDDIER_CMP4IE		(1 << 3)
/** HRTIM_TIMD_TIMDDIER_CMP3IE CMP3IE **/
#define HRTIM_TIMD_TIMDDIER_CMP3IE		(1 << 2)
/** HRTIM_TIMD_TIMDDIER_CMP2IE CMP2IE **/
#define HRTIM_TIMD_TIMDDIER_CMP2IE		(1 << 1)
/** HRTIM_TIMD_TIMDDIER_CMP1IE CMP1IE **/
#define HRTIM_TIMD_TIMDDIER_CMP1IE		(1 << 0)
...
/** HRTIM_TIMD_CPT1DR_DIR Timerx Capture 1 Direction status **/
#define HRTIM_TIMD_CPT1DR_DIR		(1 << 16)
...
/** HRTIM_TIMD_CPT2DR_DIR Timerx Capture 1 Direction status **/
#define HRTIM_TIMD_CPT2DR_DIR		(1 << 16)
...
/** HRTIM_TIMD_RSTDR_TIMFCPM2 Timer F Compare 2 **/
#define HRTIM_TIMD_RSTDR_TIMFCPM2		(1 << 31)
...
/** HRTIM_TIMD_RSTDR_TIMFCMP1 Timer A Update reset **/
#define HRTIM_TIMD_RSTDR_TIMFCMP1		(1 << 0)
...
/** HRTIM_TIMD_CPT1DCR_TFCMP2 TFCMP2 **/
#define HRTIM_TIMD_CPT1DCR_TFCMP2		(1 << 27)
/** HRTIM_TIMD_CPT1DCR_TFCMP1 TFCMP1 **/
#define HRTIM_TIMD_CPT1DCR_TFCMP1		(1 << 26)
/** HRTIM_TIMD_CPT1DCR_TF1RST TF1RST **/
#define HRTIM_TIMD_CPT1DCR_TF1RST		(1 << 25)
/** HRTIM_TIMD_CPT1DCR_TF1SET TF1SET **/
#define HRTIM_TIMD_CPT1DCR_TF1SET		(1 << 24)
...
/** HRTIM_TIMD_CPT2DCR_TFCMP2 TFCMP2 **/
#define HRTIM_TIMD_CPT2DCR_TFCMP2		(1 << 27)
/** HRTIM_TIMD_CPT2DCR_TFCMP1 TFCMP1 **/
#define HRTIM_TIMD_CPT2DCR_TFCMP1		(1 << 26)
/** HRTIM_TIMD_CPT2DCR_TF1RST TF1RST **/
#define HRTIM_TIMD_CPT2DCR_TF1RST		(1 << 25)
/** HRTIM_TIMD_CPT2DCR_TF1SET TF1SET **/
#define HRTIM_TIMD_CPT2DCR_TF1SET		(1 << 24)
...
/** HRTIM_TIMD_OUTDR_BIAR Balanced Idle Automatic Resume **/
#define HRTIM_TIMD_OUTDR_BIAR		(1 << 14)
...
/** HRTIM_TIMD_FLTDR_FLT6EN Fault 6 enable **/
#define HRTIM_TIMD_FLTDR_FLT6EN		(1 << 5)
...
/** @defgroup hrtim_timd_timdcr2 TIMDCR2 HRTIM Timerx Control Register 2
@{*/

/** HRTIM_TIMD_TIMDCR2_TRGHLF Triggered-half mode **/
#define HRTIM_TIMD_TIMDCR2_TRGHLF		(1 << 20)
/** HRTIM_TIMD_TIMDCR2_GTCMP3 Greater than Compare 3 PWM mode **/
#define HRTIM_TIMD_TIMDCR2_GTCMP3		(1 << 17)
/** HRTIM_TIMD_TIMDCR2_GTCMP1 Greater than Compare 1 PWM mode **/
#define HRTIM_TIMD_TIMDCR2_GTCMP1		(1 << 16)

#define HRTIM_TIMD_TIMDCR2_FEROM_SHIFT		14
#define HRTIM_TIMD_TIMDCR2_FEROM_MASK		0x03
/** @defgroup hrtim_timd_timdcr2_ferom FEROM Fault and Event Roll-Over Mode
@{*/
/**@}*/


#define HRTIM_TIMD_TIMDCR2_BMROM_SHIFT		12
#define HRTIM_TIMD_TIMDCR2_BMROM_MASK		0x03
/** @defgroup hrtim_timd_timdcr2_bmrom BMROM Burst Mode Roll-Over Mode
@{*/
/**@}*/


#define HRTIM_TIMD_TIMDCR2_ADROM_SHIFT		10
#define HRTIM_TIMD_TIMDCR2_ADROM_MASK		0x03
/** @defgroup hrtim_timd_timdcr2_adrom ADROM ADC Roll-Over Mode
@{*/
/**@}*/


#define HRTIM_TIMD_TIMDCR2_OUTROM_SHIFT		8
#define HRTIM_TIMD_TIMDCR2_OUTROM_MASK		0x03
/** @defgroup hrtim_timd_timdcr2_outrom OUTROM Output Roll-Over Mode
@{*/
/**@}*/


#define HRTIM_TIMD_TIMDCR2_ROM_SHIFT		6
#define HRTIM_TIMD_TIMDCR2_ROM_MASK		0x03
/** @defgroup hrtim_timd_timdcr2_rom ROM Roll-Over Mode
@{*/
/**@}*/

/** HRTIM_TIMD_TIMDCR2_UDM Up-Down Mode **/
#define HRTIM_TIMD_TIMDCR2_UDM		(1 << 4)
/** HRTIM_TIMD_TIMDCR2_DCDR Dual Channel DAC Reset trigger **/
#define HRTIM_TIMD_TIMDCR2_DCDR		(1 << 2)
/** HRTIM_TIMD_TIMDCR2_DCDS Dual Channel DAC Step trigger **/
#define HRTIM_TIMD_TIMDCR2_DCDS		(1 << 1)
/** HRTIM_TIMD_TIMDCR2_DCDE Dual Channel DAC trigger enable **/
#define HRTIM_TIMD_TIMDCR2_DCDE		(1 << 0)

/**@}*/

/** @defgroup hrtim_timd_deefr3 DEEFR3 HRTIM Timerx External Event Filtering Register 3
@{*/


#define HRTIM_TIMD_DEEFR3_EEVACNT_SHIFT		8
#define HRTIM_TIMD_DEEFR3_EEVACNT_MASK		0x3f
/** @defgroup hrtim_timd_deefr3_eevacnt EEVACNT External Event A counter
@{*/
/**@}*/


#define HRTIM_TIMD_DEEFR3_EEVASEL_SHIFT		4
#define HRTIM_TIMD_DEEFR3_EEVASEL_MASK		0x0f
/** @defgroup hrtim_timd_deefr3_eevasel EEVASEL External Event A Selection
@{*/
/**@}*/

/** HRTIM_TIMD_DEEFR3_EEVARSTM External Event A Reset Mode **/
#define HRTIM_TIMD_DEEFR3_EEVARSTM		(1 << 2)
/** HRTIM_TIMD_DEEFR3_EEVACRES External Event A Counter Reset **/
#define HRTIM_TIMD_DEEFR3_EEVACRES		(1 << 1)
/** HRTIM_TIMD_DEEFR3_EEVACE External Event A Counter Enable **/
#define HRTIM_TIMD_DEEFR3_EEVACE		(1 << 0)
