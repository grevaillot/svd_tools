...
/** @defgroup spi4_registers Serial peripheral interface/Inter-IC       sound Register
@{*/
...
/** SPI4_CR2_LDMA_TX Last DMA transfer for transmission **/
#define SPI4_CR2_LDMA_TX		(1 << 14)
/** SPI4_CR2_LDMA_RX Last DMA transfer for reception **/
#define SPI4_CR2_LDMA_RX		(1 << 13)
/** SPI4_CR2_FRXTH FIFO reception threshold **/
#define SPI4_CR2_FRXTH		(1 << 12)

#define SPI4_CR2_DS_SHIFT		8
#define SPI4_CR2_DS_MASK		0x0f
/** @defgroup spi4_cr2_ds DS Data size
@{*/
/**@}*/
...
/** SPI4_CR2_NSSP NSS pulse management **/
#define SPI4_CR2_NSSP		(1 << 3)
...
#define SPI4_SR_FTLVL_SHIFT		11
#define SPI4_SR_FTLVL_MASK		0x03
/** @defgroup spi4_sr_ftlvl FTLVL FIFO transmission level
@{*/
/**@}*/


#define SPI4_SR_FRLVL_SHIFT		9
#define SPI4_SR_FRLVL_MASK		0x03
/** @defgroup spi4_sr_frlvl FRLVL FIFO reception level
@{*/
/**@}*/
...
/** @defgroup spi4_i2spr_i2sdiv I2SDIV I2SDIV
@{*/
/**@}*/
