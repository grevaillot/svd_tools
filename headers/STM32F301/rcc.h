...
/** RCC_CFGR_PLLNODIV Do not divide PLL to MCO **/
...
/** RCC_AHBENR_ADC1EN ADC 1 **/
#define RCC_AHBENR_ADC1EN		(1 << 28)
...
/** RCC_AHBRSTR_ADC1RST ADC1 reset **/
#define RCC_AHBRSTR_ADC1RST		(1 << 28)
...
#define RCC_CFGR2_ADC1PRES_SHIFT		4
#define RCC_CFGR2_ADC1PRES_MASK		0x0f
/** @defgroup rcc_cfgr2_adc1pres ADC1PRES ADC1 prescaler
@{*/
/**@}*/
...
#define RCC_CFGR3_TIM17SW_SHIFT		13
#define RCC_CFGR3_TIM17SW_MASK		0x03
/** @defgroup rcc_cfgr3_tim17sw TIM17SW Timer17 clock source selection
@{*/
/**@}*/

/** RCC_CFGR3_TIM16SW Timer16 clock source selection **/
#define RCC_CFGR3_TIM16SW		(1 << 11)
/** RCC_CFGR3_TIM15SW Timer15 clock source selection **/
