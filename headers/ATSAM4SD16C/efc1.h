...
/** EFC1_FMR_CLOE Code Loop Optimization Enable **/
...
/** EFC1_FMR_FRDY Flash Ready Interrupt Enable **/
...
/** EFC1_FSR_FLERR Flash Error Status (cleared when a programming operation starts) **/
#define EFC1_FSR_FLERR		(1 << 3)
/** EFC1_FSR_FLOCKE Flash Lock Error Status (cleared on read) **/
#define EFC1_FSR_FLOCKE		(1 << 2)
/** EFC1_FSR_FCMDE Flash Command Error Status (cleared on read or by writing EEFC_FCR) **/
#define EFC1_FSR_FCMDE		(1 << 1)
/** EFC1_FSR_FRDY Flash Ready Status (cleared when Flash is busy) **/
