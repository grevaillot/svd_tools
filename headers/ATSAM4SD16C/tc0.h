...
/** TC0_CMR0_WAVEFORM_MODE Channel Mode Register (channel = 0) **/
#define TC0_CMR0_WAVEFORM_MODE			MMIO32(TC0_BASE + 0x04)
...
/** TC0_CMR1_WAVEFORM_MODE Channel Mode Register (channel = 1) **/
#define TC0_CMR1_WAVEFORM_MODE			MMIO32(TC0_BASE + 0x44)
...
/** TC0_CMR2_WAVEFORM_MODE Channel Mode Register (channel = 2) **/
#define TC0_CMR2_WAVEFORM_MODE			MMIO32(TC0_BASE + 0x84)
...
/** TC0_WPMR Write Protection Mode Register **/
...
/** @defgroup tc0_cmr0_waveform_mode CMR0WAVEFORMMODE Channel Mode Register (channel = 0)
@{*/


#define TC0_CMR0_WAVEFORM_MODE_BSWTRG_SHIFT		30
#define TC0_CMR0_WAVEFORM_MODE_BSWTRG_MASK		0x03
/** @defgroup tc0_cmr0_waveform_mode_bswtrg BSWTRG Software Trigger Effect on TIOB
@{*/
/**@}*/


#define TC0_CMR0_WAVEFORM_MODE_BEEVT_SHIFT		28
#define TC0_CMR0_WAVEFORM_MODE_BEEVT_MASK		0x03
/** @defgroup tc0_cmr0_waveform_mode_beevt BEEVT External Event Effect on TIOB
@{*/
/**@}*/


#define TC0_CMR0_WAVEFORM_MODE_BCPC_SHIFT		26
#define TC0_CMR0_WAVEFORM_MODE_BCPC_MASK		0x03
/** @defgroup tc0_cmr0_waveform_mode_bcpc BCPC RC Compare Effect on TIOB
@{*/
/**@}*/


#define TC0_CMR0_WAVEFORM_MODE_BCPB_SHIFT		24
#define TC0_CMR0_WAVEFORM_MODE_BCPB_MASK		0x03
/** @defgroup tc0_cmr0_waveform_mode_bcpb BCPB RB Compare Effect on TIOB
@{*/
/**@}*/


#define TC0_CMR0_WAVEFORM_MODE_ASWTRG_SHIFT		22
#define TC0_CMR0_WAVEFORM_MODE_ASWTRG_MASK		0x03
/** @defgroup tc0_cmr0_waveform_mode_aswtrg ASWTRG Software Trigger Effect on TIOA
@{*/
/**@}*/


#define TC0_CMR0_WAVEFORM_MODE_AEEVT_SHIFT		20
#define TC0_CMR0_WAVEFORM_MODE_AEEVT_MASK		0x03
/** @defgroup tc0_cmr0_waveform_mode_aeevt AEEVT External Event Effect on TIOA
@{*/
/**@}*/


#define TC0_CMR0_WAVEFORM_MODE_ACPC_SHIFT		18
#define TC0_CMR0_WAVEFORM_MODE_ACPC_MASK		0x03
/** @defgroup tc0_cmr0_waveform_mode_acpc ACPC RC Compare Effect on TIOA
@{*/
/**@}*/


#define TC0_CMR0_WAVEFORM_MODE_ACPA_SHIFT		16
#define TC0_CMR0_WAVEFORM_MODE_ACPA_MASK		0x03
/** @defgroup tc0_cmr0_waveform_mode_acpa ACPA RA Compare Effect on TIOA
@{*/
/**@}*/

/** TC0_CMR0_WAVEFORM_MODE_WAVE Waveform Mode **/
#define TC0_CMR0_WAVEFORM_MODE_WAVE		(1 << 15)

#define TC0_CMR0_WAVEFORM_MODE_WAVSEL_SHIFT		13
#define TC0_CMR0_WAVEFORM_MODE_WAVSEL_MASK		0x03
/** @defgroup tc0_cmr0_waveform_mode_wavsel WAVSEL Waveform Selection
@{*/
/**@}*/

/** TC0_CMR0_WAVEFORM_MODE_ENETRG External Event Trigger Enable **/
#define TC0_CMR0_WAVEFORM_MODE_ENETRG		(1 << 12)

#define TC0_CMR0_WAVEFORM_MODE_EEVT_SHIFT		10
#define TC0_CMR0_WAVEFORM_MODE_EEVT_MASK		0x03
/** @defgroup tc0_cmr0_waveform_mode_eevt EEVT External Event Selection
@{*/
/**@}*/


#define TC0_CMR0_WAVEFORM_MODE_EEVTEDG_SHIFT		8
#define TC0_CMR0_WAVEFORM_MODE_EEVTEDG_MASK		0x03
/** @defgroup tc0_cmr0_waveform_mode_eevtedg EEVTEDG External Event Edge Selection
@{*/
/**@}*/

/** TC0_CMR0_WAVEFORM_MODE_CPCDIS Counter Clock Disable with RC Compare **/
#define TC0_CMR0_WAVEFORM_MODE_CPCDIS		(1 << 7)
/** TC0_CMR0_WAVEFORM_MODE_CPCSTOP Counter Clock Stopped with RC Compare **/
#define TC0_CMR0_WAVEFORM_MODE_CPCSTOP		(1 << 6)

#define TC0_CMR0_WAVEFORM_MODE_BURST_SHIFT		4
#define TC0_CMR0_WAVEFORM_MODE_BURST_MASK		0x03
/** @defgroup tc0_cmr0_waveform_mode_burst BURST Burst Signal Selection
@{*/
/**@}*/

/** TC0_CMR0_WAVEFORM_MODE_CLKI Clock Invert **/
#define TC0_CMR0_WAVEFORM_MODE_CLKI		(1 << 3)

#define TC0_CMR0_WAVEFORM_MODE_TCCLKS_SHIFT		0
#define TC0_CMR0_WAVEFORM_MODE_TCCLKS_MASK		0x07
/** @defgroup tc0_cmr0_waveform_mode_tcclks TCCLKS Clock Selection
@{*/
/**@}*/
...
/** TC0_SR0_ETRGS External Trigger Status (cleared on read) **/
#define TC0_SR0_ETRGS		(1 << 7)
/** TC0_SR0_LDRBS RB Loading Status (cleared on read) **/
#define TC0_SR0_LDRBS		(1 << 6)
/** TC0_SR0_LDRAS RA Loading Status (cleared on read) **/
#define TC0_SR0_LDRAS		(1 << 5)
/** TC0_SR0_CPCS RC Compare Status (cleared on read) **/
#define TC0_SR0_CPCS		(1 << 4)
/** TC0_SR0_CPBS RB Compare Status (cleared on read) **/
#define TC0_SR0_CPBS		(1 << 3)
/** TC0_SR0_CPAS RA Compare Status (cleared on read) **/
#define TC0_SR0_CPAS		(1 << 2)
/** TC0_SR0_LOVRS Load Overrun Status (cleared on read) **/
#define TC0_SR0_LOVRS		(1 << 1)
/** TC0_SR0_COVFS Counter Overflow Status (cleared on read) **/
...
/** @defgroup tc0_cmr1_waveform_mode CMR1WAVEFORMMODE Channel Mode Register (channel = 1)
@{*/


#define TC0_CMR1_WAVEFORM_MODE_BSWTRG_SHIFT		30
#define TC0_CMR1_WAVEFORM_MODE_BSWTRG_MASK		0x03
/** @defgroup tc0_cmr1_waveform_mode_bswtrg BSWTRG Software Trigger Effect on TIOB
@{*/
/**@}*/


#define TC0_CMR1_WAVEFORM_MODE_BEEVT_SHIFT		28
#define TC0_CMR1_WAVEFORM_MODE_BEEVT_MASK		0x03
/** @defgroup tc0_cmr1_waveform_mode_beevt BEEVT External Event Effect on TIOB
@{*/
/**@}*/


#define TC0_CMR1_WAVEFORM_MODE_BCPC_SHIFT		26
#define TC0_CMR1_WAVEFORM_MODE_BCPC_MASK		0x03
/** @defgroup tc0_cmr1_waveform_mode_bcpc BCPC RC Compare Effect on TIOB
@{*/
/**@}*/


#define TC0_CMR1_WAVEFORM_MODE_BCPB_SHIFT		24
#define TC0_CMR1_WAVEFORM_MODE_BCPB_MASK		0x03
/** @defgroup tc0_cmr1_waveform_mode_bcpb BCPB RB Compare Effect on TIOB
@{*/
/**@}*/


#define TC0_CMR1_WAVEFORM_MODE_ASWTRG_SHIFT		22
#define TC0_CMR1_WAVEFORM_MODE_ASWTRG_MASK		0x03
/** @defgroup tc0_cmr1_waveform_mode_aswtrg ASWTRG Software Trigger Effect on TIOA
@{*/
/**@}*/


#define TC0_CMR1_WAVEFORM_MODE_AEEVT_SHIFT		20
#define TC0_CMR1_WAVEFORM_MODE_AEEVT_MASK		0x03
/** @defgroup tc0_cmr1_waveform_mode_aeevt AEEVT External Event Effect on TIOA
@{*/
/**@}*/


#define TC0_CMR1_WAVEFORM_MODE_ACPC_SHIFT		18
#define TC0_CMR1_WAVEFORM_MODE_ACPC_MASK		0x03
/** @defgroup tc0_cmr1_waveform_mode_acpc ACPC RC Compare Effect on TIOA
@{*/
/**@}*/


#define TC0_CMR1_WAVEFORM_MODE_ACPA_SHIFT		16
#define TC0_CMR1_WAVEFORM_MODE_ACPA_MASK		0x03
/** @defgroup tc0_cmr1_waveform_mode_acpa ACPA RA Compare Effect on TIOA
@{*/
/**@}*/

/** TC0_CMR1_WAVEFORM_MODE_WAVE Waveform Mode **/
#define TC0_CMR1_WAVEFORM_MODE_WAVE		(1 << 15)

#define TC0_CMR1_WAVEFORM_MODE_WAVSEL_SHIFT		13
#define TC0_CMR1_WAVEFORM_MODE_WAVSEL_MASK		0x03
/** @defgroup tc0_cmr1_waveform_mode_wavsel WAVSEL Waveform Selection
@{*/
/**@}*/

/** TC0_CMR1_WAVEFORM_MODE_ENETRG External Event Trigger Enable **/
#define TC0_CMR1_WAVEFORM_MODE_ENETRG		(1 << 12)

#define TC0_CMR1_WAVEFORM_MODE_EEVT_SHIFT		10
#define TC0_CMR1_WAVEFORM_MODE_EEVT_MASK		0x03
/** @defgroup tc0_cmr1_waveform_mode_eevt EEVT External Event Selection
@{*/
/**@}*/


#define TC0_CMR1_WAVEFORM_MODE_EEVTEDG_SHIFT		8
#define TC0_CMR1_WAVEFORM_MODE_EEVTEDG_MASK		0x03
/** @defgroup tc0_cmr1_waveform_mode_eevtedg EEVTEDG External Event Edge Selection
@{*/
/**@}*/

/** TC0_CMR1_WAVEFORM_MODE_CPCDIS Counter Clock Disable with RC Compare **/
#define TC0_CMR1_WAVEFORM_MODE_CPCDIS		(1 << 7)
/** TC0_CMR1_WAVEFORM_MODE_CPCSTOP Counter Clock Stopped with RC Compare **/
#define TC0_CMR1_WAVEFORM_MODE_CPCSTOP		(1 << 6)

#define TC0_CMR1_WAVEFORM_MODE_BURST_SHIFT		4
#define TC0_CMR1_WAVEFORM_MODE_BURST_MASK		0x03
/** @defgroup tc0_cmr1_waveform_mode_burst BURST Burst Signal Selection
@{*/
/**@}*/

/** TC0_CMR1_WAVEFORM_MODE_CLKI Clock Invert **/
#define TC0_CMR1_WAVEFORM_MODE_CLKI		(1 << 3)

#define TC0_CMR1_WAVEFORM_MODE_TCCLKS_SHIFT		0
#define TC0_CMR1_WAVEFORM_MODE_TCCLKS_MASK		0x07
/** @defgroup tc0_cmr1_waveform_mode_tcclks TCCLKS Clock Selection
@{*/
/**@}*/
...
/** TC0_SR1_ETRGS External Trigger Status (cleared on read) **/
#define TC0_SR1_ETRGS		(1 << 7)
/** TC0_SR1_LDRBS RB Loading Status (cleared on read) **/
#define TC0_SR1_LDRBS		(1 << 6)
/** TC0_SR1_LDRAS RA Loading Status (cleared on read) **/
#define TC0_SR1_LDRAS		(1 << 5)
/** TC0_SR1_CPCS RC Compare Status (cleared on read) **/
#define TC0_SR1_CPCS		(1 << 4)
/** TC0_SR1_CPBS RB Compare Status (cleared on read) **/
#define TC0_SR1_CPBS		(1 << 3)
/** TC0_SR1_CPAS RA Compare Status (cleared on read) **/
#define TC0_SR1_CPAS		(1 << 2)
/** TC0_SR1_LOVRS Load Overrun Status (cleared on read) **/
#define TC0_SR1_LOVRS		(1 << 1)
/** TC0_SR1_COVFS Counter Overflow Status (cleared on read) **/
...
/** @defgroup tc0_cmr2_waveform_mode CMR2WAVEFORMMODE Channel Mode Register (channel = 2)
@{*/


#define TC0_CMR2_WAVEFORM_MODE_BSWTRG_SHIFT		30
#define TC0_CMR2_WAVEFORM_MODE_BSWTRG_MASK		0x03
/** @defgroup tc0_cmr2_waveform_mode_bswtrg BSWTRG Software Trigger Effect on TIOB
@{*/
/**@}*/


#define TC0_CMR2_WAVEFORM_MODE_BEEVT_SHIFT		28
#define TC0_CMR2_WAVEFORM_MODE_BEEVT_MASK		0x03
/** @defgroup tc0_cmr2_waveform_mode_beevt BEEVT External Event Effect on TIOB
@{*/
/**@}*/


#define TC0_CMR2_WAVEFORM_MODE_BCPC_SHIFT		26
#define TC0_CMR2_WAVEFORM_MODE_BCPC_MASK		0x03
/** @defgroup tc0_cmr2_waveform_mode_bcpc BCPC RC Compare Effect on TIOB
@{*/
/**@}*/


#define TC0_CMR2_WAVEFORM_MODE_BCPB_SHIFT		24
#define TC0_CMR2_WAVEFORM_MODE_BCPB_MASK		0x03
/** @defgroup tc0_cmr2_waveform_mode_bcpb BCPB RB Compare Effect on TIOB
@{*/
/**@}*/


#define TC0_CMR2_WAVEFORM_MODE_ASWTRG_SHIFT		22
#define TC0_CMR2_WAVEFORM_MODE_ASWTRG_MASK		0x03
/** @defgroup tc0_cmr2_waveform_mode_aswtrg ASWTRG Software Trigger Effect on TIOA
@{*/
/**@}*/


#define TC0_CMR2_WAVEFORM_MODE_AEEVT_SHIFT		20
#define TC0_CMR2_WAVEFORM_MODE_AEEVT_MASK		0x03
/** @defgroup tc0_cmr2_waveform_mode_aeevt AEEVT External Event Effect on TIOA
@{*/
/**@}*/


#define TC0_CMR2_WAVEFORM_MODE_ACPC_SHIFT		18
#define TC0_CMR2_WAVEFORM_MODE_ACPC_MASK		0x03
/** @defgroup tc0_cmr2_waveform_mode_acpc ACPC RC Compare Effect on TIOA
@{*/
/**@}*/


#define TC0_CMR2_WAVEFORM_MODE_ACPA_SHIFT		16
#define TC0_CMR2_WAVEFORM_MODE_ACPA_MASK		0x03
/** @defgroup tc0_cmr2_waveform_mode_acpa ACPA RA Compare Effect on TIOA
@{*/
/**@}*/

/** TC0_CMR2_WAVEFORM_MODE_WAVE Waveform Mode **/
#define TC0_CMR2_WAVEFORM_MODE_WAVE		(1 << 15)

#define TC0_CMR2_WAVEFORM_MODE_WAVSEL_SHIFT		13
#define TC0_CMR2_WAVEFORM_MODE_WAVSEL_MASK		0x03
/** @defgroup tc0_cmr2_waveform_mode_wavsel WAVSEL Waveform Selection
@{*/
/**@}*/

/** TC0_CMR2_WAVEFORM_MODE_ENETRG External Event Trigger Enable **/
#define TC0_CMR2_WAVEFORM_MODE_ENETRG		(1 << 12)

#define TC0_CMR2_WAVEFORM_MODE_EEVT_SHIFT		10
#define TC0_CMR2_WAVEFORM_MODE_EEVT_MASK		0x03
/** @defgroup tc0_cmr2_waveform_mode_eevt EEVT External Event Selection
@{*/
/**@}*/


#define TC0_CMR2_WAVEFORM_MODE_EEVTEDG_SHIFT		8
#define TC0_CMR2_WAVEFORM_MODE_EEVTEDG_MASK		0x03
/** @defgroup tc0_cmr2_waveform_mode_eevtedg EEVTEDG External Event Edge Selection
@{*/
/**@}*/

/** TC0_CMR2_WAVEFORM_MODE_CPCDIS Counter Clock Disable with RC Compare **/
#define TC0_CMR2_WAVEFORM_MODE_CPCDIS		(1 << 7)
/** TC0_CMR2_WAVEFORM_MODE_CPCSTOP Counter Clock Stopped with RC Compare **/
#define TC0_CMR2_WAVEFORM_MODE_CPCSTOP		(1 << 6)

#define TC0_CMR2_WAVEFORM_MODE_BURST_SHIFT		4
#define TC0_CMR2_WAVEFORM_MODE_BURST_MASK		0x03
/** @defgroup tc0_cmr2_waveform_mode_burst BURST Burst Signal Selection
@{*/
/**@}*/

/** TC0_CMR2_WAVEFORM_MODE_CLKI Clock Invert **/
#define TC0_CMR2_WAVEFORM_MODE_CLKI		(1 << 3)

#define TC0_CMR2_WAVEFORM_MODE_TCCLKS_SHIFT		0
#define TC0_CMR2_WAVEFORM_MODE_TCCLKS_MASK		0x07
/** @defgroup tc0_cmr2_waveform_mode_tcclks TCCLKS Clock Selection
@{*/
/**@}*/
...
/** TC0_SR2_ETRGS External Trigger Status (cleared on read) **/
#define TC0_SR2_ETRGS		(1 << 7)
/** TC0_SR2_LDRBS RB Loading Status (cleared on read) **/
#define TC0_SR2_LDRBS		(1 << 6)
/** TC0_SR2_LDRAS RA Loading Status (cleared on read) **/
#define TC0_SR2_LDRAS		(1 << 5)
/** TC0_SR2_CPCS RC Compare Status (cleared on read) **/
#define TC0_SR2_CPCS		(1 << 4)
/** TC0_SR2_CPBS RB Compare Status (cleared on read) **/
#define TC0_SR2_CPBS		(1 << 3)
/** TC0_SR2_CPAS RA Compare Status (cleared on read) **/
#define TC0_SR2_CPAS		(1 << 2)
/** TC0_SR2_LOVRS Load Overrun Status (cleared on read) **/
#define TC0_SR2_LOVRS		(1 << 1)
/** TC0_SR2_COVFS Counter Overflow Status (cleared on read) **/
...
/** @defgroup tc0_wpmr WPMR Write Protection Mode Register
@{*/


#define TC0_WPMR_WPKEY_SHIFT		8
#define TC0_WPMR_WPKEY_MASK		0xffffff
/** @defgroup tc0_wpmr_wpkey WPKEY Write Protection Key
@{*/
/**@}*/

/** TC0_WPMR_WPEN Write Protection Enable **/
