...
/** DACC_WPMR Write Protection Mode Register **/
#define DACC_WPMR			MMIO32(DACC_BASE + 0xe4)
/** DACC_WPSR Write Protection Status Register **/
...
/** DACC_MR_MAXS Maximum Speed Mode **/
...
/** DACC_MR_ONE Must Be Set to 1 **/
#define DACC_MR_ONE		(1 << 8)
...
/** @defgroup dacc_wpmr WPMR Write Protection Mode Register
@{*/


#define DACC_WPMR_WPKEY_SHIFT		8
#define DACC_WPMR_WPKEY_MASK		0xffffff
/** @defgroup dacc_wpmr_wpkey WPKEY Write Protection Key
@{*/
/**@}*/

/** DACC_WPMR_WPEN Write Protection Enable **/
#define DACC_WPMR_WPEN		(1 << 0)

/**@}*/

/** @defgroup dacc_wpsr WPSR Write Protection Status Register
@{*/


#define DACC_WPSR_WPVSRC_SHIFT		8
#define DACC_WPSR_WPVSRC_MASK		0xff
/** @defgroup dacc_wpsr_wpvsrc WPVSRC Write Protection Violation Source
@{*/
/**@}*/

/** DACC_WPSR_WPVS Write Protection Violation Status **/
