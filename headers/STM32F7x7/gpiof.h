...
/** GPIOF_GPIOB_OSPEEDR GPIO port output speed register **/
#define GPIOF_GPIOB_OSPEEDR			MMIO32(GPIOF_BASE + 0x08)
...
/** GPIOF_LCKR GPIO port configuration lock register **/
#define GPIOF_LCKR			MMIO32(GPIOF_BASE + 0x1c)
/** GPIOF_AFRL GPIO alternate function lowregister **/
...
/** GPIOF_OTYPER_OT15 Port x configuration bits (y = 0..15) **/
#define GPIOF_OTYPER_OT15		(1 << 15)
/** GPIOF_OTYPER_OT14 Port x configuration bits (y = 0..15) **/
#define GPIOF_OTYPER_OT14		(1 << 14)
/** GPIOF_OTYPER_OT13 Port x configuration bits (y = 0..15) **/
#define GPIOF_OTYPER_OT13		(1 << 13)
/** GPIOF_OTYPER_OT12 Port x configuration bits (y = 0..15) **/
#define GPIOF_OTYPER_OT12		(1 << 12)
/** GPIOF_OTYPER_OT11 Port x configuration bits (y = 0..15) **/
#define GPIOF_OTYPER_OT11		(1 << 11)
/** GPIOF_OTYPER_OT10 Port x configuration bits (y = 0..15) **/
#define GPIOF_OTYPER_OT10		(1 << 10)
/** GPIOF_OTYPER_OT9 Port x configuration bits (y = 0..15) **/
#define GPIOF_OTYPER_OT9		(1 << 9)
/** GPIOF_OTYPER_OT8 Port x configuration bits (y = 0..15) **/
#define GPIOF_OTYPER_OT8		(1 << 8)
/** GPIOF_OTYPER_OT7 Port x configuration bits (y = 0..15) **/
#define GPIOF_OTYPER_OT7		(1 << 7)
/** GPIOF_OTYPER_OT6 Port x configuration bits (y = 0..15) **/
#define GPIOF_OTYPER_OT6		(1 << 6)
/** GPIOF_OTYPER_OT5 Port x configuration bits (y = 0..15) **/
#define GPIOF_OTYPER_OT5		(1 << 5)
/** GPIOF_OTYPER_OT4 Port x configuration bits (y = 0..15) **/
#define GPIOF_OTYPER_OT4		(1 << 4)
/** GPIOF_OTYPER_OT3 Port x configuration bits (y = 0..15) **/
#define GPIOF_OTYPER_OT3		(1 << 3)
/** GPIOF_OTYPER_OT2 Port x configuration bits (y = 0..15) **/
#define GPIOF_OTYPER_OT2		(1 << 2)
/** GPIOF_OTYPER_OT1 Port x configuration bits (y = 0..15) **/
#define GPIOF_OTYPER_OT1		(1 << 1)
/** GPIOF_OTYPER_OT0 Port x configuration bits (y = 0..15) **/
#define GPIOF_OTYPER_OT0		(1 << 0)

/**@}*/

/** @defgroup gpiof_gpiob_ospeedr GPIOBOSPEEDR GPIO port output speed register
@{*/


#define GPIOF_GPIOB_OSPEEDR_OSPEEDR15_SHIFT		30
#define GPIOF_GPIOB_OSPEEDR_OSPEEDR15_MASK		0x03
/** @defgroup gpiof_gpiob_ospeedr_ospeedr15 OSPEEDR15 Port x configuration bits (y = 0..15)
@{*/
/**@}*/


#define GPIOF_GPIOB_OSPEEDR_OSPEEDR14_SHIFT		28
#define GPIOF_GPIOB_OSPEEDR_OSPEEDR14_MASK		0x03
/** @defgroup gpiof_gpiob_ospeedr_ospeedr14 OSPEEDR14 Port x configuration bits (y = 0..15)
@{*/
/**@}*/


#define GPIOF_GPIOB_OSPEEDR_OSPEEDR13_SHIFT		26
#define GPIOF_GPIOB_OSPEEDR_OSPEEDR13_MASK		0x03
/** @defgroup gpiof_gpiob_ospeedr_ospeedr13 OSPEEDR13 Port x configuration bits (y = 0..15)
@{*/
/**@}*/


#define GPIOF_GPIOB_OSPEEDR_OSPEEDR12_SHIFT		24
#define GPIOF_GPIOB_OSPEEDR_OSPEEDR12_MASK		0x03
/** @defgroup gpiof_gpiob_ospeedr_ospeedr12 OSPEEDR12 Port x configuration bits (y = 0..15)
@{*/
/**@}*/


#define GPIOF_GPIOB_OSPEEDR_OSPEEDR11_SHIFT		22
#define GPIOF_GPIOB_OSPEEDR_OSPEEDR11_MASK		0x03
/** @defgroup gpiof_gpiob_ospeedr_ospeedr11 OSPEEDR11 Port x configuration bits (y = 0..15)
@{*/
/**@}*/


#define GPIOF_GPIOB_OSPEEDR_OSPEEDR10_SHIFT		20
#define GPIOF_GPIOB_OSPEEDR_OSPEEDR10_MASK		0x03
/** @defgroup gpiof_gpiob_ospeedr_ospeedr10 OSPEEDR10 Port x configuration bits (y = 0..15)
@{*/
/**@}*/


#define GPIOF_GPIOB_OSPEEDR_OSPEEDR9_SHIFT		18
#define GPIOF_GPIOB_OSPEEDR_OSPEEDR9_MASK		0x03
/** @defgroup gpiof_gpiob_ospeedr_ospeedr9 OSPEEDR9 Port x configuration bits (y = 0..15)
@{*/
/**@}*/


#define GPIOF_GPIOB_OSPEEDR_OSPEEDR8_SHIFT		16
#define GPIOF_GPIOB_OSPEEDR_OSPEEDR8_MASK		0x03
/** @defgroup gpiof_gpiob_ospeedr_ospeedr8 OSPEEDR8 Port x configuration bits (y = 0..15)
@{*/
/**@}*/


#define GPIOF_GPIOB_OSPEEDR_OSPEEDR7_SHIFT		14
#define GPIOF_GPIOB_OSPEEDR_OSPEEDR7_MASK		0x03
/** @defgroup gpiof_gpiob_ospeedr_ospeedr7 OSPEEDR7 Port x configuration bits (y = 0..15)
@{*/
/**@}*/


#define GPIOF_GPIOB_OSPEEDR_OSPEEDR6_SHIFT		12
#define GPIOF_GPIOB_OSPEEDR_OSPEEDR6_MASK		0x03
/** @defgroup gpiof_gpiob_ospeedr_ospeedr6 OSPEEDR6 Port x configuration bits (y = 0..15)
@{*/
/**@}*/


#define GPIOF_GPIOB_OSPEEDR_OSPEEDR5_SHIFT		10
#define GPIOF_GPIOB_OSPEEDR_OSPEEDR5_MASK		0x03
/** @defgroup gpiof_gpiob_ospeedr_ospeedr5 OSPEEDR5 Port x configuration bits (y = 0..15)
@{*/
/**@}*/


#define GPIOF_GPIOB_OSPEEDR_OSPEEDR4_SHIFT		8
#define GPIOF_GPIOB_OSPEEDR_OSPEEDR4_MASK		0x03
/** @defgroup gpiof_gpiob_ospeedr_ospeedr4 OSPEEDR4 Port x configuration bits (y = 0..15)
@{*/
/**@}*/


#define GPIOF_GPIOB_OSPEEDR_OSPEEDR3_SHIFT		6
#define GPIOF_GPIOB_OSPEEDR_OSPEEDR3_MASK		0x03
/** @defgroup gpiof_gpiob_ospeedr_ospeedr3 OSPEEDR3 Port x configuration bits (y = 0..15)
@{*/
/**@}*/


#define GPIOF_GPIOB_OSPEEDR_OSPEEDR2_SHIFT		4
#define GPIOF_GPIOB_OSPEEDR_OSPEEDR2_MASK		0x03
/** @defgroup gpiof_gpiob_ospeedr_ospeedr2 OSPEEDR2 Port x configuration bits (y = 0..15)
@{*/
/**@}*/


#define GPIOF_GPIOB_OSPEEDR_OSPEEDR1_SHIFT		2
#define GPIOF_GPIOB_OSPEEDR_OSPEEDR1_MASK		0x03
/** @defgroup gpiof_gpiob_ospeedr_ospeedr1 OSPEEDR1 Port x configuration bits (y = 0..15)
@{*/
/**@}*/


#define GPIOF_GPIOB_OSPEEDR_OSPEEDR0_SHIFT		0
#define GPIOF_GPIOB_OSPEEDR_OSPEEDR0_MASK		0x03
/** @defgroup gpiof_gpiob_ospeedr_ospeedr0 OSPEEDR0 Port x configuration bits (y = 0..15)
@{*/
/**@}*/
...
/** @defgroup gpiof_lckr LCKR GPIO port configuration lock register
@{*/

/** GPIOF_LCKR_LCKK Port x lock bit y (y= 0..15) **/
#define GPIOF_LCKR_LCKK		(1 << 16)
/** GPIOF_LCKR_LCK15 Port x lock bit y (y= 0..15) **/
#define GPIOF_LCKR_LCK15		(1 << 15)
/** GPIOF_LCKR_LCK14 Port x lock bit y (y= 0..15) **/
#define GPIOF_LCKR_LCK14		(1 << 14)
/** GPIOF_LCKR_LCK13 Port x lock bit y (y= 0..15) **/
#define GPIOF_LCKR_LCK13		(1 << 13)
/** GPIOF_LCKR_LCK12 Port x lock bit y (y= 0..15) **/
#define GPIOF_LCKR_LCK12		(1 << 12)
/** GPIOF_LCKR_LCK11 Port x lock bit y (y= 0..15) **/
#define GPIOF_LCKR_LCK11		(1 << 11)
/** GPIOF_LCKR_LCK10 Port x lock bit y (y= 0..15) **/
#define GPIOF_LCKR_LCK10		(1 << 10)
/** GPIOF_LCKR_LCK9 Port x lock bit y (y= 0..15) **/
#define GPIOF_LCKR_LCK9		(1 << 9)
/** GPIOF_LCKR_LCK8 Port x lock bit y (y= 0..15) **/
#define GPIOF_LCKR_LCK8		(1 << 8)
/** GPIOF_LCKR_LCK7 Port x lock bit y (y= 0..15) **/
#define GPIOF_LCKR_LCK7		(1 << 7)
/** GPIOF_LCKR_LCK6 Port x lock bit y (y= 0..15) **/
#define GPIOF_LCKR_LCK6		(1 << 6)
/** GPIOF_LCKR_LCK5 Port x lock bit y (y= 0..15) **/
#define GPIOF_LCKR_LCK5		(1 << 5)
/** GPIOF_LCKR_LCK4 Port x lock bit y (y= 0..15) **/
#define GPIOF_LCKR_LCK4		(1 << 4)
/** GPIOF_LCKR_LCK3 Port x lock bit y (y= 0..15) **/
#define GPIOF_LCKR_LCK3		(1 << 3)
/** GPIOF_LCKR_LCK2 Port x lock bit y (y= 0..15) **/
#define GPIOF_LCKR_LCK2		(1 << 2)
/** GPIOF_LCKR_LCK1 Port x lock bit y (y= 0..15) **/
#define GPIOF_LCKR_LCK1		(1 << 1)
/** GPIOF_LCKR_LCK0 Port x lock bit y (y= 0..15) **/
#define GPIOF_LCKR_LCK0		(1 << 0)

/**@}*/

/** @defgroup gpiof_afrl AFRL GPIO alternate function lowregister
@{*/
...
/** @defgroup gpiof_brr BRR GPIO port bit reset register
@{*/

/** GPIOF_BRR_BR15 Port D Reset bit 15 **/
#define GPIOF_BRR_BR15		(1 << 15)
/** GPIOF_BRR_BR14 Port D Reset bit 14 **/
#define GPIOF_BRR_BR14		(1 << 14)
/** GPIOF_BRR_BR13 Port D Reset bit 13 **/
#define GPIOF_BRR_BR13		(1 << 13)
/** GPIOF_BRR_BR12 Port D Reset bit 12 **/
#define GPIOF_BRR_BR12		(1 << 12)
/** GPIOF_BRR_BR11 Port D Reset bit 11 **/
#define GPIOF_BRR_BR11		(1 << 11)
/** GPIOF_BRR_BR10 Port D Reset bit 10 **/
#define GPIOF_BRR_BR10		(1 << 10)
/** GPIOF_BRR_BR9 Port D Reset bit 9 **/
#define GPIOF_BRR_BR9		(1 << 9)
/** GPIOF_BRR_BR8 Port D Reset bit 8 **/
#define GPIOF_BRR_BR8		(1 << 8)
/** GPIOF_BRR_BR7 Port D Reset bit 7 **/
#define GPIOF_BRR_BR7		(1 << 7)
/** GPIOF_BRR_BR6 Port D Reset bit 6 **/
#define GPIOF_BRR_BR6		(1 << 6)
/** GPIOF_BRR_BR5 Port D Reset bit 5 **/
#define GPIOF_BRR_BR5		(1 << 5)
/** GPIOF_BRR_BR4 Port D Reset bit 4 **/
#define GPIOF_BRR_BR4		(1 << 4)
/** GPIOF_BRR_BR3 Port D Reset bit 3 **/
#define GPIOF_BRR_BR3		(1 << 3)
/** GPIOF_BRR_BR2 Port D Reset bit 2 **/
#define GPIOF_BRR_BR2		(1 << 2)
/** GPIOF_BRR_BR1 Port D Reset bit 1 **/
#define GPIOF_BRR_BR1		(1 << 1)
/** GPIOF_BRR_BR0 Port D Reset bit 0 **/
