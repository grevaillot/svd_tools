...
/** TIM1_AF1 alternate function option register 1 **/
#define TIM1_AF1			MMIO32(TIM1_BASE + 0x60)
/** TIM1_AF2 alternate function option register 2 **/
...
/** @defgroup tim1_af1 AF1 alternate function option register 1
@{*/

/** TIM1_AF1_BKINP BRK BKIN input polarity **/
#define TIM1_AF1_BKINP		(1 << 9)
/** TIM1_AF1_BKDFBKE BRK DFSDM_BREAK[0] enable **/
#define TIM1_AF1_BKDFBKE		(1 << 8)
/** TIM1_AF1_BKINE BRK BKIN input enable **/
#define TIM1_AF1_BKINE		(1 << 0)

/**@}*/

/** @defgroup tim1_af2 AF2 alternate function option register 2
@{*/

/** TIM1_AF2_BK2INP BRK2 BKIN2 input polarity **/
#define TIM1_AF2_BK2INP		(1 << 9)
/** TIM1_AF2_BK2DFBKE BRK2 DFSDM_BREAK enable **/
#define TIM1_AF2_BK2DFBKE		(1 << 8)
