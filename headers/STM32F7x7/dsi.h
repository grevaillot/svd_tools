...
/** @defgroup dsi_dsi_dltcr DSIDLTCR DSI Host Data Lane Timer Configuration Register
@{*/


#define DSI_DSI_DLTCR_HS2LP_TIME_SHIFT		24
#define DSI_DSI_DLTCR_HS2LP_TIME_MASK		0xff
/** @defgroup dsi_dsi_dltcr_hs2lp_time HS2LPTIME High-Speed To Low-Power Time
@{*/
/**@}*/


#define DSI_DSI_DLTCR_LP2HS_TIME_SHIFT		16
#define DSI_DSI_DLTCR_LP2HS_TIME_MASK		0xff
/** @defgroup dsi_dsi_dltcr_lp2hs_time LP2HSTIME Low-Power To High-Speed Time
@{*/
/**@}*/


#define DSI_DSI_DLTCR_MRD_TIME_SHIFT		0
#define DSI_DSI_DLTCR_MRD_TIME_MASK		0x7fff
/** @defgroup dsi_dsi_dltcr_mrd_time MRDTIME Maximum Read Time
@{*/
/**@}*/
