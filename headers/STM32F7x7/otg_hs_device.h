...
#define OTG_HS_DEVICE_OTG_HS_DIEPTSIZ6			MMIO32(OTG_HS_DEVICE_BASE + 0x1a0)
/** OTG_HS_DEVICE_OTG_HS_DTXFSTS6 OTG_HS device IN endpoint transmit FIFO status register **/
#define OTG_HS_DEVICE_OTG_HS_DTXFSTS6			MMIO32(OTG_HS_DEVICE_BASE + 0x1a4)
...
#define OTG_HS_DEVICE_OTG_HS_DIEPTSIZ7			MMIO32(OTG_HS_DEVICE_BASE + 0x1a8)
/** OTG_HS_DEVICE_OTG_HS_DTXFSTS7 OTG_HS device IN endpoint transmit FIFO status register **/
#define OTG_HS_DEVICE_OTG_HS_DTXFSTS7			MMIO32(OTG_HS_DEVICE_BASE + 0x1ac)
