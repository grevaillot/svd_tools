...
/** SPI0_SPI_CSR[0] Chip Select Register **/
#define SPI0_SPI_CSR[0]			MMIO32(SPI0_BASE + 0x30)
/** SPI0_SPI_CSR[1] Chip Select Register **/
#define SPI0_SPI_CSR[1]			MMIO32(SPI0_BASE + 0x34)
/** SPI0_SPI_CSR[2] Chip Select Register **/
#define SPI0_SPI_CSR[2]			MMIO32(SPI0_BASE + 0x38)
/** SPI0_SPI_CSR[3] Chip Select Register **/
...
/** @defgroup spi0_spi_csr[0] SPICSR[0] Chip Select Register
@{*/
...
/** @defgroup spi0_spi_csr[1] SPICSR[1] Chip Select Register
@{*/
...
/** @defgroup spi0_spi_csr[2] SPICSR[2] Chip Select Register
@{*/
...
/** @defgroup spi0_spi_csr[3] SPICSR[3] Chip Select Register
@{*/
