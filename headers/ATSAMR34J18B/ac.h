...
/** AC_SCALER0 Scaler n **/
#define AC_SCALER0			MMIO32(AC_BASE + 0x0c)
/** AC_SCALER1 Scaler n **/
#define AC_SCALER1			MMIO32(AC_BASE + 0x0d)
...
#define AC_COMPCTRL0_OUT_SHIFT		28
...
#define AC_COMPCTRL0_HYST_SHIFT		20
#define AC_COMPCTRL0_HYST_MASK		0x03
/** @defgroup ac_compctrl0_hyst HYST Hysteresis Level
@{*/
/**@}*/

/** AC_COMPCTRL0_HYSTEN Hysteresis Enable **/
#define AC_COMPCTRL0_HYSTEN		(1 << 19)

#define AC_COMPCTRL0_SPEED_SHIFT		16
...
#define AC_COMPCTRL0_MUXPOS_MASK		0x07
...
/** AC_COMPCTRL0_RUNSTDBY Run in Standby **/
#define AC_COMPCTRL0_RUNSTDBY		(1 << 6)

#define AC_COMPCTRL0_INTSEL_SHIFT		3
...
#define AC_COMPCTRL0_SINGLE		(1 << 2)
/** AC_COMPCTRL0_ENABLE Enable **/
#define AC_COMPCTRL0_ENABLE		(1 << 1)
...
#define AC_COMPCTRL1_OUT_SHIFT		28
...
#define AC_COMPCTRL1_HYST_SHIFT		20
#define AC_COMPCTRL1_HYST_MASK		0x03
/** @defgroup ac_compctrl1_hyst HYST Hysteresis Level
@{*/
/**@}*/

/** AC_COMPCTRL1_HYSTEN Hysteresis Enable **/
#define AC_COMPCTRL1_HYSTEN		(1 << 19)

#define AC_COMPCTRL1_SPEED_SHIFT		16
...
#define AC_COMPCTRL1_MUXPOS_MASK		0x07
...
/** AC_COMPCTRL1_RUNSTDBY Run in Standby **/
#define AC_COMPCTRL1_RUNSTDBY		(1 << 6)

#define AC_COMPCTRL1_INTSEL_SHIFT		3
...
#define AC_COMPCTRL1_SINGLE		(1 << 2)
/** AC_COMPCTRL1_ENABLE Enable **/
#define AC_COMPCTRL1_ENABLE		(1 << 1)
