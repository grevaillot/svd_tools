...
/** RTC_TSTR_ALARMOUTTYPE AFO_ALARM output type **/
#define RTC_TSTR_ALARMOUTTYPE		(1 << 18)
/** RTC_TSTR_TSINSEL TIMESTAMP mapping **/
#define RTC_TSTR_TSINSEL		(1 << 17)
/** RTC_TSTR_TAMP1INSEL TAMPER1 mapping **/
#define RTC_TSTR_TAMP1INSEL		(1 << 16)
/** RTC_TSTR_TAMPIE Tamper interrupt enable **/
#define RTC_TSTR_TAMPIE		(1 << 2)
/** RTC_TSTR_TAMP1TRG Active level for tamper 1 **/
#define RTC_TSTR_TAMP1TRG		(1 << 1)
/** RTC_TSTR_TAMP1E Tamper 1 detection enable **/
#define RTC_TSTR_TAMP1E		(1 << 0)
