...
/** @defgroup ethernet_mac_registers Ethernet: media access control (MAC) Register
@{*/
...
#define Ethernet_MAC_MACRWKPFR_MACRWKPFR_SHIFT		0
#define Ethernet_MAC_MACRWKPFR_MACRWKPFR_MASK		0xffffffff
/** @defgroup ethernet_mac_macrwkpfr_macrwkpfr MACRWKPFR MACRWKPFR
@{*/
/**@}*/
...
#define Ethernet_MAC_MACHWF1R_ADDR64_SHIFT		14
#define Ethernet_MAC_MACHWF1R_ADDR64_MASK		0x03
/** @defgroup ethernet_mac_machwf1r_addr64 ADDR64 ADDR64
@{*/
/**@}*/
