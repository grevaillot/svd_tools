...
/** LPTIM5_CFGR2 LPTIM configuration register 2 **/
#define LPTIM5_CFGR2			MMIO32(LPTIM5_BASE + 0x24)
...
/** @defgroup lptim5_cfgr2 CFGR2 LPTIM configuration register 2
@{*/


#define LPTIM5_CFGR2_IN1SEL_SHIFT		0
#define LPTIM5_CFGR2_IN1SEL_MASK		0x03
/** @defgroup lptim5_cfgr2_in1sel IN1SEL LPTIM Input 1 selection
@{*/
/**@}*/
