...
/** SYSCFG_PWRCR SYSCFG power control register **/
...
/** SYSCFG_PMCR_BOOSTVDDSEL Analog switch supply voltage selection **/
#define SYSCFG_PMCR_BOOSTVDDSEL		(1 << 9)
...
/** @defgroup syscfg_pwrcr PWRCR SYSCFG power control register
@{*/


#define SYSCFG_PWRCR_ODEN_SHIFT		0
#define SYSCFG_PWRCR_ODEN_MASK		0x0f
/** @defgroup syscfg_pwrcr_oden ODEN Overdrive enable
@{*/
/**@}*/
