...
#define TIM12_CR1_CMS_SHIFT		5
#define TIM12_CR1_CMS_MASK		0x03
/** @defgroup tim12_cr1_cms CMS Center-aligned mode selection
@{*/
/**@}*/

/** TIM12_CR1_DIR Direction **/
#define TIM12_CR1_DIR		(1 << 4)
...
#define TIM12_CNT_CNT_H_MASK		0xffff
