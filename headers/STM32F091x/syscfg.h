...
/** SYSCFG_CFGR1_TIM3_DMA_RMP TIM3 DMA request remapping bit **/
#define SYSCFG_CFGR1_TIM3_DMA_RMP		(1 << 30)
/** SYSCFG_CFGR1_TIM2_DMA_RMP TIM2 DMA request remapping bit **/
#define SYSCFG_CFGR1_TIM2_DMA_RMP		(1 << 29)
/** SYSCFG_CFGR1_TIM1_DMA_RMP TIM1 DMA request remapping bit **/
#define SYSCFG_CFGR1_TIM1_DMA_RMP		(1 << 28)
/** SYSCFG_CFGR1_I2C1_DMA_RMP I2C1 DMA request remapping bit **/
#define SYSCFG_CFGR1_I2C1_DMA_RMP		(1 << 27)
/** SYSCFG_CFGR1_USART3_DMA_RMP USART3 DMA request remapping bit **/
#define SYSCFG_CFGR1_USART3_DMA_RMP		(1 << 26)
/** SYSCFG_CFGR1_USART2_DMA_RMP USART2 DMA request remapping bit **/
#define SYSCFG_CFGR1_USART2_DMA_RMP		(1 << 25)
/** SYSCFG_CFGR1_SPI2_DMA_RMP SPI2 DMA request remapping bit **/
#define SYSCFG_CFGR1_SPI2_DMA_RMP		(1 << 24)
/** SYSCFG_CFGR1_I2C2_FM_plus FM+ driving capability activation for I2C2 **/
#define SYSCFG_CFGR1_I2C2_FM_plus		(1 << 21)
/** SYSCFG_CFGR1_I2C1_FM_plus FM+ driving capability activation for I2C1 **/
#define SYSCFG_CFGR1_I2C1_FM_plus		(1 << 20)
...
/** SYSCFG_CFGR1_I2C_PB6_FM Fast Mode Plus (FM plus) driving capability activation bits. **/
