...
/** GPIOE_BRR Port bit reset register **/
...
/** GPIOE_OTYPER_OT15 Port x configuration bit 15 **/
#define GPIOE_OTYPER_OT15		(1 << 15)
/** GPIOE_OTYPER_OT14 Port x configuration bit 14 **/
#define GPIOE_OTYPER_OT14		(1 << 14)
/** GPIOE_OTYPER_OT13 Port x configuration bit 13 **/
#define GPIOE_OTYPER_OT13		(1 << 13)
/** GPIOE_OTYPER_OT12 Port x configuration bit 12 **/
#define GPIOE_OTYPER_OT12		(1 << 12)
/** GPIOE_OTYPER_OT11 Port x configuration bit 11 **/
#define GPIOE_OTYPER_OT11		(1 << 11)
/** GPIOE_OTYPER_OT10 Port x configuration bit 10 **/
#define GPIOE_OTYPER_OT10		(1 << 10)
/** GPIOE_OTYPER_OT9 Port x configuration bit 9 **/
#define GPIOE_OTYPER_OT9		(1 << 9)
/** GPIOE_OTYPER_OT8 Port x configuration bit 8 **/
#define GPIOE_OTYPER_OT8		(1 << 8)
/** GPIOE_OTYPER_OT7 Port x configuration bit 7 **/
#define GPIOE_OTYPER_OT7		(1 << 7)
/** GPIOE_OTYPER_OT6 Port x configuration bit 6 **/
#define GPIOE_OTYPER_OT6		(1 << 6)
/** GPIOE_OTYPER_OT5 Port x configuration bit 5 **/
#define GPIOE_OTYPER_OT5		(1 << 5)
/** GPIOE_OTYPER_OT4 Port x configuration bit 4 **/
#define GPIOE_OTYPER_OT4		(1 << 4)
/** GPIOE_OTYPER_OT3 Port x configuration bit 3 **/
#define GPIOE_OTYPER_OT3		(1 << 3)
/** GPIOE_OTYPER_OT2 Port x configuration bit 2 **/
#define GPIOE_OTYPER_OT2		(1 << 2)
/** GPIOE_OTYPER_OT1 Port x configuration bit 1 **/
#define GPIOE_OTYPER_OT1		(1 << 1)
/** GPIOE_OTYPER_OT0 Port x configuration bit 0 **/
...
/** GPIOE_LCKR_LCKK Port x lock bit y **/
...
/** @defgroup gpioe_brr BRR Port bit reset register
@{*/

/** GPIOE_BRR_BR15 Port x Reset bit y **/
#define GPIOE_BRR_BR15		(1 << 15)
/** GPIOE_BRR_BR14 Port x Reset bit y **/
#define GPIOE_BRR_BR14		(1 << 14)
/** GPIOE_BRR_BR13 Port x Reset bit y **/
#define GPIOE_BRR_BR13		(1 << 13)
/** GPIOE_BRR_BR12 Port x Reset bit y **/
#define GPIOE_BRR_BR12		(1 << 12)
/** GPIOE_BRR_BR11 Port x Reset bit y **/
#define GPIOE_BRR_BR11		(1 << 11)
/** GPIOE_BRR_BR10 Port x Reset bit y **/
#define GPIOE_BRR_BR10		(1 << 10)
/** GPIOE_BRR_BR9 Port x Reset bit y **/
#define GPIOE_BRR_BR9		(1 << 9)
/** GPIOE_BRR_BR8 Port x Reset bit y **/
#define GPIOE_BRR_BR8		(1 << 8)
/** GPIOE_BRR_BR7 Port x Reset bit y **/
#define GPIOE_BRR_BR7		(1 << 7)
/** GPIOE_BRR_BR6 Port x Reset bit y **/
#define GPIOE_BRR_BR6		(1 << 6)
/** GPIOE_BRR_BR5 Port x Reset bit y **/
#define GPIOE_BRR_BR5		(1 << 5)
/** GPIOE_BRR_BR4 Port x Reset bit y **/
#define GPIOE_BRR_BR4		(1 << 4)
/** GPIOE_BRR_BR3 Port x Reset bit y **/
#define GPIOE_BRR_BR3		(1 << 3)
/** GPIOE_BRR_BR2 Port x Reset bit y **/
#define GPIOE_BRR_BR2		(1 << 2)
/** GPIOE_BRR_BR1 Port x Reset bit y **/
#define GPIOE_BRR_BR1		(1 << 1)
/** GPIOE_BRR_BR0 Port x Reset bit y **/
