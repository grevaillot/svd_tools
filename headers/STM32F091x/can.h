...
/** CAN_CAN_MCR CAN_MCR **/
#define CAN_CAN_MCR			MMIO32(CAN_BASE + 0x00)
/** CAN_CAN_MSR CAN_MSR **/
#define CAN_CAN_MSR			MMIO32(CAN_BASE + 0x04)
/** CAN_CAN_TSR CAN_TSR **/
#define CAN_CAN_TSR			MMIO32(CAN_BASE + 0x08)
/** CAN_CAN_RF0R CAN_RF0R **/
#define CAN_CAN_RF0R			MMIO32(CAN_BASE + 0x0c)
/** CAN_CAN_RF1R CAN_RF1R **/
#define CAN_CAN_RF1R			MMIO32(CAN_BASE + 0x10)
/** CAN_CAN_IER CAN_IER **/
#define CAN_CAN_IER			MMIO32(CAN_BASE + 0x14)
/** CAN_CAN_ESR CAN_ESR **/
#define CAN_CAN_ESR			MMIO32(CAN_BASE + 0x18)
/** CAN_CAN_BTR CAN_BTR **/
#define CAN_CAN_BTR			MMIO32(CAN_BASE + 0x1c)
/** CAN_CAN_TI0R CAN_TI0R **/
#define CAN_CAN_TI0R			MMIO32(CAN_BASE + 0x180)
/** CAN_CAN_TDT0R CAN_TDT0R **/
#define CAN_CAN_TDT0R			MMIO32(CAN_BASE + 0x184)
/** CAN_CAN_TDL0R CAN_TDL0R **/
#define CAN_CAN_TDL0R			MMIO32(CAN_BASE + 0x188)
/** CAN_CAN_TDH0R CAN_TDH0R **/
#define CAN_CAN_TDH0R			MMIO32(CAN_BASE + 0x18c)
/** CAN_CAN_TI1R CAN_TI1R **/
#define CAN_CAN_TI1R			MMIO32(CAN_BASE + 0x190)
/** CAN_CAN_TDT1R CAN_TDT1R **/
#define CAN_CAN_TDT1R			MMIO32(CAN_BASE + 0x194)
/** CAN_CAN_TDL1R CAN_TDL1R **/
#define CAN_CAN_TDL1R			MMIO32(CAN_BASE + 0x198)
/** CAN_CAN_TDH1R CAN_TDH1R **/
#define CAN_CAN_TDH1R			MMIO32(CAN_BASE + 0x19c)
/** CAN_CAN_TI2R CAN_TI2R **/
#define CAN_CAN_TI2R			MMIO32(CAN_BASE + 0x1a0)
/** CAN_CAN_TDT2R CAN_TDT2R **/
#define CAN_CAN_TDT2R			MMIO32(CAN_BASE + 0x1a4)
/** CAN_CAN_TDL2R CAN_TDL2R **/
#define CAN_CAN_TDL2R			MMIO32(CAN_BASE + 0x1a8)
/** CAN_CAN_TDH2R CAN_TDH2R **/
#define CAN_CAN_TDH2R			MMIO32(CAN_BASE + 0x1ac)
/** CAN_CAN_RI0R CAN_RI0R **/
#define CAN_CAN_RI0R			MMIO32(CAN_BASE + 0x1b0)
/** CAN_CAN_RDT0R CAN_RDT0R **/
#define CAN_CAN_RDT0R			MMIO32(CAN_BASE + 0x1b4)
/** CAN_CAN_RDL0R CAN_RDL0R **/
#define CAN_CAN_RDL0R			MMIO32(CAN_BASE + 0x1b8)
/** CAN_CAN_RDH0R CAN_RDH0R **/
#define CAN_CAN_RDH0R			MMIO32(CAN_BASE + 0x1bc)
/** CAN_CAN_RI1R CAN_RI1R **/
#define CAN_CAN_RI1R			MMIO32(CAN_BASE + 0x1c0)
/** CAN_CAN_RDT1R CAN_RDT1R **/
#define CAN_CAN_RDT1R			MMIO32(CAN_BASE + 0x1c4)
/** CAN_CAN_RDL1R CAN_RDL1R **/
#define CAN_CAN_RDL1R			MMIO32(CAN_BASE + 0x1c8)
/** CAN_CAN_RDH1R CAN_RDH1R **/
#define CAN_CAN_RDH1R			MMIO32(CAN_BASE + 0x1cc)
/** CAN_CAN_FMR CAN_FMR **/
#define CAN_CAN_FMR			MMIO32(CAN_BASE + 0x200)
/** CAN_CAN_FM1R CAN_FM1R **/
#define CAN_CAN_FM1R			MMIO32(CAN_BASE + 0x204)
/** CAN_CAN_FS1R CAN_FS1R **/
#define CAN_CAN_FS1R			MMIO32(CAN_BASE + 0x20c)
/** CAN_CAN_FFA1R CAN_FFA1R **/
#define CAN_CAN_FFA1R			MMIO32(CAN_BASE + 0x214)
/** CAN_CAN_FA1R CAN_FA1R **/
#define CAN_CAN_FA1R			MMIO32(CAN_BASE + 0x21c)
...
/** @defgroup can_can_mcr CANMCR CAN_MCR
@{*/

/** CAN_CAN_MCR_DBF DBF **/
#define CAN_CAN_MCR_DBF		(1 << 16)
/** CAN_CAN_MCR_RESET RESET **/
#define CAN_CAN_MCR_RESET		(1 << 15)
/** CAN_CAN_MCR_TTCM TTCM **/
#define CAN_CAN_MCR_TTCM		(1 << 7)
/** CAN_CAN_MCR_ABOM ABOM **/
#define CAN_CAN_MCR_ABOM		(1 << 6)
/** CAN_CAN_MCR_AWUM AWUM **/
#define CAN_CAN_MCR_AWUM		(1 << 5)
/** CAN_CAN_MCR_NART NART **/
#define CAN_CAN_MCR_NART		(1 << 4)
/** CAN_CAN_MCR_RFLM RFLM **/
#define CAN_CAN_MCR_RFLM		(1 << 3)
/** CAN_CAN_MCR_TXFP TXFP **/
#define CAN_CAN_MCR_TXFP		(1 << 2)
/** CAN_CAN_MCR_SLEEP SLEEP **/
#define CAN_CAN_MCR_SLEEP		(1 << 1)
/** CAN_CAN_MCR_INRQ INRQ **/
#define CAN_CAN_MCR_INRQ		(1 << 0)

/**@}*/

/** @defgroup can_can_msr CANMSR CAN_MSR
@{*/

/** CAN_CAN_MSR_RX RX **/
#define CAN_CAN_MSR_RX		(1 << 11)
/** CAN_CAN_MSR_SAMP SAMP **/
#define CAN_CAN_MSR_SAMP		(1 << 10)
/** CAN_CAN_MSR_RXM RXM **/
#define CAN_CAN_MSR_RXM		(1 << 9)
/** CAN_CAN_MSR_TXM TXM **/
#define CAN_CAN_MSR_TXM		(1 << 8)
/** CAN_CAN_MSR_SLAKI SLAKI **/
#define CAN_CAN_MSR_SLAKI		(1 << 4)
/** CAN_CAN_MSR_WKUI WKUI **/
#define CAN_CAN_MSR_WKUI		(1 << 3)
/** CAN_CAN_MSR_ERRI ERRI **/
#define CAN_CAN_MSR_ERRI		(1 << 2)
/** CAN_CAN_MSR_SLAK SLAK **/
#define CAN_CAN_MSR_SLAK		(1 << 1)
/** CAN_CAN_MSR_INAK INAK **/
#define CAN_CAN_MSR_INAK		(1 << 0)

/**@}*/

/** @defgroup can_can_tsr CANTSR CAN_TSR
@{*/

/** CAN_CAN_TSR_LOW2 Lowest priority flag for mailbox 2 **/
#define CAN_CAN_TSR_LOW2		(1 << 31)
/** CAN_CAN_TSR_LOW1 Lowest priority flag for mailbox 1 **/
#define CAN_CAN_TSR_LOW1		(1 << 30)
/** CAN_CAN_TSR_LOW0 Lowest priority flag for mailbox 0 **/
#define CAN_CAN_TSR_LOW0		(1 << 29)
/** CAN_CAN_TSR_TME2 Lowest priority flag for mailbox 2 **/
#define CAN_CAN_TSR_TME2		(1 << 28)
/** CAN_CAN_TSR_TME1 Lowest priority flag for mailbox 1 **/
#define CAN_CAN_TSR_TME1		(1 << 27)
/** CAN_CAN_TSR_TME0 Lowest priority flag for mailbox 0 **/
#define CAN_CAN_TSR_TME0		(1 << 26)

#define CAN_CAN_TSR_CODE_SHIFT		24
#define CAN_CAN_TSR_CODE_MASK		0x03
/** @defgroup can_can_tsr_code CODE CODE
@{*/
/**@}*/

/** CAN_CAN_TSR_ABRQ2 ABRQ2 **/
#define CAN_CAN_TSR_ABRQ2		(1 << 23)
/** CAN_CAN_TSR_TERR2 TERR2 **/
#define CAN_CAN_TSR_TERR2		(1 << 19)
/** CAN_CAN_TSR_ALST2 ALST2 **/
#define CAN_CAN_TSR_ALST2		(1 << 18)
/** CAN_CAN_TSR_TXOK2 TXOK2 **/
#define CAN_CAN_TSR_TXOK2		(1 << 17)
/** CAN_CAN_TSR_RQCP2 RQCP2 **/
#define CAN_CAN_TSR_RQCP2		(1 << 16)
/** CAN_CAN_TSR_ABRQ1 ABRQ1 **/
#define CAN_CAN_TSR_ABRQ1		(1 << 15)
/** CAN_CAN_TSR_TERR1 TERR1 **/
#define CAN_CAN_TSR_TERR1		(1 << 11)
/** CAN_CAN_TSR_ALST1 ALST1 **/
#define CAN_CAN_TSR_ALST1		(1 << 10)
/** CAN_CAN_TSR_TXOK1 TXOK1 **/
#define CAN_CAN_TSR_TXOK1		(1 << 9)
/** CAN_CAN_TSR_RQCP1 RQCP1 **/
#define CAN_CAN_TSR_RQCP1		(1 << 8)
/** CAN_CAN_TSR_ABRQ0 ABRQ0 **/
#define CAN_CAN_TSR_ABRQ0		(1 << 7)
/** CAN_CAN_TSR_TERR0 TERR0 **/
#define CAN_CAN_TSR_TERR0		(1 << 3)
/** CAN_CAN_TSR_ALST0 ALST0 **/
#define CAN_CAN_TSR_ALST0		(1 << 2)
/** CAN_CAN_TSR_TXOK0 TXOK0 **/
#define CAN_CAN_TSR_TXOK0		(1 << 1)
/** CAN_CAN_TSR_RQCP0 RQCP0 **/
#define CAN_CAN_TSR_RQCP0		(1 << 0)

/**@}*/

/** @defgroup can_can_rf0r CANRF0R CAN_RF0R
@{*/

/** CAN_CAN_RF0R_RFOM0 RFOM0 **/
#define CAN_CAN_RF0R_RFOM0		(1 << 5)
/** CAN_CAN_RF0R_FOVR0 FOVR0 **/
#define CAN_CAN_RF0R_FOVR0		(1 << 4)
/** CAN_CAN_RF0R_FULL0 FULL0 **/
#define CAN_CAN_RF0R_FULL0		(1 << 3)

#define CAN_CAN_RF0R_FMP0_SHIFT		0
#define CAN_CAN_RF0R_FMP0_MASK		0x03
/** @defgroup can_can_rf0r_fmp0 FMP0 FMP0
@{*/
/**@}*/
...
/** @defgroup can_can_rf1r CANRF1R CAN_RF1R
@{*/

/** CAN_CAN_RF1R_RFOM1 RFOM1 **/
#define CAN_CAN_RF1R_RFOM1		(1 << 5)
/** CAN_CAN_RF1R_FOVR1 FOVR1 **/
#define CAN_CAN_RF1R_FOVR1		(1 << 4)
/** CAN_CAN_RF1R_FULL1 FULL1 **/
#define CAN_CAN_RF1R_FULL1		(1 << 3)

#define CAN_CAN_RF1R_FMP1_SHIFT		0
#define CAN_CAN_RF1R_FMP1_MASK		0x03
/** @defgroup can_can_rf1r_fmp1 FMP1 FMP1
@{*/
/**@}*/
...
/** @defgroup can_can_ier CANIER CAN_IER
@{*/

/** CAN_CAN_IER_SLKIE SLKIE **/
#define CAN_CAN_IER_SLKIE		(1 << 17)
/** CAN_CAN_IER_WKUIE WKUIE **/
#define CAN_CAN_IER_WKUIE		(1 << 16)
/** CAN_CAN_IER_ERRIE ERRIE **/
#define CAN_CAN_IER_ERRIE		(1 << 15)
/** CAN_CAN_IER_LECIE LECIE **/
#define CAN_CAN_IER_LECIE		(1 << 11)
/** CAN_CAN_IER_BOFIE BOFIE **/
#define CAN_CAN_IER_BOFIE		(1 << 10)
/** CAN_CAN_IER_EPVIE EPVIE **/
#define CAN_CAN_IER_EPVIE		(1 << 9)
/** CAN_CAN_IER_EWGIE EWGIE **/
#define CAN_CAN_IER_EWGIE		(1 << 8)
/** CAN_CAN_IER_FOVIE1 FOVIE1 **/
#define CAN_CAN_IER_FOVIE1		(1 << 6)
/** CAN_CAN_IER_FFIE1 FFIE1 **/
#define CAN_CAN_IER_FFIE1		(1 << 5)
/** CAN_CAN_IER_FMPIE1 FMPIE1 **/
#define CAN_CAN_IER_FMPIE1		(1 << 4)
/** CAN_CAN_IER_FOVIE0 FOVIE0 **/
#define CAN_CAN_IER_FOVIE0		(1 << 3)
/** CAN_CAN_IER_FFIE0 FFIE0 **/
#define CAN_CAN_IER_FFIE0		(1 << 2)
/** CAN_CAN_IER_FMPIE0 FMPIE0 **/
#define CAN_CAN_IER_FMPIE0		(1 << 1)
/** CAN_CAN_IER_TMEIE TMEIE **/
#define CAN_CAN_IER_TMEIE		(1 << 0)

/**@}*/

/** @defgroup can_can_esr CANESR CAN_ESR
@{*/


#define CAN_CAN_ESR_REC_SHIFT		24
#define CAN_CAN_ESR_REC_MASK		0xff
/** @defgroup can_can_esr_rec REC REC
@{*/
/**@}*/


#define CAN_CAN_ESR_TEC_SHIFT		16
#define CAN_CAN_ESR_TEC_MASK		0xff
/** @defgroup can_can_esr_tec TEC TEC
@{*/
/**@}*/


#define CAN_CAN_ESR_LEC_SHIFT		4
#define CAN_CAN_ESR_LEC_MASK		0x07
/** @defgroup can_can_esr_lec LEC LEC
@{*/
/**@}*/

/** CAN_CAN_ESR_BOFF BOFF **/
#define CAN_CAN_ESR_BOFF		(1 << 2)
/** CAN_CAN_ESR_EPVF EPVF **/
#define CAN_CAN_ESR_EPVF		(1 << 1)
/** CAN_CAN_ESR_EWGF EWGF **/
#define CAN_CAN_ESR_EWGF		(1 << 0)

/**@}*/

/** @defgroup can_can_btr CANBTR CAN_BTR
@{*/

/** CAN_CAN_BTR_SILM SILM **/
#define CAN_CAN_BTR_SILM		(1 << 31)
/** CAN_CAN_BTR_LBKM LBKM **/
#define CAN_CAN_BTR_LBKM		(1 << 30)

#define CAN_CAN_BTR_SJW_SHIFT		24
#define CAN_CAN_BTR_SJW_MASK		0x03
/** @defgroup can_can_btr_sjw SJW SJW
@{*/
/**@}*/


#define CAN_CAN_BTR_TS2_SHIFT		20
#define CAN_CAN_BTR_TS2_MASK		0x07
/** @defgroup can_can_btr_ts2 TS2 TS2
@{*/
/**@}*/


#define CAN_CAN_BTR_TS1_SHIFT		16
#define CAN_CAN_BTR_TS1_MASK		0x0f
/** @defgroup can_can_btr_ts1 TS1 TS1
@{*/
/**@}*/


#define CAN_CAN_BTR_BRP_SHIFT		0
#define CAN_CAN_BTR_BRP_MASK		0x3ff
/** @defgroup can_can_btr_brp BRP BRP
@{*/
/**@}*/
...
/** @defgroup can_can_ti0r CANTI0R CAN_TI0R
@{*/


#define CAN_CAN_TI0R_STID_SHIFT		21
#define CAN_CAN_TI0R_STID_MASK		0x7ff
/** @defgroup can_can_ti0r_stid STID STID
@{*/
/**@}*/


#define CAN_CAN_TI0R_EXID_SHIFT		3
#define CAN_CAN_TI0R_EXID_MASK		0x3ffff
/** @defgroup can_can_ti0r_exid EXID EXID
@{*/
/**@}*/

/** CAN_CAN_TI0R_IDE IDE **/
#define CAN_CAN_TI0R_IDE		(1 << 2)
/** CAN_CAN_TI0R_RTR RTR **/
#define CAN_CAN_TI0R_RTR		(1 << 1)
/** CAN_CAN_TI0R_TXRQ TXRQ **/
#define CAN_CAN_TI0R_TXRQ		(1 << 0)

/**@}*/

/** @defgroup can_can_tdt0r CANTDT0R CAN_TDT0R
@{*/


#define CAN_CAN_TDT0R_TIME_SHIFT		16
#define CAN_CAN_TDT0R_TIME_MASK		0xffff
/** @defgroup can_can_tdt0r_time TIME TIME
@{*/
/**@}*/

/** CAN_CAN_TDT0R_TGT TGT **/
#define CAN_CAN_TDT0R_TGT		(1 << 8)

#define CAN_CAN_TDT0R_DLC_SHIFT		0
#define CAN_CAN_TDT0R_DLC_MASK		0x0f
/** @defgroup can_can_tdt0r_dlc DLC DLC
@{*/
/**@}*/
...
/** @defgroup can_can_tdl0r CANTDL0R CAN_TDL0R
@{*/


#define CAN_CAN_TDL0R_DATA3_SHIFT		24
#define CAN_CAN_TDL0R_DATA3_MASK		0xff
/** @defgroup can_can_tdl0r_data3 DATA3 DATA3
@{*/
/**@}*/


#define CAN_CAN_TDL0R_DATA2_SHIFT		16
#define CAN_CAN_TDL0R_DATA2_MASK		0xff
/** @defgroup can_can_tdl0r_data2 DATA2 DATA2
@{*/
/**@}*/


#define CAN_CAN_TDL0R_DATA1_SHIFT		8
#define CAN_CAN_TDL0R_DATA1_MASK		0xff
/** @defgroup can_can_tdl0r_data1 DATA1 DATA1
@{*/
/**@}*/


#define CAN_CAN_TDL0R_DATA0_SHIFT		0
#define CAN_CAN_TDL0R_DATA0_MASK		0xff
/** @defgroup can_can_tdl0r_data0 DATA0 DATA0
@{*/
/**@}*/
...
/** @defgroup can_can_tdh0r CANTDH0R CAN_TDH0R
@{*/


#define CAN_CAN_TDH0R_DATA7_SHIFT		24
#define CAN_CAN_TDH0R_DATA7_MASK		0xff
/** @defgroup can_can_tdh0r_data7 DATA7 DATA7
@{*/
/**@}*/


#define CAN_CAN_TDH0R_DATA6_SHIFT		16
#define CAN_CAN_TDH0R_DATA6_MASK		0xff
/** @defgroup can_can_tdh0r_data6 DATA6 DATA6
@{*/
/**@}*/


#define CAN_CAN_TDH0R_DATA5_SHIFT		8
#define CAN_CAN_TDH0R_DATA5_MASK		0xff
/** @defgroup can_can_tdh0r_data5 DATA5 DATA5
@{*/
/**@}*/


#define CAN_CAN_TDH0R_DATA4_SHIFT		0
#define CAN_CAN_TDH0R_DATA4_MASK		0xff
/** @defgroup can_can_tdh0r_data4 DATA4 DATA4
@{*/
/**@}*/
...
/** @defgroup can_can_ti1r CANTI1R CAN_TI1R
@{*/


#define CAN_CAN_TI1R_STID_SHIFT		21
#define CAN_CAN_TI1R_STID_MASK		0x7ff
/** @defgroup can_can_ti1r_stid STID STID
@{*/
/**@}*/


#define CAN_CAN_TI1R_EXID_SHIFT		3
#define CAN_CAN_TI1R_EXID_MASK		0x3ffff
/** @defgroup can_can_ti1r_exid EXID EXID
@{*/
/**@}*/

/** CAN_CAN_TI1R_IDE IDE **/
#define CAN_CAN_TI1R_IDE		(1 << 2)
/** CAN_CAN_TI1R_RTR RTR **/
#define CAN_CAN_TI1R_RTR		(1 << 1)
/** CAN_CAN_TI1R_TXRQ TXRQ **/
#define CAN_CAN_TI1R_TXRQ		(1 << 0)

/**@}*/

/** @defgroup can_can_tdt1r CANTDT1R CAN_TDT1R
@{*/


#define CAN_CAN_TDT1R_TIME_SHIFT		16
#define CAN_CAN_TDT1R_TIME_MASK		0xffff
/** @defgroup can_can_tdt1r_time TIME TIME
@{*/
/**@}*/

/** CAN_CAN_TDT1R_TGT TGT **/
#define CAN_CAN_TDT1R_TGT		(1 << 8)

#define CAN_CAN_TDT1R_DLC_SHIFT		0
#define CAN_CAN_TDT1R_DLC_MASK		0x0f
/** @defgroup can_can_tdt1r_dlc DLC DLC
@{*/
/**@}*/
...
/** @defgroup can_can_tdl1r CANTDL1R CAN_TDL1R
@{*/


#define CAN_CAN_TDL1R_DATA3_SHIFT		24
#define CAN_CAN_TDL1R_DATA3_MASK		0xff
/** @defgroup can_can_tdl1r_data3 DATA3 DATA3
@{*/
/**@}*/


#define CAN_CAN_TDL1R_DATA2_SHIFT		16
#define CAN_CAN_TDL1R_DATA2_MASK		0xff
/** @defgroup can_can_tdl1r_data2 DATA2 DATA2
@{*/
/**@}*/


#define CAN_CAN_TDL1R_DATA1_SHIFT		8
#define CAN_CAN_TDL1R_DATA1_MASK		0xff
/** @defgroup can_can_tdl1r_data1 DATA1 DATA1
@{*/
/**@}*/


#define CAN_CAN_TDL1R_DATA0_SHIFT		0
#define CAN_CAN_TDL1R_DATA0_MASK		0xff
/** @defgroup can_can_tdl1r_data0 DATA0 DATA0
@{*/
/**@}*/
...
/** @defgroup can_can_tdh1r CANTDH1R CAN_TDH1R
@{*/


#define CAN_CAN_TDH1R_DATA7_SHIFT		24
#define CAN_CAN_TDH1R_DATA7_MASK		0xff
/** @defgroup can_can_tdh1r_data7 DATA7 DATA7
@{*/
/**@}*/


#define CAN_CAN_TDH1R_DATA6_SHIFT		16
#define CAN_CAN_TDH1R_DATA6_MASK		0xff
/** @defgroup can_can_tdh1r_data6 DATA6 DATA6
@{*/
/**@}*/


#define CAN_CAN_TDH1R_DATA5_SHIFT		8
#define CAN_CAN_TDH1R_DATA5_MASK		0xff
/** @defgroup can_can_tdh1r_data5 DATA5 DATA5
@{*/
/**@}*/


#define CAN_CAN_TDH1R_DATA4_SHIFT		0
#define CAN_CAN_TDH1R_DATA4_MASK		0xff
/** @defgroup can_can_tdh1r_data4 DATA4 DATA4
@{*/
/**@}*/
...
/** @defgroup can_can_ti2r CANTI2R CAN_TI2R
@{*/


#define CAN_CAN_TI2R_STID_SHIFT		21
#define CAN_CAN_TI2R_STID_MASK		0x7ff
/** @defgroup can_can_ti2r_stid STID STID
@{*/
/**@}*/


#define CAN_CAN_TI2R_EXID_SHIFT		3
#define CAN_CAN_TI2R_EXID_MASK		0x3ffff
/** @defgroup can_can_ti2r_exid EXID EXID
@{*/
/**@}*/

/** CAN_CAN_TI2R_IDE IDE **/
#define CAN_CAN_TI2R_IDE		(1 << 2)
/** CAN_CAN_TI2R_RTR RTR **/
#define CAN_CAN_TI2R_RTR		(1 << 1)
/** CAN_CAN_TI2R_TXRQ TXRQ **/
#define CAN_CAN_TI2R_TXRQ		(1 << 0)

/**@}*/

/** @defgroup can_can_tdt2r CANTDT2R CAN_TDT2R
@{*/


#define CAN_CAN_TDT2R_TIME_SHIFT		16
#define CAN_CAN_TDT2R_TIME_MASK		0xffff
/** @defgroup can_can_tdt2r_time TIME TIME
@{*/
/**@}*/

/** CAN_CAN_TDT2R_TGT TGT **/
#define CAN_CAN_TDT2R_TGT		(1 << 8)

#define CAN_CAN_TDT2R_DLC_SHIFT		0
#define CAN_CAN_TDT2R_DLC_MASK		0x0f
/** @defgroup can_can_tdt2r_dlc DLC DLC
@{*/
/**@}*/
...
/** @defgroup can_can_tdl2r CANTDL2R CAN_TDL2R
@{*/


#define CAN_CAN_TDL2R_DATA3_SHIFT		24
#define CAN_CAN_TDL2R_DATA3_MASK		0xff
/** @defgroup can_can_tdl2r_data3 DATA3 DATA3
@{*/
/**@}*/


#define CAN_CAN_TDL2R_DATA2_SHIFT		16
#define CAN_CAN_TDL2R_DATA2_MASK		0xff
/** @defgroup can_can_tdl2r_data2 DATA2 DATA2
@{*/
/**@}*/


#define CAN_CAN_TDL2R_DATA1_SHIFT		8
#define CAN_CAN_TDL2R_DATA1_MASK		0xff
/** @defgroup can_can_tdl2r_data1 DATA1 DATA1
@{*/
/**@}*/


#define CAN_CAN_TDL2R_DATA0_SHIFT		0
#define CAN_CAN_TDL2R_DATA0_MASK		0xff
/** @defgroup can_can_tdl2r_data0 DATA0 DATA0
@{*/
/**@}*/
...
/** @defgroup can_can_tdh2r CANTDH2R CAN_TDH2R
@{*/


#define CAN_CAN_TDH2R_DATA7_SHIFT		24
#define CAN_CAN_TDH2R_DATA7_MASK		0xff
/** @defgroup can_can_tdh2r_data7 DATA7 DATA7
@{*/
/**@}*/


#define CAN_CAN_TDH2R_DATA6_SHIFT		16
#define CAN_CAN_TDH2R_DATA6_MASK		0xff
/** @defgroup can_can_tdh2r_data6 DATA6 DATA6
@{*/
/**@}*/


#define CAN_CAN_TDH2R_DATA5_SHIFT		8
#define CAN_CAN_TDH2R_DATA5_MASK		0xff
/** @defgroup can_can_tdh2r_data5 DATA5 DATA5
@{*/
/**@}*/


#define CAN_CAN_TDH2R_DATA4_SHIFT		0
#define CAN_CAN_TDH2R_DATA4_MASK		0xff
/** @defgroup can_can_tdh2r_data4 DATA4 DATA4
@{*/
/**@}*/
...
/** @defgroup can_can_ri0r CANRI0R CAN_RI0R
@{*/


#define CAN_CAN_RI0R_STID_SHIFT		21
#define CAN_CAN_RI0R_STID_MASK		0x7ff
/** @defgroup can_can_ri0r_stid STID STID
@{*/
/**@}*/


#define CAN_CAN_RI0R_EXID_SHIFT		3
#define CAN_CAN_RI0R_EXID_MASK		0x3ffff
/** @defgroup can_can_ri0r_exid EXID EXID
@{*/
/**@}*/

/** CAN_CAN_RI0R_IDE IDE **/
#define CAN_CAN_RI0R_IDE		(1 << 2)
/** CAN_CAN_RI0R_RTR RTR **/
#define CAN_CAN_RI0R_RTR		(1 << 1)

/**@}*/

/** @defgroup can_can_rdt0r CANRDT0R CAN_RDT0R
@{*/


#define CAN_CAN_RDT0R_TIME_SHIFT		16
#define CAN_CAN_RDT0R_TIME_MASK		0xffff
/** @defgroup can_can_rdt0r_time TIME TIME
@{*/
/**@}*/


#define CAN_CAN_RDT0R_FMI_SHIFT		8
#define CAN_CAN_RDT0R_FMI_MASK		0xff
/** @defgroup can_can_rdt0r_fmi FMI FMI
@{*/
/**@}*/


#define CAN_CAN_RDT0R_DLC_SHIFT		0
#define CAN_CAN_RDT0R_DLC_MASK		0x0f
/** @defgroup can_can_rdt0r_dlc DLC DLC
@{*/
/**@}*/
...
/** @defgroup can_can_rdl0r CANRDL0R CAN_RDL0R
@{*/


#define CAN_CAN_RDL0R_DATA3_SHIFT		24
#define CAN_CAN_RDL0R_DATA3_MASK		0xff
/** @defgroup can_can_rdl0r_data3 DATA3 DATA3
@{*/
/**@}*/


#define CAN_CAN_RDL0R_DATA2_SHIFT		16
#define CAN_CAN_RDL0R_DATA2_MASK		0xff
/** @defgroup can_can_rdl0r_data2 DATA2 DATA2
@{*/
/**@}*/


#define CAN_CAN_RDL0R_DATA1_SHIFT		8
#define CAN_CAN_RDL0R_DATA1_MASK		0xff
/** @defgroup can_can_rdl0r_data1 DATA1 DATA1
@{*/
/**@}*/


#define CAN_CAN_RDL0R_DATA0_SHIFT		0
#define CAN_CAN_RDL0R_DATA0_MASK		0xff
/** @defgroup can_can_rdl0r_data0 DATA0 DATA0
@{*/
/**@}*/
...
/** @defgroup can_can_rdh0r CANRDH0R CAN_RDH0R
@{*/


#define CAN_CAN_RDH0R_DATA7_SHIFT		24
#define CAN_CAN_RDH0R_DATA7_MASK		0xff
/** @defgroup can_can_rdh0r_data7 DATA7 DATA7
@{*/
/**@}*/


#define CAN_CAN_RDH0R_DATA6_SHIFT		16
#define CAN_CAN_RDH0R_DATA6_MASK		0xff
/** @defgroup can_can_rdh0r_data6 DATA6 DATA6
@{*/
/**@}*/


#define CAN_CAN_RDH0R_DATA5_SHIFT		8
#define CAN_CAN_RDH0R_DATA5_MASK		0xff
/** @defgroup can_can_rdh0r_data5 DATA5 DATA5
@{*/
/**@}*/


#define CAN_CAN_RDH0R_DATA4_SHIFT		0
#define CAN_CAN_RDH0R_DATA4_MASK		0xff
/** @defgroup can_can_rdh0r_data4 DATA4 DATA4
@{*/
/**@}*/
...
/** @defgroup can_can_ri1r CANRI1R CAN_RI1R
@{*/


#define CAN_CAN_RI1R_STID_SHIFT		21
#define CAN_CAN_RI1R_STID_MASK		0x7ff
/** @defgroup can_can_ri1r_stid STID STID
@{*/
/**@}*/


#define CAN_CAN_RI1R_EXID_SHIFT		3
#define CAN_CAN_RI1R_EXID_MASK		0x3ffff
/** @defgroup can_can_ri1r_exid EXID EXID
@{*/
/**@}*/

/** CAN_CAN_RI1R_IDE IDE **/
#define CAN_CAN_RI1R_IDE		(1 << 2)
/** CAN_CAN_RI1R_RTR RTR **/
#define CAN_CAN_RI1R_RTR		(1 << 1)

/**@}*/

/** @defgroup can_can_rdt1r CANRDT1R CAN_RDT1R
@{*/


#define CAN_CAN_RDT1R_TIME_SHIFT		16
#define CAN_CAN_RDT1R_TIME_MASK		0xffff
/** @defgroup can_can_rdt1r_time TIME TIME
@{*/
/**@}*/


#define CAN_CAN_RDT1R_FMI_SHIFT		8
#define CAN_CAN_RDT1R_FMI_MASK		0xff
/** @defgroup can_can_rdt1r_fmi FMI FMI
@{*/
/**@}*/


#define CAN_CAN_RDT1R_DLC_SHIFT		0
#define CAN_CAN_RDT1R_DLC_MASK		0x0f
/** @defgroup can_can_rdt1r_dlc DLC DLC
@{*/
/**@}*/
...
/** @defgroup can_can_rdl1r CANRDL1R CAN_RDL1R
@{*/


#define CAN_CAN_RDL1R_DATA3_SHIFT		24
#define CAN_CAN_RDL1R_DATA3_MASK		0xff
/** @defgroup can_can_rdl1r_data3 DATA3 DATA3
@{*/
/**@}*/


#define CAN_CAN_RDL1R_DATA2_SHIFT		16
#define CAN_CAN_RDL1R_DATA2_MASK		0xff
/** @defgroup can_can_rdl1r_data2 DATA2 DATA2
@{*/
/**@}*/


#define CAN_CAN_RDL1R_DATA1_SHIFT		8
#define CAN_CAN_RDL1R_DATA1_MASK		0xff
/** @defgroup can_can_rdl1r_data1 DATA1 DATA1
@{*/
/**@}*/


#define CAN_CAN_RDL1R_DATA0_SHIFT		0
#define CAN_CAN_RDL1R_DATA0_MASK		0xff
/** @defgroup can_can_rdl1r_data0 DATA0 DATA0
@{*/
/**@}*/
...
/** @defgroup can_can_rdh1r CANRDH1R CAN_RDH1R
@{*/


#define CAN_CAN_RDH1R_DATA7_SHIFT		24
#define CAN_CAN_RDH1R_DATA7_MASK		0xff
/** @defgroup can_can_rdh1r_data7 DATA7 DATA7
@{*/
/**@}*/


#define CAN_CAN_RDH1R_DATA6_SHIFT		16
#define CAN_CAN_RDH1R_DATA6_MASK		0xff
/** @defgroup can_can_rdh1r_data6 DATA6 DATA6
@{*/
/**@}*/


#define CAN_CAN_RDH1R_DATA5_SHIFT		8
#define CAN_CAN_RDH1R_DATA5_MASK		0xff
/** @defgroup can_can_rdh1r_data5 DATA5 DATA5
@{*/
/**@}*/


#define CAN_CAN_RDH1R_DATA4_SHIFT		0
#define CAN_CAN_RDH1R_DATA4_MASK		0xff
/** @defgroup can_can_rdh1r_data4 DATA4 DATA4
@{*/
/**@}*/
...
/** @defgroup can_can_fmr CANFMR CAN_FMR
@{*/


#define CAN_CAN_FMR_CAN2SB_SHIFT		8
#define CAN_CAN_FMR_CAN2SB_MASK		0x3f
/** @defgroup can_can_fmr_can2sb CAN2SB CAN2SB
@{*/
/**@}*/

/** CAN_CAN_FMR_FINIT FINIT **/
#define CAN_CAN_FMR_FINIT		(1 << 0)

/**@}*/

/** @defgroup can_can_fm1r CANFM1R CAN_FM1R
@{*/

/** CAN_CAN_FM1R_FBM27 Filter mode **/
#define CAN_CAN_FM1R_FBM27		(1 << 27)
/** CAN_CAN_FM1R_FBM26 Filter mode **/
#define CAN_CAN_FM1R_FBM26		(1 << 26)
/** CAN_CAN_FM1R_FBM25 Filter mode **/
#define CAN_CAN_FM1R_FBM25		(1 << 25)
/** CAN_CAN_FM1R_FBM24 Filter mode **/
#define CAN_CAN_FM1R_FBM24		(1 << 24)
/** CAN_CAN_FM1R_FBM23 Filter mode **/
#define CAN_CAN_FM1R_FBM23		(1 << 23)
/** CAN_CAN_FM1R_FBM22 Filter mode **/
#define CAN_CAN_FM1R_FBM22		(1 << 22)
/** CAN_CAN_FM1R_FBM21 Filter mode **/
#define CAN_CAN_FM1R_FBM21		(1 << 21)
/** CAN_CAN_FM1R_FBM20 Filter mode **/
#define CAN_CAN_FM1R_FBM20		(1 << 20)
/** CAN_CAN_FM1R_FBM19 Filter mode **/
#define CAN_CAN_FM1R_FBM19		(1 << 19)
/** CAN_CAN_FM1R_FBM18 Filter mode **/
#define CAN_CAN_FM1R_FBM18		(1 << 18)
/** CAN_CAN_FM1R_FBM17 Filter mode **/
#define CAN_CAN_FM1R_FBM17		(1 << 17)
/** CAN_CAN_FM1R_FBM16 Filter mode **/
#define CAN_CAN_FM1R_FBM16		(1 << 16)
/** CAN_CAN_FM1R_FBM15 Filter mode **/
#define CAN_CAN_FM1R_FBM15		(1 << 15)
/** CAN_CAN_FM1R_FBM14 Filter mode **/
#define CAN_CAN_FM1R_FBM14		(1 << 14)
/** CAN_CAN_FM1R_FBM13 Filter mode **/
#define CAN_CAN_FM1R_FBM13		(1 << 13)
/** CAN_CAN_FM1R_FBM12 Filter mode **/
#define CAN_CAN_FM1R_FBM12		(1 << 12)
/** CAN_CAN_FM1R_FBM11 Filter mode **/
#define CAN_CAN_FM1R_FBM11		(1 << 11)
/** CAN_CAN_FM1R_FBM10 Filter mode **/
#define CAN_CAN_FM1R_FBM10		(1 << 10)
/** CAN_CAN_FM1R_FBM9 Filter mode **/
#define CAN_CAN_FM1R_FBM9		(1 << 9)
/** CAN_CAN_FM1R_FBM8 Filter mode **/
#define CAN_CAN_FM1R_FBM8		(1 << 8)
/** CAN_CAN_FM1R_FBM7 Filter mode **/
#define CAN_CAN_FM1R_FBM7		(1 << 7)
/** CAN_CAN_FM1R_FBM6 Filter mode **/
#define CAN_CAN_FM1R_FBM6		(1 << 6)
/** CAN_CAN_FM1R_FBM5 Filter mode **/
#define CAN_CAN_FM1R_FBM5		(1 << 5)
/** CAN_CAN_FM1R_FBM4 Filter mode **/
#define CAN_CAN_FM1R_FBM4		(1 << 4)
/** CAN_CAN_FM1R_FBM3 Filter mode **/
#define CAN_CAN_FM1R_FBM3		(1 << 3)
/** CAN_CAN_FM1R_FBM2 Filter mode **/
#define CAN_CAN_FM1R_FBM2		(1 << 2)
/** CAN_CAN_FM1R_FBM1 Filter mode **/
#define CAN_CAN_FM1R_FBM1		(1 << 1)
/** CAN_CAN_FM1R_FBM0 Filter mode **/
#define CAN_CAN_FM1R_FBM0		(1 << 0)

/**@}*/

/** @defgroup can_can_fs1r CANFS1R CAN_FS1R
@{*/

/** CAN_CAN_FS1R_FSC27 Filter scale configuration **/
#define CAN_CAN_FS1R_FSC27		(1 << 27)
/** CAN_CAN_FS1R_FSC26 Filter scale configuration **/
#define CAN_CAN_FS1R_FSC26		(1 << 26)
/** CAN_CAN_FS1R_FSC25 Filter scale configuration **/
#define CAN_CAN_FS1R_FSC25		(1 << 25)
/** CAN_CAN_FS1R_FSC24 Filter scale configuration **/
#define CAN_CAN_FS1R_FSC24		(1 << 24)
/** CAN_CAN_FS1R_FSC23 Filter scale configuration **/
#define CAN_CAN_FS1R_FSC23		(1 << 23)
/** CAN_CAN_FS1R_FSC22 Filter scale configuration **/
#define CAN_CAN_FS1R_FSC22		(1 << 22)
/** CAN_CAN_FS1R_FSC21 Filter scale configuration **/
#define CAN_CAN_FS1R_FSC21		(1 << 21)
/** CAN_CAN_FS1R_FSC20 Filter scale configuration **/
#define CAN_CAN_FS1R_FSC20		(1 << 20)
/** CAN_CAN_FS1R_FSC19 Filter scale configuration **/
#define CAN_CAN_FS1R_FSC19		(1 << 19)
/** CAN_CAN_FS1R_FSC18 Filter scale configuration **/
#define CAN_CAN_FS1R_FSC18		(1 << 18)
/** CAN_CAN_FS1R_FSC17 Filter scale configuration **/
#define CAN_CAN_FS1R_FSC17		(1 << 17)
/** CAN_CAN_FS1R_FSC16 Filter scale configuration **/
#define CAN_CAN_FS1R_FSC16		(1 << 16)
/** CAN_CAN_FS1R_FSC15 Filter scale configuration **/
#define CAN_CAN_FS1R_FSC15		(1 << 15)
/** CAN_CAN_FS1R_FSC14 Filter scale configuration **/
#define CAN_CAN_FS1R_FSC14		(1 << 14)
/** CAN_CAN_FS1R_FSC13 Filter scale configuration **/
#define CAN_CAN_FS1R_FSC13		(1 << 13)
/** CAN_CAN_FS1R_FSC12 Filter scale configuration **/
#define CAN_CAN_FS1R_FSC12		(1 << 12)
/** CAN_CAN_FS1R_FSC11 Filter scale configuration **/
#define CAN_CAN_FS1R_FSC11		(1 << 11)
/** CAN_CAN_FS1R_FSC10 Filter scale configuration **/
#define CAN_CAN_FS1R_FSC10		(1 << 10)
/** CAN_CAN_FS1R_FSC9 Filter scale configuration **/
#define CAN_CAN_FS1R_FSC9		(1 << 9)
/** CAN_CAN_FS1R_FSC8 Filter scale configuration **/
#define CAN_CAN_FS1R_FSC8		(1 << 8)
/** CAN_CAN_FS1R_FSC7 Filter scale configuration **/
#define CAN_CAN_FS1R_FSC7		(1 << 7)
/** CAN_CAN_FS1R_FSC6 Filter scale configuration **/
#define CAN_CAN_FS1R_FSC6		(1 << 6)
/** CAN_CAN_FS1R_FSC5 Filter scale configuration **/
#define CAN_CAN_FS1R_FSC5		(1 << 5)
/** CAN_CAN_FS1R_FSC4 Filter scale configuration **/
#define CAN_CAN_FS1R_FSC4		(1 << 4)
/** CAN_CAN_FS1R_FSC3 Filter scale configuration **/
#define CAN_CAN_FS1R_FSC3		(1 << 3)
/** CAN_CAN_FS1R_FSC2 Filter scale configuration **/
#define CAN_CAN_FS1R_FSC2		(1 << 2)
/** CAN_CAN_FS1R_FSC1 Filter scale configuration **/
#define CAN_CAN_FS1R_FSC1		(1 << 1)
/** CAN_CAN_FS1R_FSC0 Filter scale configuration **/
#define CAN_CAN_FS1R_FSC0		(1 << 0)

/**@}*/

/** @defgroup can_can_ffa1r CANFFA1R CAN_FFA1R
@{*/

/** CAN_CAN_FFA1R_FFA27 Filter FIFO assignment for filter 27 **/
#define CAN_CAN_FFA1R_FFA27		(1 << 27)
/** CAN_CAN_FFA1R_FFA26 Filter FIFO assignment for filter 26 **/
#define CAN_CAN_FFA1R_FFA26		(1 << 26)
/** CAN_CAN_FFA1R_FFA25 Filter FIFO assignment for filter 25 **/
#define CAN_CAN_FFA1R_FFA25		(1 << 25)
/** CAN_CAN_FFA1R_FFA24 Filter FIFO assignment for filter 24 **/
#define CAN_CAN_FFA1R_FFA24		(1 << 24)
/** CAN_CAN_FFA1R_FFA23 Filter FIFO assignment for filter 23 **/
#define CAN_CAN_FFA1R_FFA23		(1 << 23)
/** CAN_CAN_FFA1R_FFA22 Filter FIFO assignment for filter 22 **/
#define CAN_CAN_FFA1R_FFA22		(1 << 22)
/** CAN_CAN_FFA1R_FFA21 Filter FIFO assignment for filter 21 **/
#define CAN_CAN_FFA1R_FFA21		(1 << 21)
/** CAN_CAN_FFA1R_FFA20 Filter FIFO assignment for filter 20 **/
#define CAN_CAN_FFA1R_FFA20		(1 << 20)
/** CAN_CAN_FFA1R_FFA19 Filter FIFO assignment for filter 19 **/
#define CAN_CAN_FFA1R_FFA19		(1 << 19)
/** CAN_CAN_FFA1R_FFA18 Filter FIFO assignment for filter 18 **/
#define CAN_CAN_FFA1R_FFA18		(1 << 18)
/** CAN_CAN_FFA1R_FFA17 Filter FIFO assignment for filter 17 **/
#define CAN_CAN_FFA1R_FFA17		(1 << 17)
/** CAN_CAN_FFA1R_FFA16 Filter FIFO assignment for filter 16 **/
#define CAN_CAN_FFA1R_FFA16		(1 << 16)
/** CAN_CAN_FFA1R_FFA15 Filter FIFO assignment for filter 15 **/
#define CAN_CAN_FFA1R_FFA15		(1 << 15)
/** CAN_CAN_FFA1R_FFA14 Filter FIFO assignment for filter 14 **/
#define CAN_CAN_FFA1R_FFA14		(1 << 14)
/** CAN_CAN_FFA1R_FFA13 Filter FIFO assignment for filter 13 **/
#define CAN_CAN_FFA1R_FFA13		(1 << 13)
/** CAN_CAN_FFA1R_FFA12 Filter FIFO assignment for filter 12 **/
#define CAN_CAN_FFA1R_FFA12		(1 << 12)
/** CAN_CAN_FFA1R_FFA11 Filter FIFO assignment for filter 11 **/
#define CAN_CAN_FFA1R_FFA11		(1 << 11)
/** CAN_CAN_FFA1R_FFA10 Filter FIFO assignment for filter 10 **/
#define CAN_CAN_FFA1R_FFA10		(1 << 10)
/** CAN_CAN_FFA1R_FFA9 Filter FIFO assignment for filter 9 **/
#define CAN_CAN_FFA1R_FFA9		(1 << 9)
/** CAN_CAN_FFA1R_FFA8 Filter FIFO assignment for filter 8 **/
#define CAN_CAN_FFA1R_FFA8		(1 << 8)
/** CAN_CAN_FFA1R_FFA7 Filter FIFO assignment for filter 7 **/
#define CAN_CAN_FFA1R_FFA7		(1 << 7)
/** CAN_CAN_FFA1R_FFA6 Filter FIFO assignment for filter 6 **/
#define CAN_CAN_FFA1R_FFA6		(1 << 6)
/** CAN_CAN_FFA1R_FFA5 Filter FIFO assignment for filter 5 **/
#define CAN_CAN_FFA1R_FFA5		(1 << 5)
/** CAN_CAN_FFA1R_FFA4 Filter FIFO assignment for filter 4 **/
#define CAN_CAN_FFA1R_FFA4		(1 << 4)
/** CAN_CAN_FFA1R_FFA3 Filter FIFO assignment for filter 3 **/
#define CAN_CAN_FFA1R_FFA3		(1 << 3)
/** CAN_CAN_FFA1R_FFA2 Filter FIFO assignment for filter 2 **/
#define CAN_CAN_FFA1R_FFA2		(1 << 2)
/** CAN_CAN_FFA1R_FFA1 Filter FIFO assignment for filter 1 **/
#define CAN_CAN_FFA1R_FFA1		(1 << 1)
/** CAN_CAN_FFA1R_FFA0 Filter FIFO assignment for filter 0 **/
#define CAN_CAN_FFA1R_FFA0		(1 << 0)

/**@}*/

/** @defgroup can_can_fa1r CANFA1R CAN_FA1R
@{*/

/** CAN_CAN_FA1R_FACT27 Filter active **/
#define CAN_CAN_FA1R_FACT27		(1 << 27)
/** CAN_CAN_FA1R_FACT26 Filter active **/
#define CAN_CAN_FA1R_FACT26		(1 << 26)
/** CAN_CAN_FA1R_FACT25 Filter active **/
#define CAN_CAN_FA1R_FACT25		(1 << 25)
/** CAN_CAN_FA1R_FACT24 Filter active **/
#define CAN_CAN_FA1R_FACT24		(1 << 24)
/** CAN_CAN_FA1R_FACT23 Filter active **/
#define CAN_CAN_FA1R_FACT23		(1 << 23)
/** CAN_CAN_FA1R_FACT22 Filter active **/
#define CAN_CAN_FA1R_FACT22		(1 << 22)
/** CAN_CAN_FA1R_FACT21 Filter active **/
#define CAN_CAN_FA1R_FACT21		(1 << 21)
/** CAN_CAN_FA1R_FACT20 Filter active **/
#define CAN_CAN_FA1R_FACT20		(1 << 20)
/** CAN_CAN_FA1R_FACT19 Filter active **/
#define CAN_CAN_FA1R_FACT19		(1 << 19)
/** CAN_CAN_FA1R_FACT18 Filter active **/
#define CAN_CAN_FA1R_FACT18		(1 << 18)
/** CAN_CAN_FA1R_FACT17 Filter active **/
#define CAN_CAN_FA1R_FACT17		(1 << 17)
/** CAN_CAN_FA1R_FACT16 Filter active **/
#define CAN_CAN_FA1R_FACT16		(1 << 16)
/** CAN_CAN_FA1R_FACT15 Filter active **/
#define CAN_CAN_FA1R_FACT15		(1 << 15)
/** CAN_CAN_FA1R_FACT14 Filter active **/
#define CAN_CAN_FA1R_FACT14		(1 << 14)
/** CAN_CAN_FA1R_FACT13 Filter active **/
#define CAN_CAN_FA1R_FACT13		(1 << 13)
/** CAN_CAN_FA1R_FACT12 Filter active **/
#define CAN_CAN_FA1R_FACT12		(1 << 12)
/** CAN_CAN_FA1R_FACT11 Filter active **/
#define CAN_CAN_FA1R_FACT11		(1 << 11)
/** CAN_CAN_FA1R_FACT10 Filter active **/
#define CAN_CAN_FA1R_FACT10		(1 << 10)
/** CAN_CAN_FA1R_FACT9 Filter active **/
#define CAN_CAN_FA1R_FACT9		(1 << 9)
/** CAN_CAN_FA1R_FACT8 Filter active **/
#define CAN_CAN_FA1R_FACT8		(1 << 8)
/** CAN_CAN_FA1R_FACT7 Filter active **/
#define CAN_CAN_FA1R_FACT7		(1 << 7)
/** CAN_CAN_FA1R_FACT6 Filter active **/
#define CAN_CAN_FA1R_FACT6		(1 << 6)
/** CAN_CAN_FA1R_FACT5 Filter active **/
#define CAN_CAN_FA1R_FACT5		(1 << 5)
/** CAN_CAN_FA1R_FACT4 Filter active **/
#define CAN_CAN_FA1R_FACT4		(1 << 4)
/** CAN_CAN_FA1R_FACT3 Filter active **/
#define CAN_CAN_FA1R_FACT3		(1 << 3)
/** CAN_CAN_FA1R_FACT2 Filter active **/
#define CAN_CAN_FA1R_FACT2		(1 << 2)
/** CAN_CAN_FA1R_FACT1 Filter active **/
#define CAN_CAN_FA1R_FACT1		(1 << 1)
/** CAN_CAN_FA1R_FACT0 Filter active **/
#define CAN_CAN_FA1R_FACT0		(1 << 0)
