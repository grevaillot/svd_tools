...
/** HRTIM_Common_BMTRGR BMTRGR **/
#define HRTIM_Common_BMTRGR			MMIO32(HRTIM_Common_BASE + 0x24)
...
/** @defgroup hrtim_common_odisr ODISR DISR
@{*/
...
/** @defgroup hrtim_common_bmtrgr BMTRGR BMTRGR
@{*/

/** HRTIM_Common_BMTRGR_OCHPEV OCHPEV **/
#define HRTIM_Common_BMTRGR_OCHPEV		(1 << 31)
/** HRTIM_Common_BMTRGR_EEV8 EEV8 **/
#define HRTIM_Common_BMTRGR_EEV8		(1 << 30)
/** HRTIM_Common_BMTRGR_EEV7 EEV7 **/
#define HRTIM_Common_BMTRGR_EEV7		(1 << 29)
/** HRTIM_Common_BMTRGR_TDEEV8 TDEEV8 **/
#define HRTIM_Common_BMTRGR_TDEEV8		(1 << 28)
/** HRTIM_Common_BMTRGR_TAEEV7 TAEEV7 **/
#define HRTIM_Common_BMTRGR_TAEEV7		(1 << 27)
/** HRTIM_Common_BMTRGR_TECMP2 TECMP2 **/
#define HRTIM_Common_BMTRGR_TECMP2		(1 << 26)
/** HRTIM_Common_BMTRGR_TECMP1 TECMP1 **/
#define HRTIM_Common_BMTRGR_TECMP1		(1 << 25)
/** HRTIM_Common_BMTRGR_TEREP TEREP **/
#define HRTIM_Common_BMTRGR_TEREP		(1 << 24)
/** HRTIM_Common_BMTRGR_TERST TERST **/
#define HRTIM_Common_BMTRGR_TERST		(1 << 23)
/** HRTIM_Common_BMTRGR_TDCMP2 TDCMP2 **/
#define HRTIM_Common_BMTRGR_TDCMP2		(1 << 22)
/** HRTIM_Common_BMTRGR_TDCMP1 TDCMP1 **/
#define HRTIM_Common_BMTRGR_TDCMP1		(1 << 21)
/** HRTIM_Common_BMTRGR_TDREP TDREP **/
#define HRTIM_Common_BMTRGR_TDREP		(1 << 20)
/** HRTIM_Common_BMTRGR_TDRST TDRST **/
#define HRTIM_Common_BMTRGR_TDRST		(1 << 19)
/** HRTIM_Common_BMTRGR_TCCMP2 TCCMP2 **/
#define HRTIM_Common_BMTRGR_TCCMP2		(1 << 18)
/** HRTIM_Common_BMTRGR_TCCMP1 TCCMP1 **/
#define HRTIM_Common_BMTRGR_TCCMP1		(1 << 17)
/** HRTIM_Common_BMTRGR_TCREP TCREP **/
#define HRTIM_Common_BMTRGR_TCREP		(1 << 16)
/** HRTIM_Common_BMTRGR_TCRST TCRST **/
#define HRTIM_Common_BMTRGR_TCRST		(1 << 15)
/** HRTIM_Common_BMTRGR_TBCMP2 TBCMP2 **/
#define HRTIM_Common_BMTRGR_TBCMP2		(1 << 14)
/** HRTIM_Common_BMTRGR_TBCMP1 TBCMP1 **/
#define HRTIM_Common_BMTRGR_TBCMP1		(1 << 13)
/** HRTIM_Common_BMTRGR_TBREP TBREP **/
#define HRTIM_Common_BMTRGR_TBREP		(1 << 12)
/** HRTIM_Common_BMTRGR_TBRST TBRST **/
#define HRTIM_Common_BMTRGR_TBRST		(1 << 11)
/** HRTIM_Common_BMTRGR_TACMP2 TACMP2 **/
#define HRTIM_Common_BMTRGR_TACMP2		(1 << 10)
/** HRTIM_Common_BMTRGR_TACMP1 TACMP1 **/
#define HRTIM_Common_BMTRGR_TACMP1		(1 << 9)
/** HRTIM_Common_BMTRGR_TAREP TAREP **/
#define HRTIM_Common_BMTRGR_TAREP		(1 << 8)
/** HRTIM_Common_BMTRGR_TARST TARST **/
#define HRTIM_Common_BMTRGR_TARST		(1 << 7)
/** HRTIM_Common_BMTRGR_MSTCMP4 MSTCMP4 **/
#define HRTIM_Common_BMTRGR_MSTCMP4		(1 << 6)
/** HRTIM_Common_BMTRGR_MSTCMP3 MSTCMP3 **/
#define HRTIM_Common_BMTRGR_MSTCMP3		(1 << 5)
/** HRTIM_Common_BMTRGR_MSTCMP2 MSTCMP2 **/
#define HRTIM_Common_BMTRGR_MSTCMP2		(1 << 4)
/** HRTIM_Common_BMTRGR_MSTCMP1 MSTCMP1 **/
#define HRTIM_Common_BMTRGR_MSTCMP1		(1 << 3)
/** HRTIM_Common_BMTRGR_MSTREP MSTREP **/
#define HRTIM_Common_BMTRGR_MSTREP		(1 << 2)
/** HRTIM_Common_BMTRGR_MSTRST MSTRST **/
#define HRTIM_Common_BMTRGR_MSTRST		(1 << 1)
/** HRTIM_Common_BMTRGR_SW SW **/
#define HRTIM_Common_BMTRGR_SW		(1 << 0)
