...
/** SCB_CFSR_UFSR_BFSR_MMFSR_MMARVALID Memory Management Fault Address Register (MMAR) valid flag **/
...
/** SCB_CFSR_UFSR_BFSR_MMFSR_MSTKERR Memory manager fault on stacking for exception entry. **/
#define SCB_CFSR_UFSR_BFSR_MMFSR_MSTKERR		(1 << 4)
/** SCB_CFSR_UFSR_BFSR_MMFSR_MUNSTKERR Memory manager fault on unstacking for a return from exception **/
#define SCB_CFSR_UFSR_BFSR_MMFSR_MUNSTKERR		(1 << 3)
/** SCB_CFSR_UFSR_BFSR_MMFSR_IACCVIOL Instruction access violation flag **/
#define SCB_CFSR_UFSR_BFSR_MMFSR_IACCVIOL		(1 << 1)
...
#define SCB_MMFAR_MMFAR_SHIFT		0
#define SCB_MMFAR_MMFAR_MASK		0xffffffff
/** @defgroup scb_mmfar_mmfar MMFAR Memory management fault address
@{*/
/**@}*/
...
#define SCB_BFAR_BFAR_SHIFT		0
#define SCB_BFAR_BFAR_MASK		0xffffffff
/** @defgroup scb_bfar_bfar BFAR Bus fault address
@{*/
/**@}*/
...
#define SCB_AFSR_IMPDEF_SHIFT		0
#define SCB_AFSR_IMPDEF_MASK		0xffffffff
/** @defgroup scb_afsr_impdef IMPDEF Implementation defined
@{*/
/**@}*/
