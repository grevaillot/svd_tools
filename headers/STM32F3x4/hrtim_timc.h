...
/** HRTIM_TIMC_TIMCDIER5 TIMxDIER5 **/
#define HRTIM_TIMC_TIMCDIER5			MMIO32(HRTIM_TIMC_BASE + 0x0c)
...
/** HRTIM_TIMC_TIMCCR_TCU TCU **/
#define HRTIM_TIMC_TIMCCR_TCU		(1 << 21)
...
/** @defgroup hrtim_timc_timcdier5 TIMCDIER5 TIMxDIER5
@{*/

/** HRTIM_TIMC_TIMCDIER5_DLYPRTDE DLYPRTDE **/
#define HRTIM_TIMC_TIMCDIER5_DLYPRTDE		(1 << 30)
/** HRTIM_TIMC_TIMCDIER5_RSTDE RSTDE **/
#define HRTIM_TIMC_TIMCDIER5_RSTDE		(1 << 29)
/** HRTIM_TIMC_TIMCDIER5_RSTx2DE RSTx2DE **/
#define HRTIM_TIMC_TIMCDIER5_RSTx2DE		(1 << 28)
/** HRTIM_TIMC_TIMCDIER5_SETx2DE SETx2DE **/
#define HRTIM_TIMC_TIMCDIER5_SETx2DE		(1 << 27)
/** HRTIM_TIMC_TIMCDIER5_RSTx1DE RSTx1DE **/
#define HRTIM_TIMC_TIMCDIER5_RSTx1DE		(1 << 26)
/** HRTIM_TIMC_TIMCDIER5_SET1xDE SET1xDE **/
#define HRTIM_TIMC_TIMCDIER5_SET1xDE		(1 << 25)
/** HRTIM_TIMC_TIMCDIER5_CPT2DE CPT2DE **/
#define HRTIM_TIMC_TIMCDIER5_CPT2DE		(1 << 24)
/** HRTIM_TIMC_TIMCDIER5_CPT1DE CPT1DE **/
#define HRTIM_TIMC_TIMCDIER5_CPT1DE		(1 << 23)
/** HRTIM_TIMC_TIMCDIER5_UPDDE UPDDE **/
#define HRTIM_TIMC_TIMCDIER5_UPDDE		(1 << 22)
/** HRTIM_TIMC_TIMCDIER5_REPDE REPDE **/
#define HRTIM_TIMC_TIMCDIER5_REPDE		(1 << 20)
/** HRTIM_TIMC_TIMCDIER5_CMP4DE CMP4DE **/
#define HRTIM_TIMC_TIMCDIER5_CMP4DE		(1 << 19)
/** HRTIM_TIMC_TIMCDIER5_CMP3DE CMP3DE **/
#define HRTIM_TIMC_TIMCDIER5_CMP3DE		(1 << 18)
/** HRTIM_TIMC_TIMCDIER5_CMP2DE CMP2DE **/
#define HRTIM_TIMC_TIMCDIER5_CMP2DE		(1 << 17)
/** HRTIM_TIMC_TIMCDIER5_CMP1DE CMP1DE **/
#define HRTIM_TIMC_TIMCDIER5_CMP1DE		(1 << 16)
/** HRTIM_TIMC_TIMCDIER5_DLYPRTIE DLYPRTIE **/
#define HRTIM_TIMC_TIMCDIER5_DLYPRTIE		(1 << 14)
/** HRTIM_TIMC_TIMCDIER5_RSTIE RSTIE **/
#define HRTIM_TIMC_TIMCDIER5_RSTIE		(1 << 13)
/** HRTIM_TIMC_TIMCDIER5_RSTx2IE RSTx2IE **/
#define HRTIM_TIMC_TIMCDIER5_RSTx2IE		(1 << 12)
/** HRTIM_TIMC_TIMCDIER5_SETx2IE SETx2IE **/
#define HRTIM_TIMC_TIMCDIER5_SETx2IE		(1 << 11)
/** HRTIM_TIMC_TIMCDIER5_RSTx1IE RSTx1IE **/
#define HRTIM_TIMC_TIMCDIER5_RSTx1IE		(1 << 10)
/** HRTIM_TIMC_TIMCDIER5_SET1xIE SET1xIE **/
#define HRTIM_TIMC_TIMCDIER5_SET1xIE		(1 << 9)
/** HRTIM_TIMC_TIMCDIER5_CPT2IE CPT2IE **/
#define HRTIM_TIMC_TIMCDIER5_CPT2IE		(1 << 8)
/** HRTIM_TIMC_TIMCDIER5_CPT1IE CPT1IE **/
#define HRTIM_TIMC_TIMCDIER5_CPT1IE		(1 << 7)
/** HRTIM_TIMC_TIMCDIER5_UPDIE UPDIE **/
#define HRTIM_TIMC_TIMCDIER5_UPDIE		(1 << 6)
/** HRTIM_TIMC_TIMCDIER5_REPIE REPIE **/
#define HRTIM_TIMC_TIMCDIER5_REPIE		(1 << 4)
/** HRTIM_TIMC_TIMCDIER5_CMP4IE CMP4IE **/
#define HRTIM_TIMC_TIMCDIER5_CMP4IE		(1 << 3)
/** HRTIM_TIMC_TIMCDIER5_CMP3IE CMP3IE **/
#define HRTIM_TIMC_TIMCDIER5_CMP3IE		(1 << 2)
/** HRTIM_TIMC_TIMCDIER5_CMP2IE CMP2IE **/
#define HRTIM_TIMC_TIMCDIER5_CMP2IE		(1 << 1)
/** HRTIM_TIMC_TIMCDIER5_CMP1IE CMP1IE **/
#define HRTIM_TIMC_TIMCDIER5_CMP1IE		(1 << 0)
