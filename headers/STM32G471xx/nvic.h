...
#define NVIC_ICPR3			MMIO32(NVIC_BASE + 0x18c)
...
#define NVIC_ICPR3_CLRPEND_SHIFT		0
#define NVIC_ICPR3_CLRPEND_MASK		0xffffffff
/** @defgroup nvic_icpr3_clrpend CLRPEND CLRPEND
@{*/
/**@}*/
...
/** @defgroup nvic_stir_intid INTID Software generated interrupt ID
@{*/
/**@}*/
