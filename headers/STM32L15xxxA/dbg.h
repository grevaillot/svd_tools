...
/** DBG_DBGMCU_CR_DBG_TIM7_STOP DBG_TIM7_STOP **/
#define DBG_DBGMCU_CR_DBG_TIM7_STOP		(1 << 20)
/** DBG_DBGMCU_CR_DBG_TIM6_STOP DBG_TIM6_STOP **/
#define DBG_DBGMCU_CR_DBG_TIM6_STOP		(1 << 19)
/** DBG_DBGMCU_CR_DBG_TIM5_STOP DBG_TIM5_STOP **/
#define DBG_DBGMCU_CR_DBG_TIM5_STOP		(1 << 18)
/** DBG_DBGMCU_CR_DBG_TIM8_STOP DBG_TIM8_STOP **/
#define DBG_DBGMCU_CR_DBG_TIM8_STOP		(1 << 17)
/** DBG_DBGMCU_CR_DBG_I2C2_SMBUS_TIMEOUT DBG_I2C2_SMBUS_TIMEOUT **/
#define DBG_DBGMCU_CR_DBG_I2C2_SMBUS_TIMEOUT		(1 << 16)
...
/** DBG_DBGMCU_APB1_FZ_DBG_CAN2_STOP DBG_CAN2_STOP **/
#define DBG_DBGMCU_APB1_FZ_DBG_CAN2_STOP		(1 << 26)
/** DBG_DBGMCU_APB1_FZ_DBG_CAN1_STOP DBG_CAN1_STOP **/
#define DBG_DBGMCU_APB1_FZ_DBG_CAN1_STOP		(1 << 25)
/** DBG_DBGMCU_APB1_FZ_DBG_J2C3SMBUS_TIMEOUT DBG_J2C3SMBUS_TIMEOUT **/
#define DBG_DBGMCU_APB1_FZ_DBG_J2C3SMBUS_TIMEOUT		(1 << 23)
/** DBG_DBGMCU_APB1_FZ_DBG_J2C2_SMBUS_TIMEOUT DBG_J2C2_SMBUS_TIMEOUT **/
#define DBG_DBGMCU_APB1_FZ_DBG_J2C2_SMBUS_TIMEOUT		(1 << 22)
/** DBG_DBGMCU_APB1_FZ_DBG_J2C1_SMBUS_TIMEOUT DBG_J2C1_SMBUS_TIMEOUT **/
#define DBG_DBGMCU_APB1_FZ_DBG_J2C1_SMBUS_TIMEOUT		(1 << 21)
...
/** DBG_DBGMCU_APB1_FZ_DBG_TIM14_STOP DBG_TIM14_STOP **/
#define DBG_DBGMCU_APB1_FZ_DBG_TIM14_STOP		(1 << 8)
/** DBG_DBGMCU_APB1_FZ_DBG_TIM13_STOP DBG_TIM13_STOP **/
#define DBG_DBGMCU_APB1_FZ_DBG_TIM13_STOP		(1 << 7)
/** DBG_DBGMCU_APB1_FZ_DBG_TIM12_STOP DBG_TIM12_STOP **/
#define DBG_DBGMCU_APB1_FZ_DBG_TIM12_STOP		(1 << 6)
/** DBG_DBGMCU_APB1_FZ_DBG_TIM7_STOP DBG_TIM7_STOP **/
#define DBG_DBGMCU_APB1_FZ_DBG_TIM7_STOP		(1 << 5)
/** DBG_DBGMCU_APB1_FZ_DBG_TIM6_STOP DBG_TIM6_STOP **/
#define DBG_DBGMCU_APB1_FZ_DBG_TIM6_STOP		(1 << 4)
...
/** DBG_DBGMCU_APB2_FZ_DBG_TIM8_STOP TIM8 counter stopped when core is halted **/
#define DBG_DBGMCU_APB2_FZ_DBG_TIM8_STOP		(1 << 1)
