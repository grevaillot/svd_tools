...
/** @defgroup tim4_registers General purpose timer Register
@{*/
...
/** TIM4_SMCR_SMS_3 Slave mode selection bit3 **/
...
#define TIM4_CCMR1_Input_IC1PSC_SHIFT		2
#define TIM4_CCMR1_Input_IC1PSC_MASK		0x03
/** @defgroup tim4_ccmr1_input_ic1psc IC1PSC Input capture 1 prescaler
@{*/
/**@}*/
...
/** TIM4_CCMR2_Output_OC4M_3 Output compare 4 mode bit3 **/
#define TIM4_CCMR2_Output_OC4M_3		(1 << 24)
/** TIM4_CCMR2_Output_OC3M_3 Output compare 3 mode bit3 **/
#define TIM4_CCMR2_Output_OC3M_3		(1 << 16)
/** TIM4_CCMR2_Output_O24CE Output compare 4 clear enable **/
...
/** TIM4_CCER_CC4NP Capture/Compare 3 output Polarity **/
...
/** TIM4_CNT_CNT_or_UIFCPY if IUFREMAP=0 than CNT with read write access else UIFCPY with read only access **/
#define TIM4_CNT_CNT_or_UIFCPY		(1 << 31)

#define TIM4_CNT_CNTH_SHIFT		16
#define TIM4_CNT_CNTH_MASK		0x7fff
/** @defgroup tim4_cnt_cnth CNTH High counter value
@{*/
/**@}*/


#define TIM4_CNT_CNTL_SHIFT		0
#define TIM4_CNT_CNTL_MASK		0xffff
/** @defgroup tim4_cnt_cntl CNTL Low counter value
@{*/
/**@}*/
...
#define TIM4_ARR_ARRH_SHIFT		16
#define TIM4_ARR_ARRH_MASK		0xffff
/** @defgroup tim4_arr_arrh ARRH High Auto-reload value
@{*/
/**@}*/


#define TIM4_ARR_ARRL_SHIFT		0
#define TIM4_ARR_ARRL_MASK		0xffff
/** @defgroup tim4_arr_arrl ARRL Low Auto-reload value
@{*/
/**@}*/
...
#define TIM4_CCR1_CCR1H_SHIFT		16
#define TIM4_CCR1_CCR1H_MASK		0xffff
/** @defgroup tim4_ccr1_ccr1h CCR1H High Capture/Compare 1 value (on TIM2)
@{*/
/**@}*/


#define TIM4_CCR1_CCR1L_SHIFT		0
#define TIM4_CCR1_CCR1L_MASK		0xffff
/** @defgroup tim4_ccr1_ccr1l CCR1L Low Capture/Compare 1 value
@{*/
/**@}*/
...
#define TIM4_CCR2_CCR2H_SHIFT		16
#define TIM4_CCR2_CCR2H_MASK		0xffff
/** @defgroup tim4_ccr2_ccr2h CCR2H High Capture/Compare 2 value (on TIM2)
@{*/
/**@}*/


#define TIM4_CCR2_CCR2L_SHIFT		0
#define TIM4_CCR2_CCR2L_MASK		0xffff
/** @defgroup tim4_ccr2_ccr2l CCR2L Low Capture/Compare 2 value
@{*/
/**@}*/
...
#define TIM4_CCR3_CCR3H_SHIFT		16
#define TIM4_CCR3_CCR3H_MASK		0xffff
/** @defgroup tim4_ccr3_ccr3h CCR3H High Capture/Compare value (on TIM2)
@{*/
/**@}*/


#define TIM4_CCR3_CCR3L_SHIFT		0
#define TIM4_CCR3_CCR3L_MASK		0xffff
/** @defgroup tim4_ccr3_ccr3l CCR3L Low Capture/Compare value
@{*/
/**@}*/
...
#define TIM4_CCR4_CCR4H_SHIFT		16
#define TIM4_CCR4_CCR4H_MASK		0xffff
/** @defgroup tim4_ccr4_ccr4h CCR4H High Capture/Compare value (on TIM2)
@{*/
/**@}*/


#define TIM4_CCR4_CCR4L_SHIFT		0
#define TIM4_CCR4_CCR4L_MASK		0xffff
/** @defgroup tim4_ccr4_ccr4l CCR4L Low Capture/Compare value
@{*/
/**@}*/
