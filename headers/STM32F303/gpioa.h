...
/** GPIOA_BRR_BR15 Port x Reset bit y **/
#define GPIOA_BRR_BR15		(1 << 15)
/** GPIOA_BRR_BR14 Port x Reset bit y **/
#define GPIOA_BRR_BR14		(1 << 14)
/** GPIOA_BRR_BR13 Port x Reset bit y **/
#define GPIOA_BRR_BR13		(1 << 13)
/** GPIOA_BRR_BR12 Port x Reset bit y **/
#define GPIOA_BRR_BR12		(1 << 12)
/** GPIOA_BRR_BR11 Port x Reset bit y **/
#define GPIOA_BRR_BR11		(1 << 11)
/** GPIOA_BRR_BR10 Port x Reset bit y **/
#define GPIOA_BRR_BR10		(1 << 10)
/** GPIOA_BRR_BR9 Port x Reset bit y **/
#define GPIOA_BRR_BR9		(1 << 9)
/** GPIOA_BRR_BR8 Port x Reset bit y **/
#define GPIOA_BRR_BR8		(1 << 8)
/** GPIOA_BRR_BR7 Port x Reset bit y **/
#define GPIOA_BRR_BR7		(1 << 7)
/** GPIOA_BRR_BR6 Port x Reset bit y **/
#define GPIOA_BRR_BR6		(1 << 6)
/** GPIOA_BRR_BR5 Port x Reset bit y **/
#define GPIOA_BRR_BR5		(1 << 5)
/** GPIOA_BRR_BR4 Port x Reset bit y **/
#define GPIOA_BRR_BR4		(1 << 4)
/** GPIOA_BRR_BR3 Port x Reset bit y **/
#define GPIOA_BRR_BR3		(1 << 3)
/** GPIOA_BRR_BR2 Port x Reset bit y **/
#define GPIOA_BRR_BR2		(1 << 2)
/** GPIOA_BRR_BR1 Port x Reset bit y **/
#define GPIOA_BRR_BR1		(1 << 1)
/** GPIOA_BRR_BR0 Port x Reset bit y **/
