...
/** I2C2_DR Data register **/
#define I2C2_DR			MMIO32(I2C2_BASE + 0x10)
/** I2C2_SR1 Status register 1 **/
#define I2C2_SR1			MMIO32(I2C2_BASE + 0x14)
/** I2C2_SR2 Status register 2 **/
#define I2C2_SR2			MMIO32(I2C2_BASE + 0x18)
/** I2C2_CCR Clock control register **/
#define I2C2_CCR			MMIO32(I2C2_BASE + 0x1c)
/** I2C2_TRISE TRISE register **/
#define I2C2_TRISE			MMIO32(I2C2_BASE + 0x20)
/** I2C2_FLTR I2C FLTR register **/
#define I2C2_FLTR			MMIO32(I2C2_BASE + 0x24)
...
/** I2C2_OAR1_ADDMODE Addressing mode (slave mode) **/
#define I2C2_OAR1_ADDMODE		(1 << 15)

#define I2C2_OAR1_ADD10_SHIFT		8
#define I2C2_OAR1_ADD10_MASK		0x03
/** @defgroup i2c2_oar1_add10 ADD10 Interface address
@{*/
/**@}*/


#define I2C2_OAR1_ADD7_SHIFT		1
#define I2C2_OAR1_ADD7_MASK		0x7f
/** @defgroup i2c2_oar1_add7 ADD7 Interface address
@{*/
/**@}*/

/** I2C2_OAR1_ADD0 Interface address **/
#define I2C2_OAR1_ADD0		(1 << 0)
...
/** @defgroup i2c2_dr DR Data register
@{*/


#define I2C2_DR_DR_SHIFT		0
#define I2C2_DR_DR_MASK		0xff
/** @defgroup i2c2_dr_dr DR 8-bit data register
@{*/
/**@}*/
...
/** @defgroup i2c2_sr1 SR1 Status register 1
@{*/
...
/** @defgroup i2c2_sr2 SR2 Status register 2
@{*/
...
/** @defgroup i2c2_ccr CCR Clock control register
@{*/
...
/** @defgroup i2c2_trise TRISE TRISE register
@{*/
...
/** @defgroup i2c2_fltr FLTR I2C FLTR register
@{*/

/** I2C2_FLTR_ANOFF Analog noise filter OFF **/
#define I2C2_FLTR_ANOFF		(1 << 4)

#define I2C2_FLTR_DNF_SHIFT		0
#define I2C2_FLTR_DNF_MASK		0x0f
/** @defgroup i2c2_fltr_dnf DNF Digital noise filter
@{*/
/**@}*/
