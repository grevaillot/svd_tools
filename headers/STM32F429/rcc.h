...
/** @defgroup rcc_pllsaicfgr PLLSAICFGR RCC PLL configuration register
@{*/
...
/** @defgroup rcc_dckcfgr DCKCFGR RCC Dedicated Clock Configuration Register
@{*/
...
/** @defgroup rcc_dckcfgr_sai1asrc SAI1ASRC SAI1-A clock source selection
@{*/
/**@}*/
...
/** @defgroup rcc_dckcfgr_pllsaidivr PLLSAIDIVR division factor for LCD_CLK
@{*/
/**@}*/
...
/** @defgroup rcc_dckcfgr_pllsaidivq PLLSAIDIVQ PLLSAI division factor for SAI1 clock
@{*/
/**@}*/
...
/** @defgroup rcc_dckcfgr_plli2sdivq PLLI2SDIVQ PLLI2S division factor for SAI1 clock
@{*/
/**@}*/
