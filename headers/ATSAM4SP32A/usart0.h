...
/** USART0_RHR Receiver Holding Register **/
#define USART0_RHR			MMIO32(USART0_BASE + 0x18)
/** USART0_THR Transmitter Holding Register **/
...
/** USART0_MAN Manchester Encoder Decoder Register **/
#define USART0_MAN			MMIO32(USART0_BASE + 0x50)
/** USART0_WPMR Write Protect Mode Register **/
#define USART0_WPMR			MMIO32(USART0_BASE + 0xe4)
/** USART0_WPSR Write Protect Status Register **/
#define USART0_WPSR			MMIO32(USART0_BASE + 0xe8)
/** USART0_VERSION Version Register **/
#define USART0_VERSION			MMIO32(USART0_BASE + 0xfc)
...
/** USART0_IER_NACK Non AcknowledgeInterrupt Enable **/
...
/** USART0_IDR_NACK Non AcknowledgeInterrupt Disable **/
...
/** USART0_IMR_NACK Non AcknowledgeInterrupt Mask **/
...
/** USART0_CSR_NACK Non AcknowledgeInterrupt **/
...
/** USART0_CSR_ITER MaxNumber of Repetitions Reached **/
...
/** @defgroup usart0_rhr RHR Receiver Holding Register
@{*/
...
/** @defgroup usart0_thr THR Transmitter Holding Register
@{*/
...
/** @defgroup usart0_man MAN Manchester Encoder Decoder Register
@{*/
...
/** @defgroup usart0_wpmr WPMR Write Protect Mode Register
@{*/


#define USART0_WPMR_WPKEY_SHIFT		8
#define USART0_WPMR_WPKEY_MASK		0xffffff
/** @defgroup usart0_wpmr_wpkey WPKEY Write Protect KEY
@{*/
/**@}*/

/** USART0_WPMR_WPEN Write Protect Enable **/
#define USART0_WPMR_WPEN		(1 << 0)

/**@}*/

/** @defgroup usart0_wpsr WPSR Write Protect Status Register
@{*/


#define USART0_WPSR_WPVSRC_SHIFT		8
#define USART0_WPSR_WPVSRC_MASK		0xffff
/** @defgroup usart0_wpsr_wpvsrc WPVSRC Write Protect Violation Source
@{*/
/**@}*/

/** USART0_WPSR_WPVS Write Protect Violation Status **/
#define USART0_WPSR_WPVS		(1 << 0)

/**@}*/

/** @defgroup usart0_version VERSION Version Register
@{*/


#define USART0_VERSION_MFN_SHIFT		16
#define USART0_VERSION_MFN_MASK		0x07
/** @defgroup usart0_version_mfn MFN Metal Fix Number
@{*/
/**@}*/


#define USART0_VERSION_VERSION_SHIFT		0
#define USART0_VERSION_VERSION_MASK		0xfff
/** @defgroup usart0_version_version VERSION Harware Module Version
@{*/
/**@}*/
