...
/** UDP_CSR0_ISOENDPT Endpoint Control and Status Register **/
#define UDP_CSR0_ISOENDPT			MMIO32(UDP_BASE + 0x30)
...
/** UDP_GLB_STAT_RMWUPE Remote Wake Up Enable **/
...
/** @defgroup udp_csr0_isoendpt CSR0ISOENDPT Endpoint Control and Status Register
@{*/


#define UDP_CSR0_ISOENDPT_RXBYTECNT_SHIFT		16
#define UDP_CSR0_ISOENDPT_RXBYTECNT_MASK		0x7ff
/** @defgroup udp_csr0_isoendpt_rxbytecnt RXBYTECNT Number of Bytes Available in the FIFO
@{*/
/**@}*/

/** UDP_CSR0_ISOENDPT_EPEDS Endpoint Enable Disable **/
#define UDP_CSR0_ISOENDPT_EPEDS		(1 << 15)
/** UDP_CSR0_ISOENDPT_DTGLE Data Toggle **/
#define UDP_CSR0_ISOENDPT_DTGLE		(1 << 11)

#define UDP_CSR0_ISOENDPT_EPTYPE_SHIFT		8
#define UDP_CSR0_ISOENDPT_EPTYPE_MASK		0x07
/** @defgroup udp_csr0_isoendpt_eptype EPTYPE Endpoint Type
@{*/
/**@}*/

/** UDP_CSR0_ISOENDPT_DIR Transfer Direction (only available for control endpoints) **/
#define UDP_CSR0_ISOENDPT_DIR		(1 << 7)
/** UDP_CSR0_ISOENDPT_RX_DATA_BK1 Receive Data Bank 1 (only used by endpoints with ping-pong attributes) **/
#define UDP_CSR0_ISOENDPT_RX_DATA_BK1		(1 << 6)
/** UDP_CSR0_ISOENDPT_FORCESTALL Force Stall (used by Control, Bulk and Isochronous Endpoints) **/
#define UDP_CSR0_ISOENDPT_FORCESTALL		(1 << 5)
/** UDP_CSR0_ISOENDPT_TXPKTRDY Transmit Packet Ready **/
#define UDP_CSR0_ISOENDPT_TXPKTRDY		(1 << 4)
/** UDP_CSR0_ISOENDPT_ISOERROR A CRC error has been detected in an isochronous transfer **/
#define UDP_CSR0_ISOENDPT_ISOERROR		(1 << 3)
/** UDP_CSR0_ISOENDPT_RXSETUP Received Setup **/
#define UDP_CSR0_ISOENDPT_RXSETUP		(1 << 2)
/** UDP_CSR0_ISOENDPT_RX_DATA_BK0 Receive Data Bank 0 **/
#define UDP_CSR0_ISOENDPT_RX_DATA_BK0		(1 << 1)
/** UDP_CSR0_ISOENDPT_TXCOMP Generates an IN Packet with Data Previously Written in the DPR **/
#define UDP_CSR0_ISOENDPT_TXCOMP		(1 << 0)
...
/** @defgroup udp_csr[0]_rxbytecnt RXBYTECNT Number of Bytes Available in the FIFO
@{*/
/**@}*/

/** UDP_CSR[0]_EPEDS Endpoint Enable Disable **/
#define UDP_CSR[0]_EPEDS		(1 << 15)
/** UDP_CSR[0]_DTGLE Data Toggle **/
#define UDP_CSR[0]_DTGLE		(1 << 11)

#define UDP_CSR[0]_EPTYPE_SHIFT		8
#define UDP_CSR[0]_EPTYPE_MASK		0x07
/** @defgroup udp_csr[0]_eptype EPTYPE Endpoint Type
@{*/
/**@}*/

/** UDP_CSR[0]_DIR Transfer Direction (only available for control endpoints) **/
...
/** @defgroup udp_csr[1]_rxbytecnt RXBYTECNT Number of Bytes Available in the FIFO
@{*/
/**@}*/

/** UDP_CSR[1]_EPEDS Endpoint Enable Disable **/
#define UDP_CSR[1]_EPEDS		(1 << 15)
/** UDP_CSR[1]_DTGLE Data Toggle **/
#define UDP_CSR[1]_DTGLE		(1 << 11)

#define UDP_CSR[1]_EPTYPE_SHIFT		8
#define UDP_CSR[1]_EPTYPE_MASK		0x07
/** @defgroup udp_csr[1]_eptype EPTYPE Endpoint Type
@{*/
/**@}*/

/** UDP_CSR[1]_DIR Transfer Direction (only available for control endpoints) **/
...
/** @defgroup udp_csr[2]_rxbytecnt RXBYTECNT Number of Bytes Available in the FIFO
@{*/
/**@}*/

/** UDP_CSR[2]_EPEDS Endpoint Enable Disable **/
#define UDP_CSR[2]_EPEDS		(1 << 15)
/** UDP_CSR[2]_DTGLE Data Toggle **/
#define UDP_CSR[2]_DTGLE		(1 << 11)

#define UDP_CSR[2]_EPTYPE_SHIFT		8
#define UDP_CSR[2]_EPTYPE_MASK		0x07
/** @defgroup udp_csr[2]_eptype EPTYPE Endpoint Type
@{*/
/**@}*/

/** UDP_CSR[2]_DIR Transfer Direction (only available for control endpoints) **/
...
/** @defgroup udp_csr[3]_rxbytecnt RXBYTECNT Number of Bytes Available in the FIFO
@{*/
/**@}*/

/** UDP_CSR[3]_EPEDS Endpoint Enable Disable **/
#define UDP_CSR[3]_EPEDS		(1 << 15)
/** UDP_CSR[3]_DTGLE Data Toggle **/
#define UDP_CSR[3]_DTGLE		(1 << 11)

#define UDP_CSR[3]_EPTYPE_SHIFT		8
#define UDP_CSR[3]_EPTYPE_MASK		0x07
/** @defgroup udp_csr[3]_eptype EPTYPE Endpoint Type
@{*/
/**@}*/

/** UDP_CSR[3]_DIR Transfer Direction (only available for control endpoints) **/
...
/** @defgroup udp_csr[4]_rxbytecnt RXBYTECNT Number of Bytes Available in the FIFO
@{*/
/**@}*/

/** UDP_CSR[4]_EPEDS Endpoint Enable Disable **/
#define UDP_CSR[4]_EPEDS		(1 << 15)
/** UDP_CSR[4]_DTGLE Data Toggle **/
#define UDP_CSR[4]_DTGLE		(1 << 11)

#define UDP_CSR[4]_EPTYPE_SHIFT		8
#define UDP_CSR[4]_EPTYPE_MASK		0x07
/** @defgroup udp_csr[4]_eptype EPTYPE Endpoint Type
@{*/
/**@}*/

/** UDP_CSR[4]_DIR Transfer Direction (only available for control endpoints) **/
...
/** @defgroup udp_csr[5]_rxbytecnt RXBYTECNT Number of Bytes Available in the FIFO
@{*/
/**@}*/

/** UDP_CSR[5]_EPEDS Endpoint Enable Disable **/
#define UDP_CSR[5]_EPEDS		(1 << 15)
/** UDP_CSR[5]_DTGLE Data Toggle **/
#define UDP_CSR[5]_DTGLE		(1 << 11)

#define UDP_CSR[5]_EPTYPE_SHIFT		8
#define UDP_CSR[5]_EPTYPE_MASK		0x07
/** @defgroup udp_csr[5]_eptype EPTYPE Endpoint Type
@{*/
/**@}*/

/** UDP_CSR[5]_DIR Transfer Direction (only available for control endpoints) **/
...
/** @defgroup udp_csr[6]_rxbytecnt RXBYTECNT Number of Bytes Available in the FIFO
@{*/
/**@}*/

/** UDP_CSR[6]_EPEDS Endpoint Enable Disable **/
#define UDP_CSR[6]_EPEDS		(1 << 15)
/** UDP_CSR[6]_DTGLE Data Toggle **/
#define UDP_CSR[6]_DTGLE		(1 << 11)

#define UDP_CSR[6]_EPTYPE_SHIFT		8
#define UDP_CSR[6]_EPTYPE_MASK		0x07
/** @defgroup udp_csr[6]_eptype EPTYPE Endpoint Type
@{*/
/**@}*/

/** UDP_CSR[6]_DIR Transfer Direction (only available for control endpoints) **/
...
/** @defgroup udp_csr[7]_rxbytecnt RXBYTECNT Number of Bytes Available in the FIFO
@{*/
/**@}*/

/** UDP_CSR[7]_EPEDS Endpoint Enable Disable **/
#define UDP_CSR[7]_EPEDS		(1 << 15)
/** UDP_CSR[7]_DTGLE Data Toggle **/
#define UDP_CSR[7]_DTGLE		(1 << 11)

#define UDP_CSR[7]_EPTYPE_SHIFT		8
#define UDP_CSR[7]_EPTYPE_MASK		0x07
/** @defgroup udp_csr[7]_eptype EPTYPE Endpoint Type
@{*/
/**@}*/

/** UDP_CSR[7]_DIR Transfer Direction (only available for control endpoints) **/
