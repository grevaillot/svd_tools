...
/** TC1_CMR0_WAVE_EQ_1 Channel Mode Register (channel = 0) **/
...
/** TC1_CMR1_WAVE_EQ_1 Channel Mode Register (channel = 1) **/
...
/** TC1_CMR2_WAVE_EQ_1 Channel Mode Register (channel = 2) **/
...
/** TC1_WPMR Write Protect Mode Register **/
...
/** @defgroup tc1_cmr0_wave_eq_1 CMR0WAVEEQ1 Channel Mode Register (channel = 0)
@{*/


#define TC1_CMR0_WAVE_EQ_1_BSWTRG_SHIFT		30
#define TC1_CMR0_WAVE_EQ_1_BSWTRG_MASK		0x03
/** @defgroup tc1_cmr0_wave_eq_1_bswtrg BSWTRG Software Trigger Effect on TIOB
@{*/
/**@}*/
...
/** @defgroup tc1_cmr0_wave_eq_1_beevt BEEVT External Event Effect on TIOB
@{*/
/**@}*/
...
/** @defgroup tc1_cmr0_wave_eq_1_bcpc BCPC RC Compare Effect on TIOB
@{*/
/**@}*/
...
/** @defgroup tc1_cmr0_wave_eq_1_bcpb BCPB RB Compare Effect on TIOB
@{*/
/**@}*/
...
/** @defgroup tc1_cmr0_wave_eq_1_aswtrg ASWTRG Software Trigger Effect on TIOA
@{*/
/**@}*/
...
/** @defgroup tc1_cmr0_wave_eq_1_aeevt AEEVT External Event Effect on TIOA
@{*/
/**@}*/
...
/** @defgroup tc1_cmr0_wave_eq_1_acpc ACPC RC Compare Effect on TIOA
@{*/
/**@}*/
...
/** @defgroup tc1_cmr0_wave_eq_1_acpa ACPA RA Compare Effect on TIOA
@{*/
/**@}*/

/** TC1_CMR0_WAVE_EQ_1_WAVE Waveform Mode **/
#define TC1_CMR0_WAVE_EQ_1_WAVE		(1 << 15)

#define TC1_CMR0_WAVE_EQ_1_WAVSEL_SHIFT		13
#define TC1_CMR0_WAVE_EQ_1_WAVSEL_MASK		0x03
/** @defgroup tc1_cmr0_wave_eq_1_wavsel WAVSEL Waveform Selection
@{*/
/**@}*/

/** TC1_CMR0_WAVE_EQ_1_ENETRG External Event Trigger Enable **/
#define TC1_CMR0_WAVE_EQ_1_ENETRG		(1 << 12)

#define TC1_CMR0_WAVE_EQ_1_EEVT_SHIFT		10
#define TC1_CMR0_WAVE_EQ_1_EEVT_MASK		0x03
/** @defgroup tc1_cmr0_wave_eq_1_eevt EEVT External Event Selection
@{*/
/**@}*/
...
/** @defgroup tc1_cmr0_wave_eq_1_eevtedg EEVTEDG External Event Edge Selection
@{*/
/**@}*/

/** TC1_CMR0_WAVE_EQ_1_CPCDIS Counter Clock Disable with RC Compare **/
#define TC1_CMR0_WAVE_EQ_1_CPCDIS		(1 << 7)
/** TC1_CMR0_WAVE_EQ_1_CPCSTOP Counter Clock Stopped with RC Compare **/
#define TC1_CMR0_WAVE_EQ_1_CPCSTOP		(1 << 6)

#define TC1_CMR0_WAVE_EQ_1_BURST_SHIFT		4
#define TC1_CMR0_WAVE_EQ_1_BURST_MASK		0x03
/** @defgroup tc1_cmr0_wave_eq_1_burst BURST Burst Signal Selection
@{*/
/**@}*/

/** TC1_CMR0_WAVE_EQ_1_CLKI Clock Invert **/
#define TC1_CMR0_WAVE_EQ_1_CLKI		(1 << 3)

#define TC1_CMR0_WAVE_EQ_1_TCCLKS_SHIFT		0
#define TC1_CMR0_WAVE_EQ_1_TCCLKS_MASK		0x07
/** @defgroup tc1_cmr0_wave_eq_1_tcclks TCCLKS Clock Selection
@{*/
/**@}*/
...
/** TC1_SR0_ETRGS External Trigger Status **/
#define TC1_SR0_ETRGS		(1 << 7)
/** TC1_SR0_LDRBS RB Loading Status **/
#define TC1_SR0_LDRBS		(1 << 6)
/** TC1_SR0_LDRAS RA Loading Status **/
#define TC1_SR0_LDRAS		(1 << 5)
/** TC1_SR0_CPCS RC Compare Status **/
#define TC1_SR0_CPCS		(1 << 4)
/** TC1_SR0_CPBS RB Compare Status **/
#define TC1_SR0_CPBS		(1 << 3)
/** TC1_SR0_CPAS RA Compare Status **/
#define TC1_SR0_CPAS		(1 << 2)
/** TC1_SR0_LOVRS Load Overrun Status **/
#define TC1_SR0_LOVRS		(1 << 1)
/** TC1_SR0_COVFS Counter Overflow Status **/
...
/** @defgroup tc1_cmr1_wave_eq_1 CMR1WAVEEQ1 Channel Mode Register (channel = 1)
@{*/


#define TC1_CMR1_WAVE_EQ_1_BSWTRG_SHIFT		30
#define TC1_CMR1_WAVE_EQ_1_BSWTRG_MASK		0x03
/** @defgroup tc1_cmr1_wave_eq_1_bswtrg BSWTRG Software Trigger Effect on TIOB
@{*/
/**@}*/
...
/** @defgroup tc1_cmr1_wave_eq_1_beevt BEEVT External Event Effect on TIOB
@{*/
/**@}*/
...
/** @defgroup tc1_cmr1_wave_eq_1_bcpc BCPC RC Compare Effect on TIOB
@{*/
/**@}*/
...
/** @defgroup tc1_cmr1_wave_eq_1_bcpb BCPB RB Compare Effect on TIOB
@{*/
/**@}*/
...
/** @defgroup tc1_cmr1_wave_eq_1_aswtrg ASWTRG Software Trigger Effect on TIOA
@{*/
/**@}*/
...
/** @defgroup tc1_cmr1_wave_eq_1_aeevt AEEVT External Event Effect on TIOA
@{*/
/**@}*/
...
/** @defgroup tc1_cmr1_wave_eq_1_acpc ACPC RC Compare Effect on TIOA
@{*/
/**@}*/
...
/** @defgroup tc1_cmr1_wave_eq_1_acpa ACPA RA Compare Effect on TIOA
@{*/
/**@}*/

/** TC1_CMR1_WAVE_EQ_1_WAVE Waveform Mode **/
#define TC1_CMR1_WAVE_EQ_1_WAVE		(1 << 15)

#define TC1_CMR1_WAVE_EQ_1_WAVSEL_SHIFT		13
#define TC1_CMR1_WAVE_EQ_1_WAVSEL_MASK		0x03
/** @defgroup tc1_cmr1_wave_eq_1_wavsel WAVSEL Waveform Selection
@{*/
/**@}*/

/** TC1_CMR1_WAVE_EQ_1_ENETRG External Event Trigger Enable **/
#define TC1_CMR1_WAVE_EQ_1_ENETRG		(1 << 12)

#define TC1_CMR1_WAVE_EQ_1_EEVT_SHIFT		10
#define TC1_CMR1_WAVE_EQ_1_EEVT_MASK		0x03
/** @defgroup tc1_cmr1_wave_eq_1_eevt EEVT External Event Selection
@{*/
/**@}*/
...
/** @defgroup tc1_cmr1_wave_eq_1_eevtedg EEVTEDG External Event Edge Selection
@{*/
/**@}*/

/** TC1_CMR1_WAVE_EQ_1_CPCDIS Counter Clock Disable with RC Compare **/
#define TC1_CMR1_WAVE_EQ_1_CPCDIS		(1 << 7)
/** TC1_CMR1_WAVE_EQ_1_CPCSTOP Counter Clock Stopped with RC Compare **/
#define TC1_CMR1_WAVE_EQ_1_CPCSTOP		(1 << 6)

#define TC1_CMR1_WAVE_EQ_1_BURST_SHIFT		4
#define TC1_CMR1_WAVE_EQ_1_BURST_MASK		0x03
/** @defgroup tc1_cmr1_wave_eq_1_burst BURST Burst Signal Selection
@{*/
/**@}*/

/** TC1_CMR1_WAVE_EQ_1_CLKI Clock Invert **/
#define TC1_CMR1_WAVE_EQ_1_CLKI		(1 << 3)

#define TC1_CMR1_WAVE_EQ_1_TCCLKS_SHIFT		0
#define TC1_CMR1_WAVE_EQ_1_TCCLKS_MASK		0x07
/** @defgroup tc1_cmr1_wave_eq_1_tcclks TCCLKS Clock Selection
@{*/
/**@}*/
...
/** TC1_SR1_ETRGS External Trigger Status **/
#define TC1_SR1_ETRGS		(1 << 7)
/** TC1_SR1_LDRBS RB Loading Status **/
#define TC1_SR1_LDRBS		(1 << 6)
/** TC1_SR1_LDRAS RA Loading Status **/
#define TC1_SR1_LDRAS		(1 << 5)
/** TC1_SR1_CPCS RC Compare Status **/
#define TC1_SR1_CPCS		(1 << 4)
/** TC1_SR1_CPBS RB Compare Status **/
#define TC1_SR1_CPBS		(1 << 3)
/** TC1_SR1_CPAS RA Compare Status **/
#define TC1_SR1_CPAS		(1 << 2)
/** TC1_SR1_LOVRS Load Overrun Status **/
#define TC1_SR1_LOVRS		(1 << 1)
/** TC1_SR1_COVFS Counter Overflow Status **/
...
/** @defgroup tc1_cmr2_wave_eq_1 CMR2WAVEEQ1 Channel Mode Register (channel = 2)
@{*/


#define TC1_CMR2_WAVE_EQ_1_BSWTRG_SHIFT		30
#define TC1_CMR2_WAVE_EQ_1_BSWTRG_MASK		0x03
/** @defgroup tc1_cmr2_wave_eq_1_bswtrg BSWTRG Software Trigger Effect on TIOB
@{*/
/**@}*/
...
/** @defgroup tc1_cmr2_wave_eq_1_beevt BEEVT External Event Effect on TIOB
@{*/
/**@}*/
...
/** @defgroup tc1_cmr2_wave_eq_1_bcpc BCPC RC Compare Effect on TIOB
@{*/
/**@}*/
...
/** @defgroup tc1_cmr2_wave_eq_1_bcpb BCPB RB Compare Effect on TIOB
@{*/
/**@}*/
...
/** @defgroup tc1_cmr2_wave_eq_1_aswtrg ASWTRG Software Trigger Effect on TIOA
@{*/
/**@}*/
...
/** @defgroup tc1_cmr2_wave_eq_1_aeevt AEEVT External Event Effect on TIOA
@{*/
/**@}*/
...
/** @defgroup tc1_cmr2_wave_eq_1_acpc ACPC RC Compare Effect on TIOA
@{*/
/**@}*/
...
/** @defgroup tc1_cmr2_wave_eq_1_acpa ACPA RA Compare Effect on TIOA
@{*/
/**@}*/

/** TC1_CMR2_WAVE_EQ_1_WAVE Waveform Mode **/
#define TC1_CMR2_WAVE_EQ_1_WAVE		(1 << 15)

#define TC1_CMR2_WAVE_EQ_1_WAVSEL_SHIFT		13
#define TC1_CMR2_WAVE_EQ_1_WAVSEL_MASK		0x03
/** @defgroup tc1_cmr2_wave_eq_1_wavsel WAVSEL Waveform Selection
@{*/
/**@}*/

/** TC1_CMR2_WAVE_EQ_1_ENETRG External Event Trigger Enable **/
#define TC1_CMR2_WAVE_EQ_1_ENETRG		(1 << 12)

#define TC1_CMR2_WAVE_EQ_1_EEVT_SHIFT		10
#define TC1_CMR2_WAVE_EQ_1_EEVT_MASK		0x03
/** @defgroup tc1_cmr2_wave_eq_1_eevt EEVT External Event Selection
@{*/
/**@}*/
...
/** @defgroup tc1_cmr2_wave_eq_1_eevtedg EEVTEDG External Event Edge Selection
@{*/
/**@}*/

/** TC1_CMR2_WAVE_EQ_1_CPCDIS Counter Clock Disable with RC Compare **/
#define TC1_CMR2_WAVE_EQ_1_CPCDIS		(1 << 7)
/** TC1_CMR2_WAVE_EQ_1_CPCSTOP Counter Clock Stopped with RC Compare **/
#define TC1_CMR2_WAVE_EQ_1_CPCSTOP		(1 << 6)

#define TC1_CMR2_WAVE_EQ_1_BURST_SHIFT		4
#define TC1_CMR2_WAVE_EQ_1_BURST_MASK		0x03
/** @defgroup tc1_cmr2_wave_eq_1_burst BURST Burst Signal Selection
@{*/
/**@}*/

/** TC1_CMR2_WAVE_EQ_1_CLKI Clock Invert **/
#define TC1_CMR2_WAVE_EQ_1_CLKI		(1 << 3)

#define TC1_CMR2_WAVE_EQ_1_TCCLKS_SHIFT		0
#define TC1_CMR2_WAVE_EQ_1_TCCLKS_MASK		0x07
/** @defgroup tc1_cmr2_wave_eq_1_tcclks TCCLKS Clock Selection
@{*/
/**@}*/
...
/** TC1_SR2_ETRGS External Trigger Status **/
#define TC1_SR2_ETRGS		(1 << 7)
/** TC1_SR2_LDRBS RB Loading Status **/
#define TC1_SR2_LDRBS		(1 << 6)
/** TC1_SR2_LDRAS RA Loading Status **/
#define TC1_SR2_LDRAS		(1 << 5)
/** TC1_SR2_CPCS RC Compare Status **/
#define TC1_SR2_CPCS		(1 << 4)
/** TC1_SR2_CPBS RB Compare Status **/
#define TC1_SR2_CPBS		(1 << 3)
/** TC1_SR2_CPAS RA Compare Status **/
#define TC1_SR2_CPAS		(1 << 2)
/** TC1_SR2_LOVRS Load Overrun Status **/
#define TC1_SR2_LOVRS		(1 << 1)
/** TC1_SR2_COVFS Counter Overflow Status **/
...
/** @defgroup tc1_wpmr WPMR Write Protect Mode Register
@{*/


#define TC1_WPMR_WPKEY_SHIFT		8
#define TC1_WPMR_WPKEY_MASK		0xffffff
/** @defgroup tc1_wpmr_wpkey WPKEY Write Protect KEY
@{*/
/**@}*/

/** TC1_WPMR_WPEN Write Protect Enable **/
