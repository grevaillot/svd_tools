...
/** LPTIM1_LPTIM_CFGR2 LPTIM configuration register 2 **/
#define LPTIM1_LPTIM_CFGR2			MMIO32(LPTIM1_BASE + 0x24)
...
/** LPTIM1_CR_RSTARE Reset after read enable **/
#define LPTIM1_CR_RSTARE		(1 << 4)
/** LPTIM1_CR_COUNTRST Counter reset **/
#define LPTIM1_CR_COUNTRST		(1 << 3)
...
/** @defgroup lptim1_lptim_cfgr2 LPTIMCFGR2 LPTIM configuration register 2
@{*/


#define LPTIM1_LPTIM_CFGR2_IN2SEL_SHIFT		4
#define LPTIM1_LPTIM_CFGR2_IN2SEL_MASK		0x03
/** @defgroup lptim1_lptim_cfgr2_in2sel IN2SEL LPTIM Input 2 selection
@{*/
/**@}*/


#define LPTIM1_LPTIM_CFGR2_IN1SEL_SHIFT		0
#define LPTIM1_LPTIM_CFGR2_IN1SEL_MASK		0x03
/** @defgroup lptim1_lptim_cfgr2_in1sel IN1SEL LPTIM Input 1 selection
@{*/
/**@}*/
