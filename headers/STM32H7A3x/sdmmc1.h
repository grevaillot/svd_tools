...
/** SDMMC1_SDMMC_RESPCMDR SDMMC command response register **/
#define SDMMC1_SDMMC_RESPCMDR			MMIO32(SDMMC1_BASE + 0x10)
...
/** SDMMC1_SDMMC_VER SDMMC IP version register **/
#define SDMMC1_SDMMC_VER			MMIO32(SDMMC1_BASE + 0x3f4)
/** SDMMC1_SDMMC_ID SDMMC IP identification register **/
#define SDMMC1_SDMMC_ID			MMIO32(SDMMC1_BASE + 0x3f8)
...
/** @defgroup sdmmc1_sdmmc_respcmdr SDMMCRESPCMDR SDMMC command response register
@{*/


#define SDMMC1_SDMMC_RESPCMDR_RESPCMD_SHIFT		0
#define SDMMC1_SDMMC_RESPCMDR_RESPCMD_MASK		0x3f
/** @defgroup sdmmc1_sdmmc_respcmdr_respcmd RESPCMD Response command index
@{*/
/**@}*/
...
/** @defgroup sdmmc1_sdmmc_ver SDMMCVER SDMMC IP version register
@{*/


#define SDMMC1_SDMMC_VER_MAJREV_SHIFT		4
#define SDMMC1_SDMMC_VER_MAJREV_MASK		0x0f
/** @defgroup sdmmc1_sdmmc_ver_majrev MAJREV IP major revision number.
@{*/
/**@}*/


#define SDMMC1_SDMMC_VER_MINREV_SHIFT		0
#define SDMMC1_SDMMC_VER_MINREV_MASK		0x0f
/** @defgroup sdmmc1_sdmmc_ver_minrev MINREV IP minor revision number.
@{*/
/**@}*/
...
/** @defgroup sdmmc1_sdmmc_id SDMMCID SDMMC IP identification register
@{*/


#define SDMMC1_SDMMC_ID_IP_ID_SHIFT		0
#define SDMMC1_SDMMC_ID_IP_ID_MASK		0xffffffff
/** @defgroup sdmmc1_sdmmc_id_ip_id IPID SDMMC IP identification.
@{*/
/**@}*/
