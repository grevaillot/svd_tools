...
/** @defgroup hrtim_master_registers High Resolution Timer: Master
      Timers Register
@{*/
...
/** HRTIM_Master_MDIER4 MDIER4 **/
#define HRTIM_Master_MDIER4			MMIO32(HRTIM_Master_BASE + 0x0c)
...
/** @defgroup hrtim_master_mcr_sync_in SYNCIN ynchronization input
@{*/
/**@}*/
...
/** @defgroup hrtim_master_mdier4 MDIER4 MDIER4
@{*/

/** HRTIM_Master_MDIER4_MUPDDE MUPDDE **/
#define HRTIM_Master_MDIER4_MUPDDE		(1 << 22)
/** HRTIM_Master_MDIER4_SYNCDE SYNCDE **/
#define HRTIM_Master_MDIER4_SYNCDE		(1 << 21)
/** HRTIM_Master_MDIER4_MREPDE MREPDE **/
#define HRTIM_Master_MDIER4_MREPDE		(1 << 20)
/** HRTIM_Master_MDIER4_MCMP4DE MCMP4DE **/
#define HRTIM_Master_MDIER4_MCMP4DE		(1 << 19)
/** HRTIM_Master_MDIER4_MCMP3DE MCMP3DE **/
#define HRTIM_Master_MDIER4_MCMP3DE		(1 << 18)
/** HRTIM_Master_MDIER4_MCMP2DE MCMP2DE **/
#define HRTIM_Master_MDIER4_MCMP2DE		(1 << 17)
/** HRTIM_Master_MDIER4_MCMP1DE MCMP1DE **/
#define HRTIM_Master_MDIER4_MCMP1DE		(1 << 16)
/** HRTIM_Master_MDIER4_MUPDIE MUPDIE **/
#define HRTIM_Master_MDIER4_MUPDIE		(1 << 6)
/** HRTIM_Master_MDIER4_SYNCIE SYNCIE **/
#define HRTIM_Master_MDIER4_SYNCIE		(1 << 5)
/** HRTIM_Master_MDIER4_MREPIE MREPIE **/
#define HRTIM_Master_MDIER4_MREPIE		(1 << 4)
/** HRTIM_Master_MDIER4_MCMP4IE MCMP4IE **/
#define HRTIM_Master_MDIER4_MCMP4IE		(1 << 3)
/** HRTIM_Master_MDIER4_MCMP3IE MCMP3IE **/
#define HRTIM_Master_MDIER4_MCMP3IE		(1 << 2)
/** HRTIM_Master_MDIER4_MCMP2IE MCMP2IE **/
#define HRTIM_Master_MDIER4_MCMP2IE		(1 << 1)
/** HRTIM_Master_MDIER4_MCMP1IE MCMP1IE **/
#define HRTIM_Master_MDIER4_MCMP1IE		(1 << 0)
