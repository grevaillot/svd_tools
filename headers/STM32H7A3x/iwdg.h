...
/** IWDG_IWDG_KR Key register **/
#define IWDG_IWDG_KR			MMIO32(IWDG_BASE + 0x00)
/** IWDG_IWDG_PR Prescaler register **/
#define IWDG_IWDG_PR			MMIO32(IWDG_BASE + 0x04)
/** IWDG_IWDG_RLR Reload register **/
#define IWDG_IWDG_RLR			MMIO32(IWDG_BASE + 0x08)
/** IWDG_IWDG_SR Status register **/
#define IWDG_IWDG_SR			MMIO32(IWDG_BASE + 0x0c)
/** IWDG_IWDG_WINR Window register **/
#define IWDG_IWDG_WINR			MMIO32(IWDG_BASE + 0x10)

/**@}*/


/** @defgroup iwdg_iwdg_kr IWDGKR Key register
@{*/


#define IWDG_IWDG_KR_KEY_SHIFT		0
#define IWDG_IWDG_KR_KEY_MASK		0xffff
...
/** @defgroup iwdg_iwdg_pr IWDGPR Prescaler register
@{*/


#define IWDG_IWDG_PR_PR_SHIFT		0
#define IWDG_IWDG_PR_PR_MASK		0x07
/** @defgroup iwdg_iwdg_pr_pr PR Prescaler divider These bits are write access protected see Section23.3.6: Register access protection. They are written by software to select the prescaler divider feeding the counter clock. PVU bit of IWDG_SR must be reset in order to be able to change the prescaler divider. Note: Reading this register returns the prescaler value from the VDD voltage domain. This value may not be up to date/valid if a write operation to this register is ongoing. For this reason the value read from this register is valid only when the PVU bit in the IWDG_SR register is reset.
@{*/
/**@}*/
