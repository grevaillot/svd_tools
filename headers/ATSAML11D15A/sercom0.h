...
/** @defgroup sercom0_registers Serial Communication Interface Register
@{*/
...
/** SERCOM0_USART_CTRLC USART Control C **/
#define SERCOM0_USART_CTRLC			MMIO32(SERCOM0_BASE + 0x08)
...
/** SERCOM0_USART_RXERRCNT USART Receive Error Count **/
#define SERCOM0_USART_RXERRCNT			MMIO32(SERCOM0_BASE + 0x20)
...
/** SERCOM0_USART_CTRLA_RXINV Receive Data Invert **/
#define SERCOM0_USART_CTRLA_RXINV		(1 << 10)
/** SERCOM0_USART_CTRLA_TXINV Transmit Data Invert **/
#define SERCOM0_USART_CTRLA_TXINV		(1 << 9)
...
#define SERCOM0_USART_CTRLB_LINCMD_SHIFT		24
#define SERCOM0_USART_CTRLB_LINCMD_MASK		0x03
/** @defgroup sercom0_usart_ctrlb_lincmd LINCMD LIN Command
@{*/
/**@}*/
...
/** @defgroup sercom0_usart_ctrlc USARTCTRLC USART Control C
@{*/


#define SERCOM0_USART_CTRLC_MAXITER_SHIFT		20
#define SERCOM0_USART_CTRLC_MAXITER_MASK		0x07
/** @defgroup sercom0_usart_ctrlc_maxiter MAXITER Maximum Iterations
@{*/
/**@}*/

/** SERCOM0_USART_CTRLC_DSNACK Disable Successive NACK **/
#define SERCOM0_USART_CTRLC_DSNACK		(1 << 17)
/** SERCOM0_USART_CTRLC_INACK Inhibit Not Acknowledge **/
#define SERCOM0_USART_CTRLC_INACK		(1 << 16)

#define SERCOM0_USART_CTRLC_HDRDLY_SHIFT		10
#define SERCOM0_USART_CTRLC_HDRDLY_MASK		0x03
/** @defgroup sercom0_usart_ctrlc_hdrdly HDRDLY LIN Master Header Delay
@{*/
/**@}*/


#define SERCOM0_USART_CTRLC_BRKLEN_SHIFT		8
#define SERCOM0_USART_CTRLC_BRKLEN_MASK		0x03
/** @defgroup sercom0_usart_ctrlc_brklen BRKLEN LIN Master Break Length
@{*/
/**@}*/


#define SERCOM0_USART_CTRLC_GTIME_SHIFT		0
#define SERCOM0_USART_CTRLC_GTIME_MASK		0x07
/** @defgroup sercom0_usart_ctrlc_gtime GTIME Guard Time
@{*/
/**@}*/
...
/** SERCOM0_USART_STATUS_ITER Maximum Number of Repetitions Reached **/
#define SERCOM0_USART_STATUS_ITER		(1 << 7)
/** SERCOM0_USART_STATUS_TXE Transmitter Empty **/
#define SERCOM0_USART_STATUS_TXE		(1 << 6)
...
/** SERCOM0_USART_SYNCBUSY_RXERRCNT RXERRCNT Synchronization Busy **/
#define SERCOM0_USART_SYNCBUSY_RXERRCNT		(1 << 3)
...
/** @defgroup sercom0_usart_rxerrcnt USARTRXERRCNT USART Receive Error Count
@{*/
