...
/** ADC1_CR1_OVRIE Overrun interrupt enable **/
#define ADC1_CR1_OVRIE		(1 << 26)

#define ADC1_CR1_RES_SHIFT		24
#define ADC1_CR1_RES_MASK		0x03
/** @defgroup adc1_cr1_res RES Resolution
@{*/
/**@}*/
...
#define ADC1_CR2_EXTEN_SHIFT		28
#define ADC1_CR2_EXTEN_MASK		0x03
/** @defgroup adc1_cr2_exten EXTEN External trigger enable for regular channels
@{*/
/**@}*/


#define ADC1_CR2_EXTSEL_SHIFT		24
#define ADC1_CR2_EXTSEL_MASK		0x0f
...
#define ADC1_CR2_JSWSTART		(1 << 22)

#define ADC1_CR2_JEXTEN_SHIFT		20
#define ADC1_CR2_JEXTEN_MASK		0x03
/** @defgroup adc1_cr2_jexten JEXTEN External trigger enable for injected channels
@{*/
/**@}*/


#define ADC1_CR2_JEXTSEL_SHIFT		16
#define ADC1_CR2_JEXTSEL_MASK		0x0f
...
/** ADC1_CR2_EOCS End of conversion selection **/
#define ADC1_CR2_EOCS		(1 << 10)
/** ADC1_CR2_DDS DMA disable selection (for single ADC mode) **/
#define ADC1_CR2_DDS		(1 << 9)
/** ADC1_CR2_DMA Direct memory access mode (for single ADC mode) **/
...
#define ADC1_SMPR1_SMPx_x_SHIFT		0
#define ADC1_SMPR1_SMPx_x_MASK		0xffffffff
/** @defgroup adc1_smpr1_smpx_x SMPxx Sample time bits
@{*/
/**@}*/
...
#define ADC1_SMPR2_SMPx_x_SHIFT		0
#define ADC1_SMPR2_SMPx_x_MASK		0xffffffff
/** @defgroup adc1_smpr2_smpx_x SMPxx Sample time bits
@{*/
/**@}*/
