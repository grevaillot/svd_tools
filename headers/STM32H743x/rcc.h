...
/** @defgroup rcc_icscr ICSCR RCC Internal Clock Source Calibration Register
@{*/


#define RCC_ICSCR_CSITRIM_SHIFT		26
#define RCC_ICSCR_CSITRIM_MASK		0x1f
/** @defgroup rcc_icscr_csitrim CSITRIM CSI clock trimming
@{*/
/**@}*/


#define RCC_ICSCR_CSICAL_SHIFT		18
#define RCC_ICSCR_CSICAL_MASK		0xff
/** @defgroup rcc_icscr_csical CSICAL CSI clock calibration
@{*/
/**@}*/


#define RCC_ICSCR_HSITRIM_SHIFT		12
#define RCC_ICSCR_HSITRIM_MASK		0x3f
...
#define RCC_ICSCR_HSICAL_MASK		0xfff
...
#define RCC_CRRCR_RC48CAL_SHIFT		0
#define RCC_CRRCR_RC48CAL_MASK		0x3ff
/** @defgroup rcc_crrcr_rc48cal RC48CAL Internal RC 48 MHz clock calibration
@{*/
/**@}*/
...
#define RCC_D3CFGR_D3PPRE_MASK		0x07
/** @defgroup rcc_d3cfgr_d3ppre D3PPRE D3 domain APB4 prescaler
@{*/
/**@}*/
...
/** RCC_AHB3RSTR_CPURST CPU reset **/
#define RCC_AHB3RSTR_CPURST		(1 << 31)
...
/** RCC_APB1LRSTR_CECRST HDMI-CEC block reset **/
#define RCC_APB1LRSTR_CECRST		(1 << 27)
...
/** RCC_D3AMR_BKPRAMAMEN Backup RAM Autonomous mode enable **/
#define RCC_D3AMR_BKPRAMAMEN		(1 << 28)
...
/** RCC_AHB1ENR_USB2ULPIEN USB_PHY2 Clocks Enable **/
#define RCC_AHB1ENR_USB2ULPIEN		(1 << 28)
/** RCC_AHB1ENR_USB2OTGEN USB2OTG Peripheral Clocks Enable **/
#define RCC_AHB1ENR_USB2OTGEN		(1 << 27)
/** RCC_AHB1ENR_USB1ULPIEN USB_PHY1 Clocks Enable **/
#define RCC_AHB1ENR_USB1ULPIEN		(1 << 26)
/** RCC_AHB1ENR_USB1OTGEN USB1OTG Peripheral Clocks Enable **/
#define RCC_AHB1ENR_USB1OTGEN		(1 << 25)
/** RCC_AHB1ENR_USB2OTGHSULPIEN Enable USB_PHY2 clocks **/
#define RCC_AHB1ENR_USB2OTGHSULPIEN		(1 << 18)
...
/** RCC_APB1LENR_CECEN HDMI-CEC peripheral clock enable **/
#define RCC_APB1LENR_CECEN		(1 << 27)
...
/** RCC_AHB3LPENR_FLASHLPEN FLITF Clock Enable During CSleep Mode **/
#define RCC_AHB3LPENR_FLASHLPEN		(1 << 8)
...
/** RCC_AHB1LPENR_USB2OTGHSULPILPEN USB_PHY2 clocks enable during CSleep mode **/
#define RCC_AHB1LPENR_USB2OTGHSULPILPEN		(1 << 28)
/** RCC_AHB1LPENR_USB2OTGHSLPEN USB2OTG peripheral clock enable during CSleep mode **/
...
/** RCC_AHB1LPENR_USB1OTGHSLPEN USB1OTG peripheral clock enable during CSleep mode **/
...
/** RCC_C1_AHB1ENR_USB2ULPIEN USB_PHY2 Clocks Enable **/
#define RCC_C1_AHB1ENR_USB2ULPIEN		(1 << 28)
/** RCC_C1_AHB1ENR_USB2OTGEN USB2OTG Peripheral Clocks Enable **/
#define RCC_C1_AHB1ENR_USB2OTGEN		(1 << 27)
/** RCC_C1_AHB1ENR_USB1ULPIEN USB_PHY1 Clocks Enable **/
#define RCC_C1_AHB1ENR_USB1ULPIEN		(1 << 26)
/** RCC_C1_AHB1ENR_USB1OTGEN USB1OTG Peripheral Clocks Enable **/
#define RCC_C1_AHB1ENR_USB1OTGEN		(1 << 25)
...
/** RCC_C1_AHB1LPENR_USB2ULPILPEN USB_PHY2 clocks enable during CSleep mode **/
#define RCC_C1_AHB1LPENR_USB2ULPILPEN		(1 << 28)
/** RCC_C1_AHB1LPENR_USB2OTGLPEN USB2OTG peripheral clock enable during CSleep mode **/
#define RCC_C1_AHB1LPENR_USB2OTGLPEN		(1 << 27)
/** RCC_C1_AHB1LPENR_USB1ULPILPEN USB_PHY1 clock enable during CSleep mode **/
#define RCC_C1_AHB1LPENR_USB1ULPILPEN		(1 << 26)
/** RCC_C1_AHB1LPENR_USB1OTGLPEN USB1OTG peripheral clock enable during CSleep mode **/
#define RCC_C1_AHB1LPENR_USB1OTGLPEN		(1 << 25)
