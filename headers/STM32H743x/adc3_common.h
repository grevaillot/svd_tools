...
/** ADC3_Common_CDR2 ADC x common regular data register for 32-bit dual mode **/
#define ADC3_Common_CDR2			MMIO32(ADC3_Common_BASE + 0x10)
...
/** @defgroup adc3_common_cdr2 CDR2 ADC x common regular data register for 32-bit dual mode
@{*/


#define ADC3_Common_CDR2_RDATA_ALT_SHIFT		0
#define ADC3_Common_CDR2_RDATA_ALT_MASK		0xffffffff
/** @defgroup adc3_common_cdr2_rdata_alt RDATAALT Regular data of the master/slave alternated ADCs
@{*/
/**@}*/
