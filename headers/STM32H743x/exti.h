...
#define EXTI_CPUIMR1			MMIO32(EXTI_BASE + 0x80)
/** EXTI_CPUEMR1 EXTI event mask register **/
#define EXTI_CPUEMR1			MMIO32(EXTI_BASE + 0x84)
/** EXTI_CPUPR1 EXTI pending register **/
#define EXTI_CPUPR1			MMIO32(EXTI_BASE + 0x88)
/** EXTI_CPUIMR2 EXTI interrupt mask register **/
#define EXTI_CPUIMR2			MMIO32(EXTI_BASE + 0x90)
/** EXTI_CPUEMR2 EXTI event mask register **/
#define EXTI_CPUEMR2			MMIO32(EXTI_BASE + 0x94)
/** EXTI_CPUPR2 EXTI pending register **/
#define EXTI_CPUPR2			MMIO32(EXTI_BASE + 0x98)
/** EXTI_CPUIMR3 EXTI interrupt mask register **/
#define EXTI_CPUIMR3			MMIO32(EXTI_BASE + 0xa0)
/** EXTI_CPUEMR3 EXTI event mask register **/
#define EXTI_CPUEMR3			MMIO32(EXTI_BASE + 0xa4)
/** EXTI_CPUPR3 EXTI pending register **/
#define EXTI_CPUPR3			MMIO32(EXTI_BASE + 0xa8)
...
/** @defgroup exti_cpuimr1 CPUIMR1 EXTI interrupt mask register
@{*/

/** EXTI_CPUIMR1_MR31 Rising trigger event configuration bit of Configurable Event input **/
#define EXTI_CPUIMR1_MR31		(1 << 31)
/** EXTI_CPUIMR1_MR30 Rising trigger event configuration bit of Configurable Event input **/
#define EXTI_CPUIMR1_MR30		(1 << 30)
/** EXTI_CPUIMR1_MR29 Rising trigger event configuration bit of Configurable Event input **/
#define EXTI_CPUIMR1_MR29		(1 << 29)
/** EXTI_CPUIMR1_MR28 Rising trigger event configuration bit of Configurable Event input **/
#define EXTI_CPUIMR1_MR28		(1 << 28)
/** EXTI_CPUIMR1_MR27 Rising trigger event configuration bit of Configurable Event input **/
#define EXTI_CPUIMR1_MR27		(1 << 27)
/** EXTI_CPUIMR1_MR26 Rising trigger event configuration bit of Configurable Event input **/
#define EXTI_CPUIMR1_MR26		(1 << 26)
/** EXTI_CPUIMR1_MR25 Rising trigger event configuration bit of Configurable Event input **/
#define EXTI_CPUIMR1_MR25		(1 << 25)
/** EXTI_CPUIMR1_MR24 Rising trigger event configuration bit of Configurable Event input **/
#define EXTI_CPUIMR1_MR24		(1 << 24)
/** EXTI_CPUIMR1_MR23 Rising trigger event configuration bit of Configurable Event input **/
#define EXTI_CPUIMR1_MR23		(1 << 23)
/** EXTI_CPUIMR1_MR22 Rising trigger event configuration bit of Configurable Event input **/
#define EXTI_CPUIMR1_MR22		(1 << 22)
/** EXTI_CPUIMR1_MR21 Rising trigger event configuration bit of Configurable Event input **/
#define EXTI_CPUIMR1_MR21		(1 << 21)
/** EXTI_CPUIMR1_MR20 Rising trigger event configuration bit of Configurable Event input **/
#define EXTI_CPUIMR1_MR20		(1 << 20)
/** EXTI_CPUIMR1_MR19 Rising trigger event configuration bit of Configurable Event input **/
#define EXTI_CPUIMR1_MR19		(1 << 19)
/** EXTI_CPUIMR1_MR18 Rising trigger event configuration bit of Configurable Event input **/
#define EXTI_CPUIMR1_MR18		(1 << 18)
/** EXTI_CPUIMR1_MR17 Rising trigger event configuration bit of Configurable Event input **/
#define EXTI_CPUIMR1_MR17		(1 << 17)
/** EXTI_CPUIMR1_MR16 Rising trigger event configuration bit of Configurable Event input **/
#define EXTI_CPUIMR1_MR16		(1 << 16)
/** EXTI_CPUIMR1_MR15 Rising trigger event configuration bit of Configurable Event input **/
#define EXTI_CPUIMR1_MR15		(1 << 15)
/** EXTI_CPUIMR1_MR14 Rising trigger event configuration bit of Configurable Event input **/
#define EXTI_CPUIMR1_MR14		(1 << 14)
/** EXTI_CPUIMR1_MR13 Rising trigger event configuration bit of Configurable Event input **/
#define EXTI_CPUIMR1_MR13		(1 << 13)
/** EXTI_CPUIMR1_MR12 Rising trigger event configuration bit of Configurable Event input **/
#define EXTI_CPUIMR1_MR12		(1 << 12)
/** EXTI_CPUIMR1_MR11 Rising trigger event configuration bit of Configurable Event input **/
#define EXTI_CPUIMR1_MR11		(1 << 11)
/** EXTI_CPUIMR1_MR10 Rising trigger event configuration bit of Configurable Event input **/
#define EXTI_CPUIMR1_MR10		(1 << 10)
/** EXTI_CPUIMR1_MR9 Rising trigger event configuration bit of Configurable Event input **/
#define EXTI_CPUIMR1_MR9		(1 << 9)
/** EXTI_CPUIMR1_MR8 Rising trigger event configuration bit of Configurable Event input **/
#define EXTI_CPUIMR1_MR8		(1 << 8)
/** EXTI_CPUIMR1_MR7 Rising trigger event configuration bit of Configurable Event input **/
#define EXTI_CPUIMR1_MR7		(1 << 7)
/** EXTI_CPUIMR1_MR6 Rising trigger event configuration bit of Configurable Event input **/
#define EXTI_CPUIMR1_MR6		(1 << 6)
/** EXTI_CPUIMR1_MR5 Rising trigger event configuration bit of Configurable Event input **/
#define EXTI_CPUIMR1_MR5		(1 << 5)
/** EXTI_CPUIMR1_MR4 Rising trigger event configuration bit of Configurable Event input **/
#define EXTI_CPUIMR1_MR4		(1 << 4)
/** EXTI_CPUIMR1_MR3 Rising trigger event configuration bit of Configurable Event input **/
#define EXTI_CPUIMR1_MR3		(1 << 3)
/** EXTI_CPUIMR1_MR2 Rising trigger event configuration bit of Configurable Event input **/
#define EXTI_CPUIMR1_MR2		(1 << 2)
/** EXTI_CPUIMR1_MR1 Rising trigger event configuration bit of Configurable Event input **/
#define EXTI_CPUIMR1_MR1		(1 << 1)
/** EXTI_CPUIMR1_MR0 Rising trigger event configuration bit of Configurable Event input **/
#define EXTI_CPUIMR1_MR0		(1 << 0)

/**@}*/

/** @defgroup exti_cpuemr1 CPUEMR1 EXTI event mask register
@{*/

/** EXTI_CPUEMR1_MR31 CPU Event mask on Event input x **/
#define EXTI_CPUEMR1_MR31		(1 << 31)
/** EXTI_CPUEMR1_MR30 CPU Event mask on Event input x **/
#define EXTI_CPUEMR1_MR30		(1 << 30)
/** EXTI_CPUEMR1_MR29 CPU Event mask on Event input x **/
#define EXTI_CPUEMR1_MR29		(1 << 29)
/** EXTI_CPUEMR1_MR28 CPU Event mask on Event input x **/
#define EXTI_CPUEMR1_MR28		(1 << 28)
/** EXTI_CPUEMR1_MR27 CPU Event mask on Event input x **/
#define EXTI_CPUEMR1_MR27		(1 << 27)
/** EXTI_CPUEMR1_MR26 CPU Event mask on Event input x **/
#define EXTI_CPUEMR1_MR26		(1 << 26)
/** EXTI_CPUEMR1_MR25 CPU Event mask on Event input x **/
#define EXTI_CPUEMR1_MR25		(1 << 25)
/** EXTI_CPUEMR1_MR24 CPU Event mask on Event input x **/
#define EXTI_CPUEMR1_MR24		(1 << 24)
/** EXTI_CPUEMR1_MR23 CPU Event mask on Event input x **/
#define EXTI_CPUEMR1_MR23		(1 << 23)
/** EXTI_CPUEMR1_MR22 CPU Event mask on Event input x **/
#define EXTI_CPUEMR1_MR22		(1 << 22)
/** EXTI_CPUEMR1_MR21 CPU Event mask on Event input x **/
#define EXTI_CPUEMR1_MR21		(1 << 21)
/** EXTI_CPUEMR1_MR20 CPU Event mask on Event input x **/
#define EXTI_CPUEMR1_MR20		(1 << 20)
/** EXTI_CPUEMR1_MR19 CPU Event mask on Event input x **/
#define EXTI_CPUEMR1_MR19		(1 << 19)
/** EXTI_CPUEMR1_MR18 CPU Event mask on Event input x **/
#define EXTI_CPUEMR1_MR18		(1 << 18)
/** EXTI_CPUEMR1_MR17 CPU Event mask on Event input x **/
#define EXTI_CPUEMR1_MR17		(1 << 17)
/** EXTI_CPUEMR1_MR16 CPU Event mask on Event input x **/
#define EXTI_CPUEMR1_MR16		(1 << 16)
/** EXTI_CPUEMR1_MR15 CPU Event mask on Event input x **/
#define EXTI_CPUEMR1_MR15		(1 << 15)
/** EXTI_CPUEMR1_MR14 CPU Event mask on Event input x **/
#define EXTI_CPUEMR1_MR14		(1 << 14)
/** EXTI_CPUEMR1_MR13 CPU Event mask on Event input x **/
#define EXTI_CPUEMR1_MR13		(1 << 13)
/** EXTI_CPUEMR1_MR12 CPU Event mask on Event input x **/
#define EXTI_CPUEMR1_MR12		(1 << 12)
/** EXTI_CPUEMR1_MR11 CPU Event mask on Event input x **/
#define EXTI_CPUEMR1_MR11		(1 << 11)
/** EXTI_CPUEMR1_MR10 CPU Event mask on Event input x **/
#define EXTI_CPUEMR1_MR10		(1 << 10)
/** EXTI_CPUEMR1_MR9 CPU Event mask on Event input x **/
#define EXTI_CPUEMR1_MR9		(1 << 9)
/** EXTI_CPUEMR1_MR8 CPU Event mask on Event input x **/
#define EXTI_CPUEMR1_MR8		(1 << 8)
/** EXTI_CPUEMR1_MR7 CPU Event mask on Event input x **/
#define EXTI_CPUEMR1_MR7		(1 << 7)
/** EXTI_CPUEMR1_MR6 CPU Event mask on Event input x **/
#define EXTI_CPUEMR1_MR6		(1 << 6)
/** EXTI_CPUEMR1_MR5 CPU Event mask on Event input x **/
#define EXTI_CPUEMR1_MR5		(1 << 5)
/** EXTI_CPUEMR1_MR4 CPU Event mask on Event input x **/
#define EXTI_CPUEMR1_MR4		(1 << 4)
/** EXTI_CPUEMR1_MR3 CPU Event mask on Event input x **/
#define EXTI_CPUEMR1_MR3		(1 << 3)
/** EXTI_CPUEMR1_MR2 CPU Event mask on Event input x **/
#define EXTI_CPUEMR1_MR2		(1 << 2)
/** EXTI_CPUEMR1_MR1 CPU Event mask on Event input x **/
#define EXTI_CPUEMR1_MR1		(1 << 1)
/** EXTI_CPUEMR1_MR0 CPU Event mask on Event input x **/
#define EXTI_CPUEMR1_MR0		(1 << 0)

/**@}*/

/** @defgroup exti_cpupr1 CPUPR1 EXTI pending register
@{*/

/** EXTI_CPUPR1_PR21 CPU Event mask on Event input x **/
#define EXTI_CPUPR1_PR21		(1 << 21)
/** EXTI_CPUPR1_PR20 CPU Event mask on Event input x **/
#define EXTI_CPUPR1_PR20		(1 << 20)
/** EXTI_CPUPR1_PR19 CPU Event mask on Event input x **/
#define EXTI_CPUPR1_PR19		(1 << 19)
/** EXTI_CPUPR1_PR18 CPU Event mask on Event input x **/
#define EXTI_CPUPR1_PR18		(1 << 18)
/** EXTI_CPUPR1_PR17 CPU Event mask on Event input x **/
#define EXTI_CPUPR1_PR17		(1 << 17)
/** EXTI_CPUPR1_PR16 CPU Event mask on Event input x **/
#define EXTI_CPUPR1_PR16		(1 << 16)
/** EXTI_CPUPR1_PR15 CPU Event mask on Event input x **/
#define EXTI_CPUPR1_PR15		(1 << 15)
/** EXTI_CPUPR1_PR14 CPU Event mask on Event input x **/
#define EXTI_CPUPR1_PR14		(1 << 14)
/** EXTI_CPUPR1_PR13 CPU Event mask on Event input x **/
#define EXTI_CPUPR1_PR13		(1 << 13)
/** EXTI_CPUPR1_PR12 CPU Event mask on Event input x **/
#define EXTI_CPUPR1_PR12		(1 << 12)
/** EXTI_CPUPR1_PR11 CPU Event mask on Event input x **/
#define EXTI_CPUPR1_PR11		(1 << 11)
/** EXTI_CPUPR1_PR10 CPU Event mask on Event input x **/
#define EXTI_CPUPR1_PR10		(1 << 10)
/** EXTI_CPUPR1_PR9 CPU Event mask on Event input x **/
#define EXTI_CPUPR1_PR9		(1 << 9)
/** EXTI_CPUPR1_PR8 CPU Event mask on Event input x **/
#define EXTI_CPUPR1_PR8		(1 << 8)
/** EXTI_CPUPR1_PR7 CPU Event mask on Event input x **/
#define EXTI_CPUPR1_PR7		(1 << 7)
/** EXTI_CPUPR1_PR6 CPU Event mask on Event input x **/
#define EXTI_CPUPR1_PR6		(1 << 6)
/** EXTI_CPUPR1_PR5 CPU Event mask on Event input x **/
#define EXTI_CPUPR1_PR5		(1 << 5)
/** EXTI_CPUPR1_PR4 CPU Event mask on Event input x **/
#define EXTI_CPUPR1_PR4		(1 << 4)
/** EXTI_CPUPR1_PR3 CPU Event mask on Event input x **/
#define EXTI_CPUPR1_PR3		(1 << 3)
/** EXTI_CPUPR1_PR2 CPU Event mask on Event input x **/
#define EXTI_CPUPR1_PR2		(1 << 2)
/** EXTI_CPUPR1_PR1 CPU Event mask on Event input x **/
#define EXTI_CPUPR1_PR1		(1 << 1)
/** EXTI_CPUPR1_PR0 CPU Event mask on Event input x **/
#define EXTI_CPUPR1_PR0		(1 << 0)

/**@}*/

/** @defgroup exti_cpuimr2 CPUIMR2 EXTI interrupt mask register
@{*/

/** EXTI_CPUIMR2_MR31 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUIMR2_MR31		(1 << 31)
/** EXTI_CPUIMR2_MR30 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUIMR2_MR30		(1 << 30)
/** EXTI_CPUIMR2_MR29 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUIMR2_MR29		(1 << 29)
/** EXTI_CPUIMR2_MR28 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUIMR2_MR28		(1 << 28)
/** EXTI_CPUIMR2_MR27 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUIMR2_MR27		(1 << 27)
/** EXTI_CPUIMR2_MR26 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUIMR2_MR26		(1 << 26)
/** EXTI_CPUIMR2_MR25 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUIMR2_MR25		(1 << 25)
/** EXTI_CPUIMR2_MR24 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUIMR2_MR24		(1 << 24)
/** EXTI_CPUIMR2_MR23 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUIMR2_MR23		(1 << 23)
/** EXTI_CPUIMR2_MR22 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUIMR2_MR22		(1 << 22)
/** EXTI_CPUIMR2_MR21 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUIMR2_MR21		(1 << 21)
/** EXTI_CPUIMR2_MR20 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUIMR2_MR20		(1 << 20)
/** EXTI_CPUIMR2_MR19 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUIMR2_MR19		(1 << 19)
/** EXTI_CPUIMR2_MR18 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUIMR2_MR18		(1 << 18)
/** EXTI_CPUIMR2_MR17 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUIMR2_MR17		(1 << 17)
/** EXTI_CPUIMR2_MR16 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUIMR2_MR16		(1 << 16)
/** EXTI_CPUIMR2_MR15 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUIMR2_MR15		(1 << 15)
/** EXTI_CPUIMR2_MR14 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUIMR2_MR14		(1 << 14)
/** EXTI_CPUIMR2_MR12 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUIMR2_MR12		(1 << 12)
/** EXTI_CPUIMR2_MR11 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUIMR2_MR11		(1 << 11)
/** EXTI_CPUIMR2_MR10 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUIMR2_MR10		(1 << 10)
/** EXTI_CPUIMR2_MR9 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUIMR2_MR9		(1 << 9)
/** EXTI_CPUIMR2_MR8 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUIMR2_MR8		(1 << 8)
/** EXTI_CPUIMR2_MR7 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUIMR2_MR7		(1 << 7)
/** EXTI_CPUIMR2_MR6 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUIMR2_MR6		(1 << 6)
/** EXTI_CPUIMR2_MR5 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUIMR2_MR5		(1 << 5)
/** EXTI_CPUIMR2_MR4 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUIMR2_MR4		(1 << 4)
/** EXTI_CPUIMR2_MR3 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUIMR2_MR3		(1 << 3)
/** EXTI_CPUIMR2_MR2 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUIMR2_MR2		(1 << 2)
/** EXTI_CPUIMR2_MR1 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUIMR2_MR1		(1 << 1)
/** EXTI_CPUIMR2_MR0 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUIMR2_MR0		(1 << 0)

/**@}*/

/** @defgroup exti_cpuemr2 CPUEMR2 EXTI event mask register
@{*/

/** EXTI_CPUEMR2_MR63 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUEMR2_MR63		(1 << 31)
/** EXTI_CPUEMR2_MR62 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUEMR2_MR62		(1 << 30)
/** EXTI_CPUEMR2_MR61 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUEMR2_MR61		(1 << 29)
/** EXTI_CPUEMR2_MR60 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUEMR2_MR60		(1 << 28)
/** EXTI_CPUEMR2_MR59 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUEMR2_MR59		(1 << 27)
/** EXTI_CPUEMR2_MR58 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUEMR2_MR58		(1 << 26)
/** EXTI_CPUEMR2_MR57 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUEMR2_MR57		(1 << 25)
/** EXTI_CPUEMR2_MR56 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUEMR2_MR56		(1 << 24)
/** EXTI_CPUEMR2_MR55 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUEMR2_MR55		(1 << 23)
/** EXTI_CPUEMR2_MR54 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUEMR2_MR54		(1 << 22)
/** EXTI_CPUEMR2_MR53 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUEMR2_MR53		(1 << 21)
/** EXTI_CPUEMR2_MR52 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUEMR2_MR52		(1 << 20)
/** EXTI_CPUEMR2_MR51 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUEMR2_MR51		(1 << 19)
/** EXTI_CPUEMR2_MR50 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUEMR2_MR50		(1 << 18)
/** EXTI_CPUEMR2_MR49 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUEMR2_MR49		(1 << 17)
/** EXTI_CPUEMR2_MR48 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUEMR2_MR48		(1 << 16)
/** EXTI_CPUEMR2_MR47 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUEMR2_MR47		(1 << 15)
/** EXTI_CPUEMR2_MR46 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUEMR2_MR46		(1 << 14)
/** EXTI_CPUEMR2_MR44 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUEMR2_MR44		(1 << 12)
/** EXTI_CPUEMR2_MR43 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUEMR2_MR43		(1 << 11)
/** EXTI_CPUEMR2_MR42 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUEMR2_MR42		(1 << 10)
/** EXTI_CPUEMR2_MR41 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUEMR2_MR41		(1 << 9)
/** EXTI_CPUEMR2_MR40 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUEMR2_MR40		(1 << 8)
/** EXTI_CPUEMR2_MR39 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUEMR2_MR39		(1 << 7)
/** EXTI_CPUEMR2_MR38 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUEMR2_MR38		(1 << 6)
/** EXTI_CPUEMR2_MR37 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUEMR2_MR37		(1 << 5)
/** EXTI_CPUEMR2_MR36 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUEMR2_MR36		(1 << 4)
/** EXTI_CPUEMR2_MR35 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUEMR2_MR35		(1 << 3)
/** EXTI_CPUEMR2_MR34 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUEMR2_MR34		(1 << 2)
/** EXTI_CPUEMR2_MR33 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUEMR2_MR33		(1 << 1)
/** EXTI_CPUEMR2_MR32 CPU Interrupt Mask on Direct Event input x+32 **/
#define EXTI_CPUEMR2_MR32		(1 << 0)

/**@}*/

/** @defgroup exti_cpupr2 CPUPR2 EXTI pending register
@{*/

/** EXTI_CPUPR2_PR51 Configurable event inputs x+32 Pending bit **/
#define EXTI_CPUPR2_PR51		(1 << 19)
/** EXTI_CPUPR2_PR49 Configurable event inputs x+32 Pending bit **/
#define EXTI_CPUPR2_PR49		(1 << 17)

/**@}*/

/** @defgroup exti_cpuimr3 CPUIMR3 EXTI interrupt mask register
@{*/

/** EXTI_CPUIMR3_MR88 CPU Interrupt Mask on Direct Event input x+64 **/
#define EXTI_CPUIMR3_MR88		(1 << 24)
/** EXTI_CPUIMR3_MR87 CPU Interrupt Mask on Direct Event input x+64 **/
#define EXTI_CPUIMR3_MR87		(1 << 23)
/** EXTI_CPUIMR3_MR86 CPU Interrupt Mask on Direct Event input x+64 **/
#define EXTI_CPUIMR3_MR86		(1 << 22)
/** EXTI_CPUIMR3_MR85 CPU Interrupt Mask on Direct Event input x+64 **/
#define EXTI_CPUIMR3_MR85		(1 << 21)
/** EXTI_CPUIMR3_MR84 CPU Interrupt Mask on Direct Event input x+64 **/
#define EXTI_CPUIMR3_MR84		(1 << 20)
/** EXTI_CPUIMR3_MR82 CPU Interrupt Mask on Direct Event input x+64 **/
#define EXTI_CPUIMR3_MR82		(1 << 18)
/** EXTI_CPUIMR3_MR80 CPU Interrupt Mask on Direct Event input x+64 **/
#define EXTI_CPUIMR3_MR80		(1 << 16)
/** EXTI_CPUIMR3_MR79 CPU Interrupt Mask on Direct Event input x+64 **/
#define EXTI_CPUIMR3_MR79		(1 << 15)
/** EXTI_CPUIMR3_MR78 CPU Interrupt Mask on Direct Event input x+64 **/
#define EXTI_CPUIMR3_MR78		(1 << 14)
/** EXTI_CPUIMR3_MR77 CPU Interrupt Mask on Direct Event input x+64 **/
#define EXTI_CPUIMR3_MR77		(1 << 13)
/** EXTI_CPUIMR3_MR76 CPU Interrupt Mask on Direct Event input x+64 **/
#define EXTI_CPUIMR3_MR76		(1 << 12)
/** EXTI_CPUIMR3_MR75 CPU Interrupt Mask on Direct Event input x+64 **/
#define EXTI_CPUIMR3_MR75		(1 << 11)
/** EXTI_CPUIMR3_MR74 CPU Interrupt Mask on Direct Event input x+64 **/
#define EXTI_CPUIMR3_MR74		(1 << 10)
/** EXTI_CPUIMR3_MR73 CPU Interrupt Mask on Direct Event input x+64 **/
#define EXTI_CPUIMR3_MR73		(1 << 9)
/** EXTI_CPUIMR3_MR72 CPU Interrupt Mask on Direct Event input x+64 **/
#define EXTI_CPUIMR3_MR72		(1 << 8)
/** EXTI_CPUIMR3_MR71 CPU Interrupt Mask on Direct Event input x+64 **/
#define EXTI_CPUIMR3_MR71		(1 << 7)
/** EXTI_CPUIMR3_MR70 CPU Interrupt Mask on Direct Event input x+64 **/
#define EXTI_CPUIMR3_MR70		(1 << 6)
/** EXTI_CPUIMR3_MR69 CPU Interrupt Mask on Direct Event input x+64 **/
#define EXTI_CPUIMR3_MR69		(1 << 5)
/** EXTI_CPUIMR3_MR68 CPU Interrupt Mask on Direct Event input x+64 **/
#define EXTI_CPUIMR3_MR68		(1 << 4)
/** EXTI_CPUIMR3_MR67 CPU Interrupt Mask on Direct Event input x+64 **/
#define EXTI_CPUIMR3_MR67		(1 << 3)
/** EXTI_CPUIMR3_MR66 CPU Interrupt Mask on Direct Event input x+64 **/
#define EXTI_CPUIMR3_MR66		(1 << 2)
/** EXTI_CPUIMR3_MR65 CPU Interrupt Mask on Direct Event input x+64 **/
#define EXTI_CPUIMR3_MR65		(1 << 1)
/** EXTI_CPUIMR3_MR64 CPU Interrupt Mask on Direct Event input x+64 **/
#define EXTI_CPUIMR3_MR64		(1 << 0)

/**@}*/

/** @defgroup exti_cpuemr3 CPUEMR3 EXTI event mask register
@{*/

/** EXTI_CPUEMR3_MR88 CPU Event mask on Event input x+64 **/
#define EXTI_CPUEMR3_MR88		(1 << 24)
/** EXTI_CPUEMR3_MR87 CPU Event mask on Event input x+64 **/
#define EXTI_CPUEMR3_MR87		(1 << 23)
/** EXTI_CPUEMR3_MR86 CPU Event mask on Event input x+64 **/
#define EXTI_CPUEMR3_MR86		(1 << 22)
/** EXTI_CPUEMR3_MR85 CPU Event mask on Event input x+64 **/
#define EXTI_CPUEMR3_MR85		(1 << 21)
/** EXTI_CPUEMR3_MR84 CPU Event mask on Event input x+64 **/
#define EXTI_CPUEMR3_MR84		(1 << 20)
/** EXTI_CPUEMR3_MR82 CPU Event mask on Event input x+64 **/
#define EXTI_CPUEMR3_MR82		(1 << 18)
/** EXTI_CPUEMR3_MR80 CPU Event mask on Event input x+64 **/
#define EXTI_CPUEMR3_MR80		(1 << 16)
/** EXTI_CPUEMR3_MR79 CPU Event mask on Event input x+64 **/
#define EXTI_CPUEMR3_MR79		(1 << 15)
/** EXTI_CPUEMR3_MR78 CPU Event mask on Event input x+64 **/
#define EXTI_CPUEMR3_MR78		(1 << 14)
/** EXTI_CPUEMR3_MR77 CPU Event mask on Event input x+64 **/
#define EXTI_CPUEMR3_MR77		(1 << 13)
/** EXTI_CPUEMR3_MR76 CPU Event mask on Event input x+64 **/
#define EXTI_CPUEMR3_MR76		(1 << 12)
/** EXTI_CPUEMR3_MR75 CPU Event mask on Event input x+64 **/
#define EXTI_CPUEMR3_MR75		(1 << 11)
/** EXTI_CPUEMR3_MR74 CPU Event mask on Event input x+64 **/
#define EXTI_CPUEMR3_MR74		(1 << 10)
/** EXTI_CPUEMR3_MR73 CPU Event mask on Event input x+64 **/
#define EXTI_CPUEMR3_MR73		(1 << 9)
/** EXTI_CPUEMR3_MR72 CPU Event mask on Event input x+64 **/
#define EXTI_CPUEMR3_MR72		(1 << 8)
/** EXTI_CPUEMR3_MR71 CPU Event mask on Event input x+64 **/
#define EXTI_CPUEMR3_MR71		(1 << 7)
/** EXTI_CPUEMR3_MR70 CPU Event mask on Event input x+64 **/
#define EXTI_CPUEMR3_MR70		(1 << 6)
/** EXTI_CPUEMR3_MR69 CPU Event mask on Event input x+64 **/
#define EXTI_CPUEMR3_MR69		(1 << 5)
/** EXTI_CPUEMR3_MR68 CPU Event mask on Event input x+64 **/
#define EXTI_CPUEMR3_MR68		(1 << 4)
/** EXTI_CPUEMR3_MR67 CPU Event mask on Event input x+64 **/
#define EXTI_CPUEMR3_MR67		(1 << 3)
/** EXTI_CPUEMR3_MR66 CPU Event mask on Event input x+64 **/
#define EXTI_CPUEMR3_MR66		(1 << 2)
/** EXTI_CPUEMR3_MR65 CPU Event mask on Event input x+64 **/
#define EXTI_CPUEMR3_MR65		(1 << 1)
/** EXTI_CPUEMR3_MR64 CPU Event mask on Event input x+64 **/
#define EXTI_CPUEMR3_MR64		(1 << 0)

/**@}*/

/** @defgroup exti_cpupr3 CPUPR3 EXTI pending register
@{*/

/** EXTI_CPUPR3_PR86 Configurable event inputs x+64 Pending bit **/
#define EXTI_CPUPR3_PR86		(1 << 22)
/** EXTI_CPUPR3_PR85 Configurable event inputs x+64 Pending bit **/
#define EXTI_CPUPR3_PR85		(1 << 21)
/** EXTI_CPUPR3_PR84 Configurable event inputs x+64 Pending bit **/
#define EXTI_CPUPR3_PR84		(1 << 20)
/** EXTI_CPUPR3_PR82 Configurable event inputs x+64 Pending bit **/
#define EXTI_CPUPR3_PR82		(1 << 18)
