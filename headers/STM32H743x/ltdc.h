...
#define LTDC_AWCR_AAV_MASK		0xfff
...
/** @defgroup ltdc_bccr_bcred BCRED Background Color Red value
@{*/
/**@}*/
...
/** @defgroup ltdc_bccr_bcgreen BCGREEN Background Color Green value
@{*/
/**@}*/
...
/** @defgroup ltdc_bccr_bcblue BCBLUE Background Color Blue value
@{*/
/**@}*/
...
#define LTDC_L2CKCR_CKRED_SHIFT		16
#define LTDC_L2CKCR_CKRED_MASK		0xff
...
#define LTDC_L2CKCR_CKGREEN_MASK		0xff
