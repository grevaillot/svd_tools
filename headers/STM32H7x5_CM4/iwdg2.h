...
/** IWDG2_KR Key register **/
#define IWDG2_KR			MMIO32(IWDG2_BASE + 0x00)
/** IWDG2_PR Prescaler register **/
#define IWDG2_PR			MMIO32(IWDG2_BASE + 0x04)
/** IWDG2_RLR Reload register **/
#define IWDG2_RLR			MMIO32(IWDG2_BASE + 0x08)
/** IWDG2_SR Status register **/
#define IWDG2_SR			MMIO32(IWDG2_BASE + 0x0c)
/** IWDG2_WINR Window register **/
#define IWDG2_WINR			MMIO32(IWDG2_BASE + 0x10)

/**@}*/


/** @defgroup iwdg2_kr KR Key register
@{*/


#define IWDG2_KR_KEY_SHIFT		0
#define IWDG2_KR_KEY_MASK		0xffff
...
/** @defgroup iwdg2_pr PR Prescaler register
@{*/


#define IWDG2_PR_PR_SHIFT		0
#define IWDG2_PR_PR_MASK		0x07
/** @defgroup iwdg2_pr_pr PR Prescaler divider These bits are write access protected see Section23.3.6: Register access protection. They are written by software to select the prescaler divider feeding the counter clock. PVU bit of IWDG_SR must be reset in order to be able to change the prescaler divider. Note: Reading this register returns the prescaler value from the VDD voltage domain. This value may not be up to date/valid if a write operation to this register is ongoing. For this reason the value read from this register is valid only when the PVU bit in the IWDG_SR register is reset.
@{*/
/**@}*/
