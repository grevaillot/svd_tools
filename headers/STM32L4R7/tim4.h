...
/** TIM4_OR TIM2 option register **/
#define TIM4_OR			MMIO32(TIM4_BASE + 0x50)
...
#define TIM4_CNT_CNT_H_MASK		0xffff
/** @defgroup tim4_cnt_cnt_h CNTH High counter value (TIM2 only)
@{*/
/**@}*/
...
/** @defgroup tim4_arr_arr_h ARRH High Auto-reload value (TIM2 only)
@{*/
/**@}*/
...
/** @defgroup tim4_ccr1_ccr1_h CCR1H High Capture/Compare 1 value (TIM2 only)
@{*/
/**@}*/
...
/** @defgroup tim4_ccr2_ccr2_h CCR2H High Capture/Compare 2 value (TIM2 only)
@{*/
/**@}*/
...
/** @defgroup tim4_ccr3_ccr3_h CCR3H High Capture/Compare value (TIM2 only)
@{*/
/**@}*/
...
/** @defgroup tim4_ccr4_ccr4_h CCR4H High Capture/Compare value (TIM2 only)
@{*/
/**@}*/
...
/** @defgroup tim4_or OR TIM2 option register
@{*/


#define TIM4_OR_TI4_RMP_SHIFT		3
#define TIM4_OR_TI4_RMP_MASK		0x03
/** @defgroup tim4_or_ti4_rmp TI4RMP Internal trigger
@{*/
/**@}*/


#define TIM4_OR_ETR_RMP_SHIFT		0
#define TIM4_OR_ETR_RMP_MASK		0x07
/** @defgroup tim4_or_etr_rmp ETRRMP Timer2 ETR remap
@{*/
/**@}*/
