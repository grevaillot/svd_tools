...
/** PWR_PUCRH Power Port H pull-up control register **/
#define PWR_PUCRH			MMIO32(PWR_BASE + 0x58)
/** PWR_PDCRH Power Port H pull-down control register **/
#define PWR_PDCRH			MMIO32(PWR_BASE + 0x5c)
...
/** PWR_CR2_USV VDDUSB USB supply valid **/
#define PWR_CR2_USV		(1 << 10)
/** PWR_CR2_IOSV VDDIO2 Independent I/Os supply valid **/
#define PWR_CR2_IOSV		(1 << 9)
/** PWR_CR2_PVME4 Peripheral voltage monitoring 4 enable: VDDA vs. 2.2V **/
#define PWR_CR2_PVME4		(1 << 7)
/** PWR_CR2_PVME3 Peripheral voltage monitoring 3 enable: VDDA vs. 1.62V **/
#define PWR_CR2_PVME3		(1 << 6)
/** PWR_CR2_PVME2 Peripheral voltage monitoring 2 enable: VDDIO2 vs. 0.9V **/
#define PWR_CR2_PVME2		(1 << 5)
/** PWR_CR2_PVME1 Peripheral voltage monitoring 1 enable: VDDUSB vs. 1.2V **/
...
/** PWR_CR3_EWF Enable internal wakeup line **/
#define PWR_CR3_EWF		(1 << 15)
...
/** PWR_SR1_CSBF Standby flag **/
#define PWR_SR1_CSBF		(1 << 8)
/** PWR_SR1_CWUF5 Wakeup flag 5 **/
#define PWR_SR1_CWUF5		(1 << 4)
/** PWR_SR1_CWUF4 Wakeup flag 4 **/
#define PWR_SR1_CWUF4		(1 << 3)
/** PWR_SR1_CWUF3 Wakeup flag 3 **/
#define PWR_SR1_CWUF3		(1 << 2)
/** PWR_SR1_CWUF2 Wakeup flag 2 **/
#define PWR_SR1_CWUF2		(1 << 1)
/** PWR_SR1_CWUF1 Wakeup flag 1 **/
#define PWR_SR1_CWUF1		(1 << 0)
...
/** PWR_SCR_SBF Clear standby flag **/
#define PWR_SCR_SBF		(1 << 8)
/** PWR_SCR_WUF5 Clear wakeup flag 5 **/
#define PWR_SCR_WUF5		(1 << 4)
/** PWR_SCR_WUF4 Clear wakeup flag 4 **/
#define PWR_SCR_WUF4		(1 << 3)
/** PWR_SCR_WUF3 Clear wakeup flag 3 **/
#define PWR_SCR_WUF3		(1 << 2)
/** PWR_SCR_WUF2 Clear wakeup flag 2 **/
#define PWR_SCR_WUF2		(1 << 1)
/** PWR_SCR_WUF1 Clear wakeup flag 1 **/
#define PWR_SCR_WUF1		(1 << 0)
...
/** PWR_PUCRG_PU15 Port G pull-up bit y (y=0..15) **/
#define PWR_PUCRG_PU15		(1 << 15)
/** PWR_PUCRG_PU14 Port G pull-up bit y (y=0..15) **/
#define PWR_PUCRG_PU14		(1 << 14)
/** PWR_PUCRG_PU13 Port G pull-up bit y (y=0..15) **/
#define PWR_PUCRG_PU13		(1 << 13)
/** PWR_PUCRG_PU12 Port G pull-up bit y (y=0..15) **/
#define PWR_PUCRG_PU12		(1 << 12)
/** PWR_PUCRG_PU11 Port G pull-up bit y (y=0..15) **/
...
/** PWR_PDCRG_PD15 Port G pull-down bit y (y=0..15) **/
#define PWR_PDCRG_PD15		(1 << 15)
/** PWR_PDCRG_PD14 Port G pull-down bit y (y=0..15) **/
#define PWR_PDCRG_PD14		(1 << 14)
/** PWR_PDCRG_PD13 Port G pull-down bit y (y=0..15) **/
#define PWR_PDCRG_PD13		(1 << 13)
/** PWR_PDCRG_PD12 Port G pull-down bit y (y=0..15) **/
#define PWR_PDCRG_PD12		(1 << 12)
/** PWR_PDCRG_PD11 Port G pull-down bit y (y=0..15) **/
...
/** @defgroup pwr_pucrh PUCRH Power Port H pull-up control register
@{*/

/** PWR_PUCRH_PU1 Port H pull-up bit y (y=0..1) **/
#define PWR_PUCRH_PU1		(1 << 1)
/** PWR_PUCRH_PU0 Port H pull-up bit y (y=0..1) **/
#define PWR_PUCRH_PU0		(1 << 0)

/**@}*/

/** @defgroup pwr_pdcrh PDCRH Power Port H pull-down control register
@{*/

/** PWR_PDCRH_PD1 Port H pull-down bit y (y=0..1) **/
#define PWR_PDCRH_PD1		(1 << 1)
/** PWR_PDCRH_PD0 Port H pull-down bit y (y=0..1) **/
