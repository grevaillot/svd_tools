...
/** SDMMC2_CMD_CE_ATACMD CE-ATA command **/
#define SDMMC2_CMD_CE_ATACMD		(1 << 14)
/** SDMMC2_CMD_nIEN not Interrupt Enable **/
#define SDMMC2_CMD_nIEN		(1 << 13)
/** SDMMC2_CMD_ENCMDcompl Enable CMD completion **/
#define SDMMC2_CMD_ENCMDcompl		(1 << 12)
...
/** SDMMC2_STA_CEATAEND CE-ATA command completion signal received for CMD61 **/
#define SDMMC2_STA_CEATAEND		(1 << 23)
...
/** SDMMC2_STA_STBITERR Start bit not detected on all data signals in wide bus mode **/
#define SDMMC2_STA_STBITERR		(1 << 9)
...
/** SDMMC2_ICR_CEATAENDC CEATAEND flag clear bit **/
#define SDMMC2_ICR_CEATAENDC		(1 << 23)
...
/** SDMMC2_ICR_STBITERRC STBITERR flag clear bit **/
#define SDMMC2_ICR_STBITERRC		(1 << 9)
...
/** SDMMC2_MASK_CEATAENDIE CE-ATA command completion signal received interrupt enable **/
#define SDMMC2_MASK_CEATAENDIE		(1 << 23)
...
/** SDMMC2_MASK_STBITERRIE Start bit error interrupt enable **/
#define SDMMC2_MASK_STBITERRIE		(1 << 9)
