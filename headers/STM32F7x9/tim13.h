...
/** TIM13_OR option register **/
#define TIM13_OR			MMIO32(TIM13_BASE + 0x50)
...
/** TIM13_SMCR_SMS3 Slave mode selection **/
#define TIM13_SMCR_SMS3		(1 << 16)
...
/** @defgroup tim13_or OR option register
@{*/


#define TIM13_OR_TI1_RMP_SHIFT		0
#define TIM13_OR_TI1_RMP_MASK		0x03
/** @defgroup tim13_or_ti1_rmp TI1RMP TIM11 Input 1 remapping capability
@{*/
/**@}*/
