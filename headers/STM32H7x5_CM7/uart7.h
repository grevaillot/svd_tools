...
/** UART7_PRESC USART prescaler register **/
#define UART7_PRESC			MMIO32(UART7_BASE + 0x2c)
...
/** UART7_CR1_RXFFIE RXFIFO Full interrupt enable **/
#define UART7_CR1_RXFFIE		(1 << 31)
/** UART7_CR1_TXFEIE TXFIFO empty interrupt enable **/
#define UART7_CR1_TXFEIE		(1 << 30)
/** UART7_CR1_FIFOEN FIFO mode enable **/
#define UART7_CR1_FIFOEN		(1 << 29)
...
/** UART7_CR1_UESM USART enable in Stop mode **/
#define UART7_CR1_UESM		(1 << 1)
...
/** UART7_CR2_DIS_NSS When the DSI_NSS bit is set, the NSS pin input is ignored **/
#define UART7_CR2_DIS_NSS		(1 << 3)
/** UART7_CR2_SLVEN Synchronous Slave mode enable **/
#define UART7_CR2_SLVEN		(1 << 0)
...
#define UART7_CR3_TXFTCFG_SHIFT		29
#define UART7_CR3_TXFTCFG_MASK		0x07
/** @defgroup uart7_cr3_txftcfg TXFTCFG TXFIFO threshold configuration
@{*/
/**@}*/

/** UART7_CR3_RXFTIE RXFIFO threshold interrupt enable **/
#define UART7_CR3_RXFTIE		(1 << 28)

#define UART7_CR3_RXFTCFG_SHIFT		25
#define UART7_CR3_RXFTCFG_MASK		0x07
/** @defgroup uart7_cr3_rxftcfg RXFTCFG Receive FIFO threshold configuration
@{*/
/**@}*/

/** UART7_CR3_TCBGTIE Transmission Complete before guard time, interrupt enable **/
#define UART7_CR3_TCBGTIE		(1 << 24)
/** UART7_CR3_TXFTIE TXFIFO threshold interrupt enable **/
#define UART7_CR3_TXFTIE		(1 << 23)
/** UART7_CR3_WUFIE Wakeup from Stop mode interrupt enable **/
#define UART7_CR3_WUFIE		(1 << 22)

#define UART7_CR3_WUS_SHIFT		20
#define UART7_CR3_WUS_MASK		0x03
/** @defgroup uart7_cr3_wus WUS Wakeup from Stop mode interrupt flag selection
@{*/
/**@}*/
...
#define UART7_BRR_BRR_4_15_SHIFT		4
#define UART7_BRR_BRR_4_15_MASK		0xfff
/** @defgroup uart7_brr_brr_4_15 BRR415 DIV_Mantissa
@{*/
/**@}*/


#define UART7_BRR_BRR_0_3_SHIFT		0
#define UART7_BRR_BRR_0_3_MASK		0x0f
/** @defgroup uart7_brr_brr_0_3 BRR03 DIV_Fraction
@{*/
/**@}*/
...
/** UART7_ISR_TXFT TXFIFO threshold flag **/
#define UART7_ISR_TXFT		(1 << 27)
/** UART7_ISR_RXFT RXFIFO threshold flag **/
#define UART7_ISR_RXFT		(1 << 26)
/** UART7_ISR_TCBGT Transmission complete before guard time flag **/
#define UART7_ISR_TCBGT		(1 << 25)
/** UART7_ISR_RXFF RXFIFO Full **/
#define UART7_ISR_RXFF		(1 << 24)
/** UART7_ISR_TXFE TXFIFO Empty **/
#define UART7_ISR_TXFE		(1 << 23)
/** UART7_ISR_REACK REACK **/
#define UART7_ISR_REACK		(1 << 22)
/** UART7_ISR_TEACK TEACK **/
#define UART7_ISR_TEACK		(1 << 21)
/** UART7_ISR_WUF WUF **/
#define UART7_ISR_WUF		(1 << 20)
/** UART7_ISR_RWU RWU **/
#define UART7_ISR_RWU		(1 << 19)
/** UART7_ISR_SBKF SBKF **/
...
/** UART7_ISR_UDR SPI slave underrun error flag **/
#define UART7_ISR_UDR		(1 << 13)
/** UART7_ISR_EOBF EOBF **/
...
/** UART7_ICR_WUCF Wakeup from Stop mode clear flag **/
#define UART7_ICR_WUCF		(1 << 20)
/** UART7_ICR_CMCF Character match clear flag **/
#define UART7_ICR_CMCF		(1 << 17)
/** UART7_ICR_UDRCF SPI slave underrun clear flag **/
#define UART7_ICR_UDRCF		(1 << 13)
...
/** UART7_ICR_TCBGTC Transmission complete before Guard time clear flag **/
#define UART7_ICR_TCBGTC		(1 << 7)
/** UART7_ICR_TCCF Transmission complete clear flag **/
#define UART7_ICR_TCCF		(1 << 6)
/** UART7_ICR_TXFECF TXFIFO empty clear flag **/
#define UART7_ICR_TXFECF		(1 << 5)
...
/** @defgroup uart7_presc PRESC USART prescaler register
@{*/


#define UART7_PRESC_PRESCALER_SHIFT		0
#define UART7_PRESC_PRESCALER_MASK		0x0f
/** @defgroup uart7_presc_prescaler PRESCALER Clock prescaler
@{*/
/**@}*/
