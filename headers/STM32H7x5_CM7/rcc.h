...
/** RCC_AHB1LPENR_USB2ULPILPEN USB_PHY2 clocks enable during CSleep mode **/
#define RCC_AHB1LPENR_USB2ULPILPEN		(1 << 28)
/** RCC_AHB1LPENR_USB2OTGLPEN USB2OTG peripheral clock enable during CSleep mode **/
#define RCC_AHB1LPENR_USB2OTGLPEN		(1 << 27)
/** RCC_AHB1LPENR_USB1ULPILPEN USB_PHY1 clock enable during CSleep mode **/
#define RCC_AHB1LPENR_USB1ULPILPEN		(1 << 26)
/** RCC_AHB1LPENR_USB1OTGLPEN USB1OTG peripheral clock enable during CSleep mode **/
#define RCC_AHB1LPENR_USB1OTGLPEN		(1 << 25)
