...
/** SMC_SMC_CS_NUMBER[0]_SMC_SETUP SMC Setup Register (CS_number = 0) **/
#define SMC_SMC_CS_NUMBER[0]_SMC_SETUP			MMIO32(SMC_BASE + 0x00)
/** SMC_SMC_CS_NUMBER[0]_SMC_PULSE SMC Pulse Register (CS_number = 0) **/
#define SMC_SMC_CS_NUMBER[0]_SMC_PULSE			MMIO32(SMC_BASE + 0x04)
/** SMC_SMC_CS_NUMBER[0]_SMC_CYCLE SMC Cycle Register (CS_number = 0) **/
#define SMC_SMC_CS_NUMBER[0]_SMC_CYCLE			MMIO32(SMC_BASE + 0x08)
/** SMC_SMC_CS_NUMBER[0]_SMC_MODE SMC Mode Register (CS_number = 0) **/
#define SMC_SMC_CS_NUMBER[0]_SMC_MODE			MMIO32(SMC_BASE + 0x0c)
/** SMC_SMC_CS_NUMBER[1]_SMC_SETUP SMC Setup Register (CS_number = 0) **/
#define SMC_SMC_CS_NUMBER[1]_SMC_SETUP			MMIO32(SMC_BASE + 0x10)
/** SMC_SMC_CS_NUMBER[1]_SMC_PULSE SMC Pulse Register (CS_number = 0) **/
#define SMC_SMC_CS_NUMBER[1]_SMC_PULSE			MMIO32(SMC_BASE + 0x14)
/** SMC_SMC_CS_NUMBER[1]_SMC_CYCLE SMC Cycle Register (CS_number = 0) **/
#define SMC_SMC_CS_NUMBER[1]_SMC_CYCLE			MMIO32(SMC_BASE + 0x18)
/** SMC_SMC_CS_NUMBER[1]_SMC_MODE SMC Mode Register (CS_number = 0) **/
#define SMC_SMC_CS_NUMBER[1]_SMC_MODE			MMIO32(SMC_BASE + 0x1c)
/** SMC_SMC_CS_NUMBER[2]_SMC_SETUP SMC Setup Register (CS_number = 0) **/
#define SMC_SMC_CS_NUMBER[2]_SMC_SETUP			MMIO32(SMC_BASE + 0x20)
/** SMC_SMC_CS_NUMBER[2]_SMC_PULSE SMC Pulse Register (CS_number = 0) **/
#define SMC_SMC_CS_NUMBER[2]_SMC_PULSE			MMIO32(SMC_BASE + 0x24)
/** SMC_SMC_CS_NUMBER[2]_SMC_CYCLE SMC Cycle Register (CS_number = 0) **/
#define SMC_SMC_CS_NUMBER[2]_SMC_CYCLE			MMIO32(SMC_BASE + 0x28)
/** SMC_SMC_CS_NUMBER[2]_SMC_MODE SMC Mode Register (CS_number = 0) **/
#define SMC_SMC_CS_NUMBER[2]_SMC_MODE			MMIO32(SMC_BASE + 0x2c)
/** SMC_SMC_CS_NUMBER[3]_SMC_SETUP SMC Setup Register (CS_number = 0) **/
#define SMC_SMC_CS_NUMBER[3]_SMC_SETUP			MMIO32(SMC_BASE + 0x30)
/** SMC_SMC_CS_NUMBER[3]_SMC_PULSE SMC Pulse Register (CS_number = 0) **/
#define SMC_SMC_CS_NUMBER[3]_SMC_PULSE			MMIO32(SMC_BASE + 0x34)
/** SMC_SMC_CS_NUMBER[3]_SMC_CYCLE SMC Cycle Register (CS_number = 0) **/
#define SMC_SMC_CS_NUMBER[3]_SMC_CYCLE			MMIO32(SMC_BASE + 0x38)
/** SMC_SMC_CS_NUMBER[3]_SMC_MODE SMC Mode Register (CS_number = 0) **/
...
/** SMC_SMC_VERSION SMC Version Register **/
#define SMC_SMC_VERSION			MMIO32(SMC_BASE + 0xfc)

/**@}*/


/** @defgroup smc_smc_cs_number[0]_smc_setup SMCCSNUMBER[0]SMCSETUP SMC Setup Register (CS_number = 0)
@{*/
...
/** @defgroup smc_smc_cs_number[0]_smc_pulse SMCCSNUMBER[0]SMCPULSE SMC Pulse Register (CS_number = 0)
@{*/
...
/** @defgroup smc_smc_cs_number[0]_smc_cycle SMCCSNUMBER[0]SMCCYCLE SMC Cycle Register (CS_number = 0)
@{*/
...
/** @defgroup smc_smc_cs_number[0]_smc_mode SMCCSNUMBER[0]SMCMODE SMC Mode Register (CS_number = 0)
@{*/
...
/** @defgroup smc_smc_cs_number[1]_smc_setup SMCCSNUMBER[1]SMCSETUP SMC Setup Register (CS_number = 0)
@{*/
...
/** @defgroup smc_smc_cs_number[1]_smc_pulse SMCCSNUMBER[1]SMCPULSE SMC Pulse Register (CS_number = 0)
@{*/
...
/** @defgroup smc_smc_cs_number[1]_smc_cycle SMCCSNUMBER[1]SMCCYCLE SMC Cycle Register (CS_number = 0)
@{*/
...
/** @defgroup smc_smc_cs_number[1]_smc_mode SMCCSNUMBER[1]SMCMODE SMC Mode Register (CS_number = 0)
@{*/
...
/** @defgroup smc_smc_cs_number[2]_smc_setup SMCCSNUMBER[2]SMCSETUP SMC Setup Register (CS_number = 0)
@{*/
...
/** @defgroup smc_smc_cs_number[2]_smc_pulse SMCCSNUMBER[2]SMCPULSE SMC Pulse Register (CS_number = 0)
@{*/
...
/** @defgroup smc_smc_cs_number[2]_smc_cycle SMCCSNUMBER[2]SMCCYCLE SMC Cycle Register (CS_number = 0)
@{*/
...
/** @defgroup smc_smc_cs_number[2]_smc_mode SMCCSNUMBER[2]SMCMODE SMC Mode Register (CS_number = 0)
@{*/
...
/** @defgroup smc_smc_cs_number[3]_smc_setup SMCCSNUMBER[3]SMCSETUP SMC Setup Register (CS_number = 0)
@{*/
...
/** @defgroup smc_smc_cs_number[3]_smc_pulse SMCCSNUMBER[3]SMCPULSE SMC Pulse Register (CS_number = 0)
@{*/
...
/** @defgroup smc_smc_cs_number[3]_smc_cycle SMCCSNUMBER[3]SMCCYCLE SMC Cycle Register (CS_number = 0)
@{*/
...
/** @defgroup smc_smc_cs_number[3]_smc_mode SMCCSNUMBER[3]SMCMODE SMC Mode Register (CS_number = 0)
@{*/
...
/** @defgroup smc_smc_version SMCVERSION SMC Version Register
@{*/


#define SMC_SMC_VERSION_MFN_SHIFT		16
#define SMC_SMC_VERSION_MFN_MASK		0x07
/** @defgroup smc_smc_version_mfn MFN Metal Fix Number
@{*/
/**@}*/


#define SMC_SMC_VERSION_VERSION_SHIFT		0
#define SMC_SMC_VERSION_VERSION_MASK		0xfff
/** @defgroup smc_smc_version_version VERSION Hardware Module Version
@{*/
/**@}*/
