...
/** @defgroup tim3_registers General purpose timers Register
@{*/
...
/** TIM3_OR1 TIM3 option register 1 **/
#define TIM3_OR1			MMIO32(TIM3_BASE + 0x50)
/** TIM3_OR2 TIM3 option register 2 **/
#define TIM3_OR2			MMIO32(TIM3_BASE + 0x60)
...
/** TIM3_SMCR_SMS_3 Slave model selection - bit[3] **/
...
#define TIM3_CCMR1_Input_IC2PCS_SHIFT		10
#define TIM3_CCMR1_Input_IC2PCS_MASK		0x03
/** @defgroup tim3_ccmr1_input_ic2pcs IC2PCS Input capture 2 prescaler
@{*/
/**@}*/
...
/** TIM3_CCER_CC4NP Capture/Compare 4 output Polarity **/
...
#define TIM3_CNT_CNT_H_SHIFT		16
#define TIM3_CNT_CNT_H_MASK		0xffff
/** @defgroup tim3_cnt_cnt_h CNTH High counter value
@{*/
/**@}*/


#define TIM3_CNT_CNT_L_SHIFT		0
#define TIM3_CNT_CNT_L_MASK		0xffff
/** @defgroup tim3_cnt_cnt_l CNTL Low counter value
@{*/
/**@}*/
...
#define TIM3_ARR_ARR_H_SHIFT		16
#define TIM3_ARR_ARR_H_MASK		0xffff
/** @defgroup tim3_arr_arr_h ARRH High Auto-reload value
@{*/
/**@}*/


#define TIM3_ARR_ARR_L_SHIFT		0
#define TIM3_ARR_ARR_L_MASK		0xffff
/** @defgroup tim3_arr_arr_l ARRL Low Auto-reload value
@{*/
/**@}*/
...
#define TIM3_CCR1_CCR1_H_SHIFT		16
#define TIM3_CCR1_CCR1_H_MASK		0xffff
/** @defgroup tim3_ccr1_ccr1_h CCR1H High Capture/Compare 1 value
@{*/
/**@}*/


#define TIM3_CCR1_CCR1_L_SHIFT		0
#define TIM3_CCR1_CCR1_L_MASK		0xffff
/** @defgroup tim3_ccr1_ccr1_l CCR1L Low Capture/Compare 1 value
@{*/
/**@}*/
...
#define TIM3_CCR2_CCR2_H_SHIFT		16
#define TIM3_CCR2_CCR2_H_MASK		0xffff
/** @defgroup tim3_ccr2_ccr2_h CCR2H High Capture/Compare 2 value
@{*/
/**@}*/


#define TIM3_CCR2_CCR2_L_SHIFT		0
#define TIM3_CCR2_CCR2_L_MASK		0xffff
/** @defgroup tim3_ccr2_ccr2_l CCR2L Low Capture/Compare 2 value
@{*/
/**@}*/
...
#define TIM3_CCR3_CCR3_H_SHIFT		16
#define TIM3_CCR3_CCR3_H_MASK		0xffff
/** @defgroup tim3_ccr3_ccr3_h CCR3H High Capture/Compare value
@{*/
/**@}*/


#define TIM3_CCR3_CCR3_L_SHIFT		0
#define TIM3_CCR3_CCR3_L_MASK		0xffff
/** @defgroup tim3_ccr3_ccr3_l CCR3L Low Capture/Compare value
@{*/
/**@}*/
...
#define TIM3_CCR4_CCR4_H_SHIFT		16
#define TIM3_CCR4_CCR4_H_MASK		0xffff
/** @defgroup tim3_ccr4_ccr4_h CCR4H High Capture/Compare value
@{*/
/**@}*/


#define TIM3_CCR4_CCR4_L_SHIFT		0
#define TIM3_CCR4_CCR4_L_MASK		0xffff
/** @defgroup tim3_ccr4_ccr4_l CCR4L Low Capture/Compare value
@{*/
/**@}*/
...
/** @defgroup tim3_or1 OR1 TIM3 option register 1
@{*/


#define TIM3_OR1_TI1_RMP_SHIFT		0
#define TIM3_OR1_TI1_RMP_MASK		0x03
/** @defgroup tim3_or1_ti1_rmp TI1RMP Input Capture 1 remap
@{*/
/**@}*/
...
/** @defgroup tim3_or2 OR2 TIM3 option register 2
@{*/


#define TIM3_OR2_ETRSEL_SHIFT		14
#define TIM3_OR2_ETRSEL_MASK		0x07
/** @defgroup tim3_or2_etrsel ETRSEL ETR source selection
@{*/
/**@}*/
