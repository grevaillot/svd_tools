...
/** RCC_PLLSAICFGR PLL configuration register **/
#define RCC_PLLSAICFGR			MMIO32(RCC_BASE + 0x88)
/** RCC_DKCFGR1 dedicated clocks configuration register **/
#define RCC_DKCFGR1			MMIO32(RCC_BASE + 0x8c)
/** RCC_DKCFGR2 dedicated clocks configuration register **/
#define RCC_DKCFGR2			MMIO32(RCC_BASE + 0x90)
...
/** RCC_AHB1RSTR_GPIOKRST IO port K reset **/
#define RCC_AHB1RSTR_GPIOKRST		(1 << 10)
/** RCC_AHB1RSTR_GPIOJRST IO port J reset **/
...
/** RCC_AHB3RSTR_QSPIRST Quad SPI memory controller reset **/
#define RCC_AHB3RSTR_QSPIRST		(1 << 1)
/** RCC_AHB3RSTR_FMCRST Flexible memory controller module reset **/
...
/** RCC_APB1RSTR_I2C4RST I2C 4 reset **/
...
/** RCC_APB1RSTR_SPDIFRXRST SPDIF-RX reset **/
...
/** RCC_APB1RSTR_LPTIM1RST Low power timer 1 reset **/
...
/** RCC_APB2RSTR_LTDCRST LTDC reset **/
#define RCC_APB2RSTR_LTDCRST		(1 << 26)
/** RCC_APB2RSTR_SAI2RST SAI2 reset **/
...
/** RCC_APB2RSTR_SDMMC1RST SDMMC1 reset **/
...
/** RCC_AHB1ENR_CCMDATARAMEN CCM data RAM clock enable **/
...
/** RCC_AHB1ENR_GPIOKEN IO port K clock enable **/
#define RCC_AHB1ENR_GPIOKEN		(1 << 10)
/** RCC_AHB1ENR_GPIOJEN IO port J clock enable **/
...
/** RCC_AHB3ENR_QSPIEN Quad SPI memory controller clock enable **/
#define RCC_AHB3ENR_QSPIEN		(1 << 1)
/** RCC_AHB3ENR_FMCEN Flexible memory controller module clock enable **/
...
/** RCC_APB1ENR_CECEN HDMI-CEN clock enable **/
...
/** RCC_APB1ENR_I2C4EN I2C4 clock enable **/
...
/** RCC_APB1ENR_SPDIFRXEN SPDIF-RX clock enable **/
...
/** RCC_APB1ENR_LPTMI1EN Low power timer 1 clock enable **/
#define RCC_APB1ENR_LPTMI1EN		(1 << 9)
...
/** RCC_APB2ENR_LTDCEN LTDC clock enable **/
...
/** RCC_APB2ENR_SDMMC1EN SDMMC1 clock enable **/
...
/** RCC_AHB1LPENR_DMA2DLPEN DMA2D clock enable during Sleep mode **/
...
/** RCC_AHB1LPENR_GPIOKLPEN IO port K clock enable during Sleep mode **/
#define RCC_AHB1LPENR_GPIOKLPEN		(1 << 10)
/** RCC_AHB1LPENR_GPIOJLPEN IO port J clock enable during Sleep mode **/
...
/** RCC_AHB3LPENR_QSPILPEN Quand SPI memory controller clock enable during Sleep mode **/
#define RCC_AHB3LPENR_QSPILPEN		(1 << 1)
/** RCC_AHB3LPENR_FMCLPEN Flexible memory controller module clock enable during Sleep mode **/
...
/** RCC_APB1LPENR_CECLPEN HDMI-CEN clock enable during Sleep mode **/
...
/** RCC_APB1LPENR_I2C4LPEN I2C4 clock enable during Sleep mode **/
...
/** RCC_APB1LPENR_SPDIFRXLPEN SPDIF-RX clock enable during sleep mode **/
#define RCC_APB1LPENR_SPDIFRXLPEN		(1 << 16)
...
/** RCC_APB1LPENR_LPTIM1LPEN low power timer 1 clock enable during Sleep mode **/
...
/** RCC_APB2LPENR_LTDCLPEN LTDC clock enable during sleep mode **/
#define RCC_APB2LPENR_LTDCLPEN		(1 << 26)
/** RCC_APB2LPENR_SAI2LPEN SAI2 clock enable during sleep mode **/
...
/** RCC_APB2LPENR_SDMMC1LPEN SDMMC1 clock enable during Sleep mode **/
...
/** @defgroup rcc_plli2scfgr_plli2sq PLLI2SQ PLLI2S division factor for SAI1 clock
@{*/
/**@}*/
...
/** @defgroup rcc_pllsaicfgr PLLSAICFGR PLL configuration register
@{*/


#define RCC_PLLSAICFGR_PLLSAIR_SHIFT		28
#define RCC_PLLSAICFGR_PLLSAIR_MASK		0x07
/** @defgroup rcc_pllsaicfgr_pllsair PLLSAIR PLLSAI division factor for LCD clock
@{*/
/**@}*/


#define RCC_PLLSAICFGR_PLLSAIQ_SHIFT		24
#define RCC_PLLSAICFGR_PLLSAIQ_MASK		0x0f
/** @defgroup rcc_pllsaicfgr_pllsaiq PLLSAIQ PLLSAI division factor for SAI clock
@{*/
/**@}*/


#define RCC_PLLSAICFGR_PLLSAIP_SHIFT		16
#define RCC_PLLSAICFGR_PLLSAIP_MASK		0x03
/** @defgroup rcc_pllsaicfgr_pllsaip PLLSAIP PLLSAI division factor for 48MHz clock
@{*/
/**@}*/
...
/** @defgroup rcc_pllsaicfgr_pllsain PLLSAIN PLLSAI division factor for VCO
@{*/
/**@}*/
...
/** @defgroup rcc_dkcfgr1 DKCFGR1 dedicated clocks configuration register
@{*/

/** RCC_DKCFGR1_TIMPRE Timers clocks prescalers selection **/
#define RCC_DKCFGR1_TIMPRE		(1 << 24)

#define RCC_DKCFGR1_SAI2SEL_SHIFT		22
#define RCC_DKCFGR1_SAI2SEL_MASK		0x03
/** @defgroup rcc_dkcfgr1_sai2sel SAI2SEL SAI2 clock source selection
@{*/
/**@}*/


#define RCC_DKCFGR1_SAI1SEL_SHIFT		20
#define RCC_DKCFGR1_SAI1SEL_MASK		0x03
/** @defgroup rcc_dkcfgr1_sai1sel SAI1SEL SAI1 clock source selection
@{*/
/**@}*/


#define RCC_DKCFGR1_PLLSAIDIVR_SHIFT		16
#define RCC_DKCFGR1_PLLSAIDIVR_MASK		0x03
/** @defgroup rcc_dkcfgr1_pllsaidivr PLLSAIDIVR division factor for LCD_CLK
@{*/
/**@}*/


#define RCC_DKCFGR1_PLLSAIDIVQ_SHIFT		8
#define RCC_DKCFGR1_PLLSAIDIVQ_MASK		0x1f
/** @defgroup rcc_dkcfgr1_pllsaidivq PLLSAIDIVQ PLLSAI division factor for SAI1 clock
@{*/
/**@}*/


#define RCC_DKCFGR1_PLLI2SDIV_SHIFT		0
#define RCC_DKCFGR1_PLLI2SDIV_MASK		0x1f
/** @defgroup rcc_dkcfgr1_plli2sdiv PLLI2SDIV PLLI2S division factor for SAI1 clock
@{*/
/**@}*/
...
/** @defgroup rcc_dkcfgr2 DKCFGR2 dedicated clocks configuration register
@{*/

/** RCC_DKCFGR2_SDMMCSEL SDMMC clock source selection **/
#define RCC_DKCFGR2_SDMMCSEL		(1 << 28)
/** RCC_DKCFGR2_CK48MSEL 48MHz clock source selection **/
#define RCC_DKCFGR2_CK48MSEL		(1 << 27)
/** RCC_DKCFGR2_CECSEL HDMI-CEC clock source selection **/
#define RCC_DKCFGR2_CECSEL		(1 << 26)

#define RCC_DKCFGR2_LPTIM1SEL_SHIFT		24
#define RCC_DKCFGR2_LPTIM1SEL_MASK		0x03
/** @defgroup rcc_dkcfgr2_lptim1sel LPTIM1SEL Low power timer 1 clock source selection
@{*/
/**@}*/


#define RCC_DKCFGR2_I2C4SEL_SHIFT		22
#define RCC_DKCFGR2_I2C4SEL_MASK		0x03
/** @defgroup rcc_dkcfgr2_i2c4sel I2C4SEL I2C4 clock source selection
@{*/
/**@}*/


#define RCC_DKCFGR2_I2C3SEL_SHIFT		20
#define RCC_DKCFGR2_I2C3SEL_MASK		0x03
/** @defgroup rcc_dkcfgr2_i2c3sel I2C3SEL I2C3 clock source selection
@{*/
/**@}*/


#define RCC_DKCFGR2_I2C2SEL_SHIFT		18
#define RCC_DKCFGR2_I2C2SEL_MASK		0x03
/** @defgroup rcc_dkcfgr2_i2c2sel I2C2SEL I2C2 clock source selection
@{*/
/**@}*/


#define RCC_DKCFGR2_I2C1SEL_SHIFT		16
#define RCC_DKCFGR2_I2C1SEL_MASK		0x03
/** @defgroup rcc_dkcfgr2_i2c1sel I2C1SEL I2C1 clock source selection
@{*/
/**@}*/


#define RCC_DKCFGR2_UART8SEL_SHIFT		14
#define RCC_DKCFGR2_UART8SEL_MASK		0x03
/** @defgroup rcc_dkcfgr2_uart8sel UART8SEL UART 8 clock source selection
@{*/
/**@}*/


#define RCC_DKCFGR2_UART7SEL_SHIFT		12
#define RCC_DKCFGR2_UART7SEL_MASK		0x03
/** @defgroup rcc_dkcfgr2_uart7sel UART7SEL UART 7 clock source selection
@{*/
/**@}*/


#define RCC_DKCFGR2_USART6SEL_SHIFT		10
#define RCC_DKCFGR2_USART6SEL_MASK		0x03
/** @defgroup rcc_dkcfgr2_usart6sel USART6SEL USART 6 clock source selection
@{*/
/**@}*/


#define RCC_DKCFGR2_UART5SEL_SHIFT		8
#define RCC_DKCFGR2_UART5SEL_MASK		0x03
/** @defgroup rcc_dkcfgr2_uart5sel UART5SEL UART 5 clock source selection
@{*/
/**@}*/


#define RCC_DKCFGR2_UART4SEL_SHIFT		6
#define RCC_DKCFGR2_UART4SEL_MASK		0x03
/** @defgroup rcc_dkcfgr2_uart4sel UART4SEL UART 4 clock source selection
@{*/
/**@}*/


#define RCC_DKCFGR2_USART3SEL_SHIFT		4
#define RCC_DKCFGR2_USART3SEL_MASK		0x03
/** @defgroup rcc_dkcfgr2_usart3sel USART3SEL USART 3 clock source selection
@{*/
/**@}*/


#define RCC_DKCFGR2_USART2SEL_SHIFT		2
#define RCC_DKCFGR2_USART2SEL_MASK		0x03
/** @defgroup rcc_dkcfgr2_usart2sel USART2SEL USART 2 clock source selection
@{*/
/**@}*/


#define RCC_DKCFGR2_USART1SEL_SHIFT		0
#define RCC_DKCFGR2_USART1SEL_MASK		0x03
/** @defgroup rcc_dkcfgr2_usart1sel USART1SEL USART 1 clock source selection
@{*/
/**@}*/
