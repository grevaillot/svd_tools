...
/** SPI3_SR__FRE Frame format error **/
#define SPI3_SR__FRE		(1 << 8)
...
/** SPI3_I2SCFGR_ASTRTEN Asynchronous start enable **/
#define SPI3_I2SCFGR_ASTRTEN		(1 << 12)
