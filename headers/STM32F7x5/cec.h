...
/** @defgroup cec_cfgr_oar OAR Own addresses configuration
@{*/
/**@}*/

/** CEC_CFGR_SFTOP SFT Option Bit **/
#define CEC_CFGR_SFTOP		(1 << 8)
/** CEC_CFGR_BRDNOGEN Avoid Error-Bit Generation in Broadcast **/
