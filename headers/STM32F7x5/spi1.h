...
/** SPI1_CR1_CRCL CRC length **/
#define SPI1_CR1_CRCL		(1 << 11)
...
/** SPI1_SR_FRE Frame format error **/
#define SPI1_SR_FRE		(1 << 8)
...
/** SPI1_I2SCFGR_ASTRTEN Asynchronous start enable **/
#define SPI1_I2SCFGR_ASTRTEN		(1 << 12)
