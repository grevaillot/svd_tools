...
/** TIM2_OR1 TIM2 option register 1 **/
#define TIM2_OR1			MMIO32(TIM2_BASE + 0x50)
/** TIM2_OR2 TIM2 option register 2 **/
#define TIM2_OR2			MMIO32(TIM2_BASE + 0x60)
...
/** TIM2_SMCR_SMS_3 Slave model selection - bit[3] **/
...
/** @defgroup tim2_or1 OR1 TIM2 option register 1
@{*/


#define TIM2_OR1_TI4_RMP_SHIFT		2
#define TIM2_OR1_TI4_RMP_MASK		0x03
/** @defgroup tim2_or1_ti4_rmp TI4RMP Input Capture 4 remap
@{*/
/**@}*/

/** TIM2_OR1_ETR1_RMP External trigger remap **/
#define TIM2_OR1_ETR1_RMP		(1 << 1)
/** TIM2_OR1_ITR1_RMP Internal trigger 1 remap **/
#define TIM2_OR1_ITR1_RMP		(1 << 0)

/**@}*/

/** @defgroup tim2_or2 OR2 TIM2 option register 2
@{*/


#define TIM2_OR2_ETRSEL_SHIFT		14
#define TIM2_OR2_ETRSEL_MASK		0x07
/** @defgroup tim2_or2_etrsel ETRSEL ETR source selection
@{*/
/**@}*/
