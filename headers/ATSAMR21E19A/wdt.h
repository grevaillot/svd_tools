...
/** WDT_CTRL Control **/
#define WDT_CTRL			MMIO32(WDT_BASE + 0x00)
...
/** WDT_STATUS Status **/
#define WDT_STATUS			MMIO32(WDT_BASE + 0x07)
/** WDT_CLEAR Clear **/
#define WDT_CLEAR			MMIO32(WDT_BASE + 0x08)

/**@}*/


/** @defgroup wdt_ctrl CTRL Control
@{*/

/** WDT_CTRL_ALWAYSON Always-On **/
#define WDT_CTRL_ALWAYSON		(1 << 7)
/** WDT_CTRL_WEN Watchdog Timer Window Mode Enable **/
#define WDT_CTRL_WEN		(1 << 2)
/** WDT_CTRL_ENABLE Enable **/
...
/** @defgroup wdt_status STATUS Status
@{*/

/** WDT_STATUS_SYNCBUSY Synchronization Busy **/
