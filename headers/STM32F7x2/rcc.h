...
/** RCC_DCKCFGR1 dedicated clocks configuration register **/
...
/** RCC_CR_PLLSAIRDY PLLSAI clock ready flag **/
#define RCC_CR_PLLSAIRDY		(1 << 29)
/** RCC_CR_PLLSAION PLLSAI enable **/
...
/** RCC_AHB2RSTR_AESRST AES module reset **/
#define RCC_AHB2RSTR_AESRST		(1 << 4)
...
/** RCC_APB2RSTR_USBPHYCRST USB OTG HS PHY controller reset **/
#define RCC_APB2RSTR_USBPHYCRST		(1 << 31)
...
/** RCC_APB2RSTR_SDMMC2RST SDMMC2 reset **/
...
/** RCC_AHB1ENR_DTCMRAMEN CCM data RAM clock enable **/
...
/** RCC_AHB2ENR_AESEN AES module clock enable **/
...
/** RCC_APB1ENR_RTCAPBEN RTCAPB clock enable **/
#define RCC_APB1ENR_RTCAPBEN		(1 << 10)
/** RCC_APB1ENR_LPTIM1EN Low power timer 1 clock enable **/
...
/** RCC_APB2ENR_USBPHYCEN USB OTG HS PHY controller clock enable **/
#define RCC_APB2ENR_USBPHYCEN		(1 << 31)
...
/** RCC_APB2ENR_SDMMC2EN SDMMC2 clock enable **/
...
/** RCC_AHB1LPENR_DTCMLPEN DTCM RAM interface clock enable during Sleep mode **/
...
/** RCC_AHB1LPENR_AXILPEN AXI to AHB bridge clock enable during Sleep mode **/
...
/** RCC_AHB2LPENR_AESLPEN AES module clock enable during Sleep mode **/
#define RCC_AHB2LPENR_AESLPEN		(1 << 4)
...
/** RCC_APB2LPENR_SDMMC2LPEN SDMMC2 clock enable during Sleep mode **/
...
/** @defgroup rcc_dckcfgr1 DCKCFGR1 dedicated clocks configuration register
@{*/

/** RCC_DCKCFGR1_TIMPRE Timers clocks prescalers selection **/
#define RCC_DCKCFGR1_TIMPRE		(1 << 24)

#define RCC_DCKCFGR1_SAI2SEL_SHIFT		22
#define RCC_DCKCFGR1_SAI2SEL_MASK		0x03
/** @defgroup rcc_dckcfgr1_sai2sel SAI2SEL SAI2 clock source selection
@{*/
/**@}*/


#define RCC_DCKCFGR1_SAI1SEL_SHIFT		20
#define RCC_DCKCFGR1_SAI1SEL_MASK		0x03
/** @defgroup rcc_dckcfgr1_sai1sel SAI1SEL SAI1 clock source selection
@{*/
/**@}*/
...
/** @defgroup rcc_dckcfgr1_pllsaidivq PLLSAIDIVQ PLLSAI division factor for SAI1 clock
@{*/
/**@}*/


#define RCC_DCKCFGR1_PLLI2SDIV_SHIFT		0
#define RCC_DCKCFGR1_PLLI2SDIV_MASK		0x1f
/** @defgroup rcc_dckcfgr1_plli2sdiv PLLI2SDIV PLLI2S division factor for SAI1 clock
@{*/
/**@}*/
...
/** RCC_DCKCFGR2_SDMMC1SEL SDMMC1 clock source selection **/
#define RCC_DCKCFGR2_SDMMC1SEL		(1 << 28)
/** RCC_DCKCFGR2_CK48MSEL 48MHz clock source selection **/
#define RCC_DCKCFGR2_CK48MSEL		(1 << 27)

#define RCC_DCKCFGR2_LPTIM1SEL_SHIFT		24
#define RCC_DCKCFGR2_LPTIM1SEL_MASK		0x03
/** @defgroup rcc_dckcfgr2_lptim1sel LPTIM1SEL Low power timer 1 clock source selection
@{*/
/**@}*/


#define RCC_DCKCFGR2_I2C3SEL_SHIFT		20
#define RCC_DCKCFGR2_I2C3SEL_MASK		0x03
/** @defgroup rcc_dckcfgr2_i2c3sel I2C3SEL I2C3 clock source selection
@{*/
/**@}*/


#define RCC_DCKCFGR2_I2C2SEL_SHIFT		18
#define RCC_DCKCFGR2_I2C2SEL_MASK		0x03
/** @defgroup rcc_dckcfgr2_i2c2sel I2C2SEL I2C2 clock source selection
@{*/
/**@}*/


#define RCC_DCKCFGR2_I2C1SEL_SHIFT		16
#define RCC_DCKCFGR2_I2C1SEL_MASK		0x03
/** @defgroup rcc_dckcfgr2_i2c1sel I2C1SEL I2C1 clock source selection
@{*/
/**@}*/


#define RCC_DCKCFGR2_UART8SEL_SHIFT		14
#define RCC_DCKCFGR2_UART8SEL_MASK		0x03
/** @defgroup rcc_dckcfgr2_uart8sel UART8SEL UART 8 clock source selection
@{*/
/**@}*/


#define RCC_DCKCFGR2_UART7SEL_SHIFT		12
#define RCC_DCKCFGR2_UART7SEL_MASK		0x03
/** @defgroup rcc_dckcfgr2_uart7sel UART7SEL UART 7 clock source selection
@{*/
/**@}*/


#define RCC_DCKCFGR2_UART6SEL_SHIFT		10
#define RCC_DCKCFGR2_UART6SEL_MASK		0x03
/** @defgroup rcc_dckcfgr2_uart6sel UART6SEL USART 6 clock source selection
@{*/
/**@}*/


#define RCC_DCKCFGR2_UART5SEL_SHIFT		8
#define RCC_DCKCFGR2_UART5SEL_MASK		0x03
/** @defgroup rcc_dckcfgr2_uart5sel UART5SEL UART 5 clock source selection
@{*/
/**@}*/


#define RCC_DCKCFGR2_UART4SEL_SHIFT		6
#define RCC_DCKCFGR2_UART4SEL_MASK		0x03
/** @defgroup rcc_dckcfgr2_uart4sel UART4SEL UART 4 clock source selection
@{*/
/**@}*/


#define RCC_DCKCFGR2_UART3SEL_SHIFT		4
#define RCC_DCKCFGR2_UART3SEL_MASK		0x03
/** @defgroup rcc_dckcfgr2_uart3sel UART3SEL USART 3 clock source selection
@{*/
/**@}*/


#define RCC_DCKCFGR2_UART2SEL_SHIFT		2
#define RCC_DCKCFGR2_UART2SEL_MASK		0x03
/** @defgroup rcc_dckcfgr2_uart2sel UART2SEL USART 2 clock source selection
@{*/
/**@}*/


#define RCC_DCKCFGR2_UART1SEL_SHIFT		0
#define RCC_DCKCFGR2_UART1SEL_MASK		0x03
/** @defgroup rcc_dckcfgr2_uart1sel UART1SEL USART 1 clock source selection
@{*/
/**@}*/
