...
/** TIM5_SMCR_SMS_3 Slave model selection - bit[3] **/
...
/** @defgroup tim5_or OR option register 1
@{*/


#define TIM5_OR_TI4_RMP_SHIFT		6
#define TIM5_OR_TI4_RMP_MASK		0x03
/** @defgroup tim5_or_ti4_rmp TI4RMP Timer Input 4 remap
@{*/
/**@}*/
