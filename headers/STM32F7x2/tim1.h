...
/** TIM1_CCMR2_Input capture/compare mode register 1 (input mode) **/
...
/** TIM1_SMCR_SMS_3 Slave model selection - bit[3] **/
...
/** @defgroup tim1_smcr_sms SMS Slave mode selection - bit[2:0]
@{*/
/**@}*/
...
/** @defgroup tim1_ccmr2_input CCMR2Input capture/compare mode register 1 (input mode)
@{*/
