...
#define UART4_BRR_BRR_SHIFT		0
#define UART4_BRR_BRR_MASK		0xffff
/** @defgroup uart4_brr_brr BRR USARTDIV
@{*/
/**@}*/
...
/** UART4_ISR_TCBGT Transmission complete before guard time completion **/
...
/** UART4_ICR_TCBGTCF Transmission completed before guard time clear flag **/
