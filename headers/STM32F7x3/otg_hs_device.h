...
/** OTG_HS_DEVICE_OTG_HS_DOEPDMA9 OTG Device channel-x DMA address register **/
#define OTG_HS_DEVICE_OTG_HS_DOEPDMA9			MMIO32(OTG_HS_DEVICE_BASE + 0x434)
/** OTG_HS_DEVICE_OTG_HS_DOEPDMA10 OTG Device channel-x DMA address register **/
#define OTG_HS_DEVICE_OTG_HS_DOEPDMA10			MMIO32(OTG_HS_DEVICE_BASE + 0x454)
/** OTG_HS_DEVICE_OTG_HS_DOEPDMA11 OTG Device channel-x DMA address register **/
#define OTG_HS_DEVICE_OTG_HS_DOEPDMA11			MMIO32(OTG_HS_DEVICE_BASE + 0x474)
/** OTG_HS_DEVICE_OTG_HS_DOEPDMA12 OTG Device channel-x DMA address register **/
#define OTG_HS_DEVICE_OTG_HS_DOEPDMA12			MMIO32(OTG_HS_DEVICE_BASE + 0x494)
/** OTG_HS_DEVICE_OTG_HS_DOEPDMA13 OTG Device channel-x DMA address register **/
#define OTG_HS_DEVICE_OTG_HS_DOEPDMA13			MMIO32(OTG_HS_DEVICE_BASE + 0x4b4)
/** OTG_HS_DEVICE_OTG_HS_DOEPDMA14 OTG Device channel-x DMA address register **/
#define OTG_HS_DEVICE_OTG_HS_DOEPDMA14			MMIO32(OTG_HS_DEVICE_BASE + 0x4d4)
/** OTG_HS_DEVICE_OTG_HS_DOEPDMA15 OTG Device channel-x DMA address register **/
#define OTG_HS_DEVICE_OTG_HS_DOEPDMA15			MMIO32(OTG_HS_DEVICE_BASE + 0x4f4)
...
/** @defgroup otg_hs_device_otg_hs_doepdma9 OTGHSDOEPDMA9 OTG Device channel-x DMA address register
@{*/


/**@}*/

/** @defgroup otg_hs_device_otg_hs_doepdma10 OTGHSDOEPDMA10 OTG Device channel-x DMA address register
@{*/


/**@}*/

/** @defgroup otg_hs_device_otg_hs_doepdma11 OTGHSDOEPDMA11 OTG Device channel-x DMA address register
@{*/


/**@}*/

/** @defgroup otg_hs_device_otg_hs_doepdma12 OTGHSDOEPDMA12 OTG Device channel-x DMA address register
@{*/


/**@}*/

/** @defgroup otg_hs_device_otg_hs_doepdma13 OTGHSDOEPDMA13 OTG Device channel-x DMA address register
@{*/


/**@}*/

/** @defgroup otg_hs_device_otg_hs_doepdma14 OTGHSDOEPDMA14 OTG Device channel-x DMA address register
@{*/


/**@}*/

/** @defgroup otg_hs_device_otg_hs_doepdma15 OTGHSDOEPDMA15 OTG Device channel-x DMA address register
@{*/
