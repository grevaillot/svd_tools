...
/** TIM8_CCMR2_Input capture/compare mode register 1 (input mode) **/
...
/** TIM8_SMCR_SMS_3 Slave model selection - bit[3] **/
...
/** @defgroup tim8_smcr_sms SMS Slave mode selection - bit[2:0]
@{*/
/**@}*/
...
/** @defgroup tim8_ccmr2_input CCMR2Input capture/compare mode register 1 (input mode)
@{*/
