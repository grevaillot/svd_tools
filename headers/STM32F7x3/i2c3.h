...
#define I2C3_CR2_SADD_SHIFT		0
#define I2C3_CR2_SADD_MASK		0x3ff
/** @defgroup i2c3_cr2_sadd SADD Slave address bit (master mode)
@{*/
/**@}*/
...
/** @defgroup i2c3_oar1_oa1 OA1 Interface address
@{*/
/**@}*/
