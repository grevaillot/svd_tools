...
/** SAI2_GCR Global configuration register **/
#define SAI2_GCR			MMIO32(SAI2_BASE + 0x00)
...
/** @defgroup sai2_gcr GCR Global configuration register
@{*/


#define SAI2_GCR_SYNCOUT_SHIFT		4
#define SAI2_GCR_SYNCOUT_MASK		0x03
/** @defgroup sai2_gcr_syncout SYNCOUT Synchronization outputs
@{*/
/**@}*/


#define SAI2_GCR_SYNCIN_SHIFT		0
#define SAI2_GCR_SYNCIN_MASK		0x03
/** @defgroup sai2_gcr_syncin SYNCIN Synchronization inputs
@{*/
/**@}*/
...
#define SAI2_ACR1_MCKDIV_SHIFT		20
#define SAI2_ACR1_MCKDIV_MASK		0x0f
/** @defgroup sai2_acr1_mckdiv MCKDIV Master clock divider
@{*/
/**@}*/
...
/** SAI2_ACR1_SAIXEN Audio block A enable **/
#define SAI2_ACR1_SAIXEN		(1 << 16)
/** SAI2_ACR1_OUTDRIV Output drive **/
#define SAI2_ACR1_OUTDRIV		(1 << 13)
...
/** SAI2_AIM_LFSDETIE Late frame synchronization detection interrupt enable **/
#define SAI2_AIM_LFSDETIE		(1 << 6)
...
/** SAI2_AIM_WCKCFGIE Wrong clock configuration interrupt enable **/
#define SAI2_AIM_WCKCFGIE		(1 << 2)
/** SAI2_AIM_MUTEDETIE Mute detection interrupt enable **/
#define SAI2_AIM_MUTEDETIE		(1 << 1)
...
/** SAI2_ACLRFR_CLFSDET Clear late frame synchronization detection flag **/
#define SAI2_ACLRFR_CLFSDET		(1 << 6)
/** SAI2_ACLRFR_CAFSDET Clear anticipated frame synchronization detection flag. **/
#define SAI2_ACLRFR_CAFSDET		(1 << 5)
/** SAI2_ACLRFR_CCNRDY Clear codec not ready flag **/
#define SAI2_ACLRFR_CCNRDY		(1 << 4)
/** SAI2_ACLRFR_CWCKCFG Clear wrong clock configuration flag **/
#define SAI2_ACLRFR_CWCKCFG		(1 << 2)
/** SAI2_ACLRFR_CMUTEDET Mute detection flag **/
#define SAI2_ACLRFR_CMUTEDET		(1 << 1)
/** SAI2_ACLRFR_COVRUDR Clear overrun / underrun **/
#define SAI2_ACLRFR_COVRUDR		(1 << 0)
...
#define SAI2_BCR1_MCKDIV_SHIFT		20
#define SAI2_BCR1_MCKDIV_MASK		0x0f
/** @defgroup sai2_bcr1_mckdiv MCKDIV Master clock divider
@{*/
/**@}*/
...
/** SAI2_BCR1_SAIXEN Audio block B enable **/
#define SAI2_BCR1_SAIXEN		(1 << 16)
/** SAI2_BCR1_OUTDRIV Output drive **/
#define SAI2_BCR1_OUTDRIV		(1 << 13)
...
/** SAI2_BIM_WCKCFGIE Wrong clock configuration interrupt enable **/
#define SAI2_BIM_WCKCFGIE		(1 << 2)
/** SAI2_BIM_MUTEDETIE Mute detection interrupt enable **/
#define SAI2_BIM_MUTEDETIE		(1 << 1)
...
/** SAI2_BCLRFR_CLFSDET Clear late frame synchronization detection flag **/
#define SAI2_BCLRFR_CLFSDET		(1 << 6)
/** SAI2_BCLRFR_CAFSDET Clear anticipated frame synchronization detection flag **/
#define SAI2_BCLRFR_CAFSDET		(1 << 5)
/** SAI2_BCLRFR_CCNRDY Clear codec not ready flag **/
#define SAI2_BCLRFR_CCNRDY		(1 << 4)
/** SAI2_BCLRFR_CWCKCFG Clear wrong clock configuration flag **/
#define SAI2_BCLRFR_CWCKCFG		(1 << 2)
/** SAI2_BCLRFR_CMUTEDET Mute detection flag **/
#define SAI2_BCLRFR_CMUTEDET		(1 << 1)
/** SAI2_BCLRFR_COVRUDR Clear overrun / underrun **/
#define SAI2_BCLRFR_COVRUDR		(1 << 0)
