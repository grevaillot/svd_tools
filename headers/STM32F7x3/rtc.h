...
/** RTC_TAMPCR tamper configuration register **/
...
/** RTC_CR_ITSE timestamp on internal event enable **/
...
/** RTC_ISR_ITSF Internal tTime-stamp flag **/
#define RTC_ISR_ITSF		(1 << 17)
...
/** @defgroup rtc_tampcr TAMPCR tamper configuration register
@{*/

/** RTC_TAMPCR_TAMP3MF Tamper 3 mask flag **/
#define RTC_TAMPCR_TAMP3MF		(1 << 24)
/** RTC_TAMPCR_TAMP3NOERASE Tamper 3 no erase **/
#define RTC_TAMPCR_TAMP3NOERASE		(1 << 23)
/** RTC_TAMPCR_TAMP3IE Tamper 3 interrupt enable **/
...
/** RTC_TAMPCR_TAMPPUDIS TAMPER pull-up disable **/
#define RTC_TAMPCR_TAMPPUDIS		(1 << 15)

#define RTC_TAMPCR_TAMPPRCH_SHIFT		13
#define RTC_TAMPCR_TAMPPRCH_MASK		0x03
/** @defgroup rtc_tampcr_tampprch TAMPPRCH Tamper precharge duration
@{*/
/**@}*/
...
/** @defgroup rtc_tampcr_tampflt TAMPFLT Tamper filter count
@{*/
/**@}*/
...
/** RTC_TAMPCR_TAMP3TRG Active level for tamper 3 **/
#define RTC_TAMPCR_TAMP3TRG		(1 << 6)
/** RTC_TAMPCR_TAMP3E Tamper 3 detection enable **/
#define RTC_TAMPCR_TAMP3E		(1 << 5)
/** RTC_TAMPCR_TAMP2TRG Active level for tamper 2 **/
#define RTC_TAMPCR_TAMP2TRG		(1 << 4)
/** RTC_TAMPCR_TAMP2E Tamper 2 detection enable **/
#define RTC_TAMPCR_TAMP2E		(1 << 3)
/** RTC_TAMPCR_TAMPIE Tamper interrupt enable **/
#define RTC_TAMPCR_TAMPIE		(1 << 2)
/** RTC_TAMPCR_TAMP1TRG Active level for tamper 1 **/
#define RTC_TAMPCR_TAMP1TRG		(1 << 1)
/** RTC_TAMPCR_TAMP1E Tamper 1 detection enable **/
...
#define RTC_OR_RTC_ALARM_TYPE		(1 << 3)
/** RTC_OR_TSINSEL TIMESTAMP mapping **/
#define RTC_OR_TSINSEL		(1 << 1)
