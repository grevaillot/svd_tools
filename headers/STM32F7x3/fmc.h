...
/** FMC_PCR PC Card/NAND Flash control register **/
#define FMC_PCR			MMIO32(FMC_BASE + 0x80)
/** FMC_SR FIFO status and interrupt register **/
#define FMC_SR			MMIO32(FMC_BASE + 0x84)
/** FMC_PMEM Common memory space timing register **/
#define FMC_PMEM			MMIO32(FMC_BASE + 0x88)
/** FMC_PATT Attribute memory space timing register **/
#define FMC_PATT			MMIO32(FMC_BASE + 0x8c)
/** FMC_ECCR ECC result register **/
...
/** FMC_BCR1_WFDIS Write FIFO Disable **/
...
/** @defgroup fmc_bcr1_cpsize CPSIZE CRAM page size
@{*/
/**@}*/
...
/** @defgroup fmc_bcr2_cpsize CPSIZE CRAM page size
@{*/
/**@}*/
...
/** @defgroup fmc_bcr3_cpsize CPSIZE CRAM page size.
@{*/
/**@}*/
...
/** @defgroup fmc_bcr4_cpsize CPSIZE CRAM page size.
@{*/
/**@}*/
...
/** @defgroup fmc_pcr PCR PC Card/NAND Flash control register
@{*/
...
/** @defgroup fmc_sr SR FIFO status and interrupt register
@{*/
...
/** @defgroup fmc_pmem PMEM Common memory space timing register
@{*/
...
/** @defgroup fmc_patt PATT Attribute memory space timing register
@{*/
...
/** @defgroup fmc_eccr ECCR ECC result register
@{*/
...
/** @defgroup fmc_bwtr1_busturn BUSTURN Bus turnaround phase duration
@{*/
/**@}*/
...
/** @defgroup fmc_bwtr2_busturn BUSTURN Bus turnaround phase duration
@{*/
/**@}*/
...
/** @defgroup fmc_bwtr3_busturn BUSTURN Bus turnaround phase duration
@{*/
/**@}*/
...
/** @defgroup fmc_bwtr4_busturn BUSTURN Bus turnaround phase duration
@{*/
/**@}*/
