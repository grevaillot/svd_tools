...
#define UART5_BRR_BRR_SHIFT		0
#define UART5_BRR_BRR_MASK		0xffff
/** @defgroup uart5_brr_brr BRR USARTDIV
@{*/
/**@}*/
...
/** UART5_ISR_TCBGT Transmission complete before guard time completion **/
...
/** UART5_ICR_TCBGTCF Transmission completed before guard time clear flag **/
