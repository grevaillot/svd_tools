...
/** SAI1_GCR Global configuration register **/
#define SAI1_GCR			MMIO32(SAI1_BASE + 0x00)
...
/** @defgroup sai1_gcr GCR Global configuration register
@{*/


#define SAI1_GCR_SYNCOUT_SHIFT		4
#define SAI1_GCR_SYNCOUT_MASK		0x03
/** @defgroup sai1_gcr_syncout SYNCOUT Synchronization outputs
@{*/
/**@}*/


#define SAI1_GCR_SYNCIN_SHIFT		0
#define SAI1_GCR_SYNCIN_MASK		0x03
/** @defgroup sai1_gcr_syncin SYNCIN Synchronization inputs
@{*/
/**@}*/
...
#define SAI1_ACR1_MCKDIV_SHIFT		20
#define SAI1_ACR1_MCKDIV_MASK		0x0f
/** @defgroup sai1_acr1_mckdiv MCKDIV Master clock divider
@{*/
/**@}*/
...
/** SAI1_ACR1_SAIXEN Audio block A enable **/
#define SAI1_ACR1_SAIXEN		(1 << 16)
/** SAI1_ACR1_OUTDRIV Output drive **/
#define SAI1_ACR1_OUTDRIV		(1 << 13)
...
/** SAI1_AIM_LFSDETIE Late frame synchronization detection interrupt enable **/
#define SAI1_AIM_LFSDETIE		(1 << 6)
...
/** SAI1_AIM_WCKCFGIE Wrong clock configuration interrupt enable **/
#define SAI1_AIM_WCKCFGIE		(1 << 2)
/** SAI1_AIM_MUTEDETIE Mute detection interrupt enable **/
#define SAI1_AIM_MUTEDETIE		(1 << 1)
...
/** SAI1_ACLRFR_CLFSDET Clear late frame synchronization detection flag **/
#define SAI1_ACLRFR_CLFSDET		(1 << 6)
/** SAI1_ACLRFR_CAFSDET Clear anticipated frame synchronization detection flag. **/
#define SAI1_ACLRFR_CAFSDET		(1 << 5)
/** SAI1_ACLRFR_CCNRDY Clear codec not ready flag **/
#define SAI1_ACLRFR_CCNRDY		(1 << 4)
/** SAI1_ACLRFR_CWCKCFG Clear wrong clock configuration flag **/
#define SAI1_ACLRFR_CWCKCFG		(1 << 2)
/** SAI1_ACLRFR_CMUTEDET Mute detection flag **/
#define SAI1_ACLRFR_CMUTEDET		(1 << 1)
/** SAI1_ACLRFR_COVRUDR Clear overrun / underrun **/
#define SAI1_ACLRFR_COVRUDR		(1 << 0)
...
#define SAI1_BCR1_MCKDIV_SHIFT		20
#define SAI1_BCR1_MCKDIV_MASK		0x0f
/** @defgroup sai1_bcr1_mckdiv MCKDIV Master clock divider
@{*/
/**@}*/
...
/** SAI1_BCR1_SAIXEN Audio block B enable **/
#define SAI1_BCR1_SAIXEN		(1 << 16)
/** SAI1_BCR1_OUTDRIV Output drive **/
#define SAI1_BCR1_OUTDRIV		(1 << 13)
...
/** SAI1_BIM_WCKCFGIE Wrong clock configuration interrupt enable **/
#define SAI1_BIM_WCKCFGIE		(1 << 2)
/** SAI1_BIM_MUTEDETIE Mute detection interrupt enable **/
#define SAI1_BIM_MUTEDETIE		(1 << 1)
...
/** SAI1_BCLRFR_CLFSDET Clear late frame synchronization detection flag **/
#define SAI1_BCLRFR_CLFSDET		(1 << 6)
/** SAI1_BCLRFR_CAFSDET Clear anticipated frame synchronization detection flag **/
#define SAI1_BCLRFR_CAFSDET		(1 << 5)
/** SAI1_BCLRFR_CCNRDY Clear codec not ready flag **/
#define SAI1_BCLRFR_CCNRDY		(1 << 4)
/** SAI1_BCLRFR_CWCKCFG Clear wrong clock configuration flag **/
#define SAI1_BCLRFR_CWCKCFG		(1 << 2)
/** SAI1_BCLRFR_CMUTEDET Mute detection flag **/
#define SAI1_BCLRFR_CMUTEDET		(1 << 1)
/** SAI1_BCLRFR_COVRUDR Clear overrun / underrun **/
#define SAI1_BCLRFR_COVRUDR		(1 << 0)
