...
/** SPI4_CR1_CRCL CRC length **/
#define SPI4_CR1_CRCL		(1 << 11)
...
/** SPI4_SR_FRE frame format error **/
#define SPI4_SR_FRE		(1 << 8)
...
/** SPI4_I2SCFGR_ASTRTEN Asynchronous start enable **/
#define SPI4_I2SCFGR_ASTRTEN		(1 << 12)
