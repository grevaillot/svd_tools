...
/** @defgroup tim5_cnt_cnt_h CNTH High counter value (TIM2 only)
@{*/
/**@}*/
...
/** @defgroup tim5_arr_arr_h ARRH High Auto-reload value (TIM2 only)
@{*/
/**@}*/
...
/** @defgroup tim5_ccr1_ccr1_h CCR1H High Capture/Compare 1 value (TIM2 only)
@{*/
/**@}*/
...
/** @defgroup tim5_ccr2_ccr2_h CCR2H High Capture/Compare 2 value (TIM2 only)
@{*/
/**@}*/
...
/** @defgroup tim5_ccr3_ccr3_h CCR3H High Capture/Compare value (TIM2 only)
@{*/
/**@}*/
...
/** @defgroup tim5_ccr4_ccr4_h CCR4H High Capture/Compare value (TIM2 only)
@{*/
/**@}*/
...
/** @defgroup tim5_or OR TIM2 option register
@{*/


#define TIM5_OR_TI4_RMP_SHIFT		3
#define TIM5_OR_TI4_RMP_MASK		0x03
/** @defgroup tim5_or_ti4_rmp TI4RMP Internal trigger
@{*/
/**@}*/


#define TIM5_OR_ETR_RMP_SHIFT		0
#define TIM5_OR_ETR_RMP_MASK		0x07
/** @defgroup tim5_or_etr_rmp ETRRMP Timer2 ETR remap
@{*/
/**@}*/
