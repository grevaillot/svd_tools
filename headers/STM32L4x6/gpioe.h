...
/** GPIOE_ASCR GPIO port analog switch control register **/
#define GPIOE_ASCR			MMIO32(GPIOE_BASE + 0x2c)
...
#define GPIOE_OSPEEDR_OSPEEDR15_SHIFT		30
#define GPIOE_OSPEEDR_OSPEEDR15_MASK		0x03
/** @defgroup gpioe_ospeedr_ospeedr15 OSPEEDR15 Port x configuration bits (y = 0..15)
@{*/
/**@}*/


#define GPIOE_OSPEEDR_OSPEEDR14_SHIFT		28
#define GPIOE_OSPEEDR_OSPEEDR14_MASK		0x03
/** @defgroup gpioe_ospeedr_ospeedr14 OSPEEDR14 Port x configuration bits (y = 0..15)
@{*/
/**@}*/


#define GPIOE_OSPEEDR_OSPEEDR13_SHIFT		26
#define GPIOE_OSPEEDR_OSPEEDR13_MASK		0x03
/** @defgroup gpioe_ospeedr_ospeedr13 OSPEEDR13 Port x configuration bits (y = 0..15)
@{*/
/**@}*/


#define GPIOE_OSPEEDR_OSPEEDR12_SHIFT		24
#define GPIOE_OSPEEDR_OSPEEDR12_MASK		0x03
/** @defgroup gpioe_ospeedr_ospeedr12 OSPEEDR12 Port x configuration bits (y = 0..15)
@{*/
/**@}*/


#define GPIOE_OSPEEDR_OSPEEDR11_SHIFT		22
#define GPIOE_OSPEEDR_OSPEEDR11_MASK		0x03
/** @defgroup gpioe_ospeedr_ospeedr11 OSPEEDR11 Port x configuration bits (y = 0..15)
@{*/
/**@}*/


#define GPIOE_OSPEEDR_OSPEEDR10_SHIFT		20
#define GPIOE_OSPEEDR_OSPEEDR10_MASK		0x03
/** @defgroup gpioe_ospeedr_ospeedr10 OSPEEDR10 Port x configuration bits (y = 0..15)
@{*/
/**@}*/


#define GPIOE_OSPEEDR_OSPEEDR9_SHIFT		18
#define GPIOE_OSPEEDR_OSPEEDR9_MASK		0x03
/** @defgroup gpioe_ospeedr_ospeedr9 OSPEEDR9 Port x configuration bits (y = 0..15)
@{*/
/**@}*/


#define GPIOE_OSPEEDR_OSPEEDR8_SHIFT		16
#define GPIOE_OSPEEDR_OSPEEDR8_MASK		0x03
/** @defgroup gpioe_ospeedr_ospeedr8 OSPEEDR8 Port x configuration bits (y = 0..15)
@{*/
/**@}*/


#define GPIOE_OSPEEDR_OSPEEDR7_SHIFT		14
#define GPIOE_OSPEEDR_OSPEEDR7_MASK		0x03
/** @defgroup gpioe_ospeedr_ospeedr7 OSPEEDR7 Port x configuration bits (y = 0..15)
@{*/
/**@}*/


#define GPIOE_OSPEEDR_OSPEEDR6_SHIFT		12
#define GPIOE_OSPEEDR_OSPEEDR6_MASK		0x03
/** @defgroup gpioe_ospeedr_ospeedr6 OSPEEDR6 Port x configuration bits (y = 0..15)
@{*/
/**@}*/


#define GPIOE_OSPEEDR_OSPEEDR5_SHIFT		10
#define GPIOE_OSPEEDR_OSPEEDR5_MASK		0x03
/** @defgroup gpioe_ospeedr_ospeedr5 OSPEEDR5 Port x configuration bits (y = 0..15)
@{*/
/**@}*/


#define GPIOE_OSPEEDR_OSPEEDR4_SHIFT		8
#define GPIOE_OSPEEDR_OSPEEDR4_MASK		0x03
/** @defgroup gpioe_ospeedr_ospeedr4 OSPEEDR4 Port x configuration bits (y = 0..15)
@{*/
/**@}*/


#define GPIOE_OSPEEDR_OSPEEDR3_SHIFT		6
#define GPIOE_OSPEEDR_OSPEEDR3_MASK		0x03
/** @defgroup gpioe_ospeedr_ospeedr3 OSPEEDR3 Port x configuration bits (y = 0..15)
@{*/
/**@}*/


#define GPIOE_OSPEEDR_OSPEEDR2_SHIFT		4
#define GPIOE_OSPEEDR_OSPEEDR2_MASK		0x03
/** @defgroup gpioe_ospeedr_ospeedr2 OSPEEDR2 Port x configuration bits (y = 0..15)
@{*/
/**@}*/


#define GPIOE_OSPEEDR_OSPEEDR1_SHIFT		2
#define GPIOE_OSPEEDR_OSPEEDR1_MASK		0x03
/** @defgroup gpioe_ospeedr_ospeedr1 OSPEEDR1 Port x configuration bits (y = 0..15)
@{*/
/**@}*/


#define GPIOE_OSPEEDR_OSPEEDR0_SHIFT		0
#define GPIOE_OSPEEDR_OSPEEDR0_MASK		0x03
/** @defgroup gpioe_ospeedr_ospeedr0 OSPEEDR0 Port x configuration bits (y = 0..15)
@{*/
/**@}*/
...
/** GPIOE_BRR_BR15 Port Reset bit **/
#define GPIOE_BRR_BR15		(1 << 15)
/** GPIOE_BRR_BR14 Port Reset bit **/
#define GPIOE_BRR_BR14		(1 << 14)
/** GPIOE_BRR_BR13 Port Reset bit **/
#define GPIOE_BRR_BR13		(1 << 13)
/** GPIOE_BRR_BR12 Port Reset bit **/
#define GPIOE_BRR_BR12		(1 << 12)
/** GPIOE_BRR_BR11 Port Reset bit **/
#define GPIOE_BRR_BR11		(1 << 11)
/** GPIOE_BRR_BR10 Port Reset bit **/
#define GPIOE_BRR_BR10		(1 << 10)
/** GPIOE_BRR_BR9 Port Reset bit **/
#define GPIOE_BRR_BR9		(1 << 9)
/** GPIOE_BRR_BR8 Port Reset bit **/
#define GPIOE_BRR_BR8		(1 << 8)
/** GPIOE_BRR_BR7 Port Reset bit **/
#define GPIOE_BRR_BR7		(1 << 7)
/** GPIOE_BRR_BR6 Port Reset bit **/
#define GPIOE_BRR_BR6		(1 << 6)
/** GPIOE_BRR_BR5 Port Reset bit **/
#define GPIOE_BRR_BR5		(1 << 5)
/** GPIOE_BRR_BR4 Port Reset bit **/
#define GPIOE_BRR_BR4		(1 << 4)
/** GPIOE_BRR_BR3 Port Reset bit **/
#define GPIOE_BRR_BR3		(1 << 3)
/** GPIOE_BRR_BR2 Port Reset bit **/
#define GPIOE_BRR_BR2		(1 << 2)
/** GPIOE_BRR_BR1 Port Reset bit **/
#define GPIOE_BRR_BR1		(1 << 1)
/** GPIOE_BRR_BR0 Port Reset bit **/
#define GPIOE_BRR_BR0		(1 << 0)

/**@}*/

/** @defgroup gpioe_ascr ASCR GPIO port analog switch control register
@{*/

/** GPIOE_ASCR_ASC15 Port analog switch control **/
#define GPIOE_ASCR_ASC15		(1 << 15)
/** GPIOE_ASCR_ASC14 Port analog switch control **/
#define GPIOE_ASCR_ASC14		(1 << 14)
/** GPIOE_ASCR_ASC13 Port analog switch control **/
#define GPIOE_ASCR_ASC13		(1 << 13)
/** GPIOE_ASCR_ASC12 Port analog switch control **/
#define GPIOE_ASCR_ASC12		(1 << 12)
/** GPIOE_ASCR_ASC11 Port analog switch control **/
#define GPIOE_ASCR_ASC11		(1 << 11)
/** GPIOE_ASCR_ASC10 Port analog switch control **/
#define GPIOE_ASCR_ASC10		(1 << 10)
/** GPIOE_ASCR_ASC9 Port analog switch control **/
#define GPIOE_ASCR_ASC9		(1 << 9)
/** GPIOE_ASCR_ASC8 Port analog switch control **/
#define GPIOE_ASCR_ASC8		(1 << 8)
/** GPIOE_ASCR_ASC7 Port analog switch control **/
#define GPIOE_ASCR_ASC7		(1 << 7)
/** GPIOE_ASCR_ASC6 Port analog switch control **/
#define GPIOE_ASCR_ASC6		(1 << 6)
/** GPIOE_ASCR_ASC5 Port analog switch control **/
#define GPIOE_ASCR_ASC5		(1 << 5)
/** GPIOE_ASCR_ASC4 Port analog switch control **/
#define GPIOE_ASCR_ASC4		(1 << 4)
/** GPIOE_ASCR_ASC3 Port analog switch control **/
#define GPIOE_ASCR_ASC3		(1 << 3)
/** GPIOE_ASCR_ASC2 Port analog switch control **/
#define GPIOE_ASCR_ASC2		(1 << 2)
/** GPIOE_ASCR_ASC1 Port analog switch control **/
#define GPIOE_ASCR_ASC1		(1 << 1)
/** GPIOE_ASCR_ASC0 Port analog switch control **/
#define GPIOE_ASCR_ASC0		(1 << 0)
