...
/** SWPMI1_OR SWPMI Option register **/
#define SWPMI1_OR			MMIO32(SWPMI1_BASE + 0x24)
...
/** SWPMI1_CR_SWPACT Single wire protocol master interface activate **/
#define SWPMI1_CR_SWPACT		(1 << 5)
...
/** @defgroup swpmi1_or OR SWPMI Option register
@{*/

/** SWPMI1_OR_SWP_CLASS SWP class selection **/
#define SWPMI1_OR_SWP_CLASS		(1 << 1)
/** SWPMI1_OR_SWP_TBYP SWP transceiver bypass **/
#define SWPMI1_OR_SWP_TBYP		(1 << 0)
