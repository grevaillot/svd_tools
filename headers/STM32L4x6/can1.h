...
#define CAN1_FMR_CANSB_SHIFT		8
#define CAN1_FMR_CANSB_MASK		0x3f
/** @defgroup can1_fmr_cansb CANSB CAN start bank
@{*/
/**@}*/

/** CAN1_FMR_FINIT Filter initialization mode **/
...
/** CAN1_FFA1R_FFA27 Filter FIFO assignment for filter **/
#define CAN1_FFA1R_FFA27		(1 << 27)
/** CAN1_FFA1R_FFA26 Filter FIFO assignment for filter **/
#define CAN1_FFA1R_FFA26		(1 << 26)
/** CAN1_FFA1R_FFA25 Filter FIFO assignment for filter **/
#define CAN1_FFA1R_FFA25		(1 << 25)
/** CAN1_FFA1R_FFA24 Filter FIFO assignment for filter **/
#define CAN1_FFA1R_FFA24		(1 << 24)
/** CAN1_FFA1R_FFA23 Filter FIFO assignment for filter **/
#define CAN1_FFA1R_FFA23		(1 << 23)
/** CAN1_FFA1R_FFA22 Filter FIFO assignment for filter **/
#define CAN1_FFA1R_FFA22		(1 << 22)
/** CAN1_FFA1R_FFA21 Filter FIFO assignment for filter **/
#define CAN1_FFA1R_FFA21		(1 << 21)
/** CAN1_FFA1R_FFA20 Filter FIFO assignment for filter **/
#define CAN1_FFA1R_FFA20		(1 << 20)
/** CAN1_FFA1R_FFA19 Filter FIFO assignment for filter **/
#define CAN1_FFA1R_FFA19		(1 << 19)
/** CAN1_FFA1R_FFA18 Filter FIFO assignment for filter **/
#define CAN1_FFA1R_FFA18		(1 << 18)
/** CAN1_FFA1R_FFA17 Filter FIFO assignment for filter **/
#define CAN1_FFA1R_FFA17		(1 << 17)
/** CAN1_FFA1R_FFA16 Filter FIFO assignment for filter **/
#define CAN1_FFA1R_FFA16		(1 << 16)
/** CAN1_FFA1R_FFA15 Filter FIFO assignment for filter **/
#define CAN1_FFA1R_FFA15		(1 << 15)
/** CAN1_FFA1R_FFA14 Filter FIFO assignment for filter **/
