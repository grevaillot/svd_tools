...
/** TIM11_SMCR slave mode control register **/
#define TIM11_SMCR			MMIO32(TIM11_BASE + 0x08)
...
/** TIM11_CCMR1_Output capture/compare mode register 1 (output mode) **/
#define TIM11_CCMR1_Output			MMIO32(TIM11_BASE + 0x18)
/** TIM11_CCMR1_Input capture/compare mode register 1 (input mode) **/
...
/** @defgroup tim11_smcr SMCR slave mode control register
@{*/

/** TIM11_SMCR_SMS3 Slave mode selection **/
#define TIM11_SMCR_SMS3		(1 << 16)
/** TIM11_SMCR_ETP External trigger polarity **/
#define TIM11_SMCR_ETP		(1 << 15)
/** TIM11_SMCR_ECE External clock enable **/
#define TIM11_SMCR_ECE		(1 << 14)

#define TIM11_SMCR_ETPS_SHIFT		12
#define TIM11_SMCR_ETPS_MASK		0x03
/** @defgroup tim11_smcr_etps ETPS External trigger prescaler
@{*/
/**@}*/


#define TIM11_SMCR_ETF_SHIFT		8
#define TIM11_SMCR_ETF_MASK		0x0f
/** @defgroup tim11_smcr_etf ETF External trigger filter
@{*/
/**@}*/

/** TIM11_SMCR_MSM Master/slave mode **/
#define TIM11_SMCR_MSM		(1 << 7)

#define TIM11_SMCR_TS_SHIFT		4
#define TIM11_SMCR_TS_MASK		0x07
/** @defgroup tim11_smcr_ts TS Trigger selection
@{*/
/**@}*/


#define TIM11_SMCR_SMS_SHIFT		0
#define TIM11_SMCR_SMS_MASK		0x07
/** @defgroup tim11_smcr_sms SMS Slave mode selection
@{*/
/**@}*/
...
/** @defgroup tim11_ccmr1_output CCMR1Output capture/compare mode register 1 (output mode)
@{*/
...
/** @defgroup tim11_ccmr1_input CCMR1Input capture/compare mode register 1 (input mode)
@{*/
...
#define TIM11_CCMR1_Input_ICPCS_SHIFT		2
#define TIM11_CCMR1_Input_ICPCS_MASK		0x03
/** @defgroup tim11_ccmr1_input_icpcs ICPCS Input capture 1 prescaler
@{*/
/**@}*/
...
#define TIM11_OR_TI1_RMP_SHIFT		0
#define TIM11_OR_TI1_RMP_MASK		0x03
/** @defgroup tim11_or_ti1_rmp TI1RMP TIM11 Input 1 remapping capability
@{*/
/**@}*/
