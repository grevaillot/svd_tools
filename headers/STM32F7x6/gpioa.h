...
/** GPIOA_GPIOB_OSPEEDR GPIO port output speed register **/
#define GPIOA_GPIOB_OSPEEDR			MMIO32(GPIOA_BASE + 0x08)
...
/** @defgroup gpioa_gpiob_ospeedr GPIOBOSPEEDR GPIO port output speed register
@{*/


#define GPIOA_GPIOB_OSPEEDR_OSPEEDR15_SHIFT		30
#define GPIOA_GPIOB_OSPEEDR_OSPEEDR15_MASK		0x03
/** @defgroup gpioa_gpiob_ospeedr_ospeedr15 OSPEEDR15 Port x configuration bits (y = 0..15)
@{*/
/**@}*/


#define GPIOA_GPIOB_OSPEEDR_OSPEEDR14_SHIFT		28
#define GPIOA_GPIOB_OSPEEDR_OSPEEDR14_MASK		0x03
/** @defgroup gpioa_gpiob_ospeedr_ospeedr14 OSPEEDR14 Port x configuration bits (y = 0..15)
@{*/
/**@}*/


#define GPIOA_GPIOB_OSPEEDR_OSPEEDR13_SHIFT		26
#define GPIOA_GPIOB_OSPEEDR_OSPEEDR13_MASK		0x03
/** @defgroup gpioa_gpiob_ospeedr_ospeedr13 OSPEEDR13 Port x configuration bits (y = 0..15)
@{*/
/**@}*/


#define GPIOA_GPIOB_OSPEEDR_OSPEEDR12_SHIFT		24
#define GPIOA_GPIOB_OSPEEDR_OSPEEDR12_MASK		0x03
/** @defgroup gpioa_gpiob_ospeedr_ospeedr12 OSPEEDR12 Port x configuration bits (y = 0..15)
@{*/
/**@}*/


#define GPIOA_GPIOB_OSPEEDR_OSPEEDR11_SHIFT		22
#define GPIOA_GPIOB_OSPEEDR_OSPEEDR11_MASK		0x03
/** @defgroup gpioa_gpiob_ospeedr_ospeedr11 OSPEEDR11 Port x configuration bits (y = 0..15)
@{*/
/**@}*/


#define GPIOA_GPIOB_OSPEEDR_OSPEEDR10_SHIFT		20
#define GPIOA_GPIOB_OSPEEDR_OSPEEDR10_MASK		0x03
/** @defgroup gpioa_gpiob_ospeedr_ospeedr10 OSPEEDR10 Port x configuration bits (y = 0..15)
@{*/
/**@}*/


#define GPIOA_GPIOB_OSPEEDR_OSPEEDR9_SHIFT		18
#define GPIOA_GPIOB_OSPEEDR_OSPEEDR9_MASK		0x03
/** @defgroup gpioa_gpiob_ospeedr_ospeedr9 OSPEEDR9 Port x configuration bits (y = 0..15)
@{*/
/**@}*/


#define GPIOA_GPIOB_OSPEEDR_OSPEEDR8_SHIFT		16
#define GPIOA_GPIOB_OSPEEDR_OSPEEDR8_MASK		0x03
/** @defgroup gpioa_gpiob_ospeedr_ospeedr8 OSPEEDR8 Port x configuration bits (y = 0..15)
@{*/
/**@}*/


#define GPIOA_GPIOB_OSPEEDR_OSPEEDR7_SHIFT		14
#define GPIOA_GPIOB_OSPEEDR_OSPEEDR7_MASK		0x03
/** @defgroup gpioa_gpiob_ospeedr_ospeedr7 OSPEEDR7 Port x configuration bits (y = 0..15)
@{*/
/**@}*/


#define GPIOA_GPIOB_OSPEEDR_OSPEEDR6_SHIFT		12
#define GPIOA_GPIOB_OSPEEDR_OSPEEDR6_MASK		0x03
/** @defgroup gpioa_gpiob_ospeedr_ospeedr6 OSPEEDR6 Port x configuration bits (y = 0..15)
@{*/
/**@}*/


#define GPIOA_GPIOB_OSPEEDR_OSPEEDR5_SHIFT		10
#define GPIOA_GPIOB_OSPEEDR_OSPEEDR5_MASK		0x03
/** @defgroup gpioa_gpiob_ospeedr_ospeedr5 OSPEEDR5 Port x configuration bits (y = 0..15)
@{*/
/**@}*/


#define GPIOA_GPIOB_OSPEEDR_OSPEEDR4_SHIFT		8
#define GPIOA_GPIOB_OSPEEDR_OSPEEDR4_MASK		0x03
/** @defgroup gpioa_gpiob_ospeedr_ospeedr4 OSPEEDR4 Port x configuration bits (y = 0..15)
@{*/
/**@}*/


#define GPIOA_GPIOB_OSPEEDR_OSPEEDR3_SHIFT		6
#define GPIOA_GPIOB_OSPEEDR_OSPEEDR3_MASK		0x03
/** @defgroup gpioa_gpiob_ospeedr_ospeedr3 OSPEEDR3 Port x configuration bits (y = 0..15)
@{*/
/**@}*/


#define GPIOA_GPIOB_OSPEEDR_OSPEEDR2_SHIFT		4
#define GPIOA_GPIOB_OSPEEDR_OSPEEDR2_MASK		0x03
/** @defgroup gpioa_gpiob_ospeedr_ospeedr2 OSPEEDR2 Port x configuration bits (y = 0..15)
@{*/
/**@}*/


#define GPIOA_GPIOB_OSPEEDR_OSPEEDR1_SHIFT		2
#define GPIOA_GPIOB_OSPEEDR_OSPEEDR1_MASK		0x03
/** @defgroup gpioa_gpiob_ospeedr_ospeedr1 OSPEEDR1 Port x configuration bits (y = 0..15)
@{*/
/**@}*/


#define GPIOA_GPIOB_OSPEEDR_OSPEEDR0_SHIFT		0
#define GPIOA_GPIOB_OSPEEDR_OSPEEDR0_MASK		0x03
/** @defgroup gpioa_gpiob_ospeedr_ospeedr0 OSPEEDR0 Port x configuration bits (y = 0..15)
@{*/
/**@}*/
...
/** GPIOA_BRR_BR15 Port A Reset bit 15 **/
#define GPIOA_BRR_BR15		(1 << 15)
/** GPIOA_BRR_BR14 Port A Reset bit 14 **/
#define GPIOA_BRR_BR14		(1 << 14)
/** GPIOA_BRR_BR13 Port A Reset bit 13 **/
#define GPIOA_BRR_BR13		(1 << 13)
/** GPIOA_BRR_BR12 Port A Reset bit 12 **/
#define GPIOA_BRR_BR12		(1 << 12)
/** GPIOA_BRR_BR11 Port A Reset bit 11 **/
#define GPIOA_BRR_BR11		(1 << 11)
/** GPIOA_BRR_BR10 Port A Reset bit 10 **/
#define GPIOA_BRR_BR10		(1 << 10)
/** GPIOA_BRR_BR9 Port A Reset bit 9 **/
#define GPIOA_BRR_BR9		(1 << 9)
/** GPIOA_BRR_BR8 Port A Reset bit 8 **/
#define GPIOA_BRR_BR8		(1 << 8)
/** GPIOA_BRR_BR7 Port A Reset bit 7 **/
#define GPIOA_BRR_BR7		(1 << 7)
/** GPIOA_BRR_BR6 Port A Reset bit 6 **/
#define GPIOA_BRR_BR6		(1 << 6)
/** GPIOA_BRR_BR5 Port A Reset bit 5 **/
#define GPIOA_BRR_BR5		(1 << 5)
/** GPIOA_BRR_BR4 Port A Reset bit 4 **/
#define GPIOA_BRR_BR4		(1 << 4)
/** GPIOA_BRR_BR3 Port A Reset bit 3 **/
#define GPIOA_BRR_BR3		(1 << 3)
/** GPIOA_BRR_BR2 Port A Reset bit 2 **/
#define GPIOA_BRR_BR2		(1 << 2)
/** GPIOA_BRR_BR1 Port A Reset bit 1 **/
#define GPIOA_BRR_BR1		(1 << 1)
/** GPIOA_BRR_BR0 Port A Reset bit 0 **/
