...
/** GPIOI_BRR_BR15 Port Reset bit **/
#define GPIOI_BRR_BR15		(1 << 15)
/** GPIOI_BRR_BR14 Port Reset bit **/
#define GPIOI_BRR_BR14		(1 << 14)
/** GPIOI_BRR_BR13 Port Reset bit **/
#define GPIOI_BRR_BR13		(1 << 13)
/** GPIOI_BRR_BR12 Port Reset bit **/
#define GPIOI_BRR_BR12		(1 << 12)
/** GPIOI_BRR_BR11 Port Reset bit **/
#define GPIOI_BRR_BR11		(1 << 11)
/** GPIOI_BRR_BR10 Port Reset bit **/
#define GPIOI_BRR_BR10		(1 << 10)
/** GPIOI_BRR_BR9 Port Reset bit **/
#define GPIOI_BRR_BR9		(1 << 9)
/** GPIOI_BRR_BR8 Port Reset bit **/
#define GPIOI_BRR_BR8		(1 << 8)
/** GPIOI_BRR_BR7 Port Reset bit **/
#define GPIOI_BRR_BR7		(1 << 7)
/** GPIOI_BRR_BR6 Port Reset bit **/
#define GPIOI_BRR_BR6		(1 << 6)
/** GPIOI_BRR_BR5 Port Reset bit **/
#define GPIOI_BRR_BR5		(1 << 5)
/** GPIOI_BRR_BR4 Port Reset bit **/
#define GPIOI_BRR_BR4		(1 << 4)
/** GPIOI_BRR_BR3 Port Reset bit **/
#define GPIOI_BRR_BR3		(1 << 3)
/** GPIOI_BRR_BR2 Port Reset bit **/
#define GPIOI_BRR_BR2		(1 << 2)
/** GPIOI_BRR_BR1 Port Reset bit **/
#define GPIOI_BRR_BR1		(1 << 1)
/** GPIOI_BRR_BR0 Port Reset bit **/
