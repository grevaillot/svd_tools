...
/** TIM8_OR1 DMA address for full transfer **/
#define TIM8_OR1			MMIO32(TIM8_BASE + 0x50)
...
#define TIM8_CCR6			MMIO32(TIM8_BASE + 0x5c)
/** TIM8_OR2 DMA address for full transfer **/
#define TIM8_OR2			MMIO32(TIM8_BASE + 0x60)
/** TIM8_OR3 DMA address for full transfer **/
#define TIM8_OR3			MMIO32(TIM8_BASE + 0x64)
...
/** @defgroup tim8_or1 OR1 DMA address for full transfer
@{*/

/** TIM8_OR1_TI1_RMP Input Capture 1 remap **/
#define TIM8_OR1_TI1_RMP		(1 << 4)

#define TIM8_OR1_ETR_ADC3_RMP_SHIFT		2
#define TIM8_OR1_ETR_ADC3_RMP_MASK		0x03
/** @defgroup tim8_or1_etr_adc3_rmp ETRADC3RMP External trigger remap on ADC3 analog watchdog
@{*/
/**@}*/


#define TIM8_OR1_ETR_ADC2_RMP_SHIFT		0
#define TIM8_OR1_ETR_ADC2_RMP_MASK		0x03
/** @defgroup tim8_or1_etr_adc2_rmp ETRADC2RMP External trigger remap on ADC2 analog watchdog
@{*/
/**@}*/
...
/** @defgroup tim8_or2 OR2 DMA address for full transfer
@{*/


#define TIM8_OR2_ETRSEL_SHIFT		14
#define TIM8_OR2_ETRSEL_MASK		0x07
/** @defgroup tim8_or2_etrsel ETRSEL ETR source selection
@{*/
/**@}*/

/** TIM8_OR2_BKCMP2P BRK COMP2 input polarity **/
#define TIM8_OR2_BKCMP2P		(1 << 11)
/** TIM8_OR2_BKCMP1P BRK COMP1 input polarity **/
#define TIM8_OR2_BKCMP1P		(1 << 10)
/** TIM8_OR2_BKINP BRK BKIN input polarity **/
#define TIM8_OR2_BKINP		(1 << 9)
/** TIM8_OR2_BKDFBK2E BRK DFSDM_BREAK2 enable **/
#define TIM8_OR2_BKDFBK2E		(1 << 8)
/** TIM8_OR2_BKCMP2E BRK COMP2 enable **/
#define TIM8_OR2_BKCMP2E		(1 << 2)
/** TIM8_OR2_BKCMP1E BRK COMP1 enable **/
#define TIM8_OR2_BKCMP1E		(1 << 1)
/** TIM8_OR2_BKINE BRK BKIN input enable **/
#define TIM8_OR2_BKINE		(1 << 0)

/**@}*/

/** @defgroup tim8_or3 OR3 DMA address for full transfer
@{*/

/** TIM8_OR3_BK2CMP2P BRK2 COMP2 input polarity **/
#define TIM8_OR3_BK2CMP2P		(1 << 11)
/** TIM8_OR3_BK2CMP1P BRK2 COMP1 input polarity **/
#define TIM8_OR3_BK2CMP1P		(1 << 10)
/** TIM8_OR3_BK2INP BRK2 BKIN input polarity **/
#define TIM8_OR3_BK2INP		(1 << 9)
/** TIM8_OR3_BK2DFBK3E BRK2 DFSDM_BREAK3 enable **/
#define TIM8_OR3_BK2DFBK3E		(1 << 8)
/** TIM8_OR3_BK2CMP2E BRK2 COMP2 enable **/
#define TIM8_OR3_BK2CMP2E		(1 << 2)
/** TIM8_OR3_BK2CMP1E BRK2 COMP1 enable **/
#define TIM8_OR3_BK2CMP1E		(1 << 1)
/** TIM8_OR3_BK2INE BRK2 BKIN input enable **/
#define TIM8_OR3_BK2INE		(1 << 0)
