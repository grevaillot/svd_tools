...
#define TIM17_DCR			MMIO32(TIM17_BASE + 0x48)
/** TIM17_DMAR DMA address for full transfer **/
#define TIM17_DMAR			MMIO32(TIM17_BASE + 0x4c)
/** TIM17_OR1 TIM16 option register 1 **/
#define TIM17_OR1			MMIO32(TIM17_BASE + 0x50)
/** TIM17_OR2 TIM17 option register 1 **/
#define TIM17_OR2			MMIO32(TIM17_BASE + 0x60)
...
/** TIM17_DIER_TDE Trigger DMA request enable **/
#define TIM17_DIER_TDE		(1 << 14)
...
/** TIM17_DIER_TIE Trigger interrupt enable **/
#define TIM17_DIER_TIE		(1 << 6)
...
/** TIM17_SR_TIF Trigger interrupt flag **/
#define TIM17_SR_TIF		(1 << 6)
...
/** TIM17_EGR_TG Trigger generation **/
#define TIM17_EGR_TG		(1 << 6)
...
/** TIM17_CCMR1_Output_OC1M_2 Output Compare 1 mode **/
#define TIM17_CCMR1_Output_OC1M_2		(1 << 16)
...
#define TIM17_DMAR_DMAB_MASK		0xffff
...
/** @defgroup tim17_or1 OR1 TIM16 option register 1
@{*/


#define TIM17_OR1_TI1_RMP_SHIFT		0
#define TIM17_OR1_TI1_RMP_MASK		0x03
/** @defgroup tim17_or1_ti1_rmp TI1RMP Input capture 1 remap
@{*/
/**@}*/
...
/** @defgroup tim17_or2 OR2 TIM17 option register 1
@{*/

/** TIM17_OR2_BKCMP2P BRK COMP2 input polarit **/
#define TIM17_OR2_BKCMP2P		(1 << 11)
/** TIM17_OR2_BKCMP1P BRK COMP1 input polarity **/
#define TIM17_OR2_BKCMP1P		(1 << 10)
/** TIM17_OR2_BKINP BRK BKIN input polarity **/
#define TIM17_OR2_BKINP		(1 << 9)
/** TIM17_OR2_BKDFBK1E BRK DFSDM_BREAK1 enable **/
#define TIM17_OR2_BKDFBK1E		(1 << 8)
/** TIM17_OR2_BKCMP2E BRK COMP2 enable **/
#define TIM17_OR2_BKCMP2E		(1 << 2)
/** TIM17_OR2_BKCMP1E BRK COMP1 enable **/
#define TIM17_OR2_BKCMP1E		(1 << 1)
/** TIM17_OR2_BKINE BRK BKIN input enable **/
#define TIM17_OR2_BKINE		(1 << 0)
