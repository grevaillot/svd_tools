...
/** OPAMP_OPAMP1_CSR_USERTRIM allows to switch from AOP offset trimmed values to AOP offset **/
...
/** OPAMP_OPAMP2_CSR_USERTRIM allows to switch from AOP offset trimmed values to AOP offset **/
