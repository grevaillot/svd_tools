...
/** TIM17_TIM17_AF1 TIM17 alternate function register 1 **/
#define TIM17_TIM17_AF1			MMIO32(TIM17_BASE + 0x60)
/** TIM17_TIM17_TISEL TIM17 input selection register **/
#define TIM17_TIM17_TISEL			MMIO32(TIM17_BASE + 0x68)
...
/** @defgroup tim17_tim17_af1 TIM17AF1 TIM17 alternate function register 1
@{*/

/** TIM17_TIM17_AF1_BKCMP2P BRK COMP2 input polarity **/
#define TIM17_TIM17_AF1_BKCMP2P		(1 << 11)
/** TIM17_TIM17_AF1_BKCMP1P BRK COMP1 input polarity **/
#define TIM17_TIM17_AF1_BKCMP1P		(1 << 10)
/** TIM17_TIM17_AF1_BKINP BRK BKIN input polarity **/
#define TIM17_TIM17_AF1_BKINP		(1 << 9)
/** TIM17_TIM17_AF1_BKDFBK1E BRK dfsdm1_break[1] enable **/
#define TIM17_TIM17_AF1_BKDFBK1E		(1 << 8)
/** TIM17_TIM17_AF1_BKCMP2E BRK COMP2 enable **/
#define TIM17_TIM17_AF1_BKCMP2E		(1 << 2)
/** TIM17_TIM17_AF1_BKCMP1E BRK COMP1 enable **/
#define TIM17_TIM17_AF1_BKCMP1E		(1 << 1)
/** TIM17_TIM17_AF1_BKINE BRK BKIN input enable **/
#define TIM17_TIM17_AF1_BKINE		(1 << 0)

/**@}*/

/** @defgroup tim17_tim17_tisel TIM17TISEL TIM17 input selection register
@{*/


#define TIM17_TIM17_TISEL_TI1SEL_SHIFT		0
#define TIM17_TIM17_TISEL_TI1SEL_MASK		0x0f
/** @defgroup tim17_tim17_tisel_ti1sel TI1SEL selects TI1[0] to TI1[15] input
@{*/
/**@}*/
