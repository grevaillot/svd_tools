...
/** SPI1_CRCPOLY Polynomial Register **/
...
/** SPI1_CGFR configuration register **/
#define SPI1_CGFR			MMIO32(SPI1_BASE + 0x50)
...
/** @defgroup spi1_crcpoly CRCPOLY Polynomial Register
@{*/
...
/** @defgroup spi1_cgfr CGFR configuration register
@{*/

/** SPI1_CGFR_MCKOE Master clock output enable **/
#define SPI1_CGFR_MCKOE		(1 << 25)
/** SPI1_CGFR_ODD Odd factor for the prescaler **/
#define SPI1_CGFR_ODD		(1 << 24)

#define SPI1_CGFR_I2SDIV_SHIFT		16
#define SPI1_CGFR_I2SDIV_MASK		0xff
/** @defgroup spi1_cgfr_i2sdiv I2SDIV I2S linear prescaler
@{*/
/**@}*/

/** SPI1_CGFR_DATFMT Data format **/
#define SPI1_CGFR_DATFMT		(1 << 14)
/** SPI1_CGFR_WSINV Fixed channel length in SLAVE **/
#define SPI1_CGFR_WSINV		(1 << 13)
/** SPI1_CGFR_FIXCH Word select inversion **/
#define SPI1_CGFR_FIXCH		(1 << 12)
/** SPI1_CGFR_CKPOL Serial audio clock polarity **/
#define SPI1_CGFR_CKPOL		(1 << 11)
/** SPI1_CGFR_CHLEN Channel length (number of bits per audio channel) **/
#define SPI1_CGFR_CHLEN		(1 << 10)

#define SPI1_CGFR_DATLEN_SHIFT		8
#define SPI1_CGFR_DATLEN_MASK		0x03
/** @defgroup spi1_cgfr_datlen DATLEN Data length to be transferred
@{*/
/**@}*/

/** SPI1_CGFR_PCMSYNC PCM frame synchronization **/
#define SPI1_CGFR_PCMSYNC		(1 << 7)

#define SPI1_CGFR_I2SSTD_SHIFT		4
#define SPI1_CGFR_I2SSTD_MASK		0x03
/** @defgroup spi1_cgfr_i2sstd I2SSTD I2S standard selection
@{*/
/**@}*/


#define SPI1_CGFR_I2SCFG_SHIFT		1
#define SPI1_CGFR_I2SCFG_MASK		0x07
/** @defgroup spi1_cgfr_i2scfg I2SCFG I2S configuration mode
@{*/
/**@}*/

/** SPI1_CGFR_I2SMOD I2S mode selection **/
#define SPI1_CGFR_I2SMOD		(1 << 0)
