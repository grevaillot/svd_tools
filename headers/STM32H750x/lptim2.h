...
/** LPTIM2_LPTIM_CFGR2 LPTIM configuration register 2 **/
#define LPTIM2_LPTIM_CFGR2			MMIO32(LPTIM2_BASE + 0x24)
...
/** @defgroup lptim2_lptim_cfgr2 LPTIMCFGR2 LPTIM configuration register 2
@{*/


#define LPTIM2_LPTIM_CFGR2_IN2SEL_SHIFT		4
#define LPTIM2_LPTIM_CFGR2_IN2SEL_MASK		0x03
/** @defgroup lptim2_lptim_cfgr2_in2sel IN2SEL LPTIM Input 2 selection
@{*/
/**@}*/


#define LPTIM2_LPTIM_CFGR2_IN1SEL_SHIFT		0
#define LPTIM2_LPTIM_CFGR2_IN1SEL_MASK		0x03
/** @defgroup lptim2_lptim_cfgr2_in1sel IN1SEL LPTIM Input 1 selection
@{*/
/**@}*/
