...
#define GPIOB_GPIO_MODER_MODE15_SHIFT		30
#define GPIOB_GPIO_MODER_MODE15_MASK		0x03
/** @defgroup gpiob_gpio_moder_mode15 MODE15 [1:0]: Port x configuration bits (y = 0..15) These bits are written by software to configure the I/O mode.
@{*/
/**@}*/


#define GPIOB_GPIO_MODER_MODE14_SHIFT		28
#define GPIOB_GPIO_MODER_MODE14_MASK		0x03
/** @defgroup gpiob_gpio_moder_mode14 MODE14 [1:0]: Port x configuration bits (y = 0..15) These bits are written by software to configure the I/O mode.
@{*/
/**@}*/


#define GPIOB_GPIO_MODER_MODE13_SHIFT		26
#define GPIOB_GPIO_MODER_MODE13_MASK		0x03
/** @defgroup gpiob_gpio_moder_mode13 MODE13 [1:0]: Port x configuration bits (y = 0..15) These bits are written by software to configure the I/O mode.
@{*/
/**@}*/


#define GPIOB_GPIO_MODER_MODE12_SHIFT		24
#define GPIOB_GPIO_MODER_MODE12_MASK		0x03
/** @defgroup gpiob_gpio_moder_mode12 MODE12 [1:0]: Port x configuration bits (y = 0..15) These bits are written by software to configure the I/O mode.
@{*/
/**@}*/


#define GPIOB_GPIO_MODER_MODE11_SHIFT		22
#define GPIOB_GPIO_MODER_MODE11_MASK		0x03
/** @defgroup gpiob_gpio_moder_mode11 MODE11 [1:0]: Port x configuration bits (y = 0..15) These bits are written by software to configure the I/O mode.
@{*/
/**@}*/


#define GPIOB_GPIO_MODER_MODE10_SHIFT		20
#define GPIOB_GPIO_MODER_MODE10_MASK		0x03
/** @defgroup gpiob_gpio_moder_mode10 MODE10 [1:0]: Port x configuration bits (y = 0..15) These bits are written by software to configure the I/O mode.
@{*/
/**@}*/


#define GPIOB_GPIO_MODER_MODE9_SHIFT		18
#define GPIOB_GPIO_MODER_MODE9_MASK		0x03
/** @defgroup gpiob_gpio_moder_mode9 MODE9 [1:0]: Port x configuration bits (y = 0..15) These bits are written by software to configure the I/O mode.
@{*/
/**@}*/


#define GPIOB_GPIO_MODER_MODE8_SHIFT		16
#define GPIOB_GPIO_MODER_MODE8_MASK		0x03
/** @defgroup gpiob_gpio_moder_mode8 MODE8 [1:0]: Port x configuration bits (y = 0..15) These bits are written by software to configure the I/O mode.
@{*/
/**@}*/


#define GPIOB_GPIO_MODER_MODE7_SHIFT		14
#define GPIOB_GPIO_MODER_MODE7_MASK		0x03
/** @defgroup gpiob_gpio_moder_mode7 MODE7 [1:0]: Port x configuration bits (y = 0..15) These bits are written by software to configure the I/O mode.
@{*/
/**@}*/


#define GPIOB_GPIO_MODER_MODE6_SHIFT		12
#define GPIOB_GPIO_MODER_MODE6_MASK		0x03
/** @defgroup gpiob_gpio_moder_mode6 MODE6 [1:0]: Port x configuration bits (y = 0..15) These bits are written by software to configure the I/O mode.
@{*/
/**@}*/


#define GPIOB_GPIO_MODER_MODE5_SHIFT		10
#define GPIOB_GPIO_MODER_MODE5_MASK		0x03
/** @defgroup gpiob_gpio_moder_mode5 MODE5 [1:0]: Port x configuration bits (y = 0..15) These bits are written by software to configure the I/O mode.
@{*/
/**@}*/


#define GPIOB_GPIO_MODER_MODE4_SHIFT		8
#define GPIOB_GPIO_MODER_MODE4_MASK		0x03
/** @defgroup gpiob_gpio_moder_mode4 MODE4 [1:0]: Port x configuration bits (y = 0..15) These bits are written by software to configure the I/O mode.
@{*/
/**@}*/


#define GPIOB_GPIO_MODER_MODE3_SHIFT		6
#define GPIOB_GPIO_MODER_MODE3_MASK		0x03
/** @defgroup gpiob_gpio_moder_mode3 MODE3 [1:0]: Port x configuration bits (y = 0..15) These bits are written by software to configure the I/O mode.
@{*/
/**@}*/


#define GPIOB_GPIO_MODER_MODE2_SHIFT		4
#define GPIOB_GPIO_MODER_MODE2_MASK		0x03
/** @defgroup gpiob_gpio_moder_mode2 MODE2 [1:0]: Port x configuration bits (y = 0..15) These bits are written by software to configure the I/O mode.
@{*/
/**@}*/


#define GPIOB_GPIO_MODER_MODE1_SHIFT		2
#define GPIOB_GPIO_MODER_MODE1_MASK		0x03
/** @defgroup gpiob_gpio_moder_mode1 MODE1 [1:0]: Port x configuration bits (y = 0..15) These bits are written by software to configure the I/O mode.
@{*/
/**@}*/


#define GPIOB_GPIO_MODER_MODE0_SHIFT		0
#define GPIOB_GPIO_MODER_MODE0_MASK		0x03
/** @defgroup gpiob_gpio_moder_mode0 MODE0 [1:0]: Port x configuration bits (y = 0..15) These bits are written by software to configure the I/O mode.
@{*/
/**@}*/
