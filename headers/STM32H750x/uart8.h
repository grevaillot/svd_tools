...
/** UART8_PRESC USART prescaler register **/
#define UART8_PRESC			MMIO32(UART8_BASE + 0x2c)
...
/** UART8_CR1_RXFFIE RXFIFO Full interrupt enable **/
#define UART8_CR1_RXFFIE		(1 << 31)
/** UART8_CR1_TXFEIE TXFIFO empty interrupt enable **/
#define UART8_CR1_TXFEIE		(1 << 30)
/** UART8_CR1_FIFOEN FIFO mode enable **/
#define UART8_CR1_FIFOEN		(1 << 29)
...
/** UART8_CR1_UESM USART enable in Stop mode **/
#define UART8_CR1_UESM		(1 << 1)
...
/** UART8_CR2_DIS_NSS When the DSI_NSS bit is set, the NSS pin input is ignored **/
#define UART8_CR2_DIS_NSS		(1 << 3)
/** UART8_CR2_SLVEN Synchronous Slave mode enable **/
#define UART8_CR2_SLVEN		(1 << 0)
...
#define UART8_CR3_TXFTCFG_SHIFT		29
#define UART8_CR3_TXFTCFG_MASK		0x07
/** @defgroup uart8_cr3_txftcfg TXFTCFG TXFIFO threshold configuration
@{*/
/**@}*/

/** UART8_CR3_RXFTIE RXFIFO threshold interrupt enable **/
#define UART8_CR3_RXFTIE		(1 << 28)

#define UART8_CR3_RXFTCFG_SHIFT		25
#define UART8_CR3_RXFTCFG_MASK		0x07
/** @defgroup uart8_cr3_rxftcfg RXFTCFG Receive FIFO threshold configuration
@{*/
/**@}*/

/** UART8_CR3_TCBGTIE Transmission Complete before guard time, interrupt enable **/
#define UART8_CR3_TCBGTIE		(1 << 24)
/** UART8_CR3_TXFTIE TXFIFO threshold interrupt enable **/
#define UART8_CR3_TXFTIE		(1 << 23)
/** UART8_CR3_WUFIE Wakeup from Stop mode interrupt enable **/
#define UART8_CR3_WUFIE		(1 << 22)

#define UART8_CR3_WUS_SHIFT		20
#define UART8_CR3_WUS_MASK		0x03
/** @defgroup uart8_cr3_wus WUS Wakeup from Stop mode interrupt flag selection
@{*/
/**@}*/
...
#define UART8_BRR_BRR_4_15_SHIFT		4
#define UART8_BRR_BRR_4_15_MASK		0xfff
/** @defgroup uart8_brr_brr_4_15 BRR415 DIV_Mantissa
@{*/
/**@}*/


#define UART8_BRR_BRR_0_3_SHIFT		0
#define UART8_BRR_BRR_0_3_MASK		0x0f
/** @defgroup uart8_brr_brr_0_3 BRR03 DIV_Fraction
@{*/
/**@}*/
...
/** UART8_ISR_TXFT TXFIFO threshold flag **/
#define UART8_ISR_TXFT		(1 << 27)
/** UART8_ISR_RXFT RXFIFO threshold flag **/
#define UART8_ISR_RXFT		(1 << 26)
/** UART8_ISR_TCBGT Transmission complete before guard time flag **/
#define UART8_ISR_TCBGT		(1 << 25)
/** UART8_ISR_RXFF RXFIFO Full **/
#define UART8_ISR_RXFF		(1 << 24)
/** UART8_ISR_TXFE TXFIFO Empty **/
#define UART8_ISR_TXFE		(1 << 23)
/** UART8_ISR_REACK REACK **/
#define UART8_ISR_REACK		(1 << 22)
/** UART8_ISR_TEACK TEACK **/
#define UART8_ISR_TEACK		(1 << 21)
/** UART8_ISR_WUF WUF **/
#define UART8_ISR_WUF		(1 << 20)
/** UART8_ISR_RWU RWU **/
#define UART8_ISR_RWU		(1 << 19)
/** UART8_ISR_SBKF SBKF **/
...
/** UART8_ISR_UDR SPI slave underrun error flag **/
#define UART8_ISR_UDR		(1 << 13)
/** UART8_ISR_EOBF EOBF **/
...
/** UART8_ICR_WUCF Wakeup from Stop mode clear flag **/
#define UART8_ICR_WUCF		(1 << 20)
/** UART8_ICR_CMCF Character match clear flag **/
#define UART8_ICR_CMCF		(1 << 17)
/** UART8_ICR_UDRCF SPI slave underrun clear flag **/
#define UART8_ICR_UDRCF		(1 << 13)
...
/** UART8_ICR_TCBGTC Transmission complete before Guard time clear flag **/
#define UART8_ICR_TCBGTC		(1 << 7)
/** UART8_ICR_TCCF Transmission complete clear flag **/
#define UART8_ICR_TCCF		(1 << 6)
/** UART8_ICR_TXFECF TXFIFO empty clear flag **/
#define UART8_ICR_TXFECF		(1 << 5)
...
/** @defgroup uart8_presc PRESC USART prescaler register
@{*/


#define UART8_PRESC_PRESCALER_SHIFT		0
#define UART8_PRESC_PRESCALER_MASK		0x0f
/** @defgroup uart8_presc_prescaler PRESCALER Clock prescaler
@{*/
/**@}*/
