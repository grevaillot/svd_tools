...
/** ADC2_CCR ADC common control register **/
#define ADC2_CCR			MMIO32(ADC2_BASE + 0x08)
...
/** ADC2_CR_BOOST Boost mode control **/
#define ADC2_CR_BOOST		(1 << 8)
...
/** @defgroup adc2_ccr CCR ADC common control register
@{*/

/** ADC2_CCR_VBATEN VBAT enable **/
#define ADC2_CCR_VBATEN		(1 << 24)
/** ADC2_CCR_TSEN Temperature sensor enable **/
#define ADC2_CCR_TSEN		(1 << 23)
/** ADC2_CCR_VREFEN VREFINT enable **/
#define ADC2_CCR_VREFEN		(1 << 22)

#define ADC2_CCR_PRESC_SHIFT		18
#define ADC2_CCR_PRESC_MASK		0x0f
/** @defgroup adc2_ccr_presc PRESC ADC prescaler
@{*/
/**@}*/


#define ADC2_CCR_CKMODE_SHIFT		16
#define ADC2_CCR_CKMODE_MASK		0x03
/** @defgroup adc2_ccr_ckmode CKMODE ADC clock mode
@{*/
/**@}*/
