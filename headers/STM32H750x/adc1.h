...
/** ADC1_CCR ADC common control register **/
#define ADC1_CCR			MMIO32(ADC1_BASE + 0x08)
...
/** @defgroup adc1_ccr CCR ADC common control register
@{*/

/** ADC1_CCR_VBATEN VBAT enable **/
#define ADC1_CCR_VBATEN		(1 << 24)
/** ADC1_CCR_TSEN Temperature sensor enable **/
#define ADC1_CCR_TSEN		(1 << 23)
/** ADC1_CCR_VREFEN VREFINT enable **/
#define ADC1_CCR_VREFEN		(1 << 22)

#define ADC1_CCR_PRESC_SHIFT		18
#define ADC1_CCR_PRESC_MASK		0x0f
/** @defgroup adc1_ccr_presc PRESC ADC prescaler
@{*/
/**@}*/


#define ADC1_CCR_CKMODE_SHIFT		16
#define ADC1_CCR_CKMODE_MASK		0x03
/** @defgroup adc1_ccr_ckmode CKMODE ADC clock mode
@{*/
/**@}*/
