...
/** DSU_DCFG0 Device Configuration **/
#define DSU_DCFG0			MMIO32(DSU_BASE + 0xf0)
/** DSU_DCFG1 Device Configuration **/
#define DSU_DCFG1			MMIO32(DSU_BASE + 0xf4)
...
#define DSU_CTRL_SMSA		(1 << 7)
/** DSU_CTRL_ARR Auxiliary Row Read **/
#define DSU_CTRL_ARR		(1 << 6)
...
/** @defgroup dsu_dcfg0 DCFG0 Device Configuration
@{*/


#define DSU_DCFG0_DCFG_SHIFT		0
#define DSU_DCFG0_DCFG_MASK		0xffffffff
/** @defgroup dsu_dcfg0_dcfg DCFG Device Configuration
@{*/
/**@}*/
...
/** @defgroup dsu_dcfg1 DCFG1 Device Configuration
@{*/


#define DSU_DCFG1_DCFG_SHIFT		0
#define DSU_DCFG1_DCFG_MASK		0xffffffff
/** @defgroup dsu_dcfg1_dcfg DCFG Device Configuration
@{*/
/**@}*/
