...
/** GPIOF_ASCR GPIO port analog switch control register **/
#define GPIOF_ASCR			MMIO32(GPIOF_BASE + 0x2c)
...
/** @defgroup gpiof_ascr ASCR GPIO port analog switch control register
@{*/

/** GPIOF_ASCR_ASC15 Port analog switch control **/
#define GPIOF_ASCR_ASC15		(1 << 15)
/** GPIOF_ASCR_ASC14 Port analog switch control **/
#define GPIOF_ASCR_ASC14		(1 << 14)
/** GPIOF_ASCR_ASC13 Port analog switch control **/
#define GPIOF_ASCR_ASC13		(1 << 13)
/** GPIOF_ASCR_ASC12 Port analog switch control **/
#define GPIOF_ASCR_ASC12		(1 << 12)
/** GPIOF_ASCR_ASC11 Port analog switch control **/
#define GPIOF_ASCR_ASC11		(1 << 11)
/** GPIOF_ASCR_ASC10 Port analog switch control **/
#define GPIOF_ASCR_ASC10		(1 << 10)
/** GPIOF_ASCR_ASC9 Port analog switch control **/
#define GPIOF_ASCR_ASC9		(1 << 9)
/** GPIOF_ASCR_ASC8 Port analog switch control **/
#define GPIOF_ASCR_ASC8		(1 << 8)
/** GPIOF_ASCR_ASC7 Port analog switch control **/
#define GPIOF_ASCR_ASC7		(1 << 7)
/** GPIOF_ASCR_ASC6 Port analog switch control **/
#define GPIOF_ASCR_ASC6		(1 << 6)
/** GPIOF_ASCR_ASC5 Port analog switch control **/
#define GPIOF_ASCR_ASC5		(1 << 5)
/** GPIOF_ASCR_ASC4 Port analog switch control **/
#define GPIOF_ASCR_ASC4		(1 << 4)
/** GPIOF_ASCR_ASC3 Port analog switch control **/
#define GPIOF_ASCR_ASC3		(1 << 3)
/** GPIOF_ASCR_ASC2 Port analog switch control **/
#define GPIOF_ASCR_ASC2		(1 << 2)
/** GPIOF_ASCR_ASC1 Port analog switch control **/
#define GPIOF_ASCR_ASC1		(1 << 1)
/** GPIOF_ASCR_ASC0 Port analog switch control **/
#define GPIOF_ASCR_ASC0		(1 << 0)
