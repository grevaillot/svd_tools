...
#define OCTOSPIM_BASE			(0x50061c00)
#define SDMMC1_BASE			(0x50062400)
#define FMC_BASE			(0xa0000000)
#define OCTOSPI1_BASE			(0xa0001000)
#define OCTOSPI2_BASE			(0xa0001400)
