...
/** ADC_CFGR_JQDIS Injected Queue disable **/
#define ADC_CFGR_JQDIS		(1 << 31)
...
/** ADC_CFGR2_TROVS Triggered Regular Oversampling **/
...
/** ADC_SMPR1_SMPPLUS Addition of one clock cycle to the sampling time **/
#define ADC_SMPR1_SMPPLUS		(1 << 31)
...
#define ADC_SMPR1_SMP0_SHIFT		0
#define ADC_SMPR1_SMP0_MASK		0x07
/** @defgroup adc_smpr1_smp0 SMP0 SMP0
@{*/
/**@}*/
