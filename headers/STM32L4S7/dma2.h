...
/** @defgroup dma2_registers Direct memory access controller Register
@{*/

/** DMA2_ISR interrupt status register **/
#define DMA2_ISR			MMIO32(DMA2_BASE + 0x00)
/** DMA2_IFCR interrupt flag clear register **/
#define DMA2_IFCR			MMIO32(DMA2_BASE + 0x04)
/** DMA2_CCR1 channel x configuration register **/
#define DMA2_CCR1			MMIO32(DMA2_BASE + 0x08)
/** DMA2_CNDTR1 channel x number of data register **/
#define DMA2_CNDTR1			MMIO32(DMA2_BASE + 0x0c)
/** DMA2_CPAR1 channel x peripheral address register **/
#define DMA2_CPAR1			MMIO32(DMA2_BASE + 0x10)
/** DMA2_CMAR1 channel x memory address register **/
#define DMA2_CMAR1			MMIO32(DMA2_BASE + 0x14)
/** DMA2_CCR2 channel x configuration register **/
#define DMA2_CCR2			MMIO32(DMA2_BASE + 0x1c)
/** DMA2_CNDTR2 channel x number of data register **/
#define DMA2_CNDTR2			MMIO32(DMA2_BASE + 0x20)
/** DMA2_CPAR2 channel x peripheral address register **/
#define DMA2_CPAR2			MMIO32(DMA2_BASE + 0x24)
/** DMA2_CMAR2 channel x memory address register **/
#define DMA2_CMAR2			MMIO32(DMA2_BASE + 0x28)
/** DMA2_CCR3 channel x configuration register **/
#define DMA2_CCR3			MMIO32(DMA2_BASE + 0x30)
/** DMA2_CNDTR3 channel x number of data register **/
#define DMA2_CNDTR3			MMIO32(DMA2_BASE + 0x34)
/** DMA2_CPAR3 channel x peripheral address register **/
#define DMA2_CPAR3			MMIO32(DMA2_BASE + 0x38)
/** DMA2_CMAR3 channel x memory address register **/
#define DMA2_CMAR3			MMIO32(DMA2_BASE + 0x3c)
/** DMA2_CCR4 channel x configuration register **/
#define DMA2_CCR4			MMIO32(DMA2_BASE + 0x44)
/** DMA2_CNDTR4 channel x number of data register **/
#define DMA2_CNDTR4			MMIO32(DMA2_BASE + 0x48)
/** DMA2_CPAR4 channel x peripheral address register **/
#define DMA2_CPAR4			MMIO32(DMA2_BASE + 0x4c)
/** DMA2_CMAR4 channel x memory address register **/
#define DMA2_CMAR4			MMIO32(DMA2_BASE + 0x50)
/** DMA2_CCR5 channel x configuration register **/
#define DMA2_CCR5			MMIO32(DMA2_BASE + 0x58)
/** DMA2_CNDTR5 channel x number of data register **/
#define DMA2_CNDTR5			MMIO32(DMA2_BASE + 0x5c)
/** DMA2_CPAR5 channel x peripheral address register **/
#define DMA2_CPAR5			MMIO32(DMA2_BASE + 0x60)
/** DMA2_CMAR5 channel x memory address register **/
#define DMA2_CMAR5			MMIO32(DMA2_BASE + 0x64)
/** DMA2_CCR6 channel x configuration register **/
#define DMA2_CCR6			MMIO32(DMA2_BASE + 0x6c)
/** DMA2_CNDTR6 channel x number of data register **/
#define DMA2_CNDTR6			MMIO32(DMA2_BASE + 0x70)
/** DMA2_CPAR6 channel x peripheral address register **/
#define DMA2_CPAR6			MMIO32(DMA2_BASE + 0x74)
/** DMA2_CMAR6 channel x memory address register **/
#define DMA2_CMAR6			MMIO32(DMA2_BASE + 0x78)
/** DMA2_CCR7 channel x configuration register **/
#define DMA2_CCR7			MMIO32(DMA2_BASE + 0x80)
/** DMA2_CNDTR7 channel x number of data register **/
#define DMA2_CNDTR7			MMIO32(DMA2_BASE + 0x84)
/** DMA2_CPAR7 channel x peripheral address register **/
#define DMA2_CPAR7			MMIO32(DMA2_BASE + 0x88)
/** DMA2_CMAR7 channel x memory address register **/
#define DMA2_CMAR7			MMIO32(DMA2_BASE + 0x8c)
/** DMA2_CSELR channel selection register **/
#define DMA2_CSELR			MMIO32(DMA2_BASE + 0xa8)
...
/** DMA2_ISR_TEIF7 Channel x transfer error flag (x = 1 ..7) **/
#define DMA2_ISR_TEIF7		(1 << 27)
/** DMA2_ISR_HTIF7 Channel x half transfer flag (x = 1 ..7) **/
#define DMA2_ISR_HTIF7		(1 << 26)
/** DMA2_ISR_TCIF7 Channel x transfer complete flag (x = 1 ..7) **/
#define DMA2_ISR_TCIF7		(1 << 25)
/** DMA2_ISR_GIF7 Channel x global interrupt flag (x = 1 ..7) **/
#define DMA2_ISR_GIF7		(1 << 24)
/** DMA2_ISR_TEIF6 Channel x transfer error flag (x = 1 ..7) **/
#define DMA2_ISR_TEIF6		(1 << 23)
/** DMA2_ISR_HTIF6 Channel x half transfer flag (x = 1 ..7) **/
#define DMA2_ISR_HTIF6		(1 << 22)
/** DMA2_ISR_TCIF6 Channel x transfer complete flag (x = 1 ..7) **/
#define DMA2_ISR_TCIF6		(1 << 21)
/** DMA2_ISR_GIF6 Channel x global interrupt flag (x = 1 ..7) **/
#define DMA2_ISR_GIF6		(1 << 20)
/** DMA2_ISR_TEIF5 Channel x transfer error flag (x = 1 ..7) **/
#define DMA2_ISR_TEIF5		(1 << 19)
/** DMA2_ISR_HTIF5 Channel x half transfer flag (x = 1 ..7) **/
#define DMA2_ISR_HTIF5		(1 << 18)
/** DMA2_ISR_TCIF5 Channel x transfer complete flag (x = 1 ..7) **/
#define DMA2_ISR_TCIF5		(1 << 17)
/** DMA2_ISR_GIF5 Channel x global interrupt flag (x = 1 ..7) **/
#define DMA2_ISR_GIF5		(1 << 16)
/** DMA2_ISR_TEIF4 Channel x transfer error flag (x = 1 ..7) **/
#define DMA2_ISR_TEIF4		(1 << 15)
/** DMA2_ISR_HTIF4 Channel x half transfer flag (x = 1 ..7) **/
#define DMA2_ISR_HTIF4		(1 << 14)
/** DMA2_ISR_TCIF4 Channel x transfer complete flag (x = 1 ..7) **/
#define DMA2_ISR_TCIF4		(1 << 13)
/** DMA2_ISR_GIF4 Channel x global interrupt flag (x = 1 ..7) **/
#define DMA2_ISR_GIF4		(1 << 12)
/** DMA2_ISR_TEIF3 Channel x transfer error flag (x = 1 ..7) **/
#define DMA2_ISR_TEIF3		(1 << 11)
/** DMA2_ISR_HTIF3 Channel x half transfer flag (x = 1 ..7) **/
#define DMA2_ISR_HTIF3		(1 << 10)
/** DMA2_ISR_TCIF3 Channel x transfer complete flag (x = 1 ..7) **/
#define DMA2_ISR_TCIF3		(1 << 9)
/** DMA2_ISR_GIF3 Channel x global interrupt flag (x = 1 ..7) **/
#define DMA2_ISR_GIF3		(1 << 8)
/** DMA2_ISR_TEIF2 Channel x transfer error flag (x = 1 ..7) **/
#define DMA2_ISR_TEIF2		(1 << 7)
/** DMA2_ISR_HTIF2 Channel x half transfer flag (x = 1 ..7) **/
#define DMA2_ISR_HTIF2		(1 << 6)
/** DMA2_ISR_TCIF2 Channel x transfer complete flag (x = 1 ..7) **/
#define DMA2_ISR_TCIF2		(1 << 5)
/** DMA2_ISR_GIF2 Channel x global interrupt flag (x = 1 ..7) **/
#define DMA2_ISR_GIF2		(1 << 4)
/** DMA2_ISR_TEIF1 Channel x transfer error flag (x = 1 ..7) **/
#define DMA2_ISR_TEIF1		(1 << 3)
/** DMA2_ISR_HTIF1 Channel x half transfer flag (x = 1 ..7) **/
#define DMA2_ISR_HTIF1		(1 << 2)
/** DMA2_ISR_TCIF1 Channel x transfer complete flag (x = 1 ..7) **/
#define DMA2_ISR_TCIF1		(1 << 1)
/** DMA2_ISR_GIF1 Channel x global interrupt flag (x = 1 ..7) **/
#define DMA2_ISR_GIF1		(1 << 0)

/**@}*/

/** @defgroup dma2_ifcr IFCR interrupt flag clear register
@{*/

/** DMA2_IFCR_CTEIF7 Channel x transfer error clear (x = 1 ..7) **/
#define DMA2_IFCR_CTEIF7		(1 << 27)
/** DMA2_IFCR_CHTIF7 Channel x half transfer clear (x = 1 ..7) **/
#define DMA2_IFCR_CHTIF7		(1 << 26)
/** DMA2_IFCR_CTCIF7 Channel x transfer complete clear (x = 1 ..7) **/
#define DMA2_IFCR_CTCIF7		(1 << 25)
/** DMA2_IFCR_CGIF7 Channel x global interrupt clear (x = 1 ..7) **/
#define DMA2_IFCR_CGIF7		(1 << 24)
/** DMA2_IFCR_CTEIF6 Channel x transfer error clear (x = 1 ..7) **/
#define DMA2_IFCR_CTEIF6		(1 << 23)
/** DMA2_IFCR_CHTIF6 Channel x half transfer clear (x = 1 ..7) **/
#define DMA2_IFCR_CHTIF6		(1 << 22)
/** DMA2_IFCR_CTCIF6 Channel x transfer complete clear (x = 1 ..7) **/
#define DMA2_IFCR_CTCIF6		(1 << 21)
/** DMA2_IFCR_CGIF6 Channel x global interrupt clear (x = 1 ..7) **/
#define DMA2_IFCR_CGIF6		(1 << 20)
/** DMA2_IFCR_CTEIF5 Channel x transfer error clear (x = 1 ..7) **/
#define DMA2_IFCR_CTEIF5		(1 << 19)
/** DMA2_IFCR_CHTIF5 Channel x half transfer clear (x = 1 ..7) **/
#define DMA2_IFCR_CHTIF5		(1 << 18)
/** DMA2_IFCR_CTCIF5 Channel x transfer complete clear (x = 1 ..7) **/
#define DMA2_IFCR_CTCIF5		(1 << 17)
/** DMA2_IFCR_CGIF5 Channel x global interrupt clear (x = 1 ..7) **/
#define DMA2_IFCR_CGIF5		(1 << 16)
/** DMA2_IFCR_CTEIF4 Channel x transfer error clear (x = 1 ..7) **/
#define DMA2_IFCR_CTEIF4		(1 << 15)
/** DMA2_IFCR_CHTIF4 Channel x half transfer clear (x = 1 ..7) **/
#define DMA2_IFCR_CHTIF4		(1 << 14)
/** DMA2_IFCR_CTCIF4 Channel x transfer complete clear (x = 1 ..7) **/
#define DMA2_IFCR_CTCIF4		(1 << 13)
/** DMA2_IFCR_CGIF4 Channel x global interrupt clear (x = 1 ..7) **/
#define DMA2_IFCR_CGIF4		(1 << 12)
/** DMA2_IFCR_CTEIF3 Channel x transfer error clear (x = 1 ..7) **/
#define DMA2_IFCR_CTEIF3		(1 << 11)
/** DMA2_IFCR_CHTIF3 Channel x half transfer clear (x = 1 ..7) **/
#define DMA2_IFCR_CHTIF3		(1 << 10)
/** DMA2_IFCR_CTCIF3 Channel x transfer complete clear (x = 1 ..7) **/
#define DMA2_IFCR_CTCIF3		(1 << 9)
/** DMA2_IFCR_CGIF3 Channel x global interrupt clear (x = 1 ..7) **/
#define DMA2_IFCR_CGIF3		(1 << 8)
/** DMA2_IFCR_CTEIF2 Channel x transfer error clear (x = 1 ..7) **/
#define DMA2_IFCR_CTEIF2		(1 << 7)
/** DMA2_IFCR_CHTIF2 Channel x half transfer clear (x = 1 ..7) **/
#define DMA2_IFCR_CHTIF2		(1 << 6)
/** DMA2_IFCR_CTCIF2 Channel x transfer complete clear (x = 1 ..7) **/
#define DMA2_IFCR_CTCIF2		(1 << 5)
/** DMA2_IFCR_CGIF2 Channel x global interrupt clear (x = 1 ..7) **/
#define DMA2_IFCR_CGIF2		(1 << 4)
/** DMA2_IFCR_CTEIF1 Channel x transfer error clear (x = 1 ..7) **/
#define DMA2_IFCR_CTEIF1		(1 << 3)
/** DMA2_IFCR_CHTIF1 Channel x half transfer clear (x = 1 ..7) **/
#define DMA2_IFCR_CHTIF1		(1 << 2)
/** DMA2_IFCR_CTCIF1 Channel x transfer complete clear (x = 1 ..7) **/
#define DMA2_IFCR_CTCIF1		(1 << 1)
/** DMA2_IFCR_CGIF1 Channel x global interrupt clear (x = 1 ..7) **/
#define DMA2_IFCR_CGIF1		(1 << 0)

/**@}*/

/** @defgroup dma2_ccr1 CCR1 channel x configuration register
@{*/
...
/** @defgroup dma2_cndtr1 CNDTR1 channel x number of data register
@{*/
...
/** @defgroup dma2_cpar1 CPAR1 channel x peripheral address register
@{*/
...
/** @defgroup dma2_cmar1 CMAR1 channel x memory address register
@{*/
...
/** @defgroup dma2_ccr2 CCR2 channel x configuration register
@{*/
...
/** @defgroup dma2_cndtr2 CNDTR2 channel x number of data register
@{*/
...
/** @defgroup dma2_cpar2 CPAR2 channel x peripheral address register
@{*/
...
/** @defgroup dma2_cmar2 CMAR2 channel x memory address register
@{*/
...
/** @defgroup dma2_ccr3 CCR3 channel x configuration register
@{*/
...
/** @defgroup dma2_cndtr3 CNDTR3 channel x number of data register
@{*/
...
/** @defgroup dma2_cpar3 CPAR3 channel x peripheral address register
@{*/
...
/** @defgroup dma2_cmar3 CMAR3 channel x memory address register
@{*/
...
/** @defgroup dma2_ccr4 CCR4 channel x configuration register
@{*/
...
/** @defgroup dma2_cndtr4 CNDTR4 channel x number of data register
@{*/
...
/** @defgroup dma2_cpar4 CPAR4 channel x peripheral address register
@{*/
...
/** @defgroup dma2_cmar4 CMAR4 channel x memory address register
@{*/
...
/** @defgroup dma2_ccr5 CCR5 channel x configuration register
@{*/
...
/** @defgroup dma2_cndtr5 CNDTR5 channel x number of data register
@{*/
...
/** @defgroup dma2_cpar5 CPAR5 channel x peripheral address register
@{*/
...
/** @defgroup dma2_cmar5 CMAR5 channel x memory address register
@{*/
...
/** @defgroup dma2_ccr6 CCR6 channel x configuration register
@{*/
...
/** @defgroup dma2_cndtr6 CNDTR6 channel x number of data register
@{*/
...
/** @defgroup dma2_cpar6 CPAR6 channel x peripheral address register
@{*/
...
/** @defgroup dma2_cmar6 CMAR6 channel x memory address register
@{*/
...
/** @defgroup dma2_ccr7 CCR7 channel x configuration register
@{*/
...
/** @defgroup dma2_cndtr7 CNDTR7 channel x number of data register
@{*/
...
/** @defgroup dma2_cpar7 CPAR7 channel x peripheral address register
@{*/
...
/** @defgroup dma2_cmar7 CMAR7 channel x memory address register
@{*/
...
/** @defgroup dma2_cselr CSELR channel selection register
@{*/


#define DMA2_CSELR_C7S_SHIFT		24
#define DMA2_CSELR_C7S_MASK		0x0f
/** @defgroup dma2_cselr_c7s C7S DMA channel 7 selection
@{*/
/**@}*/


#define DMA2_CSELR_C6S_SHIFT		20
#define DMA2_CSELR_C6S_MASK		0x0f
/** @defgroup dma2_cselr_c6s C6S DMA channel 6 selection
@{*/
/**@}*/


#define DMA2_CSELR_C5S_SHIFT		16
#define DMA2_CSELR_C5S_MASK		0x0f
/** @defgroup dma2_cselr_c5s C5S DMA channel 5 selection
@{*/
/**@}*/


#define DMA2_CSELR_C4S_SHIFT		12
#define DMA2_CSELR_C4S_MASK		0x0f
/** @defgroup dma2_cselr_c4s C4S DMA channel 4 selection
@{*/
/**@}*/


#define DMA2_CSELR_C3S_SHIFT		8
#define DMA2_CSELR_C3S_MASK		0x0f
/** @defgroup dma2_cselr_c3s C3S DMA channel 3 selection
@{*/
/**@}*/


#define DMA2_CSELR_C2S_SHIFT		4
#define DMA2_CSELR_C2S_MASK		0x0f
/** @defgroup dma2_cselr_c2s C2S DMA channel 2 selection
@{*/
/**@}*/


#define DMA2_CSELR_C1S_SHIFT		0
#define DMA2_CSELR_C1S_MASK		0x0f
/** @defgroup dma2_cselr_c1s C1S DMA channel 1 selection
@{*/
/**@}*/
