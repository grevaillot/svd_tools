...
/** GPIOG_ASCR GPIO port analog switch control register **/
#define GPIOG_ASCR			MMIO32(GPIOG_BASE + 0x2c)
...
/** GPIOG_BRR_BR15 Port Reset bit **/
#define GPIOG_BRR_BR15		(1 << 15)
/** GPIOG_BRR_BR14 Port Reset bit **/
#define GPIOG_BRR_BR14		(1 << 14)
/** GPIOG_BRR_BR13 Port Reset bit **/
#define GPIOG_BRR_BR13		(1 << 13)
/** GPIOG_BRR_BR12 Port Reset bit **/
#define GPIOG_BRR_BR12		(1 << 12)
/** GPIOG_BRR_BR11 Port Reset bit **/
#define GPIOG_BRR_BR11		(1 << 11)
/** GPIOG_BRR_BR10 Port Reset bit **/
#define GPIOG_BRR_BR10		(1 << 10)
/** GPIOG_BRR_BR9 Port Reset bit **/
#define GPIOG_BRR_BR9		(1 << 9)
/** GPIOG_BRR_BR8 Port Reset bit **/
#define GPIOG_BRR_BR8		(1 << 8)
/** GPIOG_BRR_BR7 Port Reset bit **/
#define GPIOG_BRR_BR7		(1 << 7)
/** GPIOG_BRR_BR6 Port Reset bit **/
#define GPIOG_BRR_BR6		(1 << 6)
/** GPIOG_BRR_BR5 Port Reset bit **/
#define GPIOG_BRR_BR5		(1 << 5)
/** GPIOG_BRR_BR4 Port Reset bit **/
#define GPIOG_BRR_BR4		(1 << 4)
/** GPIOG_BRR_BR3 Port Reset bit **/
#define GPIOG_BRR_BR3		(1 << 3)
/** GPIOG_BRR_BR2 Port Reset bit **/
#define GPIOG_BRR_BR2		(1 << 2)
/** GPIOG_BRR_BR1 Port Reset bit **/
#define GPIOG_BRR_BR1		(1 << 1)
/** GPIOG_BRR_BR0 Port Reset bit **/
#define GPIOG_BRR_BR0		(1 << 0)

/**@}*/

/** @defgroup gpiog_ascr ASCR GPIO port analog switch control register
@{*/

/** GPIOG_ASCR_ASC15 Port analog switch control **/
#define GPIOG_ASCR_ASC15		(1 << 15)
/** GPIOG_ASCR_ASC14 Port analog switch control **/
#define GPIOG_ASCR_ASC14		(1 << 14)
/** GPIOG_ASCR_ASC13 Port analog switch control **/
#define GPIOG_ASCR_ASC13		(1 << 13)
/** GPIOG_ASCR_ASC12 Port analog switch control **/
#define GPIOG_ASCR_ASC12		(1 << 12)
/** GPIOG_ASCR_ASC11 Port analog switch control **/
#define GPIOG_ASCR_ASC11		(1 << 11)
/** GPIOG_ASCR_ASC10 Port analog switch control **/
#define GPIOG_ASCR_ASC10		(1 << 10)
/** GPIOG_ASCR_ASC9 Port analog switch control **/
#define GPIOG_ASCR_ASC9		(1 << 9)
/** GPIOG_ASCR_ASC8 Port analog switch control **/
#define GPIOG_ASCR_ASC8		(1 << 8)
/** GPIOG_ASCR_ASC7 Port analog switch control **/
#define GPIOG_ASCR_ASC7		(1 << 7)
/** GPIOG_ASCR_ASC6 Port analog switch control **/
#define GPIOG_ASCR_ASC6		(1 << 6)
/** GPIOG_ASCR_ASC5 Port analog switch control **/
#define GPIOG_ASCR_ASC5		(1 << 5)
/** GPIOG_ASCR_ASC4 Port analog switch control **/
#define GPIOG_ASCR_ASC4		(1 << 4)
/** GPIOG_ASCR_ASC3 Port analog switch control **/
#define GPIOG_ASCR_ASC3		(1 << 3)
/** GPIOG_ASCR_ASC2 Port analog switch control **/
#define GPIOG_ASCR_ASC2		(1 << 2)
/** GPIOG_ASCR_ASC1 Port analog switch control **/
#define GPIOG_ASCR_ASC1		(1 << 1)
/** GPIOG_ASCR_ASC0 Port analog switch control **/
#define GPIOG_ASCR_ASC0		(1 << 0)
