...
/** RCC_AHB3RSTR peripheral reset register **/
...
/** RCC_DCKCFGR2 Dedicated Clocks Configuration Register **/
...
#define RCC_PLLCFGR_PLLR_MASK		0x07
/** @defgroup rcc_pllcfgr_pllr PLLR Main PLL (PLL) division factor for I2S, DFSDM clocks
@{*/
/**@}*/
...
/** RCC_AHB2RSTR_RNGRST RNGRST **/
#define RCC_AHB2RSTR_RNGRST		(1 << 6)
/** RCC_AHB2RSTR_CRYPRST CRYP module reset **/
#define RCC_AHB2RSTR_CRYPRST		(1 << 4)

/**@}*/

/** @defgroup rcc_ahb3rstr AHB3RSTR peripheral reset register
@{*/

/** RCC_AHB3RSTR_QSPIRST QUADSPI module reset **/
#define RCC_AHB3RSTR_QSPIRST		(1 << 1)
/** RCC_AHB3RSTR_FSMCRST Flexible memory controller module reset **/
...
/** RCC_APB1RSTR_UART8RST UART 8 reset **/
#define RCC_APB1RSTR_UART8RST		(1 << 31)
/** RCC_APB1RSTR_UART7RST UART 7 reset **/
#define RCC_APB1RSTR_UART7RST		(1 << 30)
/** RCC_APB1RSTR_DACRST DAC reset **/
#define RCC_APB1RSTR_DACRST		(1 << 29)
/** RCC_APB1RSTR_PWRRST Power interface reset **/
#define RCC_APB1RSTR_PWRRST		(1 << 28)
/** RCC_APB1RSTR_CAN3RST CAN 3 reset **/
#define RCC_APB1RSTR_CAN3RST		(1 << 27)
/** RCC_APB1RSTR_CAN2RST CAN2RST **/
#define RCC_APB1RSTR_CAN2RST		(1 << 26)
/** RCC_APB1RSTR_CAN1RST CAN1RST **/
#define RCC_APB1RSTR_CAN1RST		(1 << 25)
/** RCC_APB1RSTR_I2C4RST I2C4RST **/
...
/** RCC_APB1RSTR_USART3RST USART3RST **/
...
/** RCC_APB1RSTR_LPTIMER1RST LPTimer1 reset **/
#define RCC_APB1RSTR_LPTIMER1RST		(1 << 9)
/** RCC_APB1RSTR_TIM14RST TIM14RST **/
#define RCC_APB1RSTR_TIM14RST		(1 << 8)
/** RCC_APB1RSTR_TIM13RST TIM13RST **/
#define RCC_APB1RSTR_TIM13RST		(1 << 7)
/** RCC_APB1RSTR_TIM12RST TIM12RST **/
#define RCC_APB1RSTR_TIM12RST		(1 << 6)
/** RCC_APB1RSTR_TIM7RST TIM7RST **/
#define RCC_APB1RSTR_TIM7RST		(1 << 5)
/** RCC_APB1RSTR_TIM6RST TIM6RST **/
...
/** RCC_APB2RSTR_DFSDM2RST DFSDM2 reset **/
#define RCC_APB2RSTR_DFSDM2RST		(1 << 25)
/** RCC_APB2RSTR_DFSDMRST DFSDMRST **/
#define RCC_APB2RSTR_DFSDMRST		(1 << 24)
/** RCC_APB2RSTR_SAI1RST SAI1 reset **/
#define RCC_APB2RSTR_SAI1RST		(1 << 22)
/** RCC_APB2RSTR_SPI5RST SPI5RST **/
...
/** RCC_APB2RSTR_SART10RST USART10 reset **/
#define RCC_APB2RSTR_SART10RST		(1 << 7)
/** RCC_APB2RSTR_USART9RST USART9 reset **/
#define RCC_APB2RSTR_USART9RST		(1 << 6)
...
/** RCC_AHB2ENR_RNGEN RNGEN **/
#define RCC_AHB2ENR_RNGEN		(1 << 6)
/** RCC_AHB2ENR_CRYPEN CRYP clock enable **/
...
/** RCC_AHB3ENR_QSPIEN QUADSPI memory controller module clock enable **/
#define RCC_AHB3ENR_QSPIEN		(1 << 1)
/** RCC_AHB3ENR_FSMCEN Flexible memory controller module clock enable **/
...
/** RCC_APB1ENR_UART8EN UART8 clock enable **/
#define RCC_APB1ENR_UART8EN		(1 << 31)
/** RCC_APB1ENR_UART7EN UART7 clock enable **/
#define RCC_APB1ENR_UART7EN		(1 << 30)
/** RCC_APB1ENR_DACEN DAC clock enable **/
#define RCC_APB1ENR_DACEN		(1 << 29)
/** RCC_APB1ENR_PWREN Power interface clock enable **/
#define RCC_APB1ENR_PWREN		(1 << 28)
/** RCC_APB1ENR_CAN3EN CAN 3 clock enable **/
#define RCC_APB1ENR_CAN3EN		(1 << 27)
/** RCC_APB1ENR_CAN2EN CAN2EN **/
#define RCC_APB1ENR_CAN2EN		(1 << 26)
/** RCC_APB1ENR_CAN1EN CAN1EN **/
#define RCC_APB1ENR_CAN1EN		(1 << 25)
/** RCC_APB1ENR_I2C4EN I2C4EN **/
...
/** RCC_APB1ENR_RTCAPB clock enable **/
#define RCC_APB1ENR_RTCAPB		(1 << 10)
/** RCC_APB1ENR_LPTIMER1EN LPTimer 1 clock enable **/
#define RCC_APB1ENR_LPTIMER1EN		(1 << 9)
/** RCC_APB1ENR_TIM14EN TIM14EN **/
#define RCC_APB1ENR_TIM14EN		(1 << 8)
/** RCC_APB1ENR_TIM13EN TIM13EN **/
#define RCC_APB1ENR_TIM13EN		(1 << 7)
/** RCC_APB1ENR_TIM12EN TIM12EN **/
#define RCC_APB1ENR_TIM12EN		(1 << 6)
/** RCC_APB1ENR_TIM7EN TIM7EN **/
#define RCC_APB1ENR_TIM7EN		(1 << 5)
/** RCC_APB1ENR_TIM6EN TIM6EN **/
...
/** RCC_APB2ENR_DFSDM2EN DFSDM2 clock enable **/
#define RCC_APB2ENR_DFSDM2EN		(1 << 25)
/** RCC_APB2ENR_DFSDMEN DFSDMEN **/
#define RCC_APB2ENR_DFSDMEN		(1 << 24)
/** RCC_APB2ENR_SAI1EN SAI 1 clock enable **/
#define RCC_APB2ENR_SAI1EN		(1 << 22)
/** RCC_APB2ENR_SPI5EN SPI5 clock enable **/
...
/** RCC_APB2ENR_SPI4EN SPI4 clock enable **/
...
/** RCC_AHB1LPENR_SRAM2LPEN SRAM2interface clock enable during Sleep mode **/
...
/** RCC_AHB2LPENR_RNGLPEN RNGLPEN **/
#define RCC_AHB2LPENR_RNGLPEN		(1 << 6)
/** RCC_AHB2LPENR_QSPILPEN QUADSPI memory controller module clock enable during Sleep mode **/
#define RCC_AHB2LPENR_QSPILPEN		(1 << 1)
/** RCC_AHB2LPENR_FSMCLPEN Flexible memory controller module clock enable during Sleep mode **/
#define RCC_AHB2LPENR_FSMCLPEN		(1 << 0)
...
/** RCC_AHB3LPENR_QSPILPEN QUADSPI memory controller module clock enable during Sleep mode **/
#define RCC_AHB3LPENR_QSPILPEN		(1 << 1)
/** RCC_AHB3LPENR_FSMCLPEN Flexible memory controller module clock enable during Sleep mode **/
...
/** RCC_APB1LPENR_DACLPEN DAC clock enable during Sleep mode **/
...
/** RCC_APB1LPENR_CAN3LPEN CAN3 clock enable during Sleep mode **/
#define RCC_APB1LPENR_CAN3LPEN		(1 << 27)
/** RCC_APB1LPENR_CAN2LPEN CAN2LPEN **/
#define RCC_APB1LPENR_CAN2LPEN		(1 << 26)
/** RCC_APB1LPENR_CAN1LPEN CAN1LPEN **/
#define RCC_APB1LPENR_CAN1LPEN		(1 << 25)
/** RCC_APB1LPENR_I2C4LPEN I2C4LPEN **/
...
/** RCC_APB1LPENR_USART5LPEN USART5 clock enable during Sleep mode **/
#define RCC_APB1LPENR_USART5LPEN		(1 << 20)
/** RCC_APB1LPENR_USART4LPEN USART4 clock enable during Sleep mode **/
#define RCC_APB1LPENR_USART4LPEN		(1 << 19)
/** RCC_APB1LPENR_USART3LPEN USART3LPEN **/
...
/** RCC_APB1LPENR_RTCAPBEN RTC APB clock enable during Sleep mode **/
#define RCC_APB1LPENR_RTCAPBEN		(1 << 10)
/** RCC_APB1LPENR_LPTIMER1LPEN TIM14 clock enable during Sleep mode **/
#define RCC_APB1LPENR_LPTIMER1LPEN		(1 << 9)
/** RCC_APB1LPENR_TIM14LPEN TIM14LPEN **/
#define RCC_APB1LPENR_TIM14LPEN		(1 << 8)
/** RCC_APB1LPENR_TIM13LPEN TIM13LPEN **/
#define RCC_APB1LPENR_TIM13LPEN		(1 << 7)
/** RCC_APB1LPENR_TIM12LPEN TIM12LPEN **/
#define RCC_APB1LPENR_TIM12LPEN		(1 << 6)
/** RCC_APB1LPENR_TIM7LPEN TIM7LPEN **/
#define RCC_APB1LPENR_TIM7LPEN		(1 << 5)
/** RCC_APB1LPENR_TIM6LPEN TIM6LPEN **/
...
/** RCC_APB2LPENR_DFSDM2LPEN DFSDM2 clock enable during Sleep mode **/
#define RCC_APB2LPENR_DFSDM2LPEN		(1 << 25)
/** RCC_APB2LPENR_DFSDMLPEN DFSDMLPEN **/
#define RCC_APB2LPENR_DFSDMLPEN		(1 << 24)
/** RCC_APB2LPENR_SAI1LPEN SAI1 clock enable during Sleep mode **/
#define RCC_APB2LPENR_SAI1LPEN		(1 << 22)
/** RCC_APB2LPENR_SPI5LPEN SPI5 clock enable during Sleep mode **/
...
/** RCC_APB2LPENR_EXTITEN EXTIT APB and SYSCTRL PFREE clock enable during Sleep mode **/
#define RCC_APB2LPENR_EXTITEN		(1 << 15)
...
/** RCC_APB2LPENR_SPI4LPEN SPI4 clock enable during Sleep mode **/
...
/** RCC_APB2LPENR_USART10LPEN USART10 clock enable during Sleep mode **/
#define RCC_APB2LPENR_USART10LPEN		(1 << 7)
/** RCC_APB2LPENR_USART9LPEN USART9 clock enable during Sleep mode **/
#define RCC_APB2LPENR_USART9LPEN		(1 << 6)
...
/** RCC_APB2LPENR_TIM8LPEN TIM8LPEN **/
...
/** RCC_BDCR_LSEMOD External low-speed oscillator bypass **/
...
#define RCC_PLLI2SCFGR_PLLI2SR_MASK		0x07
/** @defgroup rcc_plli2scfgr_plli2sr PLLI2SR PLLI2S division factor for I2S clocks
@{*/
/**@}*/


#define RCC_PLLI2SCFGR_PLLI2SQ_SHIFT		24
#define RCC_PLLI2SCFGR_PLLI2SQ_MASK		0x0f
/** @defgroup rcc_plli2scfgr_plli2sq PLLI2SQ PLLI2S division factor for USB OTG FS/SDIO/RNG clock
@{*/
/**@}*/

/** RCC_PLLI2SCFGR_PLLI2SSRC PLLI2S entry clock source **/
#define RCC_PLLI2SCFGR_PLLI2SSRC		(1 << 22)

#define RCC_PLLI2SCFGR_PLLI2SN_SHIFT		6
#define RCC_PLLI2SCFGR_PLLI2SN_MASK		0x1ff
/** @defgroup rcc_plli2scfgr_plli2sn PLLI2SN PLLI2S multiplication factor for VCO
@{*/
/**@}*/
...
/** @defgroup rcc_plli2scfgr_plli2sm PLLI2SM Division factor for the main PLL (PLL) and audio PLL (PLLI2S) input clock
@{*/
/**@}*/
...
/** @defgroup rcc_dckcfgr DCKCFGR Dedicated Clocks Configuration Register
@{*/


#define RCC_DCKCFGR_LPTIMER1SEL_SHIFT		30
#define RCC_DCKCFGR_LPTIMER1SEL_MASK		0x03
/** @defgroup rcc_dckcfgr_lptimer1sel LPTIMER1SEL LPTIMER1 kernel clock selection.
@{*/
/**@}*/


#define RCC_DCKCFGR_I2S2SRC_SHIFT		27
#define RCC_DCKCFGR_I2S2SRC_MASK		0x03
/** @defgroup rcc_dckcfgr_i2s2src I2S2SRC I2S APB2 clocks source selection (I2S1/4/5)
@{*/
/**@}*/


#define RCC_DCKCFGR_I2S1SRC_SHIFT		25
#define RCC_DCKCFGR_I2S1SRC_MASK		0x03
/** @defgroup rcc_dckcfgr_i2s1src I2S1SRC I2S APB1 clocks source selection (I2S2/3)
@{*/
/**@}*/

/** RCC_DCKCFGR_TIMPRE Timers clocks prescalers selection **/
#define RCC_DCKCFGR_TIMPRE		(1 << 24)
/** RCC_DCKCFGR_CKDFSDM1ASEL DFSDM1 audio clock selection. **/
#define RCC_DCKCFGR_CKDFSDM1ASEL		(1 << 15)

/**@}*/

/** @defgroup rcc_ckgatenr CKGATENR RCC clocks gated enable register
@{*/

/** RCC_CKGATENR_EVTCL_CKEN EVTCL_CKEN **/
#define RCC_CKGATENR_EVTCL_CKEN		(1 << 7)
/** RCC_CKGATENR_RCC_CKEN RCC clock enable **/
#define RCC_CKGATENR_RCC_CKEN		(1 << 6)
/** RCC_CKGATENR_FLITF_CKEN Flash Interface clock enable **/
#define RCC_CKGATENR_FLITF_CKEN		(1 << 5)
/** RCC_CKGATENR_SRAM_CKEN SRQAM controller clock enable **/
#define RCC_CKGATENR_SRAM_CKEN		(1 << 4)
/** RCC_CKGATENR_SPARE_CKEN Spare clock enable **/
#define RCC_CKGATENR_SPARE_CKEN		(1 << 3)
/** RCC_CKGATENR_CM4DBG_CKEN Cortex M4 ETM clock enable **/
#define RCC_CKGATENR_CM4DBG_CKEN		(1 << 2)
/** RCC_CKGATENR_AHB2APB2_CKEN AHB to APB2 Bridge clock enable **/
#define RCC_CKGATENR_AHB2APB2_CKEN		(1 << 1)
/** RCC_CKGATENR_AHB2APB1_CKEN AHB to APB1 Bridge clock enable **/
#define RCC_CKGATENR_AHB2APB1_CKEN		(1 << 0)

/**@}*/

/** @defgroup rcc_dckcfgr2 DCKCFGR2 Dedicated Clocks Configuration Register
@{*/

/** RCC_DCKCFGR2_CKSDIOSEL SDIO clock selection. **/
#define RCC_DCKCFGR2_CKSDIOSEL		(1 << 28)
/** RCC_DCKCFGR2_CK48MSEL SDIO/USBFS clock selection. **/
#define RCC_DCKCFGR2_CK48MSEL		(1 << 27)
/** RCC_DCKCFGR2_I2CFMP1SEL I2CFMP1 kernel clock source selection **/
#define RCC_DCKCFGR2_I2CFMP1SEL		(1 << 22)
