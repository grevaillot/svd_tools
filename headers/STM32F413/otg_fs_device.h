...
#define OTG_FS_DEVICE_FS_DSTS_DEVLNSTS_SHIFT		22
#define OTG_FS_DEVICE_FS_DSTS_DEVLNSTS_MASK		0x03
/** @defgroup otg_fs_device_fs_dsts_devlnsts DEVLNSTS Device line status
@{*/
/**@}*/
