...
/** FLASH_ECCR_ECCD2 ECC2 detection **/
#define FLASH_ECCR_ECCD2		(1 << 29)
/** FLASH_ECCR_ECCC2 ECC correction **/
#define FLASH_ECCR_ECCC2		(1 << 28)
/** FLASH_ECCR_ECCIE ECCIE **/
#define FLASH_ECCR_ECCIE		(1 << 24)
/** FLASH_ECCR_SYSF_ECC SYSF_ECC **/
#define FLASH_ECCR_SYSF_ECC		(1 << 22)
/** FLASH_ECCR_BK_ECC BK_ECC **/
...
/** @defgroup flash_sec1r SEC1R securable area bank1 register
@{*/

/** FLASH_SEC1R_BOOT_LOCK BOOT_LOCK **/
#define FLASH_SEC1R_BOOT_LOCK		(1 << 16)

#define FLASH_SEC1R_SEC_SIZE1_SHIFT		0
#define FLASH_SEC1R_SEC_SIZE1_MASK		0xff
/** @defgroup flash_sec1r_sec_size1 SECSIZE1 SEC_SIZE1
@{*/
/**@}*/
