...
/** ADC12_Common_CDR2 ADC x common regular data register for 32-bit dual mode **/
#define ADC12_Common_CDR2			MMIO32(ADC12_Common_BASE + 0x10)
...
/** ADC12_Common_CSR_EOSMP_SLV End of Sampling phase flag of the slave ADC **/
#define ADC12_Common_CSR_EOSMP_SLV		(1 << 17)
/** ADC12_Common_CSR_ADRDY_SLV Slave ADC ready **/
#define ADC12_Common_CSR_ADRDY_SLV		(1 << 16)
/** ADC12_Common_CSR_JQOVF_MST Injected Context Queue Overflow flag of the master ADC **/
#define ADC12_Common_CSR_JQOVF_MST		(1 << 10)
/** ADC12_Common_CSR_AWD3_MST Analog watchdog 3 flag of the master ADC **/
#define ADC12_Common_CSR_AWD3_MST		(1 << 9)
/** ADC12_Common_CSR_AWD2_MST Analog watchdog 2 flag of the master ADC **/
#define ADC12_Common_CSR_AWD2_MST		(1 << 8)
/** ADC12_Common_CSR_AWD1_MST Analog watchdog 1 flag of the master ADC **/
#define ADC12_Common_CSR_AWD1_MST		(1 << 7)
/** ADC12_Common_CSR_JEOS_MST End of injected sequence flag of the master ADC **/
#define ADC12_Common_CSR_JEOS_MST		(1 << 6)
/** ADC12_Common_CSR_JEOC_MST End of injected conversion flag of the master ADC **/
#define ADC12_Common_CSR_JEOC_MST		(1 << 5)
/** ADC12_Common_CSR_OVR_MST Overrun flag of the master ADC **/
#define ADC12_Common_CSR_OVR_MST		(1 << 4)
/** ADC12_Common_CSR_EOS_MST End of regular sequence flag of the master ADC **/
#define ADC12_Common_CSR_EOS_MST		(1 << 3)
/** ADC12_Common_CSR_EOC_MST End of regular conversion of the master ADC **/
#define ADC12_Common_CSR_EOC_MST		(1 << 2)
/** ADC12_Common_CSR_EOSMP_MST End of Sampling phase flag of the master ADC **/
#define ADC12_Common_CSR_EOSMP_MST		(1 << 1)
/** ADC12_Common_CSR_ADRDY_MST Master ADC ready **/
#define ADC12_Common_CSR_ADRDY_MST		(1 << 0)
...
/** ADC12_Common_CCR_VBATEN VBAT enable **/
#define ADC12_Common_CCR_VBATEN		(1 << 24)
/** ADC12_Common_CCR_TSEN Temperature sensor enable **/
#define ADC12_Common_CCR_TSEN		(1 << 23)
...
#define ADC12_Common_CCR_DAMDF_SHIFT		14
#define ADC12_Common_CCR_DAMDF_MASK		0x03
/** @defgroup adc12_common_ccr_damdf DAMDF Dual ADC Mode Data Format
@{*/
/**@}*/
...
/** @defgroup adc12_common_cdr2 CDR2 ADC x common regular data register for 32-bit dual mode
@{*/


#define ADC12_Common_CDR2_RDATA_ALT_SHIFT		0
#define ADC12_Common_CDR2_RDATA_ALT_MASK		0xffffffff
/** @defgroup adc12_common_cdr2_rdata_alt RDATAALT Regular data of the master/slave alternated ADCs
@{*/
/**@}*/
