...
/** USART1_PRESC USART prescaler register **/
...
/** USART1_CR2_DIS_NSS When the DSI_NSS bit is set, the NSS pin input is ignored **/
...
/** USART1_CR3_TCBGTIE Transmission Complete before guard time, interrupt enable **/
#define USART1_CR3_TCBGTIE		(1 << 24)
/** USART1_CR3_TXFTIE TXFIFO threshold interrupt enable **/
...
/** @defgroup usart1_brr_brr_4_15 BRR415 DIV_Mantissa
@{*/
/**@}*/
...
/** @defgroup usart1_brr_brr_0_3 BRR03 DIV_Fraction
@{*/
/**@}*/
...
/** USART1_ICR_TCBGTC Transmission complete before Guard time clear flag **/
#define USART1_ICR_TCBGTC		(1 << 7)
...
/** @defgroup usart1_presc PRESC USART prescaler register
@{*/
