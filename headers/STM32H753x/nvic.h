...
#define NVIC_ISER3			MMIO32(NVIC_BASE + 0x0c)
/** NVIC_ISER4 Interrupt Set-Enable Register **/
#define NVIC_ISER4			MMIO32(NVIC_BASE + 0x10)
...
#define NVIC_ICER3			MMIO32(NVIC_BASE + 0x8c)
/** NVIC_ICER4 Interrupt Clear-Enable Register **/
#define NVIC_ICER4			MMIO32(NVIC_BASE + 0x90)
...
#define NVIC_ISPR3			MMIO32(NVIC_BASE + 0x10c)
/** NVIC_ISPR4 Interrupt Set-Pending Register **/
#define NVIC_ISPR4			MMIO32(NVIC_BASE + 0x110)
...
/** NVIC_ICPR3 Interrupt Clear-Pending Register **/
#define NVIC_ICPR3			MMIO32(NVIC_BASE + 0x1c0)
/** NVIC_ICPR4 Interrupt Clear-Pending Register **/
#define NVIC_ICPR4			MMIO32(NVIC_BASE + 0x1c4)
...
#define NVIC_IABR3			MMIO32(NVIC_BASE + 0x20c)
/** NVIC_IABR4 Interrupt Active Bit Register **/
#define NVIC_IABR4			MMIO32(NVIC_BASE + 0x210)
...
/** @defgroup nvic_icpr3 ICPR3 Interrupt Clear-Pending Register
@{*/


/**@}*/

/** @defgroup nvic_icpr4 ICPR4 Interrupt Clear-Pending Register
@{*/
