...
/** @defgroup tim5_registers General purpose timer Register
@{*/
...
/** TIM5_OR option register **/
#define TIM5_OR			MMIO32(TIM5_BASE + 0x50)
...
#define TIM5_CCMR1_Input_IC1PSC_SHIFT		2
#define TIM5_CCMR1_Input_IC1PSC_MASK		0x03
/** @defgroup tim5_ccmr1_input_ic1psc IC1PSC Input capture 1 prescaler
@{*/
/**@}*/
...
/** TIM5_CCMR2_Output_O24CE Output compare 4 clear enable **/
...
/** TIM5_CCER_CC4NP Capture/Compare 3 output Polarity **/
...
#define TIM5_CNT_CNTH_SHIFT		16
#define TIM5_CNT_CNTH_MASK		0xffff
/** @defgroup tim5_cnt_cnth CNTH High counter value
@{*/
/**@}*/


#define TIM5_CNT_CNTL_SHIFT		0
#define TIM5_CNT_CNTL_MASK		0xffff
/** @defgroup tim5_cnt_cntl CNTL Low counter value
@{*/
/**@}*/
...
#define TIM5_ARR_ARRH_SHIFT		16
#define TIM5_ARR_ARRH_MASK		0xffff
/** @defgroup tim5_arr_arrh ARRH High Auto-reload value
@{*/
/**@}*/


#define TIM5_ARR_ARRL_SHIFT		0
#define TIM5_ARR_ARRL_MASK		0xffff
/** @defgroup tim5_arr_arrl ARRL Low Auto-reload value
@{*/
/**@}*/
...
#define TIM5_CCR1_CCR1H_SHIFT		16
#define TIM5_CCR1_CCR1H_MASK		0xffff
/** @defgroup tim5_ccr1_ccr1h CCR1H High Capture/Compare 1 value
@{*/
/**@}*/


#define TIM5_CCR1_CCR1L_SHIFT		0
#define TIM5_CCR1_CCR1L_MASK		0xffff
/** @defgroup tim5_ccr1_ccr1l CCR1L Low Capture/Compare 1 value
@{*/
/**@}*/
...
#define TIM5_CCR2_CCR2H_SHIFT		16
#define TIM5_CCR2_CCR2H_MASK		0xffff
/** @defgroup tim5_ccr2_ccr2h CCR2H High Capture/Compare 2 value
@{*/
/**@}*/


#define TIM5_CCR2_CCR2L_SHIFT		0
#define TIM5_CCR2_CCR2L_MASK		0xffff
/** @defgroup tim5_ccr2_ccr2l CCR2L Low Capture/Compare 2 value
@{*/
/**@}*/
...
#define TIM5_CCR3_CCR3H_SHIFT		16
#define TIM5_CCR3_CCR3H_MASK		0xffff
/** @defgroup tim5_ccr3_ccr3h CCR3H High Capture/Compare value
@{*/
/**@}*/


#define TIM5_CCR3_CCR3L_SHIFT		0
#define TIM5_CCR3_CCR3L_MASK		0xffff
/** @defgroup tim5_ccr3_ccr3l CCR3L Low Capture/Compare value
@{*/
/**@}*/
...
#define TIM5_CCR4_CCR4H_SHIFT		16
#define TIM5_CCR4_CCR4H_MASK		0xffff
/** @defgroup tim5_ccr4_ccr4h CCR4H High Capture/Compare value
@{*/
/**@}*/


#define TIM5_CCR4_CCR4L_SHIFT		0
#define TIM5_CCR4_CCR4L_MASK		0xffff
/** @defgroup tim5_ccr4_ccr4l CCR4L Low Capture/Compare value
@{*/
/**@}*/
...
/** @defgroup tim5_or OR option register
@{*/


#define TIM5_OR_IT4_RMP_SHIFT		6
#define TIM5_OR_IT4_RMP_MASK		0x03
/** @defgroup tim5_or_it4_rmp IT4RMP Timer Input 4 remap
@{*/
/**@}*/
