...
/** Flash_OBR_SDADC12_VDD_MONITOR SDADC12_VDD_MONITOR **/
#define Flash_OBR_SDADC12_VDD_MONITOR		(1 << 15)
/** Flash_OBR_SRAM_PARITY_CHECK SRAM_PARITY_CHECK **/
#define Flash_OBR_SRAM_PARITY_CHECK		(1 << 14)
...
/** Flash_OBR_LEVEL2_PROT Level 2 protection status **/
#define Flash_OBR_LEVEL2_PROT		(1 << 2)
/** Flash_OBR_LEVEL1_PROT Level 1 protection status **/
#define Flash_OBR_LEVEL1_PROT		(1 << 1)
