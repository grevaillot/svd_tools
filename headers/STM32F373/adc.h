...
#define ADC_JOFR1			MMIO32(ADC_BASE + 0x14)
/** ADC_JOFR2 injected channel data offset register x **/
#define ADC_JOFR2			MMIO32(ADC_BASE + 0x18)
/** ADC_JOFR3 injected channel data offset register x **/
#define ADC_JOFR3			MMIO32(ADC_BASE + 0x1c)
/** ADC_JOFR4 injected channel data offset register x **/
#define ADC_JOFR4			MMIO32(ADC_BASE + 0x20)
/** ADC_HTR watchdog higher threshold register **/
#define ADC_HTR			MMIO32(ADC_BASE + 0x24)
/** ADC_LTR watchdog lower threshold register **/
#define ADC_LTR			MMIO32(ADC_BASE + 0x28)
/** ADC_SQR1 regular sequence register 1 **/
#define ADC_SQR1			MMIO32(ADC_BASE + 0x2c)
/** ADC_SQR2 regular sequence register 2 **/
#define ADC_SQR2			MMIO32(ADC_BASE + 0x30)
/** ADC_SQR3 regular sequence register 3 **/
#define ADC_SQR3			MMIO32(ADC_BASE + 0x34)
/** ADC_JSQR injected sequence register **/
#define ADC_JSQR			MMIO32(ADC_BASE + 0x38)
/** ADC_JDR1 injected data register x **/
#define ADC_JDR1			MMIO32(ADC_BASE + 0x3c)
/** ADC_JDR2 injected data register x **/
#define ADC_JDR2			MMIO32(ADC_BASE + 0x40)
/** ADC_JDR3 injected data register x **/
#define ADC_JDR3			MMIO32(ADC_BASE + 0x44)
/** ADC_JDR4 injected data register x **/
#define ADC_JDR4			MMIO32(ADC_BASE + 0x48)
/** ADC_DR regular data register **/
#define ADC_DR			MMIO32(ADC_BASE + 0x4c)
...
#define ADC_CR2_EXTSEL_MASK		0x07
...
#define ADC_CR2_JEXTSEL_MASK		0x07
...
#define ADC_SMPR1_SMP17_SHIFT		21
#define ADC_SMPR1_SMP17_MASK		0x07
/** @defgroup adc_smpr1_smp17 SMP17 Channel 17 sampling time selection
@{*/
/**@}*/


#define ADC_SMPR1_SMP16_SHIFT		18
#define ADC_SMPR1_SMP16_MASK		0x07
/** @defgroup adc_smpr1_smp16 SMP16 Channel 16 sampling time selection
@{*/
/**@}*/


#define ADC_SMPR1_SMP15_SHIFT		15
#define ADC_SMPR1_SMP15_MASK		0x07
/** @defgroup adc_smpr1_smp15 SMP15 Channel 15 sampling time selection
@{*/
/**@}*/


#define ADC_SMPR1_SMP14_SHIFT		12
#define ADC_SMPR1_SMP14_MASK		0x07
/** @defgroup adc_smpr1_smp14 SMP14 Channel 14 sampling time selection
@{*/
/**@}*/


#define ADC_SMPR1_SMP13_SHIFT		9
#define ADC_SMPR1_SMP13_MASK		0x07
/** @defgroup adc_smpr1_smp13 SMP13 Channel 13 sampling time selection
@{*/
/**@}*/


#define ADC_SMPR1_SMP12_SHIFT		6
#define ADC_SMPR1_SMP12_MASK		0x07
/** @defgroup adc_smpr1_smp12 SMP12 Channel 12 sampling time selection
@{*/
/**@}*/


#define ADC_SMPR1_SMP11_SHIFT		3
#define ADC_SMPR1_SMP11_MASK		0x07
/** @defgroup adc_smpr1_smp11 SMP11 Channel 11 sampling time selection
@{*/
/**@}*/


#define ADC_SMPR1_SMP10_SHIFT		0
#define ADC_SMPR1_SMP10_MASK		0x07
/** @defgroup adc_smpr1_smp10 SMP10 Channel 10 sampling time selection
@{*/
/**@}*/
...
#define ADC_SMPR2_SMP9_SHIFT		27
#define ADC_SMPR2_SMP9_MASK		0x07
/** @defgroup adc_smpr2_smp9 SMP9 Channel 9 sampling time selection
@{*/
/**@}*/


#define ADC_SMPR2_SMP8_SHIFT		24
#define ADC_SMPR2_SMP8_MASK		0x07
/** @defgroup adc_smpr2_smp8 SMP8 Channel 8 sampling time selection
@{*/
/**@}*/


#define ADC_SMPR2_SMP7_SHIFT		21
#define ADC_SMPR2_SMP7_MASK		0x07
/** @defgroup adc_smpr2_smp7 SMP7 Channel 7 sampling time selection
@{*/
/**@}*/


#define ADC_SMPR2_SMP6_SHIFT		18
#define ADC_SMPR2_SMP6_MASK		0x07
/** @defgroup adc_smpr2_smp6 SMP6 Channel 6 sampling time selection
@{*/
/**@}*/


#define ADC_SMPR2_SMP5_SHIFT		15
#define ADC_SMPR2_SMP5_MASK		0x07
/** @defgroup adc_smpr2_smp5 SMP5 Channel 5 sampling time selection
@{*/
/**@}*/


#define ADC_SMPR2_SMP4_SHIFT		12
#define ADC_SMPR2_SMP4_MASK		0x07
/** @defgroup adc_smpr2_smp4 SMP4 Channel 4 sampling time selection
@{*/
/**@}*/


#define ADC_SMPR2_SMP3_SHIFT		9
#define ADC_SMPR2_SMP3_MASK		0x07
/** @defgroup adc_smpr2_smp3 SMP3 Channel 3 sampling time selection
@{*/
/**@}*/


#define ADC_SMPR2_SMP2_SHIFT		6
#define ADC_SMPR2_SMP2_MASK		0x07
/** @defgroup adc_smpr2_smp2 SMP2 Channel 2 sampling time selection
@{*/
/**@}*/


#define ADC_SMPR2_SMP1_SHIFT		3
#define ADC_SMPR2_SMP1_MASK		0x07
/** @defgroup adc_smpr2_smp1 SMP1 Channel 1 sampling time selection
@{*/
/**@}*/


#define ADC_SMPR2_SMP0_SHIFT		0
#define ADC_SMPR2_SMP0_MASK		0x07
/** @defgroup adc_smpr2_smp0 SMP0 Channel 0 sampling time selection
@{*/
/**@}*/
...
#define ADC_SQR1_SQ16_MASK		0x1f
/** @defgroup adc_sqr1_sq16 SQ16 16th conversion in regular sequence
@{*/
/**@}*/


#define ADC_SQR1_SQ15_SHIFT		10
#define ADC_SQR1_SQ15_MASK		0x1f
/** @defgroup adc_sqr1_sq15 SQ15 15th conversion in regular sequence
@{*/
/**@}*/


#define ADC_SQR1_SQ14_SHIFT		5
#define ADC_SQR1_SQ14_MASK		0x1f
/** @defgroup adc_sqr1_sq14 SQ14 14th conversion in regular sequence
@{*/
/**@}*/


#define ADC_SQR1_SQ13_SHIFT		0
#define ADC_SQR1_SQ13_MASK		0x1f
/** @defgroup adc_sqr1_sq13 SQ13 13th conversion in regular sequence
@{*/
/**@}*/
...
#define ADC_SQR2_SQ12_MASK		0x1f
/** @defgroup adc_sqr2_sq12 SQ12 12th conversion in regular sequence
@{*/
/**@}*/


#define ADC_SQR2_SQ11_SHIFT		20
#define ADC_SQR2_SQ11_MASK		0x1f
/** @defgroup adc_sqr2_sq11 SQ11 11th conversion in regular sequence
@{*/
/**@}*/


#define ADC_SQR2_SQ10_SHIFT		15
#define ADC_SQR2_SQ10_MASK		0x1f
/** @defgroup adc_sqr2_sq10 SQ10 10th conversion in regular sequence
@{*/
/**@}*/
...
#define ADC_SQR3_SQ6_SHIFT		25
#define ADC_SQR3_SQ6_MASK		0x1f
/** @defgroup adc_sqr3_sq6 SQ6 6th conversion in regular sequence
@{*/
/**@}*/


#define ADC_SQR3_SQ5_SHIFT		20
#define ADC_SQR3_SQ5_MASK		0x1f
/** @defgroup adc_sqr3_sq5 SQ5 5th conversion in regular sequence
@{*/
/**@}*/


#define ADC_SQR3_SQ4_SHIFT		15
#define ADC_SQR3_SQ4_MASK		0x1f
/** @defgroup adc_sqr3_sq4 SQ4 4th conversion in regular sequence
@{*/
/**@}*/


#define ADC_SQR3_SQ3_SHIFT		10
#define ADC_SQR3_SQ3_MASK		0x1f
/** @defgroup adc_sqr3_sq3 SQ3 3rd conversion in regular sequence
@{*/
/**@}*/


#define ADC_SQR3_SQ2_SHIFT		5
#define ADC_SQR3_SQ2_MASK		0x1f
/** @defgroup adc_sqr3_sq2 SQ2 2nd conversion in regular sequence
@{*/
/**@}*/


#define ADC_SQR3_SQ1_SHIFT		0
#define ADC_SQR3_SQ1_MASK		0x1f
/** @defgroup adc_sqr3_sq1 SQ1 1st conversion in regular sequence
@{*/
/**@}*/
...
/** @defgroup adc_dr_data DATA Regular data
@{*/
/**@}*/
