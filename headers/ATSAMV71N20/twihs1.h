...
/** TWIHS1_TWIHS_DR Debug Register **/
#define TWIHS1_TWIHS_DR			MMIO32(TWIHS1_BASE + 0xd0)
...
/** TWIHS1_TWIHS_VER Version Register **/
#define TWIHS1_TWIHS_VER			MMIO32(TWIHS1_BASE + 0xfc)
...
/** @defgroup twihs1_twihs_dr TWIHSDR Debug Register
@{*/

/** TWIHS1_TWIHS_DR_TRP Transfer Pending **/
#define TWIHS1_TWIHS_DR_TRP		(1 << 3)
/** TWIHS1_TWIHS_DR_SWMATCH SleepWalking Match **/
#define TWIHS1_TWIHS_DR_SWMATCH		(1 << 2)
/** TWIHS1_TWIHS_DR_CLKRQ Clock Request **/
#define TWIHS1_TWIHS_DR_CLKRQ		(1 << 1)
/** TWIHS1_TWIHS_DR_SWEN SleepWalking Enable **/
#define TWIHS1_TWIHS_DR_SWEN		(1 << 0)
...
/** @defgroup twihs1_twihs_ver TWIHSVER Version Register
@{*/


#define TWIHS1_TWIHS_VER_MFN_SHIFT		16
#define TWIHS1_TWIHS_VER_MFN_MASK		0x07
/** @defgroup twihs1_twihs_ver_mfn MFN Metal Fix Number
@{*/
/**@}*/


#define TWIHS1_TWIHS_VER_VERSION_SHIFT		0
#define TWIHS1_TWIHS_VER_VERSION_MASK		0xfff
/** @defgroup twihs1_twihs_ver_version VERSION Version of the Hardware Module
@{*/
/**@}*/
