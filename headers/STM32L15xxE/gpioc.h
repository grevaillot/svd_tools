...
#define GPIOC_MODER			MMIO32(GPIOC_BASE + 0xfffff800)
/** GPIOC_OTYPER GPIO port output type register **/
#define GPIOC_OTYPER			MMIO32(GPIOC_BASE + 0xfffff804)
/** GPIOC_OSPEEDER GPIO port output speed register **/
#define GPIOC_OSPEEDER			MMIO32(GPIOC_BASE + 0xfffff808)
/** GPIOC_PUPDR GPIO port pull-up/pull-down register **/
#define GPIOC_PUPDR			MMIO32(GPIOC_BASE + 0xfffff80c)
/** GPIOC_IDR GPIO port input data register **/
#define GPIOC_IDR			MMIO32(GPIOC_BASE + 0xfffff810)
/** GPIOC_ODR GPIO port output data register **/
#define GPIOC_ODR			MMIO32(GPIOC_BASE + 0xfffff814)
/** GPIOC_BSRR GPIO port bit set/reset register **/
#define GPIOC_BSRR			MMIO32(GPIOC_BASE + 0xfffff818)
/** GPIOC_LCKR GPIO port configuration lock register **/
#define GPIOC_LCKR			MMIO32(GPIOC_BASE + 0xfffff81c)
/** GPIOC_AFRL AFRL **/
#define GPIOC_AFRL			MMIO32(GPIOC_BASE + 0xfffff820)
/** GPIOC_AFRH GPIO alternate function high register **/
#define GPIOC_AFRH			MMIO32(GPIOC_BASE + 0xfffff824)
...
/** @defgroup gpioc_ospeeder OSPEEDER GPIO port output speed register
@{*/


#define GPIOC_OSPEEDER_OSPEEDR15_SHIFT		30
#define GPIOC_OSPEEDER_OSPEEDR15_MASK		0x03
/** @defgroup gpioc_ospeeder_ospeedr15 OSPEEDR15 OSPEEDR15
@{*/
/**@}*/


#define GPIOC_OSPEEDER_OSPEEDR14_SHIFT		28
#define GPIOC_OSPEEDER_OSPEEDR14_MASK		0x03
/** @defgroup gpioc_ospeeder_ospeedr14 OSPEEDR14 OSPEEDR14
@{*/
/**@}*/


#define GPIOC_OSPEEDER_OSPEEDR13_SHIFT		26
#define GPIOC_OSPEEDER_OSPEEDR13_MASK		0x03
/** @defgroup gpioc_ospeeder_ospeedr13 OSPEEDR13 OSPEEDR13
@{*/
/**@}*/


#define GPIOC_OSPEEDER_OSPEEDR12_SHIFT		24
#define GPIOC_OSPEEDER_OSPEEDR12_MASK		0x03
/** @defgroup gpioc_ospeeder_ospeedr12 OSPEEDR12 OSPEEDR12
@{*/
/**@}*/


#define GPIOC_OSPEEDER_OSPEEDR11_SHIFT		22
#define GPIOC_OSPEEDER_OSPEEDR11_MASK		0x03
/** @defgroup gpioc_ospeeder_ospeedr11 OSPEEDR11 OSPEEDR11
@{*/
/**@}*/


#define GPIOC_OSPEEDER_OSPEEDR10_SHIFT		20
#define GPIOC_OSPEEDER_OSPEEDR10_MASK		0x03
/** @defgroup gpioc_ospeeder_ospeedr10 OSPEEDR10 OSPEEDR10
@{*/
/**@}*/


#define GPIOC_OSPEEDER_OSPEEDR9_SHIFT		18
#define GPIOC_OSPEEDER_OSPEEDR9_MASK		0x03
/** @defgroup gpioc_ospeeder_ospeedr9 OSPEEDR9 OSPEEDR9
@{*/
/**@}*/


#define GPIOC_OSPEEDER_OSPEEDR8_SHIFT		16
#define GPIOC_OSPEEDER_OSPEEDR8_MASK		0x03
/** @defgroup gpioc_ospeeder_ospeedr8 OSPEEDR8 OSPEEDR8
@{*/
/**@}*/


#define GPIOC_OSPEEDER_OSPEEDR7_SHIFT		14
#define GPIOC_OSPEEDER_OSPEEDR7_MASK		0x03
/** @defgroup gpioc_ospeeder_ospeedr7 OSPEEDR7 OSPEEDR7
@{*/
/**@}*/


#define GPIOC_OSPEEDER_OSPEEDR6_SHIFT		12
#define GPIOC_OSPEEDER_OSPEEDR6_MASK		0x03
/** @defgroup gpioc_ospeeder_ospeedr6 OSPEEDR6 OSPEEDR6
@{*/
/**@}*/


#define GPIOC_OSPEEDER_OSPEEDR5_SHIFT		10
#define GPIOC_OSPEEDER_OSPEEDR5_MASK		0x03
/** @defgroup gpioc_ospeeder_ospeedr5 OSPEEDR5 OSPEEDR5
@{*/
/**@}*/


#define GPIOC_OSPEEDER_OSPEEDR4_SHIFT		8
#define GPIOC_OSPEEDER_OSPEEDR4_MASK		0x03
/** @defgroup gpioc_ospeeder_ospeedr4 OSPEEDR4 OSPEEDR4
@{*/
/**@}*/


#define GPIOC_OSPEEDER_OSPEEDR3_SHIFT		6
#define GPIOC_OSPEEDER_OSPEEDR3_MASK		0x03
/** @defgroup gpioc_ospeeder_ospeedr3 OSPEEDR3 OSPEEDR3
@{*/
/**@}*/


#define GPIOC_OSPEEDER_OSPEEDR2_SHIFT		4
#define GPIOC_OSPEEDER_OSPEEDR2_MASK		0x03
/** @defgroup gpioc_ospeeder_ospeedr2 OSPEEDR2 OSPEEDR2
@{*/
/**@}*/


#define GPIOC_OSPEEDER_OSPEEDR1_SHIFT		2
#define GPIOC_OSPEEDER_OSPEEDR1_MASK		0x03
/** @defgroup gpioc_ospeeder_ospeedr1 OSPEEDR1 OSPEEDR1
@{*/
/**@}*/


#define GPIOC_OSPEEDER_OSPEEDR0_SHIFT		0
#define GPIOC_OSPEEDER_OSPEEDR0_MASK		0x03
/** @defgroup gpioc_ospeeder_ospeedr0 OSPEEDR0 OSPEEDR0
@{*/
/**@}*/
