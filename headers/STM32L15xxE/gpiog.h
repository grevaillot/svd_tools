...
#define GPIOG_MODER			MMIO32(GPIOG_BASE + 0xfffff800)
/** GPIOG_OTYPER GPIO port output type register **/
#define GPIOG_OTYPER			MMIO32(GPIOG_BASE + 0xfffff804)
/** GPIOG_OSPEEDER GPIO port output speed register **/
#define GPIOG_OSPEEDER			MMIO32(GPIOG_BASE + 0xfffff808)
/** GPIOG_PUPDR GPIO port pull-up/pull-down register **/
#define GPIOG_PUPDR			MMIO32(GPIOG_BASE + 0xfffff80c)
/** GPIOG_IDR GPIO port input data register **/
#define GPIOG_IDR			MMIO32(GPIOG_BASE + 0xfffff810)
/** GPIOG_ODR GPIO port output data register **/
#define GPIOG_ODR			MMIO32(GPIOG_BASE + 0xfffff814)
/** GPIOG_BSRR GPIO port bit set/reset register **/
#define GPIOG_BSRR			MMIO32(GPIOG_BASE + 0xfffff818)
/** GPIOG_LCKR GPIO port configuration lock register **/
#define GPIOG_LCKR			MMIO32(GPIOG_BASE + 0xfffff81c)
/** GPIOG_AFRL AFRL **/
#define GPIOG_AFRL			MMIO32(GPIOG_BASE + 0xfffff820)
/** GPIOG_AFRH GPIO alternate function high register **/
#define GPIOG_AFRH			MMIO32(GPIOG_BASE + 0xfffff824)
...
/** @defgroup gpiog_ospeeder OSPEEDER GPIO port output speed register
@{*/


#define GPIOG_OSPEEDER_OSPEEDR15_SHIFT		30
#define GPIOG_OSPEEDER_OSPEEDR15_MASK		0x03
/** @defgroup gpiog_ospeeder_ospeedr15 OSPEEDR15 OSPEEDR15
@{*/
/**@}*/


#define GPIOG_OSPEEDER_OSPEEDR14_SHIFT		28
#define GPIOG_OSPEEDER_OSPEEDR14_MASK		0x03
/** @defgroup gpiog_ospeeder_ospeedr14 OSPEEDR14 OSPEEDR14
@{*/
/**@}*/


#define GPIOG_OSPEEDER_OSPEEDR13_SHIFT		26
#define GPIOG_OSPEEDER_OSPEEDR13_MASK		0x03
/** @defgroup gpiog_ospeeder_ospeedr13 OSPEEDR13 OSPEEDR13
@{*/
/**@}*/


#define GPIOG_OSPEEDER_OSPEEDR12_SHIFT		24
#define GPIOG_OSPEEDER_OSPEEDR12_MASK		0x03
/** @defgroup gpiog_ospeeder_ospeedr12 OSPEEDR12 OSPEEDR12
@{*/
/**@}*/


#define GPIOG_OSPEEDER_OSPEEDR11_SHIFT		22
#define GPIOG_OSPEEDER_OSPEEDR11_MASK		0x03
/** @defgroup gpiog_ospeeder_ospeedr11 OSPEEDR11 OSPEEDR11
@{*/
/**@}*/


#define GPIOG_OSPEEDER_OSPEEDR10_SHIFT		20
#define GPIOG_OSPEEDER_OSPEEDR10_MASK		0x03
/** @defgroup gpiog_ospeeder_ospeedr10 OSPEEDR10 OSPEEDR10
@{*/
/**@}*/


#define GPIOG_OSPEEDER_OSPEEDR9_SHIFT		18
#define GPIOG_OSPEEDER_OSPEEDR9_MASK		0x03
/** @defgroup gpiog_ospeeder_ospeedr9 OSPEEDR9 OSPEEDR9
@{*/
/**@}*/


#define GPIOG_OSPEEDER_OSPEEDR8_SHIFT		16
#define GPIOG_OSPEEDER_OSPEEDR8_MASK		0x03
/** @defgroup gpiog_ospeeder_ospeedr8 OSPEEDR8 OSPEEDR8
@{*/
/**@}*/


#define GPIOG_OSPEEDER_OSPEEDR7_SHIFT		14
#define GPIOG_OSPEEDER_OSPEEDR7_MASK		0x03
/** @defgroup gpiog_ospeeder_ospeedr7 OSPEEDR7 OSPEEDR7
@{*/
/**@}*/


#define GPIOG_OSPEEDER_OSPEEDR6_SHIFT		12
#define GPIOG_OSPEEDER_OSPEEDR6_MASK		0x03
/** @defgroup gpiog_ospeeder_ospeedr6 OSPEEDR6 OSPEEDR6
@{*/
/**@}*/


#define GPIOG_OSPEEDER_OSPEEDR5_SHIFT		10
#define GPIOG_OSPEEDER_OSPEEDR5_MASK		0x03
/** @defgroup gpiog_ospeeder_ospeedr5 OSPEEDR5 OSPEEDR5
@{*/
/**@}*/


#define GPIOG_OSPEEDER_OSPEEDR4_SHIFT		8
#define GPIOG_OSPEEDER_OSPEEDR4_MASK		0x03
/** @defgroup gpiog_ospeeder_ospeedr4 OSPEEDR4 OSPEEDR4
@{*/
/**@}*/


#define GPIOG_OSPEEDER_OSPEEDR3_SHIFT		6
#define GPIOG_OSPEEDER_OSPEEDR3_MASK		0x03
/** @defgroup gpiog_ospeeder_ospeedr3 OSPEEDR3 OSPEEDR3
@{*/
/**@}*/


#define GPIOG_OSPEEDER_OSPEEDR2_SHIFT		4
#define GPIOG_OSPEEDER_OSPEEDR2_MASK		0x03
/** @defgroup gpiog_ospeeder_ospeedr2 OSPEEDR2 OSPEEDR2
@{*/
/**@}*/


#define GPIOG_OSPEEDER_OSPEEDR1_SHIFT		2
#define GPIOG_OSPEEDER_OSPEEDR1_MASK		0x03
/** @defgroup gpiog_ospeeder_ospeedr1 OSPEEDR1 OSPEEDR1
@{*/
/**@}*/


#define GPIOG_OSPEEDER_OSPEEDR0_SHIFT		0
#define GPIOG_OSPEEDER_OSPEEDR0_MASK		0x03
/** @defgroup gpiog_ospeeder_ospeedr0 OSPEEDR0 OSPEEDR0
@{*/
/**@}*/
