...
#define GPIOF_MODER			MMIO32(GPIOF_BASE + 0xfffff800)
/** GPIOF_OTYPER GPIO port output type register **/
#define GPIOF_OTYPER			MMIO32(GPIOF_BASE + 0xfffff804)
/** GPIOF_OSPEEDER GPIO port output speed register **/
#define GPIOF_OSPEEDER			MMIO32(GPIOF_BASE + 0xfffff808)
/** GPIOF_PUPDR GPIO port pull-up/pull-down register **/
#define GPIOF_PUPDR			MMIO32(GPIOF_BASE + 0xfffff80c)
/** GPIOF_IDR GPIO port input data register **/
#define GPIOF_IDR			MMIO32(GPIOF_BASE + 0xfffff810)
/** GPIOF_ODR GPIO port output data register **/
#define GPIOF_ODR			MMIO32(GPIOF_BASE + 0xfffff814)
/** GPIOF_BSRR GPIO port bit set/reset register **/
#define GPIOF_BSRR			MMIO32(GPIOF_BASE + 0xfffff818)
/** GPIOF_LCKR GPIO port configuration lock register **/
#define GPIOF_LCKR			MMIO32(GPIOF_BASE + 0xfffff81c)
/** GPIOF_AFRL AFRL **/
#define GPIOF_AFRL			MMIO32(GPIOF_BASE + 0xfffff820)
/** GPIOF_AFRH GPIO alternate function high register **/
#define GPIOF_AFRH			MMIO32(GPIOF_BASE + 0xfffff824)
...
/** @defgroup gpiof_ospeeder OSPEEDER GPIO port output speed register
@{*/


#define GPIOF_OSPEEDER_OSPEEDR15_SHIFT		30
#define GPIOF_OSPEEDER_OSPEEDR15_MASK		0x03
/** @defgroup gpiof_ospeeder_ospeedr15 OSPEEDR15 OSPEEDR15
@{*/
/**@}*/


#define GPIOF_OSPEEDER_OSPEEDR14_SHIFT		28
#define GPIOF_OSPEEDER_OSPEEDR14_MASK		0x03
/** @defgroup gpiof_ospeeder_ospeedr14 OSPEEDR14 OSPEEDR14
@{*/
/**@}*/


#define GPIOF_OSPEEDER_OSPEEDR13_SHIFT		26
#define GPIOF_OSPEEDER_OSPEEDR13_MASK		0x03
/** @defgroup gpiof_ospeeder_ospeedr13 OSPEEDR13 OSPEEDR13
@{*/
/**@}*/


#define GPIOF_OSPEEDER_OSPEEDR12_SHIFT		24
#define GPIOF_OSPEEDER_OSPEEDR12_MASK		0x03
/** @defgroup gpiof_ospeeder_ospeedr12 OSPEEDR12 OSPEEDR12
@{*/
/**@}*/


#define GPIOF_OSPEEDER_OSPEEDR11_SHIFT		22
#define GPIOF_OSPEEDER_OSPEEDR11_MASK		0x03
/** @defgroup gpiof_ospeeder_ospeedr11 OSPEEDR11 OSPEEDR11
@{*/
/**@}*/


#define GPIOF_OSPEEDER_OSPEEDR10_SHIFT		20
#define GPIOF_OSPEEDER_OSPEEDR10_MASK		0x03
/** @defgroup gpiof_ospeeder_ospeedr10 OSPEEDR10 OSPEEDR10
@{*/
/**@}*/


#define GPIOF_OSPEEDER_OSPEEDR9_SHIFT		18
#define GPIOF_OSPEEDER_OSPEEDR9_MASK		0x03
/** @defgroup gpiof_ospeeder_ospeedr9 OSPEEDR9 OSPEEDR9
@{*/
/**@}*/


#define GPIOF_OSPEEDER_OSPEEDR8_SHIFT		16
#define GPIOF_OSPEEDER_OSPEEDR8_MASK		0x03
/** @defgroup gpiof_ospeeder_ospeedr8 OSPEEDR8 OSPEEDR8
@{*/
/**@}*/


#define GPIOF_OSPEEDER_OSPEEDR7_SHIFT		14
#define GPIOF_OSPEEDER_OSPEEDR7_MASK		0x03
/** @defgroup gpiof_ospeeder_ospeedr7 OSPEEDR7 OSPEEDR7
@{*/
/**@}*/


#define GPIOF_OSPEEDER_OSPEEDR6_SHIFT		12
#define GPIOF_OSPEEDER_OSPEEDR6_MASK		0x03
/** @defgroup gpiof_ospeeder_ospeedr6 OSPEEDR6 OSPEEDR6
@{*/
/**@}*/


#define GPIOF_OSPEEDER_OSPEEDR5_SHIFT		10
#define GPIOF_OSPEEDER_OSPEEDR5_MASK		0x03
/** @defgroup gpiof_ospeeder_ospeedr5 OSPEEDR5 OSPEEDR5
@{*/
/**@}*/


#define GPIOF_OSPEEDER_OSPEEDR4_SHIFT		8
#define GPIOF_OSPEEDER_OSPEEDR4_MASK		0x03
/** @defgroup gpiof_ospeeder_ospeedr4 OSPEEDR4 OSPEEDR4
@{*/
/**@}*/


#define GPIOF_OSPEEDER_OSPEEDR3_SHIFT		6
#define GPIOF_OSPEEDER_OSPEEDR3_MASK		0x03
/** @defgroup gpiof_ospeeder_ospeedr3 OSPEEDR3 OSPEEDR3
@{*/
/**@}*/


#define GPIOF_OSPEEDER_OSPEEDR2_SHIFT		4
#define GPIOF_OSPEEDER_OSPEEDR2_MASK		0x03
/** @defgroup gpiof_ospeeder_ospeedr2 OSPEEDR2 OSPEEDR2
@{*/
/**@}*/


#define GPIOF_OSPEEDER_OSPEEDR1_SHIFT		2
#define GPIOF_OSPEEDER_OSPEEDR1_MASK		0x03
/** @defgroup gpiof_ospeeder_ospeedr1 OSPEEDR1 OSPEEDR1
@{*/
/**@}*/


#define GPIOF_OSPEEDER_OSPEEDR0_SHIFT		0
#define GPIOF_OSPEEDER_OSPEEDR0_MASK		0x03
/** @defgroup gpiof_ospeeder_ospeedr0 OSPEEDR0 OSPEEDR0
@{*/
/**@}*/
