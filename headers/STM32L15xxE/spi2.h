...
#define SPI2_CR1			MMIO32(SPI2_BASE + 0xf800)
/** SPI2_CR2 control register 2 **/
#define SPI2_CR2			MMIO32(SPI2_BASE + 0xf804)
/** SPI2_SR status register **/
#define SPI2_SR			MMIO32(SPI2_BASE + 0xf808)
/** SPI2_DR data register **/
#define SPI2_DR			MMIO32(SPI2_BASE + 0xf80c)
/** SPI2_CRCPR CRC polynomial register **/
#define SPI2_CRCPR			MMIO32(SPI2_BASE + 0xf810)
/** SPI2_RXCRCR RX CRC register **/
#define SPI2_RXCRCR			MMIO32(SPI2_BASE + 0xf814)
/** SPI2_TXCRCR TX CRC register **/
#define SPI2_TXCRCR			MMIO32(SPI2_BASE + 0xf818)
/** SPI2_I2SCFGR I2S configuration register **/
#define SPI2_I2SCFGR			MMIO32(SPI2_BASE + 0xf81c)
/** SPI2_I2SPR I2S prescaler register **/
#define SPI2_I2SPR			MMIO32(SPI2_BASE + 0xf820)
