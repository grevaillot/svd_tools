...
/** GPIOA_OSPEEDER GPIO port output speed register **/
#define GPIOA_OSPEEDER			MMIO32(GPIOA_BASE + 0x08)
...
/** @defgroup gpioa_ospeeder OSPEEDER GPIO port output speed register
@{*/


#define GPIOA_OSPEEDER_OSPEEDR15_SHIFT		30
#define GPIOA_OSPEEDER_OSPEEDR15_MASK		0x03
/** @defgroup gpioa_ospeeder_ospeedr15 OSPEEDR15 OSPEEDR15
@{*/
/**@}*/


#define GPIOA_OSPEEDER_OSPEEDR14_SHIFT		28
#define GPIOA_OSPEEDER_OSPEEDR14_MASK		0x03
/** @defgroup gpioa_ospeeder_ospeedr14 OSPEEDR14 OSPEEDR14
@{*/
/**@}*/


#define GPIOA_OSPEEDER_OSPEEDR13_SHIFT		26
#define GPIOA_OSPEEDER_OSPEEDR13_MASK		0x03
/** @defgroup gpioa_ospeeder_ospeedr13 OSPEEDR13 OSPEEDR13
@{*/
/**@}*/


#define GPIOA_OSPEEDER_OSPEEDR12_SHIFT		24
#define GPIOA_OSPEEDER_OSPEEDR12_MASK		0x03
/** @defgroup gpioa_ospeeder_ospeedr12 OSPEEDR12 OSPEEDR12
@{*/
/**@}*/


#define GPIOA_OSPEEDER_OSPEEDR11_SHIFT		22
#define GPIOA_OSPEEDER_OSPEEDR11_MASK		0x03
/** @defgroup gpioa_ospeeder_ospeedr11 OSPEEDR11 OSPEEDR11
@{*/
/**@}*/


#define GPIOA_OSPEEDER_OSPEEDR10_SHIFT		20
#define GPIOA_OSPEEDER_OSPEEDR10_MASK		0x03
/** @defgroup gpioa_ospeeder_ospeedr10 OSPEEDR10 OSPEEDR10
@{*/
/**@}*/


#define GPIOA_OSPEEDER_OSPEEDR9_SHIFT		18
#define GPIOA_OSPEEDER_OSPEEDR9_MASK		0x03
/** @defgroup gpioa_ospeeder_ospeedr9 OSPEEDR9 OSPEEDR9
@{*/
/**@}*/


#define GPIOA_OSPEEDER_OSPEEDR8_SHIFT		16
#define GPIOA_OSPEEDER_OSPEEDR8_MASK		0x03
/** @defgroup gpioa_ospeeder_ospeedr8 OSPEEDR8 OSPEEDR8
@{*/
/**@}*/


#define GPIOA_OSPEEDER_OSPEEDR7_SHIFT		14
#define GPIOA_OSPEEDER_OSPEEDR7_MASK		0x03
/** @defgroup gpioa_ospeeder_ospeedr7 OSPEEDR7 OSPEEDR7
@{*/
/**@}*/


#define GPIOA_OSPEEDER_OSPEEDR6_SHIFT		12
#define GPIOA_OSPEEDER_OSPEEDR6_MASK		0x03
/** @defgroup gpioa_ospeeder_ospeedr6 OSPEEDR6 OSPEEDR6
@{*/
/**@}*/


#define GPIOA_OSPEEDER_OSPEEDR5_SHIFT		10
#define GPIOA_OSPEEDER_OSPEEDR5_MASK		0x03
/** @defgroup gpioa_ospeeder_ospeedr5 OSPEEDR5 OSPEEDR5
@{*/
/**@}*/


#define GPIOA_OSPEEDER_OSPEEDR4_SHIFT		8
#define GPIOA_OSPEEDER_OSPEEDR4_MASK		0x03
/** @defgroup gpioa_ospeeder_ospeedr4 OSPEEDR4 OSPEEDR4
@{*/
/**@}*/


#define GPIOA_OSPEEDER_OSPEEDR3_SHIFT		6
#define GPIOA_OSPEEDER_OSPEEDR3_MASK		0x03
/** @defgroup gpioa_ospeeder_ospeedr3 OSPEEDR3 OSPEEDR3
@{*/
/**@}*/


#define GPIOA_OSPEEDER_OSPEEDR2_SHIFT		4
#define GPIOA_OSPEEDER_OSPEEDR2_MASK		0x03
/** @defgroup gpioa_ospeeder_ospeedr2 OSPEEDR2 OSPEEDR2
@{*/
/**@}*/


#define GPIOA_OSPEEDER_OSPEEDR1_SHIFT		2
#define GPIOA_OSPEEDER_OSPEEDR1_MASK		0x03
/** @defgroup gpioa_ospeeder_ospeedr1 OSPEEDR1 OSPEEDR1
@{*/
/**@}*/


#define GPIOA_OSPEEDER_OSPEEDR0_SHIFT		0
#define GPIOA_OSPEEDER_OSPEEDR0_MASK		0x03
/** @defgroup gpioa_ospeeder_ospeedr0 OSPEEDR0 OSPEEDR0
@{*/
/**@}*/
