...
#define SPI1_CR1			MMIO32(SPI1_BASE + 0xf800)
/** SPI1_CR2 control register 2 **/
#define SPI1_CR2			MMIO32(SPI1_BASE + 0xf804)
/** SPI1_SR status register **/
#define SPI1_SR			MMIO32(SPI1_BASE + 0xf808)
/** SPI1_DR data register **/
#define SPI1_DR			MMIO32(SPI1_BASE + 0xf80c)
/** SPI1_CRCPR CRC polynomial register **/
#define SPI1_CRCPR			MMIO32(SPI1_BASE + 0xf810)
/** SPI1_RXCRCR RX CRC register **/
#define SPI1_RXCRCR			MMIO32(SPI1_BASE + 0xf814)
/** SPI1_TXCRCR TX CRC register **/
#define SPI1_TXCRCR			MMIO32(SPI1_BASE + 0xf818)
/** SPI1_I2SCFGR I2S configuration register **/
#define SPI1_I2SCFGR			MMIO32(SPI1_BASE + 0xf81c)
/** SPI1_I2SPR I2S prescaler register **/
#define SPI1_I2SPR			MMIO32(SPI1_BASE + 0xf820)
...
/** @defgroup spi1_i2scfgr I2SCFGR I2S configuration register
@{*/

/** SPI1_I2SCFGR_I2SMOD I2S mode selection **/
#define SPI1_I2SCFGR_I2SMOD		(1 << 11)
/** SPI1_I2SCFGR_I2SE I2S Enable **/
...
/** SPI1_I2SCFGR_CKPOL Steady state clock polarity **/
...
/** @defgroup spi1_i2spr I2SPR I2S prescaler register
@{*/
...
/** @defgroup spi1_i2spr_i2sdiv I2SDIV I2S Linear prescaler
@{*/
/**@}*/
