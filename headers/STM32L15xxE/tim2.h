...
#define TIM2_CR1			MMIO32(TIM2_BASE + 0xfffffc00)
/** TIM2_CR2 control register 2 **/
#define TIM2_CR2			MMIO32(TIM2_BASE + 0xfffffc04)
/** TIM2_SMCR slave mode control register **/
#define TIM2_SMCR			MMIO32(TIM2_BASE + 0xfffffc08)
/** TIM2_DIER Interrupt enable register **/
#define TIM2_DIER			MMIO32(TIM2_BASE + 0xfffffc0c)
/** TIM2_SR status register **/
#define TIM2_SR			MMIO32(TIM2_BASE + 0xfffffc10)
/** TIM2_EGR event generation register **/
#define TIM2_EGR			MMIO32(TIM2_BASE + 0xfffffc14)
/** TIM2_CCMR1_Output capture/compare mode register 1 **/
#define TIM2_CCMR1_Output			MMIO32(TIM2_BASE + 0xfffffc18)
/** TIM2_CCMR1_Input capture/compare mode register 1 (input mode) **/
#define TIM2_CCMR1_Input			MMIO32(TIM2_BASE + 0xfffffc18)
/** TIM2_CCMR2_Output capture/compare mode register 2 **/
#define TIM2_CCMR2_Output			MMIO32(TIM2_BASE + 0xfffffc1c)
/** TIM2_CCMR2_Input capture/compare mode register 2 (input mode) **/
#define TIM2_CCMR2_Input			MMIO32(TIM2_BASE + 0xfffffc1c)
/** TIM2_CCER capture/compare enable register **/
#define TIM2_CCER			MMIO32(TIM2_BASE + 0xfffffc20)
/** TIM2_CNT counter **/
#define TIM2_CNT			MMIO32(TIM2_BASE + 0xfffffc24)
/** TIM2_PSC prescaler **/
#define TIM2_PSC			MMIO32(TIM2_BASE + 0xfffffc28)
/** TIM2_ARR auto-reload register **/
#define TIM2_ARR			MMIO32(TIM2_BASE + 0xfffffc2c)
/** TIM2_CCR1 capture/compare register 1 **/
#define TIM2_CCR1			MMIO32(TIM2_BASE + 0xfffffc34)
/** TIM2_CCR2 capture/compare register 1 **/
#define TIM2_CCR2			MMIO32(TIM2_BASE + 0xfffffc38)
/** TIM2_CCR3 capture/compare register 1 **/
#define TIM2_CCR3			MMIO32(TIM2_BASE + 0xfffffc3c)
/** TIM2_CCR4 capture/compare register 1 **/
#define TIM2_CCR4			MMIO32(TIM2_BASE + 0xfffffc40)
/** TIM2_DCR DMA control register **/
#define TIM2_DCR			MMIO32(TIM2_BASE + 0xfffffc48)
/** TIM2_DMAR DMA address for full transfer **/
#define TIM2_DMAR			MMIO32(TIM2_BASE + 0xfffffc4c)
...
/** @defgroup tim2_dier DIER Interrupt enable register
@{*/
...
/** TIM2_SR_CC4OF Capture/compare 1 overcapture flag **/
...
/** @defgroup tim2_ccmr1_output CCMR1Output capture/compare mode register 1
@{*/
...
/** TIM2_CCMR1_Output_CC2S Capture/Compare 2 selection **/
#define TIM2_CCMR1_Output_CC2S		(1 << 8)
...
/** @defgroup tim2_ccmr2_output CCMR2Output capture/compare mode register 2
@{*/
...
/** TIM2_CCMR2_Output_CC4S Capture/Compare 4 selection **/
#define TIM2_CCMR2_Output_CC4S		(1 << 8)
...
/** TIM2_CCER_CC4P Capture/Compare 4 output Polarity **/
...
/** TIM2_CCER_CC1NP Capture/Compare 1 complementary output Polarity **/
...
/** @defgroup tim2_cnt_cnt CNT TIM2 counter
@{*/
/**@}*/
...
/** @defgroup tim2_psc_psc PSC TIM2 prescaler
@{*/
/**@}*/
...
/** @defgroup tim2_ccr2 CCR2 capture/compare register 1
@{*/
...
/** @defgroup tim2_ccr3 CCR3 capture/compare register 1
@{*/


#define TIM2_CCR3_CCR1_SHIFT		0
#define TIM2_CCR3_CCR1_MASK		0xffff
/** @defgroup tim2_ccr3_ccr1 CCR1 Capture/Compare 1 value
@{*/
/**@}*/
...
/** @defgroup tim2_ccr4 CCR4 capture/compare register 1
@{*/


#define TIM2_CCR4_CCR4_SHIFT		0
#define TIM2_CCR4_CCR4_MASK		0xffff
/** @defgroup tim2_ccr4_ccr4 CCR4 Capture/Compare 4 value
@{*/
/**@}*/
