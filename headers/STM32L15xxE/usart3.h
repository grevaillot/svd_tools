...
#define USART3_SR			MMIO32(USART3_BASE + 0xf000)
/** USART3_DR Data register **/
#define USART3_DR			MMIO32(USART3_BASE + 0xf004)
/** USART3_BRR Baud rate register **/
#define USART3_BRR			MMIO32(USART3_BASE + 0xf008)
/** USART3_CR1 Control register 1 **/
#define USART3_CR1			MMIO32(USART3_BASE + 0xf00c)
/** USART3_CR2 Control register 2 **/
#define USART3_CR2			MMIO32(USART3_BASE + 0xf010)
/** USART3_CR3 Control register 3 **/
#define USART3_CR3			MMIO32(USART3_BASE + 0xf014)
/** USART3_GTPR Guard time and prescaler register **/
#define USART3_GTPR			MMIO32(USART3_BASE + 0xf018)
