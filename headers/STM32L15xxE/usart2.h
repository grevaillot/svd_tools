...
#define USART2_SR			MMIO32(USART2_BASE + 0xf000)
/** USART2_DR Data register **/
#define USART2_DR			MMIO32(USART2_BASE + 0xf004)
/** USART2_BRR Baud rate register **/
#define USART2_BRR			MMIO32(USART2_BASE + 0xf008)
/** USART2_CR1 Control register 1 **/
#define USART2_CR1			MMIO32(USART2_BASE + 0xf00c)
/** USART2_CR2 Control register 2 **/
#define USART2_CR2			MMIO32(USART2_BASE + 0xf010)
/** USART2_CR3 Control register 3 **/
#define USART2_CR3			MMIO32(USART2_BASE + 0xf014)
/** USART2_GTPR Guard time and prescaler register **/
#define USART2_GTPR			MMIO32(USART2_BASE + 0xf018)
...
/** USART2_SR_NF Noise detected flag **/
#define USART2_SR_NF		(1 << 2)
