...
#define SPI3_CR1			MMIO32(SPI3_BASE + 0xf800)
/** SPI3_CR2 control register 2 **/
#define SPI3_CR2			MMIO32(SPI3_BASE + 0xf804)
/** SPI3_SR status register **/
#define SPI3_SR			MMIO32(SPI3_BASE + 0xf808)
/** SPI3_DR data register **/
#define SPI3_DR			MMIO32(SPI3_BASE + 0xf80c)
/** SPI3_CRCPR CRC polynomial register **/
#define SPI3_CRCPR			MMIO32(SPI3_BASE + 0xf810)
/** SPI3_RXCRCR RX CRC register **/
#define SPI3_RXCRCR			MMIO32(SPI3_BASE + 0xf814)
/** SPI3_TXCRCR TX CRC register **/
#define SPI3_TXCRCR			MMIO32(SPI3_BASE + 0xf818)
/** SPI3_I2SCFGR I2S configuration register **/
#define SPI3_I2SCFGR			MMIO32(SPI3_BASE + 0xf81c)
/** SPI3_I2SPR I2S prescaler register **/
#define SPI3_I2SPR			MMIO32(SPI3_BASE + 0xf820)
