...
#define TIM3_CR1			MMIO32(TIM3_BASE + 0xfffffc00)
/** TIM3_CR2 control register 2 **/
#define TIM3_CR2			MMIO32(TIM3_BASE + 0xfffffc04)
/** TIM3_SMCR slave mode control register **/
#define TIM3_SMCR			MMIO32(TIM3_BASE + 0xfffffc08)
/** TIM3_DIER Interrupt enable register **/
#define TIM3_DIER			MMIO32(TIM3_BASE + 0xfffffc0c)
/** TIM3_SR status register **/
#define TIM3_SR			MMIO32(TIM3_BASE + 0xfffffc10)
/** TIM3_EGR event generation register **/
#define TIM3_EGR			MMIO32(TIM3_BASE + 0xfffffc14)
/** TIM3_CCMR1_Output capture/compare mode register 1 **/
#define TIM3_CCMR1_Output			MMIO32(TIM3_BASE + 0xfffffc18)
/** TIM3_CCMR1_Input capture/compare mode register 1 (input mode) **/
#define TIM3_CCMR1_Input			MMIO32(TIM3_BASE + 0xfffffc18)
/** TIM3_CCMR2_Output capture/compare mode register 2 **/
#define TIM3_CCMR2_Output			MMIO32(TIM3_BASE + 0xfffffc1c)
/** TIM3_CCMR2_Input capture/compare mode register 2 (input mode) **/
#define TIM3_CCMR2_Input			MMIO32(TIM3_BASE + 0xfffffc1c)
/** TIM3_CCER capture/compare enable register **/
#define TIM3_CCER			MMIO32(TIM3_BASE + 0xfffffc20)
/** TIM3_CNT counter **/
#define TIM3_CNT			MMIO32(TIM3_BASE + 0xfffffc24)
/** TIM3_PSC prescaler **/
#define TIM3_PSC			MMIO32(TIM3_BASE + 0xfffffc28)
/** TIM3_ARR auto-reload register **/
#define TIM3_ARR			MMIO32(TIM3_BASE + 0xfffffc2c)
/** TIM3_CCR1 capture/compare register 1 **/
#define TIM3_CCR1			MMIO32(TIM3_BASE + 0xfffffc34)
/** TIM3_CCR2 capture/compare register 1 **/
#define TIM3_CCR2			MMIO32(TIM3_BASE + 0xfffffc38)
/** TIM3_CCR3 capture/compare register 1 **/
#define TIM3_CCR3			MMIO32(TIM3_BASE + 0xfffffc3c)
/** TIM3_CCR4 capture/compare register 1 **/
#define TIM3_CCR4			MMIO32(TIM3_BASE + 0xfffffc40)
/** TIM3_DCR DMA control register **/
#define TIM3_DCR			MMIO32(TIM3_BASE + 0xfffffc48)
/** TIM3_DMAR DMA address for full transfer **/
#define TIM3_DMAR			MMIO32(TIM3_BASE + 0xfffffc4c)
...
/** @defgroup tim3_dier DIER Interrupt enable register
@{*/
...
/** TIM3_SR_CC4OF Capture/compare 1 overcapture flag **/
...
/** @defgroup tim3_ccmr1_output CCMR1Output capture/compare mode register 1
@{*/
...
/** TIM3_CCMR1_Output_CC2S Capture/Compare 2 selection **/
#define TIM3_CCMR1_Output_CC2S		(1 << 8)
...
/** @defgroup tim3_ccmr2_output CCMR2Output capture/compare mode register 2
@{*/
...
/** TIM3_CCMR2_Output_CC4S Capture/Compare 4 selection **/
#define TIM3_CCMR2_Output_CC4S		(1 << 8)
...
/** TIM3_CCER_CC4P Capture/Compare 4 output Polarity **/
...
/** TIM3_CCER_CC1NP Capture/Compare 1 complementary output Polarity **/
...
/** @defgroup tim3_cnt_cnt CNT TIM2 counter
@{*/
/**@}*/
...
/** @defgroup tim3_psc_psc PSC TIM2 prescaler
@{*/
/**@}*/
...
/** @defgroup tim3_ccr2 CCR2 capture/compare register 1
@{*/
...
/** @defgroup tim3_ccr3 CCR3 capture/compare register 1
@{*/


#define TIM3_CCR3_CCR1_SHIFT		0
#define TIM3_CCR3_CCR1_MASK		0xffff
/** @defgroup tim3_ccr3_ccr1 CCR1 Capture/Compare 1 value
@{*/
/**@}*/
...
/** @defgroup tim3_ccr4 CCR4 capture/compare register 1
@{*/


#define TIM3_CCR4_CCR4_SHIFT		0
#define TIM3_CCR4_CCR4_MASK		0xffff
/** @defgroup tim3_ccr4_ccr4 CCR4 Capture/Compare 4 value
@{*/
/**@}*/
