...
#define USART1_SR			MMIO32(USART1_BASE + 0xf000)
/** USART1_DR Data register **/
#define USART1_DR			MMIO32(USART1_BASE + 0xf004)
/** USART1_BRR Baud rate register **/
#define USART1_BRR			MMIO32(USART1_BASE + 0xf008)
/** USART1_CR1 Control register 1 **/
#define USART1_CR1			MMIO32(USART1_BASE + 0xf00c)
/** USART1_CR2 Control register 2 **/
#define USART1_CR2			MMIO32(USART1_BASE + 0xf010)
/** USART1_CR3 Control register 3 **/
#define USART1_CR3			MMIO32(USART1_BASE + 0xf014)
/** USART1_GTPR Guard time and prescaler register **/
#define USART1_GTPR			MMIO32(USART1_BASE + 0xf018)
