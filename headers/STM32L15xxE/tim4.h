...
#define TIM4_CR1			MMIO32(TIM4_BASE + 0xfffffc00)
/** TIM4_CR2 control register 2 **/
#define TIM4_CR2			MMIO32(TIM4_BASE + 0xfffffc04)
/** TIM4_SMCR slave mode control register **/
#define TIM4_SMCR			MMIO32(TIM4_BASE + 0xfffffc08)
/** TIM4_DIER Interrupt enable register **/
#define TIM4_DIER			MMIO32(TIM4_BASE + 0xfffffc0c)
/** TIM4_SR status register **/
#define TIM4_SR			MMIO32(TIM4_BASE + 0xfffffc10)
/** TIM4_EGR event generation register **/
#define TIM4_EGR			MMIO32(TIM4_BASE + 0xfffffc14)
/** TIM4_CCMR1_Output capture/compare mode register 1 **/
#define TIM4_CCMR1_Output			MMIO32(TIM4_BASE + 0xfffffc18)
/** TIM4_CCMR1_Input capture/compare mode register 1 (input mode) **/
#define TIM4_CCMR1_Input			MMIO32(TIM4_BASE + 0xfffffc18)
/** TIM4_CCMR2_Output capture/compare mode register 2 **/
#define TIM4_CCMR2_Output			MMIO32(TIM4_BASE + 0xfffffc1c)
/** TIM4_CCMR2_Input capture/compare mode register 2 (input mode) **/
#define TIM4_CCMR2_Input			MMIO32(TIM4_BASE + 0xfffffc1c)
/** TIM4_CCER capture/compare enable register **/
#define TIM4_CCER			MMIO32(TIM4_BASE + 0xfffffc20)
/** TIM4_CNT counter **/
#define TIM4_CNT			MMIO32(TIM4_BASE + 0xfffffc24)
/** TIM4_PSC prescaler **/
#define TIM4_PSC			MMIO32(TIM4_BASE + 0xfffffc28)
/** TIM4_ARR auto-reload register **/
#define TIM4_ARR			MMIO32(TIM4_BASE + 0xfffffc2c)
/** TIM4_CCR1 capture/compare register 1 **/
#define TIM4_CCR1			MMIO32(TIM4_BASE + 0xfffffc34)
/** TIM4_CCR2 capture/compare register 1 **/
#define TIM4_CCR2			MMIO32(TIM4_BASE + 0xfffffc38)
/** TIM4_CCR3 capture/compare register 1 **/
#define TIM4_CCR3			MMIO32(TIM4_BASE + 0xfffffc3c)
/** TIM4_CCR4 capture/compare register 1 **/
#define TIM4_CCR4			MMIO32(TIM4_BASE + 0xfffffc40)
/** TIM4_DCR DMA control register **/
#define TIM4_DCR			MMIO32(TIM4_BASE + 0xfffffc48)
/** TIM4_DMAR DMA address for full transfer **/
#define TIM4_DMAR			MMIO32(TIM4_BASE + 0xfffffc4c)
...
/** @defgroup tim4_dier DIER Interrupt enable register
@{*/
...
/** TIM4_SR_CC4OF Capture/compare 1 overcapture flag **/
...
/** @defgroup tim4_ccmr1_output CCMR1Output capture/compare mode register 1
@{*/
...
/** TIM4_CCMR1_Output_CC2S Capture/Compare 2 selection **/
#define TIM4_CCMR1_Output_CC2S		(1 << 8)
...
/** @defgroup tim4_ccmr2_output CCMR2Output capture/compare mode register 2
@{*/
...
/** TIM4_CCMR2_Output_CC4S Capture/Compare 4 selection **/
#define TIM4_CCMR2_Output_CC4S		(1 << 8)
...
/** TIM4_CCER_CC4P Capture/Compare 4 output Polarity **/
...
/** TIM4_CCER_CC1NP Capture/Compare 1 complementary output Polarity **/
...
/** @defgroup tim4_cnt_cnt CNT TIM2 counter
@{*/
/**@}*/
...
/** @defgroup tim4_psc_psc PSC TIM2 prescaler
@{*/
/**@}*/
...
/** @defgroup tim4_ccr2 CCR2 capture/compare register 1
@{*/
...
/** @defgroup tim4_ccr3 CCR3 capture/compare register 1
@{*/


#define TIM4_CCR3_CCR1_SHIFT		0
#define TIM4_CCR3_CCR1_MASK		0xffff
/** @defgroup tim4_ccr3_ccr1 CCR1 Capture/Compare 1 value
@{*/
/**@}*/
...
/** @defgroup tim4_ccr4 CCR4 capture/compare register 1
@{*/


#define TIM4_CCR4_CCR4_SHIFT		0
#define TIM4_CCR4_CCR4_MASK		0xffff
/** @defgroup tim4_ccr4_ccr4 CCR4 Capture/Compare 4 value
@{*/
/**@}*/
