...
/** GPIOC_ASCR GPIO port analog switch control register **/
#define GPIOC_ASCR			MMIO32(GPIOC_BASE + 0x2c)
...
/** @defgroup gpioc_ascr ASCR GPIO port analog switch control register
@{*/

/** GPIOC_ASCR_ASC15 Port analog switch control **/
#define GPIOC_ASCR_ASC15		(1 << 15)
/** GPIOC_ASCR_ASC14 Port analog switch control **/
#define GPIOC_ASCR_ASC14		(1 << 14)
/** GPIOC_ASCR_ASC13 Port analog switch control **/
#define GPIOC_ASCR_ASC13		(1 << 13)
/** GPIOC_ASCR_ASC12 Port analog switch control **/
#define GPIOC_ASCR_ASC12		(1 << 12)
/** GPIOC_ASCR_ASC11 Port analog switch control **/
#define GPIOC_ASCR_ASC11		(1 << 11)
/** GPIOC_ASCR_ASC10 Port analog switch control **/
#define GPIOC_ASCR_ASC10		(1 << 10)
/** GPIOC_ASCR_ASC9 Port analog switch control **/
#define GPIOC_ASCR_ASC9		(1 << 9)
/** GPIOC_ASCR_ASC8 Port analog switch control **/
#define GPIOC_ASCR_ASC8		(1 << 8)
/** GPIOC_ASCR_ASC7 Port analog switch control **/
#define GPIOC_ASCR_ASC7		(1 << 7)
/** GPIOC_ASCR_ASC6 Port analog switch control **/
#define GPIOC_ASCR_ASC6		(1 << 6)
/** GPIOC_ASCR_ASC5 Port analog switch control **/
#define GPIOC_ASCR_ASC5		(1 << 5)
/** GPIOC_ASCR_ASC4 Port analog switch control **/
#define GPIOC_ASCR_ASC4		(1 << 4)
/** GPIOC_ASCR_ASC3 Port analog switch control **/
#define GPIOC_ASCR_ASC3		(1 << 3)
/** GPIOC_ASCR_ASC2 Port analog switch control **/
#define GPIOC_ASCR_ASC2		(1 << 2)
/** GPIOC_ASCR_ASC1 Port analog switch control **/
#define GPIOC_ASCR_ASC1		(1 << 1)
/** GPIOC_ASCR_ASC0 Port analog switch control **/
#define GPIOC_ASCR_ASC0		(1 << 0)
