...
/** @defgroup tim2_or OR TIM2 option register
@{*/


#define TIM2_OR_TI4_RMP_SHIFT		3
#define TIM2_OR_TI4_RMP_MASK		0x03
/** @defgroup tim2_or_ti4_rmp TI4RMP Internal trigger
@{*/
/**@}*/


#define TIM2_OR_ETR_RMP_SHIFT		0
#define TIM2_OR_ETR_RMP_MASK		0x07
/** @defgroup tim2_or_etr_rmp ETRRMP Timer2 ETR remap
@{*/
/**@}*/
