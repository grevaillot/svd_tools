...
/** GPIOA_ASCR GPIO port analog switch control register **/
#define GPIOA_ASCR			MMIO32(GPIOA_BASE + 0x2c)
...
/** @defgroup gpioa_ascr ASCR GPIO port analog switch control register
@{*/

/** GPIOA_ASCR_ASC15 Port analog switch control **/
#define GPIOA_ASCR_ASC15		(1 << 15)
/** GPIOA_ASCR_ASC14 Port analog switch control **/
#define GPIOA_ASCR_ASC14		(1 << 14)
/** GPIOA_ASCR_ASC13 Port analog switch control **/
#define GPIOA_ASCR_ASC13		(1 << 13)
/** GPIOA_ASCR_ASC12 Port analog switch control **/
#define GPIOA_ASCR_ASC12		(1 << 12)
/** GPIOA_ASCR_ASC11 Port analog switch control **/
#define GPIOA_ASCR_ASC11		(1 << 11)
/** GPIOA_ASCR_ASC10 Port analog switch control **/
#define GPIOA_ASCR_ASC10		(1 << 10)
/** GPIOA_ASCR_ASC9 Port analog switch control **/
#define GPIOA_ASCR_ASC9		(1 << 9)
/** GPIOA_ASCR_ASC8 Port analog switch control **/
#define GPIOA_ASCR_ASC8		(1 << 8)
/** GPIOA_ASCR_ASC7 Port analog switch control **/
#define GPIOA_ASCR_ASC7		(1 << 7)
/** GPIOA_ASCR_ASC6 Port analog switch control **/
#define GPIOA_ASCR_ASC6		(1 << 6)
/** GPIOA_ASCR_ASC5 Port analog switch control **/
#define GPIOA_ASCR_ASC5		(1 << 5)
/** GPIOA_ASCR_ASC4 Port analog switch control **/
#define GPIOA_ASCR_ASC4		(1 << 4)
/** GPIOA_ASCR_ASC3 Port analog switch control **/
#define GPIOA_ASCR_ASC3		(1 << 3)
/** GPIOA_ASCR_ASC2 Port analog switch control **/
#define GPIOA_ASCR_ASC2		(1 << 2)
/** GPIOA_ASCR_ASC1 Port analog switch control **/
#define GPIOA_ASCR_ASC1		(1 << 1)
/** GPIOA_ASCR_ASC0 Port analog switch control **/
#define GPIOA_ASCR_ASC0		(1 << 0)
