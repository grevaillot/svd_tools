...
/** PMC_PMC_PCK[0] Programmable Clock Register (chid = 0) 0 **/
#define PMC_PMC_PCK[0]			MMIO32(PMC_BASE + 0x40)
/** PMC_PMC_PCK[1] Programmable Clock Register (chid = 0) 0 **/
#define PMC_PMC_PCK[1]			MMIO32(PMC_BASE + 0x44)
/** PMC_PMC_PCK[2] Programmable Clock Register (chid = 0) 0 **/
#define PMC_PMC_PCK[2]			MMIO32(PMC_BASE + 0x48)
/** PMC_PMC_PCK[3] Programmable Clock Register (chid = 0) 0 **/
#define PMC_PMC_PCK[3]			MMIO32(PMC_BASE + 0x4c)
/** PMC_PMC_PCK[4] Programmable Clock Register (chid = 0) 0 **/
#define PMC_PMC_PCK[4]			MMIO32(PMC_BASE + 0x50)
/** PMC_PMC_PCK[5] Programmable Clock Register (chid = 0) 0 **/
#define PMC_PMC_PCK[5]			MMIO32(PMC_BASE + 0x54)
/** PMC_PMC_PCK[6] Programmable Clock Register (chid = 0) 0 **/
#define PMC_PMC_PCK[6]			MMIO32(PMC_BASE + 0x58)
/** PMC_PMC_PCK[7] Programmable Clock Register (chid = 0) 0 **/
...
/** PMC_PMC_VERSION Version Register **/
#define PMC_PMC_VERSION			MMIO32(PMC_BASE + 0xfc)
...
/** PMC_PMC_APLLACR Audio PLL Analog Configuration Register **/
#define PMC_PMC_APLLACR			MMIO32(PMC_BASE + 0x158)
/** PMC_PMC_WMST Wait Mode Startup Time Register **/
#define PMC_PMC_WMST			MMIO32(PMC_BASE + 0x15c)
...
/** @defgroup pmc_ckgr_uckr_upllcount UPLLCOUNT UTMI PLL Startup Time
@{*/
/**@}*/
...
/** @defgroup pmc_pmc_pck[0] PMCPCK[0] Programmable Clock Register (chid = 0) 0
@{*/
...
/** @defgroup pmc_pmc_pck[1] PMCPCK[1] Programmable Clock Register (chid = 0) 0
@{*/
...
/** @defgroup pmc_pmc_pck[2] PMCPCK[2] Programmable Clock Register (chid = 0) 0
@{*/
...
/** @defgroup pmc_pmc_pck[3] PMCPCK[3] Programmable Clock Register (chid = 0) 0
@{*/
...
/** @defgroup pmc_pmc_pck[4] PMCPCK[4] Programmable Clock Register (chid = 0) 0
@{*/
...
/** @defgroup pmc_pmc_pck[5] PMCPCK[5] Programmable Clock Register (chid = 0) 0
@{*/
...
/** @defgroup pmc_pmc_pck[6] PMCPCK[6] Programmable Clock Register (chid = 0) 0
@{*/
...
/** @defgroup pmc_pmc_pck[7] PMCPCK[7] Programmable Clock Register (chid = 0) 0
@{*/
...
/** PMC_PMC_SR_PCKRDY6 Programmable Clock Ready Status **/
#define PMC_PMC_SR_PCKRDY6		(1 << 14)
/** PMC_PMC_SR_PCKRDY5 Programmable Clock Ready Status **/
#define PMC_PMC_SR_PCKRDY5		(1 << 13)
/** PMC_PMC_SR_PCKRDY4 Programmable Clock Ready Status **/
#define PMC_PMC_SR_PCKRDY4		(1 << 12)
/** PMC_PMC_SR_PCKRDY3 Programmable Clock Ready Status **/
...
/** @defgroup pmc_pmc_version PMCVERSION Version Register
@{*/


#define PMC_PMC_VERSION_MFN_SHIFT		16
#define PMC_PMC_VERSION_MFN_MASK		0x07
/** @defgroup pmc_pmc_version_mfn MFN Metal Fix Number
@{*/
/**@}*/


#define PMC_PMC_VERSION_VERSION_SHIFT		0
#define PMC_PMC_VERSION_VERSION_MASK		0xfff
/** @defgroup pmc_pmc_version_version VERSION Version of the Hardware Module
@{*/
/**@}*/
...
/** PMC_PMC_SLPWK_ER0_PID21 Peripheral 21 SleepWalking Enable **/
#define PMC_PMC_SLPWK_ER0_PID21		(1 << 21)
...
/** PMC_PMC_SLPWK_ER0_PID18 Peripheral 18 SleepWalking Enable **/
#define PMC_PMC_SLPWK_ER0_PID18		(1 << 18)
/** PMC_PMC_SLPWK_ER0_PID17 Peripheral 17 SleepWalking Enable **/
#define PMC_PMC_SLPWK_ER0_PID17		(1 << 17)
/** PMC_PMC_SLPWK_ER0_PID16 Peripheral 16 SleepWalking Enable **/
#define PMC_PMC_SLPWK_ER0_PID16		(1 << 16)
/** PMC_PMC_SLPWK_ER0_PID15 Peripheral 15 SleepWalking Enable **/
#define PMC_PMC_SLPWK_ER0_PID15		(1 << 15)
...
/** PMC_PMC_SLPWK_ER0_PID12 Peripheral 12 SleepWalking Enable **/
#define PMC_PMC_SLPWK_ER0_PID12		(1 << 12)
...
/** PMC_PMC_SLPWK_ER0_PID9 Peripheral 9 SleepWalking Enable **/
#define PMC_PMC_SLPWK_ER0_PID9		(1 << 9)
...
/** PMC_PMC_SLPWK_DR0_PID21 Peripheral 21 SleepWalking Disable **/
#define PMC_PMC_SLPWK_DR0_PID21		(1 << 21)
...
/** PMC_PMC_SLPWK_DR0_PID18 Peripheral 18 SleepWalking Disable **/
#define PMC_PMC_SLPWK_DR0_PID18		(1 << 18)
/** PMC_PMC_SLPWK_DR0_PID17 Peripheral 17 SleepWalking Disable **/
#define PMC_PMC_SLPWK_DR0_PID17		(1 << 17)
/** PMC_PMC_SLPWK_DR0_PID16 Peripheral 16 SleepWalking Disable **/
#define PMC_PMC_SLPWK_DR0_PID16		(1 << 16)
/** PMC_PMC_SLPWK_DR0_PID15 Peripheral 15 SleepWalking Disable **/
#define PMC_PMC_SLPWK_DR0_PID15		(1 << 15)
...
/** PMC_PMC_SLPWK_DR0_PID12 Peripheral 12 SleepWalking Disable **/
#define PMC_PMC_SLPWK_DR0_PID12		(1 << 12)
...
/** PMC_PMC_SLPWK_DR0_PID9 Peripheral 9 SleepWalking Disable **/
#define PMC_PMC_SLPWK_DR0_PID9		(1 << 9)
...
/** PMC_PMC_SLPWK_SR0_PID21 Peripheral 21 SleepWalking Status **/
#define PMC_PMC_SLPWK_SR0_PID21		(1 << 21)
...
/** PMC_PMC_SLPWK_SR0_PID18 Peripheral 18 SleepWalking Status **/
#define PMC_PMC_SLPWK_SR0_PID18		(1 << 18)
/** PMC_PMC_SLPWK_SR0_PID17 Peripheral 17 SleepWalking Status **/
#define PMC_PMC_SLPWK_SR0_PID17		(1 << 17)
/** PMC_PMC_SLPWK_SR0_PID16 Peripheral 16 SleepWalking Status **/
#define PMC_PMC_SLPWK_SR0_PID16		(1 << 16)
/** PMC_PMC_SLPWK_SR0_PID15 Peripheral 15 SleepWalking Status **/
#define PMC_PMC_SLPWK_SR0_PID15		(1 << 15)
...
/** PMC_PMC_SLPWK_SR0_PID12 Peripheral 12 SleepWalking Status **/
#define PMC_PMC_SLPWK_SR0_PID12		(1 << 12)
...
/** PMC_PMC_SLPWK_SR0_PID9 Peripheral 9 SleepWalking Status **/
#define PMC_PMC_SLPWK_SR0_PID9		(1 << 9)
...
/** PMC_PMC_SLPWK_ASR0_PID21 Peripheral 21 Activity Status **/
#define PMC_PMC_SLPWK_ASR0_PID21		(1 << 21)
...
/** PMC_PMC_SLPWK_ASR0_PID18 Peripheral 18 Activity Status **/
#define PMC_PMC_SLPWK_ASR0_PID18		(1 << 18)
/** PMC_PMC_SLPWK_ASR0_PID17 Peripheral 17 Activity Status **/
#define PMC_PMC_SLPWK_ASR0_PID17		(1 << 17)
/** PMC_PMC_SLPWK_ASR0_PID16 Peripheral 16 Activity Status **/
#define PMC_PMC_SLPWK_ASR0_PID16		(1 << 16)
/** PMC_PMC_SLPWK_ASR0_PID15 Peripheral 15 Activity Status **/
#define PMC_PMC_SLPWK_ASR0_PID15		(1 << 15)
...
/** PMC_PMC_SLPWK_ASR0_PID12 Peripheral 12 Activity Status **/
#define PMC_PMC_SLPWK_ASR0_PID12		(1 << 12)
...
/** PMC_PMC_SLPWK_ASR0_PID9 Peripheral 9 Activity Status **/
#define PMC_PMC_SLPWK_ASR0_PID9		(1 << 9)
...
/** PMC_PMC_SLPWK_ER1_PID42 Peripheral 42 SleepWalking Enable **/
#define PMC_PMC_SLPWK_ER1_PID42		(1 << 10)
/** PMC_PMC_SLPWK_ER1_PID41 Peripheral 41 SleepWalking Enable **/
#define PMC_PMC_SLPWK_ER1_PID41		(1 << 9)
...
/** PMC_PMC_SLPWK_ER1_PID37 Peripheral 37 SleepWalking Enable **/
#define PMC_PMC_SLPWK_ER1_PID37		(1 << 5)
...
/** PMC_PMC_SLPWK_DR1_PID42 Peripheral 42 SleepWalking Disable **/
#define PMC_PMC_SLPWK_DR1_PID42		(1 << 10)
/** PMC_PMC_SLPWK_DR1_PID41 Peripheral 41 SleepWalking Disable **/
#define PMC_PMC_SLPWK_DR1_PID41		(1 << 9)
...
/** PMC_PMC_SLPWK_DR1_PID37 Peripheral 37 SleepWalking Disable **/
#define PMC_PMC_SLPWK_DR1_PID37		(1 << 5)
...
/** PMC_PMC_SLPWK_SR1_PID42 Peripheral 42 SleepWalking Status **/
#define PMC_PMC_SLPWK_SR1_PID42		(1 << 10)
/** PMC_PMC_SLPWK_SR1_PID41 Peripheral 41 SleepWalking Status **/
#define PMC_PMC_SLPWK_SR1_PID41		(1 << 9)
...
/** PMC_PMC_SLPWK_SR1_PID37 Peripheral 37 SleepWalking Status **/
#define PMC_PMC_SLPWK_SR1_PID37		(1 << 5)
...
/** PMC_PMC_SLPWK_ASR1_PID42 Peripheral 42 Activity Status **/
#define PMC_PMC_SLPWK_ASR1_PID42		(1 << 10)
/** PMC_PMC_SLPWK_ASR1_PID41 Peripheral 41 Activity Status **/
#define PMC_PMC_SLPWK_ASR1_PID41		(1 << 9)
...
/** PMC_PMC_SLPWK_ASR1_PID37 Peripheral 37 Activity Status **/
#define PMC_PMC_SLPWK_ASR1_PID37		(1 << 5)
...
/** @defgroup pmc_pmc_apllacr PMCAPLLACR Audio PLL Analog Configuration Register
@{*/


#define PMC_PMC_APLLACR_BIAS_SHIFT		8
#define PMC_PMC_APLLACR_BIAS_MASK		0x03
/** @defgroup pmc_pmc_apllacr_bias BIAS Bias Voltage Selection
@{*/
/**@}*/


#define PMC_PMC_APLLACR_FLTSEL_SHIFT		4
#define PMC_PMC_APLLACR_FLTSEL_MASK		0x0f
/** @defgroup pmc_pmc_apllacr_fltsel FLTSEL PLL Filter Selection
@{*/
/**@}*/


#define PMC_PMC_APLLACR_DCOFLTSEL_SHIFT		0
#define PMC_PMC_APLLACR_DCOFLTSEL_MASK		0x0f
/** @defgroup pmc_pmc_apllacr_dcofltsel DCOFLTSEL DCO Filter Selection
@{*/
/**@}*/
...
/** @defgroup pmc_pmc_wmst PMCWMST Wait Mode Startup Time Register
@{*/


#define PMC_PMC_WMST_KEY_SHIFT		24
#define PMC_PMC_WMST_KEY_MASK		0xff
/** @defgroup pmc_pmc_wmst_key KEY Write Access Password
@{*/
/**@}*/


#define PMC_PMC_WMST_WMST_SHIFT		0
#define PMC_PMC_WMST_WMST_MASK		0xff
/** @defgroup pmc_pmc_wmst_wmst WMST Wait Mode Startup Time
@{*/
/**@}*/
