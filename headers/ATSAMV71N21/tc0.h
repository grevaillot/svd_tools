...
/** TC0_TC_CHANNEL[0]_TC_CMR Channel Mode Register (channel = 0) **/
#define TC0_TC_CHANNEL[0]_TC_CMR			MMIO32(TC0_BASE + 0x04)
...
/** TC0_TC_CHANNEL[1]_TC_CMR Channel Mode Register (channel = 0) **/
#define TC0_TC_CHANNEL[1]_TC_CMR			MMIO32(TC0_BASE + 0x44)
...
/** TC0_TC_CHANNEL[2]_TC_CMR Channel Mode Register (channel = 0) **/
#define TC0_TC_CHANNEL[2]_TC_CMR			MMIO32(TC0_BASE + 0x84)
...
/** TC0_TC_VER Version Register **/
#define TC0_TC_VER			MMIO32(TC0_BASE + 0xfc)
...
/** @defgroup tc0_tc_channel[0]_tc_cmr TCCHANNEL[0]TCCMR Channel Mode Register (channel = 0)
@{*/


#define TC0_TC_CHANNEL[0]_TC_CMR_SBSMPLR_SHIFT		20
#define TC0_TC_CHANNEL[0]_TC_CMR_SBSMPLR_MASK		0x07
/** @defgroup tc0_tc_channel[0]_tc_cmr_sbsmplr SBSMPLR Loading Edge Subsampling Ratio
@{*/
/**@}*/


#define TC0_TC_CHANNEL[0]_TC_CMR_LDRB_SHIFT		18
#define TC0_TC_CHANNEL[0]_TC_CMR_LDRB_MASK		0x03
/** @defgroup tc0_tc_channel[0]_tc_cmr_ldrb LDRB RB Loading Edge Selection
@{*/
/**@}*/


#define TC0_TC_CHANNEL[0]_TC_CMR_LDRA_SHIFT		16
#define TC0_TC_CHANNEL[0]_TC_CMR_LDRA_MASK		0x03
/** @defgroup tc0_tc_channel[0]_tc_cmr_ldra LDRA RA Loading Edge Selection
@{*/
/**@}*/

/** TC0_TC_CHANNEL[0]_TC_CMR_WAVE Waveform Mode **/
#define TC0_TC_CHANNEL[0]_TC_CMR_WAVE		(1 << 15)
/** TC0_TC_CHANNEL[0]_TC_CMR_CPCTRG RC Compare Trigger Enable **/
#define TC0_TC_CHANNEL[0]_TC_CMR_CPCTRG		(1 << 14)
/** TC0_TC_CHANNEL[0]_TC_CMR_ABETRG TIOAx or TIOBx External Trigger Selection **/
#define TC0_TC_CHANNEL[0]_TC_CMR_ABETRG		(1 << 10)

#define TC0_TC_CHANNEL[0]_TC_CMR_ETRGEDG_SHIFT		8
#define TC0_TC_CHANNEL[0]_TC_CMR_ETRGEDG_MASK		0x03
/** @defgroup tc0_tc_channel[0]_tc_cmr_etrgedg ETRGEDG External Trigger Edge Selection
@{*/
/**@}*/

/** TC0_TC_CHANNEL[0]_TC_CMR_LDBDIS Counter Clock Disable with RB Loading **/
#define TC0_TC_CHANNEL[0]_TC_CMR_LDBDIS		(1 << 7)
/** TC0_TC_CHANNEL[0]_TC_CMR_LDBSTOP Counter Clock Stopped with RB Loading **/
#define TC0_TC_CHANNEL[0]_TC_CMR_LDBSTOP		(1 << 6)

#define TC0_TC_CHANNEL[0]_TC_CMR_BURST_SHIFT		4
#define TC0_TC_CHANNEL[0]_TC_CMR_BURST_MASK		0x03
/** @defgroup tc0_tc_channel[0]_tc_cmr_burst BURST Burst Signal Selection
@{*/
/**@}*/

/** TC0_TC_CHANNEL[0]_TC_CMR_CLKI Clock Invert **/
#define TC0_TC_CHANNEL[0]_TC_CMR_CLKI		(1 << 3)

#define TC0_TC_CHANNEL[0]_TC_CMR_TCCLKS_SHIFT		0
#define TC0_TC_CHANNEL[0]_TC_CMR_TCCLKS_MASK		0x07
/** @defgroup tc0_tc_channel[0]_tc_cmr_tcclks TCCLKS Clock Selection
@{*/
/**@}*/
...
/** @defgroup tc0_tc_channel[1]_tc_cmr TCCHANNEL[1]TCCMR Channel Mode Register (channel = 0)
@{*/


#define TC0_TC_CHANNEL[1]_TC_CMR_SBSMPLR_SHIFT		20
#define TC0_TC_CHANNEL[1]_TC_CMR_SBSMPLR_MASK		0x07
/** @defgroup tc0_tc_channel[1]_tc_cmr_sbsmplr SBSMPLR Loading Edge Subsampling Ratio
@{*/
/**@}*/


#define TC0_TC_CHANNEL[1]_TC_CMR_LDRB_SHIFT		18
#define TC0_TC_CHANNEL[1]_TC_CMR_LDRB_MASK		0x03
/** @defgroup tc0_tc_channel[1]_tc_cmr_ldrb LDRB RB Loading Edge Selection
@{*/
/**@}*/


#define TC0_TC_CHANNEL[1]_TC_CMR_LDRA_SHIFT		16
#define TC0_TC_CHANNEL[1]_TC_CMR_LDRA_MASK		0x03
/** @defgroup tc0_tc_channel[1]_tc_cmr_ldra LDRA RA Loading Edge Selection
@{*/
/**@}*/

/** TC0_TC_CHANNEL[1]_TC_CMR_WAVE Waveform Mode **/
#define TC0_TC_CHANNEL[1]_TC_CMR_WAVE		(1 << 15)
/** TC0_TC_CHANNEL[1]_TC_CMR_CPCTRG RC Compare Trigger Enable **/
#define TC0_TC_CHANNEL[1]_TC_CMR_CPCTRG		(1 << 14)
/** TC0_TC_CHANNEL[1]_TC_CMR_ABETRG TIOAx or TIOBx External Trigger Selection **/
#define TC0_TC_CHANNEL[1]_TC_CMR_ABETRG		(1 << 10)

#define TC0_TC_CHANNEL[1]_TC_CMR_ETRGEDG_SHIFT		8
#define TC0_TC_CHANNEL[1]_TC_CMR_ETRGEDG_MASK		0x03
/** @defgroup tc0_tc_channel[1]_tc_cmr_etrgedg ETRGEDG External Trigger Edge Selection
@{*/
/**@}*/

/** TC0_TC_CHANNEL[1]_TC_CMR_LDBDIS Counter Clock Disable with RB Loading **/
#define TC0_TC_CHANNEL[1]_TC_CMR_LDBDIS		(1 << 7)
/** TC0_TC_CHANNEL[1]_TC_CMR_LDBSTOP Counter Clock Stopped with RB Loading **/
#define TC0_TC_CHANNEL[1]_TC_CMR_LDBSTOP		(1 << 6)

#define TC0_TC_CHANNEL[1]_TC_CMR_BURST_SHIFT		4
#define TC0_TC_CHANNEL[1]_TC_CMR_BURST_MASK		0x03
/** @defgroup tc0_tc_channel[1]_tc_cmr_burst BURST Burst Signal Selection
@{*/
/**@}*/

/** TC0_TC_CHANNEL[1]_TC_CMR_CLKI Clock Invert **/
#define TC0_TC_CHANNEL[1]_TC_CMR_CLKI		(1 << 3)

#define TC0_TC_CHANNEL[1]_TC_CMR_TCCLKS_SHIFT		0
#define TC0_TC_CHANNEL[1]_TC_CMR_TCCLKS_MASK		0x07
/** @defgroup tc0_tc_channel[1]_tc_cmr_tcclks TCCLKS Clock Selection
@{*/
/**@}*/
...
/** @defgroup tc0_tc_channel[2]_tc_cmr TCCHANNEL[2]TCCMR Channel Mode Register (channel = 0)
@{*/


#define TC0_TC_CHANNEL[2]_TC_CMR_SBSMPLR_SHIFT		20
#define TC0_TC_CHANNEL[2]_TC_CMR_SBSMPLR_MASK		0x07
/** @defgroup tc0_tc_channel[2]_tc_cmr_sbsmplr SBSMPLR Loading Edge Subsampling Ratio
@{*/
/**@}*/


#define TC0_TC_CHANNEL[2]_TC_CMR_LDRB_SHIFT		18
#define TC0_TC_CHANNEL[2]_TC_CMR_LDRB_MASK		0x03
/** @defgroup tc0_tc_channel[2]_tc_cmr_ldrb LDRB RB Loading Edge Selection
@{*/
/**@}*/


#define TC0_TC_CHANNEL[2]_TC_CMR_LDRA_SHIFT		16
#define TC0_TC_CHANNEL[2]_TC_CMR_LDRA_MASK		0x03
/** @defgroup tc0_tc_channel[2]_tc_cmr_ldra LDRA RA Loading Edge Selection
@{*/
/**@}*/

/** TC0_TC_CHANNEL[2]_TC_CMR_WAVE Waveform Mode **/
#define TC0_TC_CHANNEL[2]_TC_CMR_WAVE		(1 << 15)
/** TC0_TC_CHANNEL[2]_TC_CMR_CPCTRG RC Compare Trigger Enable **/
#define TC0_TC_CHANNEL[2]_TC_CMR_CPCTRG		(1 << 14)
/** TC0_TC_CHANNEL[2]_TC_CMR_ABETRG TIOAx or TIOBx External Trigger Selection **/
#define TC0_TC_CHANNEL[2]_TC_CMR_ABETRG		(1 << 10)

#define TC0_TC_CHANNEL[2]_TC_CMR_ETRGEDG_SHIFT		8
#define TC0_TC_CHANNEL[2]_TC_CMR_ETRGEDG_MASK		0x03
/** @defgroup tc0_tc_channel[2]_tc_cmr_etrgedg ETRGEDG External Trigger Edge Selection
@{*/
/**@}*/

/** TC0_TC_CHANNEL[2]_TC_CMR_LDBDIS Counter Clock Disable with RB Loading **/
#define TC0_TC_CHANNEL[2]_TC_CMR_LDBDIS		(1 << 7)
/** TC0_TC_CHANNEL[2]_TC_CMR_LDBSTOP Counter Clock Stopped with RB Loading **/
#define TC0_TC_CHANNEL[2]_TC_CMR_LDBSTOP		(1 << 6)

#define TC0_TC_CHANNEL[2]_TC_CMR_BURST_SHIFT		4
#define TC0_TC_CHANNEL[2]_TC_CMR_BURST_MASK		0x03
/** @defgroup tc0_tc_channel[2]_tc_cmr_burst BURST Burst Signal Selection
@{*/
/**@}*/

/** TC0_TC_CHANNEL[2]_TC_CMR_CLKI Clock Invert **/
#define TC0_TC_CHANNEL[2]_TC_CMR_CLKI		(1 << 3)

#define TC0_TC_CHANNEL[2]_TC_CMR_TCCLKS_SHIFT		0
#define TC0_TC_CHANNEL[2]_TC_CMR_TCCLKS_MASK		0x07
/** @defgroup tc0_tc_channel[2]_tc_cmr_tcclks TCCLKS Clock Selection
@{*/
/**@}*/
...
/** @defgroup tc0_tc_ver TCVER Version Register
@{*/


#define TC0_TC_VER_MFN_SHIFT		16
#define TC0_TC_VER_MFN_MASK		0x07
/** @defgroup tc0_tc_ver_mfn MFN Metal Fix Number
@{*/
/**@}*/


#define TC0_TC_VER_VERSION_SHIFT		0
#define TC0_TC_VER_VERSION_MASK		0xfff
/** @defgroup tc0_tc_ver_version VERSION Version of the Hardware Module
@{*/
/**@}*/
