...
/** Ethernet_MMC_MMCCR_MCFHP no description available **/
#define Ethernet_MMC_MMCCR_MCFHP		(1 << 5)
/** Ethernet_MMC_MMCCR_MCP no description available **/
#define Ethernet_MMC_MMCCR_MCP		(1 << 4)
/** Ethernet_MMC_MMCCR_MCF no description available **/
#define Ethernet_MMC_MMCCR_MCF		(1 << 3)
/** Ethernet_MMC_MMCCR_ROR no description available **/
#define Ethernet_MMC_MMCCR_ROR		(1 << 2)
/** Ethernet_MMC_MMCCR_CSR no description available **/
#define Ethernet_MMC_MMCCR_CSR		(1 << 1)
/** Ethernet_MMC_MMCCR_CR no description available **/
...
/** Ethernet_MMC_MMCRIR_RGUFS no description available **/
#define Ethernet_MMC_MMCRIR_RGUFS		(1 << 17)
/** Ethernet_MMC_MMCRIR_RFAES no description available **/
#define Ethernet_MMC_MMCRIR_RFAES		(1 << 6)
/** Ethernet_MMC_MMCRIR_RFCES no description available **/
...
/** Ethernet_MMC_MMCTIR_TGFS no description available **/
#define Ethernet_MMC_MMCTIR_TGFS		(1 << 21)
/** Ethernet_MMC_MMCTIR_TGFMSCS no description available **/
#define Ethernet_MMC_MMCTIR_TGFMSCS		(1 << 15)
/** Ethernet_MMC_MMCTIR_TGFSCS no description available **/
...
/** Ethernet_MMC_MMCRIMR_RGUFM no description available **/
#define Ethernet_MMC_MMCRIMR_RGUFM		(1 << 17)
/** Ethernet_MMC_MMCRIMR_RFAEM no description available **/
#define Ethernet_MMC_MMCRIMR_RFAEM		(1 << 6)
/** Ethernet_MMC_MMCRIMR_RFCEM no description available **/
...
/** Ethernet_MMC_MMCTIMR_TGFM no description available **/
#define Ethernet_MMC_MMCTIMR_TGFM		(1 << 16)
/** Ethernet_MMC_MMCTIMR_TGFMSCM no description available **/
#define Ethernet_MMC_MMCTIMR_TGFMSCM		(1 << 15)
/** Ethernet_MMC_MMCTIMR_TGFSCM no description available **/
...
/** @defgroup ethernet_mmc_mmctgfsccr_tgfscc TGFSCC no description available
@{*/
/**@}*/
...
/** @defgroup ethernet_mmc_mmctgfmsccr_tgfmscc TGFMSCC no description available
@{*/
/**@}*/
...
/** @defgroup ethernet_mmc_mmcrfcecr_rfcfc RFCFC no description available
@{*/
/**@}*/
...
/** @defgroup ethernet_mmc_mmcrfaecr_rfaec RFAEC no description available
@{*/
/**@}*/
...
/** @defgroup ethernet_mmc_mmcrgufcr_rgufc RGUFC no description available
@{*/
/**@}*/
