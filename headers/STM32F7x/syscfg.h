...
#define SYSCFG_MEMRM_SWP_FMC_SHIFT		10
#define SYSCFG_MEMRM_SWP_FMC_MASK		0x03
/** @defgroup syscfg_memrm_swp_fmc SWPFMC FMC memory mapping swap
@{*/
/**@}*/

/** SYSCFG_MEMRM_FB_MODE Flash bank mode selection **/
#define SYSCFG_MEMRM_FB_MODE		(1 << 8)

#define SYSCFG_MEMRM_MEM_MODE_SHIFT		0
#define SYSCFG_MEMRM_MEM_MODE_MASK		0x07
/** @defgroup syscfg_memrm_mem_mode MEMMODE Memory mapping selection
@{*/
/**@}*/
...
/** SYSCFG_PMC_MII_RMII_SEL Ethernet PHY interface selection **/
#define SYSCFG_PMC_MII_RMII_SEL		(1 << 23)
/** SYSCFG_PMC_ADC3DC2 ADC3DC2 **/
#define SYSCFG_PMC_ADC3DC2		(1 << 18)
/** SYSCFG_PMC_ADC2DC2 ADC2DC2 **/
#define SYSCFG_PMC_ADC2DC2		(1 << 17)
