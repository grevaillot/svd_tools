...
#define OTG_FS_DEVICE_OTG_FS_DIEPTSIZ4			MMIO32(OTG_FS_DEVICE_BASE + 0x194)
/** OTG_FS_DEVICE_OTG_FS_DTXFSTS4 OTG_FS device IN endpoint transmit FIFO status register **/
#define OTG_FS_DEVICE_OTG_FS_DTXFSTS4			MMIO32(OTG_FS_DEVICE_BASE + 0x19c)
...
/** OTG_FS_DEVICE_OTG_FS_DIEPTSIZ55 device endpoint-5 transfer size register **/
#define OTG_FS_DEVICE_OTG_FS_DIEPTSIZ55			MMIO32(OTG_FS_DEVICE_BASE + 0x1b0)
/** OTG_FS_DEVICE_OTG_FS_DTXFSTS55 OTG_FS device IN endpoint transmit FIFO status register **/
#define OTG_FS_DEVICE_OTG_FS_DTXFSTS55			MMIO32(OTG_FS_DEVICE_BASE + 0x1b8)
...
#define OTG_FS_DEVICE_OTG_FS_DOEPCTL4			MMIO32(OTG_FS_DEVICE_BASE + 0x378)
/** OTG_FS_DEVICE_OTG_FS_DOEPINT4 device endpoint-4 interrupt register **/
#define OTG_FS_DEVICE_OTG_FS_DOEPINT4			MMIO32(OTG_FS_DEVICE_BASE + 0x380)
/** OTG_FS_DEVICE_OTG_FS_DOEPTSIZ4 device OUT endpoint-4 transfer size register **/
#define OTG_FS_DEVICE_OTG_FS_DOEPTSIZ4			MMIO32(OTG_FS_DEVICE_BASE + 0x388)
/** OTG_FS_DEVICE_OTG_FS_DOEPCTL5 device endpoint-5 control register **/
#define OTG_FS_DEVICE_OTG_FS_DOEPCTL5			MMIO32(OTG_FS_DEVICE_BASE + 0x390)
/** OTG_FS_DEVICE_OTG_FS_DOEPINT5 device endpoint-5 interrupt register **/
#define OTG_FS_DEVICE_OTG_FS_DOEPINT5			MMIO32(OTG_FS_DEVICE_BASE + 0x398)
/** OTG_FS_DEVICE_OTG_FS_DOEPTSIZ5 device OUT endpoint-5 transfer size register **/
#define OTG_FS_DEVICE_OTG_FS_DOEPTSIZ5			MMIO32(OTG_FS_DEVICE_BASE + 0x3a0)
...
/** @defgroup otg_fs_device_otg_fs_dieptsiz55 OTGFSDIEPTSIZ55 device endpoint-5 transfer size register
@{*/


#define OTG_FS_DEVICE_OTG_FS_DIEPTSIZ55_MCNT_SHIFT		29
#define OTG_FS_DEVICE_OTG_FS_DIEPTSIZ55_MCNT_MASK		0x03
/** @defgroup otg_fs_device_otg_fs_dieptsiz55_mcnt MCNT Multi count
@{*/
/**@}*/


#define OTG_FS_DEVICE_OTG_FS_DIEPTSIZ55_PKTCNT_SHIFT		19
#define OTG_FS_DEVICE_OTG_FS_DIEPTSIZ55_PKTCNT_MASK		0x3ff
/** @defgroup otg_fs_device_otg_fs_dieptsiz55_pktcnt PKTCNT Packet count
@{*/
/**@}*/


#define OTG_FS_DEVICE_OTG_FS_DIEPTSIZ55_XFRSIZ_SHIFT		0
#define OTG_FS_DEVICE_OTG_FS_DIEPTSIZ55_XFRSIZ_MASK		0x7ffff
/** @defgroup otg_fs_device_otg_fs_dieptsiz55_xfrsiz XFRSIZ Transfer size
@{*/
/**@}*/
...
/** @defgroup otg_fs_device_otg_fs_dtxfsts55 OTGFSDTXFSTS55 OTG_FS device IN endpoint transmit FIFO status register
@{*/


#define OTG_FS_DEVICE_OTG_FS_DTXFSTS55_INEPTFSAV_SHIFT		0
#define OTG_FS_DEVICE_OTG_FS_DTXFSTS55_INEPTFSAV_MASK		0xffff
/** @defgroup otg_fs_device_otg_fs_dtxfsts55_ineptfsav INEPTFSAV IN endpoint TxFIFO space available
@{*/
/**@}*/
