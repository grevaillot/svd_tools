...
/** LPTIM1_CFGR2 LPTIM configuration register 2 **/
#define LPTIM1_CFGR2			MMIO32(LPTIM1_BASE + 0x24)
...
/** @defgroup lptim1_cfgr2 CFGR2 LPTIM configuration register 2
@{*/


#define LPTIM1_CFGR2_IN2SEL_SHIFT		4
#define LPTIM1_CFGR2_IN2SEL_MASK		0x03
/** @defgroup lptim1_cfgr2_in2sel IN2SEL LPTIM1 Input 2 selection
@{*/
/**@}*/


#define LPTIM1_CFGR2_IN1SEL_SHIFT		0
#define LPTIM1_CFGR2_IN1SEL_MASK		0x03
/** @defgroup lptim1_cfgr2_in1sel IN1SEL LPTIMx Input 1 selection
@{*/
/**@}*/
