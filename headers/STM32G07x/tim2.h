...
/** TIM2_TISEL TIM alternate function option register 1 **/
...
/** @defgroup tim2_cnt_cnt_h CNTH High counter value (TIM2 only)
@{*/
/**@}*/
...
/** @defgroup tim2_arr_arr_h ARRH High Auto-reload value (TIM2 only)
@{*/
/**@}*/
...
/** @defgroup tim2_ccr1_ccr1_h CCR1H High Capture/Compare 1 value (TIM2 only)
@{*/
/**@}*/
...
/** @defgroup tim2_ccr2_ccr2_h CCR2H High Capture/Compare 2 value (TIM2 only)
@{*/
/**@}*/
...
/** @defgroup tim2_ccr3_ccr3_h CCR3H High Capture/Compare value (TIM2 only)
@{*/
/**@}*/
...
/** @defgroup tim2_ccr4_ccr4_h CCR4H High Capture/Compare value (TIM2 only)
@{*/
/**@}*/
...
/** @defgroup tim2_or1 OR1 TIM option register
@{*/

/** TIM2_OR1_IOCREF_CLR IOCREF_CLR **/
#define TIM2_OR1_IOCREF_CLR		(1 << 0)
...
/** @defgroup tim2_af1_etrsel ETRSEL External trigger source selection
@{*/
/**@}*/
...
/** @defgroup tim2_tisel TISEL TIM alternate function option register 1
@{*/


#define TIM2_TISEL_TI2SEL_SHIFT		8
#define TIM2_TISEL_TI2SEL_MASK		0x0f
/** @defgroup tim2_tisel_ti2sel TI2SEL TI2SEL
@{*/
/**@}*/
...
/** @defgroup tim2_tisel_ti1sel TI1SEL TI1SEL
@{*/
/**@}*/
