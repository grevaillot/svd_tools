...
/** SPI2_I2SCFGR configuration register **/
#define SPI2_I2SCFGR			MMIO32(SPI2_BASE + 0x1c)
/** SPI2_I2SPR prescaler register **/
#define SPI2_I2SPR			MMIO32(SPI2_BASE + 0x20)
/** SPI2_HWCFGR hardware configuration register **/
#define SPI2_HWCFGR			MMIO32(SPI2_BASE + 0x3f0)
/** SPI2_VERR EXTI IP Version register **/
#define SPI2_VERR			MMIO32(SPI2_BASE + 0x3f4)
/** SPI2_IPIDR EXTI Identification register **/
#define SPI2_IPIDR			MMIO32(SPI2_BASE + 0x3f8)
/** SPI2_SIDR EXTI Size ID register **/
#define SPI2_SIDR			MMIO32(SPI2_BASE + 0x3fc)
...
/** @defgroup spi2_i2scfgr I2SCFGR configuration register
@{*/

/** SPI2_I2SCFGR_I2SMOD I2S mode selection **/
#define SPI2_I2SCFGR_I2SMOD		(1 << 11)
/** SPI2_I2SCFGR_SE2 I2S enable **/
#define SPI2_I2SCFGR_SE2		(1 << 10)
...
/** @defgroup spi2_i2scfgr_i2sstd I2SSTD standard selection
@{*/
/**@}*/

/** SPI2_I2SCFGR_CKPOL Inactive state clock polarity **/
...
/** @defgroup spi2_i2spr I2SPR prescaler register
@{*/
...
/** @defgroup spi2_i2spr_i2sdiv I2SDIV linear prescaler
@{*/
/**@}*/
...
/** @defgroup spi2_hwcfgr HWCFGR hardware configuration register
@{*/


#define SPI2_HWCFGR_NSSCFG_SHIFT		16
#define SPI2_HWCFGR_NSSCFG_MASK		0x0f
/** @defgroup spi2_hwcfgr_nsscfg NSSCFG NSS pulse feature enhancement at SPI master
@{*/
/**@}*/


#define SPI2_HWCFGR_DSCFG_SHIFT		12
#define SPI2_HWCFGR_DSCFG_MASK		0x0f
/** @defgroup spi2_hwcfgr_dscfg DSCFG SPI data size configuration
@{*/
/**@}*/


#define SPI2_HWCFGR_I2SCKCFG_SHIFT		8
#define SPI2_HWCFGR_I2SCKCFG_MASK		0x0f
/** @defgroup spi2_hwcfgr_i2sckcfg I2SCKCFG I2S master clock generator at I2S mode
@{*/
/**@}*/


#define SPI2_HWCFGR_I2SCFG_SHIFT		4
#define SPI2_HWCFGR_I2SCFG_MASK		0x0f
/** @defgroup spi2_hwcfgr_i2scfg I2SCFG I2S mode implementation
@{*/
/**@}*/


#define SPI2_HWCFGR_CRCCFG_SHIFT		0
#define SPI2_HWCFGR_CRCCFG_MASK		0x0f
/** @defgroup spi2_hwcfgr_crccfg CRCCFG CRC capable at SPI mode
@{*/
/**@}*/
...
/** @defgroup spi2_verr VERR EXTI IP Version register
@{*/


#define SPI2_VERR_MAJREV_SHIFT		4
#define SPI2_VERR_MAJREV_MASK		0x0f
/** @defgroup spi2_verr_majrev MAJREV Major Revision number
@{*/
/**@}*/


#define SPI2_VERR_MINREV_SHIFT		0
#define SPI2_VERR_MINREV_MASK		0x0f
/** @defgroup spi2_verr_minrev MINREV Minor Revision number
@{*/
/**@}*/
...
/** @defgroup spi2_ipidr IPIDR EXTI Identification register
@{*/


#define SPI2_IPIDR_IPID_SHIFT		0
#define SPI2_IPIDR_IPID_MASK		0xffffffff
/** @defgroup spi2_ipidr_ipid IPID IP Identification
@{*/
/**@}*/
...
/** @defgroup spi2_sidr SIDR EXTI Size ID register
@{*/


#define SPI2_SIDR_SID_SHIFT		0
#define SPI2_SIDR_SID_MASK		0xffffffff
/** @defgroup spi2_sidr_sid SID Size Identification
@{*/
/**@}*/
