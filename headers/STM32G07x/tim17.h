...
/** TIM17_AF1 TIM17 option register 1 **/
#define TIM17_AF1			MMIO32(TIM17_BASE + 0x60)
/** TIM17_TISEL input selection register **/
#define TIM17_TISEL			MMIO32(TIM17_BASE + 0x68)
...
/** TIM17_BDTR_BKBID Break Bidirectional **/
#define TIM17_BDTR_BKBID		(1 << 28)
/** TIM17_BDTR_BKDSRM Break Disarm **/
...
/** @defgroup tim17_af1 AF1 TIM17 option register 1
@{*/

/** TIM17_AF1_BKCMP2P BRK COMP2 input polarit **/
...
/** TIM17_AF1_BKDFBK1E BRK DFSDM_BREAK1 enable **/
#define TIM17_AF1_BKDFBK1E		(1 << 8)
...
/** @defgroup tim17_tisel TISEL input selection register
@{*/


#define TIM17_TISEL_TI1SEL_SHIFT		0
#define TIM17_TISEL_TI1SEL_MASK		0x0f
/** @defgroup tim17_tisel_ti1sel TI1SEL selects input
@{*/
/**@}*/
