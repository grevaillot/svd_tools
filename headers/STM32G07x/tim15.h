...
/** TIM15_AF1 TIM17 option register 1 **/
#define TIM15_AF1			MMIO32(TIM15_BASE + 0x60)
/** TIM15_TISEL input selection register **/
...
/** TIM15_BDTR_BKBID Break Bidirectional **/
#define TIM15_BDTR_BKBID		(1 << 28)
/** TIM15_BDTR_BKDSRM Break Disarm **/
...
/** @defgroup tim15_af1 AF1 TIM17 option register 1
@{*/

/** TIM15_AF1_BKCMP2P BRK COMP2 input polarit **/
...
/** TIM15_AF1_BKDFBK1E BRK DFSDM_BREAK1 enable **/
#define TIM15_AF1_BKDFBK1E		(1 << 8)
...
/** @defgroup tim15_tisel TISEL input selection register
@{*/


#define TIM15_TISEL_TI1SEL_SHIFT		0
#define TIM15_TISEL_TI1SEL_MASK		0x0f
/** @defgroup tim15_tisel_ti1sel TI1SEL selects input
@{*/
/**@}*/
