...
/** TIM1_CCMR1_Input capture/compare mode register 1 (output mode) **/
...
/** TIM1_CCMR2_Input capture/compare mode register 2 (output mode) **/
...
#define TIM1_OR1			MMIO32(TIM1_BASE + 0x50)
...
#define TIM1_CCR6			MMIO32(TIM1_BASE + 0x5c)
...
#define TIM1_SMCR_TS_SHIFT		20
#define TIM1_SMCR_TS_MASK		0x03
...
#define TIM1_SMCR_TS_4_SHIFT		4
#define TIM1_SMCR_TS_4_MASK		0x07
/** @defgroup tim1_smcr_ts_4 TS4 Trigger selection
@{*/
/**@}*/
...
/** @defgroup tim1_ccmr1_input CCMR1Input capture/compare mode register 1 (output mode)
@{*/

/** TIM1_CCMR1_Input_OC2CE Output Compare 2 clear enable **/
#define TIM1_CCMR1_Input_OC2CE		(1 << 15)

#define TIM1_CCMR1_Input_OC2M_SHIFT		12
#define TIM1_CCMR1_Input_OC2M_MASK		0x07
/** @defgroup tim1_ccmr1_input_oc2m OC2M Output Compare 2 mode
@{*/
/**@}*/

/** TIM1_CCMR1_Input_OC2PE Output Compare 2 preload enable **/
#define TIM1_CCMR1_Input_OC2PE		(1 << 11)
/** TIM1_CCMR1_Input_OC2FE Output Compare 2 fast enable **/
#define TIM1_CCMR1_Input_OC2FE		(1 << 10)
...
/** TIM1_CCMR1_Input_OC1CE Output Compare 1 clear enable **/
#define TIM1_CCMR1_Input_OC1CE		(1 << 7)

#define TIM1_CCMR1_Input_OC1M_SHIFT		4
#define TIM1_CCMR1_Input_OC1M_MASK		0x07
/** @defgroup tim1_ccmr1_input_oc1m OC1M Output Compare 1 mode
@{*/
/**@}*/

/** TIM1_CCMR1_Input_OC1PE Output Compare 1 preload enable **/
#define TIM1_CCMR1_Input_OC1PE		(1 << 3)
/** TIM1_CCMR1_Input_OC1FE Output Compare 1 fast enable **/
#define TIM1_CCMR1_Input_OC1FE		(1 << 2)
...
/** @defgroup tim1_ccmr2_input CCMR2Input capture/compare mode register 2 (output mode)
@{*/

/** TIM1_CCMR2_Input_OC4CE Output compare 4 clear enable **/
#define TIM1_CCMR2_Input_OC4CE		(1 << 15)

#define TIM1_CCMR2_Input_OC4M_SHIFT		12
#define TIM1_CCMR2_Input_OC4M_MASK		0x07
/** @defgroup tim1_ccmr2_input_oc4m OC4M Output compare 4 mode
@{*/
/**@}*/

/** TIM1_CCMR2_Input_OC4PE Output compare 4 preload enable **/
#define TIM1_CCMR2_Input_OC4PE		(1 << 11)
/** TIM1_CCMR2_Input_OC4FE Output compare 4 fast enable **/
#define TIM1_CCMR2_Input_OC4FE		(1 << 10)
...
/** TIM1_CCMR2_Input_OC3CE Output compare 3 clear enable **/
#define TIM1_CCMR2_Input_OC3CE		(1 << 7)

#define TIM1_CCMR2_Input_OC3M_SHIFT		4
#define TIM1_CCMR2_Input_OC3M_MASK		0x07
/** @defgroup tim1_ccmr2_input_oc3m OC3M Output compare 3 mode
@{*/
/**@}*/

/** TIM1_CCMR2_Input_OC3PE Output compare 3 preload enable **/
#define TIM1_CCMR2_Input_OC3PE		(1 << 3)
/** TIM1_CCMR2_Input_OC3FE Output compare 3 fast enable **/
#define TIM1_CCMR2_Input_OC3FE		(1 << 2)
...
/** TIM1_BDTR_BK2ID Break2 bidirectional **/
#define TIM1_BDTR_BK2ID		(1 << 29)
/** TIM1_BDTR_BKBID Break Bidirectional **/
#define TIM1_BDTR_BKBID		(1 << 28)
/** TIM1_BDTR_BK2DSRM Break2 Disarm **/
#define TIM1_BDTR_BK2DSRM		(1 << 27)
/** TIM1_BDTR_BKDSRM Break Disarm **/
...
/** @defgroup tim1_or1 OR1 option register 1
@{*/

/** TIM1_OR1_OCREF_CLR Ocref_clr source selection **/
#define TIM1_OR1_OCREF_CLR		(1 << 0)
...
/** TIM1_CCMR3_Output_OC5M_bit3 Output Compare 5 mode bit 3 **/
#define TIM1_CCMR3_Output_OC5M_bit3		(1 << 16)
...
/** @defgroup tim1_af1 AF1 DMA address for full transfer
@{*/


#define TIM1_AF1_ETRSEL_SHIFT		14
#define TIM1_AF1_ETRSEL_MASK		0x07
...
/** @defgroup tim1_af2 AF2 DMA address for full transfer
@{*/
...
/** TIM1_AF2_BK2DFBK0E BRK2 DFSDM_BREAK0 enable **/
#define TIM1_AF2_BK2DFBK0E		(1 << 8)
