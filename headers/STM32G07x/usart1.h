...
/** USART1_PRESC Prescaler register **/
#define USART1_PRESC			MMIO32(USART1_BASE + 0x2c)
...
/** USART1_CR1_RXFFIE RXFIFO Full interrupt enable **/
#define USART1_CR1_RXFFIE		(1 << 31)
/** USART1_CR1_TXFEIE TXFIFO empty interrupt enable **/
#define USART1_CR1_TXFEIE		(1 << 30)
/** USART1_CR1_FIFOEN FIFO mode enable **/
#define USART1_CR1_FIFOEN		(1 << 29)
...
/** @defgroup usart1_cr1_deat DEAT DEAT
@{*/
/**@}*/
...
/** @defgroup usart1_cr1_dedt DEDT DEDT
@{*/
/**@}*/
...
/** USART1_CR2_DIS_NSS When the DSI_NSS bit is set, the NSS pin input will be ignored **/
#define USART1_CR2_DIS_NSS		(1 << 3)
/** USART1_CR2_SLVEN Synchronous Slave mode enable **/
#define USART1_CR2_SLVEN		(1 << 0)
...
#define USART1_CR3_TXFTCFG_SHIFT		29
#define USART1_CR3_TXFTCFG_MASK		0x07
/** @defgroup usart1_cr3_txftcfg TXFTCFG TXFIFO threshold configuration
@{*/
/**@}*/

/** USART1_CR3_RXFTIE RXFIFO threshold interrupt enable **/
#define USART1_CR3_RXFTIE		(1 << 28)

#define USART1_CR3_RXFTCFG_SHIFT		25
#define USART1_CR3_RXFTCFG_MASK		0x07
/** @defgroup usart1_cr3_rxftcfg RXFTCFG Receive FIFO threshold configuration
@{*/
/**@}*/

/** USART1_CR3_TCBGTIE Tr Complete before guard time, interrupt enable **/
#define USART1_CR3_TCBGTIE		(1 << 24)
/** USART1_CR3_TXFTIE threshold interrupt enable **/
#define USART1_CR3_TXFTIE		(1 << 23)
...
#define USART1_BRR_BRR_4_15_SHIFT		4
#define USART1_BRR_BRR_4_15_MASK		0xfff
/** @defgroup usart1_brr_brr_4_15 BRR415 BRR_4_15
@{*/
/**@}*/


#define USART1_BRR_BRR_0_3_SHIFT		0
#define USART1_BRR_BRR_0_3_MASK		0x0f
/** @defgroup usart1_brr_brr_0_3 BRR03 BRR_0_3
@{*/
/**@}*/
...
/** USART1_ISR_TXFT TXFIFO threshold flag **/
#define USART1_ISR_TXFT		(1 << 27)
/** USART1_ISR_RXFT RXFIFO threshold flag **/
#define USART1_ISR_RXFT		(1 << 26)
/** USART1_ISR_TCBGT Transmission complete before guard time flag **/
#define USART1_ISR_TCBGT		(1 << 25)
/** USART1_ISR_RXFF RXFIFO Full **/
#define USART1_ISR_RXFF		(1 << 24)
/** USART1_ISR_TXFE TXFIFO Empty **/
#define USART1_ISR_TXFE		(1 << 23)
...
/** USART1_ISR_UDR SPI slave underrun error flag **/
#define USART1_ISR_UDR		(1 << 13)
...
/** USART1_ICR_UDRCF SPI slave underrun clear flag **/
#define USART1_ICR_UDRCF		(1 << 13)
...
/** USART1_ICR_TCBGTCF Transmission complete before Guard time clear flag **/
#define USART1_ICR_TCBGTCF		(1 << 7)
/** USART1_ICR_TCCF Transmission complete clear flag **/
#define USART1_ICR_TCCF		(1 << 6)
/** USART1_ICR_TXFECF TXFIFO empty clear flag **/
#define USART1_ICR_TXFECF		(1 << 5)
...
/** @defgroup usart1_presc PRESC Prescaler register
@{*/


#define USART1_PRESC_PRESCALER_SHIFT		0
#define USART1_PRESC_PRESCALER_MASK		0x0f
/** @defgroup usart1_presc_prescaler PRESCALER Clock prescaler
@{*/
/**@}*/
