...
/** TIM16_AF1 TIM17 option register 1 **/
#define TIM16_AF1			MMIO32(TIM16_BASE + 0x60)
/** TIM16_TISEL input selection register **/
#define TIM16_TISEL			MMIO32(TIM16_BASE + 0x68)
...
/** TIM16_BDTR_BKBID Break Bidirectional **/
#define TIM16_BDTR_BKBID		(1 << 28)
/** TIM16_BDTR_BKDSRM Break Disarm **/
...
/** @defgroup tim16_af1 AF1 TIM17 option register 1
@{*/

/** TIM16_AF1_BKCMP2P BRK COMP2 input polarit **/
...
/** TIM16_AF1_BKDFBK1E BRK DFSDM_BREAK1 enable **/
#define TIM16_AF1_BKDFBK1E		(1 << 8)
...
/** @defgroup tim16_tisel TISEL input selection register
@{*/


#define TIM16_TISEL_TI1SEL_SHIFT		0
#define TIM16_TISEL_TI1SEL_MASK		0x0f
/** @defgroup tim16_tisel_ti1sel TI1SEL selects input
@{*/
/**@}*/
