...
/** ADC_WPMR Write Protection Mode Register **/
#define ADC_WPMR			MMIO32(ADC_BASE + 0xe4)
/** ADC_WPSR Write Protection Status Register **/
...
/** @defgroup adc_mr_transfer TRANSFER Hold Time
@{*/
/**@}*/
...
/** @defgroup adc_mr_startup STARTUP Startup Time
@{*/
/**@}*/
...
/** ADC_ISR_RXBUFF Receive Buffer Full (cleared by writing ADC_RCR or ADC_RNCR) **/
#define ADC_ISR_RXBUFF		(1 << 28)
/** ADC_ISR_ENDRX End of Receive Transfer (cleared by writing ADC_RCR or ADC_RNCR) **/
#define ADC_ISR_ENDRX		(1 << 27)
/** ADC_ISR_COMPE Comparison Event (cleared on read) **/
#define ADC_ISR_COMPE		(1 << 26)
/** ADC_ISR_GOVRE General Overrun Error (cleared on read) **/
#define ADC_ISR_GOVRE		(1 << 25)
/** ADC_ISR_DRDY Data Ready (automatically set / cleared) **/
#define ADC_ISR_DRDY		(1 << 24)
/** ADC_ISR_EOCAL End of Calibration Sequence **/
#define ADC_ISR_EOCAL		(1 << 23)
/** ADC_ISR_EOC15 End of Conversion 15 (automatically set / cleared) **/
#define ADC_ISR_EOC15		(1 << 15)
/** ADC_ISR_EOC14 End of Conversion 14 (automatically set / cleared) **/
#define ADC_ISR_EOC14		(1 << 14)
/** ADC_ISR_EOC13 End of Conversion 13 (automatically set / cleared) **/
#define ADC_ISR_EOC13		(1 << 13)
/** ADC_ISR_EOC12 End of Conversion 12 (automatically set / cleared) **/
#define ADC_ISR_EOC12		(1 << 12)
/** ADC_ISR_EOC11 End of Conversion 11 (automatically set / cleared) **/
#define ADC_ISR_EOC11		(1 << 11)
/** ADC_ISR_EOC10 End of Conversion 10 (automatically set / cleared) **/
#define ADC_ISR_EOC10		(1 << 10)
/** ADC_ISR_EOC9 End of Conversion 9 (automatically set / cleared) **/
#define ADC_ISR_EOC9		(1 << 9)
/** ADC_ISR_EOC8 End of Conversion 8 (automatically set / cleared) **/
#define ADC_ISR_EOC8		(1 << 8)
/** ADC_ISR_EOC7 End of Conversion 7 (automatically set / cleared) **/
#define ADC_ISR_EOC7		(1 << 7)
/** ADC_ISR_EOC6 End of Conversion 6 (automatically set / cleared) **/
#define ADC_ISR_EOC6		(1 << 6)
/** ADC_ISR_EOC5 End of Conversion 5 (automatically set / cleared) **/
#define ADC_ISR_EOC5		(1 << 5)
/** ADC_ISR_EOC4 End of Conversion 4 (automatically set / cleared) **/
#define ADC_ISR_EOC4		(1 << 4)
/** ADC_ISR_EOC3 End of Conversion 3 (automatically set / cleared) **/
#define ADC_ISR_EOC3		(1 << 3)
/** ADC_ISR_EOC2 End of Conversion 2 (automatically set / cleared) **/
#define ADC_ISR_EOC2		(1 << 2)
/** ADC_ISR_EOC1 End of Conversion 1 (automatically set / cleared) **/
#define ADC_ISR_EOC1		(1 << 1)
/** ADC_ISR_EOC0 End of Conversion 0 (automatically set / cleared) **/
...
/** ADC_EMR_TAG Tag of the ADC_LCDR **/
...
/** @defgroup adc_wpmr WPMR Write Protection Mode Register
@{*/


#define ADC_WPMR_WPKEY_SHIFT		8
#define ADC_WPMR_WPKEY_MASK		0xffffff
/** @defgroup adc_wpmr_wpkey WPKEY Write Protection Key
@{*/
/**@}*/

/** ADC_WPMR_WPEN Write Protection Enable **/
#define ADC_WPMR_WPEN		(1 << 0)

/**@}*/

/** @defgroup adc_wpsr WPSR Write Protection Status Register
@{*/


#define ADC_WPSR_WPVSRC_SHIFT		8
#define ADC_WPSR_WPVSRC_MASK		0xffff
/** @defgroup adc_wpsr_wpvsrc WPVSRC Write Protection Violation Source
@{*/
/**@}*/

/** ADC_WPSR_WPVS Write Protection Violation Status **/
