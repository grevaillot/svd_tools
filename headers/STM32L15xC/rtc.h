...
/** RTC_TAFCR_TAMP3TRG TAMPER1 mapping **/
#define RTC_TAFCR_TAMP3TRG		(1 << 6)
/** RTC_TAFCR_TAMP3E TIMESTAMP mapping **/
...
/** RTC_TAFCR_TAMP1ETRG Active level for tamper 1 **/
#define RTC_TAFCR_TAMP1ETRG		(1 << 1)
