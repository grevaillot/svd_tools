...
#define RCC_CFGR_SDPRE_SHIFT		27
#define RCC_CFGR_SDPRE_MASK		0x1f
/** @defgroup rcc_cfgr_sdpre SDPRE SDADC prescaler
@{*/
/**@}*/
...
/** RCC_APB2RSTR_SDAD3RST SDADC3 (Sigma delta ADC 3) reset **/
#define RCC_APB2RSTR_SDAD3RST		(1 << 26)
/** RCC_APB2RSTR_SDAD2RST SDADC2 (Sigma delta ADC 2) reset **/
#define RCC_APB2RSTR_SDAD2RST		(1 << 25)
/** RCC_APB2RSTR_SDAD1RST SDADC1 (Sigma delta ADC 1) reset **/
#define RCC_APB2RSTR_SDAD1RST		(1 << 24)
/** RCC_APB2RSTR_TIM19RST TIM19 timer reset **/
#define RCC_APB2RSTR_TIM19RST		(1 << 19)
...
/** RCC_APB1RSTR_DAC3RST DAC3 reset **/
#define RCC_APB1RSTR_DAC3RST		(1 << 26)
...
/** RCC_APB1RSTR_TIM18RST Timer 18 reset **/
#define RCC_APB1RSTR_TIM18RST		(1 << 9)
/** RCC_APB1RSTR_TIM14RST Timer 14 reset **/
#define RCC_APB1RSTR_TIM14RST		(1 << 8)
/** RCC_APB1RSTR_TIM13RST Timer 13 reset **/
#define RCC_APB1RSTR_TIM13RST		(1 << 7)
/** RCC_APB1RSTR_TIM12RST Timer 12 reset **/
...
/** RCC_APB2ENR_SDAD3EN SDADC3 (Sigma Delta ADC 3) clock enable **/
#define RCC_APB2ENR_SDAD3EN		(1 << 26)
/** RCC_APB2ENR_SDAD2EN SDADC2 (Sigma Delta ADC 2) clock enable **/
#define RCC_APB2ENR_SDAD2EN		(1 << 25)
/** RCC_APB2ENR_SDAD1EN SDADC1 (Sigma Delta ADC 1) clock enable **/
#define RCC_APB2ENR_SDAD1EN		(1 << 24)
/** RCC_APB2ENR_DBGMCUEN MCU debug module clock enable **/
#define RCC_APB2ENR_DBGMCUEN		(1 << 22)
/** RCC_APB2ENR_TIM19EN TIM19 timer clock enable **/
#define RCC_APB2ENR_TIM19EN		(1 << 19)
...
/** RCC_APB1ENR_DAC3EN DAC3 interface clock enable **/
#define RCC_APB1ENR_DAC3EN		(1 << 26)
...
/** RCC_APB1ENR_TIM18EN Timer 18 clock enable **/
#define RCC_APB1ENR_TIM18EN		(1 << 9)
/** RCC_APB1ENR_TIM14EN Timer 14 clock enable **/
#define RCC_APB1ENR_TIM14EN		(1 << 8)
/** RCC_APB1ENR_TIM13EN Timer 13 clock enable **/
#define RCC_APB1ENR_TIM13EN		(1 << 7)
/** RCC_APB1ENR_TIM12EN Timer 12 clock enable **/
