...
#define UART4_CR1_DEAT_SHIFT		21
#define UART4_CR1_DEAT_MASK		0x1f
/** @defgroup uart4_cr1_deat DEAT Driver Enable assertion time
@{*/
/**@}*/


#define UART4_CR1_DEDT_SHIFT		16
#define UART4_CR1_DEDT_MASK		0x1f
/** @defgroup uart4_cr1_dedt DEDT Driver Enable deassertion time
@{*/
/**@}*/
...
#define UART4_CR2_ADD4_SHIFT		28
#define UART4_CR2_ADD4_MASK		0x0f
/** @defgroup uart4_cr2_add4 ADD4 Address of the USART node
@{*/
/**@}*/


#define UART4_CR2_ADD0_SHIFT		24
#define UART4_CR2_ADD0_MASK		0x0f
/** @defgroup uart4_cr2_add0 ADD0 Address of the USART node
@{*/
/**@}*/
...
#define UART4_CR2_ABRMOD_SHIFT		21
#define UART4_CR2_ABRMOD_MASK		0x03
/** @defgroup uart4_cr2_abrmod ABRMOD Auto baud rate mode
@{*/
/**@}*/
...
/** UART4_CR2_DATAINV Binary data inversion **/
#define UART4_CR2_DATAINV		(1 << 18)
...
/** UART4_ISR_REACK Receive enable acknowledge flag **/
#define UART4_ISR_REACK		(1 << 22)
/** UART4_ISR_TEACK Transmit enable acknowledge flag **/
#define UART4_ISR_TEACK		(1 << 21)
/** UART4_ISR_WUF Wakeup from Stop mode flag **/
#define UART4_ISR_WUF		(1 << 20)
/** UART4_ISR_RWU Receiver wakeup from Mute mode **/
#define UART4_ISR_RWU		(1 << 19)
/** UART4_ISR_SBKF Send break flag **/
#define UART4_ISR_SBKF		(1 << 18)
/** UART4_ISR_CMF character match flag **/
#define UART4_ISR_CMF		(1 << 17)
/** UART4_ISR_BUSY Busy flag **/
#define UART4_ISR_BUSY		(1 << 16)
/** UART4_ISR_ABRF Auto baud rate flag **/
#define UART4_ISR_ABRF		(1 << 15)
/** UART4_ISR_ABRE Auto baud rate error **/
#define UART4_ISR_ABRE		(1 << 14)
/** UART4_ISR_EOBF End of block flag **/
#define UART4_ISR_EOBF		(1 << 12)
/** UART4_ISR_RTOF Receiver timeout **/
#define UART4_ISR_RTOF		(1 << 11)
/** UART4_ISR_CTS CTS flag **/
#define UART4_ISR_CTS		(1 << 10)
/** UART4_ISR_CTSIF CTS interrupt flag **/
#define UART4_ISR_CTSIF		(1 << 9)
/** UART4_ISR_LBDF LIN break detection flag **/
#define UART4_ISR_LBDF		(1 << 8)
/** UART4_ISR_TXE Transmit data register empty **/
#define UART4_ISR_TXE		(1 << 7)
/** UART4_ISR_TC Transmission complete **/
#define UART4_ISR_TC		(1 << 6)
/** UART4_ISR_RXNE Read data register not empty **/
#define UART4_ISR_RXNE		(1 << 5)
/** UART4_ISR_IDLE Idle line detected **/
#define UART4_ISR_IDLE		(1 << 4)
/** UART4_ISR_ORE Overrun error **/
#define UART4_ISR_ORE		(1 << 3)
/** UART4_ISR_NF Noise detected flag **/
#define UART4_ISR_NF		(1 << 2)
/** UART4_ISR_FE Framing error **/
#define UART4_ISR_FE		(1 << 1)
/** UART4_ISR_PE Parity error **/
...
/** UART4_ICR_EOBCF End of timeout clear flag **/
