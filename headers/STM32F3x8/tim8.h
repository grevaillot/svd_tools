...
/** @defgroup tim8_registers Advanced timer Register
@{*/
...
/** TIM8_CCR6 capture/compare register 6 **/
#define TIM8_CCR6			MMIO32(TIM8_BASE + 0x5c)
/** TIM8_OR option registers **/
#define TIM8_OR			MMIO32(TIM8_BASE + 0x60)
...
/** TIM8_SMCR_SMS3 Slave mode selection bit 3 **/
#define TIM8_SMCR_SMS3		(1 << 16)
...
/** TIM8_SR_C6IF Capture/Compare 6 interrupt flag **/
#define TIM8_SR_C6IF		(1 << 17)
/** TIM8_SR_C5IF Capture/Compare 5 interrupt flag **/
#define TIM8_SR_C5IF		(1 << 16)
...
#define TIM8_CCMR1_Input_IC1PCS_SHIFT		2
#define TIM8_CCMR1_Input_IC1PCS_MASK		0x03
/** @defgroup tim8_ccmr1_input_ic1pcs IC1PCS Input capture 1 prescaler
@{*/
/**@}*/
...
/** TIM8_CCER_CC4NP Capture/Compare 4 output Polarity **/
...
/** @defgroup tim8_ccr3_ccr3 CCR3 Capture/Compare 3 value
@{*/
/**@}*/
...
/** @defgroup tim8_ccr4_ccr4 CCR4 Capture/Compare 3 value
@{*/
/**@}*/
...
/** TIM8_CCMR3_Output_OC6M_3 Outout Compare 6 mode bit 3 **/
#define TIM8_CCMR3_Output_OC6M_3		(1 << 24)
/** TIM8_CCMR3_Output_OC5M_3 Outout Compare 5 mode bit 3 **/
#define TIM8_CCMR3_Output_OC5M_3		(1 << 16)
...
/** @defgroup tim8_ccr6 CCR6 capture/compare register 6
@{*/


#define TIM8_CCR6_CCR6_SHIFT		0
#define TIM8_CCR6_CCR6_MASK		0xffff
/** @defgroup tim8_ccr6_ccr6 CCR6 Capture/Compare 6 value
@{*/
/**@}*/
...
/** @defgroup tim8_or OR option registers
@{*/


#define TIM8_OR_TIM1_ETR_ADC4_RMP_SHIFT		2
#define TIM8_OR_TIM1_ETR_ADC4_RMP_MASK		0x03
/** @defgroup tim8_or_tim1_etr_adc4_rmp TIM1ETRADC4RMP TIM1_ETR_ADC4 remapping capability
@{*/
/**@}*/


#define TIM8_OR_TIM1_ETR_ADC1_RMP_SHIFT		0
#define TIM8_OR_TIM1_ETR_ADC1_RMP_MASK		0x03
/** @defgroup tim8_or_tim1_etr_adc1_rmp TIM1ETRADC1RMP TIM1_ETR_ADC1 remapping capability
@{*/
/**@}*/
