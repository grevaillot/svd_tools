...
/** USB_DADDR_ADD6 Device address **/
#define USB_DADDR_ADD6		(1 << 6)
/** USB_DADDR_ADD5 Device address **/
#define USB_DADDR_ADD5		(1 << 5)
/** USB_DADDR_ADD4 Device address **/
#define USB_DADDR_ADD4		(1 << 4)
/** USB_DADDR_ADD3 Device address **/
#define USB_DADDR_ADD3		(1 << 3)
/** USB_DADDR_ADD2 Device address **/
#define USB_DADDR_ADD2		(1 << 2)
/** USB_DADDR_ADD1 Device address **/
#define USB_DADDR_ADD1		(1 << 1)
/** USB_DADDR_ADD Device address **/
#define USB_DADDR_ADD		(1 << 0)
