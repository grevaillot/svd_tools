...
/** USART1_CR1_RXFFIE RXFFIE **/
#define USART1_CR1_RXFFIE		(1 << 31)
/** USART1_CR1_TXFEIE TXFEIE **/
#define USART1_CR1_TXFEIE		(1 << 30)
/** USART1_CR1_FIFOEN FIFOEN **/
...
/** USART1_CR2_DIS_NSS DIS_NSS **/
#define USART1_CR2_DIS_NSS		(1 << 3)
/** USART1_CR2_SLVEN SLVEN **/
...
/** @defgroup usart1_cr3_txftcfg TXFTCFG TXFTCFG
@{*/
/**@}*/

/** USART1_CR3_RXFTIE RXFTIE **/
#define USART1_CR3_RXFTIE		(1 << 28)

#define USART1_CR3_RXFTCFG_SHIFT		25
#define USART1_CR3_RXFTCFG_MASK		0x07
/** @defgroup usart1_cr3_rxftcfg RXFTCFG RXFTCFG
@{*/
/**@}*/

/** USART1_CR3_TCBGTIE TCBGTIE **/
#define USART1_CR3_TCBGTIE		(1 << 24)
/** USART1_CR3_TXFTIE TXFTIE **/
...
/** @defgroup usart1_presc_prescaler PRESCALER PRESCALER
@{*/
/**@}*/
