...
/** @defgroup lpuart1_registers Universal synchronous asynchronous receiver       transmitter Register
@{*/
...
/** LPUART1_CR1_RXFFIE RXFFIE **/
#define LPUART1_CR1_RXFFIE		(1 << 31)
/** LPUART1_CR1_TXFEIE TXFEIE **/
#define LPUART1_CR1_TXFEIE		(1 << 30)
/** LPUART1_CR1_FIFOEN FIFOEN **/
...
/** @defgroup lpuart1_cr3_txftcfg TXFTCFG TXFTCFG
@{*/
/**@}*/

/** LPUART1_CR3_RXFTIE RXFTIE **/
#define LPUART1_CR3_RXFTIE		(1 << 28)

#define LPUART1_CR3_RXFTCFG_SHIFT		25
#define LPUART1_CR3_RXFTCFG_MASK		0x07
/** @defgroup lpuart1_cr3_rxftcfg RXFTCFG RXFTCFG
@{*/
/**@}*/

/** LPUART1_CR3_TXFTIE TXFTIE **/
...
/** LPUART1_ISR_TXFT TXFT **/
#define LPUART1_ISR_TXFT		(1 << 27)
/** LPUART1_ISR_RXFT RXFT **/
#define LPUART1_ISR_RXFT		(1 << 26)
/** LPUART1_ISR_RXFF RXFF **/
#define LPUART1_ISR_RXFF		(1 << 24)
/** LPUART1_ISR_TXFE TXFE **/
...
/** @defgroup lpuart1_presc_prescaler PRESCALER PRESCALER
@{*/
/**@}*/
