...
/** HRTIM_TIMA_TIMADIER TIMxDIER **/
#define HRTIM_TIMA_TIMADIER			MMIO32(HRTIM_TIMA_BASE + 0x0c)
...
/** HRTIM_TIMA_TIMACR2 HRTIM Timerx Control Register 2 **/
#define HRTIM_TIMA_TIMACR2			MMIO32(HRTIM_TIMA_BASE + 0x6c)
/** HRTIM_TIMA_AEEFR3 HRTIM Timerx External Event Filtering Register 3 **/
#define HRTIM_TIMA_AEEFR3			MMIO32(HRTIM_TIMA_BASE + 0x70)
...
/** HRTIM_TIMA_TIMACR_TFU TFU **/
#define HRTIM_TIMA_TIMACR_TFU		(1 << 16)
...
/** HRTIM_TIMA_TIMACR_RSYNCU Re-Synchronized Update **/
#define HRTIM_TIMA_TIMACR_RSYNCU		(1 << 9)

#define HRTIM_TIMA_TIMACR_INTLVD_SHIFT		7
#define HRTIM_TIMA_TIMACR_INTLVD_MASK		0x03
/** @defgroup hrtim_tima_timacr_intlvd INTLVD Interleaved mode
@{*/
/**@}*/
...
/** HRTIM_TIMA_TIMAISR_O2CPY Output 2 Copy **/
#define HRTIM_TIMA_TIMAISR_O2CPY		(1 << 21)
/** HRTIM_TIMA_TIMAISR_O1CPY Output 1 Copy **/
#define HRTIM_TIMA_TIMAISR_O1CPY		(1 << 20)
...
/** @defgroup hrtim_tima_timadier TIMADIER TIMxDIER
@{*/

/** HRTIM_TIMA_TIMADIER_DLYPRTDE DLYPRTDE **/
#define HRTIM_TIMA_TIMADIER_DLYPRTDE		(1 << 30)
/** HRTIM_TIMA_TIMADIER_RSTDE RSTDE **/
#define HRTIM_TIMA_TIMADIER_RSTDE		(1 << 29)
/** HRTIM_TIMA_TIMADIER_RSTx2DE RSTx2DE **/
#define HRTIM_TIMA_TIMADIER_RSTx2DE		(1 << 28)
/** HRTIM_TIMA_TIMADIER_SETx2DE SETx2DE **/
#define HRTIM_TIMA_TIMADIER_SETx2DE		(1 << 27)
/** HRTIM_TIMA_TIMADIER_RSTx1DE RSTx1DE **/
#define HRTIM_TIMA_TIMADIER_RSTx1DE		(1 << 26)
/** HRTIM_TIMA_TIMADIER_SET1xDE SET1xDE **/
#define HRTIM_TIMA_TIMADIER_SET1xDE		(1 << 25)
/** HRTIM_TIMA_TIMADIER_CPT2DE CPT2DE **/
#define HRTIM_TIMA_TIMADIER_CPT2DE		(1 << 24)
/** HRTIM_TIMA_TIMADIER_CPT1DE CPT1DE **/
#define HRTIM_TIMA_TIMADIER_CPT1DE		(1 << 23)
/** HRTIM_TIMA_TIMADIER_UPDDE UPDDE **/
#define HRTIM_TIMA_TIMADIER_UPDDE		(1 << 22)
/** HRTIM_TIMA_TIMADIER_REPDE REPDE **/
#define HRTIM_TIMA_TIMADIER_REPDE		(1 << 20)
/** HRTIM_TIMA_TIMADIER_CMP4DE CMP4DE **/
#define HRTIM_TIMA_TIMADIER_CMP4DE		(1 << 19)
/** HRTIM_TIMA_TIMADIER_CMP3DE CMP3DE **/
#define HRTIM_TIMA_TIMADIER_CMP3DE		(1 << 18)
/** HRTIM_TIMA_TIMADIER_CMP2DE CMP2DE **/
#define HRTIM_TIMA_TIMADIER_CMP2DE		(1 << 17)
/** HRTIM_TIMA_TIMADIER_CMP1DE CMP1DE **/
#define HRTIM_TIMA_TIMADIER_CMP1DE		(1 << 16)
/** HRTIM_TIMA_TIMADIER_DLYPRTIE DLYPRTIE **/
#define HRTIM_TIMA_TIMADIER_DLYPRTIE		(1 << 14)
/** HRTIM_TIMA_TIMADIER_RSTIE RSTIE **/
#define HRTIM_TIMA_TIMADIER_RSTIE		(1 << 13)
/** HRTIM_TIMA_TIMADIER_RSTx2IE RSTx2IE **/
#define HRTIM_TIMA_TIMADIER_RSTx2IE		(1 << 12)
/** HRTIM_TIMA_TIMADIER_SETx2IE SETx2IE **/
#define HRTIM_TIMA_TIMADIER_SETx2IE		(1 << 11)
/** HRTIM_TIMA_TIMADIER_RSTx1IE RSTx1IE **/
#define HRTIM_TIMA_TIMADIER_RSTx1IE		(1 << 10)
/** HRTIM_TIMA_TIMADIER_SET1xIE SET1xIE **/
#define HRTIM_TIMA_TIMADIER_SET1xIE		(1 << 9)
/** HRTIM_TIMA_TIMADIER_CPT2IE CPT2IE **/
#define HRTIM_TIMA_TIMADIER_CPT2IE		(1 << 8)
/** HRTIM_TIMA_TIMADIER_CPT1IE CPT1IE **/
#define HRTIM_TIMA_TIMADIER_CPT1IE		(1 << 7)
/** HRTIM_TIMA_TIMADIER_UPDIE UPDIE **/
#define HRTIM_TIMA_TIMADIER_UPDIE		(1 << 6)
/** HRTIM_TIMA_TIMADIER_REPIE REPIE **/
#define HRTIM_TIMA_TIMADIER_REPIE		(1 << 4)
/** HRTIM_TIMA_TIMADIER_CMP4IE CMP4IE **/
#define HRTIM_TIMA_TIMADIER_CMP4IE		(1 << 3)
/** HRTIM_TIMA_TIMADIER_CMP3IE CMP3IE **/
#define HRTIM_TIMA_TIMADIER_CMP3IE		(1 << 2)
/** HRTIM_TIMA_TIMADIER_CMP2IE CMP2IE **/
#define HRTIM_TIMA_TIMADIER_CMP2IE		(1 << 1)
/** HRTIM_TIMA_TIMADIER_CMP1IE CMP1IE **/
#define HRTIM_TIMA_TIMADIER_CMP1IE		(1 << 0)
...
/** HRTIM_TIMA_CPT1AR_DIR Timerx Capture 1 Direction status **/
#define HRTIM_TIMA_CPT1AR_DIR		(1 << 16)
...
/** HRTIM_TIMA_CPT2AR_DIR Timerx Capture 1 Direction status **/
#define HRTIM_TIMA_CPT2AR_DIR		(1 << 16)
...
/** HRTIM_TIMA_RSTAR_TIMFCPM2 Timer F Compare 2 **/
#define HRTIM_TIMA_RSTAR_TIMFCPM2		(1 << 31)
...
/** HRTIM_TIMA_RSTAR_TIMFCMP1 Timer A Update reset **/
#define HRTIM_TIMA_RSTAR_TIMFCMP1		(1 << 0)
...
/** HRTIM_TIMA_CPT1ACR_TFCMP2 TFCMP2 **/
#define HRTIM_TIMA_CPT1ACR_TFCMP2		(1 << 15)
/** HRTIM_TIMA_CPT1ACR_TFCMP1 TFCMP1 **/
#define HRTIM_TIMA_CPT1ACR_TFCMP1		(1 << 14)
/** HRTIM_TIMA_CPT1ACR_TF1RST TF1RST **/
#define HRTIM_TIMA_CPT1ACR_TF1RST		(1 << 13)
/** HRTIM_TIMA_CPT1ACR_TF1SET TF1SET **/
#define HRTIM_TIMA_CPT1ACR_TF1SET		(1 << 12)
...
/** HRTIM_TIMA_CPT2ACR_TFCMP2 TFCMP2 **/
#define HRTIM_TIMA_CPT2ACR_TFCMP2		(1 << 15)
/** HRTIM_TIMA_CPT2ACR_TFCMP1 TFCMP1 **/
#define HRTIM_TIMA_CPT2ACR_TFCMP1		(1 << 14)
/** HRTIM_TIMA_CPT2ACR_TF1RST TF1RST **/
#define HRTIM_TIMA_CPT2ACR_TF1RST		(1 << 13)
/** HRTIM_TIMA_CPT2ACR_TF1SET TF1SET **/
#define HRTIM_TIMA_CPT2ACR_TF1SET		(1 << 12)
...
/** HRTIM_TIMA_OUTAR_BIAR Balanced Idle Automatic Resume **/
#define HRTIM_TIMA_OUTAR_BIAR		(1 << 14)
...
/** HRTIM_TIMA_FLTAR_FLT6EN Fault 6 enable **/
#define HRTIM_TIMA_FLTAR_FLT6EN		(1 << 5)
...
/** @defgroup hrtim_tima_timacr2 TIMACR2 HRTIM Timerx Control Register 2
@{*/

/** HRTIM_TIMA_TIMACR2_TRGHLF Triggered-half mode **/
#define HRTIM_TIMA_TIMACR2_TRGHLF		(1 << 20)
/** HRTIM_TIMA_TIMACR2_GTCMP3 Greater than Compare 3 PWM mode **/
#define HRTIM_TIMA_TIMACR2_GTCMP3		(1 << 17)
/** HRTIM_TIMA_TIMACR2_GTCMP1 Greater than Compare 1 PWM mode **/
#define HRTIM_TIMA_TIMACR2_GTCMP1		(1 << 16)

#define HRTIM_TIMA_TIMACR2_FEROM_SHIFT		14
#define HRTIM_TIMA_TIMACR2_FEROM_MASK		0x03
/** @defgroup hrtim_tima_timacr2_ferom FEROM Fault and Event Roll-Over Mode
@{*/
/**@}*/


#define HRTIM_TIMA_TIMACR2_BMROM_SHIFT		12
#define HRTIM_TIMA_TIMACR2_BMROM_MASK		0x03
/** @defgroup hrtim_tima_timacr2_bmrom BMROM Burst Mode Roll-Over Mode
@{*/
/**@}*/


#define HRTIM_TIMA_TIMACR2_ADROM_SHIFT		10
#define HRTIM_TIMA_TIMACR2_ADROM_MASK		0x03
/** @defgroup hrtim_tima_timacr2_adrom ADROM ADC Roll-Over Mode
@{*/
/**@}*/


#define HRTIM_TIMA_TIMACR2_OUTROM_SHIFT		8
#define HRTIM_TIMA_TIMACR2_OUTROM_MASK		0x03
/** @defgroup hrtim_tima_timacr2_outrom OUTROM Output Roll-Over Mode
@{*/
/**@}*/


#define HRTIM_TIMA_TIMACR2_ROM_SHIFT		6
#define HRTIM_TIMA_TIMACR2_ROM_MASK		0x03
/** @defgroup hrtim_tima_timacr2_rom ROM Roll-Over Mode
@{*/
/**@}*/

/** HRTIM_TIMA_TIMACR2_UDM Up-Down Mode **/
#define HRTIM_TIMA_TIMACR2_UDM		(1 << 4)
/** HRTIM_TIMA_TIMACR2_DCDR Dual Channel DAC Reset trigger **/
#define HRTIM_TIMA_TIMACR2_DCDR		(1 << 2)
/** HRTIM_TIMA_TIMACR2_DCDS Dual Channel DAC Step trigger **/
#define HRTIM_TIMA_TIMACR2_DCDS		(1 << 1)
/** HRTIM_TIMA_TIMACR2_DCDE Dual Channel DAC trigger enable **/
#define HRTIM_TIMA_TIMACR2_DCDE		(1 << 0)

/**@}*/

/** @defgroup hrtim_tima_aeefr3 AEEFR3 HRTIM Timerx External Event Filtering Register 3
@{*/


#define HRTIM_TIMA_AEEFR3_EEVACNT_SHIFT		8
#define HRTIM_TIMA_AEEFR3_EEVACNT_MASK		0x3f
/** @defgroup hrtim_tima_aeefr3_eevacnt EEVACNT External Event A counter
@{*/
/**@}*/


#define HRTIM_TIMA_AEEFR3_EEVASEL_SHIFT		4
#define HRTIM_TIMA_AEEFR3_EEVASEL_MASK		0x0f
/** @defgroup hrtim_tima_aeefr3_eevasel EEVASEL External Event A Selection
@{*/
/**@}*/

/** HRTIM_TIMA_AEEFR3_EEVARSTM External Event A Reset Mode **/
#define HRTIM_TIMA_AEEFR3_EEVARSTM		(1 << 2)
/** HRTIM_TIMA_AEEFR3_EEVACRES External Event A Counter Reset **/
#define HRTIM_TIMA_AEEFR3_EEVACRES		(1 << 1)
/** HRTIM_TIMA_AEEFR3_EEVACE External Event A Counter Enable **/
#define HRTIM_TIMA_AEEFR3_EEVACE		(1 << 0)
