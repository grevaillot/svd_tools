...
#define TIM1_CCR6			MMIO32(TIM1_BASE + 0x4c)
/** TIM1_CCMR3_Output capture/compare mode register 2 (output mode) **/
#define TIM1_CCMR3_Output			MMIO32(TIM1_BASE + 0x50)
/** TIM1_DTR2 timer Deadtime Register 2 **/
#define TIM1_DTR2			MMIO32(TIM1_BASE + 0x54)
/** TIM1_ECR DMA control register **/
#define TIM1_ECR			MMIO32(TIM1_BASE + 0x58)
/** TIM1_TISEL TIM timer input selection register **/
#define TIM1_TISEL			MMIO32(TIM1_BASE + 0x5c)
/** TIM1_AF1 TIM alternate function option register 1 **/
#define TIM1_AF1			MMIO32(TIM1_BASE + 0x60)
/** TIM1_AF2 TIM alternate function option register 2 **/
#define TIM1_AF2			MMIO32(TIM1_BASE + 0x64)
/** TIM1_DCR control register **/
#define TIM1_DCR			MMIO32(TIM1_BASE + 0x3dc)
/** TIM1_DMAR DMA address for full transfer **/
#define TIM1_DMAR			MMIO32(TIM1_BASE + 0x3e0)
...
/** TIM1_CR1_DITHEN Dithering Enable **/
#define TIM1_CR1_DITHEN		(1 << 12)
...
/** TIM1_CR2_MMS_3 Master mode selection - bit 3 **/
#define TIM1_CR2_MMS_3		(1 << 25)
...
/** TIM1_CR2_OIS6 Output Idle state 6 (OC6 output) **/
#define TIM1_CR2_OIS6		(1 << 18)
/** TIM1_CR2_OIS5 Output Idle state 5 (OC5 output) **/
#define TIM1_CR2_OIS5		(1 << 16)
/** TIM1_CR2_OIS4N Output Idle state 4 (OC4N output) **/
#define TIM1_CR2_OIS4N		(1 << 15)
...
/** TIM1_SMCR_SMSPS SMS Preload Source **/
#define TIM1_SMCR_SMSPS		(1 << 25)
/** TIM1_SMCR_SMSPE SMS Preload Enable **/
#define TIM1_SMCR_SMSPE		(1 << 24)
...
/** TIM1_SMCR_OCCS OCREF clear selection **/
#define TIM1_SMCR_OCCS		(1 << 3)
...
/** TIM1_DIER_TERRIE Transition Error interrupt enable **/
#define TIM1_DIER_TERRIE		(1 << 23)
/** TIM1_DIER_IERRIE Index Error interrupt enable **/
#define TIM1_DIER_IERRIE		(1 << 22)
/** TIM1_DIER_DIRIE Direction Change interrupt enable **/
#define TIM1_DIER_DIRIE		(1 << 21)
/** TIM1_DIER_IDXIE Index interrupt enable **/
#define TIM1_DIER_IDXIE		(1 << 20)
...
/** TIM1_SR_TERRF Transition Error interrupt flag **/
#define TIM1_SR_TERRF		(1 << 23)
/** TIM1_SR_IERRF Index Error interrupt flag **/
#define TIM1_SR_IERRF		(1 << 22)
/** TIM1_SR_DIRF Direction Change interrupt flag **/
#define TIM1_SR_DIRF		(1 << 21)
/** TIM1_SR_IDXF Index interrupt flag **/
#define TIM1_SR_IDXF		(1 << 20)
...
#define TIM1_CCMR1_Input_IC2PSC_SHIFT		10
#define TIM1_CCMR1_Input_IC2PSC_MASK		0x03
/** @defgroup tim1_ccmr1_input_ic2psc IC2PSC Input capture 2 prescaler
@{*/
/**@}*/
...
/** TIM1_CCMR2_Output_OC4M_3 Output Compare 4 mode - bit 3 **/
#define TIM1_CCMR2_Output_OC4M_3		(1 << 24)
...
/** TIM1_CCER_CC4NE Capture/Compare 4 complementary output enable **/
#define TIM1_CCER_CC4NE		(1 << 14)
...
#define TIM1_RCR_REP_MASK		0xffff
...
/** TIM1_BDTR_BK2ID BK2ID **/
#define TIM1_BDTR_BK2ID		(1 << 29)
/** TIM1_BDTR_BKBID BKBID **/
#define TIM1_BDTR_BKBID		(1 << 28)
/** TIM1_BDTR_BK2DSRM BK2DSRM **/
#define TIM1_BDTR_BK2DSRM		(1 << 27)
/** TIM1_BDTR_BKDSRM BKDSRM **/
#define TIM1_BDTR_BKDSRM		(1 << 26)
...
/** @defgroup tim1_ccr5 CCR5 capture/compare register 4
@{*/
...
/** @defgroup tim1_ccr5_ccr5 CCR5 Capture/Compare value
@{*/
/**@}*/
...
/** @defgroup tim1_ccr6 CCR6 capture/compare register 4
@{*/


#define TIM1_CCR6_CCR6_SHIFT		0
#define TIM1_CCR6_CCR6_MASK		0xffff
/** @defgroup tim1_ccr6_ccr6 CCR6 Capture/Compare value
@{*/
/**@}*/
...
/** @defgroup tim1_ccmr3_output CCMR3Output capture/compare mode register 2 (output mode)
@{*/

/** TIM1_CCMR3_Output_OC6M_bit3 Output Compare 6 mode bit 3 **/
#define TIM1_CCMR3_Output_OC6M_bit3		(1 << 24)

#define TIM1_CCMR3_Output_OC5M_bit3_SHIFT		16
#define TIM1_CCMR3_Output_OC5M_bit3_MASK		0x07
/** @defgroup tim1_ccmr3_output_oc5m_bit3 OC5Mbit3 Output Compare 5 mode bit 3
@{*/
/**@}*/
...
/** @defgroup tim1_dtr2 DTR2 timer Deadtime Register 2
@{*/

/** TIM1_DTR2_DTPE Deadtime Preload Enable **/
#define TIM1_DTR2_DTPE		(1 << 17)
/** TIM1_DTR2_DTAE Deadtime Asymmetric Enable **/
#define TIM1_DTR2_DTAE		(1 << 16)

#define TIM1_DTR2_DTGF_SHIFT		0
#define TIM1_DTR2_DTGF_MASK		0xff
/** @defgroup tim1_dtr2_dtgf DTGF Dead-time falling edge generator setup
@{*/
/**@}*/
...
/** @defgroup tim1_ecr ECR DMA control register
@{*/


#define TIM1_ECR_PWPRSC_SHIFT		24
#define TIM1_ECR_PWPRSC_MASK		0x07
/** @defgroup tim1_ecr_pwprsc PWPRSC Pulse Width prescaler
@{*/
/**@}*/


#define TIM1_ECR_PW_SHIFT		16
#define TIM1_ECR_PW_MASK		0xff
/** @defgroup tim1_ecr_pw PW Pulse width
@{*/
/**@}*/


#define TIM1_ECR_IPOS_SHIFT		6
#define TIM1_ECR_IPOS_MASK		0x03
/** @defgroup tim1_ecr_ipos IPOS Index Positioning
@{*/
/**@}*/

/** TIM1_ECR_FIDX First Index **/
#define TIM1_ECR_FIDX		(1 << 5)

#define TIM1_ECR_IBLK_SHIFT		3
#define TIM1_ECR_IBLK_MASK		0x03
/** @defgroup tim1_ecr_iblk IBLK Index Blanking
@{*/
/**@}*/


#define TIM1_ECR_IDIR_SHIFT		1
#define TIM1_ECR_IDIR_MASK		0x03
/** @defgroup tim1_ecr_idir IDIR Index Direction
@{*/
/**@}*/

/** TIM1_ECR_IE Index Enable **/
#define TIM1_ECR_IE		(1 << 0)

/**@}*/

/** @defgroup tim1_tisel TISEL TIM timer input selection register
@{*/


#define TIM1_TISEL_TI4SEL_SHIFT		24
#define TIM1_TISEL_TI4SEL_MASK		0x0f
/** @defgroup tim1_tisel_ti4sel TI4SEL TI4[0] to TI4[15] input selection
@{*/
/**@}*/
...
/** @defgroup tim1_tisel_ti3sel TI3SEL TI3[0] to TI3[15] input selection
@{*/
/**@}*/
...
/** @defgroup tim1_tisel_ti2sel TI2SEL TI2[0] to TI2[15] input selection
@{*/
/**@}*/
...
/** @defgroup tim1_tisel_ti1sel TI1SEL TI1[0] to TI1[15] input selection
@{*/
/**@}*/
...
/** @defgroup tim1_af1 AF1 TIM alternate function option register 1
@{*/
...
/** TIM1_AF1_BKCMP4P BRK COMP4 input polarity **/
#define TIM1_AF1_BKCMP4P		(1 << 13)
/** TIM1_AF1_BKCMP3P BRK COMP3 input polarity **/
#define TIM1_AF1_BKCMP3P		(1 << 12)
...
/** TIM1_AF1_BKCMP7E BRK COMP7 enable **/
#define TIM1_AF1_BKCMP7E		(1 << 7)
/** TIM1_AF1_BKCMP6E BRK COMP6 enable **/
#define TIM1_AF1_BKCMP6E		(1 << 6)
/** TIM1_AF1_BKCMP5E BRK COMP5 enable **/
#define TIM1_AF1_BKCMP5E		(1 << 5)
/** TIM1_AF1_BKCMP4E BRK COMP4 enable **/
#define TIM1_AF1_BKCMP4E		(1 << 4)
/** TIM1_AF1_BKCMP3E BRK COMP3 enable **/
#define TIM1_AF1_BKCMP3E		(1 << 3)
...
/** @defgroup tim1_af2 AF2 TIM alternate function option register 2
@{*/


#define TIM1_AF2_OCRSEL_SHIFT		16
#define TIM1_AF2_OCRSEL_MASK		0x07
/** @defgroup tim1_af2_ocrsel OCRSEL OCREF_CLR source selection
@{*/
/**@}*/

/** TIM1_AF2_BK2CMP4P BRK2 COMP4 input polarity **/
#define TIM1_AF2_BK2CMP4P		(1 << 13)
/** TIM1_AF2_BK2CMP3P BRK2 COMP3 input polarity **/
#define TIM1_AF2_BK2CMP3P		(1 << 12)
/** TIM1_AF2_BK2CMP2P BRK2 COMP2 input polarity **/
#define TIM1_AF2_BK2CMP2P		(1 << 11)
/** TIM1_AF2_BK2CMP1P BRK2 COMP1 input polarity **/
#define TIM1_AF2_BK2CMP1P		(1 << 10)
/** TIM1_AF2_BK2INP BRK2 BKIN input polarity **/
#define TIM1_AF2_BK2INP		(1 << 9)
/** TIM1_AF2_BK2CMP7E BRK2 COMP7 enable **/
#define TIM1_AF2_BK2CMP7E		(1 << 7)
/** TIM1_AF2_BK2CMP6E BRK2 COMP6 enable **/
#define TIM1_AF2_BK2CMP6E		(1 << 6)
/** TIM1_AF2_BK2CMP5E BRK2 COMP5 enable **/
#define TIM1_AF2_BK2CMP5E		(1 << 5)
/** TIM1_AF2_BK2CMP4E BRK2 COMP4 enable **/
#define TIM1_AF2_BK2CMP4E		(1 << 4)
/** TIM1_AF2_BK2CMP3E BRK2 COMP3 enable **/
#define TIM1_AF2_BK2CMP3E		(1 << 3)
...
/** TIM1_AF2_BKINE BRK BKIN input enable **/
#define TIM1_AF2_BKINE		(1 << 0)

/**@}*/

/** @defgroup tim1_dcr DCR control register
@{*/
