...
/** USART2_PRESC USART prescaler register **/
...
/** USART2_CR1_RXFFIE RXFFIE **/
#define USART2_CR1_RXFFIE		(1 << 31)
/** USART2_CR1_TXFEIE TXFEIE **/
#define USART2_CR1_TXFEIE		(1 << 30)
/** USART2_CR1_FIFOEN FIFOEN **/
...
/** USART2_CR2_DIS_NSS DIS_NSS **/
#define USART2_CR2_DIS_NSS		(1 << 3)
/** USART2_CR2_SLVEN SLVEN **/
...
/** @defgroup usart2_cr3_txftcfg TXFTCFG TXFTCFG
@{*/
/**@}*/

/** USART2_CR3_RXFTIE RXFTIE **/
#define USART2_CR3_RXFTIE		(1 << 28)

#define USART2_CR3_RXFTCFG_SHIFT		25
#define USART2_CR3_RXFTCFG_MASK		0x07
/** @defgroup usart2_cr3_rxftcfg RXFTCFG RXFTCFG
@{*/
/**@}*/

/** USART2_CR3_TCBGTIE TCBGTIE **/
#define USART2_CR3_TCBGTIE		(1 << 24)
/** USART2_CR3_TXFTIE TXFTIE **/
...
/** @defgroup usart2_brr_div_mantissa DIVMantissa DIV_Mantissa
@{*/
/**@}*/
...
/** @defgroup usart2_brr_div_fraction DIVFraction DIV_Fraction
@{*/
/**@}*/
...
/** @defgroup usart2_presc PRESC USART prescaler register
@{*/


#define USART2_PRESC_PRESCALER_SHIFT		0
#define USART2_PRESC_PRESCALER_MASK		0x0f
/** @defgroup usart2_presc_prescaler PRESCALER PRESCALER
@{*/
/**@}*/
